(function()
{
    return function()
    {
        ...
        {
            this.set_name("frameSSO");
            this.set_titletext("frameSSO");
            this.set_background("#f1f1f1");
            this.set_scrolltype("none");
            this.set_scrollbartype("none none");
            if (Form == this.constructor)
            {
                this._setFormPosition(240,293);
            }
            ...
            obj = new Div("divLogin","5","5","241","295",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            obj.set_background("");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",240,293,this,function(p){});
        ...
        // User Script
        this.registerScript("frameSSO.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("frameSSO.xfdl");
