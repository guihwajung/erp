(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtCbo","0","0",null,"21","21",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_enable("true");
            ...
            obj = new Button("btnCbo",null,"0","21","21","0",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("btn_WF_MultiCombo");
            this.addChild(obj.name, obj);

            obj = new PopupDiv("pdvCbo","0","21",null,"129","0",null,null,null,null,null,this);
            obj.set_text("");
