(function()
{
    return function()
    {
        ...
        {
            this.set_name("cmmCalYY");
            this.set_titletext("년도 달력");
            if (Form == this.constructor)
            {
                this._setFormPosition(80,25);
            }
            ...
            obj.set_url("cmm::cmmCalYY_Pop.xfdl");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        {
            this._addPreloadList("fdl","cmm::cmmCalYY_Pop.xfdl");
        };
        
        // User Script
        this.registerScript("cmmCalYY.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.btnCal_onclick = function(obj,e)
        {
        	...
        	this.pdvCal.form.pdvCal_SetCalendar(sDate);
        ...
        this.call_back = function(strId, val) {
        	if(!this.gfnIsNull(val) && val.length == 4) {
        ...
        this.loadIncludeScript("cmmCalYY.xfdl");
