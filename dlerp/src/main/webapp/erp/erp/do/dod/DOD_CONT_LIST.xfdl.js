(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DODPR_CONTRCT_LIST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"TY_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BONBU\" type=\"STRING\" size=\"256\"/><Column id=\"CD_FIELD\" type=\"STRING\" size=\"256\"/><Column id=\"DS_FIELD\" type=\"STRING\" size=\"256\"/><Column id=\"TY_CONT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LOC\" type=\"STRING\" size=\"256\"/><Column id=\"YN_MAIN\" type=\"STRING\" size=\"256\"/><Column id=\"GRID_HIDE_CHK1\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\"/><Col id=\"DS_CODE\">전체</Col></Row><Row><Col id=\"CD_CODE\">Y</Col><Col id=\"DS_CODE\">예</Col></Row><Row><Col id=\"CD_CODE\">N</Col><Col id=\"DS_CODE\">아니오</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_FIELD","0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("현장코드");
            ...
            obj = new Div("ccfCD_FIELD","staCD_FIELD:0.0","10.0","299","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staCD_BONBU","ccfCD_FIELD:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("공사분야");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Static("staTY_CONT","ccboCD_BONBU:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("계약수행방식");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboTY_CONT","staTY_CONT:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            ...
            obj = new Combo("ccboCD_LOC","ccboTY_CONT:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            ...
            obj = new Static("staCD_LOC","ccboCD_LOC:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("지역");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboYN_MAIN","staCD_LOC:0.0","10.0","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            ...
            obj = new Static("staCD_PROJ03","ccboYN_MAIN:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("Main");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Static("staTY_PROJ","staCD_PROJ03:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("프로젝트구분");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new CheckBox("cchkYN_HIDE1","ccboTY_PROJ:0.0","10.0","99","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("청구/수금 정보");
            obj.set_truevalue("Y");
            ...
            obj = new BindItem("item3","divSearch.form.ccboTY_CONT","value","dsSearch","TY_CONT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSearch.form.ccboCD_LOC","value","dsSearch","CD_LOC");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch.form.ccboYN_MAIN","value","dsSearch","YN_MAIN");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item7","divSearch.form.cchkYN_HIDE1","value","dsSearch","GRID_HIDE_CHK1");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DOD_CONT_LIST.xfdl", function() {
         ...
         * 변경계약생성
         ************************************************************************/
        this.fnNO_CHG_CONT = function(obj,e){
        	var param = {
         ...
         * 확장 버튼 : 화면별 버튼 설정 ID, function 연결 (화면버튼관리)
          * 계약내역편집
         ************************************************************************/
        this.fnCONT_HIST_UPD = function(obj,e){
        	var param = {
        		CD_FIELD : this.dsList.getColumn(this.dsList.rowposition, "CD_FIELD")
        	  , NO_CONT  : this.dsList.getColumn(this.dsList.rowposition, "NO_CONT")
        ...
        this.loadIncludeScript("DOD_CONT_LIST.xfdl");
