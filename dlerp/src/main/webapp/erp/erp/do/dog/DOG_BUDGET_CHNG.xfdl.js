(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DOG_BUDGET_CHNG.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnBudgetchgCncl = this.gfnFormButtonAdd("btnBudgetchgCncl", "fnBudgetchgCncl");		// 변경예산확정
        };
        ...
        this.fnExec = function(yn_apply) {
        	...
        	this.dsExec.setColumn(0, "YN_APPLY", yn_apply);
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg)
        {
        	if (svcID == "select") {
        		...
        		if (errorCode == 0) {
        			...
        			if(strArg == "Y") msg += "변경예산신청이 정상처리되었습니다.";
        			else if(strArg == "N") msg += "변경예산신청취소가 정상처리되었습니다.";
        ...
        this.fnBudgetchg = function(obj,e) {
        	...
        	this.gfnConfirm("변경예산신청을 진행하시겠습니까?", "fnBudgetChg_callback", "Y");
        }
        ...
        this.fnBudgetchgCncl = function(obj,e) {
        	...
        	this.gfnConfirm("변경예산신청취소를 진행하시겠습니까?", "fnBudgetChg_callback", "N");
        }
        ...
        this.loadIncludeScript("DOG_BUDGET_CHNG.xfdl");
