(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("objGrid","0","divDataMaster:10",null,"480","0",null,null,null,null,null,this.divData1.form);
            obj.set_taborder("3");
            obj._setContents("");
            this.divData1.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DOS_PLANDTL_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DO01";
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	//this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOS_PLANDTL_APP");
        	//this.gfnGridInit(this.dxGrid1, this.dsList1, "DW", "DWA_RISKDTLS_APP");
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOS_PLANDTL_APP", "DS_ITEM", "NO_LEVEL");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_PROJ", this.dsSearch.getColumn(0, "V1"));
        	this.dsSelect.setColumn(0, "NO_PLAN", this.dsSearch.getColumn(0, "V2"));
        ...
        // 	this.dsSelect1.setColumn(0, "NO_RISK", this.dsListMaster.getColumn(0, "V_PARAM02"));
        ...
        **************************************************************************************************/
        ...
        this.loadIncludeScript("DOS_PLANDTL_APP.xfdl");
