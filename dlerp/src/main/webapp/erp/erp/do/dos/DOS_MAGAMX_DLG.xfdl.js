(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DOSPR_SAUP_MAGAMX</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnOK","30.00%","137","60","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("확인");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCANCLE","btnOK:30","137","60","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_text("취소");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DOS_MAGAMX_DLG.xfdl", function() {
        ...
        this.loadIncludeScript("DOS_MAGAMX_DLG.xfdl");
