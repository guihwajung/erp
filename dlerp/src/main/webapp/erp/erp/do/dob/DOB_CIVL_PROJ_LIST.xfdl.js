(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1640,720);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOAPR_CIVL_PROJ_LIST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_PRC_BID","ccfCD_CLS_CONST:0.0","staCD_PROJ:10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("입찰추진");
            obj.set_textAlign("right");
            ...
            obj = new Static("staCD_CV_GO","0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("공공/민간");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboCD_PRC_BID","staCD_PRC_BID:0.0","staCD_PROJ:10.0","119","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            ...
            obj = new Static("staCD_CV_GO00","ccboTY_DT:0.0","staCD_PROJ:10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("일자");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Static("staCD_PRC_BID00","staCD_CV_GO00_00:0.0","staCD_PROJ:10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("17");
            obj.set_text("주요공사");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboTY_MJ_CONST","staCD_PRC_BID00:0.0","staCD_PROJ:10.0","120","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("18");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            ...
            obj = new Div("ccfCD_SAUP","0.0","10.0","298","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staCD_PRC_BID00_00","ccfCD_SAUP:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("20");
            obj.set_text("사업관리부서");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_SchLabel");
        ...
        // User Script
        this.registerScript("DOB_CIVL_PROJ_LIST.xfdl", function() {
        ...
        this.loadIncludeScript("DOB_CIVL_PROJ_LIST.xfdl");
