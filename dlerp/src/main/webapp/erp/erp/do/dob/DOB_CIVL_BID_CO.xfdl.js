(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOAPR_CIVL_PROJ_CO_BID_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DOAPR_CIVL_PROJ_CO_BID_SAVE</Col></Row><Row><Col id=\"TARGET\">selectCharge</Col><Col id=\"SP\">DOAPR_PROJ_YNCHARGE_SELECT</Col></Row></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"DS_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"AM_ESTM_CAL\" type=\"STRING\" size=\"256\"/><Column id=\"NO_ADDCNT\" type=\"INT\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsRequired", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_FIELD\" type=\"STRING\" size=\"256\"/><Column id=\"DS_FIELD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_FIELD\">CD_CONST_CO</Col><Col id=\"DS_FIELD\">건설사코드</Col></Row><Row><Col id=\"CD_FIELD\">AM_BID</Col><Col id=\"DS_FIELD\">투찰금액</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staAM_ESTM_CAL","0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("예정가격");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new MaskEdit("ctxtAM_ESTM_CAL","0.0","staCD_PROJ:10.0","140","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_value("");
            ...
            obj = new MaskEdit("ctxtAM_ESTM_CAL00","ctxtAM_ESTM_CAL:0.0","staCD_PROJ:10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_value("");
            obj.set_textAlign("right");
            obj.set_format("#,##0");
            ...
            obj = new Static("staAM_ESTM_CAL00","0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("추가Row");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","divSearch.form.ctxtAM_ESTM_CAL","value","dsSearch","AM_ESTM_CAL");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.ctxtAM_ESTM_CAL00","value","dsSearch","NO_ADDCNT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DOB_CIVL_BID_CO.xfdl", function() {
        ...
        this.loadIncludeScript("DOB_CIVL_BID_CO.xfdl");
