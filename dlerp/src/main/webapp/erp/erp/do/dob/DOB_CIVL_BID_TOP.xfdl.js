(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOZPR_CIVL_BID_TOP_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"DT_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"NO_RANK_FR\" type=\"INT\" size=\"256\"/><Column id=\"NO_RANK_TO\" type=\"INT\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_ORD","staCD_PROJ:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("도급순위");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_SchLabelE");
            ...
            obj = new MaskEdit("ctxtAM_ESTM_CAL00","0.0","staCD_PROJ:10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_value("");
            obj.set_textAlign("right");
            obj.set_format("#,##0");
            ...
            obj = new MaskEdit("ctxtAM_ESTM_CAL00_00","ctxtAM_ESTM_CAL00:0.0","staCD_PROJ:10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_value("");
            obj.set_textAlign("right");
            obj.set_format("#,##0");
            ...
            obj = new Static("staCD_CV_GO00_00_00","0.0","10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("~");
            obj.set_textAlign("center");
            obj.set_cssclass("sta_WF_AC");
            ...
            obj = new BindItem("item0","divSearch.form.ctxtAM_ESTM_CAL00","value","dsSearch","NO_RANK_FR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.ctxtAM_ESTM_CAL00_00","value","dsSearch","NO_RANK_TO");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DOB_CIVL_BID_TOP.xfdl", function() {
        ...
        this.loadIncludeScript("DOB_CIVL_BID_TOP.xfdl");
