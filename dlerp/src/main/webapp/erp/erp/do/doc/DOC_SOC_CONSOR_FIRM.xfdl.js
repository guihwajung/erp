(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOAPR_SOC_PROJ_CONSOR_FIRM_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DOAPR_SOC_PROJ_CONSOR_FIRM_SAVE</Col></Row><Row><Col id=\"TARGET\">selectCharge</Col><Col id=\"SP\">DOAPR_PROJ_YNCHARGE_SELECT</Col></Row></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"DS_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"NO_CONSOR\" type=\"STRING\" size=\"256\"/><Column id=\"YN_READ\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsRequired", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_FIELD\" type=\"STRING\" size=\"256\"/><Column id=\"DS_FIELD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_FIELD\">TY_CONSOR_FIRM</Col><Col id=\"DS_FIELD\">구분</Col></Row><Row><Col id=\"CD_FIELD\">CD_VENDOR</Col><Col id=\"DS_FIELD\">업체코드</Col></Row><Row><Col id=\"CD_FIELD\">YN_JUGAN</Col><Col id=\"DS_FIELD\">주간사여부</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOC_SOC_CONSOR_FIRM.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOC_SOC_CONSOR_FIRM_LIST");	// 경쟁컨소시엄 참여사구성 관리
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("CD_PROJ", "string");		// 경쟁컨소시엄순번
        	this.dsSave.addColumn("NO_CONSOR", "string");		// 경쟁컨소시엄순번
        	this.dsSave.addColumn("TY_CONSOR_FIRM", "string");	// 참여사구분
        	...
        	for (var i = 0; i < dsListCnt; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "NO_CONSOR", this.getOwnerFrame().NO_CONSOR);					// 컨소시엄순번
        				this.dsSave.setColumn(nrow, "TY_CONSOR_FIRM", this.dsList.getColumn(i, "TY_CONSOR_FIRM"));			// 구분
        ...
        this.gridGoloring = function(){
        	this.gfnGridColumnColor(this.dxGrid, "TY_CONSOR_FIRM","BACK_ReadOnly", "nx_flag==null");
        ...
        this.loadIncludeScript("DOC_SOC_CONSOR_FIRM.xfdl");
