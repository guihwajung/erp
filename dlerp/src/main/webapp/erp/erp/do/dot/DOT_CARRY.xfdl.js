(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOTPR_CARRY_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DOTPR_CARRY_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DOTPR_CARRY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DOTPR_CARRY_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOT_CARRY.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOT_CARRY");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("TY_CARRY1", "string");
        	this.dsInsert.addColumn("DS_CARRY1", "string");
        	this.dsInsert.addColumn("TY_CARRY2", "string");
        	this.dsInsert.addColumn("DS_CARRY2", "string");
        	...
        	this.dsUpdate.addColumn("TY_CARRY1", "string");
        	this.dsUpdate.addColumn("DS_CARRY1", "string");
        	this.dsUpdate.addColumn("TY_CARRY2", "string");
        	this.dsUpdate.addColumn("DS_CARRY2", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "TY_CARRY1", this.dsList.getColumn(i, "TY_CARRY1"));
        				this.dsInsert.setColumn(nrow, "DS_CARRY1", this.dsList.getColumn(i, "DS_CARRY1"));
        				this.dsInsert.setColumn(nrow, "TY_CARRY2", this.dsList.getColumn(i, "TY_CARRY2"));
        				this.dsInsert.setColumn(nrow, "DS_CARRY2", this.dsList.getColumn(i, "DS_CARRY2"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "TY_CARRY1", this.dsList.getColumn(i, "TY_CARRY1"));
        				this.dsUpdate.setColumn(nrow, "DS_CARRY1", this.dsList.getColumn(i, "DS_CARRY1"));
        				this.dsUpdate.setColumn(nrow, "TY_CARRY2", this.dsList.getColumn(i, "TY_CARRY2"));
        				this.dsUpdate.setColumn(nrow, "DS_CARRY2", this.dsList.getColumn(i, "DS_CARRY2"));
        ...
        this.loadIncludeScript("DOT_CARRY.xfdl");
