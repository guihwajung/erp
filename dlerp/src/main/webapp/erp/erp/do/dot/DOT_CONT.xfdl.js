(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOTPR_CONT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DOTPR_CONT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DOTPR_CONT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DOTPR_CONT_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOT_CONT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOT_CONT");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("TY_CONT", "string");
        	this.dsInsert.addColumn("AM_FIRST", "bigdecimal");
        	this.dsInsert.addColumn("RM_FIRST", "string");
        	this.dsInsert.addColumn("AM_CHG", "bigdecimal");
        	this.dsInsert.addColumn("RM_CHG", "string");
        	...
        	this.dsUpdate.addColumn("AM_FIRST", "bigdecimal");
        	this.dsUpdate.addColumn("RM_FIRST", "string");
        	this.dsUpdate.addColumn("AM_CHG", "bigdecimal");
        	this.dsUpdate.addColumn("RM_CHG", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "TY_CONT", this.dsList.getColumn(i, "TY_CONT"));
        				this.dsInsert.setColumn(nrow, "AM_FIRST", this.dsList.getColumn(i, "AM_FIRST"));
        				this.dsInsert.setColumn(nrow, "RM_FIRST", this.dsList.getColumn(i, "RM_FIRST"));
        				this.dsInsert.setColumn(nrow, "AM_CHG", this.dsList.getColumn(i, "AM_CHG"));
        				this.dsInsert.setColumn(nrow, "RM_CHG", this.dsList.getColumn(i, "RM_CHG"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "TY_CONT", this.dsList.getColumn(i, "TY_CONT"));
        				this.dsUpdate.setColumn(nrow, "AM_FIRST", this.dsList.getColumn(i, "AM_FIRST"));
        				this.dsUpdate.setColumn(nrow, "RM_FIRST", this.dsList.getColumn(i, "RM_FIRST"));
        				this.dsUpdate.setColumn(nrow, "AM_CHG", this.dsList.getColumn(i, "AM_CHG"));
        				this.dsUpdate.setColumn(nrow, "RM_CHG", this.dsList.getColumn(i, "RM_CHG"));
        ...
        this.loadIncludeScript("DOT_CONT.xfdl");
