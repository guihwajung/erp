(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOTPR_WORK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DOTPR_WORK_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DOTPR_WORK_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DOTPR_WORK_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOT_WORK.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOT_WORK");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DS_COMPANY", this.dsList.getColumn(i, "DS_COMPANY"));
        				...
        				this.dsInsert.setColumn(nrow, "DS_PHONE", this.dsList.getColumn(i, "DS_PHONE"));
        				this.dsInsert.setColumn(nrow, "DS_MOBILE", this.dsList.getColumn(i, "DS_MOBILE"));
        				this.dsInsert.setColumn(nrow, "DS_FAX", this.dsList.getColumn(i, "DS_FAX"));
        				this.dsInsert.setColumn(nrow, "DS_EMAIL", this.dsList.getColumn(i, "DS_EMAIL"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "DS_COMPANY", this.dsList.getColumn(i, "DS_COMPANY"));
        				...
        				this.dsUpdate.setColumn(nrow, "DS_PHONE", this.dsList.getColumn(i, "DS_PHONE"));
        				this.dsUpdate.setColumn(nrow, "DS_MOBILE", this.dsList.getColumn(i, "DS_MOBILE"));
        				this.dsUpdate.setColumn(nrow, "DS_FAX", this.dsList.getColumn(i, "DS_FAX"));
        ...
        this.loadIncludeScript("DOT_WORK.xfdl");
