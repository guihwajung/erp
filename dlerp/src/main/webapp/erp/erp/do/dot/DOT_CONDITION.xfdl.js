(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOTPR_CONDITION_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DOTPR_CONDITION_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DOTPR_CONDITION_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DOTPR_CONDITION_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOT_CONDITION.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOT_CONDITION");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DS_CONDITION", "string");
        	this.dsInsert.addColumn("RM_CONDITION", "string");
        	...
        	this.dsUpdate.addColumn("DS_CONDITION", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DS_CONDITION", this.dsList.getColumn(i, "DS_CONDITION"));
        				this.dsInsert.setColumn(nrow, "RM_CONDITION", this.dsList.getColumn(i, "RM_CONDITION"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "DS_CONDITION", this.dsList.getColumn(i, "DS_CONDITION"));
        				this.dsUpdate.setColumn(nrow, "RM_CONDITION", this.dsList.getColumn(i, "RM_CONDITION"));
        ...
        this.loadIncludeScript("DOT_CONDITION.xfdl");
