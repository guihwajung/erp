(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOFPR_CONST_COLLECT_LIST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"TY_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BONBU\" type=\"STRING\" size=\"256\"/><Column id=\"CD_FIELD\" type=\"STRING\" size=\"256\"/><Column id=\"DS_FIELD\" type=\"STRING\" size=\"256\"/><Column id=\"GRID_HIDE_CHK1\" type=\"STRING\" size=\"256\"/><Column id=\"GRID_HIDE_CHK2\" type=\"STRING\" size=\"256\"/><Column id=\"GRID_HIDE_CHK3\" type=\"STRING\" size=\"256\"/><Column id=\"GRID_HIDE_CHK4\" type=\"STRING\" size=\"256\"/><Column id=\"GRID_HIDE_CHK5\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"GRID_HIDE_CHK5\">Y</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("cchkYN_HIDE1","ccboCD_BONBU:0.0","10.0","99","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("계약금 정보");
            obj.set_truevalue("Y");
            ...
            obj = new CheckBox("cchkYN_HIDE3","cchkYN_HIDE1:0.0","10.0","86","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("기성 정보");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            ...
            obj = new CheckBox("cchkYN_HIDE5","cchkYN_HIDE3:0.0","10.0","74","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("전표 정보");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            ...
            obj = new CheckBox("cchkYN_HIDE2","cchkYN_HIDE5:0.0","10.0","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("선수금 정보");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            ...
            obj = new CheckBox("cchkYN_HIDE4","cchkYN_HIDE2:0.0","10.0","87","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("정산 정보");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            ...
            obj = new Static("staTY_PROJ","cchkYN_HIDE4:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("프로젝트구분");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new BindItem("item5","divSearch.form.cchkYN_HIDE5","value","dsSearch","GRID_HIDE_CHK5");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divSearch.form.cchkYN_HIDE2","value","dsSearch","GRID_HIDE_CHK2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divSearch.form.cchkYN_HIDE4","value","dsSearch","GRID_HIDE_CHK4");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divSearch.form.ccboTY_PROJ","value","dsSearch","TY_PROJ");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DOF_CONST_COLLECT_LIST.xfdl", function() {
        ...
        this.divSearch_cchkYN_HIDE4_onchanged = function(obj,e)
        {
        	/*
        	기성금액	과세	공급가	100
        	기성금액	과세	부가세	100
        ...
        this.divSearch_cchkYN_HIDE5_onchanged = function(obj,e)
        {
        	/*
        	전표번호	전표번호	전표번호	80
        	*/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.cchkYN_HIDE5.addEventHandler("onchanged",this.divSearch_cchkYN_HIDE5_onchanged,this);
            this.divSearch.form.cchkYN_HIDE2.addEventHandler("onchanged",this.divSearch_cchkYN_HIDE2_onchanged,this);
            this.divSearch.form.cchkYN_HIDE4.addEventHandler("onchanged",this.divSearch_cchkYN_HIDE4_onchanged,this);
            this.divData.form.objGrid.addEventHandler("oncelldblclick",this.divData_objGrid_oncelldblclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DOF_CONST_COLLECT_LIST.xfdl");
