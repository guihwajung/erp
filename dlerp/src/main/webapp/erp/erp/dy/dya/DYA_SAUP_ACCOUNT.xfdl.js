(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DYAPR_SAUP_ACCOUNT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DYAPR_SAUP_ACCOUNT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DYAPR_SAUP_ACCOUNT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DYAPR_SAUP_ACCOUNT_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DYA_SAUP_ACCOUNT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DY", "DYA_SAUP_ACCOUNT");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("AM_DOKUB", "bigdecimal");
        	this.dsInsert.addColumn("AM_SILHENG", "bigdecimal");
        	this.dsInsert.addColumn("REMARK", "string");
        	...
        	this.dsUpdate.addColumn("REMARK", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "AM_DOKUB", this.dsList.getColumn(i, "AM_DOKUB"));
        				this.dsInsert.setColumn(nrow, "AM_SILHENG", this.dsList.getColumn(i, "AM_SILHENG"));
        				this.dsInsert.setColumn(nrow, "REMARK", this.dsList.getColumn(i, "REMARK"));
        				break;
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "AM_SILHENG", this.dsList.getColumn(i, "AM_SILHENG"));
        				this.dsUpdate.setColumn(nrow, "REMARK", this.dsList.getColumn(i, "REMARK"));
        ...
        this.loadIncludeScript("DYA_SAUP_ACCOUNT.xfdl");
