(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DYAPR_SAUP_ACNT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DYAPR_SAUP_ACNT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DYAPR_SAUP_ACNT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DYAPR_SAUP_ACNT_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DYA_SAUP_ACNT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DY", "DYA_SAUP_ACNT");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("GUBUN", "string");
        	...
        	this.dsDelete.addColumn("GUBUN", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "GUBUN", this.dsList.getColumn(i, "GUBUN"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "GUBUN", this.dsList.getColumn(i, "GUBUN"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "GUBUN", this.dsList.getColumn(i, "GUBUN"));
        ...
        this.loadIncludeScript("DYA_SAUP_ACNT.xfdl");
