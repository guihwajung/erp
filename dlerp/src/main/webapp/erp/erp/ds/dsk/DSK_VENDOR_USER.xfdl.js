(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_VENDOR_USER_LIST_SELECT</Col></Row><Row><Col id=\"SP\">DSKPR_VENDOR_USER_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DSKPR_VENDOR_USER_DELETE</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DSKPR_VENDOR_USER_INSERT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_VENDOR","ccfCD_SITE:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("협력업체");
            ...
            obj = new Div("divDataLeft","0","0",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("DSK_VENDOR_USER.xfdl", function() {
        ...
        this.loadIncludeScript("DSK_VENDOR_USER.xfdl");
