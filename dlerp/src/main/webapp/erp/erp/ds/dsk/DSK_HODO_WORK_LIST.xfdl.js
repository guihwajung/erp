(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_HODO_WORK_LIST</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"CD_VENDOR\"/><Col id=\"DT_WORK\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclDT_WORK","staDT_WORK:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new BindItem("item1","divSearch.form.ctclDT_WORK","value","dsSearch","DT_WORK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DSK_HODO_WORK_LIST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_HODO_WORK_LIST");
        }
        ...
        this.fnValidate = function() {
        	if (this.gfnIsNull(this.ccfCD_SITE.form.CDTextBox.value)) {
        		...
        		this.fnVaidateCallback = function() {
        			this.divSearch.form.ctclDT_WORK.setFocus();
        		}
        ...
        this.loadIncludeScript("DSK_HODO_WORK_LIST.xfdl");
