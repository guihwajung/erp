(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("계약감액 대상업체 리스트");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_DISCOUNT_VENDOR</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclDT_GIJUN","0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Static("sta00","ctclDT_GIJUN:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("DSK_DISCOUNT_VENDOR.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_DISCOUNT_VENDOR");
        }
        ...
        this.loadIncludeScript("DSK_DISCOUNT_VENDOR.xfdl");
