(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("현장별 사업주 인정승인현황");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_SITE_SAUPJUINJUNG</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclDT_GIJUN","staDT_GIJUN:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
        ...
        // User Script
        this.registerScript("DSK_SITE_SAUPJUINJUNG.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_SITE_SAUPJUINJUNG");
        }
        ...
        this.loadIncludeScript("DSK_SITE_SAUPJUINJUNG.xfdl");
