(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("고용보험 추가징수분 조회(SAP)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_GOYONG_ADD_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSK_GOYONG_ADD.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_GOYONG_ADD");
        ...
        this.loadIncludeScript("DSK_GOYONG_ADD.xfdl");
