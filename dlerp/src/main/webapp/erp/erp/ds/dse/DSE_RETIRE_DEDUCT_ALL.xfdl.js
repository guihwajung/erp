(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSEPR_RETIRE_DEDUCT_ALL_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DSEPR_RETIRE_DEDUCT_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("objGrid","0","28",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj._setContents("");
        ...
        // User Script
        this.registerScript("DSE_RETIRE_DEDUCT_ALL.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnCalc = this.gfnFormButtonAdd("btnCalc", "fnCalc", "자료생성");
        	this.btnDetail = this.gfnFormButtonAdd("btnDetail", "fnDetail", "상세보기");
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSE_RETIRE_DEDUCT_ALL");
        }
        ...
        this.fnCalc = function(obj,e) {
        	...
        	this.gfnConfirm("이전 자료를 삭제하고 생성합니다. 계속하시겠습니까?", "fnCalcCallback");
        }

        this.fnCalcCallback = function(strId, val) {
        	...
        	this.dsInsert.setColumn(0, "CD_CORP", this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsInsert.setColumn(0, "CD_SITE", this.dsSearch.getColumn(0, "CD_SITE"));
        	this.dsInsert.setColumn(0, "YM_WORK", this.dsSearch.getColumn(0, "YM_WORK"));
        ...
        this.fnDetail = function(obj,e) {
        	...
        	trace("fnDetail param", JSON.stringify(param));

        	this.gfnFormOpen("DSE", "DSE_RETIRE_DEDUCT", "", param);
        ...
        this.loadIncludeScript("DSE_RETIRE_DEDUCT_ALL.xfdl");
