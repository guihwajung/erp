(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("금회보험료 조회 및 발행");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSHPR_INSU_LIST_SELECT</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DSHPR_INSU_LIST_SAVE</Col></Row><Row><Col id=\"TARGET\">exec1</Col><Col id=\"SP\">DSHPR_INSU_LIST_CENCEL</Col></Row><Row><Col id=\"TARGET\">exec2</Col><Col id=\"SP\">DSHPR_INSU_SLIP</Col></Row><Row><Col id=\"TARGET\">exec3</Col><Col id=\"SP\">DSHPR_INSU_SLIP_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"DT_MAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DT_MAGAM\"/><Col id=\"TY_GUBUN\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_GUBUN", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_CODE\">산재</Col><Col id=\"CD_CODE\">1</Col></Row><Row><Col id=\"CD_CODE\">2</Col><Col id=\"DS_CODE\">고용</Col></Row><Row><Col id=\"CD_CODE\">3</Col><Col id=\"DS_CODE\">사배책</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclDT_MAGAM","sta00:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Static("staTY_GUBUN",null,"58","34","25","710",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("구분");
            obj.set_textDecoration("none");
            obj.set_cssclass("zIndex");
            this.addChild(obj.name, obj);

            obj = new Radio("crdoTY_GUBUN","staTY_GUBUN:7","60","164","20",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new BindItem("item0","divSearch.form.ctclDT_MAGAM","value","dsSearch","DT_MAGAM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","crdoTY_GUBUN","value","dsSearch","TY_GUBUN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DSH_INSU_LIST.xfdl", function() {
        ...
        //마감취소 진행여부 확인
        this.fnMagamCancelYnCheck = function(obj, e) {
        ...
        //전표발행 진행여부 확인
        this.fnSlipYnCheck = function(obj, e) {
        ...
        //전표취소 진행여부 확인
        this.fnSlipCancelYnCheck = function(obj, e) {
        ...
        // 전표조회 버튼 클릭
        this.fnSlipShow = function(obj, e) {
        ...
        */
        ...
        this.crdoTY_GUBUN_onitemchanged = function(obj,e)
        {
        	   this.setBtnUsable();
        	   //this.FormBtns.Select.click();
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.crdoTY_GUBUN.addEventHandler("onitemchanged",this.crdoTY_GUBUN_onitemchanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DSH_INSU_LIST.xfdl");
