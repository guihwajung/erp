(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("ctclYY_BASE","120","51","90","25",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
        ...
        // User Script
        this.registerScript("DSB_SHINGODISK_DLG_M.xfdl", function() {
        ...
        this.loadIncludeScript("DSB_SHINGODISK_DLG_M.xfdl");
