(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSBPR_SLIP_BONSA</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DSBPR_SLIP_BONSA_SAVE</Col></Row><Row><Col id=\"TARGET\">exec1</Col><Col id=\"SP\">DSBPR_MAGAM_SLIP_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSB_SLIP_BONSA.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSB_SLIP_BONSA");
        	// 그리드 코드파인드 설정
        ...
        this.fnApprovalCancel_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		var DETAIL = "";
        ...
        this.fnSlipApproval = function(flag){
        	...
        	for(var i = 0; i < this.dsList.rowcount; i++){
        		...
        		var AM_GOYONG = this.gfnAppendComma(this.dsList.getColumn(i, "AM_GOYONG"));
        		...
        		if(flag == "UPDATE"){
        			...
        			DETAIL += "	  <TD class=td_r>" + AM_GOYONG + "</TD>";		// 고용보험
        		}else{
        			...
        			DETAIL += "	  <TD class=td_r>" + (AM_GOYONG == "0" ? "" : "-") + AM_GOYONG + "</TD>";		// 고용보험
        		}
        ...
        this.loadIncludeScript("DSB_SLIP_BONSA.xfdl");
