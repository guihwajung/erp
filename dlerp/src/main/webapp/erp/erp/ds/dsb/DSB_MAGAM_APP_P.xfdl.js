(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSBPR_MONMAGAM_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DSBPR_MONMAGAM_UPDATE</Col></Row><Row><Col id=\"TARGET\">magamcheck</Col><Col id=\"SP\">DSBPR_MAGAMCHECK_SELECT</Col></Row><Row><Col id=\"TARGET\">magam</Col><Col id=\"SP\">DSBPR_MONMAGAM</Col></Row><Row><Col id=\"TARGET\">magamcancel</Col><Col id=\"SP\">DSBPR_MONMAGAM_CANCEL</Col></Row><Row><Col id=\"TARGET\">issuemagam</Col><Col id=\"SP\">DSBPR_AUTOSLIP_ISSUE_MAGAM</Col></Row><Row><Col id=\"TARGET\">issuemagamcancel</Col><Col id=\"SP\">DSBPR_AUTOSLIP_ISSUE_MAGAM_CANCEL</Col></Row><Row><Col id=\"TARGET\">autosliplock</Col><Col id=\"SP\">DSBPR_AUTOSLIP_LOCK</Col></Row><Row><Col id=\"TARGET\">autoslipunlock</Col><Col id=\"SP\">DSBPR_AUTOSLIP_UNLOCK</Col></Row><Row><Col id=\"TARGET\">venok</Col><Col id=\"SP\">DSBPR_MONMAGAM_VEN</Col></Row><Row><Col id=\"TARGET\">vencancel</Col><Col id=\"SP\">DSBPR_MONMAGAM_VEN</Col></Row><Row><Col id=\"TARGET\">appok</Col><Col id=\"SP\">DSBPR_MONMAGAM_GW_APPROVAL</Col></Row><Row><Col id=\"TARGET\">appcancel</Col><Col id=\"SP\">DSBPR_MONMAGAM_GW_APPROVAL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSB_MAGAM_APP_P.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnFormButtonNr = this.gfnFormButtonAdd("BTN_MONMAGAM", "fnTbbMonthMagam");
        	this.btnFormButtonDe = this.gfnFormButtonAdd("BTN_MONMAGAM_CANCEL", "fnTbbMonthMagamCancel");
        	//this.btnFormButtonAe = this.gfnFormButtonAdd("tbbEmployee_Dlg", "fnTbbEmployee_Dlg", "제세보험료");
        	...
        	this.btnApp_Ok = this.gfnFormButtonAdd("btnApp_OK", "fnAppOk");
        	this.btnApp_Cancel = this.gfnFormButtonAdd("btnApp_Cancel", "fnAppCancel");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	//승인 및 승인취소
        	this.dsApp = new Dataset();
        	this.dsApp.addColumn("TY_WRK", "string");
        	this.dsApp.addColumn("CD_SITE", "string");
        	this.dsApp.addColumn("YM_WORK", "string");
        	this.dsApp.addColumn("TY_APPROVALGW", "string");
        	this.dsApp.addColumn("ID_USER", "string");
        	this.dsApp.addColumn("ID_DOC_GW", "string");
        	this.dsApp.addColumn("NO_DOC_GW", "string");
        	this.dsApp.addColumn("NO_ERPKEY", "string");
        }
        		...
        		if (errorCode == 0) {
        			...
        			if (this.magamflag == true){ // 현장마감
        				if (this.slipflag == true) { //전표발행
        					...
        					//this.btnFormButtonAe.set_enable(false);  //제세보험료
        // 					this.btnFormButtonOc.set_enable(false);  //전표발행
        // 					this.btnFormButtonPh.set_enable(true); //전표취소
        // 					this.btnFormButtonCe.set_enable(true); //전표조회
        				}
        				else {	//전표미발행
        					this.btnFormButtonNr.set_enable(false);  //현장마감
        					this.btnFormButtonDe.set_enable(true);  //현장마감해제
        					//this.btnFormButtonAe.set_enable(true);  //제세보험료
        // 					this.btnFormButtonOc.set_enable(true);  //전표발행
        // 					this.btnFormButtonPh.set_enable(false); //전표취소
        // 					this.btnFormButtonCe.set_enable(false); //전표조회
        				}
        			}
        			else { // 현장 미마감
        ...
        // 			}
        	...
        	}else if(svcID =="appcancel"){
        		if (errorCode == 0) {
        			this.FormBtns.Select.click();
        			this.gfnAlert("승인이 취소되었습니다.");
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        ...
        this.fnAppOk = function(){
        	...
        	this.dsApp.clearData();
        	this.dsApp.addRow();

        	this.dsApp.setColumn(0, "TY_WRK", "P");
        	this.dsApp.setColumn(0, "CD_SITE", this.ccfCD_SITE.form.CDTextBox.value);
        	this.dsApp.setColumn(0, "YM_WORK", this.ctclYM_WORK.form.TextBox.value);
        	this.dsApp.setColumn(0, "TY_APPROVALGW", "2");
        	this.dsApp.setColumn(0, "ID_USER", this.AuthClient.ID_USER);
        	this.dsApp.setColumn(0, "ID_DOC_GW", "0");
        	this.dsApp.setColumn(0, "NO_DOC_GW", "");
        	this.dsApp.setColumn(0, "NO_ERPKEY", this.dsList.getColumn(this.dsList.rowposition, "NO_ERPKEY"));

        	var strSvcId    = "appok";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "appok=dsApp";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnAppCancel = function(){
        	...
        	this.dsApp.setColumn(0, "CD_SITE", this.ccfCD_SITE.form.CDTextBox.value);
        	this.dsApp.setColumn(0, "YM_WORK", this.ctclYM_WORK.form.TextBox.value);
        	this.dsApp.setColumn(0, "TY_APPROVALGW", "0");
        	this.dsApp.setColumn(0, "ID_USER", this.AuthClient.ID_USER);
        	this.dsApp.setColumn(0, "ID_DOC_GW", "0");
        	this.dsApp.setColumn(0, "NO_DOC_GW", "");
        	this.dsApp.setColumn(0, "NO_ERPKEY", this.dsList.getColumn(this.dsList.rowposition, "NO_ERPKEY"));

        	var strSvcId    = "appcancel";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "appcancel=dsApp";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.loadIncludeScript("DSB_MAGAM_APP_P.xfdl");
