(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSBPR_ETCPAY_LIST</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DSBPR_ETCPAY_CHANGE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"CD_HADO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"YM_WORK\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_HADO","tclYM_WORK:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("작업반");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","divSearch.form.cfCD_HADO.form.CDTextBox","value","dsSearch","CD_HADO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.cfCD_HADO.form.DSTextBox","value","dsSearch","DS_HADO");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DSB_SETETCPAY.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSB_SETETCPAY");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("AM_ETCPAY", "string");
        }
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "U":
        				...
        				this.dsSave.setColumn(nrow, "CD_SITE", this.dsSelect.getColumn(0, "CD_SITE"));
        				this.dsSave.setColumn(nrow, "DT_WORK", this.dsList.getColumn(i, "YM_WORK"));
        				this.dsSave.setColumn(nrow, "NO_ID", this.dsList.getColumn(i, "NO_ID"));
        				this.dsSave.setColumn(nrow, "AM_ETCPAY", this.dsList.getColumn(i, "TT_ETCPAY"));
        				break;
        		}
        	}
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0,"CD_SITE"))) {
        		...
        		this.gfnAlert("출역년월 반드시 입력 하셔야 합니다.", "fnVaidateCallback");
        	}
        ...
        this.loadIncludeScript("DSB_SETETCPAY.xfdl");
