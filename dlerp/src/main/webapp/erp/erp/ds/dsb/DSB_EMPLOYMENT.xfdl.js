(function()
{
    return function()
    {
        ...
        {
            this.set_name("DSB_EMPLOYMENT");
            this.set_titletext("특수형태 근로종사자");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSBPR_EMPLOYMENT_SELECT</Col></Row><Row><Col id=\"TARGET\">selHolyday</Col><Col id=\"SP\">DSBPR_HOLIDAY_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DSBPR_EMPLOYMENT_SAVE</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DSBPR_EMPLOYMENT_CREATE</Col></Row><Row><Col id=\"TARGET\">selMagam</Col><Col id=\"SP\">DSBPR_MAGAMCHECK_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CORP\"/><Col id=\"CD_SITE\"/><Col id=\"YM_WORK\"/></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSB_EMPLOYMENT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSB_EMPLOYMENT");
        }
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("NO_SABUN", "string");
        	this.dsSave.addColumn("CD_VENDOR", "string");
        	this.dsSave.addColumn("NO_SJC", "string");
        	this.dsSave.addColumn("NO_TEL", "string");
        	this.dsSave.addColumn("DS_ADDR", "string");
        	this.dsSave.addColumn("CD_EMPLOYMENT", "string");
        	this.dsSave.addColumn("DS_EMPLOYMENT", "string");
        	this.dsSave.addColumn("CT_WORK01", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK02", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK03", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK04", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK05", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK06", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK07", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK08", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK09", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK10", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK11", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK12", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK13", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK14", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK15", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK16", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK17", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK18", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK19", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK20", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK21", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK22", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK23", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK24", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK25", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK26", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK27", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK28", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK29", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK30", "bigdecimal");
        	this.dsSave.addColumn("CT_WORK31", "bigdecimal");
        	this.dsSave.addColumn("AM_IMGUM", "bigdecimal");
        	this.dsSave.addColumn("AM_GOYONGDAY", "bigdecimal");
        	this.dsSave.addColumn("AM_GOYONGPER", "bigdecimal");
        	this.dsSave.addColumn("AM_GOYONGCORP", "bigdecimal");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "CD_SITE", this.gfnNvl(this.dsList.getColumn(i, "CD_SITE"),""));
        				this.dsSave.setColumn(nrow, "YM_WORK", this.gfnNvl(this.dsList.getColumn(i, "YM_WORK"),""));
        				this.dsSave.setColumn(nrow, "NO_ID", this.gfnNvl(this.dsList.getColumn(i, "NO_ID"),""));
        				this.dsSave.setColumn(nrow, "DS_HNAME", this.gfnNvl(this.dsList.getColumn(i, "DS_HNAME"),""));
        				this.dsSave.setColumn(nrow, "NO_SABUN", this.gfnNvl(this.dsList.getColumn(i, "NO_SABUN"),""));
        				this.dsSave.setColumn(nrow, "CD_VENDOR", this.gfnNvl(this.dsList.getColumn(i, "CD_VENDOR"),""));
        				this.dsSave.setColumn(nrow, "NO_SJC", this.gfnNvl(this.dsList.getColumn(i, "NO_SJC"),""));
        				this.dsSave.setColumn(nrow, "NO_TEL", this.gfnNvl(this.dsList.getColumn(i, "NO_TEL"),""));
        				this.dsSave.setColumn(nrow, "DS_ADDR", this.gfnNvl(this.dsList.getColumn(i, "DS_ADDR"),""));
        				this.dsSave.setColumn(nrow, "CD_EMPLOYMENT", this.gfnNvl(this.dsList.getColumn(i, "CD_EMPLOYMENT"),""));
        				this.dsSave.setColumn(nrow, "DS_EMPLOYMENT", this.gfnNvl(this.dsList.getColumn(i, "DS_EMPLOYMENT"),""));
        				this.dsSave.setColumn(nrow, "CT_WORK01", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK01"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK02", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK02"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK03", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK03"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK04", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK04"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK05", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK05"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK06", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK06"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK07", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK07"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK08", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK08"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK09", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK09"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK10", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK10"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK11", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK11"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK12", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK12"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK13", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK13"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK14", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK14"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK15", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK15"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK16", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK16"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK17", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK17"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK18", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK18"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK19", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK19"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK20", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK20"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK21", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK21"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK22", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK22"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK23", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK23"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK24", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK24"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK25", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK25"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK26", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK26"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK27", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK27"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK28", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK28"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK29", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK29"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK30", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK30"),0));
        				this.dsSave.setColumn(nrow, "CT_WORK31", this.gfnNvl(this.dsList.getColumn(i, "CT_WORK31"),0));
        				this.dsSave.setColumn(nrow, "AM_IMGUM", this.gfnNvl(this.dsList.getColumn(i, "AM_IMGUM"),0));
        				this.dsSave.setColumn(nrow, "AM_GOYONGDAY", this.gfnNvl(this.dsList.getColumn(i, "AM_GOYONGDAY"),0));
        				this.dsSave.setColumn(nrow, "AM_GOYONGPER", this.gfnNvl(this.dsList.getColumn(i, "AM_GOYONGPER"),0));
        				this.dsSave.setColumn(nrow, "AM_GOYONGCORP", this.gfnNvl(this.dsList.getColumn(i, "AM_GOYONGCORP"),0));
        				this.dsSave.setColumn(nrow, "AM_GOYONG", this.gfnNvl(this.dsList.getColumn(i, "AM_GOYONG"),0));
        ...
        this.fnCreate = function(){
        	...
        	this.gfnConfirm("기존에 작업내역이 사라집니다. 그래도 진행하시겠습니까?", "fnCreateProc");
        }

        this.fnCreateProc = function(id, val){
        	//trace(id, val);
        	...
        	if(val){
        		...
        		this.dsCreate.setColumn(nrow, "CD_CORP", this.gfnNvl(this.dsSearch.getColumn(0, "CD_CORP"),""));
        		this.dsCreate.setColumn(nrow, "CD_SITE", this.gfnNvl(this.dsSearch.getColumn(0, "CD_SITE"),""));
        		this.dsCreate.setColumn(nrow, "YM_WORK", this.gfnNvl(this.dsSearch.getColumn(0, "YM_WORK"),""));
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg){
        	...
        	if (svcID == "select") {
        		...
        		if (errorCode == 0) {
        			this.fnCreateAfter = function() {
        				this.FormBtns.Select.click();
        			}
        			this.gfnAlert("자료생성이 완료되었습니다", "fnCreateAfter");
        		} else {
        ...
        this.fnGrid_AfterEdit = function(obj,e) {
        	if(e.columnid == "CD_CORP" || e.columnid == "CD_SITE" ) {
        		if(e.oldvalue != e.newvalue) {
        			this.dsList.setColumn(this.dsList.rowposition, "NO_SABUN" ,""); //노무번호
        			this.dsList.setColumn(this.dsList.rowposition, "DS_HNAME" ,""); //성명
        			this.dsList.setColumn(this.dsList.rowposition, "NO_ID" ,""); //주민번호
        			this.dsList.setColumn(this.dsList.rowposition, "CD_VENDOR" ,""); //거래처코드
        			this.dsList.setColumn(this.dsList.rowposition, "NO_SJC" ,""); //사업자등록번호
        		}
        	}
        }
        ...
        this.loadIncludeScript("DSB_EMPLOYMENT.xfdl");
