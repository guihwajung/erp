(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSBPR_AUTOSLIP_ISSUE_MAGAM_SELECT</Col></Row><Row><Col id=\"TARGET\">issuemagamcancel</Col><Col id=\"SP\">DSBPR_AUTOSLIP_ISSUE_MAGAM_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSB_MAGAMSLIP_CANCEL_DLG.xfdl", function() {
        ...
        this.loadIncludeScript("DSB_MAGAMSLIP_CANCEL_DLG.xfdl");
