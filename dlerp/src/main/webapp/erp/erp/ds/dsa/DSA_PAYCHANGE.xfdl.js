(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("임금변동관리");
            if (Form == this.constructor)
            {
                this._setFormPosition(870,720);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSAPR_PAYCHANGE_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DSAPR_PAYCHANGE_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DSAPR_PAYCHANGE_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DSAPR_PAYCHANGE_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_ID\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"NO_ID\"/><Col id=\"NO_SABUN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta02_DSX_CFCORP","ccfNO_ID:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtNO_ID","sta02_DSX_CFCORP:0.0","10.0","35","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("DSA_PAYCHANGE.xfdl", function() {
        ...
        this.loadIncludeScript("DSA_PAYCHANGE.xfdl");
