(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSAPR_NAMELIST_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_CODE_LIST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_JIKJONG\" type=\"STRING\" size=\"256\"/><Column id=\"TY_JAEJIK\" type=\"STRING\" size=\"256\"/><Column id=\"TY_WOIGUG\" type=\"STRING\" size=\"256\"/><Column id=\"NO_ID\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_JAEJIK", this);
            ...
            obj = new Dataset("dsTY_JAEJIK_back", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">0</Col><Col id=\"VALUE\">재직</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"VALUE\">퇴직</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"VALUE\">전체</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_WOIGUBUN", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\"/><Col id=\"VALUE\">전체</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"VALUE\">일반</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"VALUE\">특례</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_WOIGUG_back", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">0</Col><Col id=\"DS_CODE\">전체</Col></Row><Row><Col id=\"CD_CODE\">1</Col><Col id=\"DS_CODE\">내국인</Col></Row><Row><Col id=\"CD_CODE\">2</Col><Col id=\"DS_CODE\">외국인</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_DEPT","ccfCD_CORP:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("현장코드");
            ...
            obj = new Static("staDS_NAME","ccfCD_SITE:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("성명");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Static("staTY_CHAIYONG","0.0","staCD_CORP:10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("채용구분");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Static("staTY_TOIJIK","staTY_CHAIYONG:0.0","staCD_CORP:10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("재직구분");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("cboTY_JAEJIK","staTY_TOIJIK:0.0","staCD_CORP:10.0","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_innerdataset("dsTY_JAEJIK");
            ...
            obj = new Combo("cboTY_WOIGUG","cboTY_JAEJIK:0.0","staCD_CORP:10.0","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Static("staTY_WOIGUG","cboTY_WOIGUG:0.0","staCD_CORP:10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("외국인여부");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("cboTY_CHAIYONG","staTY_CHAIYONG:0.0","staCD_CORP:10.0","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            ...
            obj = new Static("staYN_JUMIN","cboTY_CHAIYONG:0.0","staCD_CORP:10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("개인정보보호여부");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new CheckBox("chkYN_JUMIN","staYN_JUMIN:0.0","staCD_CORP:10.0","30","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfNO_ID","staDS_NAME:0.0","10.0","180","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new BindItem("item2","divSearch.form.cboTY_JAEJIK","value","dsSearch","TY_JAEJIK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.cboTY_WOIGUG","value","dsSearch","TY_WOIGUG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSearch.form.ccfNO_ID.form.CDTextBox","value","dsSearch","NO_SABUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch.form.ccfNO_ID.form.DSTextBox","value","dsSearch","DS_NAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divSearch.form.edtNO_ID","value","dsSearch","NO_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DSA_NAMELIST.xfdl", function() {
        ...
        this.divSearch_cboTY_JAEJIK_onitemchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.cboTY_JAEJIK.addEventHandler("onitemchanged",this.divSearch_cboTY_JAEJIK_onitemchanged,this);
            this.divSearch.form.cboTY_CHAIYONG.addEventHandler("onitemchanged",this.divSearch_cboTY_JAEJIK_onitemchanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DSA_NAMELIST.xfdl");
