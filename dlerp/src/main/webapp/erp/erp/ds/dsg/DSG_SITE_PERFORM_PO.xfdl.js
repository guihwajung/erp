(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("현장별 이행현황(PO기준)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSGPR_SITE_PERFORM_PO</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSG_SITE_PERFORM_PO.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSG_SITE_PERFORM_PO");
        };
        ...
        this.loadIncludeScript("DSG_SITE_PERFORM_PO.xfdl");
