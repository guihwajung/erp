(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("퇴직공제 누락자 현황");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSGPR_TOIJIK_OMISSION</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_END","ctclDT_START:0.0","10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("~");
            obj.set_textAlign("center");
            ...
            obj = new Div("ctclDT_END","staDT_END:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSG_TOIJIK_OMISSION.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSG_TOIJIK_OMISSION");
        };
        ...
        this.loadIncludeScript("DSG_TOIJIK_OMISSION.xfdl");
