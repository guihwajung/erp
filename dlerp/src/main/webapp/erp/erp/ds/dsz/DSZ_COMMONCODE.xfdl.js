(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"YN_DELETE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_PREFIX\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSZPR_COMMONLIST_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DSZPR_COMMONCODE_SELECT</Col></Row><Row><Col id=\"TARGET\">d_insert</Col><Col id=\"SP\">DSZPR_COMMONCODE_SAVE</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DSZPR_COMMONCODE_SAVE</Col></Row><Row><Col id=\"TARGET\">d_delete</Col><Col id=\"SP\">DSZPR_COMMONCODE_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsTY_USE_YN", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_CODE\">전체</Col><Col id=\"CD_CODE\">%</Col></Row><Row><Col id=\"DS_CODE\">사용</Col><Col id=\"CD_CODE\">N</Col></Row><Row><Col id=\"DS_CODE\">미사용</Col><Col id=\"CD_CODE\">Y</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc00", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZZPR_ROLECODEMASTER_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DZZPR_ROLECODEMASTER_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DZZPR_ROLECODEMASTER_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DZZPR_ROLECODEMASTER_DELETE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DZZPR_ROLECODEDETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">d_insert</Col><Col id=\"SP\">DZZPR_ROLECODEDETAIL_INSERT</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DZZPR_ROLECODEDETAIL_UPDATE</Col></Row><Row><Col id=\"TARGET\">d_delete</Col><Col id=\"SP\">DZZPR_ROLECODEDETAIL_DELETE</Col></Row><Row><Col id=\"TARGET\">radio</Col><Col id=\"SP\">DZXPR_COMBO_COMMON_SAVE_01</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cboTY_USE_YN","sta00:0.0","10.0","129","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_innerdataset("dsTY_USE_YN");
        ...
        // User Script
        this.registerScript("DSZ_COMMONCODE.xfdl", function() {
        ...
        this.loadIncludeScript("DSZ_COMMONCODE.xfdl");
