(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBTPR_COMMON_KINDSTATE_DETAIL_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"DS_SITE\"/><Col id=\"DT_FROM\"/><Col id=\"DT_TO\"/></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBT_COMMON_KINDSTATEDETAIL.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0, "CD_SITE", this.getOwnerFrame().KEY_CD_SITE);
        	this.dsSearch.setColumn(0, "DS_SITE", this.getOwnerFrame().KEY_DS_SITE);
        	this.dsSearch.setColumn(0, "DT_FROM", this.getOwnerFrame().KEY_DT_FRJOEBSU);
        	this.dsSearch.setColumn(0, "DT_TO"  , this.getOwnerFrame().KEY_DT_TOJOEBSU);
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBT_COMMON_KINDSTATEDETAIL");
        ...
        this.fnSelectValidate = function() {
        	...
        	if(this.gfnIsNull(this.dsSearch.getColumn(0, "CD_SITE"))) {
        		this.gfnAlert("현장코드는 필수입니다.", function() {
        ...
        this.loadIncludeScript("DBT_COMMON_KINDSTATEDETAIL.xfdl");
