(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("권역별 하자 미처리현황(3년이상)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBTPR_REPORT_AFTER_SELECT</Col></Row><Row><Col id=\"TARGET\">selectHeader</Col><Col id=\"SP\">DBTPR_REPORT_AFTER_SELECT_HEADER</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBT_REPORT_AFTER.xfdl", function() {
        ...
        this.loadIncludeScript("DBT_REPORT_AFTER.xfdl");
