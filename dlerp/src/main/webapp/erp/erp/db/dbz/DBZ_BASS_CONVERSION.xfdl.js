(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBZPR_BASS_CONVERSION_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DBZPR_BASS_CONVERSION_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DBZPR_BASS_CONVERSION_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DBZPR_BASS_CONVERSION_DELETE</Col></Row><Row><Col id=\"SP\">DBZPR_BASS_CONVERSION_CREATE</Col><Col id=\"TARGET\">execTrsf</Col></Row><Row><Col id=\"TARGET\">execInit</Col><Col id=\"SP\">DBZPR_CONVERSION_CONVERSION_INIT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo1</Col><Col id=\"SP\">DBXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">comboCtm</Col><Col id=\"SP\">DBXPR_SITECTM_CODEFIND</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VALIDATE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"CD_VALIDATE\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCD_VALIDATE", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">%</Col><Col id=\"DS_CODE\">전체</Col></Row><Row><Col id=\"CD_CODE\">N</Col><Col id=\"DS_CODE\">미검증</Col></Row><Row><Col id=\"DS_CODE\">검증완료</Col><Col id=\"CD_CODE\">Y</Col></Row><Row><Col id=\"CD_CODE\">E</Col><Col id=\"DS_CODE\">검증오류</Col></Row><Row><Col id=\"CD_CODE\">R</Col><Col id=\"DS_CODE\">필수입력누락</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsCD_PART", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCD_SUBPART", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCD_CTM", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsCD_UI", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_JUBSU", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_UMGB01","ccfCD_SITE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("검증구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboCD_VALIDATE","staTY_UMGB01:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Static("staCD_CORP","ccboCD_VALIDATE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("현장코드");
            ...
            obj = new Grid("objGrid","0","55",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj._setContents("");
            ...
            obj = new Combo("cboTY_UMGB","0","26","50","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btnTY_UMGB","cboTY_UMGB:3","26","80","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("관리단계적용");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnTY_JUBSU","233","26","80","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_text("접수구분");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("cboCD_SIL","btnTY_JUBSU:5","26","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            ...
            obj = new Button("btnCD_SIL","cboCD_SIL:3","26","50","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_text("실적용");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("cboCD_PART","btnCD_SIL:5","26","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_innerdataset("dsCD_PART");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            obj.set_type("filterlike");
            obj.set_text("전체");
            ...
            obj = new Button("btnCD_PART","cboCD_PART:3","26","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("부위적용");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("cboCD_SUBPART","btnCD_PART:5","26","130","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_innerdataset("dsCD_SUBPART");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            obj.set_type("filterlike");
            obj.set_text("전체");
            ...
            obj = new Button("btnCD_SUBPART","cboCD_SUBPART:3","26","80","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            obj.set_text("상세부위적용");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("cboCD_CTM","btnCD_SUBPART:5","26","130","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            obj.set_innerdataset("dsCD_CTM");
            obj.set_datacolumn("DS_CTM");
            obj.set_codecolumn("CD_CTM");
            obj.set_type("filterlike");
            obj.set_text("전체");
            obj.set_value("");
            obj.set_index("0");
            ...
            obj = new Button("btnCD_CTM","cboCD_CTM:3","26","80","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_text("협력업체적용");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("cboCD_ACT","btnCD_CTM:5","26","250","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            ...
            obj = new Button("btnCD_ACT","cboCD_ACT:3","26","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_text("공종적용");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("cboTY_JUBSU","btnTY_UMGB:5","26","90","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_innerdataset("dsTY_JUBSU");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            obj.set_type("filterlike");
            obj.set_text("전체");
            ...
            obj = new BindItem("item1","divSearch.form.ccboCD_VALIDATE","value","dsSearch","CD_VALIDATE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item2","divData.form.cboTY_UMGB","value","dsCombo","TY_UMGB");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divData.form.cboCD_SIL","value","dsCombo","CD_SIL");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divData.form.cboCD_PART","value","dsCombo","CD_PART");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divData.form.cboCD_SUBPART","value","dsCombo","CD_SUBPART");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.cboCD_CTM","value","dsCombo","CD_CTM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divData.form.cboCD_ACT","value","dsCombo","CD_ACT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divData.form.cboTY_JUBSU","value","dsCombo","TY_JUBSU");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DBZ_BASS_CONVERSION.xfdl", function() {
        ...
        this.fnExcelSelect = function(obj,e) {
        ...
        this.fnInit_callback = function(strId, val)
        {
         ...
         this.fnVendorCreate = function(obj,e) {
        	// 선택된 row가 있을 경우에만 팝업을 띄움
        	//if (!this.gfnGridIsRow(this.dxGrid)) { return false; }
        	if (this.gfnIsNull(this.dsSearch.getColumn(0,"CD_SITE"))) {
        		this.fnVaidateCallback = function() {
        ...
        // 관리단계적용
        this.divData_btnTY_UMGB_onclick = function(obj,e)
        {
        	for(var i = 0; i < this.dsList.rowcount; i++) {
        ...
        // 접수구분적용
        this.divData_btnTY_JUBSU_onclick = function(obj,e)
        {
        	for(var i = 0; i < this.dsList.rowcount; i++) {
        		var selected = this.dxGrid.isSelectedCell(this.dxGrid.currentcol,'body',i);
        ...
        // 실적용
        this.divData_btnCD_SIL_onclick = function(obj,e)
        {
        	for(var i = 0; i < this.dsList.rowcount; i++) {
        		var selected = this.dxGrid.isSelectedCell(this.dxGrid.currentcol,'body',i);
        ...
        // 부위적용
        this.divData_btnCD_PART_onclick = function(obj,e)
        {
        	for(var i = 0; i < this.dsList.rowcount; i++) {
        		var selected = this.dxGrid.isSelectedCell(this.dxGrid.currentcol,'body',i);
        ...
        // 상세부위적용
        this.divData_btnCD_SUBPART_onclick = function(obj,e)
        {
        	for(var i = 0; i < this.dsList.rowcount; i++) {
        		var selected = this.dxGrid.isSelectedCell(this.dxGrid.currentcol,'body',i);
        ...
        // 협력업체적용
        this.divData_btnCD_CTM_onclick = function(obj,e)
        {
        	for(var i = 0; i < this.dsList.rowcount; i++) {
        		var selected = this.dxGrid.isSelectedCell(this.dxGrid.currentcol,'body',i);
        ...
        // 공종적용
        this.divData_btnCD_ACT_onclick = function(obj,e)
        {
        	for(var i = 0; i < this.dsList.rowcount; i++) {
        		var selected = this.dxGrid.isSelectedCell(this.dxGrid.currentcol,'body',i);
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.btnTY_UMGB.addEventHandler("onclick",this.divData_btnTY_UMGB_onclick,this);
            this.divData.form.btnTY_JUBSU.addEventHandler("onclick",this.divData_btnTY_JUBSU_onclick,this);
            this.divData.form.btnCD_SIL.addEventHandler("onclick",this.divData_btnCD_SIL_onclick,this);
            this.divData.form.btnCD_PART.addEventHandler("onclick",this.divData_btnCD_PART_onclick,this);
            this.divData.form.btnCD_SUBPART.addEventHandler("onclick",this.divData_btnCD_SUBPART_onclick,this);
            this.divData.form.btnCD_CTM.addEventHandler("onclick",this.divData_btnCD_CTM_onclick,this);
            this.divData.form.btnCD_ACT.addEventHandler("onclick",this.divData_btnCD_ACT_onclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DBZ_BASS_CONVERSION.xfdl");
