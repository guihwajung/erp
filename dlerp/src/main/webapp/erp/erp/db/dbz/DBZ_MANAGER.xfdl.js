(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBZPR_MANAGER_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DBZPR_MANAGER_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DBZPR_MANAGER_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DBZPR_MANAGER_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBZ_MANAGER.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBZ_MANAGER");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("ID_MANAGER", "string");
        	...
        	this.dsDelete.addColumn("ID_MANAGER", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "ID_MANAGER", this.dsList.getColumn(i, "ID_MANAGER"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "ID_MANAGER", this.dsList.getColumn(i, "ID_MANAGER"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "ID_MANAGER", this.dsList.getColumn(i, "ID_MANAGER"));
        ...
        this.fnAdd = function() {
        	...
        	this.dsList.setColumn(nrow, "YN_LOGINDENY", "N");
        ...
        this.loadIncludeScript("DBZ_MANAGER.xfdl");
