(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("일보 작성 현황 조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_DAYWORK_STATE_SELECT</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DBSPR_DAYWORK_REPORT_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBS_DAYWORK_PRINT.xfdl", function() {
        ...
        this.loadIncludeScript("DBS_DAYWORK_PRINT.xfdl");
