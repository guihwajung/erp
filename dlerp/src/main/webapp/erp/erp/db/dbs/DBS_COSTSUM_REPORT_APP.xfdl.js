(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("objGrid","0","divDataMaster:10",null,"140","0",null,null,null,null,null,this.divData1.form);
            obj.set_taborder("3");
            obj._setContents("");
            this.divData1.addChild(obj.name, obj);

            obj = new Static("sta00","0","objGrid:10",null,"22","0",null,null,null,null,null,this.divData1.form);
            obj.set_taborder("4");
            obj.set_text("변경상세내역");
        ...
        // User Script
        this.registerScript("DBS_COSTSUM_REPORT_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DB01";
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	// 기본 버튼(입력,저장 등..) 숨김처리
        	this.objApp.getActiveForm().divTopBtn.form.fnSetVisibleButton(false);

        	this.dsSearch.setColumn(0, "V1", this.gfnNvl(this.getOwnerFrame().V1));
        	this.dsSearch.setColumn(0, "V2", this.gfnNvl(this.getOwnerFrame().V2));
        	this.dsSearch.setColumn(0, "V3", this.gfnNvl(this.getOwnerFrame().V3));
        	this.dsSearch.setColumn(0, "V4", this.gfnNvl(this.getOwnerFrame().V4));
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "YM_WORK", this.dsSearch.getColumn(0, "V1"));
        	this.dsSelect.setColumn(0, "AUTH_CD_CORP", this.dsSearch.getColumn(0, "V2"));
        ...
        **************************************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg) {
        	if (svcID == "init") {
        		...
        		if (this.dsListMaster.rowcount > 0) {
        			...
        			this.btn10.set_visible(this.dsListMaster.getColumn(0, "BTNLINES") != "H");  //210504 추가
        			...
        			this.btn10.set_enable(this.dsListMaster.getColumn(0, "BTNLINES") == "Y");   //210504 추가
        ...
        // 하단 그리드 현장명 클릭시 팝업화면 호출
        this.fnPopUp = function(obj,e) {
        	// 선택된 row가 있을 경우에만 팝업을 띄움
        	//if (!this.gfnGridIsRow(this.dxGrid)) { return false; }

        	var param = {};

        	//param.CD_SITE = this.dsSearch.getColumn(0, "V3");
        	param.CD_SITE = this.dsList1.getColumn(this.dsList1.rowposition, "CD_SITE");
            param.YM_WORK = this.dsSearch.getColumn(0, "V1");

        	// 화면 오픈.
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DBS_COSTSUM_REPORT_POPUP", "fnPopUpCallback", param);
        }
        ...
        this.loadIncludeScript("DBS_COSTSUM_REPORT_APP.xfdl");
