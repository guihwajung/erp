(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_MONTH_COST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBS_MONTH_COST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBS_MONTH_COST");
        ...
        this.fnSelect = function() {
        	...
        	//this.dsSelect.setColumn(0, "AUTH_CD_CORP", this.dsSearch.getColumn(0, "AUTH_CD_CORP"));
        ...
        this.fnSelectValidate = function() {
        	...
        	if (validate && this.gfnIsNull(this.calYM_WORK.form.TextBox.value)) {
        		...
        		this.gfnAlert("작업년월을 입력하셔야 합니다.", "fnYmWorkVaidateCallback"); // gfnAlert = function (sMsgId, arrArg, sPopId, sCallback)
        	}
        	return validate;
        };
        /*
        ...
        this.loadIncludeScript("DBS_MONTH_COST.xfdl");
