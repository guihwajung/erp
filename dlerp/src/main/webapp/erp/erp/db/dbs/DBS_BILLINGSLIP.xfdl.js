(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_BILLINGSLIP_SELECT</Col></Row><Row><Col id=\"SP\">DBSPR_BILLINGSLIP_SAVE</Col><Col id=\"TARGET\">save</Col></Row><Row><Col id=\"SP\">DBSPR_BILLING_AUTOSLIP_ISSUE</Col><Col id=\"TARGET\">slip</Col></Row><Row><Col id=\"SP\">DBSPR_BILLINGSLIP_AUTOSLIP_DELETE</Col><Col id=\"TARGET\">slipDelete</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staItem04","0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("대금대장번호");
            ...
            obj = new Edit("edtNO_BILLING","staItem04:0.0","10.0","150","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_readonly("true");
            obj.set_textAlign("left");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staItem06","0.0","staItem04:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("증빙일자");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textDecoration("none");
            ...
            obj = new Static("staBar06","staItem06:0.0","staItem04:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablebg");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("calDT_TAX","staItem06:0.0","staItem04:10.0","150","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new Static("staItem07","staBar06:0.0","staItem04:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staBar07","staItem07:0.0","staItem04:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            this.divSearch.addChild(obj.name, obj);

            obj = new MaskEdit("metAM_GISUNG_PROV","staItem07:0.0","staItem04:10.0","150","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_value("");
            obj.set_format("###,###,##,##0");
            ...
            obj = new Static("staItem08","staBar07:0.0","staItem04:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            ...
            obj = new Static("staBar08","staItem08:0.0","staItem04:10.0",null,"24.0","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_tablebg");
            this.divSearch.addChild(obj.name, obj);

            obj = new MaskEdit("metAM_GISUNG_VAT","staItem08:0.0","staItem04:10.0","150","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_value("");
            obj.set_format("###,###,##,##0");
            obj.set_limitbymask("integer");
            ...
            obj = new Static("staItem09","staBar04:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("업체코드");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textDecoration("none");
            ...
            obj = new Static("staBar09","staItem09:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_tablebg");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtCD_VENDOR","staItem09:0.0","10.0","150","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_readonly("true");
            obj.set_textAlign("left");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staItem10","staBar09:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            obj.set_text("업체명");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textDecoration("none");
            ...
            obj = new Static("staBar10","staItem10:0.0","10.0",null,"24.0","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtDS_VENDOR","staItem10:0.0","10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("17");
            obj.set_readonly("true");
            obj.set_textAlign("left");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divSearch.form.calDT_TAX","value","dsSearch","DT_WORK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DBS_BILLINGSLIP.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	// 파라미터로 넘어온 값 셋팅
        	this.edtNO_BILLING.set_value(this.getOwnerFrame().NO_BILLING);
        	this.edtCD_VENDOR.set_value(this.getOwnerFrame().CD_VENDOR);
        	this.edtDS_VENDOR.set_value(this.getOwnerFrame().DS_VENDOR);
        	this.calDT_TAX.set_value(this.getOwnerFrame().DT_TAX);
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBS_BILLINGSLIP");  // pForm.gfnGridInit = function(objGrid, objDs, cd_system, id_grid, tree_column, level_column, is_manual)
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("NO_BILLING", "string");
        	...
        	this.dsSlip.addColumn("NO_BILLING", "string");
        	this.dsSlip.addColumn("TY_BILLING", "string");
        	this.dsSlip.addColumn("ID_USER", "string");
        	this.dsSlip.addColumn("CD_DEPT", "string");
        }
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_BILLING", this.gfnNvl(this.getOwnerFrame().NO_BILLING,""));
        	this.dsSelect.setColumn(0, "CD_DEPT", this.gfnNvl(this.AuthClient.CD_DEPT,""));
        	this.dsSelect.setColumn(0, "ID_USER", this.gfnNvl(this.AuthClient.ID_USER,""));
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "NO_BILLING", this.gfnNvl(this.getOwnerFrame().NO_BILLING,""));
        ...
        this.fnGrid_AfterCDTextChanged = function(id, codeFindData) {
        	...
        	switch(id) {
        		case "DHX_CFEBILLBUY_ESERO":	//전자세금계산서번호
        			if (arrData.length > 0) {
        				// 기성청구일, 발행일자 비교
        				if( arrData[0]["ISSUE_DATE"] != this.calDT_TAX.value ){
        					//validate = false;
        					var strDate1 = this.calDT_TAX.value;
        					var strDate2 = arrData[0]["ISSUE_DATE"];
        					strMsg = "* 증빙일자 : "+strDate1.substr(0,4)+"-"+strDate1.substr(4,2)+"-"+strDate1.substr(6,2)+" , 전표발행 발행일자 : " + +strDate2.substr(0,4)+"-"+strDate2.substr(4,2)+"-"+strDate2.substr(6,2);
        				}
        		...
        		case "DHX_COMMON_CODEFIND_SELECT" :
        			if (arrData.length > 0) {
        				if( this.gfnNvl(this.dsList.getColumn(rowPos, "TY_ISSUE"),"") != "E"){
        ...
        this.fnSlipIssue = function(svcID, value){
        	...
        	if(value) {
        		...
        		this.dsSlip.addRow();
        		this.dsSlip.setColumn(0, "NO_BILLING", this.gfnNvl(this.getOwnerFrame().NO_BILLING,""));
        		this.dsSlip.setColumn(0, "TY_BILLING", "");
        		this.dsSlip.setColumn(0, "ID_USER", this.AuthClient.ID_USER);
        		this.dsSlip.setColumn(0, "CD_DEPT", this.gfnNvl(this.AuthClient.CD_DEPT,""));
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("DBS_BILLINGSLIP.xfdl");
