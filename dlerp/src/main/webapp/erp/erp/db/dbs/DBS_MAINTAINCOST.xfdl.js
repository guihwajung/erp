(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_MAINTAIN_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DBSPR_MAINTAIN_SAVE</Col></Row><Row><Col id=\"SP\">DBSPR_MAINTAIN_AUTOSLIP_ISSUE</Col><Col id=\"TARGET\">slip</Col></Row><Row><Col id=\"TARGET\">slipDelete</Col><Col id=\"SP\">DBSPR_MAINTAIN_AUTOSLIP_DELETE</Col></Row><Row><Col id=\"TARGET\">approve</Col><Col id=\"SP\">DBSPR_MAINTAIN_APPROVE</Col></Row><Row><Col id=\"TARGET\">consult</Col><Col id=\"SP\">DBSPR_MAINTAIN_CONSULTDTL_SAVE</Col></Row><Row><Col id=\"TARGET\">approveCancel</Col><Col id=\"SP\">DBSPR_MAINTAIN_APPROVE_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP","calYM_WORK:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("법인");
            ...
            obj = new Static("staCD_SITE","ccfCD_CORP:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("AS사무소");
            obj.set_visible("false");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Static("staCD_SITE00","ccfCD_DEPT_BE:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text(" 원안품의");
            obj.set_visible("false");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Static("staCD_CORP00","ccfNO_CONSULTDTL:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("결재상태 :");
            obj.set_visible("false");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Edit("edt00","staCD_CORP00:0.0","10.0","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            ...
            obj = new BindItem("item4","divSearch.form.edt00","value","dsList1","DS_CODE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DBS_MAINTAINCOST.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnElecApp = this.gfnFormButtonAdd("btnElecApp", "fnElecApp");	//전자결재상신
        	this.btnElecAppS = this.gfnFormButtonAdd("btnElecAppS", "fnElecAppS");	//전자결재문서조회

        	this.btnFormButton4 = this.gfnFormButtonAdd("WorkBtn4", "fnWorkBtn4");  // 본사승인
        	this.btnFormButton6 = this.gfnFormButtonAdd("WorkBtn6", "fnWorkBtn6");  // 본사승인취소
        	this.btnFormButton1 = this.gfnFormButtonAdd("WorkBtn1", "fnWorkBtn1");  // 전표발행
        	this.btnFormButton2 = this.gfnFormButtonAdd("WorkBtn2", "fnWorkBtn2");  // 전표취소
        	this.btnFormButton3 = this.gfnFormButtonAdd("WorkBtn3", "fnWorkBtn3");  // 전표조회
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBS_MAINTAINCOST");  // pForm.gfnGridInit = function(objGrid, objDs, cd_system, id_grid, tree_column, level_column, is_manual)
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				this.dsSave.setColumn(nrow, "CD_CORP", "");
        ...
        this.fnGrid_BeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	if (id == "DFX_CFACCOUNTMATCH") { //자금청구
        		if( this.gfnIsNull(this.dsList.getColumn(this.dsList.rowposition,"CD_SITE")) ){
        			this.dxGrid.setCellPos(this.dxGrid.getBindCellIndex("body", "CD_SITE"));
        			this.gfnAlert("단지코드를 선택하세요.");
        			return false;
        		}
        		dsUserParam.setColumn(nrow, "TY_VENDOR", this.dsList.getColumn(this.dsList.rowposition,"TY_VENDOR_MI"));
        		dsUserParam.setColumn(nrow, "CD_PAY", this.dsList.getColumn(this.dsList.rowposition,"CD_VENDOR_MI"));
        ...
        // 셀 수정가능 여부
         this.fnGrid_EnterCell = function(obj, row, cell) {
        	...
        	// DS_ETC2 = N 일때 수정불가
        	 if(this.dsList1.getColumn(0, "DS_ETC2") == "N"){
        		return false;
        	 }
        }
        /************************************************************************
        ...
        this.fnWorkBtn1 = function(obj,e) {
        	if(!this.gfnGridIsRow(this.dxGrid)) return;
        // 	if(this.dsList1.getColumn(0, "DS_CODE") != "결재완료") {
        // 		this.gfnAlert( "결재완료된 건만 전표발행이 가능합니다.");
        // 		return;
        // 	}
        ...
        // 		this.dsSlip.setColumn(0, "YM_WORK", this.dsSearch.getColumn(0, "YM_WORK"));
        // 		this.dsSlip.setColumn(0, "ID_USER", this.AuthClient.ID_USER);
        // 		this.dsSlip.setColumn(0, "AUTH_CD_CORP", this.AuthClient.CD_CORP);
        ...
        // 전자결재상신
         this.fnElecApp = function(obj,e) {
        	...
        	var param = {};
        	param.V1 = this.dsSearch.getColumn(0,"YM_WORK");
        	param.V2 = this.AuthClient.CD_CORP;
        	param.V3 = this.dsList.getColumn(this.dsList.rowposition, "CD_SITE"); // 팝업에서 쓸 CD_SITE
        	param.V4 = "";
        	param.ID_AP = this.dsList.getColumn(this.dsList.rowposition, "NO_APPR");	// 전자결재문서번호
        	param.DS_ETITLE = "집계보고 전자결재";

        	trace("ID_AP>>>" + param.ID_AP);

        	this.gfnFormOpen("DBS", "DBS_COSTSUM_REPORT_APP", "fnAprvDialogCallback", param, 1200, 700);
        }
        ...
        // 전자결재문서조회
        this.fnElecAppS = function(obj,e) {
        	if(!this.gfnGridIsRow(this.dxGrid)) return;

        	var nRow = this.dsList.rowposition;
        	if(this.gfnIsNull(this.dsList1.getColumn(0, "NO_APPROVAL"))){
        ...
        this.loadIncludeScript("DBS_MAINTAINCOST.xfdl");
