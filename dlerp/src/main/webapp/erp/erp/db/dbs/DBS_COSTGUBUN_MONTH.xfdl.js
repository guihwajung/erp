(function()
{
    return function()
    {
        ...
        {
            this.set_name("DBS_COSTGUBUN_MONTH");
            this.set_titletext("월별기성현황(비목)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_COSTGUBUN_MONTH_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBS_COSTGUBUN_MONTH.xfdl", function() {
        ...
        this.loadIncludeScript("DBS_COSTGUBUN_MONTH.xfdl");
