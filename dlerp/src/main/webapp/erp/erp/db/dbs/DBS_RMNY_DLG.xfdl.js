(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new TextArea("txtMsg","5","staTITLE:10",null,"140","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            ...
            obj = new Button("btnOK","142","txtMsg:20","60","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            obj.set_text("확인");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCANCLE","btnOK:30","txtMsg:20","60","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            obj.set_text("취소");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DBS_RMNY_DLG.xfdl", function() {
        ...
        this.loadIncludeScript("DBS_RMNY_DLG.xfdl");
