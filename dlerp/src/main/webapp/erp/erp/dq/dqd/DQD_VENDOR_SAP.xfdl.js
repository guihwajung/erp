(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DQDPR_VENDOR_IF_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DQDPR_VENDOR_IF_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DQDPR_VENDOR_IF_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DQDPR_VENDOR_IF_DELETE</Col></Row><Row><Col id=\"TARGET\">update_ap</Col><Col id=\"SP\">DQDPR_VENDOR_AP_IF_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"TYPE_SELECT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TYPE_SELECT\">AC</Col><Col id=\"CD_VENDOR\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsUpdateSap", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtCD_VENDOR","rdoTYPE_SELECT:0.0","10.0","140","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","divSearch.form.edtCD_VENDOR","value","dsSearch","CD_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DQD_VENDOR_SAP.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DQD_VENDOR_SAP.xfdl");
