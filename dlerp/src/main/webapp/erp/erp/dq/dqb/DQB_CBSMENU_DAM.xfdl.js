(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DQBPR_CBSMENU_SELECT_DAM</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DQBPR_CBSMENU_UPDATE_DAM</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DQBPR_CBSITEM_SELECT_DM</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_LV0\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SEARCH\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_LV0\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSplitter","67%","0","5","100%",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            ...
            obj = new BindItem("item0","divSearch.form.ccfCD_CBS.form.CDTextBox","value","dsSearch","CD_LV0");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DQB_CBSMENU_DAM.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.ccfCD_CBS.CodeFindName = "CF_CODE_DQ_C01";

        	this.gfnGridInit(this.dxGrid, this.dsList, "DQ", "DQB_CBSMENU_DAM");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("ID_DM_USER", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "ID_DM_USER", this.dsList.getColumn(i, "ID_DM_USER"));
        				break;
        ...
        this.fnSelectSub = function() {
        	...
        	var cd_lv0 = this.dsList.getColumn(this.dsList.rowposition, "CD_LV0");
        	if (this.gfnIsNull(cd_lv0)) {
        		return false;
        	}
        	...
        	this.dsSelectSub.setColumn(0, "CD_SITE", "");
        ...
        this.loadIncludeScript("DQB_CBSMENU_DAM.xfdl");
