(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DQZPR_MASTERTABLELOG_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"DT_YM\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SYSTEM\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SAVE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_SYSTEM","ctclDT_YM:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("시스템코드");
            obj.set_textAlign("center");
        ...
        // User Script
        this.registerScript("DQZ_MDM_MASTERLOG.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DQ", "DQZ_MDM_MASTERLOG");
        };
        ...
        this.fnSelect = function() {
        	...
        	var dt_ym = this.dsSearch.getColumn(0, "DT_YM");

        	this.dsSelect.setColumn(0, "DT_YM", dt_ym.substr(0,6));
        ...
        this.loadIncludeScript("DQZ_MDM_MASTERLOG.xfdl");
