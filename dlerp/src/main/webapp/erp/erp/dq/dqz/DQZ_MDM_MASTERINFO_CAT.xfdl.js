(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CAT_01\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCAT_01","staCAT_01:0.0","10.0","94","24.0",null,null,null,null,null,null,this.divSearch.form);
        ...
        // User Script
        this.registerScript("DQZ_MDM_MASTERINFO_CAT.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.FormInfo.DS_PARAM)) {
        		this.dsSearch.setColumn(0, "CAT_01", this.FormInfo.DS_PARAM);
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("CAT_02", "string");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CAT_02", "");
        ...
        this.loadIncludeScript("DQZ_MDM_MASTERINFO_CAT.xfdl");
