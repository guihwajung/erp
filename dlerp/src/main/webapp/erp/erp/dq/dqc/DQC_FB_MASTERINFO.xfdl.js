(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZZPR_MDM_MASTER_SELECT_WITH_USER_D_FB</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DZZPR_MDM_DETAIL_SELECT_WITH_USER</Col></Row><Row><Col id=\"TARGET\">d_insert</Col><Col id=\"SP\">DZZPR_MDM_DETAIL_INSERT</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DZZPR_MDM_DETAIL_UPDATE</Col></Row><Row><Col id=\"TARGET\">d_delete</Col><Col id=\"SP\">DZZPR_MDM_DETAIL_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_MASTER","staCD_SYSTEM00:0.0","10.0","150","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("50");
            obj.set_taborder("3");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("DQC_FB_MASTERINFO.xfdl", function() {
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_MASTER", "");
        ...
        this.loadIncludeScript("DQC_FB_MASTERINFO.xfdl");
