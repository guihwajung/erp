(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCZPR_BOARD_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCZ_BOARD_LIST.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnDetail = this.gfnFormButtonAdd("BoardDetail", "fnBoardDetail");
        };
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCZ_BOARD");
        }
        ...
        this.fnAdd = function(obj,e){
        	var param = {};
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCZ_BOARD", "fnAdd_callback",  param, 800, 600);
        }
        ...
        this.fnBoardDetail = function() {
        	if(this.dsList.rowcount == 0) {
        		...
        		this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCZ_BOARD", "fnDialogCallback",  param, 800, 600);
        	};
        };
        ...
        this.loadIncludeScript("DCZ_BOARD_LIST.xfdl");
