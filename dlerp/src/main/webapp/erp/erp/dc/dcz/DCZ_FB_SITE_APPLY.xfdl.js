(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZAPR_FB_SITE_SELECT</Col></Row><Row><Col id=\"SP\">DZAPR_FB_SITE_SAVE</Col><Col id=\"TARGET\">save</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_PROJECT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.getSetter("CodeFindName").set("DQX_PROJECT");
        ...
        // User Script
        this.registerScript("DCZ_FB_SITE_APPLY.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCZ_FB_SITE_APPLY");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "TY_SAUP", "");
        	this.dsSelect.setColumn(0, "TY_CONST", "");
        ...
        this.fnGrid_EnterCell = function(obj, row, cell) {
        	...
        	if(colnm == "DS_PROJECT" && this.dsList.getColumn(row, "YN_SAPSENT") == "Y") {
        		return false;
        	}
        };
        ...
        //
        // 	this.gfnFormOpenNonAuth("DQA", "DQA_PROJECT_CREATE", "fnCreate_Callback", param,  410, 260);
        // }
        //
        ...
        //
        // 	this.gfnFormOpenNonAuth("DQA", "DQA_PROJECT_UPDATE", "fnUpdate_Callback", param,  430, 510);
        // }
        //
        ...
        this.loadIncludeScript("DCZ_FB_SITE_APPLY.xfdl");
