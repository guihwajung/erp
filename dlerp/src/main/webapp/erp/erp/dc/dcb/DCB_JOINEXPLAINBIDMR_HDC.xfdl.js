(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_JOINBID_SELECT_HDC</Col></Row><Row><Col id=\"TARGET\">detail</Col><Col id=\"SP\">DCBPR_JOINBID_SELECT_HDC</Col></Row><Row><Col id=\"TARGET\">u_detail</Col><Col id=\"SP\">DCBPR_JOINBID_UPDATE_HDC</Col></Row><Row><Col id=\"TARGET\">update_attend</Col><Col id=\"SP\">DCBPR_SITE_EXPLAIN_ATTEND_UPDATE</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DCBPR_ESTIMATION_SUBMIT_CANCEL</Col></Row><Row><Col id=\"TARGET\">approve</Col><Col id=\"SP\">DCBPR_EXPLAIN_BIDGONGO_APPROVE</Col></Row><Row><Col id=\"TARGET\">mail</Col><Col id=\"SP\">DZZPR_BID_MAIL_SMS_SEND</Col></Row><Row><Col id=\"TARGET\">mail1</Col><Col id=\"SP\">DZZPR_BID_MAIL_SEND</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCBPR_JOINBID_UPDATE_HDC_FORM</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta02","staAT_SITEEXPLAIN:-1","staTopTitle:5","330","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta03","staAT_BIDMAGAM:-1","sta02:-1","330","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Edit("ctxtAT_BIDMAGAM","staAT_BIDMAGAM:4","sta02:4","283","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("12");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Edit("ctxtCT_BID","ctxtAT_SITEEXPLAIN:3","staTopTitle:10","40","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("14");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Button("btnDT_EXPLAIN_CHANGE","ctxtDT_EXPLAIN:3","staTopTitle:10","70","21",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("16");
            obj.set_text("변경일자");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta03_00","776","27",null,"59","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staTopTitle00","776","0",null,"22","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("18");
            obj.set_text("입찰일시 변경사유");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new TextArea("txt00","780","31",null,"51","3",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("19");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new BindItem("item8","divData.form.divDataTop.form.txt00","value","dsList","DS_CHGMAGAM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_JOINEXPLAINBIDMR_HDC.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	//this.btnExplainApp.set_color("crimson");
        	this.btnExplainCancel = this.gfnFormButtonAdd("btnExplainCancel", "fnExplainCancel");
        	//this.btnExplainCancel.set_color("crimson");
        	this.btnBidApp = this.gfnFormButtonAdd("btnBidApp", "fnBidApp");
        	//this.btnBidApp.set_color("crimson");
        	this.btnBidCancel = this.gfnFormButtonAdd("btnBidCancel", "fnBidCancel");
        	//this.btnBidCancel.set_color("crimson");
        	this.btnAttachEtc = this.gfnFormButtonAdd("btnAttachEtc", "fnAttachEtc");
        	//this.btnAttachEtc.set_color("crimson");
        	this.btnMail = this.gfnFormButtonAdd("btnMail", "fnMail");
        	this.btnSMS = this.gfnFormButtonAdd("btnSMS", "fnSMS");
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList2, "DC", "DCB_JOINEXPLAINBIDMR_HDC");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave2.addColumn("NO_BID", "string");
        	this.dsSave2.addColumn("DS_CHGMAGAM", "string");
        }
        ...
        this.fnSave = function() {
        	...
        	this.dsSave2.addRow();
        	this.dsSave2.setColumn(0, "NO_BID", this.dsSearch.getColumn(0, "NO_BID"));
        	this.dsSave2.setColumn(0, "DS_CHGMAGAM", this.dsList.getColumn(0, "DS_CHGMAGAM"));

        	var strSvcId    = "u_detail";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "u_detail=dsSave update=dsSave2";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg)
        {
        	if (svcID == "select") {
        		...
        		//21. 09. 27. ONOFF_EXPLAIN 값이 9면 버튼 DISABLE
        		if(this.dsList.getColumn(0, "ONOFF_EXPLAIN") == "9") {
        			this.btnExplainApp.set_enable(false);
        			this.btnExplainCancel.set_enable(false);
        			this.btnExplainResult.set_enable(false);

        			//입찰버튼은 살림
        			this.btnBidApp.set_enable(true);
        			this.btnBidCancel.set_enable(true);
        		} else {
        			if(this.gfnNvl(this.dsList.getColumn(0, "YN_EXPLAIN_GONGO"), "N") == "N") {
        				this.btnBidApp.set_enable(false);
        				this.btnBidCancel.set_enable(false);
        			} else {
        				this.btnBidApp.set_enable(true);
        				this.btnBidCancel.set_enable(true);
        			}
        ...
        */
        ...
        this.divData_divDataTop_btnDT_EXPLAIN_CHANGE_onclick = function(obj,e)
        {
        	var param = {};

        	var dt_explain =  this.dsList.getColumn(0, "DT_EXPLAIN");

        	var dt_explain_pre = dt_explain.substr(0,10).replace(/-/g, '');
        	var dt_explain_hour = dt_explain.substr(11,2);
        	var dt_explain_min = dt_explain.substr(14,2);

        	param.CD_SITE = this.dsSearch.getColumn(0, "CD_SITE");
        	param.DS_SITE = this.divSearch.form.ccfCD_SITE.form.DSTextBox.text;
        	param.NO_BID = this.dsSearch.getColumn(0, "NO_BID");
        	param.DS_BID = this.divSearch.form.ccfNO_BID.form.DSTextBox.text;
        	param.DT_EXPLAIN_PRE = dt_explain_pre;
        	param.DT_EXPLAIN_PRE_HOUR = dt_explain_hour;
        	param.DT_EXPLAIN_PRE_MIN = dt_explain_min;

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCB_BIDEXPLAINTIMEDLG", "fnDT_CHANGE_callback", param, 400, 300);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataTop.form.btnDT_EXPLAIN_CHANGE.addEventHandler("onclick",this.divData_divDataTop_btnDT_EXPLAIN_CHANGE_onclick,this);
        ...
        this.loadIncludeScript("DCB_JOINEXPLAINBIDMR_HDC.xfdl");
