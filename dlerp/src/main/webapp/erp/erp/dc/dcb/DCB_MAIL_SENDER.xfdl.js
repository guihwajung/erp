(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">gubun</Col><Col id=\"SP\">DZZPR_BID_MAIL_SMS_REPLACE_SELECT</Col></Row><Row><Col id=\"SP\">DZZPR_MAIL_SEND</Col><Col id=\"TARGET\">send</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"SP\">DZZPR_BID_MAIL_SMS_INFO_SELECT</Col><Col id=\"TARGET\">info</Col></Row><Row><Col id=\"SP\">DZZPR_BID_MAIL_SMS_CHARGE_INFO_UPDATE</Col><Col id=\"TARGET\">save</Col></Row></Rows>");
            ...
            obj = new Static("staTITLE","0","staTY_GUBUN:-1","87","30",null,null,null,null,null,null,this.divData.form.divDataBottom.form.divDataLeft.form);
            obj.set_taborder("1");
            obj.set_text("제목");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("right");
            ...
            obj = new Static("staCONTENT","0","staTITLE:-1","87","277",null,null,null,null,null,null,this.divData.form.divDataBottom.form.divDataLeft.form);
            obj.set_taborder("2");
            obj.set_text("내용");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("right");
            ...
            obj = new Static("staBg3","staTITLE:-1","staBg2:-1",null,"30","0%",null,null,null,null,null,this.divData.form.divDataBottom.form.divDataLeft.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataBottom.form.divDataLeft.addChild(obj.name, obj);

            obj = new Static("staBg4","staCONTENT:-1","staBg3:-1",null,"277","0.00%",null,null,null,null,null,this.divData.form.divDataBottom.form.divDataLeft.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataBottom.form.divDataLeft.addChild(obj.name, obj);
            ...
            obj = new Edit("ctxtTITLE","92","ccboTY_GUBUN:9",null,"20","5",null,null,null,null,null,this.divData.form.divDataBottom.form.divDataLeft.form);
            obj.set_taborder("7");
            obj.set_value("");
            this.divData.form.divDataBottom.form.divDataLeft.addChild(obj.name, obj);

            obj = new TextArea("ctxtCONTENT","staCONTENT:5","ctxtTITLE:9",null,"267","5",null,null,null,null,null,this.divData.form.divDataBottom.form.divDataLeft.form);
            obj.set_taborder("8");
            obj.set_value("");
            obj.set_wordWrap("char");
            this.divData.form.divDataBottom.form.divDataLeft.addChild(obj.name, obj);

            obj = new Button("btnOk","staBg4:-65","343","60","20",null,null,null,null,null,null,this.divData.form.divDataBottom.form.divDataLeft.form);
            obj.set_taborder("9");
            obj.set_text("발송");
            this.divData.form.divDataBottom.form.divDataLeft.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divData.form.divDataBottom.form.divDataLeft.form.ccboTY_GUBUN","value","dsData","TY_GUBUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divData.form.divDataBottom.form.divDataLeft.form.ctxtTITLE","value","dsData","TITLE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divData.form.divDataBottom.form.divDataLeft.form.ctxtCONTENT","value","dsData","CONTENT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divData.form.divDataTop.form.ctxtNO_BID","value","dsSearch","NO_BID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divData.form.divDataTop.form.ctxtCT_BID","value","dsSearch","CT_BID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.divDataTop.form.ctxtDT_BIDMAGAM","value","dsSearch","DT_BIDMAGAM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divData.form.divDataTop.form.ctxtDS_SUBCON","value","dsSearch","DS_SUBCON");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_MAIL_SENDER.xfdl", function() {
        ...
        this.loadIncludeScript("DCB_MAIL_SENDER.xfdl");
