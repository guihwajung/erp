(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divDataTop","0","divDataMaster:10",null,"250","0",null,null,null,null,null,this.divData1.form);
            obj.set_taborder("0");
            obj.set_text("");
            this.divData1.addChild(obj.name, obj);

            obj = new Static("staTopTitle","0","0","100%","22",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("0");
            obj.set_text("입찰계획");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staCD_COSTCLASS","0","staTopTitle:7","100","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("1");
            obj.set_text("부문");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staDT_FROM_TO","0","staCD_COSTCLASS:-1","100","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("2");
            obj.set_text("공사기간");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staAM_TT_DOKUB","0","staDT_FROM_TO:-1","100","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("3");
            obj.set_text("도급금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgCD_COSTCLASS","staCD_COSTCLASS:-1","staTopTitle:7",null,"30","581",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgDT_FROM_TO","staDT_FROM_TO:-1","staBgCD_COSTCLASS:-1",null,"30","581",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgAM_TT_DOKUB","staAM_TT_DOKUB:-1","staBgDT_FROM_TO:-1",null,"30","581",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("6");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staCD_LICCOST","staBgCD_COSTCLASS:-1","staTopTitle:7","100","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("7");
            obj.set_text("공종(품목)");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staDS_CONTMETHOD","staBgDT_FROM_TO:-1","staCD_LICCOST:-1","100","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("8");
            obj.set_text("계약방법");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staAM_TT_SILHENG","staBgAM_TT_DOKUB:-1","staDS_CONTMETHOD:-1","100","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("9");
            obj.set_text("실행금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgCD_LICCOST","staCD_LICCOST:-1","staTopTitle:7",null,"30","0",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgDS_CONTMETHOD","staDS_CONTMETHOD:-1","staBgCD_LICCOST:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgAM_TT_SILHENG","staAM_TT_SILHENG:-1","staBgDS_CONTMETHOD:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("ctxtCD_COSTCLASS","staCD_COSTCLASS:5","staTopTitle:12","110","20",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("13");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("ctxtDS_COSTCLASS","ctxtCD_COSTCLASS:3","staTopTitle:12","127","20",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("14");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Div("ccfCD_LICCOST","staCD_LICCOST:5","staTopTitle:12","290","20",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            ...
            obj = new Calendar("ctclDT_FROM","staDT_FROM_TO:5","ctxtCD_COSTCLASS:9","106","20",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("16");
            ...
            obj = new Static("sta_range","ctclDT_FROM:10","ctxtCD_COSTCLASS:5","10","20",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("17");
            obj.set_text("~");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_TO","sta_range:10","ctxtCD_COSTCLASS:9","104","20",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("18");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Combo("cboDS_CONTMETHOD","staDS_CONTMETHOD:5","ccfCD_LICCOST:9",null,"20","287",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("19");
            ...
            obj = new MaskEdit("ctxtAM_TT_DOKUB","staAM_TT_DOKUB:5","ctclDT_FROM:9","240","20",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("20");
            obj.set_value("");
            obj.set_format("#,#");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("ctxtAM_TT_SILHENG","staAM_TT_SILHENG:5","cboDS_CONTMETHOD:9","290","20",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("21");
            obj.set_value("");
            obj.set_format("#,#");
            obj.set_readonly("true");
            ...
            obj = new Static("staTY_ACCOUNT","0","staTopTitle:5","100","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("1");
            obj.set_text("구매유형");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta00","staTY_ACCOUNT:-1","staTopTitle:5","250","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staSpace01","sta00:-1","staDS_CONTMETHOD:-1","100","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("1");
            obj.set_text("");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta05","staSpace01:-1","sta04:-1","250","30",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta07_00_01","0","116","100","100",null,null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("22");
            obj.set_text("특기사항");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta08_00_00","99","116",null,"100","0",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new TextArea("txt00","105","121",null,"90","15",null,null,null,null,null,this.divData1.form.divDataTop.form);
            obj.set_taborder("24");
            this.divData1.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta00","0","divDataTop:-20",null,"22","0",null,null,null,null,null,this.divData1.form);
            obj.set_taborder("4");
            obj.set_text("입찰참여업체");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData1.addChild(obj.name, obj);

            obj = new Grid("objGrid1","0","sta00:5",null,null,"0","0",null,null,null,null,this.divData1.form);
            obj.set_taborder("5");
            obj._setContents("");
            this.divData1.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item7","divData1.form.divDataTop.form.cboDS_CONTMETHOD","value","dsList","DS_CONTMETHOD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divData1.form.divDataTop.form.ctclDT_FROM","value","dsList","DT_FROM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divData1.form.divDataTop.form.ctclDT_TO","value","dsList","DT_TO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divData1.form.divDataTop.form.ctxtAM_TT_DOKUB","value","dsList","AM_TT_DOKUB");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","divData1.form.divDataTop.form.ctxtAM_TT_SILHENG","value","dsList","AM_TT_SILHENG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","divData1.form.divDataTop.form.ctxtCD_COSTCLASS","value","dsList","CD_COSTCLASS");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divData1.form.divDataTop.form.ctxtDS_COSTCLASS","value","dsList","DS_COSTCLASS");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","divData1.form.divDataTop.form.ccfCD_LICCOST.form.CDTextBox","value","dsList","CD_LICCOST");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divData1.form.divDataTop.form.ccfCD_LICCOST.form.DSTextBox","value","dsList","DS_LICCOST");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","divData1.form.divDataTop.form.txt00","value","dsList","RM_VENDOR_REMARK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divData1.form.divDataTop.form.ctclDT_FROM","value","dsList","DT_FROM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item17","divData1.form.divDataTop.form.cboDS_CONTMETHOD","value","dsList","DS_CONTMETHOD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_RECOMMEND_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DC05";
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DC", "DCB_RECOMMENDVENDOR");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_BID", this.dsListMaster.getColumn(0, "V_PARAM02"));
        	...
        	this.dsSelect1.setColumn(0, "CD_SITE", this.dsListMaster.getColumn(0, "V_PARAM01"));
        	this.dsSelect1.setColumn(0, "NO_BID", this.dsListMaster.getColumn(0, "V_PARAM02"));
        ...
        **************************************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg) {
        	if (svcID == "init") {
        		...
        		if (this.dsListMaster.rowcount > 0) {
        			...
        			this.btn11.set_enable(this.dsListMaster.getColumn(0, "BTNSAVE") != "H");
        			// 확장버튼 숨김 처리 후 위치조정
        			var arrBtns = [];
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData1.form.divDataTop.form.staBgCD_COSTCLASS.addEventHandler("onclick",this.divData_divDataTop_staBgCD_COSTCLASS_onclick,this);
            this.divData1.form.divDataTop.form.staBgDT_FROM_TO.addEventHandler("onclick",this.divData_divDataTop_staBgDT_FROM_TO_onclick,this);
            this.divData1.form.divDataTop.form.ctxtAM_TT_DOKUB.addEventHandler("onchanged",this.divData_divDataTop_ctxtAM_TT_DOKUB_onchanged,this);
            this.divData1.form.divDataTop.form.txt00.addEventHandler("onkeydown",this.divData_divDataTop_txt00_onkeydown,this);
        };
        this.loadIncludeScript("DCB_RECOMMEND_APP.xfdl");
