(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staCD_COSTCLASS","0","staTopTitle:0","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("1");
            obj.set_text("부문");
            ...
            obj = new Static("staBgCD_COSTCLASS","staCD_COSTCLASS:-1","staTopTitle:0","400","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgDT_FROM_TO","staDT_FROM_TO:-1","staBgCD_COSTCLASS:-1","400","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgAM_TT_DOKUB","staAM_TT_DOKUB:-1","staBgDT_FROM_TO:-1","400","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("6");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staCD_LICCOST","staBgCD_COSTCLASS:-1","staTopTitle:0","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("7");
            obj.set_text("하도공종");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("staBgCD_LICCOST","staCD_LICCOST:-1","staTopTitle:0",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgDS_CONTMETHOD","staDS_CONTMETHOD:-1","staBgCD_LICCOST:-1",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgAM_TT_SILHENG","staAM_TT_SILHENG:-1","staBgDS_CONTMETHOD:-1",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("ctxtCD_COSTCLASS","staCD_COSTCLASS:5","staTopTitle:5","110","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("13");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("ctxtDS_COSTCLASS","ctxtCD_COSTCLASS:3","staTopTitle:5","127","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("14");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Div("ccfCD_LICCOST","staCD_LICCOST:5","staTopTitle:5","290","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            ...
            obj = new Combo("cboTY_ACCOUNT","351","staTopTitle:-17","240","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("25");
            ...
            obj = new Static("sta07_00_01","0","109","100","135",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("22");
            obj.set_text("특기사항");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta08_00_00","99","109",null,"135","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new TextArea("txt00","105","114",null,"125","12",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("24");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staCD_COSTCLASS00","930","22","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("26");
            obj.set_text("결재상태");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_visible("false");
            ...
            obj = new Edit("ctxtCD_APP01","1035","27","240","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("27");
            obj.set_value("");
            obj.set_readonly("true");
            obj.set_visible("false");
            ...
            obj = new BindItem("item13","divData.form.divDataTop.form.txt00","value","dsList","RM_REMARK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DCB_RECOMMENDCUSTREQSETTLE.xfdl","lib::libCommon.xjs");
        this.registerScript("DCB_RECOMMENDCUSTREQSETTLE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	if(this.getOwnerFrame().DS_PARAM == "MM") {
        		this.ccfCD_LICCOST.CodeFindName = "DMX_CFLICCOST";

        		this.divData.form.divDataTop.form.staCD_LICCOST.set_text("품목");
        		this.divData.form.divDataTop.form.staDT_FROM_TO.set_text("납품기간");
        		this.dxGrid.setCellProperty("head", this.dxGrid.getBindCellIndex("body", "AM_CONTLIMIT"), "text", "전년도매출액");
        	} else {
        		this.divData.form.divDataTop.form.staCD_LICCOST.set_text("하도공종");
        		this.divData.form.divDataTop.form.staDT_FROM_TO.set_text("공사기간");
        	}
        ...
        //	this.dsUpdate2.addColumn("CD_LICENSE", "string");
        	...
        	this.dsUpdate2.addColumn("RM_REMARK", "string");
        }
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_SYSTEM", this.getOwnerFrame().DS_PARAM);
        ...
        this.fnSave = function()
        {
        	...
        	//21.09.16 입찰계획의 비고와 동일한 컬럼 RM_REMARK로 특이사항 보여지게 변경하였음
        	//별도 컬럼인 RM_VENDOR_REMARK는 사용 안하게 됨
        ...
        //				this.dsUpdate2.setColumn(nrow, "CD_LICENSE", this.dsList2.getColumn(i, "CD_LICENSE"));
        				...
        				this.dsUpdate2.setColumn(nrow, "RM_REMARK", this.dsList2.getColumn(i, "RM_REMARK"));
        			break;
        		}
        	}
        ...
        this.fnAppValidate = function() {
        	...
        	else if(this.dsList2.rowcount == 0)
        	{
        		this.gfnAlert("지명업체를 등록해주십시오.");
        		return false;
        	}
        ...
        // 	for(var i = 0; i < this.dsList2.rowcount; i++)
        // 	{
        // 		if(this.gfnIsNull(this.dsList2.getColumn(i, "CD_LICENSE")))
        // 		{
        // 			this.gfnAlert("입찰참여업체의 면허를 선택해주세요.");
        // 			return false;
        // 		}
        // 	}
        ...
        // 		if(!this.gfnIsNull(this.dsList.getColumn(0, "CD_ELAPPRGS")))
        // 		{
        // 			this.fnSetReonlyAndEntercell(true);
        // 		}
        // 		else
        // 		{
        // 			this.fnSetReonlyAndEntercell(false);
        // 		}
        	}
        ...
        this.fnVenAdd = function(obj,e) {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCB_RECOMMEND_DLG", "fnVenAdd_callback", param, 1300, 650);
        }
        ...
        this.fnCancel = function(obj, e) {
        	var msg = "지명품의가 완료된 건을 취소하는 경우 재상신 하셔야 합니다.\n취소 하시겠습니까?";
        ...
        */
        ...
        this.fnAPP = function(obj,e) {
        	...
        	*/
        	...
        	var param = {};
        	param.V1 = this.dsList.getColumn(0, "NO_BID");			// NO_BID
        	param.V2 = this.dsList.getColumn(0, "CT_BID");
        	param.V3 = "";
        	param.V4 = "";
        	param.ID_AP = this.dsList.getColumn(0, "NO_ELAPDOC");	// 전자결재문서번호
        	param.DS_ETITLE = "실시계획서";

        	this.gfnFormOpen("DCB", "DCB_ORDERPLAN_APP", "fnDcbAprvDialogCallback", param, 1200, 700);
        }

         this.fnDcbAprvDialogCallback = function(svcID, value) {
        	// 리턴값
        ...
        this.fnSetReonlyAndEntercell = function(val)
        {
        	this.divData.form.divDataTop.form.txt00.set_readonly(val);
        }
        this.divData_divDataTop_txt00_onkeydown = function(obj,e)
        {
        	if(this.divData.form.divDataTop.form.txt00.readonly == false)
        	{
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataTop.form.txt00.addEventHandler("onkeydown",this.divData_divDataTop_txt00_onkeydown,this);
        ...
        this.loadIncludeScript("DCB_RECOMMENDCUSTREQSETTLE.xfdl");
