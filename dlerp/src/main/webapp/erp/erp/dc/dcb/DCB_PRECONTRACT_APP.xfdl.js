(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("txtDT_BIDMAGAM","757","92",null,"20","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("13");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Static("sta09","752","116",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta11","603","116","150","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("18");
            obj.set_text("선급금");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("sta12","149","116","455","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta16","0","116","150","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("20");
            obj.set_text("결재조건");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("sta17","752","145",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("21");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta18","603","145","150","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("22");
            obj.set_text("도급차인액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("sta19","149","145","455","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta20","0","145","150","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("24");
            obj.set_text("도급금액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("sta21","752","174",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta22","603","174","150","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("26");
            obj.set_text("실행차인액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("sta23","149","174","455","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("27");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta24","0","174","150","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("28");
            obj.set_text("실행금액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("sta25","752","203",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta26","603","203","150","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("30");
            obj.set_text("낙찰업체");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("sta27","149","203","455","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("31");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta28","0","203","150","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("32");
            obj.set_text("낙찰금액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Edit("txtDS_PREPAY","757","121",null,"20","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("37");
            obj.set_enable("true");
            ...
            obj = new Edit("txtAM_DOKUB_CHA","757","150",null,"20","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("38");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_SILHENG_CHA","757","179",null,"20","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("39");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtDT_EXPLAIN","154","92","445","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("41");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtDS_PAYMENT","154","121","445","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("42");
            obj.set_enable("true");
            obj.set_readonly("false");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_DOKUB","154","150","445","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("43");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new BindItem("item8","divData1.form.divDataInfo.form.txtDT_BIDMAGAM","value","dsListEtc","DT_BIDMAGAM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item20","divData1.form.divDataInfo.form.txtDS_PREPAY","value","dsListEtc","DS_PREPAY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item21","divData1.form.divDataInfo.form.txtAM_DOKUB_CHA","value","dsListEtc","AM_DOKUB_CHA");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData1.form.divDataInfo.form.txtAM_SILHENG_CHA","value","dsListEtc","AM_SILHENG_CHA");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","divData1.form.divDataInfo.form.txtDS_VENDOR","value","dsListEtc","DS_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divData1.form.divDataInfo.form.txtDT_EXPLAIN","value","dsListEtc","DT_EXPLAIN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","divData1.form.divDataInfo.form.txtDS_PAYMENT","value","dsListEtc","DS_PAYMENT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divData1.form.divDataInfo.form.txtAM_DOKUB","value","dsListEtc","AM_DOKUB");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","divData1.form.divDataInfo.form.txtAM_SILHENG","value","dsListEtc","AM_SILHENG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divData1.form.divDataInfo.form.txtAM_HADO","value","dsListEtc","AM_HADO");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_PRECONTRACT_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DC03";	//	시행품의서
        this.FlagGb = "";	// 저장 플래그값
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCB_PRECONTRACT_APP");
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg) {
        	if (svcID == "init") {
        		...
        		if (errorCode == 0) {
        			...
        			// 헤더명 변경
        			this.dxGrid.setCellProperty("head", 5, "text", this.dsListHd.getColumn(0, "DS_VENDOR1"));
        			this.dxGrid.setCellProperty("head", 6, "text", this.dsListHd.getColumn(0, "DS_VENDOR2"));
        			this.dxGrid.setCellProperty("head", 7, "text", this.dsListHd.getColumn(0, "DS_VENDOR3"));
        			this.dxGrid.setCellProperty("head", 8, "text", this.dsListHd.getColumn(0, "DS_VENDOR4"));
        			this.dxGrid.setCellProperty("head", 9, "text", this.dsListHd.getColumn(0, "DS_VENDOR5"));
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData1.form.divDataInfo.form.txtDT_BIDMAGAM.addEventHandler("onkeyup",this.divData_divDataRight_onkeyup,this);
            this.divData1.form.divDataInfo.form.txtDT_BIDMAGAM.addEventHandler("onkillfocus",this.divData_divDataRight_onkillfocus,this);
            ...
            this.divData1.form.divDataInfo.form.txtDS_PREPAY.addEventHandler("onkeyup",this.divData_divDataRight_onkeyup,this);
            this.divData1.form.divDataInfo.form.txtDS_PREPAY.addEventHandler("onkillfocus",this.divData_divDataRight_onkillfocus,this);
            this.divData1.form.divDataInfo.form.txtAM_DOKUB_CHA.addEventHandler("onkeyup",this.divData_divDataRight_onkeyup,this);
            this.divData1.form.divDataInfo.form.txtAM_DOKUB_CHA.addEventHandler("onkillfocus",this.divData_divDataRight_onkillfocus,this);
            ...
            this.divData1.form.divDataInfo.form.txtDT_EXPLAIN.addEventHandler("onkeyup",this.divData_divDataRight_onkeyup,this);
            this.divData1.form.divDataInfo.form.txtDT_EXPLAIN.addEventHandler("onkillfocus",this.divData_divDataRight_onkillfocus,this);
            this.divData1.form.divDataInfo.form.txtDS_PAYMENT.addEventHandler("onkeyup",this.divData_divDataRight_onkeyup,this);
            this.divData1.form.divDataInfo.form.txtDS_PAYMENT.addEventHandler("onkillfocus",this.divData_divDataRight_onkillfocus,this);
            this.divData1.form.divDataInfo.form.txtAM_DOKUB.addEventHandler("onkeyup",this.divData_divDataRight_onkeyup,this);
            this.divData1.form.divDataInfo.form.txtAM_DOKUB.addEventHandler("onkillfocus",this.divData_divDataRight_onkillfocus,this);
        ...
        this.loadIncludeScript("DCB_PRECONTRACT_APP.xfdl");
