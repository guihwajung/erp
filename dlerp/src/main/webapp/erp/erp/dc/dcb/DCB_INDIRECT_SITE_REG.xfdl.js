(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_INDIRECT_REG_SITE_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCBPR_INDIRECT_REG_SITE_UPDATE</Col></Row><Row><Col id=\"TARGET\">cal</Col><Col id=\"SP\">DCBPR_INDIRECT_REG_SITE_CALCULATE</Col></Row><Row><Col id=\"TARGET\">apply</Col><Col id=\"SP\">DCBPR_INDIRECT_REG_SITE_APPLY</Col></Row><Row><Col id=\"TARGET\">subselect</Col><Col id=\"SP\">DCBPR_INDIRECT_REG_SITE_SUB_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCODE_DC_03","ccfSite:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("구매요청번호");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divSearch.form.ccfOrder.form.CDTextBox","value","dsSearch","NO_PR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_INDIRECT_SITE_REG.xfdl", function() {
        ...
        this.loadIncludeScript("DCB_INDIRECT_SITE_REG.xfdl");
