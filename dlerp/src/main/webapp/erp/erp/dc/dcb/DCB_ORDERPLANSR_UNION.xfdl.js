(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_ORDER_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_ORDER_TO\" type=\"STRING\" size=\"256\"/><Column id=\"NO_UNION_BID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"DT_ORDER_FR\"/><Col id=\"DT_ORDER_TO\"/><Col id=\"NO_UNION_BID\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_WORK","ccfCD_SITE:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("입찰마감");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_SITE00","ctclDT_TO:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("통합입찰번호");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edt_Union","staCD_SITE00:0.0","10.0","120","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item3","divSearch.form.edt_Union","value","dsSearch","NO_UNION_BID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_ORDERPLANSR_UNION.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_SITE)){
        		...
        		this.dsSearch.setColumn(0, "DT_ORDER_FR", this.getOwnerFrame().DT_FROM);
        		this.dsSearch.setColumn(0, "DT_ORDER_TO", this.getOwnerFrame().DT_TO);
        		this.dsSearch.setColumn(0, "NO_UNION_BID", this.getOwnerFrame().NO_BID_UNION);
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelectSub.addColumn("NO_UNION_BID", "string");
        	...
        	this.dsDelete.addColumn("NO_UNION_HADO", "string");
        	this.dsDelete.addColumn("NO_HADO", "string");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelectSub.setColumn(0, "NO_UNION_BID", this.dsSearch.getColumn(0, "NO_UNION_BID"));

        	var strSvcId    = "select";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
        	var inData      = "select=dsSelect selectSub=dsSelectSub";
        	...
        	for (var i = 0; i < this.dsListSub.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "NO_UNION_BID", this.divSearch.form.edt_Union.value);
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "NO_UNION_HADO", this.divSearch.form.edt_Union.value);
        				this.dsDelete.setColumn(nrow, "NO_HADO", this.dsListSub.getColumn(i, "NO_HADO"));
        				this.dsDelete.setColumn(nrow, "NO_BID", this.dsListSub.getColumn(i, "NO_BID"));
        			break;
        		}
        ...
        this.fnSaveValidate = function()
        {
        	...
        	if(this.gfnIsNull(this.divSearch.form.edt_Union.value)){
        ...
        this.divData_btnRight_onclick = function(obj,e)
        {
        	...
        	{
        		var nrow = rows[j];
        		if(this.dsListSub.findRow("NO_BID", this.dsList.getColumn(nrow, "NO_BID")) > -1){
        ...
        this.loadIncludeScript("DCB_ORDERPLANSR_UNION.xfdl");
