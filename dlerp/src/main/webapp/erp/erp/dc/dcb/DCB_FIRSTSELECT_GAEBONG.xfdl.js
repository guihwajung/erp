(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("DCB_FIRSTSELECT_GAEBONG.xfdl","lib::libCommon.xjs");
        this.registerScript("DCB_FIRSTSELECT_GAEBONG.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DCB_FIRSTSELECT_GAEBONG.xfdl");
