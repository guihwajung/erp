(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_BID\" type=\"STRING\" size=\"256\"/><Column id=\"DS_BID\" type=\"STRING\" size=\"256\"/><Column id=\"DT_EXPLAIN_PRE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_EXPLAIN_PRE_HOUR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_EXPLAIN_PRE_MIN\" type=\"STRING\" size=\"256\"/><Column id=\"DT_EXPLAIN\" type=\"STRING\" size=\"256\"/><Column id=\"DT_EXPLAIN_HOUR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_EXPLAIN_MIN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_EXPLAIN_PRE","0","staNO_BID:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("현재");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("right");
            ...
            obj = new Static("staDT_EXPLAIN","0","staDT_EXPLAIN_PRE:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("변경");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("right");
            ...
            obj = new Static("staBg3","staDT_EXPLAIN_PRE:-1","staBg2:-1",null,"30","0%",null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBg4","staDT_EXPLAIN:-1","staBg3:-1",null,"30","0%",null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclDT_BIDMAGAM_PRE","staDT_EXPLAIN_PRE:5","edtNO_BID:9","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            ...
            obj = new Edit("edtDT_EXPLAIN_PRE_HOUR","ctclDT_BIDMAGAM_PRE:5","edtNO_BID:9","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_readonly("true");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDT_EXPLAIN_PRE_HOUR","edtDT_EXPLAIN_PRE_HOUR:3","staNO_BID:5","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_text("시");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("edtDT_EXPLAIN_PRE_MIN","staDT_EXPLAIN_PRE_HOUR:3","edtNO_BID:9","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("16");
            obj.set_readonly("true");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDT_EXPLAIN_PRE_MIN","edtDT_EXPLAIN_PRE_MIN:3","staNO_BID:5","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_text("분");
            this.divData.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_EXPLAIN","staDT_EXPLAIN:5","ctclDT_BIDMAGAM_PRE:9","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("18");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Combo("ccboDT_EXPLAIN_HOUR","ctclDT_EXPLAIN:5","ctclDT_BIDMAGAM_PRE:9","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            ...
            obj = new Static("staDT_EXPLAIN_HOUR","ccboDT_EXPLAIN_HOUR:3","staDT_EXPLAIN_PRE:5","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("20");
            obj.set_text("시");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("ccboDT_EXPLAIN_MIN","staDT_EXPLAIN_HOUR:3","ctclDT_BIDMAGAM_PRE:9","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            ...
            obj = new Static("staDT_EXPLAIN_MIN","ccboDT_EXPLAIN_MIN:3","staDT_EXPLAIN_PRE:5","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("22");
            obj.set_text("분");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item4","divData.form.ctclDT_BIDMAGAM_PRE","value","dsData","DT_EXPLAIN_PRE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divData.form.edtDT_EXPLAIN_PRE_HOUR","value","dsData","DT_EXPLAIN_PRE_HOUR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.edtDT_EXPLAIN_PRE_MIN","value","dsData","DT_EXPLAIN_PRE_MIN");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item8","divData.form.ccboDT_EXPLAIN_HOUR","value","dsData","DT_EXPLAIN_HOUR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divData.form.ccboDT_EXPLAIN_MIN","value","dsData","DT_EXPLAIN_MIN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_BIDEXPLAINTIMEDLG.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsData.setColumn(0, "DT_EXPLAIN_PRE", this.getOwnerFrame().DT_EXPLAIN_PRE);
        	this.dsData.setColumn(0, "DT_EXPLAIN_PRE_HOUR",  this.getOwnerFrame().DT_EXPLAIN_PRE_HOUR);
        	this.dsData.setColumn(0, "DT_EXPLAIN_PRE_MIN", this.getOwnerFrame().DT_EXPLAIN_PRE_MIN);

        	this.dsData.setColumn(0, "DT_EXPLAIN", this.getOwnerFrame().DT_EXPLAIN_PRE);
        	this.dsData.setColumn(0, "DT_EXPLAIN_HOUR", 16);
        	this.dsData.setColumn(0, "DT_EXPLAIN_MIN", "00");
        ...
        this.loadIncludeScript("DCB_BIDEXPLAINTIMEDLG.xfdl");
