(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUE_TARGET_SITE_DM_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYY_WORK","0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("평가년도/월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctcYY_WORK","staYY_WORK:0.0","10.0","60","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Static("staCD_SITE","ccfMagam:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("현장코드");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item3","divSearch.form.ctcYY_WORK.form.TextBox","value","dsSearch","YR_EVALUE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCD_EVALUE_VENDOR_DM.xfdl", function() {
        ...
        this.DWA_SILHENG_onload = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0,"YR_EVALUE",today.substr(0,6));
        };
        ...
        this.fnSetVariable = function() {
        	this.ctcYY_WORK = this.divSearch.form.ctcYY_WORK;
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUE_VENDOR_DM");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "YR_EVALUE", this.dsSearch.getColumn(0, "YR_EVALUE").substr(0,6));
        ...
        this.fnEvalue = function(obj,e) {
           ...
           if(col != "M1_STATUS" && col != "M2_STATUS" && col != "M3_STATUS" && col != "M4_STATUS") {
           ...
           if(col == "M1_STATUS") {
              param.CD_EVALUEKIND = this.dsList.getColumn(nRow, "CD_EVALUEKIND_M1");
              param.DS_EVALUEKIND = this.dsList.getColumn(nRow, "DS_EVALUEKIND_M1");
           } else if(col == "M2_STATUS") {
              param.CD_EVALUEKIND = this.dsList.getColumn(nRow, "CD_EVALUEKIND_M2");
              param.DS_EVALUEKIND = this.dsList.getColumn(nRow, "DS_EVALUEKIND_M2");
           } else if(col == "M3_STATUS") {
              param.CD_EVALUEKIND = this.dsList.getColumn(nRow, "CD_EVALUEKIND_M3");
              param.DS_EVALUEKIND = this.dsList.getColumn(nRow, "DS_EVALUEKIND_M3");
           } else if(col == "M4_STATUS") {
              param.CD_EVALUEKIND = this.dsList.getColumn(nRow, "CD_EVALUEKIND_M4");
              param.DS_EVALUEKIND = this.dsList.getColumn(nRow, "DS_EVALUEKIND_M4");
           }
        ...
        this.loadIncludeScript("DCD_EVALUE_VENDOR_DM.xfdl");
