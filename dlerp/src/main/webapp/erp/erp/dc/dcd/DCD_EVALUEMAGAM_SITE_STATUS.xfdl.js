(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_SITE_STATUS_SELECT</Col></Row><Row><Col id=\"TARGET\">year</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_YEAR_MAX_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_MAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"TY_REGIST\" type=\"STRING\" size=\"256\"/><Column id=\"AM_SCORE_FR\" type=\"STRING\" size=\"256\"/><Column id=\"AM_SCORE_TO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TY_REGIST\"/><Col id=\"YR_MAGAM\"/><Col id=\"NO_SEQ\"/><Col id=\"CD_SITE\"/><Col id=\"DS_VENDOR\"/><Col id=\"AM_SCORE_FR\"/><Col id=\"AM_SCORE_TO\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDS_VENDOR","0.0","staYR_MAGAM:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("업체명");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtDS_VENDOR","staDS_VENDOR:0.0","staYR_MAGAM:10.0","273","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_value("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTY_REGIST","ctxtDS_VENDOR:0.0","staYR_MAGAM:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("업체등록시기");
            ...
            obj = new Static("staAM_SCORE","ccboTY_REGIST:0.0","staYR_MAGAM:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("평가점수(가중치)");
            obj.set_textDecoration("none");
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_SITE_STATUS.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	if(this.FormInfo.DS_PARAM == "SF") {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_SITE_STATUS_SF");
        	} else if(this.FormInfo.DS_PARAM == "DM") {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_SITE_STATUS_DM2");
        	} else {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_SITE_STATUS");
        	}
        };
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_SITE_STATUS.xfdl");
