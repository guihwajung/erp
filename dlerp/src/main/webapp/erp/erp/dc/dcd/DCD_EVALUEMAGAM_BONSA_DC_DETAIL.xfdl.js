(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_VENDORMAGAM_BONSA_DC_DTL_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DCDPR_VENDORMAGAM_BONSA_DC_DTL_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_MAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_BONSA_DC_DETAIL.xfdl", function() {
        ...
        //	this.divSearch.form.ccfNO_SEQ.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_VENDORMAGAM_BONSA_DC_DTL_SELECT");
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_BONSA_DC_DETAIL.xfdl");
