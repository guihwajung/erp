(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_CS_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_CS_UPDATE</Col></Row><Row><Col id=\"TARGET\">submit</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_CS_SUBMIT</Col></Row><Row><Col id=\"TARGET\">year</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_YEAR_MAX_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("objGridExcel","65","50",null,null,"685","305",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_BONSA_CS.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.objGridExcel.addEventHandler("oncellclick",this.divData_objGrid_oncellclick,this);
            this.dsList.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
            this.dsExcel.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
        };
        this.loadIncludeScript("DCD_EVALUEMAGAM_BONSA_CS.xfdl");
