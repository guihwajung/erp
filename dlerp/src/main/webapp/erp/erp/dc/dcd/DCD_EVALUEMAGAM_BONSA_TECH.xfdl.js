(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_TECH_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_TECH_UPDATE</Col></Row><Row><Col id=\"TARGET\">submit</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_TECH_SUBMIT</Col></Row><Row><Col id=\"TARGET\">year</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_YEAR_MAX_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_BONSA_TECH.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_BONSA_TECH");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_ETC", this.dsList.getColumn(i, "CD_ETC3"));
        				break;
        		}
        	}
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg)
        {
        	...
        	else if(svcID == "year")
        	{
        		...
        		if (errorCode == 0) {
        			...
        			var msg = "기술연구소본사평가 제출 정상처리하였습니다.";

        			if(strArg == "N")
        			{
        				msg = "기술연구소본사평가 제출취소 정상처리하였습니다.";
        			}
         ...
         ************************************************************************/
         this.fnGrid_BeforeUserDataSetParam = function(id, dsUserParam, nrow){
        	if(id == "DCX_CFEVALUEMAGAM_SCORE"){
        		dsUserParam.setColumn(nrow, "CD_TYPE", "D04");
        	}
        ...
        this.fnDetail = function()
        {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCD_EVALUEMAGAM_BONSA_TECH_DETAIL", "fnDetail_callback", param);
        }
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_BONSA_TECH.xfdl");
