(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUERESULT_VEDNOR_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNM_SEQ","staBG:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_textDecoration("none");
            obj.set_background("#f9f9f9");
            obj.set_text("");
        ...
        // User Script
        this.registerScript("DCD_EVALUERESULT_VENDOR.xfdl", function() {
        ...
        this.loadIncludeScript("DCD_EVALUERESULT_VENDOR.xfdl");
