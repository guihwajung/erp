(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_HSE_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_HSE_UPDATE</Col></Row><Row><Col id=\"TARGET\">submit</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_HSE_SUBMIT</Col></Row><Row><Col id=\"TARGET\">year</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_YEAR_MAX_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_MAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BONBU\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_BONBU\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfNO_SEQ","ctclYR_MAGAM:0.0","10.0","300","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Combo("cbo00","ccfNO_SEQ:0.0","10.0","115","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var divSearch_form_cbo00_innerdataset = new nexacro.NormalDataset("divSearch_form_cbo00_innerdataset", obj);
            divSearch_form_cbo00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\"/><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"datacolumn\">토목</Col><Col id=\"codecolumn\">A0300000</Col></Row><Row><Col id=\"datacolumn\">건축</Col><Col id=\"codecolumn\">A0400000</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_cbo00_innerdataset);
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staYR_MAGAM00","cbo00:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("사업구분");
            ...
            obj = new BindItem("item2","divSearch.form.cbo00","value","dsSearch","CD_BONBU");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_BONSA_HSE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	if(this.FormInfo.DS_PARAM == "DM") {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_BONSA_HSE_DM");
        	} else {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_BONSA_HSE");
        	}
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("CD_ETC", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_ETC", this.dsList.getColumn(i, "CD_ETC1"));
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg)
        {
        	...
        	else if(svcID == "year")
        	{
        		...
        		if (errorCode == 0) {
        			...
        			var msg = "외주자재팀 평가 마감되었습니다.";

        			if((strArg.split(" "))[0] == "N")
        			{
        				msg = "외주자재팀 평가 마감 취소되었습니다.";
        			}
        ...
        this.fnGrid_BeforeUserDataSetParam = function(id, dsUserParam, nrow){
        	if(id == "DCX_CFEVALUEMAGAM_SCORE"){
        		dsUserParam.setColumn(nrow, "CD_TYPE", "D02");
        	}
        ...
        this.fnDetail = function()
        {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCD_EVALUEMAGAM_BONSA_HSE_DETAIL", "fnDetail_callback", param);
        }
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_BONSA_HSE.xfdl");
