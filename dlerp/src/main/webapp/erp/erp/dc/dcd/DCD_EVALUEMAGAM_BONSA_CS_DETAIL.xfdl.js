(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_BONSA_CS_DETAIL.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0, "CD_DEPT", "CS");
        ...
        //	this.divSearch.form.ccfNO_SEQ.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_BONSA_CS_DETAIL");
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_BONSA_CS_DETAIL.xfdl");
