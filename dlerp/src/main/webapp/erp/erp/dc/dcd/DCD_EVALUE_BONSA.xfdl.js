(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUE_BON_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DCDPR_EVALUE_BONSA_INSERT</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCDPR_EVALUE_BONSA_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_EVALUE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_EVALUEKIND\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"ID_EVALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YR_EVALUE\"/><Col id=\"NO_SEQ\"/><Col id=\"CD_SITE\"/><Col id=\"CD_EVALUEKIND\"/><Col id=\"CD_VENDOR\"/><Col id=\"ID_EVALUE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.getSetter("CodeFindName").set("DCX_CFEVALUE_MAGAM_BON");
            obj.set_taborder("2");
            ...
            obj = new Div("ccfCD_EVALUEKIND","staCD_EVALUEKIND:0.0","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CodeFindName").set("DCX_CFEVALUEKIND_YEAR_BONSA");
            obj.getSetter("CDTextWidth").set("50");
            obj.set_taborder("4");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_SITE","staCD_SITE:0.0","ctcYY_WORK:10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("ccfCD_VENDOR","staCD_VENDOR:0.0","staYY_WORK:10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
        ...
        // User Script
        this.registerScript("DCD_EVALUE_BONSA.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUE_BONSA");
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if(id == "ccfMagam"){
        		...
        		dsUserParam.setColumn(nrow, "ID_EVALUE", this.dsSearch.getColumn(0, "ID_EVALUE"));
        ...
        this.loadIncludeScript("DCD_EVALUE_BONSA.xfdl");
