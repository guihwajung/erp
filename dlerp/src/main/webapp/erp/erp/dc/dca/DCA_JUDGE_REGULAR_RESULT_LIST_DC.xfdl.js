(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_RESULT_LIST_DC_SELECT</Col></Row><Row><Col id=\"TARGET\">talak</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_RESULT_LIST_DC_TALAK</Col></Row><Row><Col id=\"TARGET\">auto</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_RESULT_LIST_DC_REGIST_CANCEL</Col></Row><Row><Col id=\"SP\">DCAPR_JUDGE_REGULAR_RESULT_LIST_DC_APPLY</Col><Col id=\"TARGET\">regist</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo1</Col><Col id=\"SP\">DMXPR_LICCOST_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_CODE\">전체</Col><Col id=\"CD_CODE\"/></Row><Row><Col id=\"DS_CODE\">미평가</Col><Col id=\"CD_CODE\">0</Col></Row><Row><Col id=\"DS_CODE\">평가중</Col><Col id=\"CD_CODE\">1</Col></Row><Row><Col id=\"DS_CODE\">탈락</Col><Col id=\"CD_CODE\">2</Col></Row><Row><Col id=\"DS_CODE\">평가제외</Col><Col id=\"CD_CODE\">3</Col></Row><Row><Col id=\"DS_CODE\">등록심의</Col><Col id=\"CD_CODE\">4</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_JUDGE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BUMUN\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LICCOST\" type=\"STRING\" size=\"256\"/><Column id=\"ID_DAM\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"TY_RESULT\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SELECTION\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_LICCOST\"/><Col id=\"TY_RESULT\"/><Col id=\"TY_SELECTION\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_SELECTION", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_CODE\">전체</Col><Col id=\"CD_CODE\"/></Row><Row><Col id=\"CD_CODE\">등록</Col><Col id=\"DS_CODE\">등록</Col></Row><Row><Col id=\"CD_CODE\">탈락</Col><Col id=\"DS_CODE\">탈락</Col></Row><Row><Col id=\"CD_CODE\">평가제외</Col><Col id=\"DS_CODE\">평가제외</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_LICCOST","ctclYR_JUDGE:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("품목");
            ...
            obj = new Combo("ccboCD_BUMUN","staCD_LICCOST:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new Combo("ccboCD_LICCOST","ccboCD_BUMUN:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            ...
            obj = new Combo("ccboID_DAM","staID_DAM:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staDS_VENDOR","0.0","staYR_JUDGE:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("회사명");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Edit("ctxtDS_VENDOR","staDS_VENDOR:0.0","staYR_JUDGE:10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_value("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTY_REVIEW","ctxtDS_VENDOR:0.0","staYR_JUDGE:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("심의결과");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboTY_SELECTION","staTY_REVIEW:0.0","staYR_JUDGE:10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_innerdataset("dsTY_SELECTION");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            obj.set_text("전체");
            obj.set_value("");
            ...
            obj = new Static("staTY_RESULT","ccboTY_SELECTION:0.0","staYR_JUDGE:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("평과결과");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboTY_RESULT","staTY_RESULT:0.0","staYR_JUDGE:10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            ...
            obj = new BindItem("item1","divSearch.form.ccboCD_BUMUN","value","dsSearch","CD_BUMUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.ccboCD_LICCOST","value","dsSearch","CD_LICCOST");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.ccboID_DAM","value","dsSearch","ID_DAM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item5","divSearch.form.ccboTY_SELECTION","value","dsSearch","TY_SELECTION");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCA_JUDGE_REGULAR_RESULT_LIST_DC.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        /*
        	현재 심의결과/평과결과 컬럼명 일부 임의로 지정.
        	콤보박스 Dataset 값들도 임의로 지정된 상태.
        	차후 수정 가능성 높음.
        	수정되면 해당 주석 지워주세요~
        */
        ...
        this.loadIncludeScript("DCA_JUDGE_REGULAR_RESULT_LIST_DC.xfdl");
