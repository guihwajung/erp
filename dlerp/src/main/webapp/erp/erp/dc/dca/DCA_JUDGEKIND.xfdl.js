(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCAPR_JUDGEKIND_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DCAPR_JUDGEKIND_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCAPR_JUDGEKIND_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCAPR_JUDGEKIND_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divSearch.form.ctclYR_JUDGE.form.TextBox","value","dsSearch","YR_JUDGE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCA_JUDGEKIND.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btn1 = this.gfnFormButtonAdd("btnItem", "fnItem");
        };
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCA_JUDGEKIND");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DS_JUDGEKIND", "string");
        	...
        	this.dsUpdate.addColumn("DS_JUDGEKIND", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DS_JUDGEKIND", this.dsList.getColumn(i, "DS_JUDGEKIND"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "DS_JUDGEKIND", this.dsList.getColumn(i, "DS_JUDGEKIND"));
        ...
        this.fnItem = function() {
        	...
        	param.DS_JUDGEKIND = this.dsList.getColumn(this.dsList.rowposition, "DS_JUDGEKIND");

        	// 화면 오픈.
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCA_JUDGEITEM", "", param);
        }
        ...
        this.loadIncludeScript("DCA_JUDGEKIND.xfdl");
