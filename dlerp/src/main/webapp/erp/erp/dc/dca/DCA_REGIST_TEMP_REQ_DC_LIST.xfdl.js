(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DCA_REGIST_TEMP_REQ_DC_LIST.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnInsertDLG = this.gfnFormButtonAdd("btnInsertDLG", "fnInsertDLG");
        ...
        this.fnInsertDLG = function() {
           ...
           this.gfnFormOpenNonAuth("DCA", "DCA_REGIST_TEMP_REQ_DC_DLG", "fnInsertDLG_callback", param, 600, 420);
        ...
        this.fnAPP = function(obj,e) {
        	...
        	// 타 모듈 화면 호출시 지정할것.
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCA_REGIST_TEMP_APP", "fnAprvDialogCallback", param);
        ...
        this.loadIncludeScript("DCA_REGIST_TEMP_REQ_DC_LIST.xfdl");
