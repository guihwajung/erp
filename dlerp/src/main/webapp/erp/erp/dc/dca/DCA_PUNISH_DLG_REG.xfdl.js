(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DCZPR_PUNISH_INSERT</Col></Row></Rows>");
            ...
            obj = new Div("ccfCF_SITE","119","104",null,"20","7",null,null,null,null,null,this.divData.form);
            ...
            obj = new Div("ccfCD_VENDOR","staCD_VENDOR:10","45",null,"20","7",null,null,null,null,null,this.divData.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("17");
            ...
            obj = new BindItem("item3","divData.form.ccfCF_SITE.form.CDTextBox","value","dsList","CD_REQUEST");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.ccfCF_SITE.form.DSTextBox","value","dsList","DS_REQUEST");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCA_PUNISH_DLG_REG.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DCA_PUNISH_DLG_REG.xfdl");
