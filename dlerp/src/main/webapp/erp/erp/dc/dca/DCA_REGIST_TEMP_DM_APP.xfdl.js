(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("가등록평가(자재)-품의서");
        ...
        // User Script
        this.registerScript("DCA_REGIST_TEMP_DM_APP.xfdl", function() {
        ...
        this.loadIncludeScript("DCA_REGIST_TEMP_DM_APP.xfdl");
