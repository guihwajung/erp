(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_LIST_M_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_LIST_M_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_LIST_M_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_LIST_M_DELETE</Col></Row><Row><Col id=\"TARGET\">regist</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_LIST_REGIST</Col></Row><Row><Col id=\"TARGET\">registcancel</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_LIST_REGIST_CANCEL</Col></Row><Row><Col id=\"TARGET\">autojudge</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_LIST_AUTO_JUDGE</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_LIST_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCA_JUDGE_REGULAR_LIST_M.xfdl", function() {
        ...
        this.loadIncludeScript("DCA_JUDGE_REGULAR_LIST_M.xfdl");
