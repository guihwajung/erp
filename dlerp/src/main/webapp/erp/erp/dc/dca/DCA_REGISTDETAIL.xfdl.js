(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtDS_PRESIDENT","sta03:5","61","238","20",null,null,null,null,null,null,this.divData.form.tabData.tab00.form.div_STD.form);
            obj.set_taborder("33");
            this.divData.form.tabData.tab00.form.div_STD.addChild(obj.name, obj);

            obj = new Edit("edtNO_PRESIDENT_HP","sta04:5","61","238","20",null,null,null,null,null,null,this.divData.form.tabData.tab00.form.div_STD.form);
            obj.set_taborder("34");
            this.divData.form.tabData.tab00.form.div_STD.addChild(obj.name, obj);
            ...
            obj = new Edit("edtDS_LOCATION","125","119","238","20",null,null,null,null,null,null,this.divData.form.tabData.tab00.form.div_STD.form);
            obj.set_taborder("45");
            this.divData.form.tabData.tab00.form.div_STD.addChild(obj.name, obj);

            obj = new MaskEdit("edtNO_SJC","sta00:5","32","238","20",null,null,null,null,null,null,this.divData.form.tabData.tab00.form.div_STD.form);
            obj.set_taborder("46");
            obj.set_format("9999999999");
            ...
            obj = new Static("staMsg",null,"0","150","22","13",null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("(단위 : 원)");
            ...
            obj = new BindItem("item14","divData.form.tabData.tab00.form.div_STD.form.edtDS_LOCATION","value","dsList","DS_LOCATION");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divData.form.tabData.tab00.form.div_STD.form.edtNO_SJC","value","dsList","NO_SJC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCA_REGISTDETAIL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.divSearch.form.ccfCD_ITEM.AfterCDTextChanged = "fnAfterCDTextChanged";
        //	this.divSearch.form.ccfCD_ITEM.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        };
        ...
        // 	if(this.gfnIsNull(this.dsSearch.getColumn(0, "DT_INPUT"))) {
        // 		this.gfnAlert("거래처코드를 먼저 선택해 주십시오.");
        // 		return;
        // 	}
        ...
        this.fnEcredible = function(obj, e){
        	...
        	window.open(strLink, 'watchwin', 'height=768, width=1024, status=no, scrollbars=yes, resizable=yes');
        };
        ...
        */
        ...
        {
        // 	strLink = "http://www.k-srm.co.kr/refbfautologin.do";
        // 	window.open(strLink, 'go_ksrm', 'height=150, width=900, scrollbars=no');
        // 	return;

        	this.dsSiteKey = new Dataset();

        	var strSvcId    = "ksrm";
        	var strSvcType  = "/auth/ksrm";
        	var inProc		= "";
        	var inData      = "";
        	var outData     = "dsSiteKey=output0";
        	var strArg      = "";
        	var callBackFnc = "fnSiteKey_callback";
        ...
        this.fnSiteKey_callback = function(svcID, errorCode, errorMsg)
        {
        	if (errorCode == 0)
        	{
        		if(this.gfnIsNull(this.dsList.getColumn(0, "NO_SJC"))) return;
        		...
        		var strNoSjc = this.dsList.getColumn(0, "NO_SJC");
        		var siteKey = this.dsSiteKey.getColumn(0, "siteKey");

        		strLink = "http://www.k-srm.co.kr/refbfautologin.do?acctp=J1&isSSL=&ID=DSMEC&siteKey=" + siteKey + "&BZNO=" + strNoSjc;
        		window.open(strLink, 'go_ksrm', 'height=600, width=900, status=no, scrollbars=yes, resizable=yes');
        	}
        	else
        	{
        		this.gfnAlert(errorMsg);
        ...
        this.fnSaveAction00 = function(){
        	...
        	this.dsInsert0.addColumn("DS_LOCATION", "string");
        	...
        	this.dsUpdate0.addColumn("DS_LOCATION", "string");
        	...
        	if(this.gfnIsNull(this.dsList.getColumn(0, "CD_VENDOR")))
        	{
        		...
        		this.dsInsert0.setColumn(nrow, "DS_LOCATION", this.dsList.getColumn(0, "DS_LOCATION"));
        		...
        		this.dsUpdate0.setColumn(nrow, "DS_LOCATION", this.dsList.getColumn(0, "DS_LOCATION"));
        ...
        this.fnAfterCDTextChanged = function(id, codeFindData){
        	...
        	if(id == "ccfCD_ITEM") {
        		this.dsSearch.setColumn(0, "DT_INPUT", arr[0].DT_INPUT);
        	}
        };
        });
        ...
        this.loadIncludeScript("DCA_REGISTDETAIL.xfdl");
