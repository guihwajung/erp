(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"VALUE\">전체</Col><Col id=\"CODE\"/></Row><Row><Col id=\"VALUE\">위탁요청</Col><Col id=\"CODE\">0</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"VALUE\">위탁반려</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"VALUE\">위탁확인</Col></Row><Row><Col id=\"CODE\">4</Col><Col id=\"VALUE\">검수요청</Col></Row><Row><Col id=\"CODE\">5</Col><Col id=\"VALUE\">검수반려</Col></Row><Row><Col id=\"CODE\">6</Col><Col id=\"VALUE\">검수완료</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("DCH_WORKORDER_ASK.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0, "YN_BONSA", "N");
         ...
         ************************************************************************/
         this.fnWorkOrder = function(obj,e)
         {
        	...
        	param.YN_BONSA 	= this.dsList.getColumn(this.dsList.rowposition, "YN_BONSA");

        	// 화면 오픈.
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.
        //	this.gfnFormOpenNonAuth("DCH", "DCH_WORKORDER_REQUEST", "fnWorkOrder_callback", param, 850, 700);
        	this.gfnFormOpen("DCH", "DCH_WORKORDER_RESPONSE", "fnWorkOrder_callback", param, 850, 770);
         };
        ...
        this.loadIncludeScript("DCH_WORKORDER_ASK.xfdl");
