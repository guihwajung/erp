(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCCPR_CONTRACTLIST_SELECT</Col></Row><Row><Col id=\"TARGET\">download</Col><Col id=\"SP\">DCCPR_CONTRACTFILELIST_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_CODE_LIST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_CONT\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CONT\" type=\"STRING\" size=\"256\"/><Column id=\"SN_MAX\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LICENSE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"NO_CONT\"/><Col id=\"DT_FROM\"/><Col id=\"DT_TO\"/><Col id=\"SN_MAX\"/><Col id=\"CD_LICENSE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsDownloadList", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cboCD_LICENSE","ccboSN_MAX:0.0","sta00:10.0","183","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Static("staCD_SITE00_00","cboCD_LICENSE:0.0","sta00:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_text("면허구분");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new BindItem("item7","divSearch.form.cboCD_LICENSE","value","dsSearch","CD_LICENSE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCC_CONTRACTQRY.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_SITE)
        		...
        		&& !this.gfnIsNull(this.getOwnerFrame().TY_SYS))
        	{
        		this.dsSearch.setColumn(0, "CD_SITE", this.getOwnerFrame().CD_SITE);
        		this.divSearch.form.ccfCD_SITE.form.DSTextBox.set_value(this.getOwnerFrame().DS_SITE);
        		this.dsSearch.setColumn(0, "NO_CONT", this.getOwnerFrame().NO_HADOCONT);
        		this.divSearch.form.ccfNO_CONT.form.DSTextBox.set_value(this.getOwnerFrame().DS_HADOCONT);
        		this.dsSearch.setColumn(0, "DT_FROM", "");
        		this.dsSearch.setColumn(0, "DT_TO", "");
        		this.ty_Sys = this.getOwnerFrame().TY_SYS;

        		this.FormBtns.Select.click();
        	}else{
        		this.ty_Sys = this.FormInfo.DS_PARAM;
        		var today = this.gfnGetDate();
        		this.dsSearch.setColumn(0, "DT_FROM", this.gfnAddMonth(today,-2));
        ...
        this.fnSetButton = function() {
        	...
        	// R41	외주구매팀장권한
        	// R99	운영자권한
        	// 20200722 건축CS팀 요청으로 권한 추가
        	// R45	CS팀 권한

        // 	if(cd_role!="R40" && cd_role!="R41" && cd_role!="R99" && cd_role!="R45")
        // 	{
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCC_CONTRACTQRY");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "TY_SYS", this.ty_Sys);
        ...
        this.fnPreviewContFile = function() {
        	...
        	var NO_CONT = this.dsList.getColumn(this.dsList.rowposition, "NO_CONT");
        	var SN_SEQ = this.dsList.getColumn(this.dsList.rowposition, "SN_SEQ");
        ...
        this.fnDownload = function() {
        	...
        	this.dsDownload.addColumn("NO_CONT", "string");
        	this.dsDownload.addColumn("SN_SEQ", "string");

        	this.dsDownload.addRow();
        	this.dsDownload.setColumn(0, "NO_CONT", this.dsList.getColumn(this.dsList.rowposition, "NO_CONT"));
        	this.dsDownload.setColumn(0, "SN_SEQ", this.dsList.getColumn(this.dsList.rowposition, "SN_SEQ"));

        	var strSvcId    = "select";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
        	var inData      = "download=dsDownload";
        	var outData     = "dsDownloadList=download0";
        	var strArg      = "";
        	var callBackFnc = "fnDownload_callback";
        ...
        this.fnDownload_callback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "select") {
        		for(var i = 0; i < this.dsDownloadList.getRowCount(); i++) {
        			var sFilename = this.dsDownloadList.getColumn(i, "FILE_NM");
        			var sFilepath = this.dsDownloadList.getColumn(i, "PATH_NM");
        ...
        this.dsList_onrowposchanged = function(obj,e)
        {
        	...
        	var type = this.dsList.getColumn(e.newrow, "YN_E_CONT");
        	if(type == "Y")
        	{
        		this.btnPreviewContFile.set_enable(true);
        		//this.btnDownload.set_enable(true);
        	}
        	else
        	{
        		this.btnPreviewContFile.set_enable(false);
        ...
        this.fnSetCombo = function() {
        	...
        	var outData     = "dsCD_LICENSE=combo0";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.loadIncludeScript("DCC_CONTRACTQRY.xfdl");
