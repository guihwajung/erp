(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staCD_VENDOR","0","30","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("0");
            obj.set_text("업체명");
            ...
            obj = new Static("staBgCD_VENDOR","staCD_VENDOR:-1","30","490","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staSN_SEQ","608","30","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("2");
            obj.set_text("현장명");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgSN_SEQ","staSN_SEQ:-1","30",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staTY_CONT","0","staCD_VENDOR:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("4");
            obj.set_text("변경구분");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgTY_CONT","staTY_CONT:-1","staCD_VENDOR:-1","490","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staDT_REQUEST","608","staSN_SEQ:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("6");
            obj.set_text("공사명");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgDT_REQUEST","staDT_REQUEST:-1","staSN_SEQ:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staAM_DOKUBPREV","0","staTY_CONT:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("8");
            obj.set_text("당초도급금액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgAM_DOKUBPREV","staAM_DOKUBPREV:-1","staTY_CONT:-1","490","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staAM_SILHENGPREV","0","staAM_DOKUBPREV:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("10");
            obj.set_text("당초예산금액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgAM_SILHENGPREV","staAM_SILHENGPREV:-1","staAM_DOKUBPREV:-1","490","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staAM_DOKUB","608","staDT_REQUEST:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("12");
            obj.set_text("변경도급금액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgAM_DOKUB","staAM_DOKUB:-1","staBgDT_REQUEST:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staAM_SILHENG","608","staAM_DOKUB:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("14");
            obj.set_text("변경예산금액");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgAM_SILHENG","staAM_SILHENG:-1","staAM_DOKUB:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staAM_CONTPROPREV","0","staAM_SILHENGPREV:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("16");
            ...
            obj = new Static("staBgAM_CONTPROPREV","staAM_CONTPROPREV:-1","staAM_SILHENGPREV:-1","490","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staAM_CONTPRO","608","staAM_SILHENG:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("18");
            obj.set_text("변경공급가");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgAM_CONTPRO","staAM_CONTPRO:-1","staAM_SILHENG:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staAM_CONTVATPREV","0","staAM_CONTPROPREV:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("20");
            ...
            obj = new Static("staBgAM_CONTVATPREV","staAM_CONTVATPREV:-1","staAM_CONTPROPREV:-1","490","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("21");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staAM_CONTVAT","608","staAM_CONTPRO:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("22");
            obj.set_text("변경부가세");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgAM_CONTVAT","staAM_CONTVAT:-1","staAM_CONTPRO:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staDT_WORKPREV","0","staAM_CONTVATPREV:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("24");
            obj.set_text("당초공사기간");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgDT_WORKPREV","staDT_WORKPREV:-1","staBgAM_CONTVATPREV:-1","490","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staDT_WORK","608","staAM_CONTVAT:-1","120","30",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("26");
            obj.set_text("변경공사기간");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgDT_WORK","staDT_WORK:-1","staAM_CONTVAT:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("27");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staDS_REASON","0","staDT_WORKPREV:-1","120","116",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("28");
            obj.set_text("변경사유");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgDS_REASON","staDS_REASON:-1","staDT_WORKPREV:-1",null,"116","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staRM_BIGO","0","staDS_REASON:-1","120","87",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("30");
            obj.set_text("비고");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBgRM_BIGO","staRM_BIGO:-1","staDS_REASON:-1",null,"87","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("31");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Edit("txtCD_VENDOR","staCD_VENDOR:5","34","475","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("32");
            obj.set_enable("true");
            ...
            obj = new TextArea("txtDS_REASON","staDS_REASON:5","staDT_WORKPREV:5",null,"104","7",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("33");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            obj.set_border("0px none");
            ...
            obj = new TextArea("txtRM_BIGO","staRM_BIGO:5","txtDS_REASON:11",null,"75","7",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("34");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            obj.set_border("0px none");
            ...
            obj = new Edit("txtTY_CONT","125","64","475","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("35");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtDT_CONT_PRE","125","209","475","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("36");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtDT_CONT","733","209","407","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("37");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtDS_SITE","733","35","407","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("38");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtDS_CONT","733","64","407","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("39");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_DOKUBPREV","125","93","475","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("40");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_SILHENGPREV","125","122","475","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("41");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_CONTPROPREV","125","151","475","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("42");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_CONTVATPREV","125","180","475","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("43");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_DOKUB","733","93","407","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("44");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_SILHENG","733","122","407","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("45");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_CONTPRO","733","151","407","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("46");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_CONTVAT","733","180","407","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("47");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new BindItem("item25","divData1.form.divDataInfo.form.txtCD_VENDOR","value","dsList","DS_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item33","divData1.form.divDataInfo.form.txtDS_REASON","value","dsList","DS_REASON");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item44","divData1.form.divDataInfo.form.txtRM_BIGO","value","dsList","RM_BIGO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divData1.form.divDataInfo.form.txtTY_CONT","value","dsList","TY_CONT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divData1.form.divDataInfo.form.txtDT_CONT_PRE","value","dsList","DT_CONT_PRE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divData1.form.divDataInfo.form.txtDT_CONT","value","dsList","DT_CONT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divData1.form.divDataInfo.form.txtDS_SITE","value","dsList","DS_SITE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divData1.form.divDataInfo.form.txtDS_CONT","value","dsList","DS_CONT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","divData1.form.divDataInfo.form.txtAM_DOKUBPREV","value","dsList","AM_DOKUBPREV");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","divData1.form.divDataInfo.form.txtAM_SILHENGPREV","value","dsList","AM_SILHENGPREV");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divData1.form.divDataInfo.form.txtAM_CONTPROPREV","value","dsList","AM_CONTPROPREV");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","divData1.form.divDataInfo.form.txtAM_CONTVATPREV","value","dsList","AM_CONTVATPREV");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divData1.form.divDataInfo.form.txtAM_DOKUB","value","dsList","AM_DOKUB");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","divData1.form.divDataInfo.form.txtAM_SILHENG","value","dsList","AM_SILHENG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item17","divData1.form.divDataInfo.form.txtAM_CONTPRO","value","dsList","AM_CONTPRO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item18","divData1.form.divDataInfo.form.txtAM_CONTVAT","value","dsList","AM_CONTVAT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCC_REQCHANGE_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DC06";	//	변경내역품의
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_CONT", this.dsListMaster.getColumn(0, "V_PARAM02"));
        	this.dsSelect.setColumn(0, "SN_SEQ", this.dsListMaster.getColumn(0, "V_PARAM03"));
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData1.form.divDataInfo.form.staAM_CONTVATPREV.addEventHandler("onclick",this.divData_divDataRight_sta01_onclick,this);
        };
        this.loadIncludeScript("DCC_REQCHANGE_APP.xfdl");
