(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCCPR_HD_CONTRACTFILE_SELECT_HD</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DCCPR_HD_CONTRACTFILE_SAVE</Col></Row><Row><Col id=\"SP\">DCCPR_CONTFILE_INIT_INSERT_HD</Col><Col id=\"TARGET\">exec</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new FileDownTransfer("FileDownTransferContractfileG", this);
            this.addChild(obj.name, obj);
            ...
            obj.getSetter("CodeFindName").set("DCX_CFCONTRACT_01_HD");
            ...
            obj.getSetter("CodeFindName").set("DCX_CFSNSEQ_01_HD");
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("5");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCC_CONTRACTFILE_G.xfdl", function() {
        ...
        this.fnSelect = function() {
        	...
        	this.filepath = "/CONT/" + this.dsSearch.getColumn(0, "CD_SITE") + "/" + this.dsSearch.getColumn(0, "NO_CONT") + "/" + this.dsSearch.getColumn(0, "SN_SEQ");
        ...
        this.fnDownload = function() {
        	...
        	this.FileDownTransferContractfileG.set_url(surl);
        	this.FileDownTransferContractfileG.setPostData("path", sFilepath);
        	this.FileDownTransferContractfileG.setPostData("fileName", encodeFileName);
        	if( system.navigatorname =="nexacro"){
        		this.FileDownTransferContractfileG.set_downloadfilename(sFilename);
        	}
        	this.FileDownTransferContractfileG.download();
        };
        ...
        this.loadIncludeScript("DCC_CONTRACTFILE_G.xfdl");
