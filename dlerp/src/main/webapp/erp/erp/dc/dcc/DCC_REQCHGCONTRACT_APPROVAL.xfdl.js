(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCCPR_REQCHGCONTRACT_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCCPR_REQCHGCONTRACT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCCPR_REQCHGCONTRACT_DELETE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DCCPR_REQCHGCONTRACT_INSERT</Col></Row><Row><Col id=\"TARGET\">exec1</Col><Col id=\"SP\">DCCPR_REQCHGCONTRACT_COMPLETE_UPDATE</Col></Row><Row><Col id=\"TARGET\">appr_select</Col><Col id=\"SP\">DZRPR_AP_STATE_SELECT</Col></Row><Row><Col id=\"TARGET\">aplines</Col><Col id=\"SP\">DZRPR_APPLINES_SELECT</Col></Row><Row><Col id=\"SP\">DZZPR_APPROVAL_CALLBACK</Col><Col id=\"TARGET\">execAppr</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divDataApprLeft","0","0","50%","79",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_background("");
            ...
            obj = new Edit("txtDS_VENDOR","txtCD_VENDOR:3","staTitle:9","261","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("29");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.divData.form.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("txtAM_DOKUBPREV","staAM_DOKUBPREV:5","cboTY_CONT:9","293","20",null,null,null,null,null,null,this.divData.form.divData.form);
            ...
            obj = new MaskEdit("txtAM_SILHENGPREV","staAM_SILHENGPREV:5","txtAM_DOKUBPREV:9","293","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_format("9,999");
            obj.set_taborder("43");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("txtAM_DOKUB","staAM_DOKUB:5","ctclDT_REQUEST:9","293","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("45");
            obj.set_format("9,999");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("txtAM_SILHENG","staAM_SILHENG:5","txtAM_DOKUB:9","293","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("47");
            obj.set_format("9,999");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("txtAM_CONTPROPREV","staAM_CONTPROPREV:5","txtAM_SILHENGPREV:9","293","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_format("9,999");
            obj.set_taborder("36");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("txtAM_CONTPRO","staAM_CONTPRO:5","txtAM_SILHENG:9","293","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_format("9,999");
            obj.set_taborder("38");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("txtAM_CONTVATPREV","staAM_CONTVATPREV:5","txtAM_CONTPROPREV:9","293","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_format("9,999");
            obj.set_taborder("40");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("txtAM_CONTVAT","staAM_CONTVAT:5","txtAM_CONTPRO:9","293","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("42");
            obj.set_format("9,999");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new TextArea("txtDS_REASON","staDS_REASON:5","ctclFR_WORKPREV:11","865","105",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("50");
            obj.set_readonly("true");
            this.divData.form.divData.addChild(obj.name, obj);
            ...
            obj = new Static("sta72","sta73:-1","staDS_REASON:20","378","30",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("53");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData.addChild(obj.name, obj);
            ...
            obj = new Static("sta71","sta70:-1","staDS_REASON:20","378","30",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("52");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData.addChild(obj.name, obj);

            obj = new Div("ccfSABUNSITE","125","staDS_REASON:25","368","20",null,null,null,null,null,null,this.divData.form.divData.form);
            ...
            obj = new Div("ccfBONSA","sta70:5","staDS_REASON:25","365","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.getSetter("CodeFindName").set("DZX_CFUSER");
            ...
            obj = new BindItem("item10","divData.form.divData.form.txtSN_SEQ","value","dsSearch","SN_SEQ");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item18","divData.form.divData.form.txtAM_DOKUBPREV","value","dsList","AM_DOKUBPREV");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item23","divData.form.divData.form.txtAM_DOKUB","value","dsList","AM_DOKUB");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCC_REQCHGCONTRACT_APPROVAL.xfdl", function() {
        ...
        */
        ...
        // 결제상신
         this.fnAprvSang = function(obj,e) {
        	...
        	param.ID_AP_TYPE = "DC02";
        	param.V_PARAM01 = this.dsSearch.getColumn(0, "CD_SITE");
        	param.V_PARAM02 = this.dsSearch.getColumn(0,"NO_CONT");
        	param.V_PARAM03 = this.dsSearch.getColumn(0,"SN_SEQ");
        	param.V_PARAM04 = "";
        	param.DS_TITLE =  "변경승인요청(현장) 품의서";
        ...
        this.loadIncludeScript("DCC_REQCHGCONTRACT_APPROVAL.xfdl");
