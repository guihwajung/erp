(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCCPR_CONT_FILE_MIG_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DCCPR_HD_CONTRACTFILE_SAVE</Col></Row><Row><Col id=\"SP\">DCCPR_CONTFILE_INIT_INSERT</Col><Col id=\"TARGET\">exec</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00","sta01:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("차수");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtNO_CONT","sta00:0.0","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_value("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtSN_SEQ","sta00:0.0","10.0","89","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_value("");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divSearch.form.ctxtNO_CONT","value","dsSearch","NO_CONT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.ctxtSN_SEQ","value","dsSearch","SN_SEQ");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCC_CONT_FILE_MIG.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.ctxtNO_CONT = this.divSearch.form.ctxtNO_CONT;
        	this.ctxtSN_SEQ = this.divSearch.form.ctxtSN_SEQ;
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCC_CONT_FILE_MIG");
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0, "NO_CONT"))) {
        		...
        		this.fnVaidateCallback = function() {
        			this.divSearch.form.ctxtNO_CONT.setFocus();
        		}
        		...
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			this.divSearch.form.ctxtSN_SEQ.setFocus();
        		}
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.ctxtNO_CONT.addEventHandler("onchanged",this.divSearch_ctxtDS_SITE_onchanged,this);
            this.divSearch.form.ctxtSN_SEQ.addEventHandler("onchanged",this.divSearch_ctxtDS_SITE_onchanged,this);
        ...
        this.loadIncludeScript("DCC_CONT_FILE_MIG.xfdl");
