(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAZPR_LABORINCSUBST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAZPR_LABORINCSUBST_INSERT</Col></Row><Row><Col id=\"SP\">DAZPR_LABORINCSUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DAZPR_LABORINCSUBST_DELETE</Col><Col id=\"TARGET\">delete</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAZ_LABORINCSUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAZ_LABORINCSUBST");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		if(flag == "I" || flag == "U"){
        			if(this.dsList.getColumn(i, "FR_AMOUNT") > this.gfnNvl(this.dsList.getColumn(i, "TO_AMOUNT"), 0)) {
        				var alertMessage = "공제범위[FROM]의 값보다 작은값이 [TO]에 들어갈 수 없습니다.";
        ...
        this.loadIncludeScript("DAZ_LABORINCSUBST.xfdl");
