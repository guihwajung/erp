(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_text("식대내역 가져오기");
            obj.set_cssclass("sta_TITLE_Bg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staCD_CORP","0","sta_TITLE:10","65","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("법인");
            ...
            obj = new Static("staDT_WORK_bg","staDT_WORK:-1","staDT_WORK:-30","262","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Calendar("ctclFR_WORK","70","staDT_WORK:-25","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            ...
            obj = new Div("divBtns","96","staDT_WORK:10","130","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnOK","0","divData:0","60","27",null,null,null,null,null,null,this.divData.form.divBtns.form);
            obj.set_taborder("0");
            obj.set_text("확인");
        ...
        // User Script
        this.registerScript("DAG_FOODCOST_DLG2.xfdl", function() {
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg){
        	if(svcID == "save") {
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("식대내역 가져오기 완료되었습니다.", "fnSaveAfter");
        		} else {
        ...
        this.loadIncludeScript("DAG_FOODCOST_DLG2.xfdl");
