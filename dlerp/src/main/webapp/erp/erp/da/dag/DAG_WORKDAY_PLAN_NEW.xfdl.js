(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAGPR_WORKDAY_SELECT</Col></Row><Row><Col id=\"SP\">DAGPR_WORKDAY_COMBO</Col><Col id=\"TARGET\">selectDt</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAGPR_WORKDAY_UPDATE_NEW</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"ID_PERSON\" type=\"STRING\" size=\"256\"/><Column id=\"DS_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"ID_SABUN\"/><Col id=\"ID_PERSON\"/><Col id=\"DS_WORK\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListDt", this);
            obj._setContents("<ColumnInfo><Column id=\"DT_WORK_START\" type=\"STRING\" size=\"256\"/><Column id=\"DT_WORK_END\" type=\"STRING\" size=\"256\"/><Column id=\"DS_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DT_WORK_START\"/><Col id=\"DT_WORK_END\"/><Col id=\"DS_WORK\"/><Col id=\"TY_GUBUN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYN_CLOSE","ccfID_SABUN:0.0","10.0","66.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("기한");
            obj.set_rtl("false");
            obj.set_cssclass("sta_WF_SchLabelE");
            ...
            obj = new Combo("cboDS_WORK","staYN_CLOSE:0.0","10.0","201","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_innerdataset("dsListDt");
            obj.set_codecolumn("DS_WORK");
            obj.set_datacolumn("DS_WORK");
            obj.set_value("%");
            obj.set_index("0");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_CORP00","cboDS_WORK:0.0","10.0","66.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item5","divSearch.form.cboDS_WORK","value","dsSearch","DS_WORK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAG_WORKDAY_PLAN_NEW.xfdl", function() {
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("DT_WORKDAY", "string");
        ...
        this.fnSelect = function() {
        	...
        	var nListDtRow = this.fnGetListDtRow();
        	//if(nListDtRow < 0){
        	//	this.gfnAlert("기한 선택 오류");
        	//	return false;
        	//}


        	this.dsSelect.setColumn(0, "CD_CORP", this.AuthClient.CD_CORP);
        	this.dsSelect.setColumn(0, "TY_GUBUN", this.dsListDt.getColumn(nListDtRow, "TY_GUBUN"));
        	this.dsSelect.setColumn(0, "DT_WORK_START", this.dsListDt.getColumn(nListDtRow, "DT_WORK_START"));
        	this.dsSelect.setColumn(0, "DT_WORK_END", this.dsListDt.getColumn(nListDtRow, "DT_WORK_END"));
        ...
        this.fnGetListDtRow = function(){
        	var sDS_WORK = this.divSearch.form.cboDS_WORK.value;
        	if(this.gfnIsNull(sDS_WORK)) return -9;

        	trace("sDS_WORK", sDS_WORK);
        	var nFindRow =  this.dsListDt.findRowExpr("DS_WORK == '" + sDS_WORK + "'");
        ...
        this.fnSave = function() {
        	...
        	this.dsSave.setColumn(0, "ID_PERSON", this.dsSearch.getColumn(0, "ID_PERSON"));
        	this.dsSave.setColumn(0, "CD_CORP", this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSave.setColumn(0, "ID_SABUN", this.dsSearch.getColumn(0, "ID_SABUN"));
        	this.dsSave.setColumn(0, "DT_WORK_START", this.dsListDt.getColumn(nListDtRow, "DT_WORK_START")); //조회조건_근로시작일
        	this.dsSave.setColumn(0, "DT_WORK_END", this.dsListDt.getColumn(nListDtRow, "DT_WORK_END")); //조회조건_근로종료일
        	this.dsSave.setColumn(nrow, "TY_PLAN", this.dsListDt.getColumn(nListDtRow, "TY_GUBUN")); //조회조건_탄력근무구분(2:2주 / 4:4주 /13:13주)
        	//this.dsSave.setColumn(0, "DT_WORKDAY", strData);
        ...
        // 근무일자|근무구분|소정시작시간|소정종료시간|연장근로시작시간|연장근로종료시간|주;
        // DT_WORK|CD_WORK|HH_SWORK:MM_SWORK|HH_EWORK:MM_EWORK|HH_SOVER:MM_SOVER|HH_EOVER:MM_EOVER|DS_WEEK;


        	var nCnt = 0;
        	var strData = "";
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		var sTY_GUBUN = this.dsList.getColumn(i,"TY_GUBUN");
        		if(sTY_GUBUN == "S") continue;

        		var flag = this.gfnGetFlag(this.dsList, i);


        		//if(flag == "U"){
        			var sDT_WORK = this.gfnNvl(this.dsList.getColumn(i, "DT_WORK"), "");//근무일자
        			var sCD_WORK = this.gfnNvl(this.dsList.getColumn(i, "CD_WORK"), "");//근무구분
        			var sSWORK = this.gfnNvl(this.dsList.getColumn(i, "HH_SWORK"), "")+TIME_SPLIT+this.gfnNvl(this.dsList.getColumn(i, "MM_SWORK"), ""); //소정시작시간
        			var sEWORK = this.gfnNvl(this.dsList.getColumn(i, "HH_EWORK"), "")+TIME_SPLIT+this.gfnNvl(this.dsList.getColumn(i, "MM_EWORK"), ""); //소정종료시간
        			var sSOVER = this.gfnNvl(this.dsList.getColumn(i, "HH_SOVER"), "")+TIME_SPLIT+this.gfnNvl(this.dsList.getColumn(i, "MM_SOVER"), ""); //연장근로시작시간
        			var sEOVER = this.gfnNvl(this.dsList.getColumn(i, "HH_EOVER"), "")+TIME_SPLIT+this.gfnNvl(this.dsList.getColumn(i, "MM_EOVER"), ""); //연장근로종료시간
        			var sDS_WEEK = this.gfnNvl(this.dsList.getColumn(i, "DS_WEEK"), "");//주

        			var sRowData = sDT_WORK + COL_SPLIT
        						+ sCD_WORK + COL_SPLIT
        						+ sSWORK + COL_SPLIT
        						+ sEWORK + COL_SPLIT
        						+ sSOVER + COL_SPLIT
        	...
        	trace("nCnt", nCnt);
        	if (nCnt == 0) return;
        	strData = this.gfnLeft(strData, strData.length - 1);
        	this.dsSave.setColumn(nrow, "DT_WORKDAY", strData);
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0,"DS_WORK"))) {
        		validate = false;
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			this.divSearch.form.cboDS_WORK.setFocus();
        		}
        		this.gfnAlert("기한을 선택하세요.", "fnVaidateCallback");
        		return false;
        	}
        ...
        // 	}
        	...
        	param.V2 = this.dsListDt.getColumn(nListDtRow, "DT_WORK_START");		// 근로기한 시작일
        	param.V3 = this.dsListDt.getColumn(nListDtRow, "DT_WORK_END");		// 근로기한 종료일
        	param.V4 = "";
        ...
        this.fnPlanCre = function(obj,e) {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DAG_WORKDAY_PLAN_NEW_DLG", "fnPlanCrecallback", param);
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.cboDS_WORK.addEventHandler("onitemchanged",this.fnSearchInit,this);
        ...
        this.loadIncludeScript("DAG_WORKDAY_PLAN_NEW.xfdl");
