(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DAB_BZTP_PLAN_RULE_DLG.xfdl", function() {
        ...
        this.fnSelect = function() {
        	...
        	{
        		this.dsImageFile.setColumn(0, "filename", "LOGO1_IMG.png");
        	}
        	else
        	{
        		this.dsImageFile.setColumn(0, "filename", "LOGO2_IMG.png");
        	}
        ...
        this.loadIncludeScript("DAB_BZTP_PLAN_RULE_DLG.xfdl");
