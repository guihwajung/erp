(function()
{
    return function()
    {
        ...
        {
            this.set_name("formTab3");
            this.set_titletext("유치원탭");
        ...
        // User Script
        this.registerScript("DAB_TUITION_APPROVE_TAB03.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.dsList3 = this.parentForm.dsList3;
        	this.dsList4 = this.parentForm.dsList4;
        	this.dsList5 = this.parentForm.dsList5;
        	this.parentForm.dxGrid3 = this.objGrid3;
        	this.parentForm.dxGrid4 = this.divData.form.objGrid4;
        	this.parentForm.dxGrid5 = this.divData.form.objGrid5;
        };
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.objGrid3, this.dsList3, "DA", "DAB_TUITION_LIST03");
        	this.gfnGridInit(this.divData.form.objGrid4, this.dsList4, "DA", "DAB_TUITION_LIST04");
        	this.gfnGridInit(this.divData.form.objGrid5, this.dsList5, "DA", "DAB_TUITION_LIST05");
        };
        ...
        this.loadIncludeScript("DAB_TUITION_APPROVE_TAB03.xfdl");
