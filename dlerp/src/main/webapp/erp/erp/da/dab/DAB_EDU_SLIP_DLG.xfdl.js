(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("maxheight").set("510");
            ...
            obj = new Static("staCD_PROOF_bg","109","259",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("34");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staDS_REM_bg00_00_00_01","109","144",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("31");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staAM_SUM_bg","109","346",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staAM_VAT","0","317","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("21");
            obj.set_text("부가세액");
            obj.set_visible("true");
            ...
            obj = new Static("staDS_REM_bg","staDS_REM:-1","173",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staAM_SUPPLY","0","288","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("19");
            obj.set_text("공급가액");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staAM_VAT_bg","staAM_VAT:-1","317",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("22");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_PROOF","0","259","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("17");
            obj.set_text("증빙선택");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staAM_SUPPLY_bg","staAM_SUPPLY:-1","288",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("20");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staID_ISSUE","0","230","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            ...
            obj = new Static("staNO_ACCOUNT_bg","staCD_PROOF:-1","201",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("18");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            obj.set_text("");
            ...
            obj = new Static("staAM_ACCOUNT","0","staDT_REQUEST:27","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            obj.set_text("교육지원금액");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staAM_SUPPORT_bg","staAM_ACCOUNT:-1","115",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staID_ISSUE_bg","staID_ISSUE:-1","230",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_SUPPORT","190","120","120","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_format("###,###,###,###,###,##0");
            obj.set_enable("false");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfID_ISSUE","115","235","231","20",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("ccfCD_PROOF","115","264",null,"20","5",null,null,null,null,null,this.divSearch.form);
            ...
            obj = new MaskEdit("mskAM_SUPPLY","115","293","120","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_format("###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            this.divSearch.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_VAT","115","322","120","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_format("###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staAM_SUM","0","346","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("27");
            obj.set_text("회계금액");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new MaskEdit("mskAM_SUM","115","351","120","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("28");
            obj.set_format("###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("staCD_PROOF00","0","144","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("30");
            obj.set_text("거래처");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Div("ccfCD_VENDOR","115","149",null,"20","5",null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staCD_PROOF01","0","201","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("32");
            obj.set_text("집행계좌");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Div("ccfNO_ACCOUNT","115","207",null,"20","5",null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("110");
            obj.set_taborder("33");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            ...
            obj = new Combo("cboCD_CURR","115","120","73","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("35");
            ...
            obj = new Static("staDT_REQUEST00","0","87","110","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("36");
            obj.set_text("귀속부서");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staDT_ACCOUNT_bg00_00","109","87",null,"30","0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("37");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_DEPT","115","92",null,"20","5",null,null,null,null,null,this.divSearch.form);
            ...
            obj = new BindItem("item15","divSearch.form.ccfCD_DEPT.form.CDTextBox","value","dsSearch","CD_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","divSearch.form.ccfCD_DEPT.form.DSTextBox","value","dsSearch","DS_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();
