(function()
{
    return function()
    {
        ...
        this.fnSave = function() {
        	...
        	} else if (this.cboTY_CERTIFICATE.value == "G" || this.cboTY_CERTIFICATE.value == "I") {
        		// G 갑종근로소득 원천징수확인서, I 근로소득 원천징수부 yyyyMM
        ...
        // 	this.calYM_INCOME_TO.form.TextBox.set_value("");
        	...
        	if (this.gfnIsNull(TY_CERTIFICATE) || TY_CERTIFICATE == "A" || TY_CERTIFICATE == "C" ||TY_CERTIFICATE == "E") {
        		this.ctclYY_TERM.set_visible(false);
        		this.ctclYY_TERM.set_enable(false);
        	} else if (TY_CERTIFICATE == "F" || TY_CERTIFICATE == "G" || TY_CERTIFICATE == "I") {
        		if (TY_CERTIFICATE == "F") {
        ...
        this.fnSaveValid = function() {
        	...
        	if (this.gfnIsNull(this.calYM_INCOME_FROM.form.TextBox.value) && (this.cboTY_CERTIFICATE.value === 'G')) {
        		this.fnValidCallback = function() {
        	...
        	if (this.gfnIsNull(this.calYM_INCOME_TO.form.TextBox.value) && (this.cboTY_CERTIFICATE.value === 'G')) {
        		this.fnValidCallback = function() {
