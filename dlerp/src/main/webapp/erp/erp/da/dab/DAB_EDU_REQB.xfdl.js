(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staBg17","79","225",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_tablebgT");
            obj.set_textAlign("right");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staFile","0","225","160","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("24");
            obj.set_cssclass("sta_WF_tablelabelTE");
            obj.set_text("교육관련문서첨부");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staFileUpload","staFile:8","230","146","24",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("26");
            obj.set_text("파일수 :  0 개");
            obj.set_cssclass("sta_WF_notice");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnATTACH","staFileUpload:18","230","73","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            obj.set_text("파일첨부");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta01","btnATTACH:8","227",null,"18","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("27");
            obj.set_text("※ 결제 영수증, 출석확인증 등 첨부");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SUPPORT","130","265","159","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("28");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_tabstop("false");
