(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("maxwidth").set("1155");
            ...
            obj = new Div("divData","0","divSearch:1",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTYPE","0","sta_TITLE_L:10","205","69",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("구분");
            ...
            obj = new Static("staTOTAL_COST_EST","staTYPE:-1","staTYPE:-69","185","69",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            obj.set_text("금회출장예산");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staCOST_EXEC","staTOTAL_COST_EST:-1","staTOTAL_COST_EST:-69","553","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            ...
            obj = new Static("staCOST_EXEC_REQ","staTOTAL_COST_EST:-1","67","185","40",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_text("신청금액");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staCOST_EXEC_REQ_EX","staCOST_EXEC_REQ:-1","staCOST_EXEC_REQ:-40","185","40",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staCOST_EXEC_SUBTOTAL","staCOST_EXEC_REQ_EX:-1","staCOST_EXEC_REQ_EX:-40","185","40",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staAM_ADVPGLD","staCOST_EXEC:-1","staCOST_EXEC:-30","171","69",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("22");
            obj.set_text("예산대비\r\n집행율(%)");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_IOUTBRUFLGTNOT","0","staTYPE:-1","205","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("입출국항공료");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_IOUTBRUFLGTNOT_EST_KRW_bg","staAM_IOUTBRUFLGTNOT:-1","staAM_IOUTBRUFLGTNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("24");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_IOUTBRUFLGTNOT_EXEC_REQ_bg","staAM_IOUTBRUFLGTNOT_EST_KRW_bg:-1","staAM_IOUTBRUFLGTNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_IOUTBRUFLGTNOT_EXEC_REQ_EX_bg","mskAM_IOUTBRUFLGTNOT_EXEC_REQ_bg:-1","mskAM_IOUTBRUFLGTNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("101");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_IOUTBRUFLGTNOT_SUBTOTAL_bg","staAM_IOUTBRUFLGTNOT_EXEC_REQ_EX_bg:-1","staAM_IOUTBRUFLGTNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("139");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_IOUTBRUFLGTNOT_EXEC_RATIO_bg","staAM_IOUTBRUFLGTNOT_SUBTOTAL_bg:-1","staAM_IOUTBRUFLGTNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_IOUTBRUFLGTNOT_EST_KRW","staAM_IOUTBRUFLGTNOT_EST_KRW_bg:-180","staAM_IOUTBRUFLGTNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("67");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_IOUTBRUFLGTNOT_EXEC_REQ","mskAM_IOUTBRUFLGTNOT_EXEC_REQ_bg:-180","mskAM_IOUTBRUFLGTNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("66");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_IOUTBRUFLGTNOT_EXEC_REQ_EX","staAM_IOUTBRUFLGTNOT_EXEC_REQ_EX_bg:-180","staAM_IOUTBRUFLGTNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("103");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_IOUTBRUFLGTNOT_SUBTOTAL","staAM_IOUTBRUFLGTNOT_SUBTOTAL_bg:-180","staAM_IOUTBRUFLGTNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("140");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_IOUTBRUFLGTNOT_EXEC_RATIO","staAM_IOUTBRUFLGTNOT_EXEC_RATIO_bg:-165","staAM_IOUTBRUFLGTNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("68");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_IOUTBRUFLGTNOT_BTN","staAM_IOUTBRUFLGTNOT_EXEC_RATIO_bg:0","staAM_IOUTBRUFLGTNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_TRANS","0","staAM_IOUTBRUFLGTNOT:-1","80","116",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("교통비");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_verticalAlign("middle");
            ...
            obj = new Static("staAM_RAILNOT","staAM_TRANS:-1","staAM_TRANS:-116","126","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("철도비");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_RAILNOT_EST_KRW_bg","staAM_RAILNOT:-1","staAM_RAILNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("27");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_RAILNOT_EXEC_REQ_bg","staAM_RAILNOT_EST_KRW_bg:-1","staAM_RAILNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_RAILNOT_EXEC_REQ_EX_bg","staAM_RAILNOT_EXEC_REQ_bg:-1","staAM_RAILNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("105");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_RAILNOT_SUBTOTAL_bg","staAM_RAILNOT_EXEC_REQ_EX_bg:-1","staAM_RAILNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("141");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_RAILNOT_EXEC_RATIO_bg","staAM_RAILNOT_SUBTOTAL_bg:-1","staAM_RAILNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("28");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_RAILNOT_EST_KRW","staAM_RAILNOT_EST_KRW_bg:-180","staAM_RAILNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("70");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_RAILNOT_EXEC_REQ","staAM_RAILNOT_EXEC_REQ_bg:-180","staAM_RAILNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("69");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_RAILNOT_EXEC_REQ_EX","staAM_RAILNOT_EXEC_REQ_EX_bg:-180","staAM_RAILNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("107");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_RAILNOT_SUBTOTAL","staAM_RAILNOT_SUBTOTAL_bg:-180","staAM_RAILNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("142");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_RAILNOT_EXEC_RATIO","staAM_RAILNOT_EXEC_RATIO_bg:-165","staAM_RAILNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("71");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_RAILNOT_BTN","staAM_RAILNOT_EXEC_RATIO_bg:0","staAM_RAILNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_SHIPNOT","staAM_TRANS:-1","staAM_TRANS:-87","126","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_text("선박비");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_SHIPNOT_EST_KRW_bg","staAM_SHIPNOT:-1","staAM_SHIPNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_SHIPNOT_EXEC_REQ_bg","staAM_SHIPNOT_EST_KRW_bg:-1","staAM_SHIPNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_SHIPNOT_EXEC_REQ_EX_bg","staAM_SHIPNOT_EXEC_REQ_bg:-1","staAM_SHIPNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("108");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_SHIPNOT_SUBTOTAL_bg","staAM_SHIPNOT_EXEC_REQ_EX_bg:-1","staAM_SHIPNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("143");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_SHIPNOT_EXEC_RATIO_bg","staAM_SHIPNOT_SUBTOTAL_bg:-1","staAM_SHIPNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("31");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SHIPNOT_EST_KRW","staAM_SHIPNOT_EST_KRW_bg:-180","staAM_SHIPNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("73");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SHIPNOT_EXEC_REQ","staAM_SHIPNOT_EXEC_REQ_bg:-180","staAM_SHIPNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("72");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SHIPNOT_EXEC_REQ_EX","staAM_SHIPNOT_EXEC_REQ_EX_bg:-180","staAM_SHIPNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("110");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SHIPNOT_SUBTOTAL","staAM_SHIPNOT_SUBTOTAL_bg:-180","staAM_SHIPNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("144");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SHIPNOT_EXEC_RATIO","staAM_SHIPNOT_EXEC_RATIO_bg:-165","staAM_SHIPNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("74");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_SHIPNOT_BTN","staAM_SHIPNOT_EXEC_RATIO_bg:0","staAM_SHIPNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_FLGTNOT","staAM_TRANS:-1","staAM_TRANS:-58","126","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_text("항공비");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_FLGTNOT_EST_KRW_bg","staAM_FLGTNOT:-1","staAM_FLGTNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("33");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_FLGTNOT_EXEC_REQ_bg","staAM_FLGTNOT_EST_KRW_bg:-1","staAM_FLGTNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("32");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_FLGTNOT_EXEC_REQ_EX_bg","staAM_FLGTNOT_EXEC_REQ_bg:-1","staAM_FLGTNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("113");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_FLGTNOT_SUBTOTAL_bg","staAM_FLGTNOT_EXEC_REQ_EX_bg:-1","staAM_FLGTNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("145");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_FLGTNOT_EXEC_RATIO_bg","staAM_FLGTNOT_SUBTOTAL_bg:-1","staAM_FLGTNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("34");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_FLGTNOT_EST_KRW","staAM_FLGTNOT_EST_KRW_bg:-180","staAM_FLGTNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("76");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_FLGTNOT_EXEC_REQ","staAM_FLGTNOT_EXEC_REQ_bg:-180","staAM_FLGTNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("75");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_FLGTNOT_EXEC_REQ_EX","staAM_FLGTNOT_EXEC_REQ_EX_bg:-180","staAM_FLGTNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("114");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_FLGTNOT_SUBTOTAL","staAM_FLGTNOT_SUBTOTAL_bg:-180","staAM_FLGTNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("146");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_FLGTNOT_EXEC_RATIO","staAM_FLGTNOT_EXEC_RATIO_bg:-165","staAM_FLGTNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("77");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_FLGTNOT_BTN","staAM_FLGTNOT_EXEC_RATIO_bg:0","staAM_FLGTNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CARNOT","staAM_TRANS:-1","staAM_TRANS:-29","126","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("자동차비");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_CARNOT_EST_KRW_bg","staAM_CARNOT:-1","staAM_CARNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("36");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CARNOT_EXEC_REQ_bg","staAM_CARNOT_EST_KRW_bg:-1","staAM_CARNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("35");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CARNOT_EXEC_REQ_EX_bg","staAM_CARNOT_EXEC_REQ_bg:-1","staAM_CARNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("115");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CARNOT_SUBTOTAL_bg","staAM_CARNOT_EXEC_REQ_EX_bg:-1","staAM_CARNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("147");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CARNOT_EXEC_RATIO_bg","staAM_CARNOT_SUBTOTAL_bg:-1","staAM_CARNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("37");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CARNOT_EST_KRW","staAM_CARNOT_EST_KRW_bg:-180","staAM_CARNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("79");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CARNOT_EXEC_REQ","staAM_CARNOT_EXEC_REQ_bg:-180","staAM_CARNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("78");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CARNOT_EXEC_REQ_EX","staAM_CARNOT_EXEC_REQ_EX_bg:-180","staAM_CARNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("117");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CARNOT_SUBTOTAL","staAM_CARNOT_SUBTOTAL_bg:-180","staAM_CARNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("148");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CARNOT_EXEC_RATIO","staAM_CARNOT_EXEC_RATIO_bg:-165","staAM_CARNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("80");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_CARNOT_BTN","staAM_CARNOT_EXEC_RATIO_bg:0","staAM_CARNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_LDGGNOT","0","staAM_TRANS:-1","205","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_text("숙박비");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_LDGGNOT_EST_KRW_bg","staAM_LDGGNOT:-1","staAM_LDGGNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("39");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_LDGGNOT_EXEC_REQ_bg","staAM_LDGGNOT_EST_KRW_bg:-1","staAM_LDGGNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("38");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_LDGGNOT_EXEC_REQ_EX_bg","staAM_LDGGNOT_EXEC_REQ_bg:-1","staAM_LDGGNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("119");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_LDGGNOT_SUBTOTAL_bg","staAM_LDGGNOT_EXEC_REQ_EX_bg:-1","staAM_LDGGNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("149");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_LDGGNOT_EXEC_RATIO_bg","staAM_LDGGNOT_SUBTOTAL_bg:-1","staAM_LDGGNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("40");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_LDGGNOT_EST_KRW","staAM_LDGGNOT_EST_KRW_bg:-180","staAM_LDGGNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("82");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_LDGGNOT_EXEC_REQ","staAM_LDGGNOT_EXEC_REQ_bg:-180","staAM_LDGGNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("81");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_LDGGNOT_EXEC_REQ_EX","staAM_LDGGNOT_EXEC_REQ_EX_bg:-180","staAM_LDGGNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("121");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_LDGGNOT_SUBTOTAL","staAM_LDGGNOT_SUBTOTAL_bg:-180","staAM_LDGGNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("150");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_LDGGNOT_EXEC_RATIO","staAM_LDGGNOT_EXEC_RATIO_bg:-165","staAM_LDGGNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("83");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_LDGGNOT_BTN","staAM_LDGGNOT_EXEC_RATIO_bg:0","staAM_LDGGNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CRMNNOT","0","staAM_LDGGNOT:-1","205","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            obj.set_text("식비");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_CRMNNOT_EST_KRW_bg","staAM_CRMNNOT:-1","staAM_CRMNNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("42");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CRMNNOT_EXEC_REQ_bg","staAM_CRMNNOT_EST_KRW_bg:-1","staAM_CRMNNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("41");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CRMNNOT_EXEC_REQ_EX_bg","staAM_CRMNNOT_EXEC_REQ_bg:-1","staAM_CRMNNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("122");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CRMNNOT_SUBTOTAL_bg","staAM_CRMNNOT_EXEC_REQ_EX_bg:-1","staAM_CRMNNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("151");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_CRMNNOT_EXEC_RATIO_bg","staAM_CRMNNOT_SUBTOTAL_bg:-1","staAM_CRMNNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("43");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CRMNNOT_EST_KRW","staAM_CRMNNOT_EST_KRW_bg:-180","staAM_CRMNNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("85");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CRMNNOT_EXEC_REQ","staAM_CRMNNOT_EXEC_REQ_bg:-180","staAM_CRMNNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("84");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CRMNNOT_EXEC_REQ_EX","staAM_CRMNNOT_EXEC_REQ_EX_bg:-180","staAM_CRMNNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("123");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CRMNNOT_SUBTOTAL","staAM_CRMNNOT_SUBTOTAL_bg:-180","staAM_CRMNNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("152");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CRMNNOT_EXEC_RATIO","staAM_CRMNNOT_EXEC_RATIO_bg:-165","staAM_CRMNNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("86");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_CRMNNOT_BTN","staAM_CRMNNOT_EXEC_RATIO_bg:0","staAM_CRMNNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCNOT","0","staAM_CRMNNOT:-1","205","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            obj.set_text("잡비");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_ETCNOT_EST_KRW_bg","staAM_ETCNOT:-1","staAM_ETCNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("45");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCNOT_EXEC_REQ_bg","staAM_ETCNOT_EST_KRW_bg:-1","staAM_ETCNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("44");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCNOT_EXEC_REQ_EX_bg","staAM_ETCNOT_EXEC_REQ_bg:-1","staAM_ETCNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("124");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCNOT_SUBTOTAL_bg","staAM_ETCNOT_EXEC_REQ_EX_bg:-1","staAM_ETCNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("153");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCNOT_EXEC_RATIO_bg","staAM_ETCNOT_SUBTOTAL_bg:-1","staAM_ETCNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("46");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCNOT_EST_KRW","staAM_ETCNOT_EST_KRW_bg:-180","staAM_ETCNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("88");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCNOT_EXEC_REQ","staAM_ETCNOT_EXEC_REQ_bg:-180","staAM_ETCNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("87");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCNOT_EXEC_REQ_EX","staAM_ETCNOT_EXEC_REQ_EX_bg:-180","staAM_ETCNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("125");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCNOT_SUBTOTAL","staAM_ETCNOT_SUBTOTAL_bg:-180","staAM_ETCNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("154");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCNOT_EXEC_RATIO","staAM_ETCNOT_EXEC_RATIO_bg:-165","staAM_ETCNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("89");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_ETCNOT_BTN","staAM_ETCNOT_EXEC_RATIO_bg:0","staAM_ETCNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETC","0","staAM_ETCNOT:-1","80","116",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_text("기타");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_verticalAlign("middle");
            ...
            obj = new Static("staAM_COMMNOT","staAM_ETC:-1","staAM_ETC:-116","126","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_text("통신비(로밍)");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_COMMNOT_EST_KRW_bg","staAM_COMMNOT:-1","staAM_COMMNOT:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("48");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_COMMNOT_EXEC_REQ_bg","staAM_COMMNOT_EST_KRW_bg:-1","staAM_COMMNOT_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("47");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_COMMNOT_EXEC_REQ_EX_bg","staAM_COMMNOT_EXEC_REQ_bg:-1","staAM_COMMNOT_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("126");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_COMMNOT_SUBTOTAL_bg","staAM_COMMNOT_EXEC_REQ_EX_bg:-1","staAM_COMMNOT_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("155");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_COMMNOT_EXEC_RATIO_bg","staAM_COMMNOT_SUBTOTAL_bg:-1","staAM_COMMNOT_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("49");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_COMMNOT_EST_KRW","staAM_COMMNOT_EST_KRW_bg:-180","staAM_COMMNOT_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("91");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_COMMNOT_EXEC_REQ","staAM_COMMNOT_EXEC_REQ_bg:-180","staAM_COMMNOT_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("90");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_COMMNOT_EXEC_REQ_EX","staAM_COMMNOT_EXEC_REQ_EX_bg:-180","staAM_COMMNOT_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("127");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_COMMNOT_SUBTOTAL","staAM_COMMNOT_SUBTOTAL_bg:-180","staAM_COMMNOT_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("156");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_COMMNOT_EXEC_RATIO","staAM_COMMNOT_EXEC_RATIO_bg:-165","staAM_COMMNOT_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("92");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_COMMNOT_BTN","staAM_COMMNOT_EXEC_RATIO_bg:0","staAM_COMMNOT_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_VISAPBCNCMMS","staAM_ETC:-1","staAM_ETC:-87","126","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            ...
            obj = new Static("staAM_VISAPBCNCMMS_EST_KRW_bg","staAM_VISAPBCNCMMS:-1","staAM_VISAPBCNCMMS:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("51");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_VISAPBCNCMMS_EXEC_REQ_bg","staAM_VISAPBCNCMMS_EST_KRW_bg:-1","staAM_VISAPBCNCMMS_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("50");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_VISAPBCNCMMS_EXEC_REQ_EX_bg","staAM_VISAPBCNCMMS_EXEC_REQ_bg:-1","staAM_VISAPBCNCMMS_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("128");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_VISAPBCNCMMS_SUBTOTAL_bg","staAM_VISAPBCNCMMS_EXEC_REQ_EX_bg:-1","staAM_VISAPBCNCMMS_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("157");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_VISAPBCNCMMS_EXEC_RATIO_bg","staAM_VISAPBCNCMMS_SUBTOTAL_bg:-1","staAM_VISAPBCNCMMS_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("52");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_VISAPBCNCMMS_EST_KRW","staAM_VISAPBCNCMMS_EST_KRW_bg:-180","staAM_VISAPBCNCMMS_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("94");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_VISAPBCNCMMS_EXEC_REQ","staAM_VISAPBCNCMMS_EXEC_REQ_bg:-180","staAM_VISAPBCNCMMS_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("93");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_VISAPBCNCMMS_EXEC_REQ_EX","staAM_VISAPBCNCMMS_EXEC_REQ_EX_bg:-180","staAM_VISAPBCNCMMS_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("129");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_VISAPBCNCMMS_SUBTOTAL","staAM_VISAPBCNCMMS_SUBTOTAL_bg:-180","staAM_VISAPBCNCMMS_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("158");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_VISAPBCNCMMS_EXEC_RATIO","staAM_VISAPBCNCMMS_EXEC_RATIO_bg:-165","staAM_VISAPBCNCMMS_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("95");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_VISAPBCNCMMS_BTN","staAM_VISAPBCNCMMS_EXEC_RATIO_bg:0","staAM_VISAPBCNCMMS_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_INSRCOST","staAM_ETC:-1","staAM_ETC:-58","126","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("16");
            obj.set_text("추가비용1");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_INSRCOST_EST_KRW_bg","staAM_INSRCOST:-1","staAM_INSRCOST:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("54");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_INSRCOST_EXEC_REQ_bg","staAM_INSRCOST_EST_KRW_bg:-1","staAM_INSRCOST_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("53");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_INSRCOST_EXEC_REQ_EX_bg","staAM_INSRCOST_EXEC_REQ_bg:-1","staAM_INSRCOST_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("130");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_INSRCOST_SUBTOTAL_bg","staAM_INSRCOST_EXEC_REQ_EX_bg:-1","staAM_INSRCOST_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("159");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_INSRCOST_EXEC_RATIO_bg","staAM_INSRCOST_SUBTOTAL_bg:-1","staAM_INSRCOST_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("55");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_INSRCOST_EST_KRW","staAM_INSRCOST_EST_KRW_bg:-180","staAM_INSRCOST_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("97");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_INSRCOST_EXEC_REQ","staAM_INSRCOST_EXEC_REQ_bg:-180","staAM_INSRCOST_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("96");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_INSRCOST_EXEC_REQ_EX","staAM_INSRCOST_EXEC_REQ_EX_bg:-180","staAM_INSRCOST_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("131");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_INSRCOST_SUBTOTAL","staAM_INSRCOST_SUBTOTAL_bg:-180","staAM_INSRCOST_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("160");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_INSRCOST_EXEC_RATIO","staAM_INSRCOST_EXEC_RATIO_bg:-165","staAM_INSRCOST_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("98");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_INSRCOST_BTN","staAM_INSRCOST_EXEC_RATIO_bg:0","staAM_INSRCOST_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCADTNCOST","staAM_ETC:-1","staAM_ETC:-29","126","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_text("추가비용2");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staAM_ETCADTNCOST_EST_KRW_bg","staAM_ETCADTNCOST:-1","staAM_ETCADTNCOST:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("57");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCADTNCOST_EXEC_REQ_bg","staAM_ETCADTNCOST_EST_KRW_bg:-1","staAM_ETCADTNCOST_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("56");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCADTNCOST_EXEC_REQ_EX_bg","staAM_ETCADTNCOST_EXEC_REQ_bg:-1","staAM_ETCADTNCOST_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("132");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCADTNCOST_SUBTOTAL_bg","staAM_ETCADTNCOST_EXEC_REQ_EX_bg:-1","staAM_ETCADTNCOST_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("161");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ETCADTNCOST_EXEC_RATIO_bg","staAM_ETCADTNCOST_SUBTOTAL_bg:-1","staAM_ETCADTNCOST_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("58");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCADTNCOST_EST_KRW","staAM_ETCADTNCOST_EST_KRW_bg:-180","staAM_ETCADTNCOST_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("102");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCADTNCOST_EXEC_REQ","staAM_ETCADTNCOST_EXEC_REQ_bg:-180","staAM_ETCADTNCOST_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("99");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCADTNCOST_EXEC_REQ_EX","staAM_ETCADTNCOST_EXEC_REQ_EX_bg:-180","staAM_ETCADTNCOST_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("133");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCADTNCOST_SUBTOTAL","staAM_ETCADTNCOST_SUBTOTAL_bg:-180","staAM_ETCADTNCOST_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("162");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETCADTNCOST_EXEC_RATIO","staAM_ETCADTNCOST_EXEC_RATIO_bg:-165","staAM_ETCADTNCOST_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("104");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_ETCADTNCOST_BTN","staAM_ETCADTNCOST_EXEC_RATIO_bg:0","staAM_ETCADTNCOST_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staTOTAL","0","staAM_ETC:-1","205","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("18");
            obj.set_text("합계");
            obj.set_cssclass("sta_WF_tablelabelN");
            ...
            obj = new Static("staTOTAL_EST_KRW_bg","staTOTAL:-1","staTOTAL:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("60");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staTOTAL_EXEC_REQ_bg","staTOTAL_EST_KRW_bg:-1","staTOTAL_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("59");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staTOTAL_EXEC_REQ_EX_bg","staTOTAL_EXEC_REQ_bg:-1","staTOTAL_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("134");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staTOTAL_SUBTOTAL_bg","staTOTAL_EXEC_REQ_EX_bg:-1","staTOTAL_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("163");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staTOTAL_EXEC_RATIO_bg","staTOTAL_SUBTOTAL_bg:-1","staTOTAL_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("61");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskTOTAL_EST_KRW","staTOTAL_EST_KRW_bg:-180","staTOTAL_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("109");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskTOTAL_EXEC_REQ","staTOTAL_EXEC_REQ_bg:-180","staTOTAL_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("106");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskTOTAL_EXEC_REQ_EX","staTOTAL_EXEC_REQ_EX_bg:-180","staTOTAL_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("135");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskTOTAL_SUBTOTAL","staTOTAL_SUBTOTAL_bg:-180","staTOTAL_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("164");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskTOTAL_EXEC_RATIO","staTOTAL_EXEC_RATIO_bg:-165","staTOTAL_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("111");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_TCHMCOST","0","staTOTAL:-1","205","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            ...
            obj = new Static("staAM_TCHMCOST_EST_KRW_bg","staAM_TCHMCOST:-1","staAM_TCHMCOST:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("63");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_TCHMCOST_EXEC_REQ_bg","staAM_TCHMCOST_EST_KRW_bg:-1","staAM_TCHMCOST_EST_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("62");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_TCHMCOST_EXEC_REQ_EX_bg","staAM_TCHMCOST_EXEC_REQ_bg:-1","staAM_TCHMCOST_EXEC_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("136");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_TCHMCOST_SUBTOTAL_bg","staAM_TCHMCOST_EXEC_REQ_EX_bg:-1","staAM_TCHMCOST_EXEC_REQ_EX_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("165");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_TCHMCOST_EXEC_RATIO_bg","staAM_TCHMCOST_SUBTOTAL_bg:-1","staAM_TCHMCOST_SUBTOTAL_bg:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("64");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TCHMCOST_EST_KRW","staAM_TCHMCOST_EST_KRW_bg:-180","staAM_TCHMCOST_EST_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("116");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TCHMCOST_EXEC_REQ","staAM_TCHMCOST_EXEC_REQ_bg:-180","staAM_TCHMCOST_EXEC_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("112");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TCHMCOST_EXEC_REQ_EX","staAM_TCHMCOST_EXEC_REQ_EX_bg:-180","staAM_TCHMCOST_EXEC_REQ_EX_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("137");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TCHMCOST_SUBTOTAL","staAM_TCHMCOST_SUBTOTAL_bg:-180","staAM_TCHMCOST_SUBTOTAL_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("166");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TCHMCOST_EXEC_RATIO","staAM_TCHMCOST_EXEC_RATIO_bg:-165","staAM_TCHMCOST_EXEC_RATIO_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("118");
            obj.set_format("###,##0.#0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("mskAM_TCHMCOST_BTN","staAM_TCHMCOST_EXEC_RATIO_bg:0","staAM_TCHMCOST_EXEC_RATIO_bg:-30","0","0",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("증빙(0)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_REQ","0","staAM_TCHMCOST:-1","205","30",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staAM_REQ_bg","staAM_REQ:-1","staAM_REQ:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("168");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_REQ","staAM_REQ_bg:-180","staAM_REQ_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("171");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_ADVPGLD_KRW","staAM_REQ_bg:-1","staAM_REQ_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staAM_ADVPGLD_KRW_bg","staAM_ADVPGLD_KRW:-1","staAM_ADVPGLD_KRW:-30","185","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("169");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ADVPGLD_KRW","staAM_ADVPGLD_KRW_bg:-180","staAM_ADVPGLD_KRW_bg:-25","175","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("172");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_TOTAL","staAM_ADVPGLD_KRW_bg:-1","staAM_ADVPGLD_KRW_bg:-30","185","30",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staAM_TOTAL_bg","staAM_TOTAL:-1","staAM_TOTAL:-30","171","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("170");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TOTAL","staAM_TOTAL_bg:-165","staAM_TOTAL_bg:-25","160","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("175");
            obj.set_format("###,##0");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDS_RMK","0","staAM_REQ:-1","205","90",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("20");
            obj.set_text("비고");
            obj.set_cssclass("sta_WF_tablelabelN");
            obj.set_textAlign("center");
            ...
            obj = new Static("staDS_RMK_bg","staDS_RMK:-1","staDS_RMK:-90","907","90",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("65");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new TextArea("txtDS_RMK","staDS_RMK_bg:-902","staDS_RMK_bg:-85","897","80",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staDS_RESON","0","staDS_RMK:-1","205","80",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staDS_RESON_bg","staDS_RESON:-1","staDS_RESON:-80","907","80",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("82");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new TextArea("txtDS_RESON","staDS_RESON_bg:-902","staDS_RESON_bg:-75","897","70",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("151");
            obj.set_wordWrap("char");
            obj.set_maxlength("300");
            obj.set_scrolltype("vertical");
            ...
            obj = new Div("divBtns","493","staDS_RESON:9","130","27",null,null,null,null,null,null,this.divData.form);
            obj.set_text("");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Button("btnNotice",null,"4","80","30","btnReportDetail:85",null,null,null,null,null,this.divData.form);
            obj.set_taborder("210");
            obj.set_text("주의사항");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnReportDetail",null,"4","80","30","3",null,null,null,null,null,this.divData.form);
        ...
        // User Script
        this.registerScript("DAB_BZTP_RPT_DOMESTIC_DLG.xfdl", function() {
        ...
        this.fnInit = function() {
        	if (this.getOwnerFrame().READ_ONLY == true) {
        		...
        		this.divData.form.divBtns.form.btnOK.set_enable(false);		// 저장버튼
        	}
        ...
        this.fnSave = function() {
        	...
        	this.dsSave.setColumn(nrow, "AM_TCHMCOST_EXEC_SBTT",       AM_ETCADTNCOST_EXEC_SBTT);
        	// 예산대비집행율(%)
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	...
        	if (svcID == "select") {
        		...
        		// 예산
        		this.divData.form.mskAM_IOUTBRUFLGTNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_IOUTBRUFLGTNOT_BDGT_KRW"));	// 입출국항공료
        		this.divData.form.mskAM_RAILNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_RAILNOT_BDGT_KRW"));					// 철도비
        		this.divData.form.mskAM_SHIPNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_SHIPNOT_BDGT_KRW"));					// 선박비
        		this.divData.form.mskAM_FLGTNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_FLGTNOT_BDGT_KRW"));					// 항공비
        		this.divData.form.mskAM_CARNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_CARNOT_BDGT_KRW"));					// 자동차비
        		this.divData.form.mskAM_LDGGNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_LDGGNOT_BDGT_KRW"));					// 숙박비
        		this.divData.form.mskAM_CRMNNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_CRMNNOT_BDGT_KRW"));					// 식비
        		this.divData.form.mskAM_ETCNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_ETCNOT_BDGT_KRW"));					// 잡비
        		this.divData.form.mskAM_COMMNOT_EST_KRW.set_value(this.dsList.getColumn(0, "AM_COMMNOT_BDGT_KRW"));					// 통신비
        		this.divData.form.mskAM_VISAPBCNCMMS_EST_KRW.set_value(this.dsList.getColumn(0, "AM_VISAPBCNCMMS_BDGT_KRW"));		// 비자발급수수료
        		this.divData.form.mskAM_INSRCOST_EST_KRW.set_value(this.dsList.getColumn(0, "AM_INSRCOST_BDGT_KRW"));				// 보험비용
        		this.divData.form.mskAM_ETCADTNCOST_EST_KRW.set_value(this.dsList.getColumn(0, "AM_ETCADTNCOST_BDGT_KRW"));			// 기타추가비용
        		this.divData.form.mskAM_TCHMCOST_EST_KRW.set_value(this.dsList.getColumn(0, "AM_TCHMCOST_BDGT_KRW"));				// 교제비용
        		this.divData.form.mskTOTAL_EST_KRW.set_value(this.dsList.getColumn(0, "AM_TT_BDGT_KRW"));							// 합계
        ...
        this.setObject = function(baseObjName) {
        	if (this.findObject(baseObjName + "_EST_KRW").value == 0) {
        		if (baseObjName != "mskAM_LDGGNOT" && baseObjName != "mskAM_CRMNNOT" && baseObjName != "mskAM_ETCNOT") {
        			this.findObject(baseObjName + "_EXEC_REQ").set_enable(false);	// false
        			this.findObject(baseObjName + "_EXEC_REQ_EX").set_enable(false);
        			this.findObject(baseObjName + "_BTN").set_enable(true);
        		}
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.staCD_STDMNEY.addEventHandler("onclick",this.divSearch_staCD_STDMNEY_onclick,this);
        ...
        this.loadIncludeScript("DAB_BZTP_RPT_DOMESTIC_DLG.xfdl");
