(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DABPR_LOANLIMIT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DABPR_LOANLIMIT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DABPR_LOANLIMIT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DABPR_LOANLIMIT_DELETE</Col></Row><Row><Col id=\"SP\">DAZPR_COMMONCODE_COMBO2</Col><Col id=\"TARGET\">listbox</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"DT_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"YN_USE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_CORP","284","10.0","230","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("divData","0","66",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new BindItem("item8","divSearch.form.ccfCD_CORP.form.DSTextBox","value","dsSearch","DS_CORP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.cboYN_USE","value","dsSearch","YN_USE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAB_LOANLIMIT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAB_LOANLIMIT");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("FR_POINT", "string");
        	this.dsInsert.addColumn("TO_POINT", "string");
        	...
        	this.dsInsert.addColumn("AM_MAX", "bigdecimal");
        	...
        	this.dsUpdate.addColumn("FR_POINT", "string");
        	this.dsUpdate.addColumn("TO_POINT", "string");
        	this.dsUpdate.addColumn("AM_1", "bigdecimal");
        	this.dsUpdate.addColumn("AM_2", "bigdecimal");
        	this.dsUpdate.addColumn("AM_3", "bigdecimal");
        	this.dsUpdate.addColumn("AM_4", "bigdecimal");
        	this.dsUpdate.addColumn("AM_MAX", "bigdecimal");
        ...
        this.fnSave = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		case "I":
        			...
        			this.dsInsert.setColumn(nrow, "FR_POINT", this.dsList.getColumn(i, "FR_POINT"));
        			this.dsInsert.setColumn(nrow, "TO_POINT", this.dsList.getColumn(i, "TO_POINT"));
        			this.dsInsert.setColumn(nrow, "AM_1", this.dsList.getColumn(i, "AM_1"));
        			this.dsInsert.setColumn(nrow, "AM_2", this.dsList.getColumn(i, "AM_2"));
        			this.dsInsert.setColumn(nrow, "AM_3", this.dsList.getColumn(i, "AM_3"));
        			this.dsInsert.setColumn(nrow, "AM_4", this.dsList.getColumn(i, "AM_4"));
        			this.dsInsert.setColumn(nrow, "AM_MAX", this.dsList.getColumn(i, "AM_MAX"));
        		...
        		case "U":
        			...
        			this.dsUpdate.setColumn(nrow, "FR_POINT", this.dsList.getColumn(i, "FR_POINT"));
        			this.dsUpdate.setColumn(nrow, "TO_POINT", this.dsList.getColumn(i, "TO_POINT"));
        			this.dsUpdate.setColumn(nrow, "AM_1", this.dsList.getColumn(i, "AM_1"));
        			this.dsUpdate.setColumn(nrow, "AM_2", this.dsList.getColumn(i, "AM_2"));
        			this.dsUpdate.setColumn(nrow, "AM_3", this.dsList.getColumn(i, "AM_3"));
        			this.dsUpdate.setColumn(nrow, "AM_4", this.dsList.getColumn(i, "AM_4"));
        			this.dsUpdate.setColumn(nrow, "AM_MAX", this.dsList.getColumn(i, "AM_MAX"));
        ...
        this.fnGridValidate = function(objGrid) {
        	...
        	for (var i = 0; i < objDs.rowcount; i++) {
        		...
        		if(flag =="U" || flag =="I") {
        			var FR_POINT = objDs.getColumn(i,"FR_POINT")	// 시작일
        			var TO_POINT = objDs.getColumn(i,"TO_POINT")	// 종료일
        			if (FR_POINT > TO_POINT){
        				msg += (i + 1) + "행: [평가포인트TO]는 [평가포인트FROM]보다 큰 수로 입력하셔야 합니다.\n";
        			}
        		}
        	}// for
        ...
        this.fnGrid_AfterCDTextChanged = function(id, codeFindData) {
        	...
        	switch (id) {
        	case "DAX_CFCOMMONCODE_MULTY":		// 선임현장	DAX_CERTIFICATE_DEPT
        ...
        this.loadIncludeScript("DAB_LOANLIMIT.xfdl");
