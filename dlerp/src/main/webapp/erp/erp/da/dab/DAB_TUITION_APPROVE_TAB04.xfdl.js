(function()
{
    return function()
    {
        ...
        {
            this.set_name("formTab4");
            this.set_titletext("고등학교(입학금)탭");
        ...
        // User Script
        this.registerScript("DAB_TUITION_APPROVE_TAB04.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.dsList6 = this.parentForm.dsList6;
        	this.dsList7 = this.parentForm.dsList7;
        	this.dsList8 = this.parentForm.dsList8;
        	this.parentForm.dxGrid6 = this.objGrid3;
        	this.parentForm.dxGrid7 = this.divData.form.objGrid4;
        	this.parentForm.dxGrid8 = this.divData.form.objGrid5;
        };
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.objGrid3, this.dsList6, "DA", "DAB_TUITION_LIST03");
        	this.gfnGridInit(this.divData.form.objGrid4, this.dsList7, "DA", "DAB_TUITION_LIST04");
        	this.gfnGridInit(this.divData.form.objGrid5, this.dsList8, "DA", "DAB_TUITION_LIST05");
        };
        ...
        this.loadIncludeScript("DAB_TUITION_APPROVE_TAB04.xfdl");
