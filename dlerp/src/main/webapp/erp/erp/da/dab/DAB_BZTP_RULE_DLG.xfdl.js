(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("출장계획서 작성 주의사항");
            this.getSetter("maxwidth").set("740");
            this.getSetter("maxheight").set("505");
            ...
            obj = new Div("divSearch","0","0","700","390",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            ...
            obj.set_taborder("0");
            obj.set_text("출장계획서 작성 주의사항");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staBackground","0","33","700","355",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj.set_taborder("2");
            obj.set_text("- 환율 : 하나은행 환율 조회 → 출장계획서 작성일 전일(근무일) 기준 최초고시 현금살 때 기준");
            obj.set_cssclass("");
            ...
            obj = new Static("sta03","15","sta02:-5","675","29",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("- 입출국항공료 : 해외출장의 경우, 항공일정 메일에 알려드린 항공운임을 계획서 기준환율로 환산하여 USD로 입력");
            obj.set_cssclass("");
            obj.set_verticalAlign("middle");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta04","15","sta03:-5","675","29",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj.set_taborder("6");
            obj.set_text("- 숙박비 : 실 숙박야수 기재(3박 5일 출장의 경우, 3일), 현장에서 숙박지원 부담일 경우 \"0\"입력");
            obj.set_cssclass("");
            obj.set_verticalAlign("middle");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj.set_taborder("9");
            obj.set_text("- 잡비 : 3박 5일 출장의 경우, 5일X 단가(부장이하 40$)");
            obj.set_cssclass("");
            obj.set_verticalAlign("middle");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta09","15","sta08:-5","675","29",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("- 기타 : 공항세, 로밍비, 현지 비자 발급비 등 필요시 행 추가하여 기재");
            obj.set_cssclass("");
            obj.set_verticalAlign("middle");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta10","15","sta09:-5","675","29",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("- 교제비(선물대 및 내객접대비) : 별도 회계처리 (해당 비용 및 내용은 비고란에 별도 기재)");
            obj.set_cssclass("");
            obj.set_verticalAlign("middle");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("sta13","15","sta12:-10","675","29",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            ...
            obj = new Static("sta14","15","sta13:-10","675","29",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            obj.set_text("  → 미사용 출장비는 보고서 정산 시 회사에 반납 입금하게 되는 번거러움이 발생할 수 있으니 필요한 만큼만 신청");
            obj.set_cssclass("");
            obj.set_verticalAlign("middle");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta15","15","sta14:-10","675","29",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("16");
