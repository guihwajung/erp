(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staAM_EDUCATION","0","divGrid:10","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_tablelabelTE");
            obj.set_text("교육비용");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_EXEC","staAM_EDUCATION:78","divGrid:15","180","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            obj.set_format("#,##0.##");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDesc13_01","mskAM_EXEC:2","divGrid:14","140","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("32");
            obj.set_text("(VAT 포함)");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Radio("rdoYN_RETURN","staYN_RETURN:7","mskAM_EXEC:9","143","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("22");
            ...
            obj = new Static("staCD_VENDOR","0","sta00:30","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("38");
            obj.set_cssclass("sta_WF_tablelabelE");
            obj.set_text("입금처");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staDS_ACCOUNT","cfNO_ACCOUNT:120","cfCD_VENDOR:4","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("52");
            obj.set_cssclass("sta_WF_tablelabelE");
            obj.set_text("입금처명");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_SUPPORT","mskAM_EXEC:90","divGrid:15","230","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("48");
            obj.set_enable("true");
            ...
            obj = new Combo("cboCD_CURR","133","458","73","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("59");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
