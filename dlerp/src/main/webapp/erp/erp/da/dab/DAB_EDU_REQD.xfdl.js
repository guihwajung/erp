(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new MaskEdit("mskAM_EDUCATION","staAM_EDUCATION:3","164","230","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_format("#,##0");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_SUPPORT","mskAM_EDUCATION:90","164","122","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("20");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_tabstop("false");
