(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1100,290);
            }
            ...
            obj = new Div("divData","0","35",null,"154","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("staBg2_00","79","58",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("23");
            ...
            obj = new Static("staYmRepayment","staDtLoan:130","staDtIpsa:-1","90","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_text("상환개월");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staAmRepayment","540","58","90","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("33");
            obj.set_text("상환금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CURREPAYMENT","staAmRepayment:5","64","135","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_format("#,##0.##");
            obj.set_limitbymask("integer");
            obj.set_enable("true");
            ...
            obj = new Static("staDesc12","mskAM_CURREPAYMENT:5","63","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_text("원");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_LOAN","104","63","135","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_format("#,##0.##");
            obj.set_limitbymask("integer");
            obj.set_enable("true");
            ...
            obj = new Edit("txtDS_JOIN","tclDT_JOIN:4","5","82","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("16");
            obj.set_maxlength("25");
            obj.set_readonly("true");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDS_GROUPJOIN","tclDT_GROUPJOIN:4","5","90","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_maxlength("25");
            obj.set_readonly("true");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDS_APRV","1020","99",null,"20","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            obj.set_maxlength("25");
            obj.set_readonly("true");
            ...
            obj = new Static("staDesc3","957","99",null,"20","txtDS_APRV:-8",null,null,null,null,null,this.divData.form);
            obj.set_taborder("22");
            obj.set_text("승인상태 :");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("txtYM_REPAYMENT","staYmRepayment:5","35","50","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("27");
            obj.set_limitbymask("integer");
            obj.set_format("#,###");
            obj.set_readonly("true");
            ...
            obj = new Static("staDesc2","txtYM_REPAYMENT:3","35","30","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("28");
            obj.set_text("개월");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_JAN","staAmJan:4","63","135","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("35");
            obj.set_format("#,##0.##");
            obj.set_limitbymask("integer");
            obj.set_enable("true");
            ...
            obj = new Static("staDesc12_00","mskAM_JAN:5","62","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("36");
            obj.set_text("원");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staTitle2","0","90","359","35",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("37");
            ...
            obj = new Div("divDataDetail","0","143",null,null,"0","36",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("staBg10_00","79","46",null,"30","0",null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            this.divDataDetail.addChild(obj.name, obj);

            obj = new Static("staBg10","79","17",null,"30","0",null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_tablebgT");
            obj.set_textAlign("right");
            this.divDataDetail.addChild(obj.name, obj);
            ...
            obj = new Static("staYmMax","0","17","120","30",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_tablelabelT");
            obj.set_text("최장상환개월");
            this.divDataDetail.addChild(obj.name, obj);

            obj = new Static("staYmJan","staYmMax:190","17","120","30",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablelabelT");
            obj.set_text("잔여상환개월");
            this.divDataDetail.addChild(obj.name, obj);

            obj = new Static("staAmMonth","staYmJan:200","17","120","30",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablelabelT");
            obj.set_text("기존월상환액");
            this.divDataDetail.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskYM_MAX","staYmMax:4","23","116","20",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("10");
            obj.set_format("###,###,###");
            obj.set_limitbymask("integer");
            obj.set_textAlign("right");
            ...
            obj = new MaskEdit("makYM_ALLOW","staYmPoss:4","51","116","20",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("11");
            obj.set_format("###,###,###");
            obj.set_limitbymask("integer");
            obj.set_textAlign("right");
            ...
            obj = new MaskEdit("mskYM_CHANGE","staYmChange:4","51","116","20",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("0");
            obj.set_format("###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_textAlign("right");
            ...
            obj = new MaskEdit("txtYM_JAN","staYmJan:4","22","116","20",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("12");
            obj.set_format("###,###,###");
            obj.set_limitbymask("integer");
            obj.set_textAlign("right");
            ...
            obj = new MaskEdit("mskAM_MONTH","staAmMonth:4","22","116","20",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("13");
            obj.set_format("###,###,###");
            obj.set_limitbymask("integer");
            obj.set_textAlign("right");
            ...
            obj = new MaskEdit("mskAM_CHANGEMONTH","staAmMonthChange:4","51","116","20",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("14");
            obj.set_format("###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_textAlign("right");
            ...
            obj = new Static("staDesc5_00_00","876","20","20","20",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("15");
            obj.set_text("원");
            this.divDataDetail.addChild(obj.name, obj);

            obj = new Static("staDesc5_00_00_00","875","50","20","20",null,null,null,null,null,null,this.divDataDetail.form);
            obj.set_taborder("16");
            obj.set_text("원");
            this.divDataDetail.addChild(obj.name, obj);
            ...
            obj = new Button("btnCANCEL",null,"0","73","26","61",null,null,null,null,null,this.divBtns.form);
            obj.set_taborder("0");
            obj.set_text("취소");
            this.divBtns.addChild(obj.name, obj);

            obj = new Button("btnOK","95","0","75","26",null,null,null,null,null,null,this.divBtns.form);
            obj.set_taborder("1");
            obj.set_text("신청완료");
            this.divBtns.addChild(obj.name, obj);

            obj = new Edit("txtNO_LOANREQUEST","579","4","130","24",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_maxlength("25");
        ...
        // User Script
        this.registerScript("DAB_LOANCHANGE_DLG.xfdl", function() {
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("NO_LOANREQUEST", "STRING");
        ...
        // 	this.dsSave.addColumn("DS_RETURN", "string");
        	...
        	this.dsDelete.addColumn("NO_LOANREQUEST", "string");
        };
        ...
        this.fnSave = function (vType)
        {
        	...
        	if (flag=="I" || flag=="U")
        	{
        		...
        		this.dsSave.setColumn(nrow, "TY_GUBUN", "3");
        ...
        this.fnSaveValidate = function() {
        	...
        	if(this.gfnNvl(this.dsList.getColumn(0, "AM_CHANGEMONTH"),0) ==0 ) {
        		strMsg += "※변경월상환액을 입력되지 않았습니다.\n";
        	}

        	if(this.gfnNvl(this.dsList.getColumn(0, "YM_ALLOW"),0) ==0 ) {
        		strMsg += "※변경가능상환개월이 입력되지 않았습니다.\n";
        	}

        	if(this.gfnNvl(this.dsList.getColumn(0, "YM_CHANGE"),0) ==this.gfnNvl(this.dsList.getColumn(0, "YM_JAN"),0) ) {
        		strMsg += "※잔여상환개월과 변경상환개월이 동일합니다. 변경내역이 없습니다.\n";
        	}
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	...
        	switch(svcID) {
        		...
        		case "select" :
        			...
        			if (this.dsList.getColumn(0, "ST_APRV")=="01")
        			{
        				this.fnSetMonth();
        			}
        			break;
        		case "saveOk":		// 신청완료
        				...
        				this.gfnAlert("상환기간변경 신청이 완료되었습니다.", "fnVaidateCallback");
        			break;
        		case "delete" :
        			trace(" delete=>");
        			this.getParentContext().close(true);
        ...
        this.btnCancel_onclick = function(obj,e)
        {
        	...
        	if (flag == "U" || flag == "Q")
        	{
        		this.gfnConfirm("상환기간 변경 신청 내역이 삭제 됩니다. 삭제하시겠습니까?", "fnDelCallback");
        	}else{
        		this.getParentContext().close(false);
        	}
        ...
        this.fnSetMonth = function ()
        {
        	...
        	var AmChangeMonth = this.fnGetTrunc(AmJan / (YmChange == 0 ? 1 : YmChange), 10);
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.addEventHandler("onclick",this.divData_onclick,this);
            this.divBtns.form.btnCANCEL.addEventHandler("onclick",this.btnCancel_onclick,this);
            this.divBtns.form.btnOK.addEventHandler("onclick",this.btnOk_onclick,this);
            this.dsList.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
        };
        this.loadIncludeScript("DAB_LOANCHANGE_DLG.xfdl");
