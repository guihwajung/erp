(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DABPR_EDULIST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DABPR_EDULIST_INSERT</Col></Row><Row><Col id=\"TARGET\">selectid</Col><Col id=\"SP\">DABPR_EDUSEQ_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DABPR_EDULIST_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DABPR_EDULIST_DELETE</Col></Row><Row><Col id=\"TARGET\">select_emp</Col><Col id=\"SP\">DAXPR_BASEINFO_CODEFIND_ALL</Col></Row><Row><Col id=\"TARGET\">aprv_execute</Col><Col id=\"SP\">DABPR_EDU_REQ_APRV_EXCUTE</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DABPR_EDU_REQ_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DABPR_EDU_REQ_AUTOSLIP_CALCEL</Col></Row><Row><Col id=\"TARGET\">select_Limit</Col><Col id=\"SP\">DABPR_EDU_REQ_APRV_VALIDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"FR_EDUCATION\" type=\"STRING\" size=\"256\"/><Column id=\"TO_EDUCATION\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CORP\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsId", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDS_EDUCATION","staFR_EDUCATION:248","staCD_CORP:-22","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("신청자");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfID_SABUN","staDS_EDUCATION:-10","12","250","24.0",null,null,null,null,null,null,this.divSearch.form);
        ...
        // User Script
        this.registerScript("DAB_EDULIST.xfdl", function() {
         ...
         ************************************************************************/
        // 수강전 신청서 작성
        this.fnRequestBefore = function(obj,e) {
        ...
        this.fnRequestAfter = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) return false;
        	if (!this.gfnSearchValidate(this.divSearch, this.dsSearch)) return false;
        	if (!this.fnSelectValidate()) return false;
        ...
        // 교육수강 후 결재상신 버튼 클릭시
        this.fnAfterAprv = function(obj,e)
        {
        	if (!this.gfnGridIsRow(this.dxGrid)) return;
        ...
        // 결재문서조회 버튼
        this.fnAfterAprvDocQ = function(obj, e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) return;
        	var cd_corp = this.dsSearch.getColumn(0, "CD_CORP");
        ...
        // 결재상태초기화 버튼
        this.fnAfterAprvInit = function(obj, e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) return;
        ...
        // 	if(this.gfnIsNull(this.gfnTrim(this.dsList.getColumn(this.dsList.rowposition, "ST_APRV")))){
        ...
        this.on_initEvent = function()
        {
            ...
            this.dsId.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
            this.dsEmp.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
            this.dsLimit.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
        };
        this.loadIncludeScript("DAB_EDULIST.xfdl");
