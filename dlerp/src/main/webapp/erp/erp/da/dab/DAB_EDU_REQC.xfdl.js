(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("자격 교육비지원신청서");
            this.getSetter("maxwidth").set("860");
            this.getSetter("maxheight").set("545");
            ...
            obj.set_taborder("0");
            obj.set_text("자격 교육비지원신청서");
            obj.set_cssclass("sta_TITLE_Bg");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Div("divData","0","staTitle1:0",null,null,"0","20",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("div_DATA_Bg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("staBg6","99","116",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("48");
            ...
            obj = new Static("staBg5","89","staBg:57",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("41");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_text("");
            ...
            obj = new Static("staDT_LICENSE","0","87","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("40");
            obj.set_text("자격취득일\r");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBg10","79","341",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("43");
            obj.set_cssclass("sta_WF_tablebgT");
            obj.set_textAlign("right");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staBg4","89","staBg:28",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("39");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_text("");
            ...
            obj = new Static("staBg2_01","79","174",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("37");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_text("");
            ...
            obj = new Static("staBg2","79","145",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("18");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_text("");
            ...
            obj = new Static("staBg3","89","29",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("35");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_text("");
            ...
            obj = new Static("staBgDS_EDU_PLACE","89","203",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_text("");
            ...
            obj = new Static("staBg1","89","232",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_text("");
            ...
            obj = new Div("divGrid","130","staBg:282",null,"60","20",null,null,null,null,null,this.divData.form);
            obj.set_taborder("24");
            obj.set_text("div00");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Grid("objGrid","0","59",null,"30","3",null,null,null,null,null,this.divData.form.divGrid.form);
            obj.set_taborder("0");
            obj.set_visible("false");
            obj._setContents("");
            this.divData.form.divGrid.addChild(obj.name, obj);
            ...
            obj = new Static("staBg13","79","272",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("27");
            obj.set_cssclass("sta_WF_tablebgT");
            obj.set_textAlign("right");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBg17","79","312",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_tablebgT");
            obj.set_textAlign("right");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_EDUCATION","0","272","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_tablelabelTE");
            obj.set_text("교육비용합계");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDS_EDU_PLACE","0","staID_SABUN:202","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("22");
            obj.set_text("교육장소");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDS_EDUCATION","0","staID_SABUN:115","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_text("교육 과정명");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staDesc01","cfID_SABUN:30","207","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            obj.set_text("hr");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staFR_EDUCATION","0","staID_SABUN:173","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("20");
            obj.set_text("교육기간/시간");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("txtDS_EDUCATION","staDS_EDUCATION:4","cfID_SABUN:125",null,"20","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_readonly("false");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("txtDS_EDU_PLACE","staDS_EDU_PLACE:4","cfID_SABUN:213",null,"20","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_readonly("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDesc02","240","cfID_SABUN:182","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("25");
            obj.set_text("~");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_EDUCATION","staAM_EDUCATION:3","277","230","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_format("#,##0");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDesc13_01","mskAM_EDUCATION:2","276","140","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("28");
            obj.set_text("원  (VAT 포함)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staFile","0","312","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_tablelabelTE");
            obj.set_text("교육관련문서첨부");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staFileUpload","staFile:8","316","146","24",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("31");
            obj.set_text("파일수 :  0 개");
            obj.set_cssclass("sta_WF_notice");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnATTACH","staFileUpload:18","317","73","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_text("파일첨부");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta01","btnATTACH:8","318",null,"18","30",null,null,null,null,null,this.divData.form);
            obj.set_taborder("32");
            obj.set_text("※ 교육수강증, 결제 영수증  등 첨부");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SUPPORT","mskAM_EDUCATION:90","277","230","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("33");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_tabstop("false");
            ...
            obj = new Calendar("tclFR_EDUCATION","staFR_EDUCATION:4","cfID_SABUN:183","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            ...
            obj = new Calendar("tclTO_EDUCATION","253","cfID_SABUN:183","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new MaskEdit("mskTT_EDUCATION","358","208","47","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_format("#,##0.#");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("cboCD_EDUSUB","134","34","246","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            ...
            obj = new Static("staDS_EDUCATION01","0","staID_SABUN:144","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("36");
            obj.set_text("교육 기관명");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("txtDS_EDU_ORGAN","134","179",null,"20","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_readonly("false");
            this.divData.addChild(obj.name, obj);
            ...
            obj.set_taborder("38");
            obj.set_text("기술사/자격종류");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Calendar("tclDT_LICENSE","staDT_LICENSE:4","92","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Div("cfCD_LICENSE","staCD_LICENSE:4","63","296","20",null,null,null,null,null,null,this.divData.form);
            obj.getSetter("CodeFindName").set("DAX_EDU_LICENSE_CODE");
            obj.getSetter("CDTextWidth").set("90");
            obj.getSetter("FitToContents").set("false");
            obj.set_taborder("2");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            ...
            obj = new Static("staFile2","0","341","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("42");
            obj.set_cssclass("sta_WF_tablelabelE");
            obj.set_text("자격증사본첨부");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staFileUpload2","138","346","146","24",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("44");
            obj.set_text("파일수 :  0 개");
            obj.set_cssclass("sta_WF_notice");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnATTACH2","302","347","73","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_text("파일첨부");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta01_00","383","348",null,"18","30",null,null,null,null,null,this.divData.form);
            obj.set_taborder("45");
            obj.set_text("※ 자격증 사본 첨부");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staNO_LICENSE","0","116","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("46");
            obj.set_text("면허번호");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDS_LICENSE_ORGAN","380","116","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("47");
            obj.set_text("자격허가기관");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("txtNO_LICENSE","134","121","240","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_readonly("false");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("txtDS_LICENSE_ORGAN","513","121",null,"20","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_readonly("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta01_00_00","20","368",null,"32","130",null,null,null,null,null,this.divData.form);
            obj.set_taborder("49");
            obj.set_text("※ 기술사교육비 신청의 경우 기준 지원금액이 35만원이 MAX 이며, 기록 누적을 통해 관리합니다.");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divData.form.tclDT_LICENSE","value","dsList","DT_LICENSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divData.form.cfCD_LICENSE.form.CDTextBox","value","dsList","CD_LICENSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divData.form.cfCD_LICENSE.form.DSTextBox","value","dsList","DS_LICENSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.txtNO_LICENSE","value","dsList","NO_LICENSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divData.form.txtDS_LICENSE_ORGAN","value","dsList","DS_LICENSE_ORGAN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAB_EDU_REQC.xfdl", function() {
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	if (id == "cfCD_LICENSE") {
        		...
        		dsUserParam.setColumn(nrow, "CD_UPPREFIX", this.dsList.getColumn(0, "CD_EDU") == "S06" ? "01" : "04");
        ...
        this.fnSetSupport = function() {
        	...
        	var vResult = (vAmEducation * vRtLimit/100); // 지원금액
        ...
        this.loadIncludeScript("DAB_EDU_REQC.xfdl");
