(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">1</Col><Col id=\"DS_CODE\">계좌이체</Col></Row><Row><Col id=\"CD_CODE\">2</Col><Col id=\"DS_CODE\">무료교육</Col></Row><Row><Col id=\"CD_CODE\">3</Col><Col id=\"DS_CODE\">법인카드</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divData","0","staTitle1:0",null,"735","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("staDS_EFFECT00","0","staID_SABUN:292","160","120",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("54");
            obj.set_text("교육대상자");
            obj.set_cssclass("sta_WF_tablelabelTE");
            this.divData.addChild(obj.name, obj);

            obj = new Div("divGrid","staDS_EFFECT00:-1","staBg:262",null,"150","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("27");
            obj.set_text("div00");
            this.divData.addChild(obj.name, obj);

            obj = new Div("cfID_SABUN_TARGET","100","34","247","20",null,null,null,null,null,null,this.divData.form.divGrid.form);
            ...
            obj = new Static("staBg12","79","divGrid:39",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("32");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staBg13","79","divGrid:10",null,"30","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_tablebgT");
            obj.set_textAlign("right");
            obj.set_visible("true");
            ...
            obj = new Static("staTY_PAY","0","divGrid:110","160","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("35");
            obj.set_cssclass("sta_WF_tablelabelTE");
            obj.set_text("지급구분");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_VENDOR","0","581","160","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("37");
            obj.set_cssclass("sta_WF_tablelabelE");
            obj.set_text("입금처");
            this.divData.addChild(obj.name, obj);

            obj = new Div("cfCD_VENDOR","staCD_VENDOR:3","586","317","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staNO_ACCOUNT","0","staCD_VENDOR:-1","160","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("40");
            obj.set_cssclass("sta_WF_tablelabelE");
            obj.set_text("계좌번호");
            this.divData.addChild(obj.name, obj);

            obj = new Div("cfNO_ACCOUNT","staNO_ACCOUNT:3","cfCD_VENDOR:9","145","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staCD_BANK","0","staNO_ACCOUNT:-1","160","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("48");
            obj.set_cssclass("sta_WF_tablelabelE");
            obj.set_text("입금은행");
            this.divData.addChild(obj.name, obj);

            obj = new Div("cfCD_BANK","staCD_BANK:3","cfNO_ACCOUNT:9","316","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staAM_EDUCATION","0","divGrid:10","160","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_tablelabelTE");
            ...
            obj = new Static("staDS_DOCUMENT","0","staID_SABUN:144","160","60",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("18");
            obj.set_text("교육내용");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDS_EFFECT","0","staID_SABUN:203","160","60",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("20");
            obj.set_text("소감 및 활용방법");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskTT_EDUCATION","388","121","47","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_format("#,##0.#");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDesc01","mskTT_EDUCATION:5","120","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_text("hr");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new TextArea("txtDS_RESULT","staDS_EFFECT:4","cfID_SABUN:213",null,"50","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_EXEC","238","457","180","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("59");
            obj.set_format("#,##0.##");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDesc13_01","418","divGrid:15","140","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("31");
            obj.set_text(" (VAT 포함)");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staYN_RETURN","0","staAM_EDUCATION:-1","160","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("33");
            obj.set_cssclass("sta_WF_tablelabelE");
            obj.set_text("고용보험환급여부");
            this.divData.addChild(obj.name, obj);

            obj = new Radio("rdoYN_RETURN","staYN_RETURN:7","486","143","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            ...
            obj = new Static("sta00","20","divGrid:67",null,"42","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("34");
            obj.set_text("※ 환급여부는 교육기관에 확인 후 작성해 주시기 바랍니다.  \r\n※ 오프라인 어학교육_강사초빙의 경우 총 수강기간의 합계금액 입력하시기 바랍니다.");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDS_ACCOUNT","cfNO_ACCOUNT:130","cfCD_VENDOR:4","130","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("51");
            obj.set_cssclass("sta_WF_tablelabelE");
            obj.set_text("입금처명");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staFile","0","staNO_ACCOUNT:55","160","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("42");
            obj.set_cssclass("sta_WF_tablelabelTE");
            ...
            obj = new Static("sta01","btnATTACH:8","divGrid:259",null,"18","30",null,null,null,null,null,this.divData.form);
            obj.set_taborder("45");
            obj.set_text("※수료증, 출석확인증 첨부");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SUPPORT","494","divGrid:15","128","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("47");
            obj.set_enable("true");
            ...
            obj = new Combo("cboCD_EDUSUB","staDS_EDUCATION00:3","35","276","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("55");
            ...
            obj = new Combo("cboCD_CURR","staAM_EDUCATION:3","457","73","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("58");
            ...
            obj = new Radio("rdoTY_PAY","staTY_PAY:7","divGrid:115","385","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("22");
            ...
            obj = new Button("btnAccount",null,"7","90","24","btnAPRV:5",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("계좌등록");
            this.addChild(obj.name, obj);

            obj = new Button("btnVendor",null,"7","90","24","btnAccount:5",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("거래처등록");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item15","divData.form.txtDS_RESULT","value","dsList","DS_RESULT");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item22","divData.form.mskAM_EXEC","value","dsList","AM_EXEC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAB_EDU_REQE.xfdl", function() {
        ...
        this.fnSetEnable = function ()
        {
        	...
        	trace(" fnSetEnable  stAprv=>" +  stAprv);
        	...
        	} else if(this.dsList.getColumn(0, "TY_WRK") == "I" ) {
        ...
        this.fnSetVariable = function() {
        	...
        	this.txtDS_RESULT 	= this.divData.form.txtDS_RESULT;
        ...
        this.fnSaveValidate = function() {
        	...
        	if(this.gfnIsNull(this.dsList.getColumn(0, "DS_RESULT"))) {
        		strMsg += "※ 소감 및 활용방법이 입력되지 않았습니다.\n";
        	}
        		...
        		case "select" :
        			...
        			if(this.dsList.rowcount > 0) {
        				...
        				if(this.dsList.getColumn(0, "TY_WRK") == "I") {
        					for (var i = 0; i < this.dsTarget.rowcount; i++) {
        						this.dsTarget.setColumn(i, this.ucFlag, "I");
        				}}
        ...
        this.dsList_onvaluechanged = function(obj,e)
        {
        	...
        	if (e.oldvalue != e.newvalue)
        	{
        		...
        		} else if (e.columnid == "AM_EXEC" || e.columnid == "RT_EXCH")
        		{
        ...
        this.loadIncludeScript("DAB_EDU_REQE.xfdl");
