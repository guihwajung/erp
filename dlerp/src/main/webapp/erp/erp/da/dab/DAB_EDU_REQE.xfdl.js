(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staAM_EDUCATION","0","divGrid:10","160","34",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_tablelabelTE");
            obj.set_text("교육비용\r\n(통화)/(발생통화금액)");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_EXEC","238","459","150","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("59");
            obj.set_format("#,##0.##");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDesc13_01","388","divGrid:17","140","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("31");
            obj.set_text(" (VAT 포함)");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Radio("rdoYN_RETURN","staYN_RETURN:7","490","143","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            ...
            obj = new Static("sta00","20","divGrid:69",null,"42","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("34");
            ...
            obj = new MaskEdit("mskAM_SUPPORT","592","divGrid:17","128","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("47");
            obj.set_enable("false");
            obj.set_readonly("false");
            obj.set_visible("true");
            ...
            obj = new Combo("cboCD_CURR","staAM_EDUCATION:3","459","73","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("58");
            ...
            obj = new Static("staAM_EDUCATION00","460","452","130","34",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("60");
        ...
        // 				if (this.dsList.getColumn(0, "TY_WRK")=="I" && this.dsList.get)   // 최초 입력시
        // 				{
