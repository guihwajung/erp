(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("상호평가조회(관리자기준)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAJPR_INTERACTION_LIST_SELECT</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("DAJ_INTERACTION_LIST.xfdl", function() {
        ...
        this.loadIncludeScript("DAJ_INTERACTION_LIST.xfdl");
