(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select_status</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_SELF_DS_MNG_UPDEPT_SELECT</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("DAJ_RTNG_GOAL_SELF_DESC_LIST_DEPT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	var colSEQ_GOAL 		= this.dxGrid.getBindCellIndex("body", "SEQ_GOAL");
        	this.dxGrid.setFormatColProperty(colSEQ_GOAL, "size", 0);
        	var colSTAT_RTNG 		= this.dxGrid.getBindCellIndex("body", "STAT_RTNG");
        	this.dxGrid.setFormatColProperty(colSTAT_RTNG, "size", 0);
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if (id == "ccfCD_CORP") {
        		...
        		dsUserParam.setColumn(nrow, "ID_SCREEN"   , "DAJ_RTNG_GOAL_SELF_DESC_LIST_DEPT");
        ...
        this.loadIncludeScript("DAJ_RTNG_GOAL_SELF_DESC_LIST_DEPT.xfdl");
