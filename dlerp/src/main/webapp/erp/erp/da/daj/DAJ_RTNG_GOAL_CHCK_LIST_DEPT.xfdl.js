(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staID_SABUN","ccfID_RTNG:0","10.0","79","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("성명");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Edit("edtDS_DEPT","ccfID_SABUN:3.0","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_enable("false");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item6","divSearch.form.edtDS_DEPT","value","dsSearch","DS_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAJ_RTNG_GOAL_CHCK_LIST_DEPT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsListStatus, "DA", "DAJ_RTNG_GOAL_CHCK_LIST");
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if (id == "ccfCD_CORP") {
        		...
        		dsUserParam.setColumn(nrow, "ID_SCREEN"   , "DAJ_RTNG_GOAL_CHCK_LIST_DEPT");
        ...
        this.fnEnableButton = function() {
        	var list = ['NO_COL', 'DS_GOAL_WRK', 'DS_GOAL_LVL_MIN', 'DS_GOAL_LVL_MAX', 'DS_HGHYR_ACPT', 'DS_LOWHYR_PLN', 'DS_STAF_OPNN','DS_FDBK_TOT_A','DS_FDBK_TOT_B'];
        	for (var i = 0; i < list.length; i++) {
        ...
        this.loadIncludeScript("DAJ_RTNG_GOAL_CHCK_LIST_DEPT.xfdl");
