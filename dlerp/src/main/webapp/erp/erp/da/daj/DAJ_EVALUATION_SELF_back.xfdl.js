(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staDS_CONTENT","0","objGrid:0",null,"22","380",null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("업무실적");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.addChild(obj.name, obj);

            obj = new TextArea("txtDS_CONTENT","10","staDS_CONTENT:3",null,"159","10",null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staDS_OPINION","0","txtDS_CONTENT:6",null,"22","170",null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            ...
            obj = new BindItem("item6","divData.form.divTop.form.calTO_SELF","value","dsDate","TO_SELF");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divData.form.divTop.form.calFR_SELF","value","dsDate","FR_SELF");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAJ_EVALUATION_SELF_back.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.staDS_CONTENT.addEventHandler("onclick",this.divData_staDS_CONTENT_onclick,this);
            this.divData.form.txtDS_OPINION.addEventHandler("onkeydown",this.divData_txtDS_OPINION_onkeydown,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DAJ_EVALUATION_SELF_back.xfdl");
