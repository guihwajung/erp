(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select_status</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHCK_MNG_SELECT</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("DAJ_RTNG_GOAL_CHCK_LIST.xfdl", function() {
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if (id == "ccfCD_CORP") {
        		...
        		dsUserParam.setColumn(nrow, "ID_SCREEN"   , "DAJ_RTNG_GOAL_CHCK_LIST");
        ...
        this.loadIncludeScript("DAJ_RTNG_GOAL_CHCK_LIST.xfdl");
