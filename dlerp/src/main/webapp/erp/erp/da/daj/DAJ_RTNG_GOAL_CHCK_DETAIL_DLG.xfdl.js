(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select_goal_detail</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHCK_SELECT</Col></Row><Row><Col id=\"TARGET\">save_goal_detail</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHCK_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAJ_RTNG_GOAL_CHCK_DETAIL_DLG.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsListGoalDetail, "DA", "DAJ_RTNG_GOAL_CHCK");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSaveGoalDetail.addColumn("YN_SBMS", "int");
        	...
        	this.dsSaveGoalDetail.addColumn("DS_HGHYR_ACPT", "string");
        	this.dsSaveGoalDetail.addColumn("TYPE_HGHYR_ACPT_RTNG", "string");
        	this.dsSaveGoalDetail.addColumn("DS_LOWHYR_PLN", "string");
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	...
        	if (svcID == "select_goal_detail") {
        		...
        		// 버튼 상태 변경
        		if (this.dsSearch.getColumn(0, "STATUS_RTNG") == "30" || this.dsSearch.getColumn(0, "STATUS_RTNG") == "CHCK") {
        		...
        		if (this.dsSearch.getColumn(0, "STATUS_RTNG") == "CHCK" && this.dsSearch.getColumn(0, "TY_PTCP") == "B") {
        ...
        this.fnEnableButton = function() {
        	// 작성중
        	if ((this.dsSearch.getColumn(0, "STATUS_RTNG") == "30" || this.dsSearch.getColumn(0, "STATUS_RTNG") == "CHCK") && (this.getOwnerFrame().READ_ONLY == "false" || this.getOwnerFrame().READ_ONLY == undefined)) { // 중간점검
        		if (this.dsSearch.getColumn(0, "TY_PTCP") == "B") {	// 피평가자
        			...
        			this.dxGrid.setCellProperty("body", this.dxGrid.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG"), "cssclass", "");
        			this.dxGrid.setCellProperty("body", this.dxGrid.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG"), "edittype", "combo");

        			this.dsListGoalDetail.set_enableevent(false);
        			for (var i = 0; i < this.dsListGoalDetail.rowcount; i++) {
        				this.dsListGoalDetail.setColumn(i, "MULTILINE_READONLY", "Y");
        				this.dsListGoalDetail.setColumn(i, "MULTILINE_EXCLUDE_COLUMNS", "DS_GOAL_WRK,DS_GOAL_LVL_MIN,DS_GOAL_LVL_MAX,DS_HGHYR_ACPT,DS_LOWHYR_PLN");
        			}
        			this.dsListGoalDetail.set_enableevent(true);
        		}
        		...
        		if (this.dsSearch.getColumn(0, "TY_PTCP") == "R") {	// 평가자
        			...
        			this.dxGrid.setCellProperty("body", this.dxGrid.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG"), "cssclass", "BACK_ReadOnly");
        			this.dxGrid.setCellProperty("body", this.dxGrid.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG"), "edittype", "none");
        ...
        this.btnSave_onclick = function(obj,e) {
        	...
        	for (var i = 0; i < this.dsListGoalDetail.rowcount; i++) {
        		...
        		case "D":
        			...
        			this.dsSaveGoalDetail.setColumn(nrow, "DS_HGHYR_ACPT"       , this.dsListGoalDetail.getColumn(i, "DS_HGHYR_ACPT"));
        			this.dsSaveGoalDetail.setColumn(nrow, "TYPE_HGHYR_ACPT_RTNG", this.dsListGoalDetail.getColumn(i, "TYPE_HGHYR_ACPT_RTNG"));
        			this.dsSaveGoalDetail.setColumn(nrow, "DS_LOWHYR_PLN"       , this.dsListGoalDetail.getColumn(i, "DS_LOWHYR_PLN"));
        ...
        this.loadIncludeScript("DAJ_RTNG_GOAL_CHCK_DETAIL_DLG.xfdl");
