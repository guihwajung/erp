(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("목표수립 주의사항");
            this.getSetter("maxwidth").set("1640");
            this.getSetter("maxheight").set("945");
            if (Form == this.constructor)
            {
                this._setFormPosition(1600,867);
            }
            ...
            obj = new Div("divSearch","0","0","1600","830",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new ImageViewer("PIC","0","0","1600","830",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("divData","0","divSearch:10","1600","27",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Div("divBtns","0","0","1600","27",null,null,null,null,null,null,this.divData.form);
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnOK","770","0","60","27",null,null,null,null,null,null,this.divData.form.divBtns.form);
            obj.set_taborder("1");
            obj.set_text("닫기");
            this.divData.form.divBtns.addChild(obj.name, obj);

            obj = new Button("btnfile",null,"0","60","27","5",null,null,null,null,null,this.divData.form.divBtns.form);
            obj.set_taborder("2");
            obj.set_text("업로드");
            this.divData.form.divBtns.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DAJ_RTNG_GOAL_RULE_DLG.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divBtns.form.btnfile.addEventHandler("onclick",this.btnfile_onclick,this);
        };
        this.loadIncludeScript("DAJ_RTNG_GOAL_RULE_DLG.xfdl");
