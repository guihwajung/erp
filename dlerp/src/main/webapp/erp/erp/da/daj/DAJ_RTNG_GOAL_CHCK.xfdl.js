(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsListGoalCheckSummary", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListGoalCheck", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListGoalCheckOpinion", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select_goal_bgvdprsn</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_BGVDPRSN_SELECT</Col></Row><Row><Col id=\"TARGET\">select_goal_check_summary</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_ESTT_SUMMARY_SELECT</Col></Row><Row><Col id=\"TARGET\">select_goal_check</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHCK_SELECT</Col></Row><Row><Col id=\"TARGET\">select_goal_check_excel</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHCK_EXCEL_SELECT</Col></Row><Row><Col id=\"TARGET\">save_goal_check</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHCK_SAVE</Col></Row><Row><Col id=\"TARGET\">select_goal_check_opnn</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_MDDL_CHK_OPNN_SELECT</Col></Row><Row><Col id=\"TARGET\">save_goal_check_opnn</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_MDDL_CHK_OPNN_SAVE</Col></Row><Row><Col id=\"TARGET\">submit_goal_check</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHCK_SUBMIT</Col></Row><Row><Col id=\"TARGET\">save_goal_invw</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_ITVW_PRSN_SAVE</Col></Row><Row><Col id=\"TARGET\">request_goal_check_modify</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHECK_MODIFY_REQUEST</Col></Row><Row><Col id=\"TARGET\">complete_goal_check_interview_apply</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHECK_INTERVIEW_APPLY</Col></Row><Row><Col id=\"TARGET\">complete_goal_check_interview</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHECK_INTERVIEW_COMPLETE</Col></Row><Row><Col id=\"TARGET\">complete_goal_check_interview_all</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHECK_INTERVIEW_COMPLETE_ALL</Col></Row><Row><Col id=\"TARGET\">select_goal_history</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_HISTORY_SELECT</Col></Row><Row><Col id=\"TARGET\">select_rtng_std</Col><Col id=\"SP\">DAXPR_RTNG_STD_CODEFIND</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staStatusCheck","0","5","190","40",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataTop.form.divStatus.form);
            obj.set_taborder("0");
            obj.set_text("중간점검 작성중");
            ...
            obj = new Static("staStatusRequest","staStatusCheck:5","5","190","40",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataTop.form.divStatus.form);
            obj.set_taborder("1");
            obj.set_text("중간점검 면담진행중");
            obj.set_textAlign("center");
            obj.set_background("#edecef");
            obj.set_font("bold 14px/normal \"Malgun Gothic\"");
            this.divData.form.divDataRight.form.divDataTop.form.divStatus.addChild(obj.name, obj);

            obj = new Static("staStatusApply","staStatusRequest:5","5","190","40",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataTop.form.divStatus.form);
            obj.set_taborder("2");
            ...
            obj = new Grid("objGridTitle5","0","10",null,null,"0","120",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("5");
            obj.set_autosizingtype("none");
            obj.set_visible("false");
            ...
            obj = new TextArea("txtDS_STAF_OPNN","0","sta03:10","50%",null,null,"0",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("1");
            obj.set_enable("false");
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.addChild(obj.name, obj);

            obj = new TextArea("txtDS_FDBK","txtDS_STAF_OPNN:4","sta03:10",null,null,"0","0",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("1");
            obj.set_enable("false");
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.addChild(obj.name, obj);

            obj = new Tab("tabData","txtDS_STAF_OPNN:4","sta04:10",null,null,"0","0",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("0");
            obj.set_tabindex("1");
            obj.set_visible("false");
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAJ_RTNG_GOAL_CHCK.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnHistory  = this.gfnFormButtonAdd("btnHistory" , "fnHistory");	// 목표이력조회 버튼
        ...
        this.fnSetVariable = function() {
        	...
        	// 상태표현
        	this.staStatusCheck     = this.divData.form.divDataRight.form.divDataTop.form.divStatus.form.staStatusCheck;		// 목표중간점검
        	this.staStatusRequest   = this.divData.form.divDataRight.form.divDataTop.form.divStatus.form.staStatusRequest;		// 중간점검 확인요청중
        	this.staStatusApply 	= this.divData.form.divDataRight.form.divDataTop.form.divStatus.form.staStatusApply;		// 피드백완료(평가자2명인경우)
        	this.staStatusCompleted = this.divData.form.divDataRight.form.divDataTop.form.divStatus.form.staStatusCompleted;	// 목표중간점검완료
        	...
        	// 요청사항/피드백
        	this.txtDS_STAF_OPNN = this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form.txtDS_STAF_OPNN;
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGridSub, this.dsListGoalCheck, "DA", "DAJ_RTNG_GOAL_CHCK");
        	this.gfnGridInit(this.dxGridSubExcl, this.dsExcel, "DA", "DAJ_RTNG_GOAL_CHCK_EXCL");
        	this.gfnGridInit(this.dxGridTitle, this.dsExcelTitle, "DA", "DAJ_EXCL_GOAL_CHCK"); //엑셀타이틀
         	this.gfnGridInit(this.dxGridTitle2, this.dsExcelTitle2, "DA", "DAJ_EXCL2_GOAL_CHCK"); //엑셀타이틀
         	this.gfnGridInit(this.dxGridTitle3, this.dsExcelTitle3, "DA", "DAJ_EXCL3_GOAL_CHCK"); //엑셀타이틀
         	this.gfnGridInit(this.dxGridTitle4, this.dsExcelTitle4, "DA", "DAJ_EXCL4_GOAL_CHCK"); //엑셀타이틀
         	this.gfnGridInit(this.dxGridTitle5, this.dsExcelTitle5, "DA", "DAJ_EXCL5_GOAL_CHCK"); //엑셀타이틀
        	...
        	var colTYPE_HGHYR_ACPT_RTNG = this.dxGridSub.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG");
        	var colDS_HGHYR_ACPT 		= this.dxGridSub.getBindCellIndex("body", "DS_HGHYR_ACPT");
        	var colDS_LOWHYR_PLN 		= this.dxGridSub.getBindCellIndex("body", "DS_LOWHYR_PLN");
        	...
        	this.dxGridSub.setCellProperty("body",colTYPE_HGHYR_ACPT_RTNG,	"tooltiptext","bind:TTP_TYPE_HGHYR_ACPT_RTNG");
        	this.dxGridSub.setCellProperty("body",colDS_HGHYR_ACPT,			"tooltiptext","bind:TTP_DS_HGHYR_ACPT");
        	this.dxGridSub.setCellProperty("body",colDS_LOWHYR_PLN,			"tooltiptext","bind:TTP_DS_LOWHYR_PLN");
        }
        ...
        this.fnSetParameter = function() {
        	...
        	// 업무목표 중간점검 요약 조회
        	this.dsSelectGoaleCheckSummary = new Dataset();
        	this.dsSelectGoaleCheckSummary.addColumn("CD_CORP", "string");
        	this.dsSelectGoaleCheckSummary.addColumn("ID_RTNG", "string");
        	this.dsSelectGoaleCheckSummary.addColumn("ID_SABUN_BGVD", "string");
        	this.dsSelectGoaleCheckSummary.addColumn("ID_SABUN_ITVW", "string");
        	this.dsSelectGoaleCheckSummary.addColumn("TY_PTCP", "string");

        	// 업무목표 중간점검
        	this.dsSelectGoalCheck = new Dataset();
        	this.dsSelectGoalCheck.addColumn("CD_CORP", "string");
        	this.dsSelectGoalCheck.addColumn("ID_RTNG", "string");
        	this.dsSelectGoalCheck.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsSelectGoalCheck.addColumn("ID_ITVWPRSN", "string");
        	this.dsSelectGoalCheck.addColumn("TY_PTCP", "string");

         	// 업무목표 중간점검 저장
        	this.dsSaveGoalCheck = new Dataset();
        	this.dsSaveGoalCheck.addColumn("TY_WRK", "string");
        	this.dsSaveGoalCheck.addColumn("CD_CORP", "string");
        	this.dsSaveGoalCheck.addColumn("ID_RTNG", "string");
        	this.dsSaveGoalCheck.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsSaveGoalCheck.addColumn("SEQ_GOAL", "int");
        	this.dsSaveGoalCheck.addColumn("NO_COL", "int");
        	this.dsSaveGoalCheck.addColumn("YN_SBMS", "string");
        	this.dsSaveGoalCheck.addColumn("DS_GOAL_WRK", "string");
        	this.dsSaveGoalCheck.addColumn("DS_EXEC_PLN_HGHYR", "string");
        	this.dsSaveGoalCheck.addColumn("DS_EXEC_PLN_LOWHYR", "string");
        	this.dsSaveGoalCheck.addColumn("DS_GOAL_LVL_MIN", "string");
        	this.dsSaveGoalCheck.addColumn("DS_GOAL_LVL_MAX", "string");
        	this.dsSaveGoalCheck.addColumn("DS_MNPT_ADMN", "string");
        	this.dsSaveGoalCheck.addColumn("NO_WGTV", "int");
        	this.dsSaveGoalCheck.addColumn("DS_RMK", "string");
        	this.dsSaveGoalCheck.addColumn("DS_HGHYR_ACPT", "string");
        	this.dsSaveGoalCheck.addColumn("TYPE_HGHYR_ACPT_RTNG", "string");
        	this.dsSaveGoalCheck.addColumn("DS_LOWHYR_PLN", "string");
        	this.dsSaveGoalCheck.addColumn("ID_USER", "string");
        	this.dsSaveGoalCheck.addColumn("TY_PTCP", "string");

        	// 업무목표 중간점검 직원 요청사항 조회
        	this.dsSelectGoalCheckOpinion = new Dataset();
        	this.dsSelectGoalCheckOpinion.addColumn("CD_CORP", "string");
        	this.dsSelectGoalCheckOpinion.addColumn("ID_RTNG", "string");
        	this.dsSelectGoalCheckOpinion.addColumn("SEQ_BGVDPRSN", "int");

        	// 업무목표 중간점검 직원 요청사항 저장
        	this.dsSaveGoalCheckOpnion = new Dataset();
        	this.dsSaveGoalCheckOpnion.addColumn("CD_CORP", "string");
        	this.dsSaveGoalCheckOpnion.addColumn("ID_RTNG", "string");
        	this.dsSaveGoalCheckOpnion.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsSaveGoalCheckOpnion.addColumn("DS_STAF_OPNN", "string");
        	this.dsSaveGoalCheckOpnion.addColumn("ID_USER", "string");

        	// 업무목표 중간점검 제출
        	this.dsSubmitGoalCheck = new Dataset();
        	this.dsSubmitGoalCheck.addColumn("CD_CORP", "string");
        	this.dsSubmitGoalCheck.addColumn("ID_RTNG", "string");
        	this.dsSubmitGoalCheck.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsSubmitGoalCheck.addColumn("ID_USER", "string");
        	...
        	// 업무목표 중간점검 재입력 요청
        	this.dsSaveGoalCheckModifyRequest = new Dataset();
        	this.dsSaveGoalCheckModifyRequest.addColumn("CD_CORP", "string");
        	this.dsSaveGoalCheckModifyRequest.addColumn("ID_RTNG", "string");
        	this.dsSaveGoalCheckModifyRequest.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsSaveGoalCheckModifyRequest.addColumn("ID_USER", "string");

        	// 업무목표 중간점검 면담 완료
        	this.dsSaveGoalCheckInterviewComplete = new Dataset();
        	this.dsSaveGoalCheckInterviewComplete.addColumn("CD_CORP", "string");
        	this.dsSaveGoalCheckInterviewComplete.addColumn("ID_RTNG", "string");
        	this.dsSaveGoalCheckInterviewComplete.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsSaveGoalCheckInterviewComplete.addColumn("SEQ_ITVWPRSN", "int");
        	this.dsSaveGoalCheckInterviewComplete.addColumn("ID_USER", "string");
        ...
        this.fnExcel = function() {
        	...
        	this.fnExcelExportTest(this.dxGridSubExcl, "업무목표중간점검", "업무목표중간점검");
        }
        ...
        this.fnExcelExportTest = function(objGridExcel, sSheetName, sFileName)
        {
        	...
        	//var rowCnt5 = this.dsExcel.rowcount;
        	rowCnt5 = rowCnt4 + 2;
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	...
        	// 업무목표 중간점검 조회
        	else if (svcID == "select_goal_check") {
        		var items = ['DS_GOAL_WRK', 'DS_GOAL_LVL_MIN', 'DS_GOAL_LVL_MAX', 'DS_HGHYR_ACPT', 'DS_LOWHYR_PLN'];
        		var list = [];
        		for (var i = 0; i < this.dsListGoalCheck.rowcount; i++) {
        			var max = 0;
        			for (var j = 0; j < items.length; j++) {
        				var item = this.dsListGoalCheck.getColumn(i, items[j]) || "";
        				var line = item.split("\n").length;
        				if (line > max) {
        					max = line;
        				}
        ...
        // 		this.dxGridTitle4.set_autosizingtype("row");
        		...
        		// 대상자
        		this.staBGVDPRSN_ID_SABUN_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "ID_SABUN_BGVD"));		// 사번
        		this.staBGVDPRSN_DS_HNAME_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_HNAME_BGVD"));		// 성명
        		this.staBGVDPRSN_DS_POSITION_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_POSITION_BGVD"));	// 직급
        		this.staBGVDPRSN_DS_EMPTYPE_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_EMPTYPE_BGVD"));	// 직종
        		this.staBGVDPRSN_DS_DEPT_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_DEPT_BGVD"));			// 평가조직
        		this.staBGVDPRSN_DS_DUTY_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_DUTY_BGVD"));			// 직책

        		// 면담자
        		this.staITVWPRSN_ID_SABUN_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "ID_SABUN_ITVW"));		// 사번
        		this.staITVWPRSN_DS_HNAME_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_HNAME_ITVW"));		// 성명
        		//this.staITVWPRSN_DS_POSITION_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_POSITION_ITVW"));	// 직급
        		//this.staITVWPRSN_DS_EMPTYPE_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_EMPTYPE_ITVW")); 	// 직종
        		//this.staITVWPRSN_DS_DEPT_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_DEPT_ITVW"));			// 평가조직
        		this.staITVWPRSN_DS_DUTY_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_DUTY_ITVW"));			// 직책
        		this.staITVWPRSN_STAT_RTNG_bg.set_text(this.dsListGoalCheckSummary.getColumn(0, "DS_STAT_RTNG"));			// 평가상태

        		this.staITVWPRSN_ID_SABUN_B_bg.set_text(this.dsListGoalCheckSummary.getColumn(1, "ID_SABUN_ITVW"));		// 사번
        		this.staITVWPRSN_DS_HNAME_B_bg.set_text(this.dsListGoalCheckSummary.getColumn(1, "DS_HNAME_ITVW"));		// 성명
        		this.staITVWPRSN_DS_DUTY_B_bg.set_text(this.dsListGoalCheckSummary.getColumn(1, "DS_DUTY_ITVW"));		// 직책
        		this.staITVWPRSN_STAT_RTNG_B_bg.set_text(this.dsListGoalCheckSummary.getColumn(1, "DS_STAT_RTNG"));		// 평가상태

        		// 평가자2명인 경우(승인자/면담자)
        		this.ID_SABUN_ITVW  = this.dsListGoalCheckSummary.getColumn(0, "ID_SABUN_ITVW");
        		...
        		// 직원 요청사항/면담자 피드백
        		this.txtDS_STAF_OPNN.set_value(this.dsListGoalCheckOpinion.getColumn(0, "DS_STAF_OPNN"));
        		this.txtDS_FDBK.set_value(this.dsListGoalCheckSummary.getColumn(this.dsListGoalCheckSummary.rowposition, "DS_FDBK"));
        		this.txtDS_FDBK_A.set_value(this.dsListGoalCheckSummary.getColumn(this.dsListGoalCheckSummary.rowposition, "DS_FDBK_A"));
        		this.txtDS_FDBK_B.set_value(this.dsListGoalCheckSummary.getColumn(this.dsListGoalCheckSummary.rowposition, "DS_FDBK_B"));

        		if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "STAT_RTNG") == "CHCK" && this.dsSearch.getColumn(0, "TY_PTCP") == "B") {
        			var nrow = this.dsListGoalCheck.rowcount;
        			this.dxGridSub.setCellPos(0, nrow-1);
        		}
        	}
        	// 업무목표 중간점검 저장
        	else if (svcID == "save_goal_check") {
        		this.fnSelectGoalCheck();
        		this.gfnSetFormStatus(this);	// 폼상태 초기화
        		this.btnSave.set_enable(false);
        		//this.FormBtns.Select.click();
        	}
        	// 업무목표 중간점검 제출
        	else if (svcID == "submit_goal_check") {
        		//this.fnSelectGoalCheck();
        		this.FormBtns.Select.click();
        	}
        	// 업무목표 중간점검 수정 요청
        	else if (svcID == "request_goal_check_modify") {
        		//this.fnSelectGoalCheck();
        		this.FormBtns.Select.click();
        	}
        	// 업무목표 중간점검 면담 검토자 피드백완료(평가자2명인경우)
        	else if (svcID == "complete_goal_check_interview_apply") {
        		//this.fnSelectGoalCheck();
        		this.FormBtns.Select.click();
        	}
        	// 업무목표 중간점검 면담 최종 완료
        	else if (svcID == "complete_goal_check_interview") {
        		//this.fnSelectGoalCheck();
        		this.FormBtns.Select.click();
        	}
        ...
        this.fnCheckExtensionButtonStatus = function() {
        	...
        	// 평가자2명인 경우(승인자/면담자)
        	var YN_APPLY  = this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "YN_APPLY");
        	var CL_ITVWPRSN  = this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "CL_ITVWPRSN");
        	this.staStatusApply.set_visible(false);
        	this.staStatusCompleted.set_left(390); // 585

         	// 업무목표 중간점검
        	var YN_MDDL_CHK = this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "YN_MDDL_CHK");
        	this.staStatusCheck.set_background("#edecef");
        	this.staStatusCheck.set_color("black");

        	//if (YN_MDDL_CHK == "Y") {
        	if (STATUS_RTNG == "30" || STATUS_RTNG == "CHCK") {
        		this.staStatusCheck.set_background("lightgray");
        		this.staStatusCheck.set_color("red");
        		this.staStatusRequest.set_background("#edecef");
        		this.staStatusRequest.set_color("black");
        ...
        // 		}
        	...
        	// 업무목표 중간점검 확인요청중
        	var YN_VRF_RQST = this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "YN_VRF_RQST");
        	this.staStatusRequest.set_background("#edecef");
        	this.staStatusRequest.set_color("black");
        	//if (YN_VRF_RQST == "Y") {
        	if (STATUS_RTNG == "RQST") {
        		this.staStatusCheck.set_background("#edecef");
        		this.staStatusCheck.set_color("black");
        		this.staStatusRequest.set_background("lightgray");
        		this.staStatusRequest.set_color("red");
        		this.staStatusCompleted.set_background("#edecef");
        		this.staStatusCompleted.set_color("black");
        ...
        // 		}
        	...
        	// 업무목표 중간점검 확인완료
        	var YN_CHK_CPLT = this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "YN_CHK_CPLT");
        	this.staStatusCompleted.set_background("#edecef");
        	this.staStatusCompleted.set_color("black");
        	//if (YN_CHK_CPLT == "Y") {
        	if (STATUS_RTNG == "CPLT2") {
        		this.staStatusCheck.set_background("#edecef");
        		this.staStatusCheck.set_color("black");
        		this.staStatusRequest.set_background("#edecef");
        		this.staStatusRequest.set_color("black");
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if (id == "ccfCD_CORP") {
        		...
        		dsUserParam.setColumn(nrow, "CD_RTNG_TYPE", "JA11");
        		dsUserParam.setColumn(nrow, "ID_SCREEN"   , "DAJ_RTNG_GOAL_CHCK");
        ...
        console.log('fnGridAfterEdit', e);
        	if (e.columnid == "NO_COL") {	// 순번
        		if (e.oldvalue != e.newvalue) {
        			...
        			this.dsListGoalCheck.set_enableevent(false);
        			for (var i = newRow; i < this.dsListGoalCheck.rowcount; i++) {
        				var flag = this.gfnGetFlag(this.dsListGoalCheck, i);
        				var oldNO_COL = this.dsListGoalCheck.getColumn(i, "NO_COL");
        				if (no_col != oldNO_COL) {
        					if (flag != "I" && flag != "D") {
        						this.dsListGoalCheck.setColumn(i, this.ucFlag, "U");
        					}
        					this.dsListGoalCheck.setColumn(i, "NO_COL", no_col);
        				}
        				no_col++;
        			}
        			this.dsListGoalCheck.set_enableevent(true);
        		}
        	}
        ...
        this.getNextNoCol = function() {
        	var MAX = 0;
        	for (var i = 0; i < this.dsListGoalCheck.rowcount; i++) {
        		if (this.dsListGoalCheck.getColumn(i, "NO_COL") > MAX) {
        			MAX = this.dsListGoalCheck.getColumn(i, "NO_COL");
        		}
        	}
        	return MAX + 1;
        }
        ...
        {
        	if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "STAT_RTNG") != "CHCK") {
        		return false;
        	}
        ...
        this.fnEnableButton = function() {
        	...
        	if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "STAT_RTNG") == "CHCK") {
        		if (this.dsSearch.getColumn(0, "TY_PTCP") == "B") {	// 피평가자
        			this.btnHistory.set_visible(true);		// 이력조회
        			...
        			this.btnHistory.set_enable(true);		// 이력조회
        			...
        			this.txtDS_STAF_OPNN.set_enable(true);
        			...
        			var list = ['NO_COL', 'DS_GOAL_WRK', 'DS_GOAL_LVL_MIN', 'DS_GOAL_LVL_MAX', 'DS_HGHYR_ACPT', 'DS_LOWHYR_PLN'];
        			for (var i = 0; i < list.length; i++) {
        			...
        			this.dxGridSub.setCellProperty("body", this.dxGridSub.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG"), "cssclass", "");
        			this.dxGridSub.setCellProperty("body", this.dxGridSub.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG"), "edittype", "combo");

        			this.dsListGoalCheck.set_enableevent(false);
        			for (var i = 0; i < this.dsListGoalCheck.rowcount; i++) {
        				this.dsListGoalCheck.setColumn(i, "MULTILINE_READONLY", "Y");
        				this.dsListGoalCheck.setColumn(i, "MULTILINE_EXCLUDE_COLUMNS", "DS_GOAL_WRK,DS_GOAL_LVL_MIN,DS_GOAL_LVL_MAX,DS_HGHYR_ACPT,DS_LOWHYR_PLN");
        			}
        			this.dsListGoalCheck.set_enableevent(true);
        		}
        		...
        		if (this.dsSearch.getColumn(0, "TY_PTCP") == "R") {	// 평가자
        			...
        			// 평가자2명인 경우(승인자/면담자)
        			if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "YN_APPLY") != "Y") {
        				if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "CL_ITVWPRSN") == "01") { // 평가자B
        					this.btnRequest.set_visible(false);		// 수정요청
        			...
        			this.txtDS_STAF_OPNN.set_enable(false);
        			this.txtDS_FDBK.set_enable(false);
        			this.txtDS_FDBK_A.set_enable(false);
        			this.txtDS_FDBK_B.set_enable(false);
        			...
        			this.dxGridSub.setCellProperty("body", this.dxGridSub.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG"), "cssclass", "BACK_ReadOnly");
        			this.dxGridSub.setCellProperty("body", this.dxGridSub.getBindCellIndex("body", "TYPE_HGHYR_ACPT_RTNG"), "edittype", "none");

        			this.dsListGoalCheck.set_enableevent(false);
        			for (var i = 0; i < this.dsListGoalCheck.rowcount; i++) {
        				this.dsListGoalCheck.setColumn(i, "MULTILINE_READONLY", "Y");
        				this.dsListGoalCheck.setColumn(i, "MULTILINE_EXCLUDE_COLUMNS", "");
        			}
        			this.dsListGoalCheck.set_enableevent(true);
        		}
        	}
        	// 면담진행중
        	if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "STAT_RTNG") == "RQST") {
        		if (this.dsSearch.getColumn(0, "TY_PTCP") == "B") {	// 피평가자
        			this.btnHistory.set_visible(true);		// 이력조회
        			this.btnRequest.set_visible(false);		// 수정요청
        			this.btnSubmit.set_visible(true);		// 제출
        		...
        		if (this.dsSearch.getColumn(0, "TY_PTCP") == "R") {	// 평가자
        			...
        			if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "YN_APPLY") == "Y") {
        				...
        				if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "CL_ITVWPRSN") == "01") {
        					this.btnApply.set_visible(true);		// 피드백완료
        	...
        	// 평가자 피드백 완료(APPL)
        	if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "STAT_RTNG") == "APPL") {
        	...
        	// 면담완료
        	if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "STAT_RTNG") == "CPLT2"
        ...
        // 	this.dsListGoalBgvdprsn.filter("STATUS_RTNG != 'CPLT2'");
        ...
        // 	this.dsListGoalBgvdprsn.set_enableevent(true);
        	...
        	if (this.getOwnerFrame().READ_ONLY) {
        		this.btnHistory.set_enable(false);
        	}
        }

        this.fnSelectGoalCheck = function() {
        	...
        	// 업무목표 중간점검 요약 정보
        	this.dsSelectGoaleCheckSummary.clearData();
        	this.dsSelectGoaleCheckSummary.addRow();
        	this.dsSelectGoaleCheckSummary.setColumn(0, "CD_CORP", this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSelectGoaleCheckSummary.setColumn(0, "ID_RTNG", this.dsSearch.getColumn(0, "ID_RTNG"));
        	if (this.dsSearch.getColumn(0, "TY_PTCP") == "B") {
        		this.dsSelectGoaleCheckSummary.setColumn(0, "ID_SABUN_BGVD", this.dsSearch.getColumn(0, "ID_SABUN"));
        		this.dsSelectGoaleCheckSummary.setColumn(0, "ID_SABUN_ITVW", this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "ID_ITVWPRSN"));
        	}
        	if (this.dsSearch.getColumn(0, "TY_PTCP") == "R" || this.dsSearch.getColumn(0, "TY_PTCP") == "M") {
        		this.dsSelectGoaleCheckSummary.setColumn(0, "ID_SABUN_BGVD", this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "ID_SABUN"));
        		this.dsSelectGoaleCheckSummary.setColumn(0, "ID_SABUN_ITVW", this.dsSearch.getColumn(0, "ID_SABUN"));
        	}
        	this.dsSelectGoaleCheckSummary.setColumn(0, "TY_PTCP", this.dsSearch.getColumn(0, "TY_PTCP"));

        	// 업무목표 중간점검
        	this.dsSelectGoalCheck.clearData();
        	this.dsSelectGoalCheck.addRow()
        	this.dsSelectGoalCheck.setColumn(0, "CD_CORP"     , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSelectGoalCheck.setColumn(0, "ID_RTNG"     , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSelectGoalCheck.setColumn(0, "SEQ_BGVDPRSN", this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "SEQ_BGVDPRSN"));
        	this.dsSelectGoalCheck.setColumn(0, "ID_ITVWPRSN", this.dsSearch.getColumn(0, "ID_SABUN"));
        	this.dsSelectGoalCheck.setColumn(0, "TY_PTCP", this.dsSearch.getColumn(0, "TY_PTCP"));

        	// 업무목표 중간점검 직원 요청사항
        	this.dsSelectGoalCheckOpinion.clearData();
        	this.dsSelectGoalCheckOpinion.addRow()
        	this.dsSelectGoalCheckOpinion.setColumn(0, "CD_CORP"     , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSelectGoalCheckOpinion.setColumn(0, "ID_RTNG"     , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSelectGoalCheckOpinion.setColumn(0, "SEQ_BGVDPRSN", this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "SEQ_BGVDPRSN"));

        	var strSvcId    = "select_goal_check";
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "select_goal_check_summary=dsSelectGoaleCheckSummary select_goal_check=dsSelectGoalCheck select_goal_check_opnn=dsSelectGoalCheckOpinion select_goal_check_excel=dsSelectGoaleCheckSummary";
        	var outData     = "dsListGoalCheckSummary=select_goal_check_summary0 dsListGoalCheck=select_goal_check0 dsListGoalCheckOpinion=select_goal_check_opnn0 dsExcelTitle=select_goal_check_excel0 dsExcelTitle2=select_goal_check_excel1 dsExcelTitle3=select_goal_check_excel2 dsExcel=select_goal_check_excel3 dsExcelTitle4=select_goal_check_excel4 dsExcelTitle5=select_goal_check_excel5";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.btnGoal_Estt_Itvw_onclick = function(obj,e) {
        	...
        	param.TY_PTCP = 'B';
        	param.ID_SABUN = this.dsListGoalCheckSummary.getColumn(0, "ID_SABUN_ITVW");
        	param.DS_HNAME = this.dsListGoalCheckSummary.getColumn(0, "DS_HNAME_ITVW");
        	param.SEQ_BGVDPRSN = this.dsListGoalCheckSummary.getColumn(0, "SEQ_ITVWPRSN_BGVDPRSN");
        	param.CD_RTNG_TYPE = 'JA11';
        ...
        this.btnDetail_onclick = function(obj,e) {
        	...
        	param.ID_SABUN = this.dsListGoalCheckSummary.getColumn(0, "ID_SABUN_BGVD");
        	param.DS_HNAME = this.dsListGoalCheckSummary.getColumn(0, "DS_HNAME_BGVD");
        	param.SEQ_BGVDPRSN = this.dsListGoalCheckSummary.getColumn(0, "SEQ_BGVDPRSN");
        	param.STATUS_RTNG = this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "STATUS_RTNG");
        	param.CL_ITVWPRSN = this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "CL_ITVWPRSN");

        	var Width = this.objApp.mainframe.width;		//this.parent.parent.parent.width;
        	var height = this.objApp.mainframe.height-25;	//this.parent.parent.parent.height;

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DAJ_RTNG_GOAL_CHCK_DETAIL_DLG", "fnDetailCallback", param, Width, height);
        }
        ...
        this.btnSave_onclick = function(obj,e) {
        	...
        	this.dsSaveGoalCheck.clearData();
        	...
        	if (this.dsSearch.getColumn(0, "TY_PTCP") == "B")	// 피평가자
        	{
        		for (var i = 0; i < this.dsListGoalCheck.rowcount; i++) {
        			...
        			case "U":
        			case "D":
        				var nrow = this.dsSaveGoalCheck.addRow();

        				this.dsSaveGoalCheck.setColumn(nrow, "TY_WRK"              , flag);
        				this.dsSaveGoalCheck.setColumn(nrow, "CD_CORP"             , this.dsSearch.getColumn(0, "CD_CORP"));
        				this.dsSaveGoalCheck.setColumn(nrow, "ID_RTNG"             , this.dsSearch.getColumn(0, "ID_RTNG"));
        				this.dsSaveGoalCheck.setColumn(nrow, "SEQ_BGVDPRSN"        , this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "SEQ_BGVDPRSN"));
        				this.dsSaveGoalCheck.setColumn(nrow, "SEQ_GOAL"            , this.dsListGoalCheck.getColumn(i, "SEQ_GOAL"));
        				this.dsSaveGoalCheck.setColumn(nrow, "NO_COL"              , this.dsListGoalCheck.getColumn(i, "NO_COL"));
        				this.dsSaveGoalCheck.setColumn(nrow, "YN_SBMS"             , this.dsListGoalCheck.getColumn(i, "YN_SBMS"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_GOAL_WRK"         , this.gfnNvl(this.dsListGoalCheck.getColumn(i, "DS_GOAL_WRK"), "").replace(/\v/g,"\n"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_EXEC_PLN_HGHYR"   , this.gfnNvl(this.dsListGoalCheck.getColumn(i, "DS_EXEC_PLN_HGHYR"), "").replace(/\v/g,"\n"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_EXEC_PLN_LOWHYR"  , this.gfnNvl(this.dsListGoalCheck.getColumn(i, "DS_EXEC_PLN_LOWHYR"), "").replace(/\v/g,"\n"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_GOAL_LVL_MIN"     , this.gfnNvl(this.dsListGoalCheck.getColumn(i, "DS_GOAL_LVL_MIN"), "").replace(/\v/g,"\n"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_GOAL_LVL_MAX"     , this.gfnNvl(this.dsListGoalCheck.getColumn(i, "DS_GOAL_LVL_MAX"), "").replace(/\v/g,"\n"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_MNPT_ADMN"        , this.gfnNvl(this.dsListGoalCheck.getColumn(i, "DS_MNPT_ADMN"), "").replace(/\v/g,"\n"));
        				this.dsSaveGoalCheck.setColumn(nrow, "NO_WGTV"             , this.dsListGoalCheck.getColumn(i, "NO_WGTV"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_RMK"              , this.dsListGoalCheck.getColumn(i, "DS_RMK"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_HGHYR_ACPT"       , this.gfnNvl(this.dsListGoalCheck.getColumn(i, "DS_HGHYR_ACPT"), "").replace(/\v/g,"\n"));
        				this.dsSaveGoalCheck.setColumn(nrow, "TYPE_HGHYR_ACPT_RTNG", this.dsListGoalCheck.getColumn(i, "TYPE_HGHYR_ACPT_RTNG"));
        				this.dsSaveGoalCheck.setColumn(nrow, "DS_LOWHYR_PLN"       , this.gfnNvl(this.dsListGoalCheck.getColumn(i, "DS_LOWHYR_PLN"), "").replace(/\v/g,"\n"));
        				this.dsSaveGoalCheck.setColumn(nrow, "ID_USER"             , this.AuthClient.ID_USER);
        				this.dsSaveGoalCheck.setColumn(nrow, "TY_PTCP"			   , this.dsSearch.getColumn(0, "TY_PTCP"));
        				break;
        			}
        		}

        		this.dsSaveGoalCheckOpnion.clearData();
        		this.dsSaveGoalCheckOpnion.addRow();
        		this.dsSaveGoalCheckOpnion.setColumn(0, "CD_CORP"     , this.dsSearch.getColumn(0, "CD_CORP"));
        		this.dsSaveGoalCheckOpnion.setColumn(0, "ID_RTNG"     , this.dsSearch.getColumn(0, "ID_RTNG"));
        		this.dsSaveGoalCheckOpnion.setColumn(0, "SEQ_BGVDPRSN", this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "SEQ_BGVDPRSN"));
        		this.dsSaveGoalCheckOpnion.setColumn(0, "DS_STAF_OPNN", this.txtDS_STAF_OPNN.value);
        		this.dsSaveGoalCheckOpnion.setColumn(0, "ID_USER"     , this.AuthClient.ID_USER);
        	}
        	else	// 평가자
        	{
        		...
        		this.dsSaveGoalInterviewer.setColumn(nrow, "SEQ_ITVWPRSN", this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "SEQ_ITVWPRSN"));
        		this.dsSaveGoalInterviewer.setColumn(nrow, "CL_ITVWPRSN" , this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "CL_ITVWPRSN"));

        		// 평가자2명인 경우(승인자/면담자)
        		if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "YN_APPLY") == "Y") {
        			this.dsSaveGoalInterviewer.setColumn(nrow, "DS_FDBK"     , this.txtDS_FDBK_A.text);
        		} else if (this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "CL_ITVWPRSN") == "01") {
        	...
        	var strSvcId    = "save_goal_check";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "save_goal_check=dsSaveGoalCheck save_goal_check_opnn=dsSaveGoalCheckOpnion save_goal_invw=dsSaveGoalInterviewer";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.btnAdd_onclick = function(obj,e) {
        	...
        	if(this.dsListGoalCheck.rowcount == 0) {
        		var nrow = this.gfnGridAdd(this.dxGridSub, "bottom");
        		this.dsListGoalCheck.setColumn(nrow, "NO_COL", 1);
        	}
        	else if(this.dsListGoalCheck.rowposition >= 0 && this.dsListGoalCheck.rowposition == nrow-1) {
        		var NextCol = this.getNextNoCol();
        		var nrow = this.gfnGridAdd(this.dxGridSub, "bottom");
        		this.dsListGoalCheck.set_enableevent(false);
        		this.dsListGoalCheck.setColumn(nrow, "NO_COL", NextCol);
        		this.dsListGoalCheck.set_enableevent(true);
        	}
        	else {
        		var curNO_COL = this.dsListGoalCheck.getColumn(this.dsListGoalCheck.rowposition, "NO_COL");
        		var nrow = this.gfnGridAdd(this.dxGridSub, "current");

        		this.dsListGoalCheck.set_enableevent(false);
        		this.dsListGoalCheck.setColumn(nrow, "NO_COL", curNO_COL);

        		for(var i = nrow+1; i < this.dsListGoalCheck.rowcount; i++) {
        			var flag = this.gfnGetFlag(this.dsListGoalCheck, i);
        			if(flag != "I" && flag != "D") {
        				this.dsListGoalCheck.setColumn(i, this.ucFlag, "U");
        			}
        			this.dsListGoalCheck.setColumn(i, "NO_COL", ++curNO_COL);
        		}
        		this.dsListGoalCheck.set_enableevent(true);
        	}
        ...
        this.btnRemove_onclick = function(obj,e) {
        	...
        	var rowPos = this.dsListGoalCheck.rowposition;
        	var colDS_GOAL_WRK = this.dxGridSub.getBindCellIndex("body", "DS_GOAL_WRK");
        ...
        //         resizable: true
        //     }
        //     this.gfnOpenPopup("Confirm", "cmm::cmmConfirm.xfdl", "업무목표 중간점검을 제출하시겠습니까?", sPopupCallBack, options);

        	this.gfnConfirm("업무목표 중감점검을 제출하시겠습니까?", function(strId, val) {
        		if (val == false) {
        			return;
        		}
        ...
        this.fnSubmit_callback = function() {
        	...
        	var total = 0;
        	for (var i = 0; i < this.dsListGoalCheck.rowcount; i++) {
        		total += Number(this.dsListGoalCheck.getColumn(i, "NO_WGTV"));
        	}
        	...
        	if(status == "U"){
        		this.gfnAlert("직원의견/요청사항 내용이 임시저장되지 않았습니다");
        		return;
        	}

        	this.dxGridSub.updateToDataset();
        	this.dsSubmitGoalCheck.clearData();
        	this.dsSubmitGoalCheck.addRow();
        	this.dsSubmitGoalCheck.setColumn(0, "CD_CORP"     , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSubmitGoalCheck.setColumn(0, "ID_RTNG"     , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSubmitGoalCheck.setColumn(0, "SEQ_BGVDPRSN", this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "SEQ_BGVDPRSN"));
        	this.dsSubmitGoalCheck.setColumn(0, "ID_USER"     , this.AuthClient.ID_USER);

        	if (this.dsSubmitGoalCheck.rowcount == 0) return;

        	var strSvcId    = "submit_goal_check";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "submit_goal_check=dsSubmitGoalCheck";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnHistory = function(obj,e) {
        	if (this.dsListGoalCheckSummary.getColumn(0, "YN_GOAL_CPLT") == "N") {
        ...
        this.fnRequest = function(obj,e) {
        	...
        	this.gfnConfirm(this.dsListGoalCheckSummary.getColumn(0, "DS_HNAME_BGVD") + ' '
        				  + this.dsListGoalCheckSummary.getColumn(0, "DS_POSITION_BGVD")
        				  + "의 \n업무목표 중간점검 수정을 요청하시겠습니까?", function(strId, val) {
        		if (val == false) {
        			return;
        		}
        ...
        this.fnRequest_callback = function() {
        	this.dxGridSub.updateToDataset();
        	this.dsSaveGoalCheckModifyRequest.clearData();
        	this.dsSaveGoalCheckModifyRequest.addRow();
        	this.dsSaveGoalCheckModifyRequest.setColumn(0, "CD_CORP"     , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSaveGoalCheckModifyRequest.setColumn(0, "ID_RTNG"     , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSaveGoalCheckModifyRequest.setColumn(0, "SEQ_BGVDPRSN", this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "SEQ_BGVDPRSN"));
        	this.dsSaveGoalCheckModifyRequest.setColumn(0, "ID_USER"     , this.AuthClient.ID_USER);

        	if (this.dsSaveGoalCheckModifyRequest.rowcount == 0) return;

        	var strSvcId    = "request_goal_check_modify";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "request_goal_check_modify=dsSaveGoalCheckModifyRequest";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnApply = function(obj,e) {	// fnComplete
        	var chk = false;
        // 	var status = this.gfnGetFormStatus(this);
        // 	if(status == "U"){
        // 		this.gfnAlert("면담자 피드백 내용이 임시저장되지 않았습니다");
        ...
        // 	}
        	...
        	if (chk == true)
        	{
        		this.gfnConfirm("피드백 총평이 입력되지 않았습니다.\n"
        					  + this.dsListGoalCheckSummary.getColumn(0, "DS_HNAME_BGVD") + ' '
        					  + this.dsListGoalCheckSummary.getColumn(0, "DS_POSITION_BGVD")
        					  + "의 \n업무목표 중간점검 면담을 완료하시겠습니까?", function(strId, val) {
        			if (val == false) {
        				return;
        			}
        ...
        this.fnApply_callback = function() {
        	...
        	this.dxGridSub.updateToDataset();
        	this.dsSaveGoalCheckInterviewComplete.clearData();
        	this.dsSaveGoalCheckInterviewComplete.addRow();
        	this.dsSaveGoalCheckInterviewComplete.setColumn(0, "CD_CORP"     , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSaveGoalCheckInterviewComplete.setColumn(0, "ID_RTNG"     , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSaveGoalCheckInterviewComplete.setColumn(0, "SEQ_BGVDPRSN", this.dsListGoalBgvdprsn.getColumn(this.dsListGoalBgvdprsn.rowposition, "SEQ_BGVDPRSN"));
        	this.dsSaveGoalCheckInterviewComplete.setColumn(0, "SEQ_ITVWPRSN", this.dsListGoalCheckSummary.getColumn(this.SummaryRowcount, "SEQ_ITVWPRSN"));
        	this.dsSaveGoalCheckInterviewComplete.setColumn(0, "ID_USER"     , this.AuthClient.ID_USER);

        	if (this.dsSaveGoalCheckInterviewComplete.rowcount == 0) return;

        	var strSvcId    = "complete_goal_check_interview_apply";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "save_goal_invw=dsSaveGoalInterviewer complete_goal_check_interview_apply=dsSaveGoalCheckInterviewComplete";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnComplete = function(obj,e) {	// fnApply
        	var chk = false;
        	if (this.dsListGoalCheckSummary.getColumn(1, "STAT_RTNG") == "RQST") {
        		this.gfnConfirm(this.dsListGoalCheckSummary.getColumn(0, "DS_HNAME_BGVD") + ' '
        					  + this.dsListGoalCheckSummary.getColumn(0, "DS_POSITION_BGVD")
        					  + "의 \n평가자B("
        					  + this.dsListGoalCheckSummary.getColumn(1, "DS_HNAME_ITVW") + ' '
        					  + this.dsListGoalCheckSummary.getColumn(1, "DS_DUTY_ITVW")
        					  + ") 면담이 완료되지 않았습니다. \n\n업무목표 중간점검 개인면담을 최종완료하시겠습니까?", function(strId, val) {
        			if (val == false) {
        				return;
        			}
        ...
        // 	}
        	...
        	var strSvcId    = "complete_goal_check_interview";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "save_goal_invw=dsSaveGoalInterviewer complete_goal_check_interview=dsSaveGoalCheckInterviewComplete";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnFinish = function(obj,e) {
        	...
        	for (var i = 0; i < this.dsListGoalBgvdprsn.rowcount; i++) {
        		if (this.dsListGoalBgvdprsn.getColumn(i, "STATUS_RTNG") == 30 || this.dsListGoalBgvdprsn.getColumn(i, "STATUS_RTNG") == "CHCK")
        		{
        			cnt += 1;
        	...
        	else if (chk2 == true)
        	{
        		this.gfnConfirm(target2
        					  ...
        					  + "\n\n중간점검 피평가자 전체 대상자의 \n업무목표 중간점검 면담을 최종완료하시겠습니까?", function(strId, val) {
        			if (val == false) {
        				return;
        			}
        	...
        	{
        		this.gfnConfirm("중간점검 피평가자 전체 대상자의 \n업무목표 중간점검 면담을 최종완료하시겠습니까?", function(strId, val) {
        			if (val == false) {
        				return;
        			}
        ...
        this.fnFinish_callback = function() {
        	...
        	this.dsSaveGoalCheckInterviewComplete.clearData();
        	for (var i = 0; i < this.dsListGoalBgvdprsn.rowcount; i++) {
        		var nrow = this.dsSaveGoalCheckInterviewComplete.addRow();
        		this.dsSaveGoalCheckInterviewComplete.setColumn(nrow, "CD_CORP"     , this.dsSearch.getColumn(0, "CD_CORP"));
        		this.dsSaveGoalCheckInterviewComplete.setColumn(nrow, "ID_RTNG"     , this.dsSearch.getColumn(0, "ID_RTNG"));
        		this.dsSaveGoalCheckInterviewComplete.setColumn(nrow, "SEQ_BGVDPRSN", this.dsListGoalBgvdprsn.getColumn(i, "SEQ_BGVDPRSN"));
        		this.dsSaveGoalCheckInterviewComplete.setColumn(nrow, "SEQ_ITVWPRSN", 0);
        		this.dsSaveGoalCheckInterviewComplete.setColumn(nrow, "ID_USER"     , this.AuthClient.ID_USER);
        	}
        	if (this.dsSaveGoalCheckInterviewComplete.rowcount == 0) return;
        	...
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "complete_goal_check_interview=dsSaveGoalCheckInterviewComplete";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        // 직원의견/요청사항
        this.divDataBottom_txtDS_STAF_OPNN_oninput = function(obj,e)
        {
        	this.btnSave.set_enable(true);
        };
        // 평가자 피드백 총평
        ...
        this.dsListGoalCheck_onvaluechanged = function(obj,e)
        {
        	var status = this.gfnGetFormStatus(this);
        	if(status == "U")
        	{
        ...
        this.checkTarget = function() {
        	...
        	this.dsSelectRtngStd.setColumn(0, "CD_RTNG_TYPE", "JA11");
        	this.dsSelectRtngStd.setColumn(0, "ID_SCREEN", "DAJ_RTNG_GOAL_CHCK");
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form.txtDS_STAF_OPNN.addEventHandler("oninput",this.divDataBottom_txtDS_STAF_OPNN_oninput,this);
            ...
            this.dsListGoalCheck.addEventHandler("onvaluechanged",this.dsListGoalCheck_onvaluechanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DAJ_RTNG_GOAL_CHCK.xfdl");
