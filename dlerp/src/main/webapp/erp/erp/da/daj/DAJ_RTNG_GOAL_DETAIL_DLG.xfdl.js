(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("maxwidth").set("1900");
        ...
        // User Script
        this.registerScript("DAJ_RTNG_GOAL_DETAIL_DLG.xfdl", function() {
        ...
        this.fnEnableButton = function() {
        	// 작성중
        	if (this.dsSearch.getColumn(0, "STATUS_RTNG") == "40" || this.dsSearch.getColumn(0, "STATUS_RTNG") == "SFDS") { // 자기기술작성중
        ...
        this.loadIncludeScript("DAJ_RTNG_GOAL_DETAIL_DLG.xfdl");
