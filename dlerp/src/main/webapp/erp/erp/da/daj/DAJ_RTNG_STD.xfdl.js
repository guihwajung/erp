(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAJPR_RTNG_STD_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAJPR_RTNG_STD_SAVE</Col></Row><Row><Col id=\"TARGET\">copy_goal_estt_again</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_ESTT_CREATE</Col></Row><Row><Col id=\"TARGET\">copy_goal_estt</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_CHCK_CREATE</Col></Row><Row><Col id=\"TARGET\">copy_goal_check</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_SELF_DS_CREATE</Col></Row><Row><Col id=\"TARGET\">copy_goal_self_desc</Col><Col id=\"SP\">DAJPR_RTNG_PSNL_RTNG_CREATE</Col></Row><Row><Col id=\"TARGET\">magam</Col><Col id=\"SP\">DAJPR_RTNG_STD_MAGAM</Col></Row></Rows>");
