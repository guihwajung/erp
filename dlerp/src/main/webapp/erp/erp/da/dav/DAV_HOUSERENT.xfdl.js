(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAV_HOUSERENT");
            this.set_titletext("임대차계약");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAVPR_HOUSERENT_SELECT</Col></Row><Row><Col id=\"TARGET\">closeCheck</Col><Col id=\"SP\">DAVPR_CLOSE_CHECK2</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAVPR_HOUSERENT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DAVPR_HOUSERENT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAVPR_HOUSERENT_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAV_HOUSERENT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAV_HOUSERENT");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DS_NAME_RENT", "string");
        	this.dsInsert.addColumn("ID_RESIDENT_RENT", "string");
        	this.dsInsert.addColumn("TY_HOUSE", "string");
        	this.dsInsert.addColumn("NO_SIZE", "string");
        	this.dsInsert.addColumn("DS_ADDRESS_RENT", "string");
        	this.dsInsert.addColumn("DT_FROM_RENT", "string");
        	this.dsInsert.addColumn("DT_TO_RENT", "string");
        	this.dsInsert.addColumn("AM_RENT", "string");
        	...
        	this.dsUpdate.addColumn("DS_NAME_RENT", "string");
        	this.dsUpdate.addColumn("ID_RESIDENT_RENT", "string");
        	this.dsUpdate.addColumn("TY_HOUSE", "string");
        	this.dsUpdate.addColumn("NO_SIZE", "string");
        	this.dsUpdate.addColumn("DS_ADDRESS_RENT", "string");
        	this.dsUpdate.addColumn("DT_FROM_RENT", "string");
        	this.dsUpdate.addColumn("DT_TO_RENT", "string");
        	this.dsUpdate.addColumn("AM_RENT", "string");
        	...
        	this.dsDelete.addColumn("DS_NAME_RENT", "string");
        	this.dsDelete.addColumn("ID_RESIDENT_RENT", "string");
        	this.dsDelete.addColumn("DS_ADDRESS_RENT", "string");
        	this.dsDelete.addColumn("DT_FROM_RENT", "string");
        	this.dsDelete.addColumn("DT_TO_RENT", "string");
        	this.dsDelete.addColumn("AM_RENT", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DS_NAME_RENT", this.dsList.getColumn(i, "DS_NAME_RENT"));
        				this.dsInsert.setColumn(nrow, "ID_RESIDENT_RENT", this.dsList.getColumn(i, "ID_RESIDENT_RENT").replace(/-/g,""));
        				...
        				this.dsInsert.setColumn(nrow, "DS_ADDRESS_RENT", this.dsList.getColumn(i, "DS_ADDRESS_RENT"));
        				this.dsInsert.setColumn(nrow, "DT_FROM_RENT", this.dsList.getColumn(i, "DT_FROM_RENT"));
        				this.dsInsert.setColumn(nrow, "DT_TO_RENT", this.dsList.getColumn(i, "DT_TO_RENT"));
        				this.dsInsert.setColumn(nrow, "AM_RENT", this.dsList.getColumn(i, "AM_RENT"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "DS_NAME_RENT", this.dsList.getColumn(i, "DS_NAME_RENT"));
        				this.dsUpdate.setColumn(nrow, "ID_RESIDENT_RENT", this.dsList.getColumn(i, "ID_RESIDENT_RENT").replace(/-/g,""));
        				...
        				this.dsUpdate.setColumn(nrow, "DS_ADDRESS_RENT", this.dsList.getColumn(i, "DS_ADDRESS_RENT"));
        				this.dsUpdate.setColumn(nrow, "DT_FROM_RENT", this.dsList.getColumn(i, "DT_FROM_RENT"));
        				this.dsUpdate.setColumn(nrow, "DT_TO_RENT", this.dsList.getColumn(i, "DT_TO_RENT"));
        				this.dsUpdate.setColumn(nrow, "AM_RENT", this.dsList.getColumn(i, "AM_RENT"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "DS_NAME_RENT", this.dsList.getColumn(i, "DS_NAME_RENT"));
        				this.dsDelete.setColumn(nrow, "ID_RESIDENT_RENT", this.dsList.getColumn(i, "ID_RESIDENT_RENT").replace(/-/g,""));
        				this.dsDelete.setColumn(nrow, "DS_ADDRESS_RENT", this.dsList.getColumn(i, "DS_ADDRESS_RENT"));
        				this.dsDelete.setColumn(nrow, "DT_FROM_RENT", this.dsList.getColumn(i, "DT_FROM_RENT"));
        				this.dsDelete.setColumn(nrow, "DT_TO_RENT", this.dsList.getColumn(i, "DT_TO_RENT"));
        				this.dsDelete.setColumn(nrow, "AM_RENT", this.dsList.getColumn(i, "AM_RENT"));
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("DAV_HOUSERENT.xfdl");
