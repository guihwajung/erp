(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAV_STOCKSUBST");
            this.set_titletext("장기주식형저축 공제");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAVPR_LONGSTOCKSUBST_SELECT</Col></Row><Row><Col id=\"TARGET\">closeCheck</Col><Col id=\"SP\">DAVPR_CLOSE_CHECK2</Col></Row><Row><Col id=\"SP\">DAVPR_CLOSE_CHECK</Col><Col id=\"TARGET\">closeCheck</Col></Row><Row><Col id=\"SP\">DAVPR_LONGSTOCKSUBST_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"SP\">DAVPR_LONGSTOCKSUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAVPR_LONGSTOCKSUBST_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAV_STOCKSUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAV_STOCKSUBST");
        ...
        this.fnAdd = function() {
        	...
        	this.dsList.setColumn(nrow, "CD_SUBST", "C44");	//장기주식형저축공제 코드
        ...
        this.loadIncludeScript("DAV_STOCKSUBST.xfdl");
