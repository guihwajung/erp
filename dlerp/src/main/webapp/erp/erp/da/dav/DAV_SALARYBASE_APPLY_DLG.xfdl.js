(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("급여이관-급여적용");
            this.getSetter("maxwidth").set("460");
            this.getSetter("maxheight").set("450");
            if (Form == this.constructor)
            {
                this._setFormPosition(426,360);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsList", this);
            obj._setContents("<ColumnInfo><Column id=\"YN_MID\" type=\"STRING\" size=\"256\"/><Column id=\"WORK_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"ID_RESIDENT\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"YM_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"YN_CLOSE\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAVPR_SALARYBASE_SALARY</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">Y</Col><Col id=\"VALUE\">마감</Col></Row><Row><Col id=\"CODE\">N</Col><Col id=\"VALUE\">마감취소</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("sta03_00","96","249","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            ...
            obj = new Div("divBtns","72","301","200","40",null,null,null,null,null,null,this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta02","96","75","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Static("sta00","96","104","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Static("staCD_ORDER","0","220","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("대상구분");
            obj.set_visible("true");
            ...
            obj = new Static("sta03","96","220","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Radio("rdoTY_GUBUN","102","221","189","24",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            ...
            obj = new Static("staTY_MAGAM","0","46","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("구분");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("sta04","96","46","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Combo("cboYN_MID","102","51","80","20",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_datacolumn("datacolumn");
            obj.set_codecolumn("codecolumn");
            ...
            obj = new Static("staWORK_BASE","0","75","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("적용년도");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Div("ctclWORK_BASE","102","80","100","20",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_async("false");
            ...
            obj = new Static("staCD_CORP","0","104","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Div("ccfCD_CORP","102","109","250","20",null,null,null,null,null,null,this);
            ...
            obj = new Static("staID_RESIDENT","0","249","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("주민번호");
            obj.set_cssclass("sta_WF_tablelabel");
            this.addChild(obj.name, obj);

            obj = new Div("ccfID_RESIDENT","102","254","240","20",null,null,null,null,null,null,this);
            ...
            obj = new Edit("edtID_SABUN","ccfID_RESIDENT:1","254","79","20",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_visible("false");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Static("staTY_MAGAM00","0","133","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("마감여부");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("sta04_00","96","133","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Radio("rdoYN_CLOSE","102","136","148","24",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            ...
            obj = new Static("staYM_PAYMENT00","0","162","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("급여적용년월");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("sta00_00","96","162","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Div("ctclYM_SALARY","102","167","80","20",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.addChild(obj.name, obj);

            obj = new Static("staTY_SALARY","0","191","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("급여구분");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("sta03_01","96","191","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Combo("cboSN_SALARY","165","196","40","20",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            ...
            obj = new Combo("cboTY_SALARY","102","196","60","20",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            ...
            obj = new BindItem("item7","rdoYN_CLOSE","value","dsList","YN_CLOSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","ctclYM_SALARY.form.TextBox","value","dsList","YM_SALARY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","cboSN_SALARY","value","dsList","SN_SALARY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","cboTY_SALARY","value","dsList","TY_SALARY");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAV_SALARYBASE_APPLY_DLG.xfdl", function() {
        ...
        this.loadIncludeScript("DAV_SALARYBASE_APPLY_DLG.xfdl");
