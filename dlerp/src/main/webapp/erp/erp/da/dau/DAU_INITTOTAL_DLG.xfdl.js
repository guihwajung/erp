(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAU_CALCTAX_DLG");
            this.set_titletext("세액계산");
            this.getSetter("maxwidth").set("450");
            this.getSetter("maxheight").set("315");
            if (Form == this.constructor)
            {
                this._setFormPosition(406,237);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsList", this);
            obj._setContents("<ColumnInfo><Column id=\"YM_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SUBST\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DAUPR_INITTOTAL</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DAZPR_COMMONCODE_COMBO</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsTY_SUBST", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTITLE","2","-5","364","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            ...
            obj = new Static("staYM_SALARY_bg","staYM_SALARY:-1","staYM_SALARY:-30","320","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            ...
            obj = new Static("staTY_SALARY_bg","staTY_SALARY:-1","staTY_SALARY:-30","320","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Combo("cboTY_SUBST","cboSN_SALARY:5","staTY_SALARY:-25","180","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_innerdataset("dsTY_SUBST");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            obj.set_readonly("false");
            obj.set_value("1");
            ...
            obj = new Static("staCD_CORP_bg","staCD_CORP:-1","staCD_CORP:-30","320","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);

            obj = new Div("ccfCD_CORP","staCD_CORP:5","staCD_CORP:-25","309","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staTY_WORK_bg","staTY_WORK:-1","staTY_WORK:-30","320","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);

            obj = new Radio("rdoTY_WORK","staTY_WORK:5","staTY_WORK:-25","239","24",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            ...
            obj = new Static("staID_SABUN_bg","staID_SABUN:-1","staID_SABUN:-30","320","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);

            obj = new Div("ccfID_SABUN","staID_SABUN:5","staID_SABUN:-25","309","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Static("staCD_DEPT_bg","staCD_DEPT:-1","staCD_DEPT:-30","320","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);

            obj = new Div("ccfCD_DEPT","staCD_DEPT:5","staCD_DEPT:-25","309","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Div("divBtns","140","staCD_DEPT:10","130","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("18");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item3","divData.form.cboTY_SUBST","value","dsList","TY_SUBST");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item6","divData.form.rdoTY_WORK","value","dsList","TY_WORK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divData.form.ccfID_SABUN.form.CDTextBox","value","dsList","ID_SABUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divData.form.ccfID_SABUN.form.DSTextBox","value","dsList","DS_HNAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divData.form.ccfCD_DEPT.form.CDTextBox","value","dsList","CD_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divData.form.ccfCD_DEPT.form.DSTextBox","value","dsList","DS_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAU_INITTOTAL_DLG.xfdl", function() {
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsExecute.addColumn("TY_SUBST", "string");
        ...
        this.fnSetCombo = function() {
           ...
           this.dsCombo.setColumn(1, "CD_PREFIX"  , "GO");
           this.dsCombo.setColumn(1, "CD_UPPREFIX", "");
        	...
        	var outData     = "dsTY_SALARY=combo0 dsTY_SUBST=combo1";
        	var strArg      = "";
        ...
        this.fnInit = function() {
        	...
        	this.dsList.setColumn(0, "TY_SUBST", "A");
        ...
        this.btnOK_onclick = function(obj, e) {
        	...
        	this.dsExecute.setColumn(nrow, "TY_SUBST" , this.dsList.getColumn(0, "TY_SUBST"));
        	...
        	this.dsExecute.setColumn(nrow, "CD_DEPT"  , this.dsList.getColumn(0, "CD_ORG2"));
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	if (svcID == "select") {
        		...
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("급여 일괄 계산이 완료되었습니다.", "fnClose");
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	} else if (svcID == "combo") {
        		this.cboTY_SUBST.set_index(0);
        	}
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.cboTY_SUBST.addEventHandler("onitemchanged",this.fnSearchInit,this);
        ...
        this.loadIncludeScript("DAU_INITTOTAL_DLG.xfdl");
