(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAU_INITINCOME_DLG");
            this.set_titletext("소득생성");
            this.getSetter("maxwidth").set("390");
            this.getSetter("maxheight").set("315");
            if (Form == this.constructor)
            {
                this._setFormPosition(348,236);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DAUPR_MONTHLYINC_CREATE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DAZPR_COMMONCODE_COMBO</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTITLE","0","-6","344","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_text("급여 소득정보 생성");
        ...
        // User Script
        this.registerScript("DAU_INITINCOME_DLG.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	this.ctclYM_SALARY = this.divData.form.ctclYM_SALARY;	// 지급년원
        ...
        this.loadIncludeScript("DAU_INITINCOME_DLG.xfdl");
