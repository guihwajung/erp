(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("maxheight").set("318");
            if (Form == this.constructor)
            {
                this._setFormPosition(348,243);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"YM_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"OP_PRINT\" type=\"STRING\" size=\"256\"/><Column id=\"OD_PRINT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YM_BASE\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_SALARY", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">S</Col><Col id=\"VALUE\">급여</Col></Row><Row><Col id=\"VALUE\">성과급</Col><Col id=\"CODE\">X</Col></Row><Row><Col id=\"VALUE\">퇴직급여</Col><Col id=\"CODE\">R</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            divData_form_cboOP_PRINT_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"datacolumn\">전체</Col><Col id=\"codecolumn\">%</Col></Row><Row><Col id=\"datacolumn\">특정부서</Col><Col id=\"codecolumn\">2</Col></Row><Row><Col id=\"datacolumn\">특정사번</Col><Col id=\"codecolumn\">1</Col></Row></Rows>");
            ...
            obj = new BindItem("item9","divData.form.ccfID_SABUN.form.CDTextBox","value","dsData","ID_SABUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divData.form.ccfID_SABUN.form.DSTextBox","value","dsData","DS_HNAME");
            this.addChild(obj.name, obj);
            obj.bind();
