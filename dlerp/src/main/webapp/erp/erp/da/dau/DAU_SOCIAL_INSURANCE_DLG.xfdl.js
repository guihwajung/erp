(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"YM_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ORG2\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_MAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_N\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_H\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DAUPR_SOCIAL_INSURANCE_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCHK_SOCIAL","0","161","87","30",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("사회보험");
            ...
            obj = new CheckBox("CHK_N","92","166","100","20",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_truevalue("Y");
            ...
            obj = new CheckBox("CHK_H","170","166","100","20",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            obj.set_value("Y");
            ...
            obj = new BindItem("item4","rdoTY_WORK","value","dsList","TY_GUBUN");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item7","ccfCD_DEPT.form.CDTextBox","value","dsList","CD_ORG2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","rdoTY_MAGAM","value","dsList","TY_MAGAM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","CHK_N","value","dsList","CHK_N");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","CHK_H","value","dsList","CHK_H");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAU_SOCIAL_INSURANCE_DLG.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//사회보험
        	this.CHK_N.set_value("Y");
        	this.CHK_H.set_value("Y");
        	//작업대상
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsExecute.addColumn("CHK_N", "string");
        	this.dsExecute.addColumn("CHK_H", "string");
        ...
        this.btnOK_onclick = function(obj,e)
        {
        	...
        	this.dsExecute.setColumn(nrow, "TY_GUBUN", this.dsList.getColumn(0, "TY_MAGAM"));
        	...
        	this.dsExecute.setColumn(nrow, "CHK_N", this.dsList.getColumn(0, "CHK_N"));
        	this.dsExecute.setColumn(nrow, "CHK_H", this.dsList.getColumn(0, "CHK_H"));
        	this.dsExecute.setColumn(nrow, "ID_SABUN", this.gfnIsNull(this.dsList.getColumn(0, "ID_SABUN")) ? "%" : this.dsList.getColumn(0, "ID_SABUN"));
        	this.dsExecute.setColumn(nrow, "CD_DEPT", this.gfnIsNull(this.dsList.getColumn(0, "CD_ORG2")) ? "%" : this.dsList.getColumn(0, "CD_ORG2"));
        	//this.dsExecute.setColumn(nrow, "INID_INSERT", this.AuthClient.ID_USER);
        ...
        this.loadIncludeScript("DAU_SOCIAL_INSURANCE_DLG.xfdl");
