(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("반제전표발행");
            this.getSetter("maxwidth").set("413");
            this.getSetter("maxheight").set("288");
            if (Form == this.constructor)
            {
                this._setFormPosition(373,213);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DAZPR_COMMONCODE_COMBO</Col></Row><Row><Col id=\"SP\">DAUPR_BRANCH_AUTOSLIP_CREATE</Col><Col id=\"TARGET\">save</Col></Row></Rows>");
            ...
            obj = new Static("staYM_SALARY","0","staTITLE:5","112","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_text("귀속년월");
            obj.set_textAlign("left");
            ...
            obj = new Static("staCD_CORP","0","staYM_SALARY:-1","112","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("법인");
            obj.set_textAlign("left");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staTY_SALARY","0","staCD_CORP:-1","112","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("지급구분 ");
            obj.set_textAlign("left");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Combo("cboTY_SALARY","staTY_SALARY:5","staTY_SALARY:-25","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("16");
            ...
            obj = new Combo("cboSN_SALARY","cboTY_SALARY:5","staTY_SALARY:-25","40","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_readonly("false");
            ...
            obj = new Static("staCD_DEPT_ACNT","0","staTY_SALARY:-1","112","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("발행부서");
            obj.set_textAlign("left");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staCD_DEPT_ACNT_bg","staCD_DEPT_ACNT:-1","staCD_DEPT_ACNT:-30","262","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Div("cfCD_DEPT_ACNT","staCD_DEPT_ACNT:5","staCD_DEPT_ACNT:-25","250","20",null,null,null,null,null,null,this.divData.form);
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("18");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            ...
            obj = new Static("staDT_ACCOUNT","0","staCD_DEPT_ACNT:-1","112","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("회계일자");
            obj.set_textAlign("left");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staDT_ACCOUNT_bg","staDT_ACCOUNT:-1","staDT_ACCOUNT:-30","262","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Calendar("tclDT_ACCOUNT","staDT_ACCOUNT:5","staDT_ACCOUNT:-25","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            ...
            obj = new Div("divBtns","130","staDT_ACCOUNT:10","130","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            this.divData.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAU_AUTOSLIPMAIN_ISSUE_REVERSE.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.staYM_SALARY.addEventHandler("onclick",this.divData_staDS_SITE_onclick,this);
            this.divData.form.staCD_CORP.addEventHandler("onclick",this.divData_staDS_SITE_onclick,this);
        ...
        this.loadIncludeScript("DAU_AUTOSLIPMAIN_ISSUE_REVERSE.xfdl");
