(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAUPR_FIXEDALLOW_SELECT</Col></Row><Row><Col id=\"SP\">DAUPR_FIXEDALLOW_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"SP\">DAUPR_FIXEDALLOW_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DAUPR_FIXEDALLOW_DELETE</Col><Col id=\"TARGET\">delete</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DAZPR_COMMONCODE_COMBO</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ALLOW\" type=\"STRING\" size=\"256\"/><Column id=\"YM_SALARY_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ALLOW\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"YM_SALARY_TO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_ALLOW","ccfID_SABUN:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("소득항목");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_ALLOW","staCD_ALLOW:0.0","10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("8");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staYM_SALARY","ccfCD_ALLOW:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("기준년월");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYM_SALARY_FR","staYM_SALARY:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_url("cmm::cmmCalMM.xfdl");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staYM_SALARY_TO","ctclYM_SALARY_FR:0.0","10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("~");
            obj.set_cssclass("sta_WF_AC");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYM_SALARY_TO","staYM_SALARY_TO:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item3","divSearch.form.ccfCD_ALLOW.form.CDTextBox","value","dsSearch","CD_ALLOW");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSearch.form.ctclYM_SALARY_FR.form.TextBox","value","dsSearch","YM_SALARY_FR");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item6","divSearch.form.ccfID_SABUN.form.DSTextBox","value","dsSearch","DS_SABUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divSearch.form.ccfCD_ALLOW.form.DSTextBox","value","dsSearch","DS_ALLOW");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divSearch.form.ctclYM_SALARY_TO.form.TextBox","value","dsSearch","YM_SALARY_TO");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAU_FIXEDALLOW.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.ccfCD_ALLOW = this.divSearch.form.ccfCD_ALLOW;
        	this.ctclYM_SALARY_FR = this.divSearch.form.ctclYM_SALARY_FR;
        	this.ctclYM_SALARY_TO = this.divSearch.form.ctclYM_SALARY_TO;
        ...
        this.fnSetEvent = function() {
        	this.ccfCD_ALLOW.CodeFindName = "DAX_CFALLOW_CODE";
        	this.ccfCD_ALLOW.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";

        	this.ccfCD_CORP.CodeFindName = "DAX_CFCORP";
        	this.ccfCD_CORP.AfterCDTextChanged = "codefind_AfterCDTextChanged";

        	this.ccfID_SABUN.CodeFindName = "DAX_CFBASEINFO"; //DAX_CFBASEINFO_ALL
        	this.ccfID_SABUN.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";

        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAU_FIXEDALLOW");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("YM_SALARY_FR", "string");
        	this.dsSelect.addColumn("YM_SALARY_TO", "string");

        	this.dsInsert = new Dataset();
        	this.dsInsert.addColumn("TY_SALARY", "string");
        	this.dsInsert.addColumn("ID_SABUN", "string");
        	this.dsInsert.addColumn("CD_ALLOW", "string");
        	this.dsInsert.addColumn("AM_ALLOW", "int");
        	...
        	this.dsUpdate.addColumn("CD_ALLOW", "string");
        	this.dsUpdate.addColumn("AM_ALLOW", "int");
        	...
        	this.dsDelete.addColumn("CD_ALLOW", "string");
        ...
        this.fnInit = function() {
        	//this.ccboTY_SALARY.set_value("S");
        	...
        	if(!this.gfnIsNull(frame.ID_SABUN) && !this.gfnIsNull(frame.DS_HNAME)){
        		...
        		this.ctclYM_SALARY_FR.form.TextBox.set_value(frame.YM_SALARY);
        		this.ctclYM_SALARY_TO.form.TextBox.set_value(frame.YM_SALARY);
        	}

        	//if(!this.gfnIsNull(frame.ID_SABUN) && !this.gfnIsNull(frame.DS_HNAME) && !this.gfnIsNull(frame.CD_CORP) && !this.gfnIsNull(frame.DS_CORP)) {
        	if(!this.gfnIsNull(frame.CD_CORP) && !this.gfnIsNull(frame.DS_CORP)) {
        		var todayfr = this.gfnAddMonth(this.gfnGetDate().substring(0,8),-12);
        		var todayto = this.gfnAddMonth(this.gfnGetDate().substring(0,8),12);
        		this.ccfCD_CORP.form.CDTextBox.set_value(frame.CD_CORP);
        		this.ccfCD_CORP.form.DSTextBox.set_value(frame.DS_CORP);
        		this.ctclYM_SALARY_FR.form.TextBox.set_value("202208");
        		this.ctclYM_SALARY_TO.form.TextBox.set_value(todayto.substring(0,6));
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_ALLOW", this.dsSearch.getColumn(0, "CD_ALLOW"));
        	this.dsSelect.setColumn(0, "YM_SALARY_FR", this.dsSearch.getColumn(0, "YM_SALARY_FR"));
        	this.dsSelect.setColumn(0, "YM_SALARY_TO", this.dsSearch.getColumn(0, "YM_SALARY_TO"));
        ...
        this.fnAdd = function() {
        	...
        	this.dsList.setColumn(nrow, "ID_SABUN", this.ccfID_SABUN.form.CDTextBox.value); //사번
        	this.dsList.setColumn(nrow, "DS_HNAME", this.ccfID_SABUN.form.DSTextBox.value);     //성명
        }
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "CD_ALLOW", this.dsList.getColumn(i, "CD_ALLOW"));
        				this.dsInsert.setColumn(nrow, "AM_ALLOW", this.dsList.getColumn(i, "AM_ALLOW"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_ALLOW", this.dsList.getColumn(i, "CD_ALLOW"));
        				this.dsUpdate.setColumn(nrow, "AM_ALLOW", this.dsList.getColumn(i, "AM_ALLOW"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "CD_ALLOW", this.dsList.getColumn(i, "CD_ALLOW"));
        ...
        // 	}
        	...
        	if(this.gfnIsNull(this.ctclYM_SALARY_FR.form.TextBox.value)){
        		this.gfnAlert("기준 시작월을 입력하세요.");
        		this.ctclYM_SALARY_FR.form.TextBox.setFocus();
        		return false;
        	}

        	if(this.gfnIsNull(this.ctclYM_SALARY_TO.form.TextBox.value)){
        		this.gfnAlert("기준 종료월을 입력하세요.");
        		this.ctclYM_SALARY_TO.form.TextBox.setFocus();
        		return false;
        	}

        	if(!this.gfnIsNull(this.ctclYM_SALARY_FR.form.TextBox.value) && !this.gfnIsNull(this.ctclYM_SALARY_TO.form.TextBox.value)){
        		if(this.ctclYM_SALARY_FR.form.TextBox.value > this.ctclYM_SALARY_TO.form.TextBox.value){
        			validate = false;
        			this.gfnAlert("기준 시작월이 종료월보다 클 수 없습니다.");
        			this.ctclYM_SALARY_FR.form.TextBox.setFocus();
        			return false;
        		}
        	}
        			...
        			case "U":
        				if(!this.gfnIsNull(this.dsList.getColumn(i, "FR_MON")) && !this.gfnIsNull(this.dsList.getColumn(i, "TO_MON"))) {
        					if(this.dsList.getColumn(i, "FR_MON").replace(/-/g, '') > this.dsList.getColumn(i, "TO_MON").replace(/-/g, '')) {
        						this.gfnAlert("지급FROM 값은 지급 TO 값 보다 클 수 없습니다.");
        						validate = false;
        					}
        				}
        				break;
        ...
        */
        ...
        if(arr.length > 0) {
        	trace("fnGrid_AfterCDTextChanged->" + arr[0]["DS_HNAME"] + " / " + arr[0]["DS_CORP"]);
        }
        	switch(id) {
        		case "DAX_CFBASEINFO":
        ...
        this.fnExcelImportCallback = function(sImportId, dsOut, dsSheet) {
        	...
        	for (var i=0; i<dsOut.rowcount; i++) {
        		...
        		this.dsList.setColumn(nrow, "CD_ALLOW", dsOut.getColumn(i, "Column2"));
        		this.dsList.setColumn(nrow, "DS_ALLOW", dsOut.getColumn(i, "Column3"));
        		this.dsList.setColumn(nrow, "FR_MON", dsOut.getColumn(i, "Column4"));
        		this.dsList.setColumn(nrow, "TO_MON", dsOut.getColumn(i, "Column5"));
        		this.dsList.setColumn(nrow, "AM_ALLOW", dsOut.getColumn(i, "Column6"));
        ...
        */
        ...
        this.loadIncludeScript("DAU_FIXEDALLOW.xfdl");
