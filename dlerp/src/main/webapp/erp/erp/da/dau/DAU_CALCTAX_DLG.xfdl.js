(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DAUPR_CALCTAX</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DAZPR_COMMONCODE_COMBO</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAU_CALCTAX_DLG.xfdl", function() {
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	if (svcID == "select") {
        		...
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("세액계산이 완료되었습니다.", "fnClose");
        		} else {
        ...
        this.loadIncludeScript("DAU_CALCTAX_DLG.xfdl");
