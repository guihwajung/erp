(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAAPR_STATUS_DEPTRET</Col></Row><Row><Col id=\"SP\">DAAPR_STATUS_DEPTRET_SUB</Col><Col id=\"TARGET\">selectSub</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSplitter","0","50.00%","100.00%","5",null,"0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("DAA_STATUS_DEPTRET.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAA_STATUS_DEPTRET");
        	this.dxGrid.set_selecttype("cell");	// IE경우만 multiarea모드에서 master선택후 마우스 이동 빠르게 할 경우 버그가 있어서 cell 모드로 변경
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DA", "DAA_STATUS_DEPTRET2");
        	this.dxGrid.set_selecttype("cell");	// IE경우만 multiarea모드에서 master선택후 마우스 이동 빠르게 할 경우 버그가 있어서 cell 모드로 변경
        ...
        /*
          *	조회 버튼
          */
        this.fnSelectSub = function(strTY_GUBUN,strMM,strCD_DEPT) {
        	if (!this.fnSelectValidate()) return false;
        	...
        	this.dsSelectSub.setColumn(0, "CD_DEPT", strCD_DEPT);
        ...
        this.dxGrid_oncellposchanged = function(obj,e)
        {
        	if(e.oldcol != e.col || e.oldrow != e.row){
        		...
        		if( this.gfnGridGetBindColumnNameByIndex( this.dxGrid, e.col ).indexOf("SUM") > -1 ){
        			...
        			strCD_DEPT = this.dsList.getColumn(this.dsList.rowposition,"CD_DEPT");

        			this.fnSelectSub(strTY_GUBUN,strMM,strCD_DEPT);
        		} else {
        			this.gfnGridClear(this.dxGridSub);
        		}
        	}
        ...
        this.loadIncludeScript("DAA_STATUS_DEPTRET.xfdl");
