(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAA_EDI_SINGO_DLG");
            this.set_titletext("EDI 대상자 생성");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAAPR_EDI_SINGO_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("sta05","86","124","244","30",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            ...
            obj = new Static("sta03","0","95","87","30",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("기준일자");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Static("sta04","86","37","244","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("staYN_DELETE","0","37","87","30",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("기존자료");
            obj.set_cssclass("sta_WF_tablelabel");
            this.addChild(obj.name, obj);

            obj = new Radio("rdoYN_DELETE","91","42","232","20",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            obj.set_fittocontents("none");
            var rdoYN_DELETE_innerdataset = new nexacro.NormalDataset("rdoYN_DELETE_innerdataset", obj);
            rdoYN_DELETE_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">삭제</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">보존</Col></Row></Rows>");
            obj.set_innerdataset(rdoYN_DELETE_innerdataset);
            obj.set_text("삭제");
            obj.set_value("1");
            obj.set_index("0");
            this.addChild(obj.name, obj);

            obj = new Static("sta00","0","66","87","30",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Static("sta01","86","66","244","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("sta02","86","95","244","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Div("divBtns","67","170","200","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclDT_FROM","93","100","105","20",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            ...
            obj = new Div("ccfCD_CORP","93","71","230","20",null,null,null,null,null,null,this);
            ...
            obj = new Static("staTY_SINGO","0","124","87","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("신고구분");
            obj.set_cssclass("sta_WF_tablelabel");
            this.addChild(obj.name, obj);

            obj = new Static("staDT00","ctclDT_FROM:5","100","10","20",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("~");
            this.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_TO","staDT00:5","100","105","20",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Radio("rdoTY_SINGO","91","129","232","20",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
        ...
        // User Script
        this.registerScript("DAA_EDI_SINGO_DLG.xfdl", function() {
        ...
        this.loadIncludeScript("DAA_EDI_SINGO_DLG.xfdl");
