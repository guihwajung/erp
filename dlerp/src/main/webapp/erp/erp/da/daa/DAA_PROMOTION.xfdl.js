(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAAPR_PROMOTION_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAAPR_PROMOTION_SAVE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DAAPR_PROMOTION_TARGET</Col></Row><Row><Col id=\"TARGET\">cancel</Col><Col id=\"SP\">DAAPR_PROMOTION_ORDER_CANCEL</Col></Row><Row><Col id=\"SP\">DAAPR_PROMOTION_ORDER_CANCEL</Col><Col id=\"TARGET\">cancl</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsYN_PROMOTION", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">%</Col><Col id=\"VALUE\">전체</Col></Row><Row><Col id=\"CODE\">Y</Col><Col id=\"VALUE\">대상</Col></Row><Row><Col id=\"CODE\">N</Col><Col id=\"VALUE\">미대상</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"DT_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"YN_PROMOTION\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYN_PROMOTION","ccfCD_CORP:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("대상여부");
            obj.set_rtl("false");
            ...
            obj = new Combo("cboYN_PROMOTION","staYN_PROMOTION:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_innerdataset("dsYN_PROMOTION");
            ...
            obj = new Static("staTY_GUBUN","cboYN_PROMOTION:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("구분");
            obj.set_rtl("false");
            obj.set_cssclass("sta_WF_SchLabelE");
            ...
            obj = new BindItem("item1","divSearch.form.cboYN_PROMOTION","value","dsSearch","YN_PROMOTION");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAA_PROMOTION.xfdl", function() {
        ...
        // 대상 버튼 클릭
        this.fnFormButton10 = function(obj,e) {
        	this.fnUpdate_d('Y');
        }

        // 미대상 버튼 클릭
        this.fnFormButton11 = function(obj,e) {
        	this.fnUpdate_d('N');
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.staYN_PROMOTION.addEventHandler("onclick",this.divSearch_staYN_PROMOTION_onclick,this);
            this.divSearch.form.cboYN_PROMOTION.addEventHandler("onitemchanged",this.fnSearchInit,this);
            this.divSearch.form.cboTY_GUBUN.addEventHandler("onitemchanged",this.fnSearchInit,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
            this.dsList.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
        };
        this.loadIncludeScript("DAA_PROMOTION.xfdl");
