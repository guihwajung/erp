(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DACPR_MGTVACATION_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DACPR_YEARLYVACATION_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"YR_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"ID_PERSON\" type=\"STRING\" size=\"256\"/><Column id=\"TY_RETIRE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ORG2\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ORG2\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YR_BASE\"/><Col id=\"ID_SABUN\"/><Col id=\"ID_PERSON\"/><Col id=\"TY_RETIRE\"/><Col id=\"CD_CORP\"/><Col id=\"CD_ORG2\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYR_BASE","0.0","10.0","79.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("년도");
            obj.set_taborder("0");
            ...
            obj = new Static("staCD_CORP","ctclYR_BASE:0.0","10.0","79.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("법인");
            ...
            obj = new Static("staTY_RETIRE","0.0","staYR_BASE:10.0","79.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccfTY_RETIRE","staTY_RETIRE:0.0","ctclYR_BASE:10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            ...
            obj = new Static("staCD_ORG2","ccfTY_RETIRE:0.0","staYR_BASE:10.0","79.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("부서");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staSABUN","ccfCD_CORP:0.0","10.0","79.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("사번");
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_ORG2","staCD_ORG2:0.0","staYR_BASE:10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("10");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            ...
            obj = new BindItem("item3","divSearch.form.ccfTY_RETIRE","value","dsSearch","TY_RETIRE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item2","divSearch.form.ccfCD_ORG2.form.CDTextBox","value","dsSearch","CD_ORG2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch.form.ccfCD_ORG2.form.DSTextBox","value","dsSearch","DS_ORG2");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAC_MGTVACATION.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.staCD_ORG2.addEventHandler("onclick",this.Common_onclick,this);
        ...
        this.loadIncludeScript("DAC_MGTVACATION.xfdl");
