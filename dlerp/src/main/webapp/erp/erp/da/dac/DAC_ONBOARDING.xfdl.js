(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("On-Boarding 휴가 관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DACPR_ONBOARDING_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DACPR_ONBOARDING_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP","ctclYR_BASE:10","10.0","66","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAC_ONBOARDING.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드영역
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAC_ONBOARDING");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("QN_ONBOARDING", "bigdecimal");
        ...
        this.fnAdd = function() {
        	...
        	this.dsList.setColumn(nrow, "QN_ONBOARDING", 3);
        }
        ...
        this.fnSave = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		case "D":
        			...
        			this.dsSave.setColumn(nrow, "QN_ONBOARDING", this.dsList.getColumn(i, "QN_ONBOARDING"));
        ...
        this.fnGrid_AfterCDTextChanged = function(id, codeFindData) {
        	...
        	switch(id) {
        		...
        		case "DAX_CFBASEINFO_ALL":
        			...
        			var vToday = this.dsList.getColumn(this.dsList.rowposition, "DT_FROM").replace("-","");

        			this.dsList.setColumn(this.dsList.rowposition, "DT_TO", this.gfnAddDate(this.gfnAddMonth(vToday,12),-1));
        			break;
        		default:
        	}
        ...
        this.fnGrid_AfterEdit = function(obj,e) {
        	if(e.columnid == "DT_FROM" ) { // 사용시작일 변경 시 1년 세팅
        		var vToday = this.dsList.getColumn(e.row, "DT_FROM");
        		this.dsList.setColumn(e.row, "DT_TO", this.gfnAddDate(this.gfnAddMonth(vToday,12),-1));
        	}
        }
        ...
        this.loadIncludeScript("DAC_ONBOARDING.xfdl");
