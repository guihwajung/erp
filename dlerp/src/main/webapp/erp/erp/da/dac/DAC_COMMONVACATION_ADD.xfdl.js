(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("공동연차 복직자 현황");
            ...
            obj._setContents("<ColumnInfo><Column id=\"YY_COMMON\" type=\"STRING\" size=\"256\"/><Column id=\"DT_COMMON\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CORP\"/><Col id=\"DS_CORP\"/><Col id=\"DT_COMMON\"/><Col id=\"YY_COMMON\"/></Row></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DACPR_COMMONVACATION_ADD_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DACPR_COMMONVACATION_ADD_INSERT</Col></Row><Row><Col id=\"SP\">DACPR_COMMON_DATE_SELECT</Col><Col id=\"TARGET\">combo</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsDT_COMMON", this);
            ...
            obj = new Static("staYY_COMMON","0","10","136","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("공동연차 발생일");
            obj.set_taborder("1");
            ...
            obj = new Combo("ccboDT_COMMON","ctclYY_COMMON:5","10","100","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_innerdataset("dsDT_COMMON");
            ...
            obj = new Static("staCD_CORP","ccboDT_COMMON:0","10","66","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item3","divSearch.form.ctclYY_COMMON.form.TextBox","value","dsSearch","YY_COMMON");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item0","divSearch.form.ccboDT_COMMON","value","dsSearch","DT_COMMON");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAC_COMMONVACATION_ADD.xfdl", function() {
         ...
         ************************************************************************/
        // 공동연차 등록
        this.fnAddComonVacation = function(obj,e) {
        ...
        this.loadIncludeScript("DAC_COMMONVACATION_ADD.xfdl");
