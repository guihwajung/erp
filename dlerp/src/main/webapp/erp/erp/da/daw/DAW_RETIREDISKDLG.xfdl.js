(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"YY_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CFSELFACNT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CFSELFACNT\" type=\"STRING\" size=\"256\"/><Column id=\"ID_HOMETAX\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/><Column id=\"DS_TELNO\" type=\"STRING\" size=\"256\"/><Column id=\"CONT\" type=\"STRING\" size=\"256\"/><Column id=\"DT_PRINT\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SAUP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TY_GUBUN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divData.form.cboTY_GUBUN","value","dsData","TY_GUBUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divData.form.ctclYY_BASE.form.TextBox","value","dsData","YY_BASE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item11","divData.form.calDT_PRINT","value","dsData","DT_PRINT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","divData.form.edtNO_SAUP","value","dsData","NO_SAUP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.fnSetVariable = function() {
        	...
        	this.cboTY_GUBUN      = this.divData.form.cboTY_GUBUN;			// 작업구분
        	this.ctclYY_BASE      = this.divData.form.ctclYY_BASE;			// 정산년도
        	...
        	this.calDT_PRINT      = this.divData.form.calDT_PRINT;			// 제출일
        ...
        this.fnInit = function() {
        	this.cboTY_GUBUN.set_value("1");
        	this.dsData.setColumn(0, "YY_BASE" , this.gfnGetDate().substr(0,4) - 1);			// 법인
        	this.dsData.setColumn(0, "CD_CORP" , this.AuthClient.CD_CORP);			// 법인
        	this.dsData.setColumn(0, "DS_CORP" , this.AuthClient.DS_CORP);
        	this.dsData.setColumn(0, "CD_CFSELFACNT", this.UserInfo.CD_DEPT_SELFACNT);
        	this.dsData.setColumn(0, "DS_CFSELFACNT", this.UserInfo.DS_DEPT_SELFACNT);
        	this.dsData.setColumn(0, "DT_PRINT", this.gfnGetDate().substr(0,4) + "0228"); // 제출일
        	this.ccfCD_CFSELFACNT.form.fnCodeFindLoad();
        //
        // 	//정산년도(현재)
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsData.getColumn(0, "ID_HOMETAX"))) {
        		this.fnVaidateCallback = function() {
        ...
        */
        ...
        this.fnGetTxtDatasetListC = function(dataset){
        	...
        	for(var row = 0; row < dataset.rowcount; row++) {
        		...
        		for( var col = 0 ; col < dataset.colcount; col++){
        			//strCont += this.gfnNvl(dataset.getColumn(row, "COL_"+col),"");
        			strDiskC = strDiskC +  this.gfnNvl(dataset.getColumn(row, col), "");
        		}
        		strDiskC = nexacro.replaceAll(strDiskC, '★', '');
        		strDiskC = nexacro.replaceAll(strDiskC, "■", "\n");
        		if(row < dataset.rowcount-1) strDiskC += "\n";
        		strCont += strDiskC;
        	}
        ...
        // 		strDiskI15 = "";
        // 		strDiskI16 = "";
        // 		trace(" dataset.colcount =>" + dataset.colcount);
        ...
        this.fnFileDown = function() {
        	...
        	var sNO_SAUP = this.divData.form.edtNO_SAUP.text;
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.edtNO_SAUP.addEventHandler("onchanged",this.divData_edtNO_SAUP_onchanged,this);
