(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAW_RETIREPROVISION_DLG");
            this.set_titletext("퇴직금지급계산서");
            this.getSetter("maxwidth").set("380");
            this.getSetter("maxheight").set("265");
            if (Form == this.constructor)
            {
                this._setFormPosition(339,187);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DAWPR_RETIREPROVISION_REPORT</Col></Row><Row><Col id=\"TARGET\">reportDSC</Col><Col id=\"SP\">DAWPR_RETIREDOCUMENT_REPORT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTITLE","0","0",null,"30","68",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_text("퇴직금 지급계산서");
            obj.set_cssclass("sta_TITLE_Bg");
            obj.set_textAlign("left");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staCD_CORP","0","35","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("법인");
            ...
            obj = new Static("staYM_BASE","0","staCD_CORP:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("적용년월");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staYM_BASE_bg","staYM_BASE:-1","staYM_BASE:-30","252","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            ...
            obj = new Static("staTY_GUBUN","0","staYM_BASE:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_text("구분");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staTY_GUBUN_bg","staTY_GUBUN:-1","staTY_GUBUN:-30","252","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);

            obj = new Radio("rdoTY_GUBUN","staTY_GUBUN:7","staTY_GUBUN:-25","128","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            ...
            divData_form_rdoTY_GUBUN_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">E</Col><Col id=\"datacolumn\">임직원</Col></Row><Row><Col id=\"codecolumn\">T</Col><Col id=\"datacolumn\">노무자</Col></Row></Rows>");
            ...
            obj = new Static("staID_SABUN","0","staTY_GUBUN:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("사번");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Div("divBtns","105","160","130","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","ctclYM_BASE.form.TextBox","value","dsSearch","DT_WORK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAW_RETIREPROVISION_DLG.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.rdoTY_GUBUN.addEventHandler("onitemchanged",this.rdoTY_GUBUN_onitemchanged,this);
        ...
        this.loadIncludeScript("DAW_RETIREPROVISION_DLG.xfdl");
