(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQ\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"ID_PERSON\" type=\"INT\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_EMPTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_EMPTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_OCCUPATION\" type=\"STRING\" size=\"256\"/><Column id=\"DS_OCCUPATION\" type=\"STRING\" size=\"256\"/><Column id=\"CD_POSITION\" type=\"STRING\" size=\"256\"/><Column id=\"DS_POSITION\" type=\"STRING\" size=\"256\"/><Column id=\"NO_RETIRE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_RETIRE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_RETIRE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BANK\" type=\"STRING\" size=\"256\"/><Column id=\"DS_BANK\" type=\"STRING\" size=\"256\"/><Column id=\"NO_IRP\" type=\"STRING\" size=\"256\"/><Column id=\"DT_BIRTHDAY\" type=\"STRING\" size=\"256\"/><Column id=\"NO_APRV\" type=\"STRING\" size=\"256\"/><Column id=\"ST_APRV\" type=\"STRING\" size=\"256\"/><Column id=\"NM_FILE\" type=\"STRING\" size=\"256\"/><Column id=\"ID_INSERT\" type=\"STRING\" size=\"256\"/><Column id=\"ID_UPDATE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_INSERT\" type=\"STRING\" size=\"256\"/><Column id=\"DT_UPDATE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListchk", this);
            obj._setContents("<ColumnInfo><Column id=\"MSG\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAWPR_RETIRE_REQUEST_LIST_SELECT</Col></Row><Row><Col id=\"TARGET\">selectchk</Col><Col id=\"SP\">DAWPR_RETIRE_REQUEST_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAWPR_RETIRE_REQUEST_DELETE</Col></Row><Row><Col id=\"TARGET\">copy</Col><Col id=\"SP\">DAWPR_RETIRE_REQUEST_COPY</Col></Row><Row><Col id=\"TARGET\">aprv_execute</Col><Col id=\"SP\">DAWPR_RETIRE_REQUEST_APRV_EXECUTE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("objGridChk","0","0",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_autofittype("none");
        ...
        //사직서 버튼 클릭 이벤트
        this.fnRetireRequestNew= function(obj,e) {
        ...
        //사직서 보기 버큰 클릭 이벤트
        this.fnRetireRequestSearch= function(obj,e) {
        	//사직서 팝업 실행
        ...
        //사직서 복사 버튼 클릭 이벤트
        this.fnRetireRequestCopy= function(obj,e) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.objGridChk.addEventHandler("oncellposchanged",this.fnGridCellPosChanged,this);
            this.divData.form.objGridChk.addEventHandler("oncelldblclick",this.divData_objGrid_oncelldblclick,this);
