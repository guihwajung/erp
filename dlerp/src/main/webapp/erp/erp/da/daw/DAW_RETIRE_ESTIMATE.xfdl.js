(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAWPR_RETIRE_ESTIMATE_SELECT</Col></Row><Row><Col id=\"SP\">DAWPR_RETIRE_ESTIMATE_SAVE</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"SP\">DAWPR_RETIRE_ESTIMATE_SAVE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAWPR_RETIRE_ESTIMATE_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"YM_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_STANDARD\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CORP\"/><Col id=\"YM_BASE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP","0","10.0","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("법인");
        ...
        // User Script
        this.registerScript("DAW_RETIRE_ESTIMATE.xfdl", function() {
        ...
        // 퇴직금추계액 계산
        this.fnRetireEstimateCalc = function(obj,e) {
        ...
        this.loadIncludeScript("DAW_RETIRE_ESTIMATE.xfdl");
