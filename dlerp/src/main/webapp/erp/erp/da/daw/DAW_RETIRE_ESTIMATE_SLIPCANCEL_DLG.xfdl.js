(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">slip</Col><Col id=\"SP\">DAWPR_RETIRE_EST_AUTOSLIP_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAW_RETIRE_ESTIMATE_SLIPCANCEL_DLG.xfdl", function() {
        ...
        this.loadIncludeScript("DAW_RETIRE_ESTIMATE_SLIPCANCEL_DLG.xfdl");
