(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAMPR_CAR_STATEMENT_SELECT</Col></Row><Row><Col id=\"TARGET\">selectBase</Col><Col id=\"SP\">DAMPR_CAR_STATEMENT_BASE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP","ctclYY_CARUSE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("법인코드");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAM_CAR_STATEMENT.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.divSearch.form.ctclYY_CARUSE.form.TextBox.set_value(today);
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DA", "DAM_CAR_STATEMENT");
        	this.gfnGridInit(this.dxGrid2, this.dsList2, "DA", "DAM_CAR_STATEMENT_BASE");
        ...
        this.fnValidate = function() {
        	...
        	else if (this.gfnIsNull(this.ccfCD_CAR.form.CDTextBox.value)) {
        		this.fnVaidateCallback = function() {
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if (id == "ccfCD_CORP") {
         	...
         	if (id == "ccfCD_CAR") {
        		dsUserParam.setColumn(nrow, "CD_CORP", this.divSearch.form.ccfCD_CORP.form.CDTextBox.text);
        	}
        ...
        this.loadIncludeScript("DAM_CAR_STATEMENT.xfdl");
