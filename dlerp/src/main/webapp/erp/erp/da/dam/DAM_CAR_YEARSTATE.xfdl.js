(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAMPR_CAR_YEARSTATE_SELECT</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DAMPR_CAR_YEARSTATE_RPT_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYY_CARCOST","0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("작업년도");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYY_CARCOST","staYY_CARCOST:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Div("ccfCD_CORP","ctclYY_CARCOST:0.0","10.0","220","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staTY_CAR","ccfCD_CORP:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("차종");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtTY_CAR","staTY_CAR:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_CAR","edtTY_CAR:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("차량코드");
            ...
            obj = new Div("ccfCD_CAR","staCD_CAR:0.0","10.0","210","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staDS_HNAME","ccfCD_CAR:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("사용자");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtDS_HNAME","staDS_HNAME:0.0","10.0","75","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staDT_STD","edtDS_HNAME:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("기준일자");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_STD","staDT_STD:0.0","10.0","115","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            ...
            obj = new Static("staCD_CORP","ctclYY_CARCOST:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("법인코드");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divSearch.form.ctclDT_STD","value","dsSearch","DT_FROM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAM_CAR_YEARSTATE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAM_CAR_YEARSTATE");
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edtDS_HNAME.addEventHandler("onchanged",this.fnSearchInit,this);
            this.divSearch.form.ctclDT_STD.addEventHandler("onchanged",this.fnSearchInit,this);
            this.dsList.addEventHandler("cancolumnchange",this.dsList_cancolumnchange,this);
            this.dsList.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
        };
        this.loadIncludeScript("DAM_CAR_YEARSTATE.xfdl");
