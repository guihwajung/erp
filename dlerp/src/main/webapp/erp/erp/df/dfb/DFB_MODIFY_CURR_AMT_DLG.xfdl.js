(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("집행내역 변경");
            this.getSetter("maxwidth").set("315");
            this.getSetter("maxheight").set("300");
            if (Form == this.constructor)
            {
                this._setFormPosition(280,250);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFBPR_EXECDTL_UPDATE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DHXPR_CURRENCY_EXCHAGE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsList", this);
            obj._setContents("<ColumnInfo><Column id=\"SEQ_EXEC\" type=\"STRING\" size=\"256\"/><Column id=\"DT_REQ\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CURR_EXEC\" type=\"STRING\" size=\"256\"/><Column id=\"AM_AMT\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"AM_AMT_KRW\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"RT_LOCAL_EXCH\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"RT_KRW_EXCH\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"RT_USD_EXCH\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"RT_EUR_EXCH\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"AM_EXEC\" type=\"BIGDECIMAL\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCD_CURR", this);
            obj._setContents("<ColumnInfo><Column id=\"DT_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"RT_LOCAL_EXCH\" type=\"STRING\" size=\"256\"/><Column id=\"RT_KRW_EXCH\" type=\"STRING\" size=\"256\"/><Column id=\"RT_USD_EXCH\" type=\"STRING\" size=\"256\"/><Column id=\"RT_EUR_EXCH\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnSave","86","174","50","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("저장");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancel","142","174","50","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("취소");
            this.divData.addChild(obj.name, obj);
            ...
            obj.set_taborder("8");
            obj.set_datacolumn("CD_CURR");
            obj.set_codecolumn("CD_CURR");
            ...
            obj = new BindItem("item3","divData.form.mskAM_EXEC_KRW","value","dsList","AM_AMT_KRW");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divData.form.mskAM_EXEC","value","dsList","AM_AMT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divData.form.ccboCD_CURR","value","dsList","CD_CURR_EXEC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFB_MODIFY_CURR_AMT_DLG.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DFB_MODIFY_CURR_AMT_DLG.xfdl");
