(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("objGrid","0","divDataMaster:10",null,null,"0","0",null,null,null,null,this.divData1.form);
            obj.set_taborder("3");
            obj._setContents("");
            this.divData1.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DFB_ACCOUNT_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DF01";	//"DW11";
        //DF02	예금간대체및지급계획
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFB_ACCOUNT_APP");
        ...
        this.fnSetParameter = function() {
        	...
        	**************************************************************************************************/
        	...
        	this.dsSelect.addColumn("TM_APPR", "string");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "TM_APPR", this.dsListMaster.getColumn(0, "V_PARAM01"));
        ...
        **************************************************************************************************/
         ...
         ************************************************************************/
         this.fnGrid_ExpandUp = function(obj, e) {
        	...
        	if(colnm == "CT_PROOF") {
        		...
        		fileManager.CD_DIR = [this.dsList.getColumn(e.row, "NO_ACCOUNT")];
        ...
        // 		}
        		...
        		// 수정가능여부
        		fileManager.IS_READONLY = (this.dsList.getColumn(e.row, "YN_EDIT") == "N");

        // 		trace("수정가능여부" + this.dsList.getColumn(e.row, "YN_EDIT"));
        ...
        this.loadIncludeScript("DFB_ACCOUNT_APP.xfdl");
