(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFBPR_MONTHDAILY_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCD_ACCOUNT", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("cfCD_CORP","sta00:0.0","10.0","282","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("sta01","staCD_PERIOD:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("계좌정보");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("cfNO_ACCOUNT","sta01:0.0","10.0","282","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("calYM_ACCOUNT","cfNO_ACCOUNT:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new BindItem("item0","divSearch.form.calYM_ACCOUNT.form.TextBox","value","dsSearch","YM_ACCOUNT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFB_MONTHDAILY_SELECT.xfdl", function() {
        ...
        this.divSearch_cboCD_ACCOUNT_onitemchanged = function(obj,e)
        {
        ...
        this.loadIncludeScript("DFB_MONTHDAILY_SELECT.xfdl");
