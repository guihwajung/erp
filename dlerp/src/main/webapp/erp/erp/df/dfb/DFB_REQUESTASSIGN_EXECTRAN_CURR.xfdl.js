(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnSlipView",null,"0","100","22","btnChangeAccount:5",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("6");
            obj.set_text("전자결재조회");
            obj.set_visible("false");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Button("btnAssignConfirm",null,"0","100","22","5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("0");
            obj.set_text("배정내역확정");
            ...
            obj = new Button("btnExecChange",null,"63","100","22","btnExecEdit:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("16");
            obj.set_text("집행통화변경");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("tbbAssignCncl","btnExecChange:-175","63",null,"22","btnExecChange:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("15");
            obj.set_text("배정취소");
            this.divData.form.divDataBottom.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DFB_REQUESTASSIGN_EXECTRAN_CURR.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGridAssign, this.dsListAssign, "DF", "DFB_REQUESTASSIGN_EXECTRAN_CURR");
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFB_REQUESTASSIGN_EXECTRAN_CURR2");
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "select") {
        		...
        		this.divSearch.form.ccboTY_PAYMENT2.set_index(0);
         		...
         		this.divSearch.form.ccboYN_APPR.set_index(2);
        ...
        // 	this.dsCombo.setColumn(4, "CD_TYPE", "B7");
        	...
        	var inProc		= "_dsProc";
        	var inData      = "combo=dsCombo";
        	var outData     = "dsYN_SLIP=combo0 dsYN_APPR=combo2 dsTY_GUBUN=combo3";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.divData_divDataTop_btnSlipView_onclick = function(obj,e)
        {
        	if(!this.gfnGridIsRow(this.dxGridAssign)) return;

        	var nICnt = this.dsListAssign.findRow(this.ucFlag,"I");
        	var nUCnt = this.dsListAssign.findRow(this.ucFlag,"U");
        	var nDCnt = this.dsListAssign.findRow(this.ucFlag,"D");
        	...
        	// 결재상태 0 : 결재전 시 return;
        // 	var tyAppr = this.dsList.getColumn(this.dsListAssign.rowposition, "TY_APPR");
        // 	if ( tyAppr == "0") {
        ...
        // 	}
        	...
        	url +="forminstanceID="+this.dsListAssign.getColumn(this.dsListAssign.rowposition , "NO_APPR");
        	url +="&processID="+this.dsListAssign.getColumn(this.dsListAssign.rowposition , "NM_APPR");
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataTop.form.btnSlipView.addEventHandler("onclick",this.divData_divDataTop_btnSlipView_onclick,this);
        ...
        this.loadIncludeScript("DFB_REQUESTASSIGN_EXECTRAN_CURR.xfdl");
