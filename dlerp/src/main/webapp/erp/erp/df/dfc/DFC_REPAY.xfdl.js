(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFCPR_REPAY_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFCPR_REPAY_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFCPR_REPAY_UPDATE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFCPR_REPAY_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFCPR_REPAY_AUTOSLIPX</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFC_REPAY.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFC_REPAY");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("AM_FVALUE", "bigdecimal");
        	this.dsUpdate.addColumn("AM_FSANG", "bigdecimal");
        	this.dsUpdate.addColumn("AM_YEZA", "bigdecimal");
        	this.dsUpdate.addColumn("AM_EZA", "bigdecimal");
        	this.dsUpdate.addColumn("AM_REPAY", "bigdecimal");
        	this.dsUpdate.addColumn("AM_TSANG", "bigdecimal");
        	this.dsUpdate.addColumn("AM_TVALUE", "bigdecimal");
        	this.dsUpdate.addColumn("RT_YEZA", "bigdecimal");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "AM_FVALUE", this.dsList.getColumn(i, "AM_FVALUE"));
        				this.dsUpdate.setColumn(nrow, "AM_FSANG", this.dsList.getColumn(i, "AM_FSANG"));
        				this.dsUpdate.setColumn(nrow, "AM_YEZA", this.dsList.getColumn(i, "AM_YEZA"));
        				this.dsUpdate.setColumn(nrow, "AM_EZA", this.dsList.getColumn(i, "AM_EZA"));
        				this.dsUpdate.setColumn(nrow, "AM_REPAY", this.dsList.getColumn(i, "AM_REPAY"));
        				this.dsUpdate.setColumn(nrow, "AM_TSANG", this.dsList.getColumn(i, "AM_TSANG"));
        				this.dsUpdate.setColumn(nrow, "AM_TVALUE", this.dsList.getColumn(i, "AM_TVALUE"));
        ...
        this.loadIncludeScript("DFC_REPAY.xfdl");
