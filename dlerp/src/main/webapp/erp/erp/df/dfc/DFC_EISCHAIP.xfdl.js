(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFCPR_EISCHAIP_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFC_EISCHAIP.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFC_EISCHAIP");
        ...
        this.loadIncludeScript("DFC_EISCHAIP.xfdl");
