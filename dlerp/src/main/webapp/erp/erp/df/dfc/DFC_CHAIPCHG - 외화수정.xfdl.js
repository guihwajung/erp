(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFCPR_CHAIPCHG_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFCPR_CHAIPCHG_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFCPR_CHAIPCHG_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFCPR_CHAIPCHG_DELETE</Col></Row><Row><Col id=\"TARGET\">e_create</Col><Col id=\"SP\">DFCPR_CHAIPPLAN_CREATE</Col></Row><Row><Col id=\"TARGET\">selectExc</Col><Col id=\"SP\">DHXPR_CURRENCY_EXCHAGE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"NO_CHAIP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("cfNO_CHAIP","sta01:0.0","10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("cfCD_CORP","cfNO_CHAIP:111","10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("sta04","378","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("법인코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divSearch.form.cfNO_CHAIP.form.CDTextBox","value","dsSearch","NO_CHAIP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFC_CHAIPCHG - 외화수정.xfdl", function() {
        ...
        this.loadIncludeScript("DFC_CHAIPCHG - 외화수정.xfdl");
