(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("차입금이자비용결산조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFCPR_GYULSAN2_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("calFR_MONTH","cboTY_GUBUN:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("DFC_GYULSAN_MIBUL2.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFC_GYULSAN_MIBUL2");
        ...
        this.loadIncludeScript("DFC_GYULSAN_MIBUL2.xfdl");
