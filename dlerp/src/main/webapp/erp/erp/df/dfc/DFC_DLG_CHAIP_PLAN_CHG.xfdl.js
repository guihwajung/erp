(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnOk","143","295","45","21",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("확인");
            obj.getSetter("uWord").set("popup.ok");
            this.addChild(obj.name, obj);

            obj = new Button("btnCancle","193","295","45","21",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("취소");
        ...
        // User Script
        this.registerScript("DFC_DLG_CHAIP_PLAN_CHG.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("DFC_DLG_CHAIP_PLAN_CHG.xfdl");
