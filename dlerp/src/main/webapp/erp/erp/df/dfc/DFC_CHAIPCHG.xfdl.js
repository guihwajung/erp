(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("cfCD_CORP","cfNO_CHAIP:0.0","10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
        ...
        // User Script
        this.registerScript("DFC_CHAIPCHG.xfdl", function() {
        ...
        this.fnApproval = function(obj,e) {
        	...
        	url += "&legacyFormID=WF_FORM_ERP_BORROWINGS";
        	url += "&subject="+encodeURI("차입금 공시정보 상신");
        	url += "&dataType=proc";
        	url += "&empno=" + this.AuthClient.ID_USER;
        	//url += "&empno="+this.AuthClient.ID_USER; 현재 하나의 사번만가능하여 사번 고정
        	url += "&P_DS_KEY1="+this.dsSearch.getColumn(0, "NO_CHAIP");							// 차입번호
        ...
        this.loadIncludeScript("DFC_CHAIPCHG.xfdl");
