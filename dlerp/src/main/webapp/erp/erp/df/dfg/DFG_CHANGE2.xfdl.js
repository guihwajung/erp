(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("대여금외화환산결산조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFGPR_CHANGE2_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFG_CHANGE2.xfdl", function() {
        ...
        this.loadIncludeScript("DFG_CHANGE2.xfdl");
