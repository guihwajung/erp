(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staBar53","119","138","251","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Button("btnOk","143","296","45","21",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("확인");
            obj.getSetter("uWord").set("popup.ok");
            this.addChild(obj.name, obj);

            obj = new Button("btnCancle","193","296","45","21",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("취소");
            ...
            obj = new Static("staBar01","119","196","251","30",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Static("staBar02","119","256","251","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_ETC","125","172","195","20",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_format("#,###,###,###,###,###,##0");
            ...
            obj = new Static("staItem55","20","138","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("이자");
            ...
            obj = new Static("staItem01","20","196","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("입금예상금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.addChild(obj.name, obj);

            obj = new Static("staItem02","20","256","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("거래내역");
            ...
            obj = new Static("staTitle00","20","229","350","22",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("입금정보");
            obj.set_cssclass("sta_TITLE_Bg");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_EZA","125","143","195","20",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("sta00","326","143","20","20",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("원");
            this.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_TOTAL","125","201","195","20",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("sta03","326","201","20","20",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("원");
            this.addChild(obj.name, obj);

            obj = new Div("cfLST_TRADE","125","260","238","20",null,null,null,null,null,null,this);
            ...
            obj = new Static("staBar04","119","109","251","30",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Static("staItem04","20","109","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("법인세/주민세");
            obj.set_cssclass("sta_WF_tablelabel");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CORP_JUMIN","125","113","195","20",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("sta04","326","113","20","20",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("원");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item0","cfLST_TRADE.form.CDTextBox","value","dsSearch","NO_LOAN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFG_DLG_LOAN_INSLIP.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        * FORM EVENT 영역(onload)
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	if (id == "cfLST_TRADE") {
        		...
        		dsUserParam.setColumn(nrow, "NO_ACCOUNT", this.pv_NO_ACCOUNT_LOAN);
        ...
        */
        ...
        this.loadIncludeScript("DFG_DLG_LOAN_INSLIP.xfdl");
