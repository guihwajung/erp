(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFGPR_CHANGE_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFGPR_CHANGE_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFGPR_CHANGE_UPDATE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFGPR_CHANGE_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFGPR_CHANGE_AUTOSLIPX</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"RT_CURRENCY\" type=\"BIGDECIMAL\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskRT_CURRENCY","calYM_WORK:0.0","10.0","115","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_format("##,###,###,###,###,##0.##");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta01","mskRT_CURRENCY:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("기준환율");
            ...
            obj = new BindItem("item5","divSearch.form.mskRT_CURRENCY","value","dsSearch","RT_CURRENCY");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFG_CHANGE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFG_CHANGE");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("RT_CURRENCY2", "bigdecimal");
        	this.dsUpdate.addColumn("RM_BIGO", "string");

        	this.dsUpdate.addColumn("AM_EZA", "bigdecimal");
        	this.dsUpdate.addColumn("AM_MISU", "bigdecimal");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "RT_CURRENCY2", this.dsList.getColumn(i, "RT_CURRENCY2"));
        				this.dsUpdate.setColumn(nrow, "RM_BIGO", this.dsList.getColumn(i, "RM_BIGO"));

        				this.dsUpdate.setColumn(nrow, "AM_EZA", this.dsList.getColumn(i, "AM_EZA"));
        				this.dsUpdate.setColumn(nrow, "AM_MISU", this.dsList.getColumn(i, "AM_MISU"));
        ...
        this.fnSaveValidate = function() {
        	...
        	if (this.gfnIsNull(this.mskRT_CURRENCY.value)) {
        		this.gfnAlert("기준환율을 입력 하세요.");
        ...
        this.fnCreateData = function(obj,e) {
        	...
        	this.dsCreate.setColumn(nRow, "RT_CURRENCY", rtCurrency);			// 기준환율
        ...
        this.loadIncludeScript("DFG_CHANGE.xfdl");
