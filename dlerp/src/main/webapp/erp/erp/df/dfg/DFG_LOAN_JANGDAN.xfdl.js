(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("대여금 장단기대체 결산");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFGPR_YUDONG_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFGPR_YUDONG_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFGPR_YUDONG_UPDATE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFGPR_YUDONG_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFGPR_YUDONG_AUTOSLIPX</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFG_LOAN_JANGDAN.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFG_LOAN_JANGDAN");
        ...
        this.loadIncludeScript("DFG_LOAN_JANGDAN.xfdl");
