(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFAPR_SUJIFOURTH_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFAPR_SUJIFOURTH_INSERT</Col></Row><Row><Col id=\"TARGET\">udpate</Col><Col id=\"SP\">DFAPR_SUJIFOURTH_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFAPR_SUJIFOURTH_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SUJIFIRST\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SUJISECOND\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SUJITHIRD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFA_SUJIFOURTH.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFA_SUJIFOURTH");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DS_SUJIFOURTH", "string");
        	this.dsInsert.addColumn("YN_NOTES", "string");
        	this.dsInsert.addColumn("NO_SEQ", "string");

        	this.dsUpdate = new Dataset();
        	this.dsUpdate.addColumn("CD_SUJIFIRST", "string");
        	this.dsUpdate.addColumn("CD_SUJISECOND", "string");
        	this.dsUpdate.addColumn("CD_SUJITHIRD", "string");
        	this.dsUpdate.addColumn("CD_SUJIFOURTH", "string");
        	this.dsUpdate.addColumn("DS_SUJIFOURTH", "string");
        	this.dsUpdate.addColumn("YN_NOTES", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "CD_SUJIFIRST", this.ccfCD_SUJIFIRST.form.CDTextBox.value);
        				this.dsInsert.setColumn(nrow, "CD_SUJISECOND", this.ccfCD_SUJISECOND.form.CDTextBox.value);
        				this.dsInsert.setColumn(nrow, "CD_SUJITHIRD", this.ccfCD_SUJITHIRD.form.CDTextBox.value);
        				this.dsInsert.setColumn(nrow, "CD_SUJIFOURTH", this.dsList.getColumn(i, "CD_SUJIFOURTH"));
        				this.dsInsert.setColumn(nrow, "DS_SUJIFOURTH", this.dsList.getColumn(i, "DS_SUJIFOURTH"));
        				this.dsUpdate.setColumn(nrow, "YN_NOTES", this.dsList.getColumn(i, "YN_NOTES"));
        ...
        // 				this.dsInsert.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_SUJIFIRST", this.ccfCD_SUJIFIRST.form.CDTextBox.value);
        				this.dsUpdate.setColumn(nrow, "CD_SUJISECOND", this.ccfCD_SUJISECOND.form.CDTextBox.value);
        				this.dsUpdate.setColumn(nrow, "CD_SUJITHIRD", this.ccfCD_SUJITHIRD.form.CDTextBox.value);
        				this.dsUpdate.setColumn(nrow, "CD_SUJIFOURTH", this.dsList.getColumn(i, "CD_SUJIFOURTH"));
        				this.dsUpdate.setColumn(nrow, "DS_SUJIFOURTH", this.dsList.getColumn(i, "DS_SUJIFOURTH"));
        				this.dsUpdate.setColumn(nrow, "YN_NOTES", this.dsList.getColumn(i, "YN_NOTES"));
        ...
        // 				this.dsUpdate.setColumn(nrow, "ID_UPDATE", this.AuthClient.ID_USER);
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "CD_SUJIFIRST", this.ccfCD_SUJIFIRST.form.CDTextBox.value);
        				this.dsDelete.setColumn(nrow, "CD_SUJISECOND", this.ccfCD_SUJISECOND.form.CDTextBox.value);
        				this.dsDelete.setColumn(nrow, "CD_SUJITHIRD", this.ccfCD_SUJITHIRD.form.CDTextBox.value);
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.ccfCD_SUJIFIRST.form.CDTextBox.value)) {
        		...
        		this.fnVaidateCallback = function() {
        			this.ccfCD_SUJIFIRST.form.CDTextBox.setFocus();
        		}
        	...
        	if (this.gfnIsNull(this.ccfCD_SUJISECOND.form.CDTextBox.value)) {
        		...
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			this.ccfCD_SUJISECOND.form.CDTextBox.setFocus();
        		}
        		this.gfnAlert("중분류코드를 입력하세요.", "fnVaidateCallback");
        		return false;
        	}
        	...
        	if (this.gfnIsNull(this.ccfCD_SUJITHIRD.form.CDTextBox.value)) {
        		...
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			this.ccfCD_SUJITHIRD.form.CDTextBox.setFocus();
        		}
        		this.gfnAlert("소분류코드를 입력하세요.", "fnVaidateCallback");
        		return false;
        	}
        ...
        this.loadIncludeScript("DFA_SUJIFOURTH.xfdl");
