(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staUnit",null,"divDataMaster:10","85","20","5",null,null,null,null,null,this.divData1.form);
            obj.set_taborder("4");
            obj.set_text("(단위 : 백만원)");
            this.divData1.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","staUnit:5",null,null,"0","0",null,null,null,null,this.divData1.form);
            obj.set_taborder("3");
            obj._setContents("");
            this.divData1.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DFA_PLANS_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DF03";	//	단기자금계획
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "YM_PLAN", this.dsListMaster.getColumn(0, "V_PARAM01"));	// 작성년월
        	this.dsSelect.setColumn(0, "CD_CORP", this.dsListMaster.getColumn(0, "V_PARAM02"));	// 법인코드
        	this.dsSelect.setColumn(0, "CD_SITE", this.dsListMaster.getColumn(0, "V_PARAM03"));	// 작성부서
        	this.dsSelect.setColumn(0, "YN_FINAL", this.dsListMaster.getColumn(0, "V_PARAM04"));// 최종여부
        ...
        **************************************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg) {
        	if (svcID == "init") {
        		...
        		if (errorCode == 0) {
        			//헤더 상단 설정
        			var dtPlan = this.dsListMaster.getColumn(0, "V_PARAM01") +"01";
        			var headTitle1 = this.gfnAddMonth(dtPlan,1);
        			var headTitle2 = this.gfnAddMonth(dtPlan,2);
        			var headTitle3 = this.gfnAddMonth(dtPlan,3);

        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_0"), "text", dtPlan.substr(4,2)+"월");		// AM_0	M월
        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_1"), "text", headTitle1.substr(4,2)+"월");	// AM_1	M+1월
        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_2"), "text", headTitle2.substr(4,2)+"월");	// AM_2	M+2월
        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_3"), "text", headTitle3.substr(4,2)+"월");	// AM_3	M+3월
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        ...
        this.loadIncludeScript("DFA_PLANS_APP.xfdl");
