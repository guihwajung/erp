(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFAPR_PLANL_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFAPR_PLANL_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFAPR_PLANL_UPDATE</Col></Row><Row><Col id=\"TARGET\">createx</Col><Col id=\"SP\">DFAPR_PLANL_CREATEX</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">clearx</Col><Col id=\"SP\">DFAPR_PLANL_GW_CLEAR</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFAPR_PLANL_CREATE</Col></Row><Row><Col id=\"TARGET\">createx</Col><Col id=\"SP\">DFAPR_PLANL_CREATEX</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFA_PLAN_LONG.xfdl", function() {
        ...
        this.loadIncludeScript("DFA_PLAN_LONG.xfdl");
