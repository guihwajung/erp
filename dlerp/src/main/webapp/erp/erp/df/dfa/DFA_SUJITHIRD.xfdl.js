(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFAPR_SUJITHIRD_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFAPR_SUJITHIRD_INSERT</Col></Row><Row><Col id=\"TARGET\">udpate</Col><Col id=\"SP\">DFAPR_SUJITHIRD_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFAPR_SUJITHIRD_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SUJIFIRST\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SUJISECOND\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFA_SUJITHIRD.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFA_SUJITHIRD");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DS_SUJITHIRD", "string");
        	...
        	this.dsUpdate.addColumn("DS_SUJITHIRD", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DS_SUJITHIRD", this.dsList.getColumn(i, "DS_SUJITHIRD"));
        ...
        // 				this.dsInsert.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_SUJITHIRD", this.dsList.getColumn(i, "CD_SUJITHIRD"));
        				this.dsUpdate.setColumn(nrow, "DS_SUJITHIRD", this.dsList.getColumn(i, "DS_SUJITHIRD"));
        ...
        this.loadIncludeScript("DFA_SUJITHIRD.xfdl");
