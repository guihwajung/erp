(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("장기자금계획 자료삭제(초기화)");
            ...
            obj.set_taborder("5");
            obj.set_text("장기자금계획 자료삭제(초기화)");
            obj.set_cssclass("sta_POP_Title");
            this.addChild(obj.name, obj);

            obj = new Static("sta00","26","174","264","20",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("※ 해당 조건의 모든자료가 삭제됩니다.");
            obj.set_font("bold 12px/normal \"Dotum\"");
            this.addChild(obj.name, obj);

            obj = new Static("sta01","266","174","97","20",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("[주의]");
            obj.set_color("red");
            obj.set_font("bold 12px/normal \"Dotum\"");
        ...
        // User Script
        this.registerScript("DFA_DLG_PLANL_DELETE.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("DFA_DLG_PLANL_DELETE.xfdl");
