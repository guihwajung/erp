(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("단기자금계획 자료삭제(초기화)");
        ...
        // User Script
        this.registerScript("DFA_DLG_PLANS_DELETE.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("DFA_DLG_PLANS_DELETE.xfdl");
