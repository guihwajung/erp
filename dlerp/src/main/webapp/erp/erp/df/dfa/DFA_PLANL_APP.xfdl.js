(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DFA_PLANL_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DF04";	//	장기자금계획
        ...
        **************************************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg) {
        	if (svcID == "init") {
        		...
        		if (errorCode == 0) {
        			//헤더 상단 설정
        			var dtPlan = this.dsListMaster.getColumn(0, "V_PARAM01");

        			var YrPlan = nexacro.toNumber(dtPlan.substr(0,4));
        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_0"), "text", YrPlan+"년");		// AM_0	M년
        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_1"), "text", (YrPlan+1)+"년");	// AM_1	M+1년
        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_2"), "text", (YrPlan+2)+"년");	// AM_2	M+2년
        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_3"), "text", (YrPlan+3)+"년");	// AM_3	M+3년
        			this.dxGrid.setCellProperty("head", this.gfnGetHeadCellIndex(this.dxGrid, "AM_4"), "text", (YrPlan+4)+"년");	// AM_3	M+4년
        ...
        this.loadIncludeScript("DFA_PLANL_APP.xfdl");
