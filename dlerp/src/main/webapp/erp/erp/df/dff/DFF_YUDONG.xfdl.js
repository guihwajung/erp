(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFFPR_YUDONG_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFFPR_YUDONG_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFFPR_YUDONG_UPDATE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFFPR_YUDONG_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFFPR_YUDONG_AUTOSLIPX</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFFPR_YUDONG_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00","cfCD_CORP:0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("회계년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFF_YUDONG.xfdl", function() {
        ...
        this.loadIncludeScript("DFF_YUDONG.xfdl");
