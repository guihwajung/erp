(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"FR_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"TO_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BANKITEM\" type=\"STRING\" size=\"256\"/><Column id=\"NO_YEJUKUM\" type=\"STRING\" size=\"256\"/><Column id=\"TY_EXPIRY\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("cfNO_YEJUKUM","451","44","270","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("sta03","cfNO_YEJUKUM:0","sta04:10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("완료여부");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboTY_EXPIRY","sta03:0","sta04:10","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new BindItem("item1","divSearch.form.cfNO_YEJUKUM.form.CDTextBox","value","dsSearch","NO_YEJUKUM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFF_ACCOUNT_SCHEDULE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFF_YEJUKUMSCDL");
        ...
        this.loadIncludeScript("DFF_ACCOUNT_SCHEDULE.xfdl");
