(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1520,820);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFFPR_YEJUKUMREG_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFFPR_YEJUKUMREG_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFFPR_YEJUKUMREG_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFFPR_YEJUKUMREG_DELETE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo2</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo3</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo4</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo5</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo6</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo7</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo8</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">e_create</Col><Col id=\"SP\">DFFPR_YEJUKUMPLAN_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta03","392","44","92.0","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("완료여부");
            ...
            obj = new Static("sta05","323","28","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("40");
            obj.set_text("법인코드");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Div("ccfCD_CORP","404","33","240","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("1");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_enable("true");
            ...
            obj = new Static("sta28","0","127",null,"22","-1",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("44");
            obj.set_text("납입조건");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta29","651","28","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("45");
            obj.set_text("금융상품");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta33","74","154",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("46");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta34","0","154","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("47");
            obj.set_text("불입일");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta36","233","154","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("48");
            obj.set_text("불입주기");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("staChitPubPnt","731","154","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("49");
            obj.set_text("불입액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta45","0","290",null,"22","-1",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("50");
            obj.set_text("진행정보");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta01","0","28","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("37");
            obj.set_text("관리번호");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Edit("txtNO_YEJUKUM","81","33","232","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("0");
            obj.set_maxlength("20");
            obj.set_enable("false");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta21","651","57","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("42");
            obj.set_text("금융기관");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta26","651","86","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("43");
            obj.set_text("가입기간");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta10","0","57","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("51");
            obj.set_text("예적금계좌");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta12","323","86","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("52");
            obj.set_text("귀속부서");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskTR_INCOME","334","159","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("11");
            obj.set_format("#0");
            obj.set_limitbymask("integer");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta07","94","319",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("53");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta08","0","319","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("54");
            obj.set_text("계약금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CONT","121","324","175","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("22");
            obj.set_format("#,###,###,###,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta09","334","319","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("55");
            obj.set_text("총불입횟수");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskCT_TINCOM","455","324","165","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("23");
            obj.set_format("#,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta38","660","319","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("56");
            obj.set_text("불입액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_INTOT","781","324","165","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("24");
            obj.set_format("#,###,###,###,###,###,##0");
            ...
            obj = new Static("sta41","94","348",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("57");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta42","0","348","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("58");
            obj.set_text("현불입횟수");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta43","334","348","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("59");
            obj.set_text("잔액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta44","660","348","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("60");
            obj.set_text("계획생성");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta47","94","377",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("61");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta49","660","377","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("62");
            obj.set_text("완료여부");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta50","334","377","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("63");
            obj.set_text("해지일자");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta51","0","377","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("64");
            obj.set_text("해지여부");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboYN_CANCEL","121","382","175","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("28");
            ...
            obj = new Static("sta52","0","420",null,"22","-1",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("65");
            obj.set_text("담보/제한 및 비고");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta53","74","449",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("66");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta55","334","449","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("67");
            obj.set_text("종류");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta56","74","507",null,"100","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("68");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta59","0","449","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("69");
            obj.set_text("금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta64","0","507","115","100",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("71");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_text("비고");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new TextArea("TeaRM_BIGO","121","514","837","87",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("35");
            obj.set_maxlength("200");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Edit("txtDS_LIMIT","455","454","165","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("32");
            obj.set_maxlength("100");
            obj.set_enable("true");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta04","323","57","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("72");
            obj.set_text("예적금명");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Div("cfCD_BANKITEM2","732","33","251","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("2");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_enable("true");
            ...
            obj = new Edit("txtNM_YEJUKUM","404","62","240","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("4");
            obj.set_maxlength("50");
            obj.set_enable("true");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Div("cfNO_ACCOUNT","81","62","232","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            ...
            obj = new Div("cfCD_VENDOR","732","62","251","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("5");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_enable("true");
            ...
            obj = new Div("cfCD_DEPT_ACNT","404","91","240","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("7");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_enable("true");
            ...
            obj = new Calendar("calDT_CONT","732","91","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("8");
            ...
            obj = new Static("staCD_TILDE01","843","91","10","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("73");
            obj.set_text("~");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Calendar("calDT_FINISH","859","91","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("9");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new MaskEdit("mskAM_INCOME","833","159","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("13");
            obj.set_format("#,###,###,###,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta02","0","193",null,"22","-1",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("74");
            obj.set_text("이자수취조건");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta13","74","220",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("75");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta14","0","220","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("76");
            obj.set_text("이율(%)");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta27","233","220","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("77");
            obj.set_text("방식");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("staChitPubPnt00","731","220","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("78");
            obj.set_text("계산방식");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta32","481","220","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("79");
            obj.set_text("유형");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskRT_EZA","101","225","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("14");
            obj.set_format("###,##0.####");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_DANBOK","334","225","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("15");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Combo("cboTY_EZA","583","225","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("16");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Combo("cboTY_EZACAL","833","225","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("17");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Combo("cboYN_PLAN","781","353","165","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("27");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Combo("cboTY_EXPIRY2","781","382","165","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("30");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Calendar("calDT_CANCEL","455","382","165","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("29");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new MaskEdit("mskAM_LIMIT","121","454","175","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("31");
            obj.set_format("#,###,###,###,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskDT_INCOME","101","159","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("10");
            obj.set_format("#0");
            obj.set_limitbymask("integer");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskQN_IN","121","353","175","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("25");
            obj.set_format("#,###,###,##0");
            obj.set_enable("false");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_JAN","455","353","165","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("26");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_enable("false");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta15","74","249",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("80");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta16","0","249","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("81");
            obj.set_text("수취일");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta17","233","249","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("82");
            obj.set_text("주기(개월)");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("staChitPubPnt01","731","249","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("83");
            obj.set_text("일수계산");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta18","481","249","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("84");
            obj.set_text("수취기준");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskTR_EZASTD","101","254","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("18");
            obj.set_format("#,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_SUNHOO","583","254","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("20");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Combo("cboTY_YANGDAN","833","254","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("21");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new MaskEdit("mskTR_INTTERM","334","254","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("19");
            obj.set_format("#,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta19","0","86","75","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("85");
            obj.set_text("대체계좌");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Div("cfNO_ACCOUNT_DCHE","81","91","232","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.getSetter("CDTextWidth").set("110");
            obj.set_taborder("6");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_enable("true");
            ...
            obj = new Static("sta20","481","154","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("86");
            obj.set_text("회전주기");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskTR_TURN","583","159","125","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("12");
            obj.set_format("#0");
            obj.set_limitbymask("integer");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta22","74","478",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("87");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta61","0","478","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("70");
            obj.set_text("실가용금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SIL","121","483","175","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("33");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_enable("false");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta23","334","478","115","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("88");
            obj.set_text("브랜치전송");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_CMS","455","484","165","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("34");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new BindItem("item20","divData.form.divDataRight.form.mskDT_INCOME","value","dsList","DT_INCOME");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item22","divData.form.divDataRight.form.mskAM_INCOME","value","dsList","AM_INCOME");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item27","divData.form.divDataRight.form.mskAM_CONT","value","dsList","AM_CONT");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item29","divData.form.divDataRight.form.mskAM_INTOT","value","dsList","AM_INTOT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item30","divData.form.divDataRight.form.mskQN_IN","value","dsList","AS QN_IN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item31","divData.form.divDataRight.form.mskAM_JAN","value","dsList","AM_JAN");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item36","divData.form.divDataRight.form.mskAM_LIMIT","value","dsList","AM_LIMIT");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item38","divData.form.divDataRight.form.mskAM_SIL","value","dsList","AM_SIL");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFF_ACCOUNT_REGISTRATION.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	// 납입조건
        	this.mskDT_INCOME = this.divData.form.divDataRight.form.mskDT_INCOME;		// 불입일
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFF_YEJUKUMREG");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DT_INCOME", "bigdecimal");
        	...
        	this.dsUpdate.addColumn("DT_INCOME", "bigdecimal");
        ...
        // 	}
        	...
        	//this.dsList.setColumn(nrow, "CD_BANKITEM", "");   // 금융상품
        	//this.dsList.setColumn(nrow, "NM_YEJUKUM", "");    // 예적금명
        	//this.dsList.setColumn(nrow, "NO_ACCOUNT", "");    // 계좌번호
        	//this.dsList.setColumn(nrow, "TY_GUBUN", "");      // 계좌구분
        	//this.dsList.setColumn(nrow, "CD_BANK", "");       // 은행코드
        	//this.dsList.setColumn(nrow, "CD_VENDOR", "");     // 금융기관
        	//this.dsList.setColumn(nrow, "CD_DEPT", "");       // 귀속부서
        	//this.dsList.setColumn(nrow, "DT_CONT", "");       // 가입일
        	//this.dsList.setColumn(nrow, "DT_FINISH", "");     // 만기일
        	//this.dsList.setColumn(nrow, "DT_CANCEL", "");    	// 해지일자
        	//this.dsList.setColumn(nrow, "DS_LIMIT", "");     	// 담보/제한종류
        	//this.dsList.setColumn(nrow, "RM_BIGO", "");       // 비고
        	...
        	this.dsList.setColumn(nrow, "TY_EZACAL", "월수");   				// 이자계산방식
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	// 계좌
        	case "cfNO_ACCOUNT":
        		dsUserParam.setColumn(nrow, "GUBUN", "51");
        ...
        this.fnSetCombo = function() {
        	...
        	this.dsCombo2.setColumn(0, "CD_TYPE", "F3");
        	...
        	this.dsCombo3.setColumn(0, "CD_TYPE", "F6");
        	...
        	this.dsCombo4.setColumn(0, "CD_TYPE", "F9");
        	...
        	this.dsCombo5.setColumn(0, "CD_TYPE", "F5");
        	...
        	this.dsCombo6.setColumn(0, "CD_TYPE", "F7");
        	...
        	this.dsCombo7.setColumn(0, "CD_TYPE", "ZZ");

        	var strSvcId    = "combo";
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "combo=dsCombo combo2=dsCombo2 combo3=dsCombo3 combo4=dsCombo4 combo5=dsCombo4 combo6=dsCombo5 combo7=dsCombo6 combo8=dsCombo7";
        	var outData     = "dsTY_DANBOK=combo0 dsTY_EZA=combo20 dsTY_EZACAL=combo30 dsTY_EXPIRY=combo40 dsTY_EXPIRY2=combo50 dsTY_SUNHOO=combo60 dsTY_YANGDAN=combo70 dsTY_CMS=combo80";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnPlanPerform = function(obj,e) {
        	...
        	var param = {};
        	param.OWNER_ID = "DFF_ACCOUNT_REGISTRATION";
        	...
        	param.DT_TO =  this.gfnAddMonth(this.dsList.getColumn(this.dsList.rowposition, "DT_FINISH"), 1);
        ...
        this.fnChngInfoInsert = function(obj,e) {
        	...
        	param.NO_YEJUKUM = this.dsList.getColumn(this.dsList.rowposition,"NO_YEJUKUM");
        	param.NM_YEJUKUM = this.dsList.getColumn(this.dsList.rowposition,"NM_YEJUKUM");
        	this.gfnFormOpen("DFF", "DFF_YEJUKUMCHG", "fnPopCallBack", param, this.getOffsetWidth(), this.getOffsetHeight());
        }

        this.fnPopCallBack = function(svcID, val) {

        	if (svcID.indexOf("DFF_YEJUKUMCHG") > -1) {
        		this.FormBtns.Select.click();
        	}
        }
        ...
        this.loadIncludeScript("DFF_ACCOUNT_REGISTRATION.xfdl");
