(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("전표발행(입금)");
            if (Form == this.constructor)
            {
                this._setFormPosition(390,330);
            }
            ...
            obj = new Div("divData","0","-40",null,null,"0","10",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("div_DATA_Bg");
            this.addChild(obj.name, obj);

            obj = new Static("staBar02","119","257","251","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBar00","119","80","251","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBar03","119","138","251","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBar04","119","167","251","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBar01","119","196","251","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBar53","119","109","251","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_TRADE","125","84","195","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_format("#,###,###,###,###,###,##0.##");
            ...
            obj = new MaskEdit("mskAM_EZA","125","114","195","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_format("#,##0.##");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("sta00","326","114","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_text("원");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mskAM_CORP_JUMIN","125","143","195","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("staItem04","20","167","100","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            obj.set_text("부대비용");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_ETC","125","172","195","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_format("#,##0.##");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("staItem01","20","196","100","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_text("입금예상금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TOTAL","125","201","195","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_format("#,##0.##");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("staTitle00","20","230","350","22",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("16");
            obj.set_text("입금정보");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staItem02","20","257","100","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_text("입금 거래내역");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.addChild(obj.name, obj);

            obj = new Div("cfLST_TRADE","125","261","238","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Button("btnOk","143","317","45","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("20");
            obj.set_text("확인");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancle","193","317","45","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            obj.set_text("취소");
            obj.getSetter("uWord").set("popup.cancel");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta01","326","143","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("22");
            obj.set_text("원");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta02","326","84","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("23");
            obj.set_text("원");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta04","326","172","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("24");
            obj.set_text("원");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta03","326","201","20","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("25");
            obj.set_text("원");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",390,330,this,function(p){});
        ...
        // User Script
        this.registerScript("DFF_DLG_INSLIP.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("DFF_DLG_INSLIP.xfdl");
