(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFLPR_ETC1_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DFLPR_ETC_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">confirm</Col><Col id=\"SP\">DFLPR_ETC_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFLPR_ETC_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFLPR_ETC_DELETE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFLPR_ETC_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFLPR_ETC_AUTOSLIPX</Col></Row><Row><Col id=\"TARGET\">comboTyCms</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"YN_SLIP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_CMS\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta03","calDT_TRADE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("발행여부");
            ...
            obj = new Static("staTyCms","calDT_TRADE:0.0","sta04:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("대체구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboTY_CMS","staTyCms:0.0","sta04:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Div("divSplitter","54.45%","0","5",null,null,"0",null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            ...
            obj = new BindItem("item2","divSearch.form.calDT_TRADE","value","dsSearch","DT_TRADE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","divSearch.form.cboTY_CMS","value","dsSearch","TY_CMS");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFL_ETC.xfdl", function() {
        ...
        this.loadIncludeScript("DFL_ETC.xfdl");
