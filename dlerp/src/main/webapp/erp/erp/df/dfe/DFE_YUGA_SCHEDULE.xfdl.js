(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFEPR_YUGASCDL_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"FR_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"TO_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_YUGA\" type=\"STRING\" size=\"256\"/><Column id=\"NO_YUGA\" type=\"STRING\" size=\"256\"/><Column id=\"YN_CLOSE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("calFR_TRADE","sta00:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Calendar("calTO_TRADE","staCD_TILDE:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Static("sta02","cfCD_YUGA:0.0","sta04:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("관리번호");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("cfNO_YUGA","sta02:0.0","sta04:10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Combo("cboYN_CLOSE","sta03:0.0","sta04:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new BindItem("item5","divSearch.form.cfCD_YUGA.form.CDTextBox","value","dsSearch","CD_YUGA");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item7","divSearch.form.cboYN_CLOSE","value","dsSearch","YN_CLOSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.cfNO_YUGA.form.CDTextBox","value","dsSearch","NO_YUGA");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFE_YUGA_SCHEDULE.xfdl", function() {
        ...
        this.loadIncludeScript("DFE_YUGA_SCHEDULE.xfdl");
