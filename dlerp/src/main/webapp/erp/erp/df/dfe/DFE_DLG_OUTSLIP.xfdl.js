(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staTitle","20","139","350","22",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("전표참고정보");
            ...
            obj = new Button("btnOk","143","304","45","21",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("확인");
            obj.getSetter("uWord").set("popup.ok");
            this.addChild(obj.name, obj);

            obj = new Button("btnCancle","193","304","45","21",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("취소");
            obj.getSetter("uWord").set("popup.cancel");
            this.addChild(obj.name, obj);

            obj = new Static("staBar01","119","108","251","30",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staItem01","20","108","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Static("sta03","326","113","20","20",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("원");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staBar00","119","166","251","30",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Static("staItem00","20","166","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("출금금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TOTAL","125","171","195","20",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("sta02","326","171","20","20",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("원");
            this.addChild(obj.name, obj);

            obj = new Static("staBar04","119","195","251","30",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Static("staItem04","20","195","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("출금예상금액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_PRE_TOTAL","125","200","195","20",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_limitbymask("integer");
            obj.set_enable("false");
            ...
            obj = new Static("sta04","326","200","20","20",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_text("원");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DFE_DLG_OUTSLIP.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("DFE_DLG_OUTSLIP.xfdl");
