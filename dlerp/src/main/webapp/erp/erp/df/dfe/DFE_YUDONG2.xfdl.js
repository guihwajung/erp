(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("유가증권장단기대체결산조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFEPR_YUDONG2_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFE_YUDONG2.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFE_YUDONG2");
        ...
        this.loadIncludeScript("DFE_YUDONG2.xfdl");
