(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRBPR_CONTRACTCANCEL_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"DT_START\" type=\"STRING\" size=\"256\"/><Column id=\"DT_END\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_START","ccfCD_ACNTUNIT:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("취소일자");
        ...
        // User Script
        this.registerScript("DRB_CONTRACTCANCEL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRB_CONTRACTCANCEL");
        };
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "DT_START", this.gfnNvl(this.dsSearch.getColumn(0, "DT_START"),"").replaceAll("-",""));
        	this.dsSelect.setColumn(0, "DT_END", this.gfnNvl(this.dsSearch.getColumn(0, "DT_END"),"").replaceAll("-",""));
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0,"CD_ACNTUNIT"))) {
        		...
        		this.gfnAlert("사업지코드를 입력하세요.", "fnVaidateCallback");
        	     ...
        	     && !this.gfnIsNull(this.dsSearch.getColumn(0,"DT_END")))
        	{
        ...
        this.loadIncludeScript("DRB_CONTRACTCANCEL.xfdl");
