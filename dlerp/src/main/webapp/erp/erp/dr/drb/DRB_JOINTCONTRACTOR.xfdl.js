(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRBPR_CONTRACTDETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">selectJoint</Col><Col id=\"SP\">DRBPR_JOINTCONTRACTOR_SELECT</Col></Row><Row><Col id=\"TARGET\">insertJoint</Col><Col id=\"SP\">DRBPR_JOINTCONTRACTOR_INSERT</Col></Row><Row><Col id=\"TARGET\">updateJoint</Col><Col id=\"SP\">DRBPR_JOINTCONTRACTOR_UPDATE</Col></Row><Row><Col id=\"TARGET\">deleteJoint</Col><Col id=\"SP\">DRBPR_JOINTCONTRACTOR_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRB_JOINTCONTRACTOR.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsListJoint, "DR", "DRB_JOINTCONTRACTOR");
        };
        ...
        this.loadIncludeScript("DRB_JOINTCONTRACTOR.xfdl");
