(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"SP\">DRBPR_WEB_MINAP_SELECT</Col><Col id=\"TARGET\">select</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DRBPR_WEB_MINAP_OPT1_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DRBPR_WEB_MINAP_OPT2_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTitle03","0","512",null,"22","0",null,null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("2");
            obj.set_text("별도계약1");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataMain.addChild(obj.name, obj);
            ...
            obj = new Grid("objGrid","0","115",null,null,"780","470",null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("5");
            obj._setContents("");
            this.divData.form.divDataMain.addChild(obj.name, obj);

            obj = new Grid("objGrid1","0","535",null,null,"780","283",null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("6");
            obj._setContents("");
            this.divData.form.divDataMain.addChild(obj.name, obj);

            obj = new Static("staTitle03_00","0","712",null,"22","0",null,null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("7");
            obj.set_text("별도계약2");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataMain.addChild(obj.name, obj);

            obj = new Grid("objGrid2","0","735",null,null,"780","60",null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("8");
            obj._setContents("");
            this.divData.form.divDataMain.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRQ_MINAP.xfdl", function() {
        ...
        this.loadIncludeScript("DRQ_MINAP.xfdl");
