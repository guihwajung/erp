(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">selectRemark</Col><Col id=\"SP\">DRBPR_REMARK_INFO_SELECT</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRBPR_CONTRACTDETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRBPR_CONTRACTOR_UPDATE</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DRBPR_RECEIVED_SELECT_DT</Col></Row><Row><Col id=\"TARGET\">select2_1</Col><Col id=\"SP\">DRCPR_APPROPRIATE_SELECT</Col></Row><Row><Col id=\"TARGET\">select2_2</Col><Col id=\"SP\">DRBPR_LOANAPPLY_INFO_SELECT</Col></Row><Row><Col id=\"TARGET\">select3</Col><Col id=\"SP\">DRBPR_LAWSUIT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert3</Col><Col id=\"SP\">DRCPR_LAWSUIT_INSERT</Col></Row><Row><Col id=\"TARGET\">update3</Col><Col id=\"SP\">DRCPR_LAWSUIT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete3</Col><Col id=\"SP\">DRCPR_LAWSUIT_DELETE</Col></Row><Row><Col id=\"TARGET\">select4</Col><Col id=\"SP\">DRBPR_INTEREST_INFO_SELECT</Col></Row><Row><Col id=\"TARGET\">select4_2</Col><Col id=\"SP\">DRBPR_INTEREST_SUNAP_INFO_SELECT</Col></Row><Row><Col id=\"TARGET\">receiptcancel</Col><Col id=\"SP\">DRCPR_RECEIPT_CANCEL_SHINYOUNG</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSplitter","0","58%","100%","5",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            ...
            obj = new Static("sta39","0","sta33:-1","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("39");
            obj.set_text("e-Mail");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta40","sta39:-1","sta34:-1",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("40");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta41","0","sta39:-1","100","50",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("41");
            obj.set_text("특이사항");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta42","sta41:-1","sta40:-1",null,"50","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("42");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta45","0","sta41:9","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("41");
            obj.set_text("약정분양금");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta46","sta45:-1","sta41:9",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("42");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta47","sta34:-1","sta41:9","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("41");
            obj.set_text("수납분양금");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta48","sta36:-1","sta41:9","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("41");
            obj.set_text("예수금");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new MaskEdit("txtNO_SIZE","sta01:5","37","80","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("43");
            obj.set_value("");
            obj.set_format("#,###.0000");
            obj.set_readonly("true");
            ...
            obj = new Edit("txtYN_OPTION","sta05:5","sta02:4","90","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("48");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Edit("txtNO_JUMIN","sta15:5","sta10:4","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("53");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Edit("txtNO_MOBILE","sta21:5","sta16:4","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("55");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDS_RECADDR2","cfNO_RECPOST:5","sta18:4","410","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("58");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDS_ADDR2","cfNO_POST:5","sta24:4","410","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("60");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDS_UPJONG","sta31:5","sta26:4","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("63");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Radio("rdoYN_JOINT","sta37:5","sta32:4","133","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("66");
            obj.set_direction("vertical");
            obj.set_fittocontents("width");
            obj.set_codecolumn("CD_CODE");
            ...
            obj = new Edit("txtDS_EMAIL","sta39:5","sta34:4","200","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("67");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new TextArea("txtDS_REMARK","sta41:5","sta40:4",null,"40","94",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("68");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new MaskEdit("txtAM_BUNYANGPLAN","sta45:5","sta42:14","200","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("43");
            obj.set_value("");
            obj.set_format("#,##0");
            ...
            obj = new MaskEdit("txtAM_BUNYANGGET","sta47:5","sta42:14","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("43");
            obj.set_value("");
            obj.set_format("#,##0");
            obj.set_textAlign("right");
            ...
            obj = new MaskEdit("txtAM_KASU","sta48:5","sta42:14","173","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("43");
            obj.set_value("");
            obj.set_format("#,##0");
            obj.set_textAlign("right");
            ...
            obj = new Button("btnReceiptCancel",null,"5","70","20","10",null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab1.form);
            obj.set_taborder("1");
            obj.set_text("수납취소");
            ...
            obj = new Static("objGrid4_1","5","0","100","22",null,null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab4.form);
            obj.set_taborder("0");
            obj.set_text("후불이자대납");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataBottom.form.tabData.tab4.addChild(obj.name, obj);

            obj = new Grid("objGrid4","5","25","500",null,"5","5",null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab4.form);
            obj.set_taborder("1");
            obj._setContents("");
            this.divData.form.divDataBottom.form.tabData.tab4.addChild(obj.name, obj);

            obj = new Static("objGrid4_2_1","objGrid4:5","0","100","22",null,null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab4.form);
            obj.set_taborder("0");
            obj.set_text("후불이자상환");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataBottom.form.tabData.tab4.addChild(obj.name, obj);

            obj = new Grid("objGrid4_2","objGrid4:5","25",null,null,"5","5",null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab4.form);
            obj.set_taborder("1");
            obj._setContents("");
            this.divData.form.divDataBottom.form.tabData.tab4.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DRD_RECEIPTDETAIL.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnIpjuSche = this.gfnFormButtonAdd("IpjuSche", "fnIpjuSche");
        	this.btnOwner = this.gfnFormButtonAdd("Owner", "fnOwner");
        };
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DR", "DRD_RECEIPTDETAIL_RECEIVED");
        	this.gfnGridInit(this.dxGrid2_1, this.dsList2_1, "DR", "DRD_RECEIPTDETAIL_APPROPRIATE");
        	this.gfnGridInit(this.dxGrid2_2, this.dsList2_2, "DR", "DRD_RECEIPTDETAIL_PAYBACK");
        	this.gfnGridInit(this.dxGrid3, this.dsList3, "DR", "DRD_RECEIPTDETAIL_LOWSUIT");
        	this.gfnGridInit(this.dxGrid4, this.dsList4, "DR", "DRD_RECEIPTDETAIL_INTEREST");
        	this.gfnGridInit(this.dxGrid4_2, this.dsList4_2, "DR", "DRD_RECEIPTDETAIL_INTEREST_SUNAP");
        ...
        this.fnSelect = function() {
        	...
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
         	var inData      = "selectRemark=dsSelectRemark select=dsSelect select1=dsSelect select2_1=dsSelect select2_2=dsSelect select3=dsSelect select4=dsSelect select4_2=dsSelect";
         	var outData     = "dsRemarkInfo=selectRemark0 dsList=select0 dsList1=select10 dsList2_1=select2_10 dsList2_2=select2_20 dsList3=select30 dsList4=select40 dsList4_2=select4_20";
        	var strArg      = "";
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				if (this.gfnIsNull(this.dsList3.getColumn(i, "TY_CHECK"))) {
        					...
        					else if (this.dsList3.getColumn(i, "TY_CHECK") == "해지") {
        						if (this.gfnIsNull(this.dsList3.getColumn(i, "DT_CLOSE"))) {
        							strMsg += "해지일자는 반드시 입력 하셔야 합니다.\n";
        						}
        					}
        				}
        				break;
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	if (svcID == "select") {
        		...
        		if (this.dsRemarkInfo.rowcount > 0 && !this.gfnIsNull(this.dsRemarkInfo.getColumn(0, "MSG"))) {
        			this.btnOwner.set_enable(false);
        		}
        		else {
        			this.btnOwner.set_enable(true);
        		}
        ...
        this.fnInit = function() {
        	if (this.gfnIsNull(this.dsList.getColumn(0, "DT_CONTRACT"))) {
        		...
        		this.cfRT_OPTION.set_enable(true);
        ...
        //입주예정관리
        this.fnIpjuSche = function(obj,e) {
        	var param = {};
        	param.CD_ACNTUNIT = this.dsSearch.getColumn(0, "CD_ACNTUNIT");
        	param.DS_ACNTUNIT = this.dsSearch.getColumn(0, "DS_ACNTUNIT");
        	param.DONG = this.dsSearch.getColumn(0, "NO_DONG");
        ...
        this.fnPopupCallback = function(svcID, val) {
        	if (svcID.indexOf("DRD_IPJUSCHEDULE") > -1 || svcID.indexOf("DRD_OWNERSHIP") > -1) {
        		this.FormBtns.Select.click();
        	}
        }
        ...
        this.loadIncludeScript("DRD_RECEIPTDETAIL.xfdl");
