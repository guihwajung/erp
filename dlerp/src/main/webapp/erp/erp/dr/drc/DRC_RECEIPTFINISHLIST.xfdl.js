(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRCPR_RECEIPTFINISH_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"YN_OPTION\" type=\"STRING\" size=\"256\"/><Column id=\"DT_KIJUN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_ACNTUNIT\"/><Col id=\"DS_ACNTUNIT\"/><Col id=\"YN_OPTION\"/><Col id=\"DT_KIJUN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdoYN_OPTION","staTY_OPTION:0.0","10.0","120","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            ...
            obj = new Static("staDT_KIJUN","rdoYN_OPTION:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("기준일자");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_KIJUN","staDT_KIJUN:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new BindItem("item3","divSearch.form.ctclDT_KIJUN","value","dsSearch","DT_KIJUN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DRC_RECEIPTFINISHLIST.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.ctclDT_KIJUN = this.divSearch.form.ctclDT_KIJUN;
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRC_RECEIPTFINISHLIST_2");
        	this.dsSearch.setColumn(0, "DT_KIJUN", this.gfnGetDate());
        ...
        this.rdoYN_OPTION_onitemchanged = function(obj,e)
        {
        	if(this.dsSearch.getColumn(0, "YN_OPTION")=="Y"){	// 구분이 옵션일경우 DRC_RECEIPTFINISHLIST_1, 분양일경우 DRC_RECEIPTFINISHLIST_2
        		this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRC_RECEIPTFINISHLIST_1");
        	}else{
        		this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRC_RECEIPTFINISHLIST_2");
        	}
        };
        ...
        this.loadIncludeScript("DRC_RECEIPTFINISHLIST.xfdl");
