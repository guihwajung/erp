(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DRC_RECEIPTBATCHEXCEL_NEW.xfdl", function() {
        ...
        this.loadIncludeScript("DRC_RECEIPTBATCHEXCEL_NEW.xfdl");
