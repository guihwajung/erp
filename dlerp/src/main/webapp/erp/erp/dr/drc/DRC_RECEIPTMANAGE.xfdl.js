(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">selectleft</Col><Col id=\"SP\">DRCPR_RECEIPTCONDITION_SELECT</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRBPR_CONTRACTDETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRBPR_CONTRACTOR_UPDATE</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DRBPR_RECEIVED_SELECT_DT</Col></Row><Row><Col id=\"TARGET\">select2_1</Col><Col id=\"SP\">DRBPR_LOANAPPLY_INFO_SELECT</Col></Row><Row><Col id=\"TARGET\">select2_2</Col><Col id=\"SP\">DRBPR_LOANRECEIVED_SELECT</Col></Row><Row><Col id=\"TARGET\">select3</Col><Col id=\"SP\">DRBPR_LAWSUIT_SELECT</Col></Row><Row><Col id=\"TARGET\">select4</Col><Col id=\"SP\">DRCPR_APPROPRIATE_SELECT</Col></Row><Row><Col id=\"TARGET\">select5</Col><Col id=\"SP\">DRBPR_TRANSFERHISTORY_SELECT</Col></Row><Row><Col id=\"TARGET\">select6</Col><Col id=\"SP\">DRBPR_CANCELHISTORY_SELECT</Col></Row><Row><Col id=\"TARGET\">select7</Col><Col id=\"SP\">DRBPR_IND_RTDELAY_SELECT</Col></Row><Row><Col id=\"TARGET\">insert3</Col><Col id=\"SP\">DRCPR_LAWSUIT_INSERT</Col></Row><Row><Col id=\"TARGET\">update3</Col><Col id=\"SP\">DRCPR_LAWSUIT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete3</Col><Col id=\"SP\">DRCPR_LAWSUIT_DELETE</Col></Row><Row><Col id=\"TARGET\">insert7</Col><Col id=\"SP\">DRBPR_IND_RTDELAY_INSERT</Col></Row><Row><Col id=\"TARGET\">update7</Col><Col id=\"SP\">DRBPR_IND_RTDELAY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete7</Col><Col id=\"SP\">DRBPR_IND_RTDELAY_DELETE</Col></Row><Row><Col id=\"TARGET\">summary</Col><Col id=\"SP\">DRCPR_RECEIPTSUMMARY_SELECT</Col></Row><Row><Col id=\"TARGET\">nominalrecovery</Col><Col id=\"SP\">DRBPR_NOMINALTRANSFER_RECOVERY</Col></Row><Row><Col id=\"TARGET\">receiptcancel</Col><Col id=\"SP\">DRCPR_RECEIPT_CANCEL_SHINYOUNG</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSplitter2","0","53%","100%","5",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("1");
            obj.set_background("skyblue");
            ...
            obj = new Grid("objGrid2_1","5","5","400",null,null,"5",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.tabData.tab2.form);
            obj.set_taborder("1");
            obj._setContents("");
            this.divData.form.divDataRight.form.divDataBottom.form.tabData.tab2.addChild(obj.name, obj);

            obj = new Grid("objGrid2_2","objGrid2_1:5","5",null,null,"5","5",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.tabData.tab2.form);
            obj.set_taborder("2");
            obj._setContents("");
            this.divData.form.divDataRight.form.divDataBottom.form.tabData.tab2.addChild(obj.name, obj);
            ...
            obj = new Tabpage("tab7",this.divData.form.divDataRight.form.divDataBottom.form.tabData);
            obj.set_text("변동금리");
            this.divData.form.divDataRight.form.divDataBottom.form.tabData.addChild(obj.name, obj);

            obj = new Grid("objGrid7","5","5",null,null,"5","5",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.tabData.tab7.form);
            obj.set_taborder("1");
            obj._setContents("");
            this.divData.form.divDataRight.form.divDataBottom.form.tabData.tab7.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("DRC_RECEIPTMANAGE.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.FileManager = {};
        	this.FileManager.CD_GUBUN = "DR01";
        ...
        this.fnSetExtendButton = function() {
        	this.btnCotractDetail = this.gfnFormButtonAdd("CotractDetail", "fnCotractDetail");		//약정변경
        	this.btnNominal = this.gfnFormButtonAdd("Nominal", "fnNominal");						//명의변경
        	this.btnCancel = this.gfnFormButtonAdd("Cancel", "fnCancel");							//해약관리
        	this.btnJoint = this.gfnFormButtonAdd("Joint", "fnJoint");								//공동명의계약자
        	this.btnOption = this.gfnFormButtonAdd("Option", "fnOption");							//별도계약관리
        	this.btnCounsel = this.gfnFormButtonAdd("Counsel", "fnCounsel");						//상담일지
        	this.btnNominalRecovery = this.gfnFormButtonAdd("NominalRecovery", "fnNominalRecovery");	//최근 명의변경자 복원
        ...
        this.fnSetVariable = function() {
        	...
        	this.dxGrid7 = this.tabData.tab7.form.objGrid7;
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsLeft, "DR", "DRC_RECEIPTMANAGE_1");
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DR", "DRC_RECEIPTMANAGE_2");
        	this.gfnGridInit(this.dxGrid2_1, this.dsList2_1, "DR", "DRC_RECEIPTMANAGE_3");
        	this.gfnGridInit(this.dxGrid2_2, this.dsList2_2, "DR", "DRC_RECEIPTMANAGE_4");
        	this.gfnGridInit(this.dxGrid3, this.dsList3, "DR", "DRC_RECEIPTMANAGE_5");
        	this.gfnGridInit(this.dxGrid4, this.dsList4, "DR", "DRC_RECEIPTMANAGE_6");
        	this.gfnGridInit(this.dxGrid5, this.dsList5, "DR", "DRC_RECEIPTMANAGE_7");
        	this.gfnGridInit(this.dxGrid6, this.dsList6, "DR", "DRC_RECEIPTMANAGE_8");
        	this.gfnGridInit(this.dxGrid7, this.dsList7, "DR", "DRC_RECEIPTMANAGE_9");

         	this.gfnGridColumnColor(this.dxGrid1, "TY_MONEY", "Blue", "TY_MONEY != ''");

        	this.dxGrid.addEventHandler("onselectchanged", this.fnGrid_RowCellChanged, this);

        	this.dxGrid7.AfterEdit = "fnGrid7_AfterEdit";
        ...
        // 	this.dsUpdate.addColumn("DT_REFUND", "string");
        	...
        	this.dsInsert7 = new Dataset();
        	this.dsInsert7.addColumn("CD_ACNTUNIT", "string");
        	this.dsInsert7.addColumn("TY_GUBUN", "string");
        	this.dsInsert7.addColumn("NO_CHASU", "string");
        	this.dsInsert7.addColumn("NO_DONG", "string");
        	this.dsInsert7.addColumn("NO_FLOOR", "string");
        	this.dsInsert7.addColumn("NO_HO", "string");
        	this.dsInsert7.addColumn("NO_UNIONMEMBER", "string");
        	this.dsInsert7.addColumn("TY_NAPIP", "string");
        	this.dsInsert7.addColumn("NO_NAPIP", "string");
        	this.dsInsert7.addColumn("DT_START", "string");
        	this.dsInsert7.addColumn("DT_END", "string");
        	this.dsInsert7.addColumn("RT_DISCOUNT", "bigdecimal");
        	this.dsInsert7.addColumn("RT_DELAY1", "bigdecimal");
        	this.dsInsert7.addColumn("RT_DELAY3", "bigdecimal");
        	this.dsInsert7.addColumn("RT_DELAY6", "bigdecimal");
        	this.dsInsert7.addColumn("RT_DELAY99", "bigdecimal");
        	this.dsInsert7.addColumn("ID_INSERT", "string");

        	this.dsUpdate7 = new Dataset();
        	this.dsUpdate7.addColumn("CD_ACNTUNIT", "string");
        	this.dsUpdate7.addColumn("TY_GUBUN", "string");
        	this.dsUpdate7.addColumn("NO_CHASU", "string");
        	this.dsUpdate7.addColumn("NO_DONG", "string");
        	this.dsUpdate7.addColumn("NO_FLOOR", "string");
        	this.dsUpdate7.addColumn("NO_HO", "string");
        	this.dsUpdate7.addColumn("NO_UNIONMEMBER", "string");
        	this.dsUpdate7.addColumn("TY_NAPIP", "string");
        	this.dsUpdate7.addColumn("NO_NAPIP", "string");
        	this.dsUpdate7.addColumn("DT_START", "string");
        	this.dsUpdate7.addColumn("DT_END", "string");
        	this.dsUpdate7.addColumn("RT_DISCOUNT", "bigdecimal");
        	this.dsUpdate7.addColumn("RT_DELAY1", "bigdecimal");
        	this.dsUpdate7.addColumn("RT_DELAY3", "bigdecimal");
        	this.dsUpdate7.addColumn("RT_DELAY6", "bigdecimal");
        	this.dsUpdate7.addColumn("RT_DELAY99", "bigdecimal");
        	this.dsUpdate7.addColumn("ID_UPDATE", "string");

        	this.dsDelete7 = new Dataset();
        	this.dsDelete7.addColumn("CD_ACNTUNIT", "string");
        	this.dsDelete7.addColumn("TY_GUBUN", "string");
        	this.dsDelete7.addColumn("NO_CHASU", "string");
        	this.dsDelete7.addColumn("NO_DONG", "string");
        	this.dsDelete7.addColumn("NO_FLOOR", "string");
        	this.dsDelete7.addColumn("NO_HO", "string");
        	this.dsDelete7.addColumn("NO_UNIONMEMBER", "string");
        	this.dsDelete7.addColumn("TY_NAPIP", "string");
        	this.dsDelete7.addColumn("NO_NAPIP", "string");
        	this.dsDelete7.addColumn("DT_START", "string");


        	this.dsSelectSummary = new Dataset();
        	this.dsSelectSummary.addColumn("CD_ACNTUNIT", "string");
        	this.dsSelectSummary.addColumn("TY_GUBUN", "string");
        	this.dsSelectSummary.addColumn("NO_CHASU", "string");
        	this.dsSelectSummary.addColumn("NO_DONG", "string");
        	this.dsSelectSummary.addColumn("NO_FLOOR", "string");
        	this.dsSelectSummary.addColumn("NO_HO", "string");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelectLeft.setColumn(0, "DS_RECEIPTSTAT", this.gfnNvl(this.dsSearch.getColumn(0, "DS_RECEIPTSTAT")));
        ...
        this.fnSelectDetail = function() {
        	...
        	this.dsSelectSummary.setColumn(0, "CD_ACNTUNIT", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(0, 6));
        	this.dsSelectSummary.setColumn(0, "TY_GUBUN", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(6, 1));
        	this.dsSelectSummary.setColumn(0, "NO_CHASU", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(7, 2));
        	this.dsSelectSummary.setColumn(0, "NO_DONG", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_DONG"));
        	this.dsSelectSummary.setColumn(0, "NO_FLOOR", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_FLOOR"));
        	this.dsSelectSummary.setColumn(0, "NO_HO", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_HO"));

        	var strSvcId    = "select";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
         	var inData      = "select=dsSelect select1=dsSelect select2_1=dsSelect select2_2=dsSelect select3=dsSelect select4=dsSelect select5=dsSelect select6=dsSelect select7=dsSelect summary=dsSelectSummary";
         	var outData     = "dsList=select0 dsList1=select10 dsList2_1=select2_10 dsList2_2=select2_20 dsList3=select30 dsList4=select40 dsList5=select50 dsList6=select60 dsList7=select70 dsSummary=summary0";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnAdd = function() {
        	...
        	else if (this.tabData.tabindex == 6)
        		this.gfnGridAdd(this.dxGrid7);
        }
        ...
        this.fnSave = function() {
        	...
        	this.dsUpdate.setColumn(nrow, "NO_UNIONMEMBER", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_UNIONMEMBER"));
        	...
        	this.dsUpdate.setColumn(nrow, "DT_CONTRACT", this.dsList.getColumn(0, "DT_CONTRACT"));
        ...
        // 	this.dsUpdate.setColumn(nrow, "DT_REFUND", "");
        	...
        	for (var i = 0; i < this.dsList7.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				var nrow = this.dsInsert7.addRow();
        				this.dsInsert7.setColumn(nrow, "CD_ACNTUNIT", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(0, 6));
        				this.dsInsert7.setColumn(nrow, "TY_GUBUN", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(6, 1));
        				this.dsInsert7.setColumn(nrow, "NO_CHASU", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(7, 2));
        				this.dsInsert7.setColumn(nrow, "NO_DONG", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_DONG"));
        				this.dsInsert7.setColumn(nrow, "NO_FLOOR", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_FLOOR"));
        				this.dsInsert7.setColumn(nrow, "NO_HO", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_HO"));
        				this.dsInsert7.setColumn(nrow, "NO_UNIONMEMBER", "");
        				this.dsInsert7.setColumn(nrow, "TY_NAPIP", tyNapip);
        				this.dsInsert7.setColumn(nrow, "NO_NAPIP", this.dsList7.getColumn(i, "NO_NAPIP"));
        				this.dsInsert7.setColumn(nrow, "DT_START", nexacro.replaceAll(this.dsList7.getColumn(i, "DT_START"), "-", ""));
        				this.dsInsert7.setColumn(nrow, "DT_END", nexacro.replaceAll(this.dsList7.getColumn(i, "DT_END"), "-", ""));
        				this.dsInsert7.setColumn(nrow, "RT_DISCOUNT", this.dsList7.getColumn(i, "RT_DISCOUNT"));
        				this.dsInsert7.setColumn(nrow, "RT_DELAY1", this.dsList7.getColumn(i, "RT_DELAY1"));
        				this.dsInsert7.setColumn(nrow, "RT_DELAY3", this.dsList7.getColumn(i, "RT_DELAY3"));
        				this.dsInsert7.setColumn(nrow, "RT_DELAY6", this.dsList7.getColumn(i, "RT_DELAY6"));
        				this.dsInsert7.setColumn(nrow, "RT_DELAY99", this.dsList7.getColumn(i, "RT_DELAY99"));
        				this.dsInsert7.setColumn(nrow, "ID_INSERT", this.AuthClient.ID_USER);
        				break;

        			case "U":
        				var nrow = this.dsUpdate7.addRow();
        				this.dsUpdate7.setColumn(nrow, "CD_ACNTUNIT", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(0, 6));
        				this.dsUpdate7.setColumn(nrow, "TY_GUBUN", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(6, 1));
        				this.dsUpdate7.setColumn(nrow, "NO_CHASU", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(7, 2));
        				this.dsUpdate7.setColumn(nrow, "NO_DONG", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_DONG"));
        				this.dsUpdate7.setColumn(nrow, "NO_FLOOR", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_FLOOR"));
        				this.dsUpdate7.setColumn(nrow, "NO_HO", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_HO"));
        				this.dsUpdate7.setColumn(nrow, "NO_UNIONMEMBER", "");
        				this.dsUpdate7.setColumn(nrow, "TY_NAPIP", tyNapip);
        				this.dsUpdate7.setColumn(nrow, "NO_NAPIP", this.dsList7.getColumn(i, "NO_NAPIP"));
        				this.dsUpdate7.setColumn(nrow, "DT_START", nexacro.replaceAll(this.dsList7.getColumn(i, "DT_START"), "-", ""));
        				this.dsUpdate7.setColumn(nrow, "DT_END", nexacro.replaceAll(this.dsList7.getColumn(i, "DT_END"), "-", ""));
        				this.dsUpdate7.setColumn(nrow, "RT_DISCOUNT", this.dsList7.getColumn(i, "RT_DISCOUNT"));
        				this.dsUpdate7.setColumn(nrow, "RT_DELAY1", this.dsList7.getColumn(i, "RT_DELAY1"));
        				this.dsUpdate7.setColumn(nrow, "RT_DELAY3", this.dsList7.getColumn(i, "RT_DELAY3"));
        				this.dsUpdate7.setColumn(nrow, "RT_DELAY6", this.dsList7.getColumn(i, "RT_DELAY6"));
        				this.dsUpdate7.setColumn(nrow, "RT_DELAY99", this.dsList7.getColumn(i, "RT_DELAY99"));
        				this.dsUpdate7.setColumn(nrow, "ID_UPDATE", this.AuthClient.ID_USER);

        				break;

        			case "D":
        				var nrow = this.dsDelete7.addRow();
        				this.dsDelete7.setColumn(nrow, "CD_ACNTUNIT", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(0, 6));
        				this.dsDelete7.setColumn(nrow, "TY_GUBUN", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(6, 1));
        				this.dsDelete7.setColumn(nrow, "NO_CHASU", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(7, 2));
        				this.dsDelete7.setColumn(nrow, "NO_DONG", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_DONG"));
        				this.dsDelete7.setColumn(nrow, "NO_FLOOR", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_FLOOR"));
        				this.dsDelete7.setColumn(nrow, "NO_HO", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_HO"));
        				this.dsDelete7.setColumn(nrow, "NO_UNIONMEMBER", "");
        				this.dsDelete7.setColumn(nrow, "TY_NAPIP", tyNapip);
        				this.dsDelete7.setColumn(nrow, "NO_NAPIP", this.dsList7.getColumn(i, "NO_NAPIP"));
        				this.dsDelete7.setColumn(nrow, "DT_START", nexacro.replaceAll(this.dsList7.getColumn(i, "DT_START"), "-", ""));
        				break;
        		}
        	}
        	...
        	if (!(this.dsInsert7.rowcount == 0 && this.dsUpdate7.rowcount == 0 && this.dsDelete7.rowcount == 0)) {
        		strInData += " insert7=dsInsert7 update7=dsUpdate7 delete7=dsDelete7";
        	}
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "selectleft") {
        		...
        		if (this.dsSummary.rowcount > 0) {
        			var frow = this.dsSummary.findRow("DS_GUBUN", "분양대금");
        			this.amSelling = nexacro.toNumber(this.dsSummary.getColumn(frow, "AM_SELLING"));
        			this.amBunyang = nexacro.toNumber(this.dsSummary.getColumn(frow, "AM_RECEIPT"));
        		}
        	}
        	else if(svcID == "save") {
        		if (errorCode == 0) {
        ...
        this.fnGrid7_AfterEdit = function(obj,e) {
        ...
        this.fnInit = function() {
        	if (this.gfnIsNull(this.dsList.getColumn(0, "DT_CONTRACT"))) {
        		...
        		//Button
        		this.btnNominal.set_enable(false);
        		...
        		//Button
        		this.btnNominal.set_enable(true);
        		...
        		this.btnSpecialReceipt_2.set_enable(bReadonly);

        		if (this.FormInfo.TY_AUTH == "R") {
        			this.btnReceipt.set_enable(false);
        			this.btnReceiptCancel.set_enable(false);
        			this.btnSpecialReceipt_2.set_enable(false);

        			this.btnContractDetail.set_enable(false);
        			this.btnNominal.set_enable(false);
        			this.btnCancel.set_enable(false);
        			this.btnNominalRecovery.set_enable(false);
        		}
        	}
        }
         ...
         ************************************************************************/
        //약정변경
        this.fnCotractDetail = function(obj,e) {
        	...
        	this.gfnFormOpen("DRB", "DRB_CONTRACTDETAIL", "fnPopupCallback", param);
        }

        //명의변경
        this.fnNominal = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) return;

        	if (this.amSelling - this.amBunyang <= 0) {
        		this.gfnConfirm("수납이 이미 완료되었습니다.\n명의변경을 하시겠습니까?", "fnNominal_callback");
        		return;
        	}

        	this.fnNominal_callback("", true);
        }

        this.fnNominal_callback = function(strID, val) {
        	if (!val) return;
        	...
        	this.gfnFormOpen("DRB", "DRB_DLGTRANSFER", "fnPopupCallback", param);
        }
        ...
        this.fnCancel = function(obj,e) {
        	...
        	if (this.dsList.getColumn(0, "YN_OPTION") == "있음") {
        		//this.gfnConfirm("별도계약을 먼저 해약처리해야 합니다.\n별도계약 화면으로 이동하려면 [예]를 클릭하세요.", "fnCancel_callback", "1");
        		this.gfnConfirm("별도계약을 먼저 해약처리해야 합니다.\n별도계약 화면으로 이동하려면 [예]를 클릭하세요.", "fnCancel_true_callback");
        		return;
        	}

        	if (this.amSelling - this.amBunyang <= 0) {
        		this.gfnConfirm("수납이 이미 완료되었습니다.\계약을 해약 하시겠습니까?", "fnCancel_callback", "2");
        		return;
        	}

        	this.fnCancel_callback("", true);
        }

        this.fnCancel_true_callback = function(strID, val) {
        	if (!val) return;
        ...
        this.fnCancel_callback = function(strID, val) {
        	...
        	param.NO_UNIONMEMBER = this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_UNIONMEMBER");
        	param.NO_JUMIN = this.dsList.getColumn(0, "NO_JUMIN");
        	param.AM_BUNYANG = this.amSelling;
        	...
        	if (this.dsList1.rowcount == 0) {
        		...
        		param.AM_RECEIPT = this.dsList1.getSum("AM_BUNYANG");
        		param.AM_DISCOUNT = this.dsList1.getSum("AM_DISCOUNT");
        		param.AM_DELAY = this.dsList1.getSum("AM_DELAY");
        		param.AM_REALRECEIPT = this.dsList1.getSum("AM_RECEIPT");
        	}

        	param.AM_FORFEIT = nexacro.round(this.amSelling * 0.1);

        	this.gfnFormOpen("DRB", "DRB_DLGCANCEL", "fnPopupCallback", param);
        }

        //공동명의계약자
        this.fnJoint = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) return;
        	...
        	param.TY_DISTRICT = this.dsList.getColumn(0, "TY_DISTRICT");
        	param.RT_OPTION = this.dsList.getColumn(0, "RT_OPTION");
        	param.DS_OPTION = this.dsList.getColumn(0, "DS_OPTION");

        	this.gfnFormOpen("DRB", "DRB_JOINTCONTRACTOR", "fnPopupCallback", param);
        }

        //별도계약관리
        this.fnOption = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) return;
        	...
        	this.gfnFormOpen("DRF", "DRF_RECEIPTDETAIL", "fnPopupCallback", param);
        }
        ...
        this.fnCounsel = function(obj,e) {
        	...
        	this.gfnFormOpen("DRB", "DRB_COUNSEL", "fnPopupCallback", param);
        }

        //최근 명의변경자 복원
        this.fnNominalRecovery = function(obj,e) {
        	if (this.dsList5.rowcount <= 0) {
        		this.gfnAlert("명의변경 내역이 없습니다.");
        		return false;
        	}

        	this.gfnConfirm("최근 명의변경자로 복원하시겠습니까?\n복원되면 명의변경이 취소되며 기존 계약자 정보는 영구 삭제됩니다.", "fnNominalRecovery_callback");
        }

        this.fnNominalRecovery_callback = function(strID, val) {
        	if (!val) return;

        	this.dsNominalRecovery.clearData();
        	var nrow = this.dsNominalRecovery.addRow();
        	this.dsNominalRecovery.setColumn(nrow, "CD_ACNTUNIT", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(0, 6));
        	this.dsNominalRecovery.setColumn(nrow, "TY_GUBUN", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(6, 1));
        	this.dsNominalRecovery.setColumn(nrow, "NO_CHASU", this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(7, 2));
        	this.dsNominalRecovery.setColumn(nrow, "NO_DONG", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_DONG"));
        	this.dsNominalRecovery.setColumn(nrow, "NO_FLOOR", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_FLOOR"));
        	this.dsNominalRecovery.setColumn(nrow, "NO_HO", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_HO"));
        	this.dsNominalRecovery.setColumn(nrow, "NO_UNIONMEMBER", "");
        	this.dsNominalRecovery.setColumn(nrow, "ID_INSERT", this.AuthClient.ID_USER);

        	if (this.dsNominalRecovery.rowcount == 0) return;

        	var strSvcId    = "nominalrecovery";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "nominalrecovery=dsNominalRecovery";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnFileUpload = function(obj,e) {
        	...
        	this.FileManager.CD_DIR = [this.dsSearch.getColumn(0, "CD_ACNTUNIT"), 					//사업지코드
        	                           this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_DONG"), 	//동
        ...
        this.fnExcReceiptInfo = function(obj,e) {
        	...
        	param.NO_HO = this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_HO");
        	param.NO_UNIONMEMBER = this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_UNIONMEMBER");
        	param.DS_CONTRACTOR = this.dsLeft.getColumn(this.dsLeft.rowposition, "DS_CONTRACTOR");
        	param.DS_ADDR = this.dsList.getColumn(0, "DS_ADDR2") + " " + this.dsList.getColumn(0, "DS_ADDR3")
        ...
        this.fnPopupCallback = function(svcID, val) {
        	if (svcID.indexOf("DRB_CONTRACTDETAIL") > -1 || svcID.indexOf("DRB_JOINTCONTRACTOR") > -1 || svcID.indexOf("DRF_RECEIPTDETAIL") > -1) {
        		this.FormBtns.Select.click();
        	}
        	else if (svcID.indexOf("DRB_DLGTRANSFER") > -1) {
        		if (val) {
        			this.FormBtns.Select.click();
        		}
        	}
        	else if (svcID.indexOf("DRB_DLGCANCEL") > -1 || svcID.indexOf("DRC_DLGRECEIPT") > -1 || svcID.indexOf("DRC_DLGSPECIALRECEIPT") > -1) {
        		if (val) {
        			this.fnSelectDetail();
        		}
        	}
        	else if (svcID.indexOf("DRB_COUNSEL") > -1) {
        		//
        		//Select_JointContractorAndCounselGubun
        	}
        }
        ...
        this.btnReceiptCancel_callback = function(strID, val) {
        	...
        	if (i < 0) {
        		...
        		this.dsReceiptCancel.setColumn(nrow, "NO_UNIONMEMBER", this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_UNIONMEMBER"));
        		this.dsReceiptCancel.setColumn(nrow, "TY_NAPIP", strTyNapip);
        		this.dsReceiptCancel.setColumn(nrow, "NO_NAPIP", this.dsList1.getColumn(i, "NO_NAPCHA"));
        ...
        this.divData_divDataRight_divDataBottom_tabData_tab1_btnSpecialReceipt_2_onclick = function(obj,e) {
        	...
        	param.CD_GUJA = this.dsList.getColumn(0, "CD_GUJA");
        	param.NO_GUJA = this.dsList.getColumn(0, "NO_GUJA");
        	param.TY_NAPIP = this.dsLeft.getColumn(this.dsLeft.rowposition, "TY_NAPIP");
        	param.NO_NAPIP = this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_NAPIP");
        	param.NO_BUNNAP = this.dsLeft.getColumn(this.dsLeft.rowposition, "NO_BUNNAP");
        ...
        this.loadIncludeScript("DRC_RECEIPTMANAGE.xfdl");
