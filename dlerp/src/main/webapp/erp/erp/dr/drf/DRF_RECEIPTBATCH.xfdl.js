(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRCPR_AUTORECEIPT_BATCH_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRCPR_FBS_AUTORECEIPT_MIGRATION</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRCPR_AUTORECEIPT_BATCH_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRCPR_AUTORECEIPT_DELETE</Col></Row><Row><Col id=\"TARGET\">deleteFBS</Col><Col id=\"SP\">DRCPR_FBS_AUTORECEIPT_MIGRATION_ERR</Col></Row><Row><Col id=\"TARGET\">deleteFBSTrade</Col><Col id=\"SP\">DRCPR_FBS_TRADE_UPLOAD_SHINYOUNG</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRF_RECEIPTBATCH.xfdl", function() {
        ...
        this.loadIncludeScript("DRF_RECEIPTBATCH.xfdl");
