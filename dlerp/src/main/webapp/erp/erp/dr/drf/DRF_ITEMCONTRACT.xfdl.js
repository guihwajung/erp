(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">selectLeft</Col><Col id=\"SP\">DRFPR_ITEMSFORCONTRACT_SELECT</Col></Row><Row><Col id=\"SP\">DRFPR_ITEMCONTRACT_SELECT</Col><Col id=\"TARGET\">select</Col></Row><Row><Col id=\"SP\">DRFPR_ITEMCONTRACT_INSERT_DT</Col><Col id=\"TARGET\">save</Col></Row><Row><Col id=\"SP\">DRFPR_CONTRACT_NO_SELECT</Col><Col id=\"TARGET\">selectContNo</Col></Row><Row><Col id=\"SP\">DRFPR_DONGHOSIZE_SELECT</Col><Col id=\"TARGET\">selectDongHo</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DRFPR_CONTRACT_KSBJ</Col></Row><Row><Col id=\"TARGET\">report2</Col><Col id=\"SP\">DRFPR_CONTRACT_KSBJ_OPT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRF_ITEMCONTRACT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGridLeft, this.dsListLeft, "DR", "DRF_ITEMCONTRACT");
        	this.gfnGridInit(this.dxGridRight, this.dsListRight, "DR", "DRF_ITEMCONTRACT");
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRF_ITEMCONTRACT_CONS");
        ...
        // 확장 버튼 활성화 처리
        this.fnArrowBtnEnabled = function(move) {
        	...
        	if(move == "<"){
        		...
        		{
        			if(this.dsListLeft.getColumn(i, "YN_SERVICE") == "N"){
        				this.btnItemCont.set_enable(true);
        			}
        			if(this.dsListLeft.getColumn(i, "YN_SERVICE") == "Y"){
        				this.btnSvcItem.set_enable(true);
        			}
        		}
        	}else{
        ...
        this.divData_btnLeftAll_onclick = function(obj,e)
        {
         ...
         this.fnSvcItem = function(obj,e) {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRF_DLGSERVICECONT", "fnSvcItemCallback", param);
        }
        ...
        this.fnItemContCallback =  function(svcID, val) {
         ...
         this.fnEtcPrint = function(obj,e) {
        	if(this.dsList.rowposition < 0){
        		this.gfnAlert("계약된 품목을 선택하세요!");
        		return;
        	}

        	var sNO_CONTRACT = this.dsList.getColumn(this.dsList.rowposition, "NO_CONTRACT");

        	trace("sNO_CONTRACT", sNO_CONTRACT);
        	...
        	this.dsReport.addColumn("NO_CONTRACT", "string");
        	...
        	//this.dsReport.setColumn(0, "NO_CONTRACT", this.getOwnerFrame().NO_CONTRACT);
        	//this.dsReport.setColumn(0, "NO_CONTRACT", this.dsList.getColumn(0, "NO_CONTRACT"));
        	this.dsReport.setColumn(0, "NO_CONTRACT", sNO_CONTRACT);
        	...
        	if(sNO_CONTRACT == "01"){
        		...
        		var reportpath  = "/dr/drf/DRF_CONTRACT_KSBJ_OPT_REPORT.ozr";
        		...
        		//var inParam 	= "params=dsReport1";	// 조회SP이외 사용할 정보
        		var inParam 	= "";						// 필요없는 경우 생략
        		var inData      = "report=dsReport report2=dsReport";
        		var reportpath  = "/dr/drf/DRF_CONTRACT_KSBJ_OPT_REPORT2.ozr";
        ...
        this.loadIncludeScript("DRF_ITEMCONTRACT.xfdl");
