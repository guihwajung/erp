(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_BALCONY_MAGAMINFO_SELECT</Col></Row><Row><Col id=\"TARGET\">magam</Col><Col id=\"SP\">DRFPR_BALCONY_MAGAM</Col></Row><Row><Col id=\"TARGET\">magamCancel</Col><Col id=\"SP\">DRFPR_BALCONY_Magam_Cancel</Col></Row><Row><Col id=\"TARGET\">createSlip</Col><Col id=\"SP\">DRFPR_AUTOSLIP_ISSUE_BALCONY</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DRFPR_AUTOSLIP_ISSUE_CANCLE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRF_BALCONYMAGAMINFO.xfdl", function() {
        ...
        this.loadIncludeScript("DRF_BALCONYMAGAMINFO.xfdl");
