(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_ITEMCONTRACT_SELECT2</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DRFPR_CONTRACTOR_ITEM_AGREEMENT_SELECT2</Col></Row><Row><Col id=\"SP\">DRFPR_CONTRACTOR_ITEM_AGREEMENT_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"SP\">DRFPR_CONTRACTOR_ITEM_AGREEMENT_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DRFPR_CONTRACTOR_ITEM_AGREEMENT_DELETE</Col><Col id=\"TARGET\">delete</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"NO_DONG\" type=\"STRING\" size=\"256\"/><Column id=\"NO_FLOOR\" type=\"STRING\" size=\"256\"/><Column id=\"NO_HO\" type=\"STRING\" size=\"256\"/><Column id=\"NO_UNIONMEMBER\" type=\"STRING\" size=\"256\"/><Column id=\"NO_CONTRACT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_ACNTUNIT\"/><Col id=\"NO_DONG\"/><Col id=\"NO_FLOOR\"/><Col id=\"NO_HO\"/><Col id=\"NO_UNIONMEMBER\"/><Col id=\"NO_CONTRACT\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListInfo", this);
            obj._setContents("<ColumnInfo><Column id=\"AM_TOTSUP\" type=\"STRING\" size=\"256\"/><Column id=\"AM_TOTVAT\" type=\"STRING\" size=\"256\"/><Column id=\"AM_TOTAL\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"AM_TOTSUP\"/><Col id=\"AM_TOTVAT\"/><Col id=\"AM_TOTAL\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP01","ctxtNO_HO:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("계약번호");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtNO_CONTRACT","staCD_CORP01:0.0","10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_value("");
            obj.set_readonly("true");
            obj.set_maxlength("4");
            ...
            obj = new Div("divDataTop2","0","-1",null,"59","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("1");
            ...
            obj = new Grid("objGrid","0","70",null,null,"0","0",null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new BindItem("item5","divSearch.form.ctxtNO_CONTRACT","value","dsSearch","NO_CONTRACT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DRF_CONTRACTAGREE.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DRF_CONTRACTAGREE.xfdl");
