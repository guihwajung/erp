(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("옵션별 계약현황 조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_OPTION_CONT_SELECT</Col></Row><Row><Col id=\"TARGET\">selectSub</Col><Col id=\"SP\">DRFPR_OPTION_CONTLIST_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DRFPR_OPTION_NCONTLIST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divDataBottom","0","370",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Grid("objGridSub1","0","0",null,null,"0","0",null,null,null,null,this.divData.form.divDataBottom.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("1");
            obj._setContents("");
            this.divData.form.divDataBottom.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRF_OPTION_CONT.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DRF_OPTION_CONT.xfdl");
