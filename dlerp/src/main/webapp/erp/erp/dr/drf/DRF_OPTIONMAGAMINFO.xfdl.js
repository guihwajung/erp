(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("옵션수납마감(더존전표)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_OPTION_MAGAMINFO_SELECT_DT</Col></Row><Row><Col id=\"TARGET\">magam</Col><Col id=\"SP\">DRFPR_OPTION_MAGAM_DT</Col></Row><Row><Col id=\"TARGET\">magamCancel</Col><Col id=\"SP\">DRFPR_Option_Magam_Cancel</Col></Row><Row><Col id=\"TARGET\">createSlip</Col><Col id=\"SP\">DRFPR_AUTOSLIP_ISSUE_OPTION_DHAMC</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DRFPR_AUTOSLIP_ISSUE_CANCLE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRF_OPTIONMAGAMINFO.xfdl", function() {
        ...
        this.loadIncludeScript("DRF_OPTIONMAGAMINFO.xfdl");
