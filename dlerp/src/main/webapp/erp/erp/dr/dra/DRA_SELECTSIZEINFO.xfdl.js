(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRAPR_SELECT_SIZE_INFO</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRA_SELECTSIZEINFO.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRA_SELECTSIZEINFO");
        ...
        this.fnSelectValidate = function() {
        	...
        	if(this.gfnIsNull(this.dsSearch.getColumn(0, "CD_ACNTUNIT")))
        	{
        		...
        		this.gfnAlert("사업지코드를 입력해주세요.", "fnValidateCallback");
        ...
        this.loadIncludeScript("DRA_SELECTSIZEINFO.xfdl");
