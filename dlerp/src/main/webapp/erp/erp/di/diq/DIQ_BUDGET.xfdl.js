(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DIQPR_BUDGET_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DIQPR_BUDGET_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DIQPR_BUDGET_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DIQPR_BUDGET_DELETE</Col></Row><Row><Col id=\"TARGET\">select_excel</Col><Col id=\"SP\">DIQPR_BUDGET_SELECT_EXCEL</Col></Row><Row><Col id=\"TARGET\">exec_magam</Col><Col id=\"SP\">DIQPR_BUDGET_UPDATE_MAGAM</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_BUDGET\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SAUPBU\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"YN_GUBUN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYR_BUDGET","0","10.0","92","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("회계년도");
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYR_BUDGET","staYR_BUDGET:0.0","10.0","60","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_url("cmm::cmmCalYY.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_DEPT","ctclYR_BUDGET:0","10.0","92","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("귀속부서");
            obj.set_taborder("4");
            ...
            obj = new CheckBox("chkYN_GUBUN","ccfCD_DEPT:20","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("예산변경표시");
            obj.set_truevalue("Y");
            ...
            obj = new Static("staCD_SAUPBU","chkYN_GUBUN:0.0","10.0","79","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("사업부");
            obj.set_taborder("2");
            obj.set_visible("false");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Static("sta01",null,"10","131.0","24.0","10",null,null,null,null,null,this.divSearch.form);
            obj.set_text("(단위:천원)");
            ...
            obj = new Grid("objGridExcel","62","195","976","209",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_enable("true");
            obj.set_visible("false");
            ...
            obj = new BindItem("item1","divSearch.form.ccfCD_SAUPBU.form.CDTextBox","value","dsSearch","CD_SAUPBU");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item2","divSearch.form.chkYN_GUBUN","value","dsSearch","YN_GUBUN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DIQ_BUDGET.xfdl", function() {
        ...
        this.fnbtnMagam = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }

        	this.gfnConfirm("마감 하시겠습니까?", "fnConfirm_Confirm", "Y");
        }

        this.fnbtnMagamCancel = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }
        ...
        this.loadIncludeScript("DIQ_BUDGET.xfdl");
