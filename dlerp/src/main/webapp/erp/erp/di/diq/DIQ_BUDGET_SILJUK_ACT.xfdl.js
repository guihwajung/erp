(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("예산대비실적조회(세목)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DIQPR_BUDGET_SILJUK_ACT_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YM_BUDGET\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SAUPBU\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ACTIVE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ACCOUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YM_BUDGET\"/><Col id=\"CD_SAUPBU\"/><Col id=\"TY_GUBUN\"/><Col id=\"CD_DEPT\"/><Col id=\"CD_ACTIVE\"/><Col id=\"DS_DEPT\"/><Col id=\"CD_ACCOUNT\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_GUBUN","ctclYM_BUDGET:0.0","10.0","66","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("구분");
            obj.set_taborder("2");
            ...
            obj = new Static("staCD_DEPT","ccboTY_GUBUN:0.0","10.0","92","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("귀속부서");
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj.getSetter("CodeFindName").set("DIX_SILJUK_ACCOUNT");
            obj.getSetter("CDTextWidth").set("80");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_taborder("7");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj.getSetter("CodeFindName").set("DIX_SILJUK_ACTIVE_2");
            obj.getSetter("CDTextWidth").set("80");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_taborder("9");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staUNIT","ccfCD_ACTIVE:0.0","10.0","131.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("(단위:천원)");
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Grid("objGrid","11","3",null,null,"-11","-3",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj._setContents("");
            ...
            obj = new BindItem("item3","divSearch.form.ccfCD_ACTIVE.form.CDTextBox","value","dsSearch","CD_ACTIVE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DIQ_BUDGET_SILJUK_ACT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DI", "DIQ_BUDGET_SILJUK_ACK");
        ...
        this.fnColor = function()
        {
        	...
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "BACK_KuBun", "DS_ACCOUNT == '소계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "BACK_SoKe", "DS_ACCOUNT_M == '중계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "BACK_Sum", "DS_ACTIVE == '합계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "BACK_ReadOnly", "YN_COLOR == 'Y'", true);
        ...
        this.fnSiljukPopup = function(column)
        {
        	...
        	if(nexacro.toNumber(MONTH) <= 12 && CD_GUBUN == "실적"){
        		if(DS_ACCOUNT == "소계" || DS_ACCOUNT_M == "중계" || DS_ACTIVE == "합계"){
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.staTY_GUBUN.addEventHandler("onclick",this.staCD_SAUPBU00_onclick,this);
            this.divSearch.form.ccboTY_GUBUN.addEventHandler("onitemchanged",this.fnSearchInit,this);
            this.divData.form.objGrid.addEventHandler("oncelldblclick",this.divData_objGrid_oncelldblclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DIQ_BUDGET_SILJUK_ACT.xfdl");
