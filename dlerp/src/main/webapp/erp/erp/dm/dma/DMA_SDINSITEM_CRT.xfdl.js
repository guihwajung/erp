(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(375,280);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DMAPR_SDINSITEM_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsDetail", this);
            obj._setContents("<ColumnInfo><Column id=\"YN_KOR\" type=\"STRING\" size=\"256\"/><Column id=\"YM_SDINS\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"AM_STANDARD\" type=\"STRING\" size=\"256\"/><Column id=\"AM_SALE\" type=\"STRING\" size=\"256\"/><Column id=\"RM_BIGO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsRequired", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_FIELD\" type=\"STRING\" size=\"256\"/><Column id=\"DS_FIELD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_FIELD\">YN_KOR</Col><Col id=\"DS_FIELD\">국산여부</Col></Row><Row><Col id=\"CD_FIELD\">YM_SDINS</Col><Col id=\"DS_FIELD\">기준년월</Col></Row><Row><Col id=\"CD_FIELD\">CD_SITE</Col><Col id=\"DS_FIELD\">현장코드</Col></Row><Row><Col id=\"CD_FIELD\">CD_VENDOR</Col><Col id=\"DS_FIELD\">업체코드</Col></Row><Row><Col id=\"CD_FIELD\">AM_STANDARD</Col><Col id=\"DS_FIELD\">기준가</Col></Row><Row><Col id=\"CD_FIELD\">AM_SALE</Col><Col id=\"DS_FIELD\">할인금액</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_SITE","0","58","80","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("현장코드");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staCD_VENDOR","0","87","80","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_text("업체코드");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staAM_STANDARD","0","116","80","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            obj.set_text("기준가");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staBg3","79","58","291","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBg4","79","87","291","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBg5","79","116","291","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staAM_SALE","0","145","80","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_text("할인금액");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staRM_BIGO","0","174","80","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            obj.set_text("비고");
            ...
            obj = new Static("staBg01","79","145","291","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("18");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBg02","79","174","291","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("20");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnSave","31.73%","239","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_text("단가생성");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancel","51.73%","239","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_text("닫기");
            this.divData.addChild(obj.name, obj);

            obj = new Div("ccfCD_SITE","84","63","282","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Div("ccfCD_VENDOR","84","92","282","20",null,null,null,null,null,null,this.divData.form);
            obj.getSetter("CDTextWidth").set("80");
            ...
            obj = new Edit("ctxtRM_BIGO","84","180","282","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_value("");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("ctxtAM_STANDARD","84","121","96","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("21");
            obj.set_value("");
            obj.set_textAlign("right");
            obj.set_format("#,0");
            ...
            obj = new MaskEdit("ctxtAM_SALE","84","150","96","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("22");
            obj.set_value("");
            obj.set_textAlign("right");
            obj.set_format("#,0");
            ...
            obj = new BindItem("item","divData.form.ccfCD_SITE.form.CDTextBox","value","dsDetail","CD_SITE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divData.form.ccfCD_VENDOR.form.CDTextBox","value","dsDetail","CD_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DMA_SDINSITEM_CRT.xfdl", function() {
        ...
        */
        ...
        this.fnSaveDsDetail = function(svcId, val){
        	if(val){
        		...
        		this.dsInsert.setColumn(nrow, "CD_SITE", this.dsDetail.getColumn(0, "CD_SITE"));
        		this.dsInsert.setColumn(nrow, "CD_VENDOR", this.dsDetail.getColumn(0, "CD_VENDOR"));
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.ccfCD_VENDOR.addEventHandler("onclick",this.Common_onclick,this);
            this.dsDetail.addEventHandler("onvaluechanged",this.dsData_onvaluechanged,this);
        };
        this.loadIncludeScript("DMA_SDINSITEM_CRT.xfdl");
