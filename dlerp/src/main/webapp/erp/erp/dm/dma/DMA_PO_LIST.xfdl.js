(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMAPR_PO_LIST_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">req_ok</Col><Col id=\"SP\">DMAPR_PO_REQUEST</Col></Row><Row><Col id=\"TARGET\">req_cancel</Col><Col id=\"SP\">DMAPR_PO_REQUEST_CANCEL</Col></Row><Row><Col id=\"TARGET\">approve_ok</Col><Col id=\"SP\">DMAPR_PO_APPROVE</Col></Row><Row><Col id=\"TARGET\">approve_cancel</Col><Col id=\"SP\">DMAPR_PO_APPROVE_CANCEL</Col></Row><Row><Col id=\"TARGET\">contagree</Col><Col id=\"SP\">DMAPR_PO_APPROVE_CONTAGREE</Col></Row><Row><Col id=\"TARGET\">select_dam</Col><Col id=\"SP\">DMZPR_ID_DAMCODE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staID_DAM","ctclDT_TO:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("품목담당자");
            ...
            obj = new Static("staTY_SELECT","ccboID_DAM:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("구매구분");
            obj.set_visible("false");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboTY_SELECT","staTY_SELECT:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            ...
            obj = new Static("staYN_APPROVE","ctclDT_TO:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DMA_PO_LIST.xfdl", function() {
        ...
        this.loadIncludeScript("DMA_PO_LIST.xfdl");
