(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMAPR_SDINSDATE_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DMAPR_SDINSDATE_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DMA_SDINSDATE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMA_SDINSDATE");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("YM_SDINS", "string");
        ...
        this.fnAdd = function() {
        	...
        	this.dsList.setColumn(nrow,"YM_SDINS",this.dsSearch.getColumn(0,"YM_WORK"));
        }
        ...
        this.fnSave = function() {
        	...
        	for(var i = 0; i < rowCnt; i++) {
        		...
        		this.dsSave.setColumn(nRow,"TY_WRK", 	this.gfnGetFlag(this.dsList, i));
        		this.dsSave.setColumn(nRow,"YM_SDINS", 	this.dsList.getColumn(i,"YM_SDINS"));
        ...
        this.fnSelectValidate = function() {
        	...
        	if(this.gfnIsNull(this.dsSearch.getColumn(0,"YM_WORK"))) {
        		this.gfnAlert("조회 할 기준년월을 입력하세요!");
        		validate = false;
        	};
        ...
        this.loadIncludeScript("DMA_SDINSDATE.xfdl");
