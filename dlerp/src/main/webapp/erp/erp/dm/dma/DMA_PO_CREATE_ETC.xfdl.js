(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMAPR_CREATE_PO_PR_MASTER_SELECT</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DMAPR_CREATE_PO_PR_DETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DMAPR_CREATE_PO_MASTER_SELECT</Col></Row><Row><Col id=\"TARGET\">d_insert</Col><Col id=\"SP\">DMAPR_CREATE_PO_MASTER_INSERT</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DMAPR_CREATE_PO_MASTER_UPDATE</Col></Row><Row><Col id=\"TARGET\">d_delete</Col><Col id=\"SP\">DMAPR_CREATE_PO_MASTER_DELETE</Col></Row><Row><Col id=\"TARGET\">d1_select</Col><Col id=\"SP\">DMAPR_CREATE_PO_DETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">d1_insert</Col><Col id=\"SP\">DMAPR_CREATE_PO_DETAIL_INSERT</Col></Row><Row><Col id=\"TARGET\">d1_update</Col><Col id=\"SP\">DMAPR_CREATE_PO_DETAIL_UPDATE</Col></Row><Row><Col id=\"TARGET\">d1_delete</Col><Col id=\"SP\">DMAPR_CREATE_PO_DETAIL_DELETE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_BID\" type=\"STRING\" size=\"256\"/><Column id=\"ID_DAM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_ORDER_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_ORDER_TO\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE_SUB\" type=\"STRING\" size=\"256\"/><Column id=\"NO_PO\" type=\"STRING\" size=\"256\"/><Column id=\"ID_DAM_SUB\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"NO_BID\"/><Col id=\"ID_DAM\"/><Col id=\"DT_ORDER_FR\"/><Col id=\"DT_ORDER_TO\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_BID","ccfCD_SITE:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form.divSearchLeft.form);
            obj.set_taborder("2");
            obj.set_text("입찰번호");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.form.divSearchLeft.addChild(obj.name, obj);

            obj = new Div("ccfNO_BID","staNO_BID:0.0","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form.divSearchLeft.form);
            ...
            obj = new Static("staID_DAM","0.0","staCD_SITE:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form.divSearchLeft.form);
            obj.set_taborder("4");
            obj.set_text("담당자");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.form.divSearchLeft.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_ORDER","ccboID_DAM:0.0","staCD_SITE:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form.divSearchLeft.form);
            obj.set_taborder("6");
            obj.set_text("발주요청일");
            ...
            obj = new Static("staID_DAM","ctxtNO_BID:0.0","staCD_SITE_SUB:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form.divSearchRight.form);
            obj.set_taborder("4");
            obj.set_text("담당자");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.form.divSearchRight.addChild(obj.name, obj);

            obj = new Combo("ccboID_DAM","staID_DAM:0.0","ccfCD_SITE_SUB:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form.divSearchRight.form);
            obj.set_taborder("5");
            obj.set_innerdataset("dsID_DAM");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new BindItem("item7","divSearch.form.divSearchRight.form.ccboID_DAM","value","dsSearch","ID_DAM_SUB");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.divSearchLeft.form.ccfNO_BID.form.CDTextBox","value","dsSearch","NO_BID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DMA_PO_CREATE_ETC.xfdl", function() {
        ...
        // 	this.ccfNO_PR.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMA_PO_CREATE_ETC_PR_MASTER");
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DM", "DMA_PO_CREATE_ETC_PR_DETAIL");
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DM", "DMA_PO_CREATE_ETC_PO_MASTER");
        	this.gfnGridInit(this.dxGridSub1, this.dsListSub1, "DM", "DMA_PO_CREATE_ETC_PO_DETAIL");
        ...
        this.dsSelectSub = new Dataset();
        	...
        	this.dsSelectSub.addColumn("TY_SELECT", "string");
        ...
        this.fnSelectSub = function() {
        	...
        	this.dsSelectSub.setColumn(0, "TY_SELECT", "");
        	...
        	for (var i = 0; i < this.dsListSub.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				this.dsUpdateSub.setColumn(nrow, "CD_SITE", this.dsList.getColumn(i, "CD_SITE"));
        				this.dsUpdateSub.setColumn(nrow, "NO_BID", this.dsList.getColumn(i, "NO_BID"));
        				this.dsUpdateSub.setColumn(nrow, "NO_CONT", this.dsList.getColumn(i, "NO_CONT"));
        				this.dsUpdateSub.setColumn(nrow, "DS_SUBCON", this.dsList.getColumn(i, "DS_SUBCON"));
        				this.dsUpdateSub.setColumn(nrow, "CD_VENDOR", this.dsList.getColumn(i, "CD_VENDOR"));
        				this.dsUpdateSub.setColumn(nrow, "CD_LICCOST", this.dsList.getColumn(i, "CD_LICCOST"));
        				this.dsUpdateSub.setColumn(nrow, "CD_PAYMENT", this.dsList.getColumn(i, "CD_PAYMENT"));
        				this.dsUpdateSub.setColumn(nrow, "CD_DELIVERY", this.dsList.getColumn(i, "CD_DELIVERY"));
        				this.dsUpdateSub.setColumn(nrow, "CD_ORDER", this.dsList.getColumn(i, "CD_ORDER"));
        				this.dsUpdateSub.setColumn(nrow, "CD_PAY_CONDITION", this.dsList.getColumn(i, "CD_PAY_CONDITION"));
        				this.dsUpdateSub.setColumn(nrow, "CD_QUALITY", this.dsList.getColumn(i, "CD_QUALITY"));
        				this.dsUpdateSub.setColumn(nrow, "CD_PACKING", this.dsList.getColumn(i, "CD_PACKING"));
        				this.dsUpdateSub.setColumn(nrow, "CD_INCREASE", this.dsList.getColumn(i, "CD_INCREASE"));
        				this.dsUpdateSub.setColumn(nrow, "CD_H02", this.dsList.getColumn(i, "CD_H02"));
        				this.dsUpdateSub.setColumn(nrow, "TY_SELECT", this.dsList.getColumn(i, "TY_SELECT"));
        				this.dsUpdateSub.setColumn(nrow, "ID_DAM", this.dsList.getColumn(i, "ID_DAM"));
        				break;
        			case "D":
        ...
        */
        this.fnSelectSub1 = function() {
        	...
        	this.dsSelectSub1.setColumn(0, "CD_SITE", this.dsListSub.getColumn(this.dsListSub.rowposition, "CD_SITE"));
        ...
        this.divData_btnRight_onclick = function(obj,e)
        {
        	...
        	for(var i = 0; i < rows.length; i++)
        	{
        		...
        		this.dsListSub1.setColumn(listRow, "QN_TT_HADO", this.dsList1.getColumn(nrow, "QN_TT_ORDER_PRE"));
        ...
        this.loadIncludeScript("DMA_PO_CREATE_ETC.xfdl");
