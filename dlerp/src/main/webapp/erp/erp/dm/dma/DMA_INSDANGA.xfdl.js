(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMAPR_INSDANGA_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DMAPR_INSDANGA_SAVE</Col></Row><Row><Col id=\"TARGET\">save1</Col><Col id=\"SP\">DMAPR_INSDANGA_COPY</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_INS\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YY_WORK\"/><Col id=\"YM_WORK\"/><Col id=\"DT_WORK\"/><Col id=\"CD_INS\"/><Col id=\"CD_VENDOR\"/><Col id=\"CD_SITE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfSite","sta02:0.0","10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staYM_WORK","ccfSite:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("작업년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item3","divSearch.form.ccfSite.form.CDTextBox","value","dsSearch","CD_SITE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DMA_INSDANGA.xfdl", function() {
        ...
        this.DWA_SILHENG_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_SITE)) {
        		...
        		this.divSearch.form.ccfSite.form.DSTextBox.set_value(this.getOwnerFrame().DS_SITE);

        		this.divSearch.form.ccfSite.form.fnFitToContents();
        	}
        ...
        this.fnSetEvent = function() {
        	this.ccfSite.CodeFindName = "DMX_CFSITE2";
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMA_INSDANGA");
        ...
        this.fnSetParameter = function() {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_INS)){
        		this.ccfSite.form.CDTextBox.set_value(this.getOwnerFrame().CD_SITE);
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "select") {
        		...
        		if(errorCode == 0) {
        			...
        			this.gfnAlert("계약단가정보생성을 정상처리하였습니다..", "fnCallbackCreate_callback");
        		}
        		else
        		{
        			this.gfnAlert(errorMsg);
        ...
        this.fnCreate = function(obj, e){
        	...
        	this.gfnConfirm("계약단가정보를 생성하시겠습니까?", "fnCreate_callback");
        };
        ...
        this.fnCreate_callback = function(strId, val){
        	...
        	this.dsSave1.setColumn(0, "CD_SITE", this.ccfSite.form.CDTextBox.value);
        ...
        this.loadIncludeScript("DMA_INSDANGA.xfdl");
