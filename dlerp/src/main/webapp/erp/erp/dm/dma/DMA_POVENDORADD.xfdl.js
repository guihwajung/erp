(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMAPR_POVENDORADD_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DMAPR_POVENDORADD_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DMAPR_POVENDORADD_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DMAPR_POVENDORADD_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"NO_CONT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SUBCON\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SEQ\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"NO_CONT\"/><Col id=\"DS_SUBCON\"/><Col id=\"SN_SEQ\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("txtSN_SEQ","sta02:0.0","10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new BindItem("item0","divSearch.form.txtSN_SEQ","value","dsSearch","SN_SEQ");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DMA_POVENDORADD.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	if(!this.gfnIsNull(this.getOwnerFrame().YN_PO) && this.getOwnerFrame().YN_PO == "Y") {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMA_POVENDORADD_PO");
        	} else {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMA_POVENDORADD");
        	}
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("YN_NEEDSIGN", "string");
        	...
        	this.dsUpdate.addColumn("YN_NEEDSIGN", "string");
        ...
        this.fnSave = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "YN_NEEDSIGN", this.dsList.getColumn(i, "YN_NEEDSIGN"));
        				this.dsInsert.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);

        				sum += this.dsList.getColumn(i, "RT_DIVIDE");
        				break;
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "YN_NEEDSIGN", this.dsList.getColumn(i, "YN_NEEDSIGN"));
        	...
        	if(sum > 100) {
        		this.gfnAlert("분배율의 합은 100%를 넘을 수 없습니다.");
        		return;
        	}
        ...
        this.loadIncludeScript("DMA_POVENDORADD.xfdl");
