(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select0</Col><Col id=\"SP\">DMBPR_CMS_INVOITEM_SELECT</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMBPR_INVOBAS_SELECT </Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DMBPR_INVOMST_SAVE</Col></Row><Row><Col id=\"TARGET\">savedtl</Col><Col id=\"SP\">DMBPR_InvoDtl_Save</Col></Row><Row><Col id=\"TARGET\">confirm</Col><Col id=\"SP\">DMBPR_InvoStk_Act</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"NO_INVOICE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"BiGo\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"NO_INVOICE\"/><Col id=\"CD_SITE\"/><Col id=\"DT_WORK\"/><Col id=\"BiGo\"/></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DMB_INVOICEMCPS.xfdl", function() {
        ...
        this.loadIncludeScript("DMB_INVOICEMCPS.xfdl");
