(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMBPR_TM_STOCK_TRANS_SELECT</Col></Row><Row><Col id=\"TARGET\">confirm</Col><Col id=\"SP\">DMBPR_TM_STOCK_TRANS_CONFIRM</Col></Row><Row><Col id=\"TARGET\">selectSub</Col><Col id=\"SP\">DMBPR_TM_STOCK_TRANS_ITEM_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("objGrid","0","0",null,null,"0","51%",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_treeinitstatus("collapse,all");
            obj._setContents("");
            this.divData.addChild(obj.name, obj);

            obj = new Grid("objGridSub","0","51%",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj._setContents("");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DMB_TM_STOCK_TRANS_CONFIRM.xfdl", function() {
        ...
        this.loadIncludeScript("DMB_TM_STOCK_TRANS_CONFIRM.xfdl");
