(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUERESULT_QCS_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DCDPR_EVALUERESULT_QCS_SAVE</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DCDPR_EVALUERESULT_QCS_CREATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCDPR_EVALUERESULT_QCS_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ctclYEAR","staYY_WORK:0.0","10.0","59","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_url("cmm::cmmCalYY.xfdl");
            obj.set_formscrolltype("both");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclDT_GISUNG_FR","ctclYEAR:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staDT_WORK00","ctclDT_GISUNG_FR:0.0","10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("~");
            ...
            obj = new Static("staDT_WORK","ctclYEAR:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("기성기간");
            ...
            obj = new BindItem("item0","divSearch.form.ctclYEAR.form.TextBox","value","dsSearch","YEAR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DMD_EVALUERESULT_QCS.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMD_EVALUERESULT_QCS");
        };
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "MODULE", "DM");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				this.dsSave.setColumn(nrow, "MODULE", "DM");
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "MODULE", "DM");
        ...
        */
        ...
        this.fnCreate_Confirm = function(strId, val) {
        	if(val == true) {
        		...
        		this.dsExec.setColumn(0, "MODULE", "DM");
        ...
        */
        ...
        this.loadIncludeScript("DMD_EVALUERESULT_QCS.xfdl");
