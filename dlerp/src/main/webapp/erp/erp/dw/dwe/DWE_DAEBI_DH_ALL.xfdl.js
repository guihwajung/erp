(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("원가월별 CHECK LIST");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWEPR_DAEBI_ALL_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWE_DAEBI_DH_ALL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWE_DAEBI_DH_ALL");
        ...
        this.fnCompare = function(){
        	...
        	param.YM_WORK = this.dsList.getColumn(this.dsList.rowposition, "YM_WORK");
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DWE_DAEBI_DH", "", param);
        }
        ...
        this.loadIncludeScript("DWE_DAEBI_DH_ALL.xfdl");
