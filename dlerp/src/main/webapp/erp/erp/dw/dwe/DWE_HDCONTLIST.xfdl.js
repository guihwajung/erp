(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YY_WORK\"/><Col id=\"YM_WORK\"/><Col id=\"DT_WORK\"/><Col id=\"CD_SITE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_SITE","staCD_SITE:0.0","10.0","250","24.0",null,null,null,"120",null,null,this.divSearch.form);
        ...
        // User Script
        this.registerScript("DWE_HDCONTLIST.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	// ---------------------------//
        	   ...
        	   if(!this.gfnIsNull(this.FormInfo.DS_PARAM)) {
        		var param = this.gfnArgsToJson(this.FormInfo.DS_PARAM);
        		this.ID_GRID = param.GID;
        		this._dsProc.setColumn(0, "SP", param.SP);
        	}
        	this.fnSetButton();
        ...
        this.fnSetEvent = function() {
            ...
            this.gfnGridInit(this.dxGrid, this.dsList, "DW", this.ID_GRID);
        ...
        this.loadIncludeScript("DWE_HDCONTLIST.xfdl");
