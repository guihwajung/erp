(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">init</Col><Col id=\"SP\">DZRPR_APPROVAL_INIT</Col></Row><Row><Col id=\"TARGET\">selectmaster</Col><Col id=\"SP\">DZRPR_APPROVAL_MASTER_SELECT</Col></Row><Row><Col id=\"TARGET\">savemaster</Col><Col id=\"SP\">DZRPR_APPROVAL_MASTER_SAVE</Col></Row><Row><Col id=\"TARGET\">line1</Col><Col id=\"SP\">DZRPR_APPROVAL_LINE_SELECT</Col></Row><Row><Col id=\"TARGET\">line2</Col><Col id=\"SP\">DZRPR_APPROVAL_LINE_SELECT</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DZRPR_APPROVAL_EXECUTE</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_SITEBUDGET_SELECT_APPROVAL</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DWAPR_SILHENGREGEXCELVT_SELECT_APPROVAL</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"ID_AP\" type=\"STRING\" size=\"256\"/><Column id=\"ID_AP_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"V1\" type=\"STRING\" size=\"256\"/><Column id=\"V2\" type=\"STRING\" size=\"256\"/><Column id=\"V3\" type=\"STRING\" size=\"256\"/><Column id=\"V4\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ETITLE\" type=\"STRING\" size=\"256\"/><Column id=\"YN_QNITEM\" type=\"STRING\" size=\"256\"/><Column id=\"TY_COST\" type=\"STRING\" size=\"256\"/><Column id=\"CD_RP\" type=\"STRING\" size=\"256\"/><Column id=\"YN_CHANGE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"ID_AP\"/><Col id=\"ID_AP_TYPE\"/><Col id=\"V1\"/><Col id=\"V2\"/><Col id=\"V3\"/><Col id=\"V4\"/><Col id=\"DS_ETITLE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("objGrid","0","35",null,"130","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Grid("objGrid1","0","202",null,null,"0","0",null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("1");
            obj._setContents("");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staTITLE00","0","objGrid:10",null,"22","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("2");
            obj.set_text("상세내역");
        ...
        // User Script
        this.registerScript("DWA_SILHENG_APPROVAL.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DW12";
        this.FlagGb = "";	// 저장 플래그값
        ...
        this.fnSetVariable = function() {
        	...
        	this.dxGrid1 = this.divData1.form.divDataInfo.form.objGrid1;
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWA_SITEBUDGET_APP");
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DW", "DWA_SILHENGREGEXCELVT_APP", "DS_COST", "GR_COST");
        ...
        this.fnSetParameter = function() {
        	...
        	**************************************************************************************************/
        	...
        	this.dsSelect1.addColumn("NO_SILHENG", "string");
        	this.dsSelect1.addColumn("YN_CHANGE", "string");
        	this.dsSelect1.addColumn("YN_QNITEM", "string");
        	this.dsSelect1.addColumn("TY_COST", "string");
        	this.dsSelect1.addColumn("CD_RP", "string");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_SITE", this.dsSearch.getColumn(0, "V1"));
        	this.dsSelect.setColumn(0, "NO_SILHENG", this.dsSearch.getColumn(0, "V2"));

        	this.dsSelect1.clearData();
        	this.dsSelect1.addRow();

        	this.dsSelect1.setColumn(0, "CD_SITE", this.dsSearch.getColumn(0, "V1"));
        	this.dsSelect1.setColumn(0, "NO_SILHENG", this.dsSearch.getColumn(0, "V2"));
        	this.dsSelect1.setColumn(0, "YN_QNITEM", "");
        	this.dsSelect1.setColumn(0, "TY_COST", "");
        	this.dsSelect1.setColumn(0, "CD_RP", this.dsSearch.getColumn(0, "CD_RP"));

        	if(this.dsSearch.getColumn(0, "YN_CHANGE") == "N") {
        		this.dsSelect1.setColumn(0, "YN_CHANGE", "");
        	}else{
        		this.dsSelect1.setColumn(0, "YN_CHANGE", this.dsSearch.getColumn(0, "YN_CHANGE"));
        	}
        	...
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
         	var inData      = "select=dsSelect select1=dsSelect1";	// select1=dsSelect1
         	var outData     = "dsList=select0 dsList1=select10";		// dsList1=select10
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData1.form.divDataInfo.form.staTITLE00.addEventHandler("onclick",this.divData1_divDataInfo_staTITLE00_onclick,this);
            this.dsListEtc.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
        };
        this.loadIncludeScript("DWA_SILHENG_APPROVAL.xfdl");
