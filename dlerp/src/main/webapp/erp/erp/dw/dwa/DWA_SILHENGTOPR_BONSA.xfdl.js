(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_SILHENGTOPR_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWAPR_SILHENGTOPR_SAVE_BONSA</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_PR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_PR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_RP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_PR","ccfCD_SITE:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("구매요청번호");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfNO_PR","staNO_PR:0.0","10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staCD_RP","ccfNO_PR:0.0","staCD_SITE:10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Div("ccfCD_RP","staCD_RP:0.0","staCD_SITE:10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new CheckBox("chkYN_DOKUB","ccfCD_RP:0.0","10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("도급");
            obj.set_truevalue("Y");
            ...
            obj = new CheckBox("chkYN_TOP","chkYN_DOKUB:0.0","10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("상하");
            obj.set_value("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Div("divDataLeft","0","0",null,null,"divSplitter:0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Button("btnSend_Right",null,"40%","30","30","divSplitter:0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("▶");
            ...
            obj = new Button("btnSend_Left",null,"60%","30","30","divSplitter:0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("◀");
            obj.set_verticalAlign("middle");
            obj.set_textAlign("center");
            ...
            obj = new BindItem("item4","divSearch.form.ccfNO_PR.form.DSTextBox","value","dsSearch","DS_PR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWA_SILHENGTOPR_BONSA.xfdl", function() {
        this.objApp = this.gfnGetApplication();
        this._SPLITTER_ID = "splitterTop";
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.divSearch_chkYN_TOP_onchanged(this.divSearch.form.chkYN_TOP, {postvalue:this.divSearch.form.chkYN_TOP.value});
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("AM_IND", "bigdecimal");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_HADOCONT", this.dsSearch.getColumn(0, "NO_PR"));
        	...
        	for (var i = 0; i < this.dsListSub.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "AM_IND", this.dsListSub.getColumn(i, "AM_IND"));
        ...
        */
        this.fnExec = function() {
        	...
        	this.dsExec.setColumn(nrow, "NO_HADOCONT", this.dsSearch.getColumn(0, "NO_PR"));
        ...
        {
        	if(e.userdata == "splitterTop") {
        		this.divData.form.divSplitter.set_top(e.clienty);
        		this.divData.form.resetScroll();
        	}
        	else if(e.userdata == "splitterLeft") {
        ...
        {
        	e.set_userdata(this._SPLITTER_ID);
        	return true;
        };
        ...
        this.divData_btnSend_Right_onclick = function(obj,e)
        {
        	...
        	for(var i = 0; i < rows.length; i++)
        	{
        		...
        		// 2020.05.22 단가가 0인 실행은 입력 pass
        		// if( this.gfnNvl(this.dsList.getColumn(nrow,"UP_TT_SILHENG"), 0) == 0) continue;
        ...
        this.dsListSub_oncolumnchanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue){
        		if(e.columnid == "AM_TT_DOKUB"){
        			...
        			// 2020.05.11 예산 수량, 금액(식인경우) 변경 시 하도, 도급에 반영
        			// -------------------------------------------------------------------------------------------------
        			...
        			var QN_TT_DOKUB = nexacro.toNumber(this.dsListSub.getColumn(e.row, "QN_TT_DOKUB"),0);
        			var UP_TT_DOKUB = nexacro.toNumber(this.dsListSub.getColumn(e.row, "UP_TT_DOKUB"),0);
        			this.dsListSub.setColumn(e.row, "AM_TT_DOKUB", nexacro.toNumber((QN_TT_DOKUB * UP_TT_DOKUB).toFixed(0)),0);
        			// -------------------------------------------------------------------------------------------------
        ...
        // 상하 체크박스 변경 이벤트.
        this.divSearch_chkYN_TOP_onchanged = function(obj,e)
        {
        	if(e.prevalue != e.postvalue)
        	{
        		if(e.postvalue == true)
        		{
        			this.divData.form.btnSend_Left.set_text("▲");
        			this.divData.form.btnSend_Right.set_text("▼");
        			this.divData.form.btnSend_Left.set_left("40%");
        			this.divData.form.btnSend_Right.set_left("60%");
        			this.divData.form.btnSend_Left.set_top("divSplitter:1");
        			this.divData.form.btnSend_Right.set_top("divSplitter:1");
        			this.divData.form.divSplitter.set_width("100%");
        			this.divData.form.divSplitter.set_height(5);
        			this.divData.form.divSplitter.set_top("50%");
        			this.divData.form.divSplitter.set_left(0);
        			this.divData.form.divDataLeft.set_right(0);
        			this.divData.form.divDataRight.set_right(0);
        			this.divData.form.divDataLeft.set_left(0);
        			this.divData.form.divDataRight.set_left(0);
        			this.divData.form.divDataLeft.set_top(0);
        			this.divData.form.divDataRight.set_top("divSplitter:5");
        			this.divData.form.divDataLeft.set_bottom("divSplitter:5");
        			this.divData.form.divSplitter.set_cursor("ns-resize");
        			this.divData.form.divDataRight.set_bottom(0);
        			this._SPLITTER_ID = "splitterTop";
        		}
        		else
        		{
        			this.divData.form.btnSend_Left.set_text("◀");
        			this.divData.form.btnSend_Right.set_text("▶");
        			this.divData.form.btnSend_Left.set_left("divSplitter:1");
        			this.divData.form.btnSend_Right.set_left("divSplitter:1");
        			this.divData.form.btnSend_Left.set_top("60%");
        			this.divData.form.btnSend_Right.set_top("40%");
        			this.divData.form.divSplitter.set_width(5);
        			this.divData.form.divSplitter.set_height("100%");
        			this.divData.form.divSplitter.set_top(0);
        			this.divData.form.divSplitter.set_left("50%");
        			this.divData.form.divDataLeft.set_right("divSplitter:5");
        			this.divData.form.divDataRight.set_right(0);
        			this.divData.form.divDataLeft.set_left(0);
        			this.divData.form.divDataRight.set_left("divSplitter:35");
        			this.divData.form.divDataLeft.set_top(0);
        			this.divData.form.divDataRight.set_top(0);
        			this.divData.form.divDataLeft.set_bottom(0);
        			this.divData.form.divDataRight.set_right(0);
        			this.divData.form.divSplitter.set_cursor("ew-resize");
        			this._SPLITTER_ID = "splitterLeft";
        		}
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.chkYN_TOP.addEventHandler("onchanged",this.divSearch_chkYN_TOP_onchanged,this);
        ...
        this.loadIncludeScript("DWA_SILHENGTOPR_BONSA.xfdl");
