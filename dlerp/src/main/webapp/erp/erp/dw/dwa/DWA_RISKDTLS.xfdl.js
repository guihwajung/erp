(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_RISKDTLSTREE_SELECT</Col></Row><Row><Col id=\"TARGET\">selectSub</Col><Col id=\"SP\">DWAPR_RISKDTLS_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWAPR_RISKDTLS_SAVE</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DWAPR_RISKDTLS_EXECUTE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_HADOCONT","ccfNO_RISK:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("계약번호");
            ...
            obj = new CheckBox("cchkYN_Pre","ccfNO_HADOCONT:0.0","10.0","60","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("변경전");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWA_RISKDTLS.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btn2 = this.gfnFormButtonAdd("btnExcelDownload", "fnExcelDownload");
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWA_RISKDTLSTREE","DS_ITEM","GR_COST");

        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DW", "DWA_RISKDTLS");
        	// 셀 변경 후 이벤트
        ...
        // 	}
        	...
        	else if(id == "ccfNO_HADOCONT")
        	{
        		...
        		{
        			this.gfnAlert("리스크번호를 먼저 입력해주세요.");
        			return false;
        		}
        ...
        this.divSearch_cchkYN_Pre_onchanged = function(obj,e)
        {
        	...
        	if(obj.isChecked()) {
        		...
        		this.dxGridSub.setRealColSize("body", QN_HADO_PRE_Index, 70);
        		this.dxGridSub.setRealColSize("body", UP_HADO_PRE_Index, 80);
        		this.dxGridSub.setRealColSize("body", AM_HADO_PRE_Index, 100);
        	}
        	else
        	{
        ...
        this.loadIncludeScript("DWA_RISKDTLS.xfdl");
