(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_SILHENGSORTTREE_SELECT</Col></Row><Row><Col id=\"TARGET\">selectSub</Col><Col id=\"SP\">DWAPR_SILHENGSORT_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWAPR_SILHENGSORT_SAVE</Col></Row><Row><Col id=\"TARGET\">status</Col><Col id=\"SP\">DWAPR_SILHENG_CHANGE_STATUS</Col></Row><Row><Col id=\"SP\">DWAPR_NO_SORT_SIBLING_ALL_SAVE</Col><Col id=\"TARGET\">sort</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SILHENG\" type=\"STRING\" size=\"256\"/><Column id=\"YN_AMT\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_REQ\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YN_AMT\">N</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsStatusResult", this);
            obj._setContents("<ColumnInfo><Column id=\"SILHENG_STATUS\" type=\"STRING\" size=\"256\"/><Column id=\"EP_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divDataRight","divSplitter:50","0",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Button("btnUp","divDataLeft:15","34.74%","30","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("▲");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnDown","divDataLeft:15","54.59%","30","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("▼");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DWA_SILHENGSORT.xfdl", function() {
        ...
        this.divData_btnUp_onclick = function(obj,e)
        {
        ...
        this.divData_btnDown_onclick = function(obj,e)
        {
        // 	if(this.insertYn == "Y"){
        // 		this.gfnAlert("신규 공종이 있을 경우 위치이동이 불가합니다.", "");
        // 		return false;
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.btnUp.addEventHandler("onclick",this.divData_btnUp_onclick,this);
            this.divData.form.btnDown.addEventHandler("onclick",this.divData_btnDown_onclick,this);
            this.dsListSub.addEventHandler("onvaluechanged",this.dsListSub_onvaluechanged,this);
        };
        this.loadIncludeScript("DWA_SILHENGSORT.xfdl");
