(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_SILHENG_MODIFY_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWAPR_SILHENG_MODIFY_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"YN_ERROR\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"YN_ERROR\">Y</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk_GISUNGREQ","ccfCD_SITE:0.0","10.0","175","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("오류내역");
            obj.set_value("1");
            ...
            obj = new BindItem("item3","divSearch.form.chk_GISUNGREQ","value","dsSearch","YN_ERROR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWA_SILHENG_MODIFY.xfdl", function() {
        ...
        this.loadIncludeScript("DWA_SILHENG_MODIFY.xfdl");
