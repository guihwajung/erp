(function()
{
    return function()
    {
        ...
        {
            this.set_name("DWZ_ORDPLN_SILJUK");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWZPR_ORDPLN_SILJUK_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LICCOST\" type=\"STRING\" size=\"256\"/><Column id=\"FR_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"TO_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_LICCOST","sta01:0.0","10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("7");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staDT_DATE","ccfCD_LICCOST:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("계획년월");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
        ...
        // User Script
        this.registerScript("DWZ_ORDPLN_SILJUK.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.DWZ_ORDPLN_SILJUK_onload = function(obj,e)
        {
        	// -- 필수 -------------------//
        ...
        */
        ...
        {
            this.addEventHandler("onload",this.DWZ_ORDPLN_SILJUK_onload,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DWZ_ORDPLN_SILJUK.xfdl");
