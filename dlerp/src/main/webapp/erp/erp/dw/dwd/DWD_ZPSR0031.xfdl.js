(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DWD_ZPSR0031.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DW", "DWD_ZPSR0031");
        };
        ...
        this.fnSelect = function() {
        	...
        	ds_value.push(this.dsSearch.getColumn(0, "YM_WORK"));
        ...
        this.loadIncludeScript("DWD_ZPSR0031.xfdl");
