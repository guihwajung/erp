(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_SILHENGCOST_COST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SYSTEM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"DS_SITE\"/><Col id=\"YM_WORK\"/><Col id=\"DS_SYSTEM\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListApp", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWD_SILHENGCOST_COST_2021.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWD_SILHENGCOST_COST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("DS_SYSTEM", "string");
        }
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "DS_SYSTEM", this.dsSearch.getColumn(0, "DS_SYSTEM"));

        	var strSvcId    = "select";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
        	var inData      = "select=dsSelect";
        	var outData     = "dsList=select0 dsListApp=select1";
        	var strArg      = "";
        ...
        this.fnApp = function(obj,e) {
        	var noElapdoc = "";
        	if(this.gfnIsNull(this.dsListApp.rowcount > 0)){
        		noElapdoc = this.dsListApp.getColumn(0, "NO_ELAPDOC");
        	}

        	var param = {};
        	param.V1 = this.dsSearch.getColumn(0, "CD_SITE");
        	param.V2 = this.dsSearch.getColumn(0, "YM_WORK").substr(0,6);
        	param.V3 = "";
        	param.V4 = "";
        	param.ID_AP = noElapdoc;	// 전자결재문서번호
        	param.DS_ETITLE = "기성집계표";

        	this.gfnFormOpen("DWD", "DWD_SILHENGCOST_APPROVAL", "fnAprvDialogCallback", param, 1200, 700);
        }
        ...
        this.loadIncludeScript("DWD_SILHENGCOST_COST_2021.xfdl");
