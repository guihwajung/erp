(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_FNDREQDPLN_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWDPR_FNDREQDPLN_SAVE</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DWDPR_FNDREQDPLN_EXECUTE</Col></Row><Row><Col id=\"TARGET\">selectd</Col><Col id=\"SP\">DWDPR_FNDREQDPLN_SELECT</Col></Row><Row><Col id=\"TARGET\">appr_select</Col><Col id=\"SP\">DZRPR_AP_STATE_SELECT</Col></Row><Row><Col id=\"TARGET\">aplines</Col><Col id=\"SP\">DZRPR_APPLINES_SELECT</Col></Row><Row><Col id=\"TARGET\">execAppr</Col><Col id=\"SP\">DZZPR_APPROVAL_CALLBACK</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divDataTop","0","divDataAppr:10",null,"92","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            this.divData.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWD_FNDREQDPLN_APP.xfdl", function() {
        ...
        // 결제상신
         this.fnAprvSang = function(obj,e) {
        	...
        	param.ID_AP_TYPE = "DW03";
        	param.V_PARAM01 = this.dsSearch.getColumn(0, "CD_SITE");
        	param.V_PARAM02 = this.dsSearch.getColumn(0, "YM_WORK").substr(0,6);
        	param.V_PARAM03 = "";
        	param.V_PARAM04 = "";
        	param.DS_TITLE =  "월별자금소요계획 품의서";
        ...
        this.loadIncludeScript("DWD_FNDREQDPLN_APP.xfdl");
