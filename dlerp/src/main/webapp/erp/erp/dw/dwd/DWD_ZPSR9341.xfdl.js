(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_YM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ctclDT_YM","staCD_PERIOD:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("DWD_ZPSR9341.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//this.divSearch.form.ctclDT_YM.form.TextBox.set_value(today.substr(0,6));
        ...
        this.fnSetVariable = function() {
        	...
        	this.ctclDT_YM = this.divSearch.form.ctclDT_YM;
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DW", "DWD_ZPSR9341");
        };
        ...
        this.fnSelect = function() {
        	...
        	ds_value.push(this.dsSearch.getColumn(0, "DT_YM").substr(0,6));
        ...
        this.fnSelectValidate = function() {
        	...
        	else if (this.gfnIsNull(this.dsSearch.getColumn(0, "DT_YM"))) {
        		validate = false;
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			this.ctclDT_YM.setFocus();
        		}
        ...
        this.fnCalcPrice = function()
        {
        	if(this.dsList1.rowcount > 0)
        	{
        		...
        		for(var i = 0 ; i < this.dsList1.rowcount; i++)
        		{
        			...
        			this.dsList1.setColumn(i, "OWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "OWRBTR"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "ZZBAN", (nexacro.toNumber(this.dsList1.getColumn(i, "ZZBAN"),0) * 100).toFixed(0));
        		}
        ...
        this.loadIncludeScript("DWD_ZPSR9341.xfdl");
