(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("objGrid","0","divDataMaster:10",null,null,"0","300",null,null,null,null,this.divData1.form);
            obj.set_taborder("3");
            obj._setContents("");
            this.divData1.addChild(obj.name, obj);

            obj = new Static("staTopTitle","0","objGrid:10",null,"22","440",null,null,null,null,null,this.divData1.form);
            obj.set_taborder("4");
            obj.set_text("상세내역");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData1.addChild(obj.name, obj);

            obj = new Grid("objGrid1","0","staTopTitle:10",null,null,"0","0",null,null,null,null,this.divData1.form);
            obj.set_taborder("5");
            obj._setContents("");
            this.divData1.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DWD_SILHENGCOST_APPROVAL.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DW14";	//	기성집계표
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWD_SILHENGCOST_LIST");
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DW", "DWD_SILHENGCOST_DETAIL");
        ...
        this.fnSetParameter = function() {
        	...
        	**************************************************************************************************/
        	...
        	this.dsSelect1.addColumn("DS_SYSTEM", "string");
        }
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect1.setColumn(0, "YM_WORK", this.dsListMaster.getColumn(0, "V_PARAM02"));
        	this.dsSelect1.setColumn(0, "DS_SYSTEM", "");
        ...
        */
        ...
        this.loadIncludeScript("DWD_SILHENGCOST_APPROVAL.xfdl");
