(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_SHGONGSA_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWDPR_HDSILHENG_SAVE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_HADOCONT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HADOCONT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_RP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_GBIMOK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkYN_HADO_JAN","chkYN_DOKUB:0.0","10.0","99","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("잔여존재여부");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            ...
            obj = new Static("staTY_APPROVAL","chkYN_HADO_JAN:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("비목");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboCD_BIMOK","staTY_APPROVAL:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            ...
            obj = new BindItem("item2","divSearch.form.ccboCD_BIMOK","value","dsSearch","CD_GBIMOK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWD_SHGONGSA_DETAIL.xfdl", function() {
        ...
        */
        ...
        this.divSearch_chkYN_HADO_JAN_onchanged = function(obj,e)
        {
        	if(obj.isChecked())
        	{
        ...
        this.divSearch_ccboCD_BIMOK_onitemchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.chkYN_HADO_JAN.addEventHandler("onchanged",this.divSearch_chkYN_HADO_JAN_onchanged,this);
            this.divSearch.form.ccboCD_BIMOK.addEventHandler("onitemchanged",this.divSearch_ccboCD_BIMOK_onitemchanged,this);
        ...
        this.loadIncludeScript("DWD_SHGONGSA_DETAIL.xfdl");
