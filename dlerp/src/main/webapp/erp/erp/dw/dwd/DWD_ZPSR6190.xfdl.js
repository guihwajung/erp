(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staDT_MAGAM","ccfCD_SITE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("마감일자");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_MAGAM","staDT_MAGAM:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("DWD_ZPSR6190.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.divSearch.form.ctclDT_MAGAM.set_value(this.gfnGetLastDate(today));
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DW", "DWD_ZPSR6190");
        };
        ...
        this.fnSelectValidate = function() {
        	...
        	else if (this.gfnIsNull(this.ctclDT_MAGAM.value)) {
        		validate = false;
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        ...
        this.loadIncludeScript("DWD_ZPSR6190.xfdl");
