(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new MaskEdit("ctxtIWRBTR",null,"10.0","150","24.0","5",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_value("");
            ...
            obj = new Static("staIWRBTR",null,"10.0","92.0","24.0","ctxtIWRBTR:5",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("전월잔액");
        ...
        // User Script
        this.registerScript("DWD_ZPSR0030.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DW", "DWD_ZPSR0030");
        };
        ...
        this.fnSelectValidate = function() {
        	...
        	else if((this.ctclDT_FROM.value).substr(0,4) != (this.ctclDT_TO.value).substr(0,4))
        	{
        		validate = false;
        		this.fnVaidateCallback = function() {
        			this.ctclDT_FROM.setFocus();
        		...
        		this.gfnAlert("처리일자 년월은 동일한 년월을 선택하셔야 합니다.", "fnVaidateCallback");
        	}
        	return validate;
        };
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	...
        	if (svcID == "select") {
        		...
        		{
        			var iwrbtr = (nexacro.toNumber(this.dsExport.getColumn(0, "E_IWRBTR"),0) * 100).toFixed(0);

        			this.divSearch.form.ctxtIWRBTR.set_value(iwrbtr);
        		}
        ...
        this.dsSearch_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue) {
        		...
        		this.divSearch.form.ctxtIWRBTR.set_value("");
        	}
        };
        ...
        this.fnCalcPrice = function()
        {
        	if(this.dsList1.rowcount > 0)
        	{
        		...
        		{
        			this.dsList1.setColumn(i, "IWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "IWRBTR"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "JWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "JWRBTR"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "NWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "NWRBTR"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "KWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "KWRBTR"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "GWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "GWRBTR"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "BWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "BWRBTR"),0) * 100).toFixed(0));
        		}
        ...
        this.loadIncludeScript("DWD_ZPSR0030.xfdl");
