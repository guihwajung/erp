(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("원가보고서총괄표(현장별)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_SILHENGCOST_LIST_SITE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"DS_SITE\"/><Col id=\"YM_WORK\"/></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWD_SILHENGCOST_LIST_BYSITE.xfdl", function() {
         ...
         ************************************************************************/
         this.fnGrid_CellDblclick = function(obj,e){
        	...
        	param.CD_SITE = this.dsList.getColumn(this.dsList.rowposition, "CD_SITE"); //this.gfnTrim(this.ccfCD_CORP.form.CDTextBox.value);
        	param.DS_SITE = this.dsList.getColumn(this.dsList.rowposition, "DS_SITE"); //this.gfnTrim(this.ccfCD_CORP.form.DSTextBox.value);
        	...
        	this.gfnFormOpen("DWD", "DWD_SILHENGCOST_DETAIL", "", param);
        };
        /************************************************************************
         * 기타 이벤트
         ************************************************************************/
        ...
        this.loadIncludeScript("DWD_SILHENGCOST_LIST_BYSITE.xfdl");
