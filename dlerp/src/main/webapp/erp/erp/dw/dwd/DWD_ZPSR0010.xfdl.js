(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DWD_ZPSR0010.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DW", "DWD_ZPSR0010");
        };
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0,"CD_SITE"))) {
        		...
        		this.gfnAlert("전기일자 시작일을 입력하세요.", "fnVaidateCallback");
        	}
        		...
        		this.gfnAlert("전기일자 종료일을 입력하세요.", "fnVaidateCallback");
        	}
        ...
        this.fnCalcPrice = function()
        {
              ...
              for(var i = 0 ; i < this.dsList1.rowcount; i++)
              {
                 ...
                 this.dsList1.setColumn(i, "MWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "MWRBTR"),0) * 100).toFixed(0));
              }
        ...
        this.loadIncludeScript("DWD_ZPSR0010.xfdl");
