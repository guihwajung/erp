(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWBPR_PREPAYCONTRACT_SELECT</Col></Row><Row><Col id=\"TARGET\">d_save</Col><Col id=\"SP\">DWBPR_PREPAY_ALL_SAVE</Col></Row><Row><Col id=\"TARGET\">d_exec</Col><Col id=\"SP\">DWBPR_PREPAY_EXECUTE</Col></Row><Row><Col id=\"SP\">DWBPR_PREPAY_ALL_SELECT</Col><Col id=\"TARGET\">d_select</Col></Row><Row><Col id=\"TARGET\">sapauto</Col><Col id=\"SP\">DWZPR_SAP_AUTOSLIP_ISSUE_SELECT</Col></Row><Row><Col id=\"TARGET\">sapcancel</Col><Col id=\"SP\">DWZPR_SAP_AUTOSLIP_CANCEL_SELECT</Col></Row><Row><Col id=\"TARGET\">file</Col><Col id=\"SP\">DWBPR_PREPAYFILE_EXECUTE</Col></Row><Row><Col id=\"TARGET\">appSelect</Col><Col id=\"SP\">DWBPR_APP_DW07_SELECT</Col></Row><Row><Col id=\"TARGET\">appChk</Col><Col id=\"SP\">DWBPR_APP_DW07_CHK</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnStockView",null,"0","73","23","106",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("2");
            obj.set_text("보증서보기");
            obj.set_cssclass("btnExt");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnStockChange",null,"0","103","23","0",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("3");
            obj.set_text("보증변경내역");
            obj.set_cssclass("btnExt");
        ...
        // User Script
        this.addIncludeScript("DWB_PREPAY_ALL.xfdl",'lib::libCommon.xjs');
        this.registerScript("DWB_PREPAY_ALL.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DWB_PREPAY_ALL.xfdl");
