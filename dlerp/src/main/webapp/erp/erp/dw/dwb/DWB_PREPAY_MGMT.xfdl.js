(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TY_WRK\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_HADOCONT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"YN_CMPLT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YN_CMPLT\">Y</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk_GISUNGREQ","ccfCD_VENDOR:0.0","10.0","175","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("완료제외");
            obj.set_value("1");
            ...
            obj = new Div("divDataBottom","0","0",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            ...
            obj = new Button("btnStockRes",null,"0","73","23","320",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("2");
            obj.set_text("보증반려");
            obj.set_cssclass("btnExt");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnStockAcc",null,"0","73","23","245",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("3");
            obj.set_text("보증승인");
            obj.set_cssclass("btnExt");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnStockDes",null,"0","73","23","170",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("4");
            obj.set_text("보증파기");
            obj.set_cssclass("btnExt");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnStockView",null,"0","73","23","95",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("5");
            obj.set_text("보증서보기");
            obj.set_cssclass("btnExt");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnStockChange",null,"0","93","23","0",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("6");
            obj.set_text("보증서변경내역");
            obj.set_cssclass("btnExt");
            this.divData.form.divDataBottom.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item3","divSearch.form.chk_GISUNGREQ","value","dsSearch","YN_CMPLT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DWB_PREPAY_MGMT.xfdl",'lib::libCommon.xjs');
        this.registerScript("DWB_PREPAY_MGMT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DW", "DWB_PREPAY_MGMT");
        ...
        */
        ...
        this.fnAppOpen = function()
        {
        	...
        	if(this.dsAppList.rowcount > 0)
        	{
        		...
        		if(sApType == "DW03"){
        			sTitle = "선급금 신청서 ["+this.dsListSub.getColumn(this.dsListSub.rowposition, "DS_SITE")+'] - '+this.dsListSub.getColumn(this.dsListSub.rowposition, "DS_VENDOR");
        		}else if(sApType == "DW04"){
        			sTitle = "선급금 신청서 취소 ["+this.dsListSub.getColumn(this.dsListSub.rowposition, "DS_SITE")+'] - '+this.dsListSub.getColumn(this.dsListSub.rowposition, "DS_VENDOR");
        		}
        ...
        this.loadIncludeScript("DWB_PREPAY_MGMT.xfdl");
