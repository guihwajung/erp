(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWBPR_WOINTLND_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWBPR_WOINTLND_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWB_WOINTLND.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	var dt = new Date();
        	this.dsSearch.setColumn(0, "YR_WORK", dt.getFullYear());
        };
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWB_WOINTLND");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("FR_REQPERD", "string");
        	this.dsSave.addColumn("TO_REQPERD", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "FR_REQPERD", this.dsList.getColumn(i, "FR_REQPERD"));
        				this.dsSave.setColumn(nrow, "TO_REQPERD", this.dsList.getColumn(i, "TO_REQPERD"));
        ...
        this.loadIncludeScript("DWB_WOINTLND.xfdl");
