(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TY_WRK\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_HADOCONT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWBPR_PREPAYCONTRACT_SELECT</Col></Row><Row><Col id=\"TARGET\">d_save</Col><Col id=\"SP\">DWBPR_PREPAY_SAVE</Col></Row><Row><Col id=\"TARGET\">d_exec</Col><Col id=\"SP\">DWBPR_PREPAY_EXECUTE</Col></Row><Row><Col id=\"SP\">DWBPR_PREPAY_SELECT</Col><Col id=\"TARGET\">d_select</Col></Row><Row><Col id=\"TARGET\">sapauto</Col><Col id=\"SP\">DWZPR_SAP_AUTOSLIP_ISSUE_SELECT</Col></Row><Row><Col id=\"TARGET\">sapcancel</Col><Col id=\"SP\">DWZPR_SAP_AUTOSLIP_CANCEL_SELECT</Col></Row><Row><Col id=\"TARGET\">file</Col><Col id=\"SP\">DWBPR_PREPAYFILE_EXECUTE</Col></Row><Row><Col id=\"TARGET\">appSelect</Col><Col id=\"SP\">DWBPR_APP_DW03_SELECT</Col></Row><Row><Col id=\"TARGET\">appChk</Col><Col id=\"SP\">DWBPR_APP_DW03_CHK</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_HADOCONT","ccfCD_SITE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("계약번호");
            ...
            obj = new Static("sta02","0","0",null,"22","5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("1");
            obj.set_text("선급금청구내역");
            obj.set_cssclass("sta_TITLE_Bg");
            ...
            obj = new Button("btnStockRes",null,"0","73","23","711",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("2");
            obj.set_text("보증반려");
            ...
            obj = new Button("btnStockAcc",null,"0","73","23","637",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("3");
            obj.set_text("보증승인");
            obj.set_cssclass("btnExt");
            obj.set_visible("false");
            ...
            obj = new Button("btnStockDes",null,"0","73","23","563",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("4");
            obj.set_text("보증파기");
            obj.set_cssclass("btnExt");
            obj.set_visible("false");
            ...
            obj = new Button("btnStockView",null,"0","73","23","109",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("5");
            obj.set_text("보증서보기");
            obj.set_cssclass("btnExt");
            obj.set_visible("false");
            ...
            obj = new Button("btnStockChange",null,"0","103","23","1",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("6");
            obj.set_text("보증변경내역");
            obj.set_cssclass("btnExt");
            obj.set_visible("false");
        ...
        // User Script
        this.addIncludeScript("DWB_PREPAY.xfdl",'lib::libCommon.xjs');
        this.registerScript("DWB_PREPAY.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
           ...
           this.btnSlipIssue_past = this.gfnFormButtonAdd("btnSlipIssue_past", "fnSlipIssue_past");
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWB_PREPAYCONTRACT");
        	...
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DW", "DWB_PREPAY");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("DS_CONTMETHOD", "string"); // DS_CONTMETHOD 추가
        	...
        	this.dsSelectSub.addColumn("DS_CONTMETHOD", "string"); // DS_CONTMETHOD 추가
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "DS_CONTMETHOD", this.FormInfo.DS_PARAM); // DS_CONTMETHOD 추가
        ...
        this.fnSelectSub = function() {
           ...
           if (this.dsSearch.getColumn(0, "CD_SITE") == "") {
        	...
        	this.dsSelectSub.setColumn(0, "DS_CONTMETHOD", this.FormInfo.DS_PARAM); // DS_CONTMETHOD 추가
        ...
        this.fnSave = function() {
        		...
        		for (var i = 0; i < this.dsListSub.rowcount; i++) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "NO_CONT", this.dsList.getColumn(this.dsList.rowposition, "NO_HADOCONT"));
        				...
        				this.dsSave.setColumn(nrow, "NO_TAX", this.dsListSub.getColumn(i, "NO_ACCOUNT"));
        ...
        this.fnAdd = function() {
        	   ...
        	   this.dsListSub.setColumn(nrow, "YN_EDIT_VNDR", "Y");
        	   this.dsListSub.setColumn(nrow, "BTN_SCRTS_AUTO", "F");
        	   this.dsListSub.setColumn(nrow, "CD_SITE", this.dsSearch.getColumn(0, "CD_SITE"));
        	   this.dsListSub.setColumn(nrow, "NO_CONT", this.dsList.getColumn(this.dsList.rowposition, "NO_HADOCONT"));
        	   ...
        	   this.dsListSub.setColumn(nrow, "CD_VENDOR", this.dsList.getColumn(this.dsList.rowposition, "CD_VENDOR"));

        	   this.dsListSub.setColumn(nrow, "AM_REQUESTPRO", this.dsList.getColumn(this.dsList.rowposition, "AM_PREPAY_PROV"));
        	   this.dsListSub.setColumn(nrow, "AM_REQUESTVAT", this.dsList.getColumn(this.dsList.rowposition, "AM_PREPAY_VAT"));
        	   this.dsListSub.setColumn(nrow, "AM_REQUESTTXFR", this.dsList.getColumn(this.dsList.rowposition, "AM_PREPAY_NVAT"));
        	   this.dsListSub.setColumn(nrow, "AM_REQUEST", this.dsList.getColumn(this.dsList.rowposition, "AM_PREPAY_TOT"));
        ...
        */
        ...
        this.fnGridSub_AfterEdit = function(obj,e) {
         ...
         this.fnGridSub_BeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	if(id == "DFX_CFACCOUNTMATCH"){
        		...
        		dsUserParam.setColumn(nrow, "CD_PAY", this.dsListSub.getColumn(this.dsListSub.rowposition, "CD_VENDOR_DH"));
         ...
         this.fnGridSub_ExpandUp = function(obj, e) {
        	...
        	var cd_site = this.dsSearch.getColumn(0, "CD_SITE");
        	var no_hadocont = this.dsList.getColumn(this.dsList.rowposition, "NO_HADOCONT");
        	...
        	if(colnm == "BTN_SCRTS") {
        		...
        		fileManager.CD_DIR = [cd_site, no_hadocont, cd_vendor, no_seq,  "SCRTS"];
        ...
        this.dsList_canrowposchange = function(obj,e) {
        	...
        	if(!can_rowchange) {
        		this._row = e.newrow;
        		this.gfnConfirm("변경된 데이터가 있습니다.\r\n자료저장 후 이동하시겠습니까?", "dsList_canrowposchange_callback");
        		}
         ...
         ************************************************************************/
         ...
         this.fnSlipIssue = function(obj,e) {
        	...
        	var noHadocont = this.dsList.getColumn(this.dsList.rowposition, "NO_HADOCONT");	//계약번호
        	var dsHadocont = this.dsList.getColumn(this.dsList.rowposition, "DS_HADOCONT");
        	var cdVendor = this.dsList.getColumn(this.dsList.rowposition, "CD_VENDOR"); //업체명
        	var dsVendor = this.dsList.getColumn(this.dsList.rowposition, "DS_VENDOR");
        	var noSeq = this.dsListSub.getColumn(this.dsListSub.rowposition, "NO_SEQ");	// 선급회차

        	this.gfnConfirm("현장코드 : [" + cdSite + "] " + dsSite + "\r\n계약번호 : [" + noHadocont + "] " +dsHadocont + "\r\n업체코드 : [" + cdVendor + "] " +dsVendor+ "\r\n선급회차 : " + noSeq+  "\r\n \r\n선급금청구 전표발행 하시겠습니까?", "dsListSub_slipIssue_callback");
        }


        // 전표발행 버튼 클릭 후 callback
        this.dsListSub_slipIssue_callback = function(strId, val)
        {
        	if(val == true) {

        	var tyWrk = "SLPPUB";
        	var cdSite = this.divSearch.form.ccfCD_SITE.form.CDTextBox.value;
        	...
        	var noSlip = this.dsListSub.getColumn(this.dsListSub.rowposition, "NO_SLIP");
        	var ds_rtnrsn = "";

        	this.execGubun = "btnExec";

        	this.fnExec(tyWrk, cdSite, noHadocont, cdVendor, noSeq, noSlip, ds_rtnrsn);
           }
        }
        ...
        this.fnSlipSearch = function(obj,e) {
        	...
        	var nRowPo = this.dsListSub.rowposition;
        	nRowPo = (this.dsListSub.rowcount > 0 && nRowPo < 0) ? 0 : nRowPo;

        	var no_slip = this.dsListSub.getColumn(nRowPo, "NO_SLIP");
         ...
         this.fnSlipCancel = function(obj,e) {
        	...
        	this.gfnConfirm("현장코드 : [" + cdSite + "]" +dsSite + "\r\n계약번호 : [" + noHadocont + "] " + dsHadocont + "\r\n업체코드 : [" + cdVendor + "] " +dsVendor+  "\r\n선급회차 : " + noSeq+  "\r\n \r\n선급금청구 전표취소 하시겠습니까?", "dsListSub_slipCancel_callback");
        }

        // 전표취소 버튼 클릭 후 callback
        this.dsListSub_slipCancel_callback = function(strId, val)
        {
        	if(val == true) {
        ...
        this.fnSlipIssueSap = function() {
        	...
        	this.gfnConfirm("현장코드 : [" + cdSite + "] " + dsSite + "\r\n계약번호 : [" + noHadocont + "] " +dsHadocont  + "\r\n업체코드 : [" + cdVendor + "] " +dsVendor+ "\r\n선급회차 : " + noSeq+  "\r\n \r\n선급금청구 전표발행(SAP) 하시겠습니까?", "dsListSub_slipIssueSap_callback");
        }

        this.dsListSub_slipIssueSap_callback = function(strId, val) {
        	if(val == true) {
        		this.dsSapAuto.clearData();
        		this.dsSapAuto.addRow();

        		this.dsSapAuto.setColumn(0, "TY_WRK", "Q");
        		this.dsSapAuto.setColumn(0, "CD_AUTOSLIP", "DWB0001");
        		this.dsSapAuto.setColumn(0, "NO_ERPKEY", this.dsListSub.getColumn(this.dsListSub.rowposition, "NO_ERPKEY"));
        ...
        this.fnSlipCancelSap = function() {
        	...
        	this.gfnConfirm("현장코드 : [" + cdSite + "] " + dsSite + "\r\n계약번호 : [" + noHadocont + "] " +dsHadocont+ "\r\n업체코드 : [" + cdVendor + "] " +dsVendor+  "\r\n선급회차 : " + noSeq+  "\r\n \r\n선급금청구 전표(SAP) 취소하시겠습니까?", "dsListSub_slipCancelSap_callback");
        }

        this.dsListSub_slipCancelSap_callback = function(strId, val) {
        	if(val == true) {
        		this.dsSapAuto.clearData();
        		this.dsSapAuto.addRow();
        ...
        this.fnChrProc = function(obj,e) {
        		...
        		if(this.dsList.rowposition < 0){
        			this.gfnAlert("계약정보 그리드의 선택된 행이 없습니다.");
        			return false;
        		}else if(this.dsListSub.rowposition < 0){
        		...
        		var listSubRow = this.dsListSub.rowposition;

        		param.CD_SITE = this.dsSearch.getColumn(0, "CD_SITE");
        		param.DS_SITE = this.divSearch.form.ccfCD_SITE.form.DSTextBox.text;
        		param.NO_HADOCONT = this.dsList.getColumn(listRow, "NO_HADOCONT");
        		param.DS_HADOCONT = this.dsList.getColumn(listRow, "DS_HADOCONT");
        		param.CD_VENDOR = this.dsList.getColumn(listRow, "CD_VENDOR");
        		param.DS_VENDOR = this.dsList.getColumn(listRow, "DS_VENDOR");
        		param.NO_SEQ = this.dsListSub.getColumn(listSubRow, "NO_SEQ");
        		param.CD_PROCDIV = this.dsListSub.getColumn(listSubRow, "CD_PROCDIV");
        ...
        this.fnSgnReq = function(obj,e) {
        	...
        	var msg = "현장코드 : [" + this.dsSearch.getColumn(0, "CD_SITE") + "] " + this.divSearch.form.ccfCD_SITE.form.DSTextBox.text
        			+ "\n계약번호 : [" + this.dsList.getColumn(row, "NO_HADOCONT") + "] " + this.dsList.getColumn(row, "DS_HADOCONT")
        			+ "\n업체코드 : [" + this.dsList.getColumn(row, "CD_VENDOR") + "] " + this.dsList.getColumn(row, "DS_VENDOR")
        ...
        this.fnFileExecute = function()
        {
        	...
        	this.dsFileExec.setColumn(nrow, "NO_CONT", this.dsList.getColumn(this.dsList.rowposition, "NO_HADOCONT"));
        	this.dsFileExec.setColumn(nrow, "CD_VENDOR", this.dsList.getColumn(this.dsList.rowposition, "CD_VENDOR"));
        ...
        this.fnAutoFile = function() {
        	  ...
        	  dsAutoForm.setColumn(nrow, "ATTR02", this.dsList.getColumn(this.dsList.rowposition, "NO_HADOCONT"));
        	  dsAutoForm.setColumn(nrow, "ATTR03", this.dsList.getColumn(this.dsList.rowposition, "CD_VENDOR"));
        ...
        this.fnFileCallback = function(strID, val) {
        	...
        	var objSubDs = this.dxGridSub.getBindDataset();

        	// 파일개수를 다시 셋팅
        	objSubDs.set_enableevent(false);

        	objSubDs.setColumn(objSubDs.rowposition, "BTN_SCRTS", "증권(" + val.Cnt + ")");

        	objSubDs.set_enableevent(true);
        };
        ...
        // 	}
        	...
        	var msg = "현장코드 : [" + this.dsListSub.getColumn(0, "CD_SITE") + "] " + this.divSearch.form.ccfCD_SITE.form.DSTextBox.text
        			+ "\n계약번호 : [" + this.dsListSub.getColumn(0, "NO_CONT")+ "]"
        			+ "\n계약차수 : [" + this.dsListSub.getColumn(0, "NO_SEQ")+ "]"
        			+ "\n\n외주전표 전자결재를 하시겠습니까?";
        ...
        // 		}
        		...
        		this.dsAppParam.setColumn(nrow, "ID_AP_TYPE", "DW03");
        ...
        // 		}
        		...
        		this.dsAppParam.setColumn(nrow, "NO_CONT", this.dsListSub.getColumn(this.dsListSub.rowposition, "NO_CONT"));
        		this.dsAppParam.setColumn(nrow, "NO_SEQ", this.dsListSub.getColumn(this.dsListSub.rowposition, "NO_SEQ"));
        		this.dsAppParam.setColumn(nrow, "ID_AP_TYPE", "DW04");
        ...
        this.fnAppOpen = function()
        {
        	...
        	if(this.dsAppList.rowcount > 0)
        	{
        		...
        		if(sApType == "DW03"){
        			sTitle = "선급금전표 ["+this.divSearch.form.ccfCD_SITE.form.DSTextBox.value+']';
        		}else if(sApType == "DW04"){
        			sTitle = "선급금전표 취소 ["+this.divSearch.form.ccfCD_SITE.form.DSTextBox.value+']';
        		}
        ...
        this.divData_divDataBottom_objGridSub_oncellposchanged = function(obj,e)
        {
        	var colnm = this.gfnGridGetBindColumnNameByIndex(this.dxGridSub, e.cell);
        	if(e.cell == "52"||e.cell == "53"){
        ...
        this.fnStockRes = function(obj,e) {
        	...
        	this.dsTransure.setColumn(0, "TY_STOCK", 	"P");
        ...
        this.fnStockChange = function(obj,e)
        {
        	var param = {};
        ...
        this.fnSlipIssue_past = function(){
        	// 선택된 row가 있을 경우에만 팝업을 띄움
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }
        	...
        	this.gfnConfirm("현장코드 : [" + cdSite + "] " + dsSite + "\r\n계약번호 : [" + noHadocont + "] "
        					+ dsHadocont + "\r\n업체코드 : [" + cdVendor + "] " +dsVendor+ "\r\n선급회차 : "
        					+ noSeq+  "\r\n \r\n선급금청구 전표발행 하시겠습니까?", "dsListSub_slipIssue_past_callback");
        }

        // 전표발행 버튼 클릭 후 callback
        this.dsListSub_slipIssue_past_callback = function(strId, val)
        {
        	if(val == true) {

        	var tyWrk = "SLPPUB_PAST";
        	var cdSite = this.divSearch.form.ccfCD_SITE.form.CDTextBox.value;
        	var noHadocont = this.dsList.getColumn(this.dsList.rowposition, "NO_HADOCONT");
        	var cdVendor = this.dsList.getColumn(this.dsList.rowposition, "CD_VENDOR");
        	var noSeq = this.dsListSub.getColumn(this.dsListSub.rowposition, "NO_SEQ");
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataBottom.form.objGridSub.addEventHandler("oncellposchanged",this.divData_divDataBottom_objGridSub_oncellposchanged,this);
            this.divData.form.divDataBottom.form.btnStockRes.addEventHandler("onclick",this.fnStockRes,this);
            this.divData.form.divDataBottom.form.btnStockAcc.addEventHandler("onclick",this.fnStockAcc,this);
            this.divData.form.divDataBottom.form.btnStockDes.addEventHandler("onclick",this.fnStockDes,this);
            this.divData.form.divDataBottom.form.btnStockView.addEventHandler("onclick",this.fnStockView,this);
            this.divData.form.divDataBottom.form.btnStockChange.addEventHandler("onclick",this.fnStockChange,this);
            this.dsList.addEventHandler("canrowposchange",this.dsList_canrowposchange,this);
        ...
        this.loadIncludeScript("DWB_PREPAY.xfdl");
