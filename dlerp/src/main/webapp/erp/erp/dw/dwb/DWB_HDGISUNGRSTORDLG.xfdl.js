(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new TextArea("ctxtCHG_RSN","staRM_RSTOR:5","edtNO_VENDOR:9",null,"60","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            obj.set_value("");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item8","divData.form.ctxtCHG_RSN","value","dsData","CHG_RSN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWB_HDGISUNGRSTORDLG.xfdl", function() {
        ...
        this.fnApproveValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsData.getColumn(0, "CHG_RSN"))) {
        		validate = false;
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			this.divData.form.ctxtCHG_RSN.setFocus();
        		}
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "approve") {
        		if(errorCode == 0)
        		{
        			...
        			this.gfnAlert("기성청구반려가 정상 처리되었습니다.", "fnApprove_callback");
        		}else
        		{
        ...
        this.divData_btnOk_onclick = function(obj,e)
        {
        	...
        	this.dsExecute.setColumn(nrow, "TY_WRK", "RSTOR");
        ...
        this.loadIncludeScript("DWB_HDGISUNGRSTORDLG.xfdl");
