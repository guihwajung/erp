(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DWB_HDLEDGER_DDCT.xfdl", function() {
        ...
        this.loadIncludeScript("DWB_HDLEDGER_DDCT.xfdl");
