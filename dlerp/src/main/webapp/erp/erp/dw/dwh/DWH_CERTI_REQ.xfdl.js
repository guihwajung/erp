(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWHPR_REQCERTI_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DWHPR_REQCERTI_INSERT</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DWHPR_REQCERTI_DELETE</Col></Row><Row><Col id=\"SP\">DWHPR_REQCERTI_UPDATE</Col><Col id=\"TARGET\">update</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWH_CERTI_REQ.xfdl", function() {
        ...
        this.loadIncludeScript("DWH_CERTI_REQ.xfdl");
