(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("투자조정_공종코드부여");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_TUJAADJUSTTREE_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DWTPR_TUJAADJUST_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_YN_COMBO_COMMON_SELECT_01</Col></Row><Row><Col id=\"TARGET\">combo2</Col><Col id=\"SP\">DZXPR_COMBO_COMMON_SELECT_01</Col></Row><Row><Col id=\"TARGET\">d_save</Col><Col id=\"SP\">DWDPR_TUJAADJUST_SAVE</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DWDPR_COSTTUJA_EXECUTE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divDataLeft","0","0","539",null,null,"0",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            ...
            obj = new Div("divDataRight","divDataLeft:5","0",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staBOT_YM_WORK","0","0","96.91%","20",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form);
            obj.set_taborder("1");
            obj.set_text("투입내역");
            ...
            obj = new BindItem("item1","divSearch.form.cboYN_GUBUN","value","dsSearch","GUBUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.chk_OPR_VIEW","value","dsSearch","CHK_OPR_VIEW");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","divSearch.form.cboYN_BIMOK","value","dsSearch","CD_BIMOK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch.form.ctclYM_WORK","text","dsSearch","YM_WORK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWT_TUJAADJUST.xfdl", function() {
        ...
        this.DWD_TUJAADJUST_onload = function(obj,e)
        {
           ...
           //this.FormBtns.Select.click();
            if(!this.gfnIsNull(this.getOwnerFrame().CD_SITE) && !this.gfnIsNull(this.getOwnerFrame().YM_WORK))
        	{
        		...
        		//this.divSearch.form.ctclYM_WORK.set_value(this.getOwnerFrame().YM_WORK);
        ...
        this.fnSetEvent = function() {
           ...
           this.gfnGridInit(this.dxGridSub1, this.dsListSub1, "DW", "DWD_TUJAADJUST_GRID2");
        	...
        	for (var i = 0; i < this.dsListSub1.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "YM_WORK", this.dsListSub1.getColumn(i, "YM_WORK"));
        				this.dsSave.setColumn(nrow, "CD_SITE", this.dsListSub1.getColumn(i, "CD_SITE"));
        ...
        this.fnTujaAdj = function(obj,e) {
        	...
        	if(this.dsListSub1.getColumn(this.dsListSub1.rowposition,"YN_PSBLE") == "Y"){
        		...
        		param.YM_WORK = this.dsListSub1.getColumn(this.dsListSub1.rowposition, "YM_WORK");
        ...
        this.fnChkOprView = function() {
        	if(this.dsSearch.getColumn(0, "CHK_OPR_VIEW") == "0") {
        		...
        		this.divData.form.divDataRight.set_left(530);
        	}
        ...
        this.loadIncludeScript("DWT_TUJAADJUST.xfdl");
