(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOZPR_CONST_ORD_DMD_FIRM_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DOZPR_CONST_ORD_DMD_FIRM_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWU_RCOMNG.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWU_RCOMNG");
        	// row 수정가능 여부
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("CLASS_ORD_DMD", "string");
        	this.dsSave.addColumn("CD_ORD_DMD_FIRM", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "CLASS_ORD_DMD", this.dsList.getColumn(i, "CLASS_ORD_DMD"));
        				this.dsSave.setColumn(nrow, "CD_ORD_DMD_FIRM", this.dsList.getColumn(i, "CD_ORD_DMD_FIRM"));
        				this.dsSave.setColumn(nrow, "RT_PORTION", this.dsList.getColumn(i, "RT_PORTION"));
        				this.dsSave.setColumn(nrow, "CD_SUP_DIV", this.dsList.getColumn(i, "CD_SUP_DIV"));
        				this.dsSave.setColumn(nrow, "CD_SUP_CTP", this.dsList.getColumn(i, "CD_SUP_CTP"));
        ...
        this.loadIncludeScript("DWU_RCOMNG.xfdl");
