(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHNPR_ASSETDEP_MAX</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHNPR_ASSETDEP_REPAYMENT_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00","2","123","288","17",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_text("해당월까지의 감가상각을 취소 합니다.");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("DHN_ASSETDEPMAGAMCANCEL.xfdl", function() {
        /***********************************************************************************************
        ...
        */
        ...
        this.loadIncludeScript("DHN_ASSETDEPMAGAMCANCEL.xfdl");
