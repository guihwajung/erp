(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHNPR_LSECLSNGDTLS_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DHNPR_LSECLSNGDTLS_SAVE</Col></Row><Row><Col id=\"TARGET\">select_m</Col><Col id=\"SP\">DHZPR_SRNMSG_SELECT</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DHNPR_LSECLSNGDTLS_EXECUTE</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DHNPR_LSECLSNGDTLS_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DHNPR_LSECLSNGDTLS_AUTOSLIP_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYM_ACNT","ctxtDS_LSEASST:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("회계년월");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabelE");
        ...
        // User Script
        this.registerScript("DHN_LSECLSNGDTLS.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHN_LSECLSNGDTLS");
        ...
        ************************************************************************/
        ...
        // 	this.dsList.filter("");
        	...
        	this.gfnConfirm(strMsg, "fnIssueSlip_callback");
        ...
        this.fnIssueSlip_callback = function(strId, val)
        {
        	if(val == true) {
        		...
        		this.dsIssueSlip.setColumn(nRow, "NO_LSEASST" , this.dsSearch.getColumn(0, "NO_LSEASST"));
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("DHN_LSECLSNGDTLS.xfdl");
