(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_CARDSAAPP_BY_SITE_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHAPR_CARDSAAPP_BY_SITE_UPDATE</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DHAPR_CARDSAAPP_BY_SITE_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DHAPR_CARDSAAPP_BY_SITE_CANCELSLIP</Col></Row><Row><Col id=\"TARGET\">selectBudget</Col><Col id=\"SP\">DHAPR_AVAILABLEBUDGET_SELECT</Col></Row><Row><Col id=\"SP\">DHAPR_CARDSAAPP_BY_SITE_DELETE</Col><Col id=\"TARGET\">delete</Col></Row><Row><Col id=\"TARGET\">aprv_execute</Col><Col id=\"SP\">DHAPR_SLIP_DETAIL_APRV_EXECUTE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"TY_CONFIRM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_DATE_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_DATE_TO\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPTOPER\" type=\"STRING\" size=\"256\"/><Column id=\"NO_CARD\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"ID_USER\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPTOPER\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_CONFIRM", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\"/><Col id=\"VALUE\">전체</Col></Row><Row><Col id=\"CODE\">N</Col><Col id=\"VALUE\">전표미발행</Col></Row><Row><Col id=\"CODE\">Y</Col><Col id=\"VALUE\">전표발행</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_GUBUN", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\"/><Col id=\"VALUE\">전체</Col></Row><Row><Col id=\"CODE\">개인</Col><Col id=\"VALUE\">개인</Col></Row><Row><Col id=\"CODE\">법인</Col><Col id=\"VALUE\">법인</Col></Row><Row><Col id=\"CODE\">임원</Col><Col id=\"VALUE\">임원</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_CORP","sta04:0.0","10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("sta03","ctclDT_TO:30","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("발행구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboTY_GUBUN","sta03:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_innerdataset("dsTY_CONFIRM");
            ...
            obj = new Static("staCD_DEPTOPER","0","sta00:10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("귀속부서");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_SchLabelE");
            ...
            obj = new Div("ccfCD_DEPTOPER","staCD_DEPTOPER:0","sta00:10","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("9");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            ...
            obj = new Static("sta01","ccfCD_DEPTOPER:0.0","sta00:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("카드번호");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_NOCARD","sta01:0.0","sta00:10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("sta05","1024","45","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("개인법인");
            ...
            obj = new Combo("cboTY_PSBUBIN","1120","44","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            ...
            obj = new Edit("edtGR_DEPT_ACNT","cboTY_PSBUBIN:10","sta00:10.0","31","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_visible("false");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staID_SABUN","sta01:269","44","83","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            obj.set_text("사용자");
            ...
            obj = new Div("ccfID_SABUN","815","44","280","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CodeFindName").set("DHX_CFIDSABUN_CODEFIND");
            ...
            obj = new Static("sta00",null,"0","732","24","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("※ 결재상태가 \"결재중\" 또는 \"결재완료\" 인 경우,수정 불가합니다.  궁금한 점이 있으시다면 재무팀 법인카드 담당자에게 연락바랍니다.");
            ...
            obj = new BindItem("item5","divSearch.form.cboTY_GUBUN","value","dsSearch","TY_CONFIRM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item7","divSearch.form.ccfID_SABUN.form.CDTextBox","value","dsSearch","ID_USER");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHA_BUBINCARDSAAPP_SITE.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DHA_BUBINCARDSAAPP_SITE.xfdl");
