(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_JUNDOREQ_EXEC_SELECT</Col></Row><Row><Col id=\"SP\">DHAPR_JUNDOREQ_EXEC_HEADER_SELECT</Col><Col id=\"TARGET\">selectHeader</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"YM_ACCOUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CORP\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsJundoReqList", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_DEPTOFFICER\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPTOFFICER\" type=\"STRING\" size=\"256\"/><Column id=\"AM_THISMON_PAY\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","divSearch.form.ctclYM_WORK.form.TextBox","value","dsSearch","YM_ACCOUNT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHA_JUNDOREQ_EXEC.xfdl", function() {
        ...
        // 전표금 현황표
        this.fnJundoReqExec = function (obj,e){
        ...
        this.loadIncludeScript("DHA_JUNDOREQ_EXEC.xfdl");
