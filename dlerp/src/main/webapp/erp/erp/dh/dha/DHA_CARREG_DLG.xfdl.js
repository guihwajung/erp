(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DHA_CARREG_DLG.xfdl", function() {
        ...
        this.fnDetail = function(obj,e) {
        	...
        	if(selRows.length > 0) {
        		...
        		this.gfnFormOpen("DGB", "DHN_ASSETREG", "", param);
        	}
        }
        ...
        this.loadIncludeScript("DHA_CARREG_DLG.xfdl");
