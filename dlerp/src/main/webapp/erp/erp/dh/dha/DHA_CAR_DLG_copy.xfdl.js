(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DT_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"ID_USER\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"ID_PERSON\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DT_REQUEST\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">slip</Col><Col id=\"SP\">DHAPR_CARINSUR_AUTOSLIP_ISSUE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHA_CAR_DLG_copy.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().ID_PERSON)) {
        		...
        		//this.dsList.setColumn(0, "INSURANCE_PAY", this.getOwnerFrame().INSURANCE_PAY);
        		//this.dsList.setColumn(0, "CD_CAR", this.getOwnerFrame().CD_CAR);
        		this.dsList.setColumn(0, "DT_REQUEST", this.getOwnerFrame().DT_REQUEST);
        ...
        this.fnSetParameter = function() {
        	...
        	//this.dsSlip.addColumn("CD_VENDOR", "string");
        	//this.dsSlip.addColumn("INSURANCE_PAY", "string");
        ...
        this.dlgfnSave = function() {
        	...
        	this.dsSlip.setColumn(nrow, "DT_REQUEST", this.dsList.getColumn(0, "DT_REQUEST"));
        	...
        	//this.dsSlip.setColumn(nrow, "CD_VENDOR", this.dsList.getColumn(0, "CD_VENDOR"));
        	//this.dsSlip.setColumn(nrow, "INSURANCE_PAY", this.dsList.getColumn(0, "INSURANCE_PAY"));
        	//this.dsSlip.setColumn(nrow, "CD_CAR", this.dsList.getColumn(0, "CD_CAR"));
        	...
        	this.dsSlip.setColumn(nrow, "NO_AUTOSLIP", "");
        ...
        this.loadIncludeScript("DHA_CAR_DLG_copy.xfdl");
