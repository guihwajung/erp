(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divDataIssue","0","divDataMaster:10",null,null,"0","0",null,null,null,null,this.divData1.form);
            obj.set_taborder("2");
            obj.set_text("");
            this.divData1.addChild(obj.name, obj);

            obj = new Static("sta11","0","0","120","30",null,null,null,null,null,null,this.divData1.form.divDataIssue.form);
            obj.set_taborder("6");
            obj.set_text("전표유형");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataIssue.addChild(obj.name, obj);

            obj = new Static("sta12","sta11:-1","0","170","30",null,null,null,null,null,null,this.divData1.form.divDataIssue.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataIssue.addChild(obj.name, obj);

            obj = new Static("sta13","sta12:-1","0","120","30",null,null,null,null,null,null,this.divData1.form.divDataIssue.form);
            obj.set_taborder("8");
            obj.set_text("전표번호");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataIssue.addChild(obj.name, obj);

            obj = new Static("sta14","sta13:-1","0","170","30",null,null,null,null,null,null,this.divData1.form.divDataIssue.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataIssue.addChild(obj.name, obj);

            obj = new Static("sta15","sta14:-1","0","120","30",null,null,null,null,null,null,this.divData1.form.divDataIssue.form);
            obj.set_taborder("10");
            obj.set_text("자동전표명");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataIssue.addChild(obj.name, obj);

            obj = new Static("sta16","sta15:-1","0","170","30",null,null,null,null,null,null,this.divData1.form.divDataIssue.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataIssue.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","sta11:10",null,null,"0","50",null,null,null,null,this.divData1.form.divDataIssue.form);
            obj.set_taborder("12");
            obj.set_binddataset("dsList");
            obj.set_autofittype("col");
            obj.set_enable("true");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"180\"/><Column size=\"250\"/><Column size=\"160\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/><Row size=\"24\"/><Row size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"계정코드 및 계정명\"/><Cell col=\"1\" text=\"회계일자\"/><Cell col=\"2\" text=\"차변\"/><Cell col=\"3\" colspan=\"2\" text=\"대변\"/></Band><Band id=\"body\"><Cell text=\"bind:DS_ACCOUNT\" border=\"1px solid #d2cfcd,1px solid #f2f2f2,0px solid #d2cfcd\"/><Cell col=\"1\" text=\"bind:DT_ACCOUNT\"/><Cell col=\"2\" text=\"bind:AM_CR\" textAlign=\"right\" edittype=\"none\" maskeditformat=\"#,###\" displaytype=\"mask\" font=\"bold 12px/normal &quot;Dotum&quot;\"/><Cell col=\"3\" colspan=\"2\" text=\"bind:AM_DR\" textAlign=\"right\" maskeditformat=\"#,###\" displaytype=\"mask\" font=\"bold 12px/normal &quot;Dotum&quot;\"/><Cell row=\"1\" text=\"bind:CD_ACCOUNT\" border=\"1px solid #d2cfcd,1px solid #f2f2f2,0px solid #d2cfcd\"/><Cell row=\"1\" col=\"1\" colspan=\"4\" text=\"bind:DS_REM\"/><Cell row=\"2\" text=\"bind:DS_PROOF\" border=\"1px solid #d2cfcd,1px solid #f2f2f2,0px solid #d2cfcd\"/><Cell row=\"2\" col=\"1\" text=\"bind:NO_REF\"/><Cell row=\"2\" col=\"2\" textAlign=\"right\" text=\"bind:DS_REFDT1\"/><Cell row=\"2\" col=\"3\" text=\"bind:DT_REF1\" displaytype=\"expr:DT_REF1 == null ? &quot;normal&quot; : &quot;date&quot;\" calendardateformat=\"yyyy-MM-dd\" border=\"1px solid #d2cfcd,0px solid #f2f2f2,1px solid #d2cfcd,1px solid #f2f2f2\"/><Cell row=\"2\" col=\"4\" border=\"1px solid #d2cfcd,1px solid #f2f2f2,1px solid #d2cfcd,0px solid #f2f2f2\"/><Cell row=\"3\" text=\"expr:CD_DEPT_BE +' : ' + DS_DEPT_BE\"/><Cell row=\"3\" col=\"1\" colspan=\"2\" text=\"bind:DS_ETC\"/><Cell row=\"3\" col=\"3\" edittype=\"none\" displaytype=\"buttoncontrol\" text=\"bind:ISSUE_ID\" border=\"1px solid #d2cfcd,0px solid #f2f2f2,1px solid #d2cfcd,1px solid #f2f2f2\"/><Cell row=\"3\" col=\"4\" edittype=\"none\" text=\"bind:CD_REF1\" displaytype=\"buttoncontrol\" border=\"1px solid #d2cfcd,1px solid #f2f2f2,1px solid #d2cfcd,0px solid #f2f2f2\"/></Band></Format></Formats>");
            this.divData1.form.divDataIssue.addChild(obj.name, obj);

            obj = new Div("divDataIssueSum","0","objGrid:10",null,null,"0","0",null,null,null,null,this.divData1.form.divDataIssue.form);
            obj.set_taborder("2");
            obj.set_text("");
            this.divData1.form.divDataIssue.addChild(obj.name, obj);

            obj = new Static("staAmCrSum",null,"0","250","30","0",null,null,null,null,null,this.divData1.form.divDataIssue.form.divDataIssueSum.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_font("bold 12px/normal \"Dotum\"");
            this.divData1.form.divDataIssue.form.divDataIssueSum.addChild(obj.name, obj);

            obj = new Static("staAmDrSum",null,"0","250","30","staAmCrSum:-1",null,null,null,null,null,this.divData1.form.divDataIssue.form.divDataIssueSum.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_textAlign("right");
            obj.set_font("bold 12px/normal \"Dotum\"");
            ...
            obj = new Static("sta21",null,"0","120","30","staAmDrSum:-1",null,null,null,null,null,this.divData1.form.divDataIssue.form.divDataIssueSum.form);
            obj.set_taborder("6");
            obj.set_text("전표합계");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData1.form.divDataIssue.form.divDataIssueSum.addChild(obj.name, obj);
            ...
            obj = new BindItem("item3","divData1.form.divDataIssue.form.sta12","text","dsList","TY_AUTOSLIP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divData1.form.divDataIssue.form.sta14","text","dsList","CD_TRADE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divData1.form.divDataIssue.form.sta16","text","dsList","DS_AUTOSLIP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHA_ISSUESLIP_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DH02";	// 결재유형등록 (DZR_AP_TYPES)
        ...
        this.fnSetVariable = function() {
        	...
        	this.dxGrid = this.divData1.form.divDataIssue.form.objGrid;
        	this.dxGrid.set_cssclass("grd_GC");

        	// 전표 합계 (차변 / 대변)
        	this.staAmDrSum = this.divData1.form.divDataIssue.form.divDataIssueSum.form.staAmDrSum;
        	this.staAmCrSum = this.divData1.form.divDataIssue.form.divDataIssueSum.form.staAmCrSum;
        };
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	//this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHAPR_SLIP_APPROVE");

        	//가로 스크롤이 생기지 않게 세팅
        	this.dxGrid.set_scrollbartype("none default");
        	this.dxGrid.setCellProperty("body", 13, "displaytype", "expr: (ISSUE_ID =='' || ISSUE_ID == null) ? 'none' : 'buttoncontrol'");
        	this.dxGrid.setCellProperty("body", 13, "text", "expr: (ISSUE_ID =='' || ISSUE_ID == null) ? '' : '전자'");

        	this.dxGrid.setCellProperty("body", 14, "displaytype", "expr:YN_FILE_EXIST =='Y' ? 'buttoncontrol' : 'none'");
        	this.dxGrid.setCellProperty("body", 14, "text", "expr:YN_FILE_EXIST =='Y' ? '첨부파일' : ''");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_TRADE", this.dsListMaster.getColumn(0, "V_PARAM01"));
        ...
        **************************************************************************************************/
        	...
        	if (svcID == "init") {
        		...
        		if (errorCode == 0) {
        			...
        			for (var i = 0; i < this.dsList.rowcount; i++) {
        				AmDrSum += nexacro.toNumber(this.gfnNvl(this.dsList.getColumn(i, "AM_DR"), 0));
        				AmCrSum += nexacro.toNumber(this.gfnNvl(this.dsList.getColumn(i, "AM_CR"), 0));
        			}

        			// 전표 합계 (차변 / 대변)
        			this.staAmDrSum.set_text(this.gfnAppendComma(AmDrSum));
        			this.staAmCrSum.set_text(this.gfnAppendComma(AmCrSum));
        ...
        this.fnPrint = function(svcID, val) {
        	...
        	var inParam 	= "params=dsListPrint";						// 조회SP이외 사용할 정보
         	...
         	var reportpath  = "/dh/dha/DHA_ISSUESLIP_APP.ozr";
        ...
        this.divData1_divDataIssue_objGrid_oncellclick = function(obj,e)
        {

        	var colnm = this.gfnGridGetBindColumnNameByIndex(obj, e.cell);
        	//trace(" colnm ->" + colnm + "\n e.cell ->" + e.cell + "\n e.col ->" + e.col);

        	var cdSlip = this.dsList.getColumn(e.row, "CD_SLIP");
        	var ynFileExist = this.dsList.getColumn(e.row, "YN_FILE_EXIST");
        	var issueId =  this.gfnTrim(this.dsList.getColumn(e.row, "ISSUE_ID"));
        	...
        	if(e.cell == 13){
        		var tySalebuy = this.dsList.getColumn(e.row, "TY_SALEBUY");
        		trace("전자 CD_SLIP->" + cdSlip + " / ISSUE_ID->" + issueId + " / TY_SALEBUY->" + tySalebuy) ;
        	...
        	if(e.cell == 14){
        		if(this.gfnIsNull(ynFileExist) || ynFileExist == "N") return;

        		//trace( sCdgubun + "첨부파일" + sProofUrl + "\n"  + "키1:" + sCdRef1 + "/ 키2:" + sCdRef2+ "/ 키3:" + sCdRef3 + "/ 키4:" + sCdRef4);

        		// 파일첨부 - 수정가능
        		var fileManager = {};
        		fileManager.IS_READONLY = false;	// (this.dsListMaster.getColumn(0, "BTNFILE") == "Y")
        		...
        		if(!this.gfnIsNull(sProofUrl)){
        			...
        			var cdDir = sCdRef1+sCdRef2+sCdRef3+sCdRef4+sCdRef5

        			fileManager.IS_READONLY = true;
        			fileManager.CD_GUBUN = sCdgubun;
        			fileManager.CD_DIR = [ cdDir ];
        		}else{
        			fileManager.CD_GUBUN = "DH03";
        			fileManager.CD_DIR = [ cdSlip];
        		}
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData1.form.divDataIssue.form.objGrid.addEventHandler("oncellclick",this.divData1_divDataIssue_objGrid_oncellclick,this);
        };
        this.loadIncludeScript("DHA_ISSUESLIP_APP.xfdl");
