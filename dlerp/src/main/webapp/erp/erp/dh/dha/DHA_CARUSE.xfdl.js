(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_CARUSE_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHAPR_CARUSE_INSERT</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DHAPR_CARUSE_DELETE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHAPR_CARUSE_UPDATE</Col></Row><Row><Col id=\"SP\">DHAPR_CARUSE_KMAFTER_SELECT</Col><Col id=\"TARGET\">selectCar</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHA_CARUSE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHA_CARUSE");
        ...
        this.loadIncludeScript("DHA_CARUSE.xfdl");
