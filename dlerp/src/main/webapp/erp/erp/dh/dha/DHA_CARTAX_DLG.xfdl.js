(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">slip</Col><Col id=\"SP\">DHAPR_CARTAX_AUTOSLIP_ISSUE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHA_CARTAX_DLG.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_CAR)) {
        		...
        		this.dsList.setColumn(0, "AMT_TAX", this.getOwnerFrame().AMT_TAX);
        ...
        this.dlgfnSave = function() {
        	...
        	this.dsSlip.setColumn(nrow, "AMT_TAX", this.dsList.getColumn(0, "AMT_TAX"));
        ...
        this.loadIncludeScript("DHA_CARTAX_DLG.xfdl");
