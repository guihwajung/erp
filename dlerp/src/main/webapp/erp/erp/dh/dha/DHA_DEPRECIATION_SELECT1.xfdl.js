(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_LA_NORSK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHAPR_LA_NORSK_CALC</Col></Row><Row><Col id=\"TARGET\">cancel</Col><Col id=\"SP\">DHAPR_LA_NORSK_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHA_DEPRECIATION_SELECT1.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnCalc = this.gfnFormButtonAdd("Calc", "fnCalc", "정상상각 자료생성");
        	this.btnCalcCan = this.gfnFormButtonAdd("CalcCan", "fnCalcCan", "정상상각 자료삭제");

        	this.btnCalc.set_enable(false);
        	this.btnCalcCan.set_enable(false);
        };
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHA_DEPRECIATION_SELECT1");
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	...
        	if(svcID == "select") {
        		if (this.dxGrid.rowcount > 0) {
        			...
        			this.btnCalcCan.set_enable(true);
        		}
        		...
        		this.gfnAlert("정상상각 자료생성작업이 완료되었습니다.");
        		...
        		this.gfnAlert("정상상각 자료삭제작업이 완료되었습니다.");
        ...
        this.fnCalc = function(obj,e) {
        	this.gfnConfirm("정상상각 자료를 생성 하시겠습니까?", "fnCalc_callback");
        }

        this.fnCalc_callback = function(strId, val)
        {
        	if(val == true) {
        ...
        this.fnCalcCan = function(obj,e) {
        	this.gfnConfirm("정상상각 자료삭제를 하시겠습니까?", "fnCalcCancel_callback");
        }
        ...
        this.fnCalcCancel_callback = function(strId, val)
        {
        	...
        	this.dsDelete.setColumn(0, "CD_CORP", this.gfnTrim(this.ccfCorp.form.CDTextBox.value));
        ...
        this.loadIncludeScript("DHA_DEPRECIATION_SELECT1.xfdl");
