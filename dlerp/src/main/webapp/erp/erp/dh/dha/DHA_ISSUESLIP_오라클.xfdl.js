(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("txtCD_TRADE","sta06:0.0","10.0","210","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_color("royalblue");
            ...
            obj = new Static("sta01","1005","2","95","30",null,null,null,null,null,null,this.divData.form.divDataBottom.form.divTotal.form);
            obj.set_taborder("11");
            obj.set_text("전표마감일");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textDecoration("none");
            ...
            obj = new Edit("txtDT_MAGAM","1105","7","80","20",null,null,null,null,null,null,this.divData.form.divDataBottom.form.divTotal.form);
            obj.set_taborder("10");
            obj.set_maxlength("7");
            obj.set_enable("false");
            obj.set_visible("true");
            ...
            obj = new Grid("objGrid","0","sta01:6",null,null,"0","3",null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.form.divDataTop.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHA_ISSUESLIP_오라클.xfdl", function() {
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("DHA_ISSUESLIP_오라클.xfdl");
