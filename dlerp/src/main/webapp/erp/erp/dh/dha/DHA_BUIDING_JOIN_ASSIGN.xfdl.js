(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_BUIDING_JOIN_ASSIGN_SELECT</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DHAPR_BUIDING_JOIN_ASSIGN_SELECT1</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DHAPR_BUIDING_JOIN_ASSIGN_SELECT2</Col></Row><Row><Col id=\"TARGET\">select3</Col><Col id=\"SP\">DHAPR_BUIDING_JOIN_ASSIGN_SELECT3</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DHAPR_BUIDING_JOIN_ASSIGN_WRITE</Col></Row><Row><Col id=\"SP\">DHAPR_BUIDING_JOIN_ASSIGN_SELECT_HEAD</Col><Col id=\"TARGET\">selectHeader</Col></Row><Row><Col id=\"TARGET\">cdSlipSelect</Col><Col id=\"SP\">DHAPR_BUIDING_DIV_COST2_AUTOSLIP_SELECT</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DHAPR_BUIDING_DIV_COST2_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DHAPR_BUIDING_DIV_COST2_AUTOSLIP_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new PopupDiv("pdvCdSlip","837","27","433","245",null,null,null,null,null,null,this.divData.form);
            obj.set_text("pdiv00");
            ...
            obj = new Static("sta00","41","10",null,"17","42",null,null,null,null,null,this.divData.form.pdvCdSlip.form);
            obj.set_taborder("0");
            obj.set_text("전표번호를 선택하세요.");
            obj.set_textAlign("center");
            this.divData.form.pdvCdSlip.addChild(obj.name, obj);

            obj = new Grid("grd","10","40",null,null,"13","45",null,null,null,null,this.divData.form.pdvCdSlip.form);
            obj.set_taborder("1");
            ...
            obj = new Button("btnConfirm","160","210","60","21",null,null,null,null,null,null,this.divData.form.pdvCdSlip.form);
            obj.set_taborder("2");
            obj.set_text("확인");
            this.divData.form.pdvCdSlip.addChild(obj.name, obj);

            obj = new Button("btnCancel","230","210","60","21",null,null,null,null,null,null,this.divData.form.pdvCdSlip.form);
            obj.set_taborder("3");
            obj.set_text("취소");
            this.divData.form.pdvCdSlip.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DHA_BUIDING_JOIN_ASSIGN.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.pdvCdSlip.form.grd.addEventHandler("oncelldblclick",this.pdvCdSlip_grd_oncelldblclick,this);
            this.divData.form.pdvCdSlip.form.btnConfirm.addEventHandler("onclick",this.pdvCdSlip_btnConfirm_onclick,this);
            this.divData.form.pdvCdSlip.form.btnCancel.addEventHandler("onclick",this.pdvCdSlip_btnCancel_onclick,this);
        };
        this.loadIncludeScript("DHA_BUIDING_JOIN_ASSIGN.xfdl");
