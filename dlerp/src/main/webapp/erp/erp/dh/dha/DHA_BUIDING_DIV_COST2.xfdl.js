(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("건물공동운영안분(원가집계)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_BUIDING_JOIN_SPEND_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHAPR_BUIDING_JOIN_SPEND_UPDATE</Col></Row><Row><Col id=\"TARGET\">write</Col><Col id=\"SP\">DHAPR_BUIDING_JOIN_SPEND_WRITE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00","rdo00:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("법인코드");
            ...
            obj = new Static("staYM_WORK","ccfDEPT:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("작업년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("sta02","ctclDT_WORK:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("원가발생현장");
        ...
        // User Script
        this.registerScript("DHA_BUIDING_DIV_COST2.xfdl", function() {
        ...
        this.loadIncludeScript("DHA_BUIDING_DIV_COST2.xfdl");
