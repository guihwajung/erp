(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHVPR_DIVDEPT_SITE_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHVPR_DIVDEPT_SITE_UPDATE</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DHVPR_DIVDEPT_MAGAM_SITE</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DHVPR_DIVDEPT_SITE_DHV0096</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DHVPR_DIVDEPT_SITE_ISSUECANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHV_DIVDEPT_SITE_ALL.xfdl", function() {
        ...
        this.loadIncludeScript("DHV_DIVDEPT_SITE_ALL.xfdl");
