(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHVPR_ZERO_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHVPR_ZERO_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHVPR_ZERO_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DHVPR_ZERO_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHV_ZERO.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHV_ZERO");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsDelete.addColumn("TY_GUBUN", "bigdecimal");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "TY_GUBUN", this.dsList.getColumn(i, "CD_CODE"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "TY_GUBUN", this.dsList.getColumn(i, "CD_CODE"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "TY_GUBUN", this.dsList.getColumn(i, "CD_CODE"));
        				break;
        		}
        	}
        ...
        this.dsList_onvaluechanged = function(obj,e)
        {
        	if (e.columnid == "AM_WON" ) {
        		if (e.oldvalue != e.newvalue) { // 합계 구하기
        			var nRow19 = obj.findRow( "CD_CODE", "19" ); // 부가세법 합계
        			var nRow37 = obj.findRow( "CD_CODE", "37" ); // 조특법 합계
        			var nRow38 = obj.findRow( "CD_CODE", "38" ); // 총 합계
        			var nSum2 = 0 , nSum1 = 0 ;
        			var nallSum = 0 ;
        			var tyGubun = "" ;

        			for (var i= 0; i<obj.rowcount; i++) {
        			   tyGubun = this.dsList.getColumn(i, "CD_CODE");
        			   var amWon = nexacro.toNumber(this.dsList.getColumn(i,"AM_WON"),0);
        			   //trace(" tyGubun =>" + tyGubun + " , amWon=>" + amWon);
        			   if (amWon != 0 && tyGubun != "19" && tyGubun != "37"  && tyGubun != "38") {
        			    nallSum = nallSum + amWon;
        				if ( this.gfnLeft(tyGubun,1) == "1")
        				{ // 조특법
        					nSum1 = nSum1 + amWon;
        				} else
        				{	// 부가세법
        ...
        //			trace(" nallSum=>" + nallSum);
        // 			trace(" nSum1=>" + nSum1);
        // 			trace(" nSum2=>" + nSum2);
        			this.dsList.setColumn(nRow19, "AM_WON" , nSum2);
        			this.dsList.setColumn(nRow37, "AM_WON" , nSum1);
        			this.dsList.setColumn(nRow38, "AM_WON" , nallSum);
        		}
        	}
        }
        ...
        this.loadIncludeScript("DHV_ZERO.xfdl");
