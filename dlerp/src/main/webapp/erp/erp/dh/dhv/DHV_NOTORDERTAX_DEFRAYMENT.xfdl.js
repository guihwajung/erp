(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHVPR_NOTORDERTAX_DEFRAYMENT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_DELETE</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_CANCELSLIP</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_PRINT</Col></Row><Row><Col id=\"TARGET\">linkCancel</Col><Col id=\"SP\">DHVPR_DOMESTICTAX_SLIP_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("txtCD_SLIP","978","staCD_CORP:-24","280","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
        ...
        // User Script
        this.registerScript("DHV_NOTORDERTAX_DEFRAYMENT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHV_NOTORDERTAX_DEFRAYMENT");
        ...
        this.fnGrid_AfterEdit = function(obj,e) {
        	...
        	if (this.dsList.getColumn(e.row, "TY_VENDOR") != "P")  // 법인이면 법인세계산 처리
        ...
        this.fnGrid_BeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	var tyIncome = "43" //this.dsList.getColumn(this.dsList.rowposition, "TY_INCOMETYPE");
        	switch(id) {
        ...
        this.dsInsertMake = function(nrow, i) {
        	...
        	this.dsInsert.setColumn(nrow, "TY_INCOMETYPE", "43");
        ...
        this.dsUpdateMake = function(nrow, i) {
        	...
        	this.dsUpdate.setColumn(nrow, "TY_INCOMETYPE", "43");
        }
        ...
        */
        ...
        this.loadIncludeScript("DHV_NOTORDERTAX_DEFRAYMENT.xfdl");
