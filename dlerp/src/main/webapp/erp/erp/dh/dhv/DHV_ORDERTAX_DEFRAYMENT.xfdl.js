(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_DELETE</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_CANCELSLIP</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DHVPR_ORDERTAX_DEFRAYMENT_PRINT</Col></Row><Row><Col id=\"TARGET\">linkCancel</Col><Col id=\"SP\">DHVPR_DOMESTICTAX_SLIP_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_DEPT_ACNT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT_BH\" type=\"STRING\" size=\"256\"/><Column id=\"YM_IMPUTE_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"YM_IMPUTE_TO\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SLIP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_INCOMETYPE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_DEPT_ACNT\"/><Col id=\"YM_IMPUTE_FROM\"/><Col id=\"YM_IMPUTE_TO\"/><Col id=\"CD_VENDOR\"/><Col id=\"TY_GUBUN\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_SLIP","ccfCD_VENDOR:0.0","staCD_CORP:10.0","92","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_text("소득구분");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Edit("txtCD_SLIP","staCD_SLIP:176","staCD_CORP:-24","280","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_visible("false");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_INCOMETYPE","803","44","147","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_visible("false");
            var divSearch_form_ccboTY_INCOMETYPE_innerdataset = new nexacro.NormalDataset("divSearch_form_ccboTY_INCOMETYPE_innerdataset", obj);
            divSearch_form_ccboTY_INCOMETYPE_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"datacolumn\">전체</Col><Col id=\"codecolumn\"/></Row><Row><Col id=\"datacolumn\">기타소득</Col><Col id=\"codecolumn\">42</Col></Row><Row><Col id=\"codecolumn\">43</Col><Col id=\"datacolumn\">기타소득(비거주사업기타)</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_ccboTY_INCOMETYPE_innerdataset);
            obj.set_text("기타소득");
            obj.set_value("42");
            obj.set_index("1");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item8","divSearch.form.ccboTY_INCOMETYPE","value","dsSearch","YN_RESIDENT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHV_ORDERTAX_DEFRAYMENT.xfdl", function() {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.ccboTY_INCOMETYPE.addEventHandler("onitemchanged",this.fnSearchInit,this);
        ...
        this.loadIncludeScript("DHV_ORDERTAX_DEFRAYMENT.xfdl");
