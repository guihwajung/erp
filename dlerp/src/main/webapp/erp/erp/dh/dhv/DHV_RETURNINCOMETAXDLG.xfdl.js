(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHVPR_RETURNINCOMETAXDLG_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"YR_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("staTitle","0","10",null,"22","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("원천징수신고내역");
            ...
            obj = new Static("staCD_GUBUN","210","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("소득구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta03","-2","10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("귀속연도");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_GUBUN","302","10","259","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("ctclYR_WORK","85","10","60","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new BindItem("item1","divSearch.form.ccfCD_GUBUN.form.CDTextBox","value","dsSearch","CD_GUBUN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHV_RETURNINCOMETAXDLG.xfdl", function() {
        ...
        //	trace(" YR_WORK=>" + this.getOwnerFrame().YR_WORK);
        ...
        this.fnSetEvent = function() {
        	...
        	//소득구분
         	this.ccfCD_GUBUN.CodeFindName = "DHX_COMMON_CODEFIND_SELECT_MULTI";
         	this.ccfCD_GUBUN.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        	this.ccfCD_GUBUN.AfterCDTextChanged = "fnAfterCDTextChanged";

        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHV_RETURNINCOMETAXDLG");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_GUBUN" , this.ccfCD_GUBUN.form.CDTextBox.value);  	// 소득구분
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.ccfCD_GUBUN.form.CDTextBox.value)) {
        		//validate = false;
        		this.gfnAlert("소득구분 필수입니다.");
        		this.ccfCD_GUBUN.form.CDTextBox.setFocus();
        		return false;
        	}
        ...
        */
        	...
        	switch(id) {
        		...
        		case "ccfCD_GUBUN":	//소득구분
        			if (arrData.length > 0) {
        				...
        				this.ccfCD_GUBUN.form.CDTextBox.set_value(strCdCode);
        				this.ccfCD_GUBUN.form.DSTextBox.set_value(strDsCode);
        			}
        		break;
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	switch(id) {
        		...
        		case "ccfCD_GUBUN":		//소득구분
        			...
        			dsUserParam.setColumn(nrow, "CD_TYPE"	, "V24");					//공통분류코드
        			break;
        	}
        ...
        this.btnConf_onclick = function(obj,e)
        {
        	...
        	//팝업 닫기 처리
        	this.getParentContext().close(this.dsResultIncomeTax.saveXML());
        };
        ...
        this.fnSetParentsData = function(){
        	...
        	this.dsResultIncomeTax.set_enableevent(false);

        	//컬럼/데이터 복사
        	this.dsResultIncomeTax.assign(this.dsList);

        	var arrDel = [];
         	for(var i =0;i<this.dsResultIncomeTax.getRowCountNF();i++){
        		this.dsResultIncomeTax.setColumnNF(i, this.ucFlag, "I");
        		//미선택/필터 로우 제외
        	...
        	//미선택 데이터 삭제
        	this.dsResultIncomeTax.deleteMultiRows(arrDel);

        	this.dsResultIncomeTax.set_enableevent(true);
        ...
        this.loadIncludeScript("DHV_RETURNINCOMETAXDLG.xfdl");
