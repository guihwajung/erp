(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHFPR_PL_DEPT_SELECT</Col></Row><Row><Col id=\"TARGET\">selectHeader</Col><Col id=\"SP\">DHFPR_PL_DEPT_HEADER_SELECT</Col></Row><Row><Col id=\"TARGET\">selectG</Col><Col id=\"SP\">DHFPR_PL_GROUP_SELECT</Col></Row><Row><Col id=\"TARGET\">selectHeaderG</Col><Col id=\"SP\">DHFPR_PL_GROUP_HEADER_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"TY_DT\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SITE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_ID","ccfCD_CORP:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("회계년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYM_WORK","staNO_ID:0.0","10.0","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Radio("rdoTY_DT","ctclYM_WORK:0.0","10.0","104","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_direction("vertical");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var divSearch_form_rdoTY_DT_innerdataset = new nexacro.NormalDataset("divSearch_form_rdoTY_DT_innerdataset", obj);
            divSearch_form_rdoTY_DT_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">월</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">누계</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_rdoTY_DT_innerdataset);
            this.divSearch.addChild(obj.name, obj);

            obj = new Radio("rdoTY_SITE","rdoTY_DT:0.0","10.0","204","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_direction("vertical");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var divSearch_form_rdoTY_SITE_innerdataset = new nexacro.NormalDataset("divSearch_form_rdoTY_SITE_innerdataset", obj);
            divSearch_form_rdoTY_SITE_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">D</Col><Col id=\"datacolumn\">사업장별</Col></Row><Row><Col id=\"codecolumn\">G</Col><Col id=\"datacolumn\">사업장그룹별</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_rdoTY_SITE_innerdataset);
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item5","divSearch.form.rdoTY_DT","value","dsSearch","TY_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.rdoTY_SITE","value","dsSearch","TY_SITE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHE_SITE_PL.xfdl", function() {
        ...
        this.loadIncludeScript("DHE_SITE_PL.xfdl");
