(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staCD_SYSTEM00_00","1112","10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_text("구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_PRINT","1176","10","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            ...
            obj = new BindItem("item9","divSearch.form.ccfCD_ACNT.form.CDTextBox","value","dsSearch","CD_ACNT_FROM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item5","divSearch.form.ccfCD_ACNT.form.DSTextBox","value","dsSearch","DS_ACNT_FROM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divSearch.form.ccboTY_PRINT","value","dsSearch","TY_PRINT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHE_ACCOUNTSELECT_MULTI.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
            ...
            this.amSum= 0   // 차변 - 대변 합계
        	this.amExec = 0   // 집행화 차변 - 대변 합계
        	this.amLocal = 0  // 로컬화 차변 - 대변 합계
        	this.amCha = 0 // 차액 합계
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_CORP_REC)) {
        		...
        		if(idForm == "DHD_PREPAY_SLIP"){	//건설중인 자산관리
        ...
        this.fnSetVariable = function() {
        	...
        	var nWidth = nexacro.toNumber(this.ccfCD_ACNT.form.CDTextBox.width) + 100;
        	this.ccfCD_ACNT.form.CDTextBox.set_width(nWidth);

        	nWidth = nWidth + nexacro.toNumber(this.ccfCD_ACNT.form.CDTextBox.left) + 3;
        	this.ccfCD_ACNT.form.BtnSearch.set_left(nWidth);

        	nWidth = nWidth + nexacro.toNumber(this.ccfCD_ACNT.form.BtnSearch.width) + 3;
        	this.ccfCD_ACNT.form.DSTextBox.set_left(nWidth);
        };
        ...
        //	this.ccfCD_CON.CodeFindName = "DHX_CFALLVENDOR_CODEFIND_MULTI";	// 거래처멀티
        ...
        //	this.ccfCD_CON.AfterCDTextChanged = "fnAfterCDTextChanged";	// 거래처 멀티로 사용할때 사용함
        }
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(nRow, "CD_ACNT_FROM", CD_ACNT_FROM);
        	//this.dsSelect.setColumn(nRow, "CD_ACNT_TO", this.gfnNvl(CD_ACNT_TO, "949000"));
        	this.dsSelect.setColumn(nRow, "YN_MULTI", "Y");
        ...
        this.fnPrint = function() {
        	...
        	var inData      = "select=dsSelect";
        	var reportpath  = "/dh/dhe/DHE_ACCOUNTSELECT_MULTI.ozr";
        ...
        this.fnAfterCDTextChanged = function(id, codeFindData)
        {
        	...
        	if(id == "ccfCD_CON") {
        		...
        		if (arr.length > 0) {
        			for(var r = 0; r < arr.length; r++) {
        				strCd += arr[r]["CD_VENDOR"]+",";
        				strDs += arr[r]["DS_VENDOR"]+",";
        			}

        			this.ccfCD_CON.form.CDTextBox.set_value(strCd.substr(0,strCd.length-1));
        			this.ccfCD_CON.form.DSTextBox.set_value(strDs.substr(0,strDs.length-1));
        		}
        	}
        }
        ...
        // 	var sumDr = 0
        // 	var sumCr = 0
        // 	if(colnm =="AM_DR" || colnm == "AM_EXEC_DR" || colnm == "AM_LOCAL_DR"){
        // 		for(var i = 0; i < rows.length; i++) {
        // 			var am = objDs.getColumn(rows[i], colnm);
        //
        // 			bRet = isNaN(am); // 문자:true, 숫자:false
        ...
        // 				sumDr += nexacro.toNumber(am, 0);
        // 			}
        // 		}
        // 	}
        // 	if(colnm =="AM_CR" || colnm == "AM_EXEC_CR" || colnm == "AM_LOCAL_CR"){
        // 		for(var i = 0; i < rows.length; i++) {
        // 			var am = objDs.getColumn(rows[i], colnm);
        //
        // 			bRet = isNaN(am); // 문자:true, 숫자:false
        ...
        this.fnGrid_onlbuttondown = function(obj,e)
        {
        	...
        	trace("fnGrid_onlbuttondown: "+ this.IsCtrl);
        };
        ...
        this.loadIncludeScript("DHE_ACCOUNTSELECT_MULTI.xfdl");
