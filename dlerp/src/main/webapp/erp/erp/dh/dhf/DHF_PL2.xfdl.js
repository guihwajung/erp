(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHFPR_PL_SELECT1</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DHFPR_PL_SELECT1</Col></Row><Row><Col id=\"TARGET\">selectYmMagam</Col><Col id=\"SP\">DHXPR_ACNTUNIT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DHFPR_PL_PERIOD_SELECT2</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT </Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsYN_FLAG", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">N</Col><Col id=\"VALUE\">상세</Col></Row><Row><Col id=\"CODE\">Y</Col><Col id=\"VALUE\">요약</Col></Row><Row><Col id=\"CODE\">X</Col><Col id=\"VALUE\">포괄</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"YN_FLAG\" type=\"STRING\" size=\"256\"/><Column id=\"YM_MAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"YM_MAGAM2\" type=\"STRING\" size=\"256\"/><Column id=\"DS_COMPANYNAME\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SEARCH\" type=\"STRING\" size=\"256\"/><Column id=\"YM_MAGAMTO\" type=\"STRING\" size=\"256\"/><Column id=\"YM_MAGAM2TO\" type=\"STRING\" size=\"256\"/><Column id=\"TY_PRINT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_DEPT","ccfCD_CORP:-321","44","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("귀속부서");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_DEPT","staCD_DEPT:0","44","230","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("8");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Radio("crdoTY_SEARCH","514","44","104","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            ...
            obj = new Static("staNO_ID","650","10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("회계년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta00","staNO_ID:-28","10","66","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("당기");
            ...
            obj = new Div("ctclYM_WORK","sta00:5","10","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta01","sta00:-66","44","66","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("전기");
            obj.set_textAlign("center");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Div("ctclYM_WORK2","sta00:5","44","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_url("cmm::cmmCalMM.xfdl");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Radio("rdoCD_CURR","staTY_GUBUN:99","10","120","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            ...
            obj = new Div("ctclYM_WORKTO","ctclYM_WORK:18","10","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYM_WORK2TO","ctclYM_WORK2:18","44","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("16");
            obj.set_url("cmm::cmmCalMM.xfdl");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staDT_WORK","ctclYM_WORK:-6","10","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_text("~");
            ...
            obj = new Static("staDT_WORK2","ctclYM_WORK2:-6","44","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            obj.set_text("~");
            obj.set_visible("false");
            obj.set_cssclass("sta_WF_AC");
            ...
            obj = new Static("staCD_SYSTEM00_00","324","44","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("17");
            obj.set_text("출력구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_PRINT","414","44","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("18");
            ...
            obj = new BindItem("item8","divSearch.form.crdoTY_SEARCH","value","dsSearch","TY_SEARCH");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divSearch.form.ctclYM_WORKTO.form.TextBox","value","dsSearch","YM_MAGAMTO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divSearch.form.ctclYM_WORK2TO.form.TextBox","value","dsSearch","YM_MAGAM2TO");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item11","divSearch.form.ccboTY_PRINT","value","dsSearch","TY_PRINT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHF_PL2.xfdl", function() {
        ...
        this.loadIncludeScript("DHF_PL2.xfdl");
