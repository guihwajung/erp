(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staYM_MAGAM","ccfCD_DEPT:0.0","staCD_DEPT_ORG:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("회계년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_SYSTEM00_00","526","10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("출력구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_PRINT","615","10","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            ...
            obj = new BindItem("item4","divSearch.form.ccboTY_PRINT","value","dsSearch","TY_PRINT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHF_PLMONTH.xfdl", function() {
        ...
        this.loadIncludeScript("DHF_PLMONTH.xfdl");
