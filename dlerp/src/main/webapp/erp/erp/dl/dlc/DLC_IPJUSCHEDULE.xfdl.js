(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRDPR_ADJUST_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DLCPR_ADJUST_UPDATE</Col></Row><Row><Col id=\"TARGET\">selectSub</Col><Col id=\"SP\">DRDPR_IPJUSCHEDULE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnConf",null,"5","70","20","5",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("2");
            obj.set_text("입주증출력");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("staBgDT_IPJUSTART","staDT_IPJUSTART:-1","divSplitter:10","550","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_FIPJU","staBgDT_IPJU:-1","staBgDT_IPJUSTART:0","130","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("1");
            obj.set_text("입주기산일자");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new Static("staBgDT_FIPJU","staDT_FIPJU:-1","staBgDT_IPJUSTART:0","176","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_FIPJU","staDT_FIPJU:5","staBgDT_IPJU:-25","105","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("16");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Static("staBgElev","staElev:-1","staDT_IPJU:0","550","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("staBgYN_REGISTRYFEE","staYN_REGISTRYFEE:-1","staElev:0","550","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("staBgYN_LAWPAPER","staYN_LAWPAPER:-1","staYN_REGISTRYFEE:0","550","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new BindItem("item22","divData.form.divDataTop.form.ctclDT_FIPJU","value","dsList","DT_FIPJU");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DLC_IPJUSCHEDULE.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsList.setColumn(0, "DT_IPJU", this.gfnGetDate());
        	this.dsList.setColumn(0, "DT_FROM", this.gfnAddMonth(this.gfnGetDate(),-3));
        	this.dsList.setColumn(0, "DT_TO",   this.gfnGetDate());
        ...
        this.fnSetVariable = function() {
        	...
        	this.ctclDT_FIPJU = this.divData.form.divDataTop.form.ctclDT_FIPJU;
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList2, "DL", "DLC_IPJUSCHEDULE");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("DT_FIPJU", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsUpdate.setColumn(nrow, "YN_REGISTRYFEE", this.dsList.getColumn(i, "YN_REGISTRYFEE"));
        				this.dsUpdate.setColumn(nrow, "TY_LIVING", this.dsList.getColumn(i, "TY_LIVING"));
        				this.dsUpdate.setColumn(nrow, "DT_IPJU", this.dsList.getColumn(i, "DT_IPJU"));
        				this.dsUpdate.setColumn(nrow, "DT_FIPJU", this.dsList.getColumn(i, "DT_FIPJU"));
        				this.dsUpdate.setColumn(nrow, "YN_JUNGSAN", this.dsList.getColumn(i, "YN_JUNGSAN"));
        				this.dsUpdate.setColumn(nrow, "YN_LOAN", this.dsList.getColumn(i, "YN_LOAN"));
        				this.dsUpdate.setColumn(nrow, "YN_LAWPAPER", this.dsList.getColumn(i, "YN_LAWPAPER"));
        				this.dsUpdate.setColumn(nrow, "TM_PLAN_FR", this.dsList.getColumn(i, "TM_PLAN_FR"));
        				this.dsUpdate.setColumn(nrow, "TM_PLAN_TO", this.dsList.getColumn(i, "TM_PLAN_TO"));
        ...
        this.fnSaveValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsList.getColumn(0, "DT_IPJU")) && this.gfnIsNull(this.dsList.getColumn(0, "TM_PLAN_FR")) || this.gfnIsNull(this.dsList.getColumn(0, "TM_PLAN_TO"))) {
        		strMsg += "입주예정일자/시간를 입력하지 않았습니다.\n";
        		validate = false;
        	}
        	if (!validate) {
        ...
        {
        	if(this.dsList.getColumn(0,"YN_JUNGSAN") == "2"){
        ...
        this.loadIncludeScript("DLC_IPJUSCHEDULE.xfdl");
