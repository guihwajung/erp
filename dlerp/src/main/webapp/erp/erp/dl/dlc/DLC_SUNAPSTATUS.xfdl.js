(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLCPR_RECEIVEDSTATUS_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_IPJUSTATE", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" size=\"256\"/><Column id=\"DS_CODE\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\"/><Col id=\"DS_CODE\">전체보기</Col></Row><Row><Col id=\"CD_CODE\">입주</Col><Col id=\"DS_CODE\">입주세대</Col></Row><Row><Col id=\"CD_CODE\">해지신청</Col><Col id=\"DS_CODE\">해지신청</Col></Row><Row><Col id=\"CD_CODE\">미계약</Col><Col id=\"DS_CODE\">미계약세대</Col></Row><Row><Col id=\"CD_CODE\">잔금미납</Col><Col id=\"DS_CODE\">잔금미납세대</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_IPJUSTATE","ccfCD_ACNTUNIT:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("입주상태");
            ...
            obj = new Combo("ccboTY_IPJUSTATE","staTY_IPJUSTATE:0.0","10.0","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_innerdataset("dsTY_IPJUSTATE");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staContent","ccboTY_IPJUSTATE:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("동층호");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
        ...
        // User Script
        this.registerScript("DLC_SUNAPSTATUS.xfdl", function() {
        ...
        this.fngrid_onCellDblClickHandler = function(obj,e)
        {
        	this.fnDetailView();
        };
        ...
        this.loadIncludeScript("DLC_SUNAPSTATUS.xfdl");
