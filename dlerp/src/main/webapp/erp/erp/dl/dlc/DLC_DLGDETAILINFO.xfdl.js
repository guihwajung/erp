(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLBPR_PERSONALDAILYRECEIPT_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_text("일자별납입금조회");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnConf","115",null,"70","20",null,"20",null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("확인");
            this.divData.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","40",null,null,"0","60",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DLC_DLGDETAILINFO.xfdl", function() {
        ...
        this.loadIncludeScript("DLC_DLGDETAILINFO.xfdl");
