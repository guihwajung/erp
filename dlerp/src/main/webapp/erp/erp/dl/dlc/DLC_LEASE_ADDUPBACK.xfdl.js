(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLCPR_LEASE_ADDUPBACK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DLCPR_LEASE_ADDUPBACK_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DLCPR_LEASE_ADDUPBACK_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DLCPR_LEASE_ADDUPBACK_DELETE</Col></Row><Row><Col id=\"TARGET\">issue</Col><Col id=\"SP\">DLCPR_ADDUPBACK_AUTOSLIP_APPRO</Col></Row><Row><Col id=\"TARGET\">cancel</Col><Col id=\"SP\">DLCPR_ADDUPBACK_AUTOSLIP_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLC_LEASE_ADDUPBACK.xfdl", function() {
        ...
        this.divData_divDataBottom_btnAddUpBack_onclick = function(obj,e) {
        	...
        	if(ty_process == "1"){
        		if (this.gfnIsNull(cd_cms) || cd_cms == "") {
        			...
        			this.gfnFormOpen("DLC", "DLC_DLGADDUPBACK", "fnAddCallback", param);
        		}
        	}
        	 else {
        ...
        this.loadIncludeScript("DLC_LEASE_ADDUPBACK.xfdl");
