(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRCPR_PAYBACK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRCPR_PAYBACK_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRCPR_PAYBACK_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRCPR_PAYBACK_DELETE</Col></Row><Row><Col id=\"SP\">DRCPR_PAYBACK_AUTOSLIP_APPRO</Col><Col id=\"TARGET\">issue</Col></Row><Row><Col id=\"SP\">DRCPR_PAYBACK_AUTOSLIP_CANCEL</Col><Col id=\"TARGET\">cancel</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnAddUpBack",null,"0","80","22","0",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("2");
            obj.set_text("반제처리");
        ...
        // User Script
        this.registerScript("DLB_APPROBACK.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DR", "DRC_APPROBACK");
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRC_APPROBACK_B");
        ...
        this.divData_divDataBottom_btnAddUpBack_onclick = function(obj,e) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataBottom.form.btnAddUpBack.addEventHandler("onclick",this.divData_divDataBottom_btnAddUpBack_onclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DLB_APPROBACK.xfdl");
