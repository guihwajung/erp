(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRCPR_ADDUPBACK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRCPR_ADDUPBACK_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRCPR_ADDUPBACK_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRCPR_ADDUPBACK_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLB_ADDUPBACK.xfdl", function() {
        ...
        // 	this.gfnGridInit(this.dxGrid1, this.dsList1, "DL", "DLB_ADDUPBACK1");
        // 	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLB_ADDUPBACK2");

        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DR", "DRC_ADDUPBACK");
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRC_ADDUPBACK_B");

         	this.gfnGridColumnColor(this.dxGrid, "DT_REFUND", "BACK_ReadOnly", "TY_PROCESS=='3'");
         	this.gfnGridColumnColor(this.dxGrid, "DS_OWNER", "BACK_ReadOnly", "TY_PROCESS=='3'");
        ...
        // 		if (this.dsList.getColumn(e.row, "TY_PROCESS") == "1" && this.gfnIsNull(this.dsList.getColumn(e.row, "CD_CMS"))) {
        // 			this.btnAddUpBack.set_enable(true);
        // 		}
        // 		else {
        // 			this.btnAddUpBack.set_enable(false);
        ...
        //
        // 	this.gfnFormOpen("DLB", "DLB_DLGADDUPBACK", "", param);
        // };
        ...
        this.loadIncludeScript("DLB_ADDUPBACK.xfdl");
