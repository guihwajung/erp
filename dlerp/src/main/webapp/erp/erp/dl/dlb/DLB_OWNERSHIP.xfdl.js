(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLBPR_OwnerShip_Select</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRDPR_OWNERSHIP_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRDPR_OWNERSHIP_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRDPR_OWNERSHIP_DELETE</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("DLB_OWNERSHIP.xfdl", function() {
        ...
        this.loadIncludeScript("DLB_OWNERSHIP.xfdl");
