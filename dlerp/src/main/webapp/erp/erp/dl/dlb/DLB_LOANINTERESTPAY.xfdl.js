(function()
{
    return function()
    {
        ...
        {
            this.set_name("DLB_LOANINTERESTPAY");
            this.set_titletext("융자이자대납관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLB_LOANINTERESTPAY.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLB_LOANINTERESTPAY");
        ...
        this.loadIncludeScript("DLB_LOANINTERESTPAY.xfdl");
