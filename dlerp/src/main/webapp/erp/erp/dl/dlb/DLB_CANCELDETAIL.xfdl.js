(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLBPR_CANCEL_DETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DLBPR_CANCEL_UPDATE</Col></Row><Row><Col id=\"TARGET\">selectReceived</Col><Col id=\"SP\">DLBPR_CANCEL_RECEIVED_SELECT</Col></Row><Row><Col id=\"TARGET\">selectLaw</Col><Col id=\"SP\">DLBPR_CANCEL_LAWSUIT_SELECT</Col></Row><Row><Col id=\"TARGET\">selectLoan</Col><Col id=\"SP\">DLBPR_CANCEL_LAWSUIT_SELECT</Col></Row><Row><Col id=\"TARGET\">selectAppro</Col><Col id=\"SP\">DLBPR_CANCEL_APPROPRIATE_SELECT</Col></Row><Row><Col id=\"TARGET\">selectPayback</Col><Col id=\"SP\">DLFPR_PAYBACK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRFPR_IND_RTDELAY_INSERT</Col></Row><Row><Col id=\"TARGET\">cancelRestore</Col><Col id=\"SP\">DLBPR_CANCEL_RESTORE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("statxtAM_PAYMENT","sta27:-1","sta24:-1","766","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("88");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("edttxtCD_BANK_CANCEL","124","sta24:5","135","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("89");
            obj.set_enable("false");
            obj.set_readonly("true");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Edit("edttxtDS_BANK_CANCEL","statxtBANK:10","sta24:4","268","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("91");
            obj.set_enable("false");
            obj.set_readonly("true");
            this.divData.addChild(obj.name, obj);

            obj = new Tab("tabData","0","486",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("92");
            obj.set_tabindex("0");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Grid("objGridAppro","0","0","30%",null,null,"0",null,null,null,null,this.divData.form.tabData.page3.form);
            obj.set_taborder("6");
            obj._setContents("");
            this.divData.form.tabData.page3.addChild(obj.name, obj);

            obj = new Grid("objGridPayback","objGridAppro:15","0",null,null,"0","0",null,null,null,null,this.divData.form.tabData.page3.form);
            obj.set_taborder("6");
            obj._setContents("");
            this.divData.form.tabData.page3.addChild(obj.name, obj);
            ...
            obj = new Grid("objGridLoan","0","0",null,null,"0","0",null,null,null,null,this.divData.form.tabData.page4.form);
            obj.set_taborder("6");
            obj._setContents("");
            this.divData.form.tabData.page4.addChild(obj.name, obj);

            obj = new Static("sta26_00","576","412","120","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("93");
            obj.set_text("해약처리자");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("edttxtDT_RETURN00","701","417","178","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("94");
            obj.set_enable("false");
            obj.set_readonly("true");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item30","divData.form.edttxtDT_RETURN00","value","dsList","DT_PAYMENT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DLB_CANCELDETAIL.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.dxGridAppro         = this.divData.form.tabData.page3.form.objGridAppro;
        	this.dxGridPayback       = this.divData.form.tabData.page3.form.objGridPayback;
        	this.dxGridLoan          = this.divData.form.tabData.page4.form.objGridLoan;
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGridReceived, this.dsListReceived, "DL", "DLB_CANCELDETAIL_RECEIVED");
        	this.gfnGridInit(this.dxGridLaw     , this.dsListLaw     , "DL", "DLB_CANCELDETAIL_LAW");
        	this.gfnGridInit(this.dxGridLoan    , this.dsListLoan    , "DL", "DLB_CANCELDETAIL_LOAN");
        	this.gfnGridInit(this.dxGridAppro   , this.dsListAppro   , "DL", "DLB_CANCELDETAIL_APPRO");
        	this.gfnGridInit(this.dxGridPayback , this.dsListPayback , "DL", "DLB_CANCELDETAIL_PAYBACK");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("NO_CANCEL"				, "string");
        	this.dsUpdate.addColumn("DS_REMARK"				, "string");
        	this.dsUpdate.addColumn("DT_RETURN"				, "string");
        	this.dsUpdate.addColumn("TY_RETURN"				, "string");
        	...
        	this.dsUpdate.addColumn("DS_BANK_CANCEL"		, "string");
        	this.dsUpdate.addColumn("DS_GUJA_CANCEL"		, "string");
        	this.dsUpdate.addColumn("DS_HANDLER"    		, "string");
        ...
        this.fnSave = function() {
        	...
        	this.dsUpdate.setColumn(0, "CD_ACNTUNIT"   , this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(0, 6));
        	this.dsUpdate.setColumn(0, "TY_GUBUN"      , this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(6, 1));
        	this.dsUpdate.setColumn(0, "NO_CHASU"      , this.dsSearch.getColumn(0, "CD_ACNTUNIT").substr(7, 2));
        	this.dsUpdate.setColumn(0, "NO_DONG"       , this.dsSearch.getColumn(0, "NO_DONG"));
        	this.dsUpdate.setColumn(0, "NO_FLOOR"      , this.dsSearch.getColumn(0, "NO_FLOOR"));
        	this.dsUpdate.setColumn(0, "NO_HO"         , this.dsSearch.getColumn(0, "NO_HO"));
        	this.dsUpdate.setColumn(0, "NO_CANCEL"     , this.dsSearch.getColumn(0, "NO_CANCEL"));		// ?????
        	this.dsUpdate.setColumn(0, "DS_REMARK"     , this.dsList.getColumn(0, "DS_CANCEL"));
        	this.dsUpdate.setColumn(0, "DT_RETURN"     , this.dsList.getColumn(0, "DT_RETURN"));
        	this.dsUpdate.setColumn(0, "TY_RETURN"     , this.dsList.getColumn(0, "TY_RETURN"));
        	this.dsUpdate.setColumn(0, "AM_INTEREST"   , this.dsList.getColumn(0, "AM_INTEREST"));
        	this.dsUpdate.setColumn(0, "AM_FORFEIT"    , this.dsList.getColumn(0, "AM_FORFEIT"));
        	this.dsUpdate.setColumn(0, "AM_DELAY"      , 0);
        	this.dsUpdate.setColumn(0, "AM_RETURN"     , this.dsList.getColumn(0, "AM_RETURN"));
        	this.dsUpdate.setColumn(0, "DS_BANK_CANCEL", this.dsList.getColumn(0, "DS_BANK_CANCEL"));
        	this.dsUpdate.setColumn(0, "DS_GUJA_CANCEL", this.dsList.getColumn(0, "DS_GUJA_CANCEL"));
        	this.dsUpdate.setColumn(0, "DS_HANDLER"    , this.dsList.getColumn(0, "DS_HANDLER"));
        ...
        this.fnButtonClick = function(obj,e) {
        	...
        	switch(obj.name) {
        		...
        		case "btnExt_CancelCounsel":										// 상담일지.
        				...
        				this.gfnFormOpen("DLB", "DLB_CANCELCOUNSEL", "", param);
        ...
        this.loadIncludeScript("DLB_CANCELDETAIL.xfdl");
