(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Radio("crdoYN_RECEIPT","ctclDT_END:0.0","10.0","133","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new BindItem("item4","divSearch.form.crdoYN_RECEIPT","value","dsSearch","YN_RECEIPT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DLB_RECEIPTBATCH.xfdl", function() {
        ...
        this.loadIncludeScript("DLB_RECEIPTBATCH.xfdl");
