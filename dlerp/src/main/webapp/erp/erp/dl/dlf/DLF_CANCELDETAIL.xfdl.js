(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staBgTY_DELAY01","staTY_DELAY01:-1","216","523","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("33");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("staBgNO_REFTEL00","119","216","200","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("71");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Edit("ctxtCD_BANKVENDOR","staTY_DELAY01:5","221","108","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("68");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("ctxtDS_BANKVENDOR","staTY_DELAY01:118","221","369","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("69");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_REFTEL00","0","216","120","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("73");
            obj.set_text("전표번호");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new Edit("ctxtCD_SLIP","staNO_REFTEL00:5","221","160","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("72");
            obj.set_value("");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new BindItem("item24","divData.form.divDataTop.form.ctxtCD_SLIP","value","dsList","CD_SLIP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DLF_CANCELDETAIL.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnSlipSelectC = this.gfnFormButtonAdd("btnSlipSelectC", "fnSlipSelectC");
        ...
        this.fnExec = function() {
         ...
         // 전표조회 버튼 클릭시 팝업화면 호출
         this.fnSlipSelectC = function(obj,e) {
        	// 선택된 row가 있을 경우에만 팝업을 띄움
        	//if (!this.gfnGridIsRow(this.dxGrid)) { return false; }
        	if (this.dsList.rowcount < 1) { return false; }

        	if(this.gfnIsNull(this.dsList.getColumn(0, "CD_SLIP"))){
        		var msg = "회계일자 :" + this.dsList.getColumn(0, "DT_CANCEL") + "\n전표가 존재하지 않습니다!";
        	...
        	var param = {};
        	param.CD_TRADE = this.dsList.getColumn(0, "CD_SLIP");

        	// 화면 오픈.
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.

        	this.gfnFormOpen("DHA", "DHA_AUTOSLIP", "", param);
        }
        ...
        this.loadIncludeScript("DLF_CANCELDETAIL.xfdl");
