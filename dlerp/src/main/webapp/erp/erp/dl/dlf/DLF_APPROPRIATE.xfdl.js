(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staTY_PAYBACKSTATE","ctclDT_END:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("반제유무");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboTY_PAYBACKSTATE","staTY_PAYBACKSTATE:0.0","10.0","90","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_datacolumn("datacolumn");
            obj.set_codecolumn("codecolumn");
            var divSearch_form_ccboTY_PAYBACKSTATE_innerdataset = new nexacro.NormalDataset("divSearch_form_ccboTY_PAYBACKSTATE_innerdataset", obj);
            divSearch_form_ccboTY_PAYBACKSTATE_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\"/><Col id=\"datacolumn\">전체보기</Col></Row><Row><Col id=\"codecolumn\">반제</Col><Col id=\"datacolumn\">반제</Col></Row><Row><Col id=\"codecolumn\">미반제</Col><Col id=\"datacolumn\">미반제</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_ccboTY_PAYBACKSTATE_innerdataset);
            obj.set_text("전체");
            obj.set_value("");
            obj.set_index("0");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item4","divSearch.form.ccboTY_PAYBACKSTATE","value","dsSearch","TY_PAYBACKSTATE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DLF_APPROPRIATE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLF_APPROPRIATE");

        	this.gfnGridColumnColor(this.dxGrid, "", "BACK_ReadOnly", "TY_PROCESS=='환불처리'", true);
        ...
        this.fnSave = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		if(this.dsList.getColumn(i, "TY_APPRO") == "입금액<연체료")     this.dsList.setColumn(i, "TY_APPRO", "1");
        		if(this.dsList.getColumn(i, "TY_APPRO") == "입금액>분양총액")   this.dsList.setColumn(i, "TY_APPRO", "2");
        		if(this.dsList.getColumn(i, "TY_APPRO") == "입금액>상환금액")   this.dsList.setColumn(i, "TY_APPRO", "3");
        		if(this.dsList.getColumn(i, "TY_APPRO") == "착오입금")           this.dsList.setColumn(i, "TY_APPRO", "4");

        		if(this.dsList.getColumn(i, "TY_PROCESS") == "환불처리")         this.dsList.setColumn(i, "TY_PROCESS", "3");
        		if(this.dsList.getColumn(i, "TY_PROCESS") == "영업외 수익처리") this.dsList.setColumn(i, "TY_PROCESS", "2");
        ...
        this.loadIncludeScript("DLF_APPROPRIATE.xfdl");
