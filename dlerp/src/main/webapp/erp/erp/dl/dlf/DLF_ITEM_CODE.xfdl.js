(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_RCODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_ACNTUNIT\"/><Col id=\"CD_RCODE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP00","ctxtCD_RCODE:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("코드명");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtDS_RCODE","staCD_CORP00:0.0","10.0","160","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_value("");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLF_ITEM_CODE.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_ACNTUNIT) && !this.gfnIsNull(this.getOwnerFrame().CD_RCODE)) {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLF_ITEM_CODE");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_LCODE", this.getOwnerFrame().CD_LCODE);
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "CD_LCODE", this.getOwnerFrame().CD_LCODE);
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_LCODE", this.getOwnerFrame().CD_LCODE);
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "CD_LCODE", this.getOwnerFrame().CD_LCODE);
        ...
        this.dsSearch_onvaluechanged = function(obj,e) {
         ...
         this.fnColorCd = function(obj,e) {
            ...
            param.CD_LCODE = this.getOwnerFrame().CD_LCODE;
        	param.DS_LCODE = this.getOwnerFrame().DS_LCODE;
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DLF_COLOR_CODE", "fnColorCdCallback", param);
        }
        ...
        this.loadIncludeScript("DLF_ITEM_CODE.xfdl");
