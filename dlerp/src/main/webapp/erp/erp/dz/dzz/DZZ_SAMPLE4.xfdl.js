(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_Silheng_Select</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YY_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"DT_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YY_WORK\"/><Col id=\"YM_WORK\"/><Col id=\"DT_WORK\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfSite","sta00:10","10","300","25",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("0");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staYY_WORK","ccfSite:10","10","30","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("년도");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYY_WORK","staYY_WORK:10","10","60","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_url("cmm::cmmCalYY.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staYM_WORK","ctclYY_WORK:10","10","30","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("년월");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_WORK","ctclYM_WORK:10","10","30","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("달력");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_WORK","staDT_WORK:10","10","105","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("DZZ_SAMPLE4.xfdl", function() {
        ...
        this.loadIncludeScript("DZZ_SAMPLE4.xfdl");
