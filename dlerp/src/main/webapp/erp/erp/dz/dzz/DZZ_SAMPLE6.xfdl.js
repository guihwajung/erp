(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSAPR_EMPLOYEE_LIST_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_CHAIYONG","ccfCD_DEPT:10","10","50","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("채용구분");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_CHAIYONG","staTY_CHAIYONG:10","10","70","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Static("staNO_ID","ccboTY_CHAIYONG:10","10","30","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("성명");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfNO_ID","staNO_ID:10","10","200","25",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("60");
            obj.set_taborder("0");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTY_JAJIK","10","staCD_CORP:10","60","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_cssclass("sta_SearchY");
            obj.set_taborder("1");
            obj.set_text("재직구분");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_JAJIK","staTY_JAJIK:10","staCD_CORP:10","70","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Static("staTY_WOIGUG","ccfCD_CORP:10","staCD_CORP:10","60","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("외국인여부");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_WOIGUG","staTY_WOIGUG:10","staCD_CORP:10","70","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
        ...
        // User Script
        this.registerScript("DZZ_SAMPLE6.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.ccboTY_CHAIYONG.addEventHandler("onitemchanged",this.fnSearchInit,this);
            this.divSearch.form.ccboTY_JAJIK.addEventHandler("onitemchanged",this.fnSearchInit,this);
            this.divSearch.form.ccboTY_WOIGUG.addEventHandler("onitemchanged",this.fnSearchInit,this);
        };
        this.loadIncludeScript("DZZ_SAMPLE6.xfdl");
