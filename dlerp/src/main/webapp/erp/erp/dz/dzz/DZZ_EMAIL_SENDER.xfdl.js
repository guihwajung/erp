(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new BindItem("item0","divData.form.divDataBottom.form.ctxtTITLE","value","dsSearch","DS_TITLE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divData.form.divDataBottom.form.ctxtCONTENT","value","dsSearch","DS_CONTENT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DZZ_EMAIL_SENDER.xfdl", function() {
        ...
        this.loadIncludeScript("DZZ_EMAIL_SENDER.xfdl");
