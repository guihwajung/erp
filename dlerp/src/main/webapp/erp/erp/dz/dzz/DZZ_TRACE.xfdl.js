(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZZPR_TRACE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_GUBUN", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\"/><Col id=\"VALUE\">전체</Col></Row><Row><Col id=\"CODE\">로그인</Col><Col id=\"VALUE\">로그인</Col></Row><Row><Col id=\"CODE\">로그아웃</Col><Col id=\"VALUE\">로그아웃</Col></Row><Row><Col id=\"CODE\">조회</Col><Col id=\"VALUE\">조회</Col></Row><Row><Col id=\"CODE\">저장</Col><Col id=\"VALUE\">저장</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP","ccfCD_SYSTEM:10","10","40","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("법인");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_CORP","staCD_CORP:10","10","200","25",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staID_USER","ccfCD_CORP:10","10","40","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("사용자");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfID_USER","staID_USER:10","10","200","25",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staDT","ccfID_USER:10","10","30","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("날짜");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_FROM","staDT:10","10","105","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Static("staSP_NAME","ctclDT_TO:10","10","30","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("SP");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtSP_NAME","staSP_NAME:10","10","140","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTY_GUBUN","ctxtSP_NAME:10","10","40","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("구분");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_GUBUN","staTY_GUBUN:5","10","60","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("DZZ_TRACE.xfdl", function() {
        ...
        this.loadIncludeScript("DZZ_TRACE.xfdl");
