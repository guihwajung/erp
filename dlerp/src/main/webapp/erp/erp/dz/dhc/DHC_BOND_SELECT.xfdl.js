(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT_BH\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT_BH\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT_BE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT_BE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"YN_JUNGSAN\" type=\"STRING\" size=\"256\"/><Column id=\"CD_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"TY_MIGEUL\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsYN_JUNGSAN", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_CODE\">전체</Col></Row><Row><Col id=\"CD_CODE\">Y</Col><Col id=\"DS_CODE\">정산</Col></Row><Row><Col id=\"CD_CODE\">N</Col><Col id=\"DS_CODE\">미정산</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_MIGEUL", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_CODE\">전체</Col></Row><Row><Col id=\"DS_CODE\">채권</Col><Col id=\"CD_CODE\">C</Col></Row><Row><Col id=\"DS_CODE\">채무</Col><Col id=\"CD_CODE\">K</Col></Row><Row><Col id=\"DS_CODE\">일반</Col><Col id=\"CD_CODE\">N</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_DEPT_BE","443","10","260","24",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("2");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            ...
            obj = new Static("staCD_ACCOUNT","ccfCD_DEPT_BE:0","10","92","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("계정코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_ACCOUNT","staCD_ACCOUNT:0","10","259","24",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Calendar("ctclDT_FROM","staDT_FROM:0","42","120","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("sta05","ctclDT_FROM:0","41","20","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("16");
            obj.set_text("~");
            ...
            obj = new Calendar("ctclDT_TO","sta05:0","42","120","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyy-MM-dd");
            obj.set_autoselect("true");
            ...
            obj = new Static("staTY_MIGEUL","ctclDT_TO:0","42","92","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("20");
            obj.set_text("구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_MIGEUL","staTY_MIGEUL:0","42","102","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            ...
            obj = new Static("staYN_JUNGSAN","ccfCD_ACCOUNT:0","10","92","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("19");
            obj.set_text("정산여부");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboYN_JUNGSAN","staYN_JUNGSAN:0","10","97","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            ...
            obj = new Static("staCD_TRADE","ccboTY_MIGEUL:157","42","92","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("18");
            obj.set_text("전표번호");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtCD_TRADE","staCD_TRADE:0","42","180","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item14","divSearch.form.ccboTY_MIGEUL","value","dsSearch","TY_MIGEUL");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHC_BOND_SELECT.xfdl", function() {
        ...
        //채권정산
        this.fnBondJungSan = function (obj,e){
        	var chkCnt = 0;
        	var strRowMsg = "";
        	for(var i=0;i<this.dsList.rowcount;i++){
        ...
        this.loadIncludeScript("DHC_BOND_SELECT.xfdl");
