(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            obj.getSetter("CodeFindName").set("DHX_CFACNT_SLIP");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHC_MIKYUL_SELECT.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnMikyulJungSan = this.gfnFormButtonAdd("MikyulJungSan", "fnMikyulJungSan");  //미결계정정산
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid   , this.dsList   , "DH", "DHC_MIKYUL_SELECT");
        	...
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DH", "DHC_MIKYUL_SELECT_DTL");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "TY_MIGEUL"   , "N");											// 미결구분(N:일반)
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	case "ccfCD_ACCOUNT" :	//계정코드
        		...
        		dsUserParam.setColumn(nrow, "NO_ORDER"	  , "NORMAL_MIGEUL");
        ...
        this.dsSearch_onvaluechanged = function(obj,e){
        	if(e.oldvalue != e.newvalue) {
        		...
        		if(e.columnid == "CD_CORP"){
        			...
        			if(e.newvalue == "Y"){
        				this.btnMikyulJungSan.set_enable(false);
        			}else{
        				if(this.dsList.rowcount > 0){
        					this.btnMikyulJungSan.set_enable(true);
        				}
        			}
        		}
        	}
        ...
        //미결계정정산
        this.fnMikyulJungSan = function (obj,e){
        	var chkCnt = 0;
        	var strRowMsg = "";
        ...
        this.loadIncludeScript("DHC_MIKYUL_SELECT.xfdl");
