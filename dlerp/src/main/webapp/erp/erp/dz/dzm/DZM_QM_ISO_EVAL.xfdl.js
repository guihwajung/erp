(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZMPR_QM_LIST_ISO</Col></Row><Row><Col id=\"TARGET\">select_be</Col><Col id=\"SP\">DZMPR_QM_CODE_SELECT_ISO</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DZMQM_ISO_EVAL_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DUAPR_GONGSU_MANAGER_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DUAPR_GONGSU_MANAGER_DELETE</Col></Row><Row><Col id=\"SP\">DUZPR_AUTHORIZE_LIST</Col><Col id=\"TARGET\">combo</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"DT_YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"ID_USER\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEL_USER\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DT_YYYY\"/><Col id=\"NO_SEQ\"/><Col id=\"CD_SITE\"/><Col id=\"CD_DEPT\"/><Col id=\"DS_HNAME\"/><Col id=\"NO_SEL_USER\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCD_DEPT", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_SITE","100","10",null,"24","940",null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("ccfNoSeq","ctclDT_YYYY:0","10","98","24",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("50");
            obj.getSetter("CodeFindName").set("DZM_QM_ISO_SEQ");
            obj.set_taborder("6");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staID_USER","ccfNoSeq:0","10","79","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("점검자");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfNO_SEL_USER","staID_USER:0","10","250","24",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CodeFindName").set("DZX_CFUSERINFO");
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("3");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            ...
            obj = new BindItem("item1","divSearch.form.ctclDT_YYYY.form.TextBox","value","dsSearch","DT_YYYY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.ccfNoSeq.form.CDTextBox","value","dsSearch","NO_SEQ");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.ccfNO_SEL_USER.form.CDTextBox","value","dsSearch","NO_SEL_USER");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DZM_QM_ISO_EVAL.xfdl", function() {
        ...
        this.divData_staCD_SITE_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.staCD_SITE.addEventHandler("onclick",this.divData_staCD_SITE_onclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DZM_QM_ISO_EVAL.xfdl");
