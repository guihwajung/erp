(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnDel","8","202","25","25",null,null,null,null,null,null,this.divData.form.divDataBottom.form.div00.form);
            obj.set_taborder("0");
            obj.set_cssclass("btn_WF_prev");
            this.divData.form.divDataBottom.form.div00.addChild(obj.name, obj);

            obj = new Button("btnAdd","8","170","25","25",null,null,null,null,null,null,this.divData.form.divDataBottom.form.div00.form);
            obj.set_taborder("1");
