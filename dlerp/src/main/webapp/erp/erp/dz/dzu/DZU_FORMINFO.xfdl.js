(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMZPR_FORMINFO_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DMZPR_FORMINFO_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DMZPR_FORMINFO_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DMZPR_FORMINFO_DELETE</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DZZPR_DEVWORK_SELECT</Col></Row><Row><Col id=\"TARGET\">select3</Col><Col id=\"SP\">DZZPR_SPLOG_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"ID_FORM\" type=\"STRING\" size=\"256\"/><Column id=\"GR_SEARCH\" type=\"STRING\" size=\"256\"/><Column id=\"TY_AUTH\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"GR_SEARCH\"/><Col id=\"TY_AUTH\"/><Col id=\"ID_FORM\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsDescription", this);
            obj._setContents("<ColumnInfo><Column id=\"DS_DESCRIPTION\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_DESCRIPTION\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_FORM","10","10","60","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_cssclass("sta_SearchY");
            obj.set_taborder("6");
            obj.set_text("FORM ID");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtCD_FORM","staCD_FORM:10","10","200","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_value("");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staGR_SEARCH","ctxtCD_FORM:20","10","80","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_cssclass("sta_SearchY");
            obj.set_taborder("6");
            obj.set_text("GR_SEARCH");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtGR_SEARCH","staGR_SEARCH:10","10","100","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_value("");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTY_AUTH","ctxtGR_SEARCH:20","10","60","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_cssclass("sta_SearchY");
            obj.set_taborder("6");
            obj.set_text("TY_AUTH");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtTY_AUTH","staTY_AUTH:10","10","100","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_value("");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Div("divDataTop","0","0",null,null,"0","70%",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.addChild(obj.name, obj);

            obj = new Div("divDataTopLeft","0","0","600",null,null,"0",null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","0",null,null,"0","0",null,null,null,null,this.divData.form.divDataTop.form.divDataTopLeft.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.form.divDataTop.form.divDataTopLeft.addChild(obj.name, obj);

            obj = new Div("divDataTopRight","divDataTopLeft:5","0",null,null,"0","0",null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Grid("objGrid2","0","0",null,null,"0","0",null,null,null,null,this.divData.form.divDataTop.form.divDataTopRight.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.form.divDataTop.form.divDataTopRight.addChild(obj.name, obj);

            obj = new Div("divDataBottom","0","divDataTop:20",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.addChild(obj.name, obj);

            obj = new Div("divDataBottomLeft","0","0","600",null,null,"0",null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Grid("objGrid3","0","0",null,null,"0","0",null,null,null,null,this.divData.form.divDataBottom.form.divDataBottomLeft.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.form.divDataBottom.form.divDataBottomLeft.addChild(obj.name, obj);

            obj = new Div("divDataBottomRight","divDataBottomLeft:5","0",null,null,"0","0",null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new TextArea("ctxtDS_DESCRIPTION","0","0",null,null,"5","0",null,null,null,null,this.divData.form.divDataBottom.form.divDataBottomRight.form);
            obj.set_taborder("1");
            obj.set_value("");
            this.divData.form.divDataBottom.form.divDataBottomRight.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item0","divSearch.form.ctxtCD_FORM","value","dsSearch","ID_FORM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.ctxtGR_SEARCH","value","dsSearch","GR_SEARCH");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.ctxtTY_AUTH","value","dsSearch","TY_AUTH");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divData.form.divDataBottom.form.divDataBottomRight.form.ctxtDS_DESCRIPTION","value","dsDescription","DS_DESCRIPTION");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DZU_FORMINFO.xfdl", function() {
        ...
        this.fnGrid3_RowCellChanged = function(obj,e)
        {
        	if ((obj.oldrow > -1 && obj.oldrow == e.row)
        		|| (obj.oldrow == -1 && e.oldrow != e.row)) {
        ...
        this.loadIncludeScript("DZU_FORMINFO.xfdl");
