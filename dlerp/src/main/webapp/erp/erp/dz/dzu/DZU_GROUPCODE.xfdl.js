(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZZPR_GROUPCODE_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DZZPR_GROUPCODE_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DZZPR_GROUPCODE_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DZZPR_GROUPCODE_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("txtCD_GROUP","sta00:0","10","140","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DZU_GROUPCODE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DZ", "DZU_GROUPCODE");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_GROUP", this.divSearch.form.txtCD_GROUP.text);
        ...
        this.loadIncludeScript("DZU_GROUPCODE.xfdl");
