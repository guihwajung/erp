(function()
{
	return function()
	{
            ...
            "MainFrame" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid #3b2f30")
            					}
            				}
            			},
            			"titlebar" :
            			...
            			"HScrollBarControl" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid #e4e4e4, 1px solid #e4e4e4, 0px none, 1px solid #e4e4e4"),
            				...
            				"parent" :
            				{
            					"HScrollBarControl" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								...
            								"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_HScrTrackBarN.png\")")
            							},
            							"mouseover" :
            							{
            								"border" : nexacro.BorderObject("1px solid #c3c3c3"),
            							...
            							"disabled" :
            							{
            								...
            								"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_HScrTrackBarD.png\")")
            							}
            						}
            					},
            					"VScrollBarControl" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"border" : nexacro.BorderObject("1px solid #cdcdcd"),
            								"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_VScrTrackBarN.png\")")
            							},
            							"mouseover" :
            							{
            								"border" : nexacro.BorderObject("1px solid #cdcdcd"),
            							...
            							{
            								"border" : nexacro.BorderObject("1px solid #e3e3e3"),
            								"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_VScrTrackBarD.png\")")
            							}
            						}
            					},
            			...
            			"VScrollBarControl" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid #e4e4e4, 0px none, 1px solid #e4e4e4, 1px solid #e4e4e4"),
            			...
            			"Button" :
            			{
            				"self" :
            				{
            					...
            					{
            						"font" : nexacro.FontObject("12px \"Malgun Gothic\""),
            						"border" : nexacro.BorderObject("1px solid #949494"),
            						"color" : nexacro.ColorObject("#333333")
            					},
            					"disabled" :
            					{
            					...
            					},
            					{
            						"btn_MDI_Btn" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #c5c6ca, 1px solid #c5c6ca, 1px solid #c5c6ca, 1px solid #c5c6ca"),
            									"padding" : nexacro.PaddingObject("0px 34px 0px 15px"),
            									"font" : nexacro.FontObject("12px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#c5c6ca")
            								},
            								"selected" :
            								{
            									"border" : nexacro.BorderObject("1px solid #c5c6ca, 1px solid #c5c6ca, 1px solid #c5c6ca, 1px solid #c5c6ca"),
            					...
            					},
            					{
            						"btn_MDI_BtnS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #c5c6ca, 1px solid #c5c6ca, 1px solid #FFFFFF, 1px solid #c5c6ca"),
            									"padding" : nexacro.PaddingObject("0px 30px 0px 15px"),
            									"font" : nexacro.FontObject("bold 12px \"Malgun Gothic\""),
            					...
            					},
            					{
            						"btn_WF_default" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"padding" : nexacro.PaddingObject("0px 13px")
            								}
            							}
            						}
            					},
            					{
            						"btn_WF_function" :
            						{
            							"self" :
            							{
            								...
            								{
            									"padding" : nexacro.PaddingObject("0px 13px"),
            									"border" : nexacro.BorderObject("1px solid #9b241b"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #828282"),
            					...
            					},
            					{
            						"btn_WF_action" :
            						{
            							"self" :
            							{
            								...
            								{
            									"padding" : nexacro.PaddingObject("0px 13px"),
            									"border" : nexacro.BorderObject("1px solid #3d4042"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"disabled" :
            								{
            					...
            					},
            					{
            						"btn_WF_searchNormal" :
            						{
            							"self" :
            							{
            								...
            								{
            									"padding" : nexacro.PaddingObject("0px 13px"),
            									"border" : nexacro.BorderObject("1px solid #696969"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #a6a6a6"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"mouseover" :
            								{
            					...
            					},
            					{
            						"btn_WF_search01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #cb372b"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_search01.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #da7870")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #cb372b")
            					...
            					},
            					{
            						"btn_WF_save01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #2455a1"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_save01.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #a7b4cb")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #1b488c")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("1px solid #1b488c")
            					...
            					},
            					{
            						"btn_WF_excelDown01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #7a7a7a"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_excelDown01.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            					...
            					},
            					{
            						"btn_WF_print01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("1px solid #7a7a7a"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_print01.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            					...
            					},
            					{
            						"btn_WF_close01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("1px solid #7a7a7a"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_close01.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            					...
            					},
            					{
            						"btn_WF_minus01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("1px solid #7a7a7a"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_minus01.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            					...
            					},
            					{
            						"btn_WF_help01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("1px solid #7a7a7a"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_help01.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            					...
            					},
            					{
            						"btn_WF_monthPrev" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_monthPrevN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_monthPrevD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_monthPrevO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_WF_monthNext" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_monthNextN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_monthNextD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_monthNextO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_pageLeft" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_pageLeftN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_pageLeftD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_pageLeftO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_pageRight" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_pagerightN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_pagerightD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_pagerightO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_WF_windowMax" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8, 0px none, 0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_windowMaxN_2.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8, 0px none, 0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_windowMaxD_2.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8, 0px none, 0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_windowMaxO_2.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8, 0px none, 0px none"),
            					...
            					},
            					{
            						"btn_WF_windowMin" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8, 0px none, 0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_windowMinN_2.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8, 0px none, 0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_windowMinD_2.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8, 0px none, 0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_windowMinO_2.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8, 0px none, 0px none"),
            					...
            					},
            					{
            						"btn_TF_winClose" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 0px none, 0px solid #d4d4d4"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_TF_winCloseN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 0px none, 0px solid #d4d4d4"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_TF_winCloseD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 0px none, 0px solid #d4d4d4"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_TF_winCloseO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 0px none, 0px solid #d4d4d4"),
            					...
            					},
            					{
            						"btn_TF_ss01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_TF_search01.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            						...
            						"btn_WF_grdSave" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_grdSave.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #c5c6ca"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_grdSaveD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #cb4848"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_grdSave.png\")")
            								},
            								"pushed" :
            								{
            					...
            					},
            					{
            						"btn_WF_grdPlus" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("1px solid #a8a8a8"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_grdPlus.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #c5c6ca"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_grdPlusD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #cb4848"),
            					...
            					},
            					{
            						"btn_WF_grdMinus" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("1px solid #a8a8a8"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_grdMinus.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #c5c6ca"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_grdMinusD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #cb4848"),
            					...
            					},
            					{
            						"btn_WF_first" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_firstN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_firstD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_firstO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_WF_next" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_nextN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_nextD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_nextO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_WF_prev" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_prevN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_prevD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_prevO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_WF_up" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_upN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_upD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_upO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_WF_down" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_downN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_downD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_downO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_WF_last" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_lastN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_lastD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_lastO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            						...
            						"btn_WF_Splitter" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("0px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/slt_WF_SplitterIcoH.png\")"),
            									"edge" : nexacro.EdgeImageObject("URL(\"theme://images/btn_WF_SpltLine.png\") 5px 0px")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            						...
            						"btn_WF_SplitterV" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("0px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/slt_WF_SplitterIcoV.png\")"),
            									"edge" : nexacro.EdgeImageObject("URL(\"theme://images/btn_WF_SpltLineV.png\") 0px 5px")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_window" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_windowPlus" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowPlusN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowPlusD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowPlusO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_windowX" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowXN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowXD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowXO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_windowY" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowYN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowYD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowYO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_windowClose" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowCloseN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowCloseD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_windowCloseO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_btnClose" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_btnCloseN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_btnCloseD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_btnCloseO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_btnCloseOn" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_btnCloseOnN.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_btnCloseOnD.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_MDI_btnCloseOnO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MDI_button" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8"),
            									"padding" : nexacro.PaddingObject("0px 33px 0px 20px"),
            								...
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8"),
            									"padding" : nexacro.PaddingObject("0px 33px 0px 20px"),
            									"color" : nexacro.ColorObject("#4e8fe6")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8"),
            					...
            					},
            					{
            						"btn_MDI_buttonS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #4e8fe6"),
            									"padding" : nexacro.PaddingObject("0px 33px 0px 20px"),
            									"font" : nexacro.FontObject("bold 13px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								...
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #4e8fe6"),
            									"padding" : nexacro.PaddingObject("0px 33px 0px 20px"),
            									"color" : nexacro.ColorObject("#fffe84")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #4e8fe6"),
            					...
            					},
            					{
            						"btn_LF_default" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_default.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            					...
            					},
            					{
            						"btn_LF_defaultS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #cdcdcd, 0px none"),
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_defaultS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            								"disabled" :
            								{
            						...
            						"btn_LF_mmS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_bookmarkS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dq" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_MDM.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            						...
            						"btn_LF_dqS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_MDMS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_do" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_expenses.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_doS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 16px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_expensesS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dw" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_construction.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dwS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_constructionS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dc" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_outsourcing.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dcS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 15px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_outsourcingS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dm" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_resource.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dmS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_resourceS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_ds" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 15px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_work.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dsS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 15px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_workS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_da" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 17px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_personnel.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_daS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 17px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_personnelS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dh" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_accounting.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dhS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_accountingS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_df" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 17px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_money.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dfS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 17px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_moneyS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_du" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 17px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_members.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_duS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 17px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_membersS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_di" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_management.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_diS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_managementS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dy" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_EIS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 16px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dyS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_EISS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 16px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dz" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_common.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("rgba(255, 255, 255, 0.7)"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            						...
            						"btn_LF_dzS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 28px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 19px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_LF_commonS.png\")"),
            									"iconPosition" : "left",
            									"color" : nexacro.ColorObject("#2979e1"),
            									"font" : nexacro.FontObject("bold 15px \"Malgun Gothic\"")
            								},
            					...
            					},
            					{
            						"btn_TF_home01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_TF_home01O.png\")"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"disabled" :
            								{
            						...
            						"btn_WF_Favorit" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_Favorit_D.png\")")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_Favorit_DO.png\")")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px"),
            						...
            						"btn_WF_accountNavi" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"color" : nexacro.ColorObject("#3571d4"),
            									"font" : nexacro.FontObject("bold 12px \"Malgun Gothic\"")
            								},
            								"disabled" :
            								{
            								...
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #e17f7f")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("1px solid #e17f7f")
            						...
            						"btn_LOGIN_Login" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("normal bold 20px/normal \"Malgun Gothic\"")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            						...
            						"btn_POP_Btn" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"font" : nexacro.FontObject("bold 10px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"focused" :
            								{
            					...
            					},
            					{
            						"btn_CF_Search" :
            						{
            							"self" :
            							{
            								...
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #94b9ec")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("1px solid #94b9ec")
            					...
            					},
            					{
            						"btn_save" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px"),
            									"icon" : nexacro.UrlObject("url(\"theme://images/control_btn_down.png\")")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px"),
            									"icon" : nexacro.UrlObject("url(\"theme://images/control_btn_down_o.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px"),
            									"icon" : nexacro.UrlObject("url(\"theme://images/control_btn_down_n.png\")")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"btn_help" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px"),
            									"icon" : nexacro.UrlObject("url(\"theme://images/control_btn_help.png\")")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px"),
            						...
            						"btn_MF_approval" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"iconPosition" : "left",
            									"padding" : nexacro.PaddingObject("3px 20px 3px 3px"),
            									"font" : nexacro.FontObject("13px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#333333")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#e17f7f")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            						...
            						"btn_MF_notiGo" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#ffffff"),
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('theme://images/btn_MF_arrowRwh.png')"),
            									"iconPosition" : "right",
            									"textPadding" : nexacro.PaddingObject("0px 8px 0px 0px"),
            									"font" : nexacro.FontObject("normal 10pt/normal \"Malgun Gothic\"")
            								},
            								"mouseover" :
            								{
            									"font" : nexacro.FontObject("normal 700 10pt/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"btn_MF_More2" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#414141"),
            									"font" : nexacro.FontObject("13px \"Malgun Gothic\""),
            									"border" : nexacro.BorderObject("0px none")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#E43B2E")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"btn_NoticeMore" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#8f9ca8")
            								},
            								"mouseover" :
            								{
            									"color" : nexacro.ColorObject("#C5CED6")
            								}
            							}
            						}
            					},
            					{
            						"btn_NotiDetail" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#2f90eb"),
            									"font" : nexacro.FontObject("normal 14px/normal \"Malgun Gothic\"")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_addNotice" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#8f9ca8"),
            									"font" : nexacro.FontObject("normal 13px/normal \"Malgun Gothic\""),
            									"border" : nexacro.BorderObject("0px none")
            								},
            								"mouseover" :
            								{
            									"color" : nexacro.ColorObject("#5e6770")
            								}
            							}
            						}
            					}
            			...
            			"CheckBox" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						...
            						"iconPosition" : "left",
            						"textPadding" : nexacro.PaddingObject("0px 15px 0px 5px")
            					},
            					"readonly" :
            					{
            						"border" : nexacro.BorderObject("0px none"),
            				...
            				[
            					{
            						"chk_id_memory" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/login_check_off.png\")"),
            									"iconPosition" : "left",
            									"textPadding" : nexacro.PaddingObject("0px 15px 0px 5px"),
            									"font" : nexacro.FontObject("normal 13px/normal \"Malgun Gothic\"")
            								},
            								...
            								"focused_selected" :
            								{
            									"icon" : nexacro.UrlObject("URL(\"theme://images/login_check_on.png\")")
            								},
            								"mouseover_selected" :
            								{
            									"icon" : nexacro.UrlObject("URL(\"theme://images/login_check_on.png\")")
            			...
            			"Combo" :
            			{
            				"self" :
            				{
            					...
            					"mouseover" :
            					{
            						"border" : nexacro.BorderObject("1px solid #999fe5")
            					},
            					"focused" :
            					{
            						"border" : nexacro.BorderObject("1px solid #999fe5")
            				...
            				"parent" :
            				{
            					...
            					"ListBox" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"padding" : nexacro.PaddingObject("5px 5px 5px 8px")
            							},
            							"focused" :
            							{
            								"padding" : nexacro.PaddingObject("5px 5px 5px 8px")
            				...
            				"parent" :
            				{
            					...
            					"Grid" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #94999d, 0px none")
            							},
            							"mouseover" :
            							{
            								"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #94999d, 0px none")
            						...
            						[
            							{
            								"grd_MF_budget" :
            								{
            									"self" :
            									{
            										"enabled" :
            										{
            											"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #EDEFF6")
            										},
            										"mouseover" :
            										{
            											"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #EDEFF6")
            						...
            						"parent" :
            						{
            							"DatePickerControl" :
            							{
            								"self" :
            								{
            									...
            									{
            										"color" : nexacro.ColorObject("#ffffff"),
            										"font" : nexacro.FontObject("bold 11px \"Malgun Gothic\"")
            									},
            									"today" :
            									{
            										"color" : nexacro.ColorObject("#ffffff")
            				...
            				[
            					{
            						"div_SEARCH_Bg" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #94b9ec, 0px none, 1px solid #94b9ec, 0px none")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #94b9ec, 0px none, 1px solid #94b9ec, 0px none")
            					...
            					},
            					{
            						"div_Splitter" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #bbb")
            								}
            							}
            						}
            					}
            			...
            			"Edit" :
            			{
            				"self" :
            				{
            					...
            					{
            						"border" : nexacro.BorderObject("0px none"),
            						"padding" : nexacro.PaddingObject("0px 10px 0px 1px")
            					}
            				},
            				"class" :
            				[
            					...
            					},
            					{
            						"edi_TF_Search01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid rgba(255, 255, 255, 0.7)"),
            					...
            					},
            					{
            						"edi_LOGIN_ID" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"padding" : nexacro.PaddingObject("1px 0px 0px 64px"),
            									"font" : nexacro.FontObject("16px \"Malgun Gothic\""),
            									"border" : nexacro.BorderObject("3px solid #ffffff")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("3px solid #00E1D5")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("3px solid #00E1D5")
            						...
            						"edi_login_input" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"font" : nexacro.FontObject("normal 16px/normal \"Malgun Gothic\"")
            								},
            								"disabled" :
            								{
            			...
            			"FileDownload" :
            			{
            				"self" :
            				{
            					...
            					"mouseover" :
            					{
            						"border" : nexacro.BorderObject("1px solid #717171")
            					},
            					"focused" :
            					{
            						"border" : nexacro.BorderObject("1px solid #717171")
            						...
            						"parent" :
            						{
            							"FileUpload" :
            							{
            								"self" :
            								{
            									...
            									{
            										"border" : nexacro.BorderObject("1px solid #c5c6ca"),
            										"textPadding" : nexacro.PaddingObject("3px 7px 3px 7px"),
            										"icon" : nexacro.UrlObject("URL(\"theme://images/btn_WF_AddFile.png\")"),
            										"iconPosition" : "left"
            									},
            									"mouseover" :
            			...
            			"Grid" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid #656a6e, 1px solid #e4e4e4, 1px solid #e4e4e4, 1px solid #e4e4e4"),
            						"font" : nexacro.FontObject("12px \"Malgun Gothic\"")
            					},
            					"mouseover" :
            					{
            											...
            											},
            											{
            												"grd_MF_deadline" :
            												{
            													"self" :
            													{
            														...
            														{
            															"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #EDEFF6"),
            															"font" : nexacro.FontObject("normal 12pt/normal \"Malgun Gothic\"")
            														},
            														"selected" :
            														{
            															"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #EDEFF6"),
            								...
            								"parent" :
            								{
            									"Grid" :
            									{
            										"self" :
            										{
            											...
            											{
            												"border" : nexacro.BorderObject("1px solid #e4e4e4"),
            												"padding" : nexacro.PaddingObject("3px 6px 3px 6px")
            											},
            											"mouseover" :
            											{
            												"padding" : nexacro.PaddingObject("3px 6px 3px 6px")
            											...
            											{
            												"padding" : nexacro.PaddingObject("3px 6px 3px 6px"),
            												"color" : nexacro.ColorObject("#a1a1a1")
            											},
            											"selected" :
            											{
            												"padding" : nexacro.PaddingObject("3px 6px 3px 6px")
            												...
            												"grd_MF_notice" :
            												{
            													"self" :
            													{
            														...
            														"mouseover" :
            														{
            															"border" : nexacro.BorderObject("0px none"),
            															"padding" : nexacro.PaddingObject("0px"),
            															"color" : nexacro.ColorObject("#2e7be4")
            														},
            														"selected" :
            														{
            															"border" : nexacro.BorderObject("0px none"),
            													...
            													[
            														{
            															"grd_WF_leftTree" :
            															{
            																"self" :
            																{
            																	"enabled" :
            																	{
            																		"padding" : nexacro.PaddingObject("4px 4px 4px 30px")
            																	},
            																	"mouseover" :
            																	{
            																		"padding" : nexacro.PaddingObject("4px 4px 4px 30px")
            													...
            													[
            														{
            															"grd_WF_leftTree" :
            															{
            																"self" :
            																{
            																	"enabled" :
            																	{
            																		"padding" : nexacro.PaddingObject("4px 4px 4px 40px")
            																	},
            																	"mouseover" :
            																	{
            																		"padding" : nexacro.PaddingObject("4px 4px 4px 40px")
            											...
            											"parent" :
            											{
            												"Grid" :
            												{
            													"self" :
            													{
            														"enabled" :
            														{
            															"border" : nexacro.BorderObject("0px none, 1px solid #e4e4e4")
            														}
            													}
            												}
            											}
            											...
            											"parent" :
            											{
            												"Grid" :
            												{
            													"self" :
            													{
            														"enabled" :
            														{
            															"color" : nexacro.ColorObject("#70e113")
            														}
            													}
            												}
            											}
            				...
            				"parent" :
            				{
            					"GridCellControl" :
            					{
            						"self" :
            						{
            							...
            							{
            								"border" : nexacro.BorderObject("1px solid #c5c6ca"),
            								"padding" : nexacro.PaddingObject("0px 8px 0px 10px"),
            								"font" : nexacro.FontObject("12px \"Malgun Gothic\"")
            							},
            							"nulltext" :
            							{
            				...
            				"parent" :
            				{
            					"GridCellControl" :
            					{
            						"self" :
            						{
            							...
            							{
            								"border" : nexacro.BorderObject("1px solid #c5c6ca"),
            								"padding" : nexacro.PaddingObject("6px 4px 0px 8px"),
            								"font" : nexacro.FontObject("12px \"Malgun Gothic\"")
            							},
            							"nulltext" :
            							{
            														...
            														[
            															{
            																"grd_WF_leftTree" :
            																{
            																	"self" :
            																	{
            																		"collapse" :
            																		{
            																			"icon" : nexacro.UrlObject("URL(\"theme://images/cell_WF_leftCollapse.png\")")
            																		},
            																		"expand" :
            																		{
            																			"icon" : nexacro.UrlObject("URL(\"theme://images/cell_WF_leftExpand.png\")")
            																		}
            																	}
            																}
            															},
            														...
            														[
            															{
            																"grd_WF_leftTree" :
            																{
            																	"self" :
            																	{
            																		"leaf" :
            																		{
            																			"icon" : nexacro.UrlObject("URL(\"theme://images/cell_WF_leftLeaf.png\")")
            																		}
            																	}
            																}
            															},
            					...
            					},
            					{
            						"msk_MF_budget01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#28466a"),
            									"font" : nexacro.FontObject("normal 700 16pt/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            						...
            						"msk_MF_budget02" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#949494"),
            									"font" : nexacro.FontObject("normal 16pt/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					}
            					...
            					},
            					{
            						"sta_WF_blue" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#2561ba")
            								},
            								"disabled" :
            								{
            									"color" : nexacro.ColorObject("#2561ba")
            					...
            					},
            					{
            						"sta_WF_red" :
            						{
            							"self" :
            							{
            								...
            								{
            									"font" : nexacro.FontObject("bold 13px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#d63a2d")
            								},
            								"disabled" :
            								{
            									"font" : nexacro.FontObject("bold 13px \"Malgun Gothic\""),
            					...
            					},
            					{
            						"sta_WF_notice" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"padding" : nexacro.PaddingObject("1px 5px 0px 28px"),
            									"font" : nexacro.FontObject("13px/1.5 \"Malgun Gothic\""),
            					...
            					},
            					{
            						"sta_WF_noticeTxt01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"padding" : nexacro.PaddingObject("0px"),
            									"font" : nexacro.FontObject("15px/1.5 \"Malgun Gothic\"")
            								},
            								"disabled" :
            								{
            									"padding" : nexacro.PaddingObject("0px"),
            					...
            					},
            					{
            						"sta_WF_noticeBox01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #999999, 0px none")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #999999, 0px none")
            					...
            					},
            					{
            						"sta_MF_BG" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #c8c8c8, 0px none")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"sta_TITLE_Bg2" :
            						{
            							"self" :
            							{
            								...
            								{
            									"font" : nexacro.FontObject("bold 12px \"Malgun Gothic\""),
            									"padding" : nexacro.PaddingObject("0px 2px 0px 12px")
            								}
            							}
            						}
            					},
            						...
            						"sta_TITLE_Popup" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("bold 14px \"Malgun Gothic\""),
            									"padding" : nexacro.PaddingObject("0px"),
            									"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #999999, 0px none")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"sta_MF_tit04" :
            						{
            							"self" :
            							{
            								...
            								{
            									"font" : nexacro.FontObject("15px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#686868")
            								},
            								"disabled" :
            								{
            									"font" : nexacro.FontObject("15px \"Malgun Gothic\""),
            					...
            					},
            					{
            						"sta_MF_tit05" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("22px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#444444")
            								},
            								"disabled" :
            								{
            					...
            					},
            					{
            						"sta_MF_tit06" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("18px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#ff8400")
            								},
            								"disabled" :
            								{
            									"font" : nexacro.FontObject("18px \"Malgun Gothic\""),
            					...
            					},
            					{
            						"sta_MF_tit07" :
            						{
            							"self" :
            							{
            								...
            								{
            									"font" : nexacro.FontObject("16px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#6e6e6e")
            								},
            								"disabled" :
            								{
            									"font" : nexacro.FontObject("16px \"Malgun Gothic\""),
            						...
            						"sta_MF_data01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"color" : nexacro.ColorObject("#f24040"),
            									"font" : nexacro.FontObject("19px \"Malgun Gothic\"")
            								},
            								"disabled" :
            								{
            									"padding" : nexacro.PaddingObject("1px"),
            								...
            								{
            									"padding" : nexacro.PaddingObject("1px"),
            									"color" : nexacro.ColorObject("#ce0a0a"),
            									"font" : nexacro.FontObject("19px \"Malgun Gothic\"")
            								}
            							}
            						}
            					...
            					},
            					{
            						"sta_MF_BoxLine" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 0px none, 1px solid #e2e2e2")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 0px none, 1px solid #e2e2e2")
            						...
            						"sta_MF_infoBox01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"color" : nexacro.ColorObject("#333333"),
            									"font" : nexacro.FontObject("17px \"Malgun Gothic\"")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #dbdbdb"),
            					...
            					},
            					{
            						"sta_MF_date01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("bold 27px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#676767")
            								},
            								"disabled" :
            								{
            									"font" : nexacro.FontObject("bold 27px \"Malgun Gothic\""),
            					...
            					},
            					{
            						"sta_MF_notitxt01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#ff3333"),
            									"font" : nexacro.FontObject("normal bold 16pt/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"sta_MF_title01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#000000"),
            									"font" : nexacro.FontObject("normal 700 14pt/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"sta_MF_title01_theme" :
            						{
            							"self" :
            							{
            								"enabled" :
            					...
            					},
            					{
            						"sta_MF_txt001" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("normal 13pt/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"sta_MF_txt002" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("normal 20pt/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"sta_today" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("normal 24px/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"sta_welcome" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("normal 44px/normal \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#ffffff")
            								}
            							}
            						}
            					},
            					{
            						"sta_titleNotice" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("normal 32px/normal \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#ffffff")
            								}
            							}
            						}
            					},
            					{
            						"sta_NoticeDay" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#4fbabf"),
            									"font" : nexacro.FontObject("normal bold 44px/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"sta_NoticeTitle" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#222222"),
            									"font" : nexacro.FontObject("normal bold 22px/normal \"Malgun Gothic\"")
            								},
            								"mouseover" :
            								{
            								}
            					...
            					},
            					{
            						"sta_NoticeCon" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#949494"),
            									"font" : nexacro.FontObject("normal 14px/1.5 \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"sta_Login_copy" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("normal 11px/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"sta_companyName" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("normal bold 32px/normal \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#0C2440")
            								}
            							}
            						}
            					},
            					{
            						"sta_pw_reset" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#319fc4"),
            				...
            				"parent" :
            				{
            					"Tab" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"border" : nexacro.BorderObject("1px solid #d1d1d1, 1px solid #d1d1d1, 2px solid #5e6266, 1px solid #d1d1d1"),
            								"padding" : nexacro.PaddingObject("6px 15px 6px 15px"),
            								"color" : nexacro.ColorObject("#000000")
            							},
            							"mouseover" :
            							{
            							...
            							"selected" :
            							{
            								"border" : nexacro.BorderObject("1px solid #5e6266,0px none,2px solid #5e6266, 1px solid #5e6266"),
            								"color" : nexacro.ColorObject("#ffffff")
            							},
            							"disabled" :
            							{
            				...
            				"parent" :
            				{
            					"Tab" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"border" : nexacro.BorderObject("2px solid #5e6266, 0px none, 0px none, 0px none")
            							},
            							"mouseover" :
            							{
            								"border" : nexacro.BorderObject("2px solid #5e6266, 0px none, 0px none, 0px none")
            			...
            			"TextArea" :
            			{
            				"self" :
            				{
            					...
            					{
            						"border" : nexacro.BorderObject("1px solid #c5c6ca"),
            						"padding" : nexacro.PaddingObject("6px 0px 0px 8px")
            					},
            					"nulltext" :
            					{
            						"border" : nexacro.BorderObject("1px solid #c5c6ca"),
            					...
            					{
            						"border" : nexacro.BorderObject("0px none"),
            						"padding" : nexacro.PaddingObject("1px 0px 0px 1px")
            					}
            				},
            				"class" :
            				[
        ...
        imgcache[nexacro._getImageLocation("theme://images/btn_TF_Min.png")] = { width:24, height:24 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/Hscl_WF_decN.png")] = { width:5, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/Hscl_WF_decM.png")] = { width:5, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/Hscl_WF_decP.png")] = { width:5, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/Hscl_WF_decD.png")] = { width:5, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/Hscl_WF_incN.png")] = { width:5, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/Hscl_WF_incM.png")] = { width:5, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/Hscl_WF_incP.png")] = { width:5, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/Hscl_WF_incD.png")] = { width:5, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_HScrTrackBarN.png")] = { width:7, height:7 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_HScrTrackBarD.png")] = { width:7, height:7 };
        		imgcache[nexacro._getImageLocation("theme://images/Vscl_WF_decN.png")] = { width:8, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/Vscl_WF_decM.png")] = { width:8, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/Vscl_WF_decP.png")] = { width:8, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/Vscl_WF_decD.png")] = { width:8, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/Vscl_WF_incN.png")] = { width:8, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/Vscl_WF_incM.png")] = { width:8, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/Vscl_WF_incP.png")] = { width:8, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/Vscl_WF_incD.png")] = { width:8, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_VScrTrackBarN.png")] = { width:7, height:7 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_VScrTrackBarD.png")] = { width:7, height:7 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/cmb_WF_btnN.png")] = { width:10, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/cmb_WF_btnM.png")] = { width:10, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/cmb_WF_btnD.png")] = { width:10, height:5 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/cell_WF_leftCollapse.png")] = { width:21, height:11 };
        		imgcache[nexacro._getImageLocation("theme://images/cell_WF_leftExpand.png")] = { width:21, height:11 };
        		imgcache[nexacro._getImageLocation("theme://images/cell_WF_leftLeaf.png")] = { width:17, height:13 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_search01.png")] = { width:15, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_save01.png")] = { width:15, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_excelDown01.png")] = { width:18, height:14 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_print01.png")] = { width:16, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_close01.png")] = { width:20, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_minus01.png")] = { width:16, height:4 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_plus01.png")] = { width:14, height:14 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_help01.png")] = { width:11, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_monthPrevN.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_monthPrevD.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_monthPrevO.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_monthNextN.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_monthNextD.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_monthNextO.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_pageLeftN.png")] = { width:9, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_pageLeftD.png")] = { width:9, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_pageLeftO.png")] = { width:9, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_pagerightN.png")] = { width:9, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_pagerightD.png")] = { width:9, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_pagerightO.png")] = { width:9, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMaxN_2.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMaxD_2.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMaxO_2.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMinN_2.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMinD_2.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMinO_2.png")] = { width:10, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_winCloseN.png")] = { width:19, height:21 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_winCloseD.png")] = { width:19, height:21 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_winCloseO.png")] = { width:19, height:21 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_setting.png")] = { width:12, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_search01.png")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_grdSave.png")] = { width:14, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_grdSaveD.png")] = { width:14, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_grdPlus.png")] = { width:12, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_grdPlusD.png")] = { width:12, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_grdMinus.png")] = { width:12, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_grdMinusD.png")] = { width:12, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_firstN.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_firstD.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_firstO.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_nextN.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_nextD.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_nextO.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_prevN.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_prevD.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_prevO.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_upN.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_upD.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_upO.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_downN.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_downD.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_downO.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_lastN.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_lastD.png")] = { width:25, height:25 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_lastO.png")] = { width:25, height:25 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/slt_WF_SplitterIcoH.png")] = { width:23, height:23 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_SpltLine.png")] = { width:60, height:23 };
        		imgcache[nexacro._getImageLocation("theme://images/slt_WF_SplitterIcoV.png")] = { width:23, height:23 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_SpltLineV.png")] = { width:23, height:60 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowN.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowD.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowO.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowPlusN.png")] = { width:18, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowPlusD.png")] = { width:18, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowPlusO.png")] = { width:18, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowXN.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowXD.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowXO.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowYN.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowYD.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowYO.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowCloseN.png")] = { width:20, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowCloseD.png")] = { width:20, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_windowCloseO.png")] = { width:20, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_btnCloseN.png")] = { width:9, height:9 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_btnCloseD.png")] = { width:9, height:9 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_btnCloseO.png")] = { width:9, height:9 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_btnCloseOnN.png")] = { width:9, height:9 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_btnCloseOnD.png")] = { width:9, height:9 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MDI_btnCloseOnO.png")] = { width:9, height:9 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_default.png")] = { width:19, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_expand01.png")] = { width:36, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_defaultS.png")] = { width:19, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_expand01S.png")] = { width:36, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_bookmark.png")] = { width:19, height:22 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_bookmarkS.png")] = { width:19, height:22 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_MDM.png")] = { width:20, height:20 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_MDMS.png")] = { width:20, height:20 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_expenses.png")] = { width:22, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_expensesS.png")] = { width:22, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_construction.png")] = { width:17, height:22 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_constructionS.png")] = { width:17, height:22 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_outsourcing.png")] = { width:22, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_outsourcingS.png")] = { width:22, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_resource.png")] = { width:17, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_resourceS.png")] = { width:17, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_work.png")] = { width:21, height:21 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_workS.png")] = { width:21, height:21 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_personnel.png")] = { width:19, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_personnelS.png")] = { width:19, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_accounting.png")] = { width:17, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_accountingS.png")] = { width:17, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_money.png")] = { width:20, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_moneyS.png")] = { width:20, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_members.png")] = { width:21, height:21 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_membersS.png")] = { width:21, height:21 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_management.png")] = { width:19, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_managementS.png")] = { width:19, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_EIS.png")] = { width:21, height:18 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_EISS.png")] = { width:21, height:18 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_common.png")] = { width:19, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_LF_commonS.png")] = { width:19, height:19 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_home01O.png")] = { width:21, height:21 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Favorit_D.png")] = { width:26, height:27 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Favorit_DO.png")] = { width:26, height:27 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Favorit.png")] = { width:26, height:27 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Favorit_O.png")] = { width:26, height:27 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_SchLabelE.png")] = { width:24, height:6 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_notice.png")] = { width:20, height:21 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/Icon_Login_user.png")] = { width:24, height:24 };
        		imgcache[nexacro._getImageLocation("theme://images/Icon_Login_key.png")] = { width:24, height:24 };
        		imgcache[nexacro._getImageLocation("theme://images/img_LOGIN_Logo.png")] = { width:240, height:57 };
        		imgcache[nexacro._getImageLocation("theme://images/img_LOGIN_CI.png")] = { width:310, height:39 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_essential01.png")] = { width:9, height:9 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_selfilter.png")] = { width:13, height:11 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_selfilter2.png")] = { width:13, height:31 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_diagonal.png")] = { width:86, height:31 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/search_btn_codefinder.png")] = { width:13, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/search_btn_codefinderD.png")] = { width:13, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_Title001.png")] = { width:8, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_Title002.png")] = { width:4, height:4 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/control_btn_down.png")] = { width:26, height:27 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/control_btn_help.png")] = { width:26, height:27 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/sta_MF_bgLine01.png")] = { width:399, height:282 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_MF_bgLine02.png")] = { width:348, height:83 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_MF_banner.png")] = { width:399, height:241 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MF_move.png")] = { width:8, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/Icon_MF_noti.png")] = { width:24, height:24 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MF_arrowRwh.png")] = { width:7, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/Icon_MF_payment.png")] = { width:36, height:36 };
        		imgcache[nexacro._getImageLocation("theme://images/Icon_MF_bookread.png")] = { width:36, height:36 };
        		imgcache[nexacro._getImageLocation("theme://images/Icon_MF_piechart.png")] = { width:36, height:36 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_MF_arrowRbk.png")] = { width:7, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/bg_MF_Round.png")] = { width:78, height:36 };
        		imgcache[nexacro._getImageLocation("theme://images/bg_MF_Round_wh.png")] = { width:78, height:36 };
        		imgcache[nexacro._getImageLocation("theme://images/img_dllogo.png")] = { width:145, height:66 };
        		imgcache[nexacro._getImageLocation("theme://images/ico_arrowGray.png")] = { width:7, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/img_nodata.png")] = { width:64, height:64 };
        		imgcache[nexacro._getImageLocation("theme://images/img_WF_Splitter.png")] = { width:5, height:81 };
        		...
        		imgcache[nexacro._getImageLocation("theme://file_icon_DOC.gif")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_DOC.png")] = { width:25, height:30 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_ETC.gif")] = { width:18, height:19 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_ETC.png")] = { width:25, height:30 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_IMG.gif")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_IMG.png")] = { width:25, height:30 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_PDF.gif")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_PDF.png")] = { width:25, height:30 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_PPT.gif")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_PPT.png")] = { width:25, height:30 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_TXT.gif")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_TXT.png")] = { width:25, height:30 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_XLS.gif")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_XLS.png")] = { width:25, height:30 };
        		imgcache[nexacro._getImageLocation("theme://file_icon_ZIP.gif")] = { width:16, height:16 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/btn_MF_arrowB.png")] = { width:7, height:12 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_home01N.png")] = { width:21, height:21 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_search01D.png")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_search01N.png")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_TF_search01O.png")] = { width:16, height:16 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMaxD.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMaxN.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMaxO.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMinD.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMinN.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_windowMinO.png")] = { width:16, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/cell_WF_treeLine.png")] = { width:11, height:14 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/ERP_LOGO01.png")] = { width:122, height:16 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/HDC_favicon.ico")] = { width:256, height:256 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/img_DAA_OrderInfo.png")] = { width:410, height:386 };
        		imgcache[nexacro._getImageLocation("theme://images/Img_FT_CI.png")] = { width:310, height:39 };
        		imgcache[nexacro._getImageLocation("theme://images/Img_FT_CI_.png")] = { width:125, height:36 };
        		imgcache[nexacro._getImageLocation("theme://images/img_LOGIN_CI_.png")] = { width:165, height:133 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/imv_TF_pictuer01.png")] = { width:27, height:27 };
        		imgcache[nexacro._getImageLocation("theme://images/imv_TF_pictuer02.png")] = { width:143, height:143 };
        		imgcache[nexacro._getImageLocation("theme://images/imv_TF_pictuer03.png")] = { width:41, height:41 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/leftmenu_di.png")] = { width:33, height:22 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/Nodata.png")] = { width:156, height:37 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/slt_WF_SplitterH.png")] = { width:400, height:23 };
        		imgcache[nexacro._getImageLocation("theme://images/slt_WF_SplitterV.png")] = { width:23, height:400 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_LF_logo01.png")] = { width:112, height:23 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_TF_HDClogo.png")] = { width:182, height:19 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_TITLE_Bg.png")] = { width:8, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_title_dot.png")] = { width:7, height:8 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_WF_TitleBG.png")] = { width:4, height:4 };
        		...
        		imgcache[nexacro._getImageLocation("theme://img_logo_DL.PNG")] = { width:174, height:82 };
        		...
        		imgcache[nexacro._getImageLocation("theme://login_check_off.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://login_check_on.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://pw_icon.png")] = { width:3, height:5 };
	};
}
)();
