(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("maxheight").set("620");
            if (Form == this.constructor)
            {
                this._setFormPosition(550,560);
            }
            ...
            obj = new Div("divData","0","42",null,null,"0","80",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("sta26","104","408",null,"30","10",null,null,null,null,null,this.divData.form);
            obj.set_taborder("38");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta27","10","408","95","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("39");
            obj.set_text("체크필드");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkCK_OMIT","110","411","122","24",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("16");
            obj.set_text("누락여부");
            ...
            obj = new Edit("txtFILE","199","412","277","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("47");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Button("btnConf","191",null,"69","27",null,"29",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("확인");
            this.addChild(obj.name, obj);

            obj = new Button("btnCancel","270",null,"69","27",null,"29",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("취소");
            this.addChild(obj.name, obj);

            obj = new Button("btnFile","380","503","70","27",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("첨부");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item13","divData.form.chkCK_OMIT","value","dsList","CK_OMIT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHA_ISSUEVATDLG_backup.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	trace("넘어온 전표번호 CD_SLIP :: "+this.CD_SLIP);
        	trace("넘어온 파일구분 FILE_DIR :: "+this.getOwnerFrame().FILE_DIR);
        	trace("넘어온 파일의로우 FILE_ROW :: "+this.getOwnerFrame().FILE_ROW);
        	...
        	if(this.GUBUN == "VATCONTROL"){
        		...
        		this.btnCancel.set_left(231);		//취소버튼 가운데
        ...
        */
        	...
        	switch(id) {
        		...
        		case "ccfCD_PROOF":	//증빙선택
        			if (arrData.length > 0) {
        				...
        				//전자세금계산서가 아닐경우
        				if(this.gfnIsNull(this.getOwnerFrame().ISSUE_ID)){
        					//부가세 계산
        ...
        this.dsList_ColumnChanged = function(obj, e)
        {
        	...
        	if(e.columnid == "TY_SALEBUY"){	//거래구분
        		//this.fnChangeTY_SALEBUY(e.newvalue);
        ...
        this.btnConf_onclick = function(obj,e)
        {
        	...
        	this.dsResult.setColumn(nRow, "FILE_DIR"   , this.dsList.getColumn(rPos, "FILE_DIR"));
        ...
        this.fnVatInit = function()
        {
        	if(this.getOwnerFrame().YN_VAT == "Y"){
        		...
        		if(!this.gfnIsNull(this.getOwnerFrame().CD_DEPT)){
        			...
        			var sDept = this.getOwnerFrame().CD_DEPT.split("|");

        			trace("sDept :: "+sDept);
        			trace("sDept[0] :: "+sDept[0]);
        			trace("sDept[1] :: "+sDept[1]);
        ...
        // 		this.dsList.addRow();
        //
        // 		if(!this.gfnIsNull(this.getOwnerFrame().CD_VATACCOUNT)){
        // 			trace("계정 있음");
        // 			var sAccnt = this.getOwnerFrame().CD_VATACCOUNT.split("|");
        // 			this.ccfCD_ACNT.form.CDTextBox.set_value(sAccnt[0]);
        // 			this.ccfCD_ACNT.form.DSTextBox.set_value(sAccnt[1]);
        // 		}
        ...
        this.fnSetParamData = function ()
        {
        	...
        	if(this.GUBUN == "SLIP"){
        		...
        		this.dsList.setColumn(nRow, "DT_PROOF"	, this.getOwnerFrame().DT_PROOF);		//회계일자
        		...
        		this.dsList.setColumn(nRow, "FILE_DIR"	, this.getOwnerFrame().FILE_DIR);

        		trace("### 부가세팝업 FILE_DIR :: "+this.getOwnerFrame().FILE_DIR);
        		...
        		this.dsList.setColumn(nRow, "CK_OMIT"	, this.getOwnerFrame().CK_OMIT);				//누락여부
        		this.dsList.setColumn(nRow, "VAT_RATE"	, this.getOwnerFrame().VAT_RATE);
        		...
        		if(!this.gfnIsNull(this.getOwnerFrame().NO_CREDIT)){
        			...
        			if(this.getOwnerFrame().CD_PROOF == "22"){
        				this.txtNO_SJC.set_value(this.getOwnerFrame().NO_CREDIT);
        			}
        		}
        ...
        // 		   cdProof == "18" || cdProof == "12" || cdProof == "19"){
        // 			chkFlag = true;
        // 		}
        ...
        this.fnEnableComp = function()
        {
        	...
        	if(this.GUBUN == "SLIP" && this.IUD_FLAG == "I"){
        ...
        this.loadIncludeScript("DHA_ISSUEVATDLG_backup.xfdl");
