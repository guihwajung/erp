(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_ORDERPLAN_SITE_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCBPR_ORDERPLAN_SITE_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCBPR_ORDERPLAN_SITE_DELETE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DCBPR_JOINBID_SITE_SELECT</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DCBPR_PR_JOINBID_UPDATE_HDC</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DCBPR_PREORDERPLAN_APPROVE_GW1_UPDATE</Col></Row><Row><Col id=\"TARGET\">update_attend</Col><Col id=\"SP\">DCBPR_SITE_EXPLAIN_ATTEND_UPDATE</Col></Row><Row><Col id=\"TARGET\">update_attach</Col><Col id=\"SP\">DCBPR_PR_EXPLAIN_FILE_CONFIRM</Col></Row><Row><Col id=\"TARGET\">select_jodal</Col><Col id=\"SP\">DZZPR_EPS_BID_SAP_MIDDLE_POPUP_SELECT</Col></Row><Row><Col id=\"TARGET\">appr_select</Col><Col id=\"SP\">DZRPR_AP_STATE_SELECT</Col></Row><Row><Col id=\"TARGET\">aplines</Col><Col id=\"SP\">DZRPR_APPLINES_SELECT</Col></Row><Row><Col id=\"TARGET\">execAppr</Col><Col id=\"SP\">DZZPR_APPROVAL_CALLBACK</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_BID\" type=\"STRING\" size=\"256\"/><Column id=\"YN_LINK\" type=\"STRING\" size=\"256\"/><Column id=\"ID_AP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"NO_BID\"/><Col id=\"ID_AP\"/><Col id=\"YN_LINK\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divData01","0","sta01:10","950","300",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("sta007","0","175","110","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("5");
            obj.set_text("현장 연면적");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta010","289","204","131","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("6");
            obj.set_text("1공구연면적");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta011","599","204","119","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("7");
            obj.set_text("2공구연면적");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta107","sta007:-1","175","181","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta110","sta010:-1","204","181","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta111","sta011:-1","204","231","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta205","597","175","121","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("15");
            obj.set_text("당사지분율");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta306","419","175","181","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta206","289","175",null,"30","sta306:-1",null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("16");
            obj.set_text("세대수");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta207","0","117","109","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("17");
            obj.set_text("입찰결과게시");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta208","289","262","131","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("18");
            obj.set_text("당해공종 공구분할수");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_visible("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta209","599","262","118","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("19");
            obj.set_text("금회 발주공구");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_visible("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta210","289","233","131","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("20");
            obj.set_text("3공구연면적");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta211","599","233","119","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("21");
            obj.set_text("4공구연면적");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta305","sta205:-1","175","231","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("24");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta307","sta207:-1","117","182","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta308","sta208:-1","262","181","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("27");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            obj.set_text("");
            ...
            obj = new Static("sta309","sta209:0","262","231","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("28");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta310","sta210:-1","233","181","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta311","sta211:-1","233","231","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta406","599","87","120","30.5",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("36");
            obj.set_text("선정방법");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_visible("false");
            ...
            obj = new Static("sta408","289","117","141","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("37");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_text("1식입찰(내역첨부)");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta409","599","117","120","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("38");
            obj.set_text("현설자료별도적용");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta410","0","204","110","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("39");
            obj.set_text("공구연면적합");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta506","sta406:-1","87","231","30.5",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("45");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("false");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta508","419","117","181","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("46");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta509","sta409:-1","117","231","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("47");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta510","sta410:-1","204","181","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("48");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("txtAREA_SITE","sta007:5","180","165","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("53");
            obj.set_value("");
            obj.set_type("number");
            obj.set_format("#,#.##");
            ...
            obj = new MaskEdit("txtAREA_GONGU1","sta010:5","209","165","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("54");
            obj.set_value("");
            obj.set_format("#,0.00");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new MaskEdit("txtAREA_GONGU2","sta011:5","209","216","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("55");
            obj.set_value("");
            obj.set_format("#,0.00");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("txtRT_JIBUN","sta205:5","180","216","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("58");
            obj.set_value("");
            obj.set_format("9,999.99");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new CheckBox("cchkYN_PUBLISH_BID","sta207:5","121","15","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("59");
            obj.set_text("");
            obj.set_truevalue("Y");
            ...
            obj = new Combo("ccboCT_GONGU","sta208:5","266","164","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("4");
            obj.set_innerdataset("dsGONGU");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            obj.set_visible("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Combo("ccboNUM_GONGU","sta209:5","267","216","19",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("2");
            obj.set_innerdataset("dsGONGU");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new MaskEdit("txtAREA_GONGU3","sta210:5","237","164","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("60");
            obj.set_value("");
            obj.set_format("#,0.00");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new MaskEdit("txtAREA_GONGU4","sta211:5","238","216","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("61");
            obj.set_value("");
            obj.set_format("#,0.00");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDS_SUBCON","sta405:5","63","216","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("68");
            obj.set_value("");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Combo("ccboTY_BID","sta406:5","92","216","19",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("3");
            ...
            obj = new CheckBox("cchkYN_ATTACH_ILSIK","sta408:5","121","16","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("69");
            obj.set_text("");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new CheckBox("cchkYN_EXFILE_SEPARATE","sta409:5","121","16","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("71");
            obj.set_text("");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new MaskEdit("txtAREA_GONGUALL","sta410:5","209","165","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("70");
            obj.set_value("");
            obj.set_format("#,#.##");
            obj.set_readonly("true");
            ...
            obj = new Static("sta407","0","262","110","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("73");
            obj.set_text("고용하수급승인");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_visible("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta507","sta407:-1","262","181","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("72");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            obj.set_visible("true");
            ...
            obj = new CheckBox("cchkYN_HASU00","115","266","16","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("74");
            obj.set_text("");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new MaskEdit("txtCT_HOUSEHOLD","424","180","165","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("75");
            obj.set_value("");
            obj.set_type("number");
            ...
            obj = new Layout("default","",0,0,this,
                ...
                p.sta007.set_taborder("5");
                p.sta007.set_text("현장 연면적");
                p.sta007.set_cssclass("sta_WF_tablelabel");
                p.sta007.move("0","175","110","30",null,null);

                p.sta010.set_taborder("6");
                p.sta010.set_text("1공구연면적");
                p.sta010.set_cssclass("sta_WF_tablelabelE");
                p.sta010.move("289","204","131","30",null,null);

                p.sta011.set_taborder("7");
                p.sta011.set_text("2공구연면적");
                p.sta011.set_cssclass("sta_WF_tablelabelE");
                p.sta011.move("599","204","119","30",null,null);

                p.sta101.set_taborder("8");
                p.sta101.set_cssclass("sta_WF_tablebg");
                p.sta101.set_visible("false");
                p.sta101.move("sta001:-1","0","181","30",null,null);

                p.sta102.set_taborder("9");
                ...
                p.sta107.set_taborder("10");
                p.sta107.set_cssclass("sta_WF_tablebg");
                p.sta107.move("sta007:-1","175","181","30",null,null);

                p.sta110.set_taborder("11");
                p.sta110.set_cssclass("sta_WF_tablebg");
                p.sta110.move("sta010:-1","204","181","30",null,null);

                p.sta111.set_taborder("12");
                p.sta111.set_cssclass("sta_WF_tablebg");
                p.sta111.move("sta011:-1","204","231","30",null,null);

                p.sta201.set_taborder("13");
                p.sta201.set_text("계약유형");
                p.sta201.set_cssclass("sta_WF_tablelabelE");
                p.sta201.move("0","0","110","30",null,null);

                p.sta202.set_taborder("14");
                p.sta202.set_text("과세율");
                p.sta202.set_cssclass("sta_WF_tablelabel");
                p.sta202.move("sta102:-1","sta201:-1","131","30",null,null);

                p.sta205.set_taborder("15");
                p.sta205.set_text("당사지분율");
                p.sta205.set_cssclass("sta_WF_tablelabel");
                p.sta205.move("597","175","121","30",null,null);

                p.sta306.set_taborder("25");
                p.sta306.set_cssclass("sta_WF_tablebg");
                p.sta306.set_text("");
                p.sta306.move("419","175","181","30",null,null);

                p.sta206.set_taborder("16");
                p.sta206.set_text("세대수");
                p.sta206.set_cssclass("sta_WF_tablelabel");
                p.sta206.move("289","175",null,"30","sta306:-1",null);

                p.sta207.set_taborder("17");
                p.sta207.set_text("입찰결과게시");
                p.sta207.set_cssclass("sta_WF_tablelabel");
                p.sta207.move("0","117","109","30",null,null);

                p.sta208.set_taborder("18");
                p.sta208.set_text("당해공종 공구분할수");
                p.sta208.set_cssclass("sta_WF_tablelabel");
                p.sta208.set_visible("true");
                p.sta208.move("289","262","131","30",null,null);

                p.sta209.set_taborder("19");
                p.sta209.set_text("금회 발주공구");
                p.sta209.set_cssclass("sta_WF_tablelabel");
                p.sta209.set_visible("true");
                p.sta209.move("599","262","118","30",null,null);

                p.sta210.set_taborder("20");
                p.sta210.set_text("3공구연면적");
                p.sta210.set_cssclass("sta_WF_tablelabelE");
                p.sta210.move("289","233","131","30",null,null);

                p.sta211.set_taborder("21");
                p.sta211.set_text("4공구연면적");
                p.sta211.set_cssclass("sta_WF_tablelabelE");
                p.sta211.move("599","233","119","30",null,null);

                p.sta301.set_taborder("22");
                p.sta301.set_cssclass("sta_WF_tablebg");
                p.sta301.move("sta201:-1","0","181","30",null,null);

                p.sta302.set_taborder("23");
                p.sta302.set_cssclass("sta_WF_tablebg");
                p.sta302.move("sta202:-1","sta301:-1","181","30",null,null);

                p.sta305.set_taborder("24");
                p.sta305.set_cssclass("sta_WF_tablebg");
                p.sta305.set_text("");
                p.sta305.move("sta205:-1","175","231","30",null,null);

                p.sta307.set_taborder("26");
                p.sta307.set_cssclass("sta_WF_tablebg");
                p.sta307.move("sta207:-1","117","182","30",null,null);

                p.sta308.set_taborder("27");
                p.sta308.set_cssclass("sta_WF_tablebg");
                p.sta308.set_visible("true");
                p.sta308.set_text("");
                p.sta308.move("sta208:-1","262","181","30",null,null);

                p.sta309.set_taborder("28");
                p.sta309.set_cssclass("sta_WF_tablebg");
                p.sta309.set_visible("true");
                p.sta309.move("sta209:0","262","231","30",null,null);

                p.sta310.set_taborder("29");
                p.sta310.set_cssclass("sta_WF_tablebg");
                p.sta310.move("sta210:-1","233","181","30",null,null);

                p.sta311.set_taborder("30");
                p.sta311.set_cssclass("sta_WF_tablebg");
                p.sta311.move("sta211:-1","233","231","30",null,null);

                p.sta401.set_taborder("31");
                p.sta401.set_text("과세구분");
                p.sta401.set_cssclass("sta_WF_tablelabelE");
                p.sta401.move("sta301:-1","0","131","30",null,null);

                p.sta402.set_taborder("32");
                p.sta402.set_text("공사기간");
                p.sta402.set_cssclass("sta_WF_tablelabelE");
                p.sta402.move("sta302:-1","sta401:-1","120","30",null,null);

                p.sta403.set_taborder("33");
                p.sta403.set_text("부문");
                p.sta403.set_cssclass("sta_WF_tablelabelE");
                p.sta403.move("0","58","110","30",null,null);

                p.sta404.set_taborder("34");
                p.sta404.set_text("하도공종");
                p.sta404.set_cssclass("sta_WF_tablelabelE");
                p.sta404.move("289","58","131","30",null,null);

                p.sta405.set_taborder("35");
                p.sta405.set_text("하도급명");
                p.sta405.set_cssclass("sta_WF_tablelabelE");
                p.sta405.move("599","58","120","30",null,null);

                p.sta406.set_taborder("36");
                p.sta406.set_text("선정방법");
                p.sta406.set_cssclass("sta_WF_tablelabel");
                p.sta406.set_visible("false");
                p.sta406.move("599","87","120","30.5",null,null);

                p.sta408.set_taborder("37");
                p.sta408.set_cssclass("sta_WF_tablelabel");
                p.sta408.set_text("1식입찰(내역첨부)");
                p.sta408.move("289","117","141","30",null,null);

                p.sta409.set_taborder("38");
                p.sta409.set_text("현설자료별도적용");
                p.sta409.set_cssclass("sta_WF_tablelabel");
                p.sta409.move("599","117","120","30",null,null);

                p.sta410.set_taborder("39");
                p.sta410.set_text("공구연면적합");
                p.sta410.set_cssclass("sta_WF_tablelabel");
                p.sta410.move("0","204","110","30",null,null);

                p.sta501.set_taborder("40");
                p.sta501.set_cssclass("sta_WF_tablebg");
                p.sta501.move("sta401:-1","0","181","30",null,null);

                p.sta502.set_taborder("41");
                p.sta502.set_cssclass("sta_WF_tablebg");
                p.sta502.move("sta402:-1","sta501:-1","231","30",null,null);

                p.sta503.set_taborder("42");
                p.sta503.set_cssclass("sta_WF_tablebg");
                p.sta503.move("sta403:-1","58","181","30",null,null);

                p.sta504.set_taborder("43");
                p.sta504.set_cssclass("sta_WF_tablebg");
                p.sta504.move("sta404:-1","58","181","30",null,null);

                p.sta505.set_taborder("44");
                p.sta505.set_cssclass("sta_WF_tablebg");
                p.sta505.move("sta405:-1","58","231","30",null,null);

                p.sta506.set_taborder("45");
                p.sta506.set_cssclass("sta_WF_tablebg");
                p.sta506.set_visible("false");
                p.sta506.move("sta406:-1","87","231","30.5",null,null);

                p.sta508.set_taborder("46");
                p.sta508.set_cssclass("sta_WF_tablebg");
                p.sta508.move("419","117","181","30",null,null);

                p.sta509.set_taborder("47");
                p.sta509.set_cssclass("sta_WF_tablebg");
                p.sta509.set_text("");
                p.sta509.move("sta409:-1","117","231","30",null,null);

                p.sta510.set_taborder("48");
                p.sta510.set_cssclass("sta_WF_tablebg");
                p.sta510.move("sta410:-1","204","181","30",null,null);

                p.staSpace00.set_taborder("50");
                p.staSpace00.set_text("");
                p.staSpace00.set_cssclass("sta_WF_tablelabelE");
                p.staSpace00.move("sta501:-1","0","120","30",null,null);

                p.staBgSpace00.set_taborder("51");
                ...
                p.txtAREA_SITE.set_taborder("53");
                p.txtAREA_SITE.set_value("");
                p.txtAREA_SITE.set_type("number");
                p.txtAREA_SITE.set_format("#,#.##");
                p.txtAREA_SITE.move("sta007:5","180","165","20",null,null);

                p.txtAREA_GONGU1.set_taborder("54");
                p.txtAREA_GONGU1.set_value("");
                p.txtAREA_GONGU1.set_format("#,0.00");
                p.txtAREA_GONGU1.move("sta010:5","209","165","20",null,null);

                p.txtAREA_GONGU2.set_taborder("55");
                p.txtAREA_GONGU2.set_value("");
                p.txtAREA_GONGU2.set_format("#,0.00");
                p.txtAREA_GONGU2.move("sta011:5","209","216","20",null,null);

                p.cboDS_CONTMETHOD.set_taborder("56");
                ...
                p.txtRT_TAX.set_taborder("57");
                p.txtRT_TAX.set_value("");
                p.txtRT_TAX.set_format("#,0.##");
                p.txtRT_TAX.move("sta202:5","sta301:4","164","20",null,null);

                p.txtRT_JIBUN.set_taborder("58");
                p.txtRT_JIBUN.set_value("");
                p.txtRT_JIBUN.set_format("9,999.99");
                p.txtRT_JIBUN.move("sta205:5","180","216","20",null,null);

                p.cchkYN_PUBLISH_BID.set_taborder("59");
                p.cchkYN_PUBLISH_BID.set_text("");
                p.cchkYN_PUBLISH_BID.set_truevalue("Y");
                p.cchkYN_PUBLISH_BID.set_falsevalue("N");
                p.cchkYN_PUBLISH_BID.move("sta207:5","121","15","20",null,null);

                p.ccboCT_GONGU.set_taborder("4");
                p.ccboCT_GONGU.set_innerdataset("dsGONGU");
                p.ccboCT_GONGU.set_codecolumn("CD_CODE");
                p.ccboCT_GONGU.set_datacolumn("DS_CODE");
                p.ccboCT_GONGU.set_visible("true");
                p.ccboCT_GONGU.move("sta208:5","266","164","20",null,null);

                p.ccboNUM_GONGU.set_taborder("2");
                p.ccboNUM_GONGU.set_innerdataset("dsGONGU");
                p.ccboNUM_GONGU.set_codecolumn("CD_CODE");
                p.ccboNUM_GONGU.set_datacolumn("DS_CODE");
                p.ccboNUM_GONGU.set_visible("true");
                p.ccboNUM_GONGU.move("sta209:5","267","216","19",null,null);

                p.txtAREA_GONGU3.set_taborder("60");
                p.txtAREA_GONGU3.set_value("");
                p.txtAREA_GONGU3.set_format("#,0.00");
                p.txtAREA_GONGU3.move("sta210:5","237","164","20",null,null);

                p.txtAREA_GONGU4.set_taborder("61");
                p.txtAREA_GONGU4.set_value("");
                p.txtAREA_GONGU4.set_format("#,0.00");
                p.txtAREA_GONGU4.move("sta211:5","238","216","20",null,null);

                p.cboTY_TAX.set_taborder("62");
                ...
                p.txtDS_SUBCON.set_taborder("68");
                p.txtDS_SUBCON.set_value("");
                p.txtDS_SUBCON.move("sta405:5","63","216","20",null,null);

                p.ccboTY_BID.set_taborder("3");
                p.ccboTY_BID.set_innerdataset("dsTY_BID");
                p.ccboTY_BID.set_codecolumn("CD_CODE");
                p.ccboTY_BID.set_datacolumn("DS_CODE");
                p.ccboTY_BID.set_visible("false");
                p.ccboTY_BID.move("sta406:5","92","216","19",null,null);

                p.cchkYN_ATTACH_ILSIK.set_taborder("69");
                p.cchkYN_ATTACH_ILSIK.set_text("");
                p.cchkYN_ATTACH_ILSIK.set_falsevalue("N");
                p.cchkYN_ATTACH_ILSIK.set_truevalue("Y");
                p.cchkYN_ATTACH_ILSIK.move("sta408:5","121","16","20",null,null);

                p.cchkYN_EXFILE_SEPARATE.set_taborder("71");
                p.cchkYN_EXFILE_SEPARATE.set_text("");
                p.cchkYN_EXFILE_SEPARATE.set_falsevalue("N");
                p.cchkYN_EXFILE_SEPARATE.set_truevalue("Y");
                p.cchkYN_EXFILE_SEPARATE.move("sta409:5","121","16","20",null,null);

                p.txtAREA_GONGUALL.set_taborder("70");
                p.txtAREA_GONGUALL.set_value("");
                p.txtAREA_GONGUALL.set_format("#,#.##");
                p.txtAREA_GONGUALL.set_readonly("true");
                p.txtAREA_GONGUALL.move("sta410:5","209","165","20",null,null);

                p.cfCD_COSTCLASS.getSetter("CodeFindName").set("DCX_CFCOSTCLASS_01");
                p.cfCD_COSTCLASS.getSetter("CDTextWidth").set("70");
                p.cfCD_COSTCLASS.set_taborder("65");
                ...
                p.cfCD_LICCOST.set_taborder("66");
                p.cfCD_LICCOST.set_url("cmm::cmmCodeFind.xfdl");
                p.cfCD_LICCOST.move("sta404:5","63","165","20",null,null);

                p.sta407.set_taborder("73");
                p.sta407.set_text("고용하수급승인");
                p.sta407.set_cssclass("sta_WF_tablelabel");
                p.sta407.set_visible("true");
                p.sta407.move("0","262","110","30",null,null);

                p.sta507.set_taborder("72");
                p.sta507.set_cssclass("sta_WF_tablebg");
                p.sta507.set_text("");
                p.sta507.set_visible("true");
                p.sta507.move("sta407:-1","262","181","30",null,null);

                p.cchkYN_HASU00.set_taborder("74");
                p.cchkYN_HASU00.set_text("");
                p.cchkYN_HASU00.set_falsevalue("N");
                p.cchkYN_HASU00.set_truevalue("Y");
                p.cchkYN_HASU00.set_visible("true");
                p.cchkYN_HASU00.move("115","266","16","20",null,null);

                p.txtCT_HOUSEHOLD.set_taborder("75");
                p.txtCT_HOUSEHOLD.set_value("");
                p.txtCT_HOUSEHOLD.set_type("number");
                p.txtCT_HOUSEHOLD.set_format("999,999");
                p.txtCT_HOUSEHOLD.move("424","180","165","20",null,null);
                // this.divData.form.divData01 }}
                ...
                p.sta03.set_textDecoration("none");
                ...
                p.sta05.set_taborder("1");
                p.sta05.set_cssclass("sta_WF_tablebg");
                p.sta05.move("sta06:-1","30","199","30",null,null);

                p.sta08.set_taborder("1");
                p.sta08.set_cssclass("sta_WF_tablebg");
                p.sta08.move("sta07:-1","sta05:-1","199","30",null,null);

                p.txtRM_BIDREMARK.set_taborder("2");
                ...
                p.ccfID_SITESABUN.set_taborder("1");
                p.ccfID_SITESABUN.set_url("cmm::cmmCodeFind.xfdl");
                p.ccfID_SITESABUN.move("sta00:5","sta101:4","272","20",null,null);

                p.ccfID_MANAGER.getSetter("CodeFindName").set("DZX_CFUSER");
                p.ccfID_MANAGER.getSetter("CDTextWidth").set("70");
                p.ccfID_MANAGER.set_taborder("1");
                p.ccfID_MANAGER.set_url("cmm::cmmCodeFind.xfdl");
                p.ccfID_MANAGER.move("sta001:5","35","272","20",null,null);

                p.txtNO_MANAGERTEL.set_taborder("2");
                p.txtNO_MANAGERTEL.set_value("");
                p.txtNO_MANAGERTEL.move("sta06:5","35","188","20",null,null);

                p.txtNO_SITETEL.set_taborder("2");
                p.txtNO_SITETEL.set_value("");
                p.txtNO_SITETEL.move("sta07:5","sta05:4","188","20",null,null);
                // this.divData.form.tabData.tab1.form.div01 }}
                ...
                p.ccfID_SITESABUN_01.set_taborder("1");
                p.ccfID_SITESABUN_01.set_url("cmm::cmmCodeFind.xfdl");
                p.ccfID_SITESABUN_01.getSetter("readonly").set("true");
                p.ccfID_SITESABUN_01.move("sta00:5","sta101:4","272","20",null,null);

                p.ccfID_MANAGER_01.getSetter("CodeFindName").set("DZX_CFUSER");
                p.ccfID_MANAGER_01.getSetter("CDTextWidth").set("70");
                p.ccfID_MANAGER_01.set_taborder("1");
                p.ccfID_MANAGER_01.set_url("cmm::cmmCodeFind.xfdl");
                p.ccfID_MANAGER_01.getSetter("readonly").set("true");
                p.ccfID_MANAGER_01.move("sta001:5","35","272","20",null,null);

                p.txtNO_MANAGERTEL.set_taborder("2");
                p.txtNO_MANAGERTEL.set_value("");
                p.txtNO_MANAGERTEL.set_readonly("true");
                p.txtNO_MANAGERTEL.move("sta06:5","35","188","20",null,null);
                ...
                p.divDataApprLeft.set_taborder("5");
                p.divDataApprLeft.set_background("");
                p.divDataApprLeft.set_border("1px solid #c9c6c3");
                p.divDataApprLeft.move("0","0","700","79",null,null);

                p.divDataAppr.set_taborder("4");
                p.divDataAppr.move("divDataApprLeft:10","0",null,"80","0",null);

                p.sta01.set_taborder("3");
                p.sta01.set_text("선정 및 승인사항");
                p.sta01.set_cssclass("sta_TITLE_Bg");
                p.sta01.move("0","divDataAppr:10","950","22",null,null);
            ...
            obj = new Layout("default0","",0,0,this,
                ...
                p.sta007.set_taborder("2");
                p.sta007.set_text("현장 연면적");
                p.sta007.set_cssclass("sta_WF_tablelabel");
                p.sta007.move("0","175","110","30",null,null);

                p.sta010.set_taborder("3");
                p.sta010.set_text("1공구연면적");
                p.sta010.set_cssclass("sta_WF_tablelabel");
                p.sta010.move("289","204","131","30",null,null);

                p.sta011.set_taborder("4");
                p.sta011.set_text("2공구연면적");
                p.sta011.set_cssclass("sta_WF_tablelabel");
                p.sta011.move("599","204","119","30",null,null);

                p.sta101.set_taborder("5");
                p.sta101.set_cssclass("sta_WF_tablebg");
                p.sta101.move("sta001:-1","0","181","30",null,null);

                p.sta102.set_taborder("6");
                p.sta102.set_cssclass("sta_WF_tablebg");
                p.sta102.move("sta002:-1","sta101:-1","181","30",null,null);

                p.sta107.set_taborder("7");
                p.sta107.set_cssclass("sta_WF_tablebg");
                p.sta107.move("sta007:-1","175","181","30",null,null);

                p.sta110.set_taborder("8");
                p.sta110.set_cssclass("sta_WF_tablebg");
                p.sta110.move("sta010:-1","204","181","30",null,null);

                p.sta111.set_taborder("9");
                p.sta111.set_cssclass("sta_WF_tablebg");
                p.sta111.move("sta011:-1","204","231","30",null,null);

                p.sta201.set_taborder("10");
                p.sta201.set_text("계약유형");
                p.sta201.set_cssclass("sta_WF_tablelabelE");
                p.sta201.move("sta101:-1","0","131","30",null,null);

                p.sta202.set_taborder("11");
                p.sta202.set_text("면세율");
                p.sta202.set_cssclass("sta_WF_tablelabel");
                p.sta202.move("sta102:-1","sta201:-1","131","30",null,null);

                p.sta205.set_taborder("12");
                p.sta205.set_text("당사지분율");
                p.sta205.set_cssclass("sta_WF_tablelabel");
                p.sta205.move("597","175","121","30",null,null);

                p.sta206.set_taborder("13");
                p.sta206.set_text("세대수");
                p.sta206.set_cssclass("sta_WF_tablelabel");
                p.sta206.move("289","175","131","30",null,null);

                p.sta207.set_taborder("14");
                p.sta207.set_text("입찰결과게시");
                p.sta207.set_cssclass("sta_WF_tablelabel");
                p.sta207.move("0","117","109","30",null,null);

                p.sta208.set_taborder("15");
                p.sta208.set_text("당해공종 공구분할수");
                p.sta208.set_cssclass("sta_WF_tablelabel");
                p.sta208.set_visible("true");
                p.sta208.move("289","262","131","30",null,null);

                p.sta209.set_taborder("16");
                p.sta209.set_text("금회 발주공구");
                p.sta209.set_cssclass("sta_WF_tablelabel");
                p.sta209.set_visible("true");
                p.sta209.move("599","262","118","30",null,null);

                p.sta210.set_taborder("17");
                p.sta210.set_text("3공구 연면적");
                p.sta210.set_cssclass("sta_WF_tablelabel");
                p.sta210.move("289","233","131","30",null,null);

                p.sta211.set_taborder("18");
                p.sta211.set_text("4공구 연면적");
                p.sta211.set_cssclass("sta_WF_tablelabel");
                p.sta211.move("599","233","119","30",null,null);

                p.sta301.set_taborder("19");
                p.sta301.set_cssclass("sta_WF_tablebg");
                p.sta301.move("sta201:-1","0","181","30",null,null);

                p.sta302.set_taborder("20");
                p.sta302.set_cssclass("sta_WF_tablebg");
                p.sta302.move("sta202:-1","sta301:-1","181","30",null,null);

                p.sta305.set_taborder("21");
                p.sta305.set_cssclass("sta_WF_tablebg");
                p.sta305.set_text("");
                p.sta305.move("sta205:-1","175","231","30",null,null);

                p.sta306.set_taborder("22");
                p.sta306.set_cssclass("sta_WF_tablebg");
                p.sta306.move("419","175","181","30",null,null);

                p.sta307.set_taborder("23");
                p.sta307.set_cssclass("sta_WF_tablebg");
                p.sta307.move("sta207:-1","117","181","30",null,null);

                p.sta308.set_taborder("24");
                p.sta308.set_cssclass("sta_WF_tablebg");
                p.sta308.set_visible("true");
                p.sta308.set_text("");
                p.sta308.move("sta208:-1","262","181","30",null,null);

                p.sta309.set_taborder("25");
                p.sta309.set_cssclass("sta_WF_tablebg");
                p.sta309.set_visible("true");
                p.sta309.move("sta209:0","262","231","30",null,null);

                p.sta310.set_taborder("26");
                p.sta310.set_cssclass("sta_WF_tablebg");
                p.sta310.move("sta210:-1","233","181","30",null,null);

                p.sta311.set_taborder("27");
                p.sta311.set_cssclass("sta_WF_tablebg");
                p.sta311.move("sta211:-1","233","231","30",null,null);

                p.sta401.set_taborder("28");
                p.sta401.set_text("과세구분");
                p.sta401.set_cssclass("sta_WF_tablelabelE");
                p.sta401.move("sta301:-1","0","131","30",null,null);

                p.sta402.set_taborder("29");
                p.sta402.set_text("공사기간");
                p.sta402.set_cssclass("sta_WF_tablelabelE");
                p.sta402.move("sta302:-1","sta401:-1","120","30",null,null);

                p.sta403.set_taborder("30");
                p.sta403.set_text("부문");
                p.sta403.set_cssclass("sta_WF_tablelabelE");
                p.sta403.move("0","58","110","30",null,null);

                p.sta404.set_taborder("31");
                p.sta404.set_text("하도공종");
                p.sta404.set_cssclass("sta_WF_tablelabelE");
                p.sta404.move("289","58","130","30",null,null);

                p.sta405.set_taborder("32");
                p.sta405.set_text("하도급명");
                p.sta405.set_cssclass("sta_WF_tablelabelE");
                p.sta405.move("599","58","120","30",null,null);

                p.sta406.set_taborder("33");
                p.sta406.set_text("선정방법");
                p.sta406.set_cssclass("sta_WF_tablelabel");
                p.sta406.set_visible("true");
                p.sta406.move("599","87","120","30.5",null,null);

                p.sta408.set_taborder("34");
                p.sta408.set_cssclass("sta_WF_tablelabel");
                p.sta408.set_text("1식입찰(내역첨부)");
                p.sta408.move("289","117","141","30",null,null);

                p.sta409.set_taborder("35");
                p.sta409.set_text("현설자료별도적용");
                p.sta409.set_cssclass("sta_WF_tablelabel");
                p.sta409.move("599","117","120","30",null,null);

                p.sta410.set_taborder("36");
                p.sta410.set_text("공구연면적합");
                p.sta410.set_cssclass("sta_WF_tablelabel");
                p.sta410.move("0","204","110","30",null,null);

                p.sta501.set_taborder("37");
                p.sta501.set_cssclass("sta_WF_tablebg");
                p.sta501.move("sta401:-1","0","231","30",null,null);

                p.sta502.set_taborder("38");
                p.sta502.set_cssclass("sta_WF_tablebg");
                p.sta502.move("sta402:-1","sta501:-1","231","30",null,null);

                p.sta503.set_taborder("39");
                p.sta503.set_cssclass("sta_WF_tablebg");
                p.sta503.move("sta403:-1","58","180","30",null,null);

                p.sta504.set_taborder("40");
                p.sta504.set_cssclass("sta_WF_tablebg");
                p.sta504.move("sta404:-1","58","182","30",null,null);

                p.sta505.set_taborder("41");
                p.sta505.set_cssclass("sta_WF_tablebg");
                p.sta505.move("sta405:-1","58","231","30",null,null);

                p.sta506.set_taborder("42");
                p.sta506.set_cssclass("sta_WF_tablebg");
                p.sta506.set_visible("true");
                p.sta506.move("sta406:-1","87","231","30.5",null,null);

                p.sta508.set_taborder("43");
                p.sta508.set_cssclass("sta_WF_tablebg");
                p.sta508.move("419","117","181","30",null,null);

                p.sta509.set_taborder("44");
                p.sta509.set_cssclass("sta_WF_tablebg");
                p.sta509.set_text("");
                p.sta509.move("sta409:-1","117","231","30",null,null);

                p.sta510.set_taborder("45");
                p.sta510.set_cssclass("sta_WF_tablebg");
                p.sta510.move("sta410:-1","204","181","30",null,null);
                ...
                p.txtAREA_SITE.set_taborder("51");
                p.txtAREA_SITE.set_value("");
                p.txtAREA_SITE.set_type("number");
                p.txtAREA_SITE.set_format("#,#.##");
                p.txtAREA_SITE.move("sta007:5","180","165","20",null,null);

                p.txtAREA_GONGU1.set_taborder("52");
                p.txtAREA_GONGU1.set_value("");
                p.txtAREA_GONGU1.set_format("#,#.##");
                p.txtAREA_GONGU1.move("sta010:5","209","165","20",null,null);

                p.txtAREA_GONGU2.set_taborder("53");
                p.txtAREA_GONGU2.set_value("");
                p.txtAREA_GONGU2.set_format("#,#.##");
                p.txtAREA_GONGU2.move("sta011:5","209","216","20",null,null);
                ...
                p.txtRT_JIBUN.set_taborder("56");
                p.txtRT_JIBUN.set_value("");
                p.txtRT_JIBUN.set_format("9,999.99");
                p.txtRT_JIBUN.move("sta205:5","180","216","20",null,null);

                p.cchkYN_PUBLISH_BID.set_taborder("58");
                p.cchkYN_PUBLISH_BID.set_text("");
                p.cchkYN_PUBLISH_BID.set_truevalue("Y");
                p.cchkYN_PUBLISH_BID.set_falsevalue("N");
                p.cchkYN_PUBLISH_BID.move("sta207:5","121","15","20",null,null);
                ...
                p.txtAREA_GONGU3.set_taborder("59");
                p.txtAREA_GONGU3.set_value("");
                p.txtAREA_GONGU3.set_format("#,#.##");
                p.txtAREA_GONGU3.move("sta210:5","237","164","20",null,null);

                p.txtAREA_GONGU4.set_taborder("60");
                p.txtAREA_GONGU4.set_value("");
                p.txtAREA_GONGU4.set_format("#,#.##");
                p.txtAREA_GONGU4.move("sta211:5","238","216","20",null,null);
                ...
                p.ccboTY_BID.set_codecolumn("CD_CODE");
                p.ccboTY_BID.set_datacolumn("DS_CODE");
                p.ccboTY_BID.set_visible("true");
                p.ccboTY_BID.move("sta406:5","92","216","19",null,null);

                p.cchkYN_ATTACH_ILSIK.set_taborder("68");
                p.cchkYN_ATTACH_ILSIK.set_text("");
                p.cchkYN_ATTACH_ILSIK.set_falsevalue("N");
                p.cchkYN_ATTACH_ILSIK.set_truevalue("Y");
                p.cchkYN_ATTACH_ILSIK.move("sta408:5","121","16","20",null,null);

                p.cchkYN_EXFILE_SEPARATE.set_taborder("70");
                p.cchkYN_EXFILE_SEPARATE.set_text("");
                p.cchkYN_EXFILE_SEPARATE.set_falsevalue("N");
                p.cchkYN_EXFILE_SEPARATE.set_truevalue("Y");
                p.cchkYN_EXFILE_SEPARATE.move("sta409:5","121","16","20",null,null);

                p.txtAREA_GONGUALL.set_taborder("69");
                p.txtAREA_GONGUALL.set_value("");
                p.txtAREA_GONGUALL.set_format("#,#.##");
                p.txtAREA_GONGUALL.set_readonly("true");
                p.txtAREA_GONGUALL.move("sta410:5","209","165","20",null,null);
                ...
                p.sta407.set_taborder("72");
                p.sta407.set_text("고용하수급승인");
                p.sta407.set_cssclass("sta_WF_tablelabel");
                p.sta407.set_visible("true");
                p.sta407.move("0","262","110","30",null,null);

                p.sta507.set_taborder("71");
                p.sta507.set_cssclass("sta_WF_tablebg");
                p.sta507.set_text("");
                p.sta507.set_visible("true");
                p.sta507.move("sta407:-1","262","181","30",null,null);

                p.cchkYN_HASU00.set_taborder("73");
                p.cchkYN_HASU00.set_text("");
                p.cchkYN_HASU00.set_falsevalue("N");
                p.cchkYN_HASU00.set_truevalue("Y");
                p.cchkYN_HASU00.set_visible("true");
                ...
                p.tclDT_EXPLAIN.set_autoselect("true");
                p.tclDT_EXPLAIN.set_value("");
                p.tclDT_EXPLAIN.set_onchanged("divData_tabData_tab1_div00_tclDT_EXPLAIN_onchanged");
                p.tclDT_EXPLAIN.move("sta03:5","sta02:4","110","20",null,null);
                ...
                p.divData01.set_taborder("1");
                p.divData01.set_text("");
                p.divData01.move("0","32","950","300",null,null);

                p.divData02.set_taborder("2");
                p.divData02.move("0","342","1100","59",null,null);
            ...
            obj = new BindItem("item10","divData.form.divData01.form.txtAREA_SITE","value","dsList","AREA_SITE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divData.form.divData01.form.txtAREA_GONGU1","value","dsList","AREA_SITE1");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","divData.form.divData01.form.txtAREA_GONGU2","value","dsList","AREA_SITE2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divData.form.divData01.form.txtAREA_GONGU3","value","dsList","AREA_SITE3");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","divData.form.divData01.form.txtAREA_GONGU4","value","dsList","AREA_SITE4");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item17","divData.form.divData01.form.txtAREA_GONGUALL","value","dsList","AREA_SITEALL");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item20","divData.form.divData01.form.txtRT_JIBUN","value","dsList","RT_JIBUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item22","divData.form.divData01.form.cchkYN_PUBLISH_BID","value","dsList","YN_PUBLISH_BID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item23","divData.form.divData01.form.ccboCT_GONGU","value","dsList","CT_GONGU");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item24","divData.form.divData01.form.ccboNUM_GONGU","value","dsList","NUM_GONGU");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item33","divData.form.divData01.form.ccboTY_BID","value","dsList","TY_BID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item35","divData.form.divData01.form.cchkYN_ATTACH_ILSIK","value","dsList","YN_ATTACH_ILSIK");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item46","divData.form.tabData.tab1.form.div00.form.tclDT_EXPLAIN","value","dsList","DT_EXPLAIN");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item48","divData.form.tabData.tab1.form.div00.form.tclDT_EXPLAIN_GONGO","value","dsList","DT_EXPLAIN_GONGO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item49","divData.form.tabData.tab1.form.div01.form.ccfID_MANAGER.form.CDTextBox","value","dsList","ID_MANAGER");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item50","divData.form.tabData.tab1.form.div01.form.ccfID_MANAGER.form.DSTextBox","value","dsList","NM_MANAGER");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item51","divData.form.tabData.tab1.form.div01.form.txtNO_MANAGERTEL","value","dsList","NO_MANAGERTEL");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item61","divData.form.tabData.tab3.form.div01.form.ccfID_MANAGER_01.form.CDTextBox","value","dsList","ID_MANAGER");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item62","divData.form.tabData.tab3.form.div01.form.ccfID_MANAGER_01.form.DSTextBox","value","dsList","NM_MANAGER");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item63","divData.form.tabData.tab3.form.div01.form.txtNO_MANAGERTEL","value","dsList","NO_MANAGERTEL");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item92","divData.form.divData01.form.cchkYN_EXFILE_SEPARATE","value","dsList","YN_EXFILE_SEPARATE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item93","divData.form.tabData.tab1.form.div00.form.ccboDT_EXPLAIN_HOUR","value","dsTempTime","EXPLAIN_HOUR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item94","divData.form.tabData.tab1.form.div00.form.ccboDT_EXPLAIN_MINUTE","value","dsTempTime","EXPLAIN_MINUTE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","divData.form.divData01.form.txtCT_HOUSEHOLD","value","dsList","CT_HOUSEHOLDS");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_ORDERPLANSR_SITE_APPROVAL.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnDetail = this.gfnFormButtonAdd("btnDetail", "fnBtnDetail"); // 발주내역 버튼.
        ...
        this.fnSetCombo = function()
        {
        	...
        	var outData     = "dsTY_ACCOUNT=combo0 dsDS_CONTMETHOD=combo1 dsTY_BID=combo2 dsONOFF_EXPLAIN=combo3 dsONOFF=combo4";
        	var strArg      = "";
        ...
        // 발주내역 버튼 클릭 이벤트
        this.fnBtnDetail = function(obj,e)
        {
        	var param = {};
        	param.CD_SITE = this.dsSearch.getColumn(0, "CD_SITE");
        	param.DS_SITE = this.divSearch.form.ccfCD_SITE.form.DSTextBox.text;
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCB_PRITEM", "", param);
        }
        });
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divData01.form.sta306.addEventHandler("onclick",this.divData_divData01_sta306_onclick,this);
            this.divData.form.tabData.addEventHandler("onchanged",this.divData_tabData_onchanged,this);
            this.divData.form.tabData.tab1.form.div00.form.tclDT_EXPLAIN.addEventHandler("onchanged",this.divData_tabData_tab1_div00_tclDT_EXPLAIN_onchanged,this);
        ...
        this.loadIncludeScript("DCB_ORDERPLANSR_SITE_APPROVAL.xfdl");
