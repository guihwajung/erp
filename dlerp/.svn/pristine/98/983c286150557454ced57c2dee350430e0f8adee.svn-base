(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsListExchangeRatio", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DABPR_BZTP_PLAN_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DABPR_BZTP_PLAN_SAVE</Col></Row><Row><Col id=\"TARGET\">aprv_execute</Col><Col id=\"SP\">DABPR_BZTP_PLAN_APRV_EXECUTE</Col></Row><Row><Col id=\"TARGET\">select_currency</Col><Col id=\"SP\">DHXPR_CURRENCY_EXCHAGE_BUY</Col></Row><Row><Col id=\"TARGET\">select_emp</Col><Col id=\"SP\">DAXPR_BASEINFO_CODEFIND_FULL</Col></Row><Row><Col id=\"TARGET\">select_exchange_ratio</Col><Col id=\"SP\">DAXPR_BZTP_NATION_CODEFIND</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAB_BZTP_PLAN.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnNotice = this.gfnFormButtonAdd("btnNotice", "fnNotice");	// 계획서주의사항 버튼
        ...
        this.fnInit = function() {
        	...
        	this.dxGrid.setCellProperty("body", this.dxGrid.getBindCellIndex("body", "AM_STDEXRT"), "cssclass", "expr:(dataset.getColumn(currow, 'DS_APRV_NAME') == 'DOMESTIC' || dataset.getColumn(currow, 'BTN_APRV') == 'N') ? 'BACK_ReadOnly' : ''");
        	this.dxGrid.setCellProperty("body", this.dxGrid.getBindCellIndex("body", "AM_STDEXRT"), "edittype", "expr:(dataset.getColumn(currow, 'DS_APRV_NAME') == 'DOMESTIC' ) ? 'none' : 'text'");
        ...
        this.fnAdd = function() {
        	...
        	this.fnGetYesterday(this.gfnAddDate(TODAY, -1));
        	...
        	this.gfnConfirm(msg, function(strId, val) {
        		...
        		for (var i = 0; i < this.dsList.rowcount; i++) {
        			...
        			case "D":
        				...
        				var DS_APRV_NAME = this.dsList.getColumn(nrow, "DS_APRV_NAME");
         ...
         ************************************************************************/
        // 출장규정 버튼
        this.fnRule = function(obj,e) {

        	var fileManager = {};

            fileManager.CD_GUBUN = "DA70";
        ...
        this.fnNotice = function() {
        	var param = {};
        	param.GUBUN = "PLAN";
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DAB_BZTP_RULE_DLG", "", param);
        }
        ...
        this.fnPlan = function() {
        	...
        	param.DS_APRV_NAME    = this.dsList.getColumn(nrow, "DS_APRV_NAME");

        	param.DS_NOTICE       = this.dsList.getColumn(nrow, "DS_NOTICE");			// 주의사항


        	var DS_APRV_NAME = this.dsList.getColumn(nrow, "DS_APRV_NAME");   // 공통코드에서 가져오게 수정
        	var formName = "DAB_BZTP_PLAN_" + DS_APRV_NAME + "_DLG";
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, formName, "fnPlanCallback", param);

        //  var CD_AREA_BZTP = this.dsList.getColumn(nrow, "CD_AREA_BZTP");
        // 	if (CD_AREA_BZTP == "A22" || CD_AREA_BZTP == "B22" || CD_AREA_BZTP == "C22") {  //국내
        ...
        this.fnAprv = function(obj, e) {
        	...
        	this.gfnConfirm(msg, function(strId, isOk) {
        		...
        		var TITLE = locale === "[해외] " ? this.gfnGetConfig("DA" , "TITLE_PLAN_OVERSEAS") : this.gfnGetConfig("DA" , "TITLE_PLAN_DOMESTIC");
        		...
        		var initParam = {
        			...
        			TT_DOC: TITLE + DS_BZTP, // locale + "출장계획서 (" + person + ")",
        ...
        this.fnAfterCDTextChanged = function(id, codeFindData) {
        	...
        	if (id == "ccfCD_CORP") {
        		...
        		console.log('codeFindData', codeFindData);
         	}
        }
        ...
        this.fnGridAfterCDTextChanged = function(id, codeFindData) {
        	...
        	case "DAX_CFBZ_AREA":
        		...
        		var DS_ETC = codeFindData[0]["DS_ETC1"];
         		if (DS_ETC == "DOMESTIC") {  //국내이면
        ...
        this.fnGridAfterEdit = function(obj, e) {
        	if (e.columnid == "AM_STDEXRT") {
        		...
        		var TODAY = this.dsList.getColumn(this.dsList.rowposition, "DT_WRITE");
        		this.dsList.setColumn(this.dsList.rowposition, "DT_CUR_BASE", this.fnGetYesterday(TODAY));
        		this.fnSetExchangeRatio("US");
        	}
        	else if (e.columnid == "DT_CUR_BASE") {
        		this.fnSetExchangeRatio("US");
        	}
        }
        ...
        this.fnGridEnterCell = function(obj, row, cell) {
        	...
        	//var CD_AREA_BZTP = this.dsList.getColumn(this.dsList.rowposition, "CD_AREA_BZTP");
        	var DS_APRV_NAME = this.dsList.getColumn(this.dsList.rowposition, "DS_APRV_NAME");
        	if ((colnm == "DT_CUR_BASE" || colnm == "AM_STDEXRT") && DS_APRV_NAME == "DOMESTIC" ) {
        	//if ((colnm == "DT_CUR_BASE" || colnm == "AM_STDEXRT") && (CD_AREA_BZTP == "A22" || CD_AREA_BZTP == "B22" || CD_AREA_BZTP == "C22")) {
        		return false;
        	}
        }
        ...
        this.fnSetExchangeRatio = function(CD_NATION) {
        	...
        	this.dsSelectExchangeRatio.setColumn(0, "DT_EXCH"  , this.fnGetYesterday(this.dsList.getColumn(this.dsList.rowposition, "DT_CUR_BASE")));
        	...
        	this.dsList.setColumn(this.dsList.rowposition, "AM_STDEXRT", this.dsListExchangeRatio.getColumn(0, "AM_BUY"));
        }
        ...
        this.loadIncludeScript("DAB_BZTP_PLAN.xfdl");
