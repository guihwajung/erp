(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsListPlanApp1", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListPlanApp2", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListPlanApp3", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListPlanApp4", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj.set_text("예금간대체계획");
            obj.set_formscrolltype("none");
            this.divData1.form.divDataBottom.form.tabData.addChild(obj.name, obj);

            obj = new Grid("objGridSub1","0","0",null,"150","0",null,null,null,null,null,this.divData1.form.divDataBottom.form.tabData.tab1.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("1");
            obj._setContents("");
            this.divData1.form.divDataBottom.form.tabData.tab1.addChild(obj.name, obj);

            obj = new Grid("objGridSub2","0","objGridSub1:10","1198",null,null,"0",null,null,null,null,this.divData1.form.divDataBottom.form.tabData.tab1.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("1");
            obj._setContents("");
            this.divData1.form.divDataBottom.form.tabData.tab1.addChild(obj.name, obj);
            ...
            obj = new Grid("objGridSub3","0","0",null,"150","0",null,null,null,null,null,this.divData1.form.divDataBottom.form.tabData.tab2.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("1");
            obj._setContents("");
            this.divData1.form.divDataBottom.form.tabData.tab2.addChild(obj.name, obj);

            obj = new Grid("objGridSub4","0","objGridSub3:10",null,null,"0","0",null,null,null,null,this.divData1.form.divDataBottom.form.tabData.tab2.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("1");
            obj._setContents("");
            this.divData1.form.divDataBottom.form.tabData.tab2.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFB_PLAN_APP.xfdl", function() {
        ...
        **************************************************************************************************/
        ...
        this.divData1_divDataBottom_tabData_tab2_objGridSub4_oncellclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData1.form.divDataBottom.form.tabData.tab2.form.objGridSub4.addEventHandler("oncellclick",this.divData1_divDataBottom_tabData_tab2_objGridSub4_oncellclick,this);
        };
        this.loadIncludeScript("DFB_PLAN_APP.xfdl");
