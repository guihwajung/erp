(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtNO_ID","ccfNO_ID:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            ...
            obj = new Static("staCD_EMPLOYMENT","624","84","120","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("39");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_text("특수형태\r\n근로종사자 유형");
            this.divData.form.divDataRight.addChild(obj.name, obj);
            ...
            obj = new Div("cfCD_EMPLOYMENT","staCD_EMPLOYMENT:5","89","183","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("122");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            obj.getSetter("CodeFindName").set("DSX_CFEMPLOYMENT");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta77","1","sta02_00_00_00_00:40","936","22",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("33");
            obj.set_text("평가");
            obj.set_cssclass("sta_TITLE_Bg");
            ...
            obj = new TextArea("txtDS_FINISH","0","sta77:5","936","70",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            ...
            obj = new BindItem("item27","divData.form.divDataRight.form.cfCD_EMPLOYMENT.form.CDTextBox","value","dsListSub","CD_EMPLOYMENT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item37","divData.form.divDataRight.form.cfCD_EMPLOYMENT.form.DSTextBox","value","dsListSub","DS_EMPLOYMENT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item52","divData.form.divDataRight.form.txtDS_FINISH","value","dsListSub","DS_FINISH");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DSA_EMPLOYEE_LIST.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataRight.form.staCD_EMPLOYMENT.addEventHandler("onclick",this.divData_divDataRight_sta01_onclick,this);
        ...
        this.loadIncludeScript("DSA_EMPLOYEE_LIST.xfdl");
