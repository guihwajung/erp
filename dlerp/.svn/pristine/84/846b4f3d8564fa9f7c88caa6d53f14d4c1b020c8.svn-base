(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("대상업체 인건비조회(SAP)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_VENDOR_IMGUM_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSK_VENDOR_IMGUM.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_VENDOR_IMGUM");
        ...
        this.loadIncludeScript("DSK_VENDOR_IMGUM.xfdl");
