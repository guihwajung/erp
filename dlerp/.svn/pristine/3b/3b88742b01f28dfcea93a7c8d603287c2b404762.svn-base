(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_PAYBACK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRFPR_PAYBACK_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRFPR_PAYBACK_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRFPR_PAYBACK_DELETE</Col></Row><Row><Col id=\"SP\">DRFPR_PAYBACK_AUTOSLIP_APPRO</Col><Col id=\"TARGET\">issue</Col></Row><Row><Col id=\"SP\">DRFPR_PAYBACK_AUTOSLIP_CANCEL</Col><Col id=\"TARGET\">cancel</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSplitter","0","20%","100%","5",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            ...
            obj = new Grid("objGrid1","0","sta01:5",null,null,"0","0",null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.form.divDataTop.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRF_APPROBACK.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsList1.setColumn(nrow, "NO_CONTRACT", this.getOwnerFrame().NO_CONTRACT);
        	//this.dsList1.setColumn(nrow, "NO_UNIONMEMBER", this.getOwnerFrame().NO_UNIONMEMBER);
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DR", "DRF_APPROBACK");
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRF_APPROBACK_B");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("AM_PAYBACK", "int");
        	...
        	this.dsIssue.addColumn("NO_DONG", "string");
        	this.dsIssue.addColumn("NO_FLOOR", "string");
        	this.dsIssue.addColumn("NO_HO", "string");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_DONG", this.dsList1.getColumn(this.dsList1.rowposition, "NO_DONG"));
        	this.dsSelect.setColumn(0, "NO_FLOOR", this.dsList1.getColumn(this.dsList1.rowposition, "NO_FLOOR"));
        	this.dsSelect.setColumn(0, "NO_HO", this.dsList1.getColumn(this.dsList1.rowposition, "NO_HO"));
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "NO_DONG", this.dsList1.getColumn(this.dsList1.rowposition, "NO_DONG"));
        				this.dsInsert.setColumn(nrow, "NO_FLOOR", this.dsList1.getColumn(this.dsList1.rowposition, "NO_FLOOR"));
        				this.dsInsert.setColumn(nrow, "NO_HO", this.dsList1.getColumn(this.dsList1.rowposition, "NO_HO"));
        				this.dsInsert.setColumn(nrow, "NO_CONTRACT", this.dsList1.getColumn(this.dsList1.rowposition, "NO_CONTRACT"));
        				...
        				this.dsInsert.setColumn(nrow, "DS_OWNER", this.dsList1.getColumn(this.dsList1.rowposition, "DS_OWNER"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "NO_DONG", this.dsList1.getColumn(this.dsList1.rowposition, "NO_DONG"));
        				this.dsUpdate.setColumn(nrow, "NO_FLOOR", this.dsList1.getColumn(this.dsList1.rowposition, "NO_FLOOR"));
        				this.dsUpdate.setColumn(nrow, "NO_HO", this.dsList1.getColumn(this.dsList1.rowposition, "NO_HO"));
        				this.dsUpdate.setColumn(nrow, "NO_CONTRACT", this.dsList1.getColumn(this.dsList1.rowposition, "NO_CONTRACT"));
        				...
        				this.dsUpdate.setColumn(nrow, "DS_OWNER", this.dsList1.getColumn(this.dsList1.rowposition, "DS_OWNER"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "NO_DONG", this.dsList1.getColumn(this.dsList1.rowposition, "NO_DONG"));
        				this.dsDelete.setColumn(nrow, "NO_FLOOR", this.dsList1.getColumn(this.dsList1.rowposition, "NO_FLOOR"));
        				this.dsDelete.setColumn(nrow, "NO_HO", this.dsList1.getColumn(this.dsList1.rowposition, "NO_HO"));
        				this.dsDelete.setColumn(nrow, "NO_CONTRACT", this.dsList1.getColumn(this.dsList1.rowposition, "NO_CONTRACT"));
        ...
        this.fnSaveValidation = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		if (this.gfnNvl(this.dsList.getColumn(i, "TY_PROCESS")) == "3" || this.gfnNvl(this.dsList.getColumn(i, "TY_PROCESS")) == "4") {
        ...
        // 			amPayback_left = amAppro - amPayback;
        //
        // 			if (amPayback_left >= 0 && this.gfnNvl(this.dsList.getColumn(this.dsList.rowposition, "TY_PROCESS")) == "1" && cd_cms == "") {
        // 				this.btnAddUpBack.set_enable(true);
        // 			}
        // 			else {
        // 				this.btnAddUpBack.set_enable(false);
        ...
        this.fnGrid_AfterEdit = function(obj,e) {
        	if (e.columnid == "TY_PROCESS") {
        		if (e.oldvalue != e.newvalue) {
        			...
        			else if (this.dsList.getColumn("TY_PROCESS") != "4") {
        				this.dsList.setColumn(e.row, "DT_REFUND" ,"");
        				this.dsList.setColumn(e.row, "DS_REFUNDBANK" ,"");
        				this.dsList.setColumn(e.row, "NO_REFUNDBANK" ,"");
        				this.dsList.setColumn(e.row, "DS_OWNER" ,"");
        ...
        // 	param.DT_RECEIVED = this.dsList.getColumn(row, "DT_PAYBACK");
        // 	param.AM_RECEIVED = nexacro.toNumber(this.dsList.getColumn(row, "AM_PAYBACK"));
        //
        // 	this.gfnFormOpen("DRC", "DRC_DLGADDUPBACK", "", param);
        // };
        ...
        this.fnSlipIssue_callback = function(strId, val)
        {
        	if(val == true)
        	{
        		...
        		this.dsIssue.setColumn(nrow, "CD_BANK", "");
        		this.dsIssue.setColumn(nrow, "NO_DONG", this.dsList1.getColumn(this.dsList1.rowposition, "NO_DONG"));
        		this.dsIssue.setColumn(nrow, "NO_FLOOR", this.dsList1.getColumn(this.dsList1.rowposition, "NO_FLOOR"));
        		this.dsIssue.setColumn(nrow, "NO_HO", this.dsList1.getColumn(this.dsList1.rowposition, "NO_HO"));
        ...
        this.fnSlipCancel = function(obj,e) {
        	...
        	var cd_cms = this.dsList.getColumn(this.dsList.rowposition, "CD_CMS");
             ...
             if((ty_process == "2" && cd_cms != "") || ty_process == "3" || ty_process == "4"){
        ...
        this.loadIncludeScript("DRF_APPROBACK.xfdl");
