(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_background("#eeeeee");
            this.set_scrollbartype("none");
            if (Form == this.constructor)
            {
                this._setFormPosition(270,638);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_MODULE\" type=\"STRING\" size=\"0\"/><Column id=\"TY_MENU\" type=\"STRING\" size=\"0\"/><Column id=\"ID_FORM\" type=\"STRING\" size=\"0\"/><Column id=\"NM_FORM\" type=\"STRING\" size=\"0\"/><Column id=\"NO_LEVEL\" type=\"INT\" size=\"0\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsParam", this);
            obj._setContents("<ColumnInfo><Column id=\"ID_USER\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SYSTEM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsModule", this);
            obj._setContents("<ColumnInfo><Column id=\"Column0\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">dsModule</Col><Col id=\"SP\">DZZPR_SYSTEM_SELECT_UXMAIN_NEW</Col></Row><Row><Col id=\"TARGET\">dsMenu</Col><Col id=\"SP\">DZZPR_MENU_SELECT_NEW</Col></Row><Row><Col id=\"TARGET\">dsAuthForm</Col><Col id=\"SP\">DZZPR_AUTHORITYFORM_SELECT_NEW</Col></Row><Row><Col id=\"TARGET\">dsBtnInfo</Col><Col id=\"SP\">DZZPR_USERBUTTON_SELECT</Col></Row><Row><Col id=\"TARGET\">dsConfig</Col><Col id=\"SP\">DZZPR_CONFIG_SELECT</Col></Row><Row><Col id=\"TARGET\">dsUserConfig</Col><Col id=\"SP\">DZZPR_USERINFO_SELECT</Col></Row><Row><Col id=\"TARGET\">dsMyMenu</Col><Col id=\"SP\">DZZPR_MYMENU_DETAIL_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsUserConfig", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsParamMyMenu", this);
            ...
            obj = new Dataset("dsMenu_MM", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("staLogo","0","0","270","65",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btn00","staLogo:-53","0","53","54",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("btn_TF_home01");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Div("divModule","0","staLogo:0","270",null,null,"0",null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj.set_background("#17426A");
            this.addChild(obj.name, obj);

            obj = new Div("divLeft","270","0","270",null,null,"0",null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new Grid("grdTree","0","0","270","500",null,null,null,null,null,null,this.divLeft.form);
            obj.set_taborder("2");
            ...
            obj.set_cssclass("grd_WF_leftTree");
            obj.set_scrollbarsize("5");
            obj.set_visible("true");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"15\"/><Column size=\"168\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"0\"/></Columns><Rows><Row size=\"34\"/></Rows><Band id=\"body\"><Cell/><Cell col=\"1\" edittype=\"tree\" text=\"bind:NM_FORM\" cssclass=\"expr:TY_MENU!=&quot;메뉴&quot; ? &quot;&quot; : NO_LEVEL==1 ? &quot;level0&quot; : NO_LEVEL==2 ? &quot;level1&quot; : NO_LEVEL==3 ?  &quot;level2&quot; : NO_LEVEL==4 ?  &quot;level3&quot; : &quot;&quot;\" treestartlevel=\"1\" treelevel=\"bind:NO_LEVEL\" tooltiptext=\"bind:NM_FORM\" textAlign=\"left\" displaytype=\"treeitemcontrol\"/><Cell col=\"2\" displaytype=\"none\" text=\"bind:TY_MENU\"/><Cell col=\"3\" displaytype=\"none\" text=\"bind:CD_MODULE\"/><Cell col=\"4\" displaytype=\"none\" text=\"bind:ID_FORM\"/></Band></Format></Formats>");
        ...
        */
        ...
        this.btnModule_onclick = function(obj,  e)
        {
        ...
        */
        ...
        this.grdMenu_oncelldblclick = function(obj,e)
        {
        	this.fnMenuOpen(obj, e.row);
        };

        this.fnMenuOpen = function(obj, dsrow, isMenu) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn00.addEventHandler("onclick",this.staLogo_onclick,this);
        };
