        	...
        	for (var i=0; i<dsOut.rowcount; i++) {
        		...
        		for (var j=0; j< dsOut.colcount; j++) {
        			if (!this.gfnIsNull(dsOut.getColumn(i,j)) ){
        				...
        				//날짜 형식 수정
        				if ( strColID == "Column8" || strColID == "Column9"){
        		...
        		this.dsList.setColumn(nrow, "NO_INSURANCE", dsOut.getColumn(i, "Column4"));
        		this.dsList.setColumn(nrow, "DS_INSURANCE", dsOut.getColumn(i, "Column5"));
        		this.dsList.setColumn(nrow, "AM_GAIP", dsOut.getColumn(i, "Column6"));
        		this.dsList.setColumn(nrow, "AM_INSURANCE", dsOut.getColumn(i, "Column7"));
        		this.dsList.setColumn(nrow, "DT_START", dsOut.getColumn(i, "Column8"));
        		this.dsList.setColumn(nrow, "DT_END", dsOut.getColumn(i, "Column9"));
        		this.dsList.setColumn(nrow, "DS_REMARK", dsOut.getColumn(i, "Column10"));
