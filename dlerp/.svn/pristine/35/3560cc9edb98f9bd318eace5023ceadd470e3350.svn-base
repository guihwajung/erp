(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZZPR_GYUMJIK_SELECT</Col></Row><Row><Col id=\"SP\">DZZPR_GYUMJIK_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"SP\">DZZPR_GYUMJIK_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DZZPR_GYUMJIK_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DZU_GYUMJIK.xfdl", function() {
        ...
        this.loadIncludeScript("DZU_GYUMJIK.xfdl");
