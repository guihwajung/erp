(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRCPR_ADDUPBACK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRCPR_ADDUPBACK_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRCPR_ADDUPBACK_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRCPR_ADDUPBACK_DELETE</Col></Row><Row><Col id=\"TARGET\">issue</Col><Col id=\"SP\">DRCPR_ADDUPBACK_AUTOSLIP_APPRO</Col></Row><Row><Col id=\"TARGET\">cancel</Col><Col id=\"SP\">DRCPR_ADDUPBACK_AUTOSLIP_APPRO_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRC_ADDUPBACK.xfdl", function() {
        ...
        this.fnSlipIssue = function(obj,e) {
           ...
           if((ty_process == "1" && cd_cms != "") ||  ty_process == "2" || ty_process == "3"){
        	...
        	this.gfnConfirm(msg, "fnSlipIssue_callback", "");
        	 ...
        	 this.gfnAlert("분양대금 수납이후에 전표발행 가능합니다.");
           }
        ...
        this.divData_divDataBottom_btnAddUpBack_onclick = function(obj,e) {
        	...
        	this.gfnFormOpen("DRC", "DRC_DLGADDUPBACK", "fnAddCallback", param);

        	}
        	 else {
        	    this.gfnAlert("수납이 이미 되었거나 분양대금반제 항목이 아닙니다");
        	 }
        ...
        this.loadIncludeScript("DRC_ADDUPBACK.xfdl");
