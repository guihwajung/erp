(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(700,450);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DABPR_LEISURE_ROOMTYPE_SELECT</Col></Row></Rows>");
            ...
            obj.set_taborder("3");
            obj.set_text("객실별정보 안내");
            obj.getSetter("uWord").set("popup.confirm");
            obj.set_cssclass("sta_POP_Title");
            this.divData.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","staTitle:10",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DAB_LEISURE_ROOMTYPE_DLG.xfdl", function() {
        ...
        this.loadIncludeScript("DAB_LEISURE_ROOMTYPE_DLG.xfdl");
