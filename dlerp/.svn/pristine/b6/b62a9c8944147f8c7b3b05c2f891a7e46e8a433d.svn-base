(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","319","19",null,"21","-311",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("sta00","5","11","120","30",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("대상칼럼");
            ...
            obj = new Combo("cbo00","sta00:3","11",null,"21","5",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Static("sta01","5","42","120","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("찾을 문자열");
            ...
            obj = new Static("sta02","5","73","120","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("바꿀 문자열");
            ...
            obj = new Static("sta03","5","104","120","30",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("찾을 방향");
            ...
            obj = new Radio("rdo00","sta03:3","104",null,"21","5",null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Static("sta04","5","135","120","30",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("찾을 위치");
            ...
            obj = new Radio("rdo01","sta04:3","135",null,"21","5",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_direction("vertical");
            ...
            obj = new Static("sta05","5","166","120","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("찾을 조건");
            ...
            obj = new Radio("rdo02","sta05:3","166",null,"21","3",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_direction("vertical");
            ...
            obj = new CheckBox("chk00","128","199",null,"21","3",null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("대/소문자구분");
            obj.getSetter("uWord").set("popup.casesensitive");
            this.addChild(obj.name, obj);

            obj = new Button("btn00","12","242","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("찾기");
            obj.getSetter("uWord").set("popup.find");
            this.addChild(obj.name, obj);

            obj = new Button("btn01","84","242","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("바꾸기");
            obj.getSetter("uWord").set("popup.replace");
            this.addChild(obj.name, obj);

            obj = new Button("btn02","155","242","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("모두바꾸기");
            obj.getSetter("uWord").set("popup.allchange");
            this.addChild(obj.name, obj);

            obj = new Button("btn03","226","242","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("닫기");
            obj.getSetter("uWord").set("popup.close");
            this.addChild(obj.name, obj);

            obj = new Edit("edt00","sta01:3","42",null,"21","5",null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new Edit("edt01","sta02:3","73",null,"21","5",null,null,null,null,null,this);
            obj.set_taborder("6");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
