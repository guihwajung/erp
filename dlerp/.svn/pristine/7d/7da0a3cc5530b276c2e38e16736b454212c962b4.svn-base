(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",410,360,this,function(p){});
        ...
        // User Script
        this.registerScript("DFE_DLG_YUGAPR_CHG.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.fnSetCombo = function() {
        	...
        	this.dsCombo.setColumn(0, "CD_TYPE", "EB");
        ...
        this.loadIncludeScript("DFE_DLG_YUGAPR_CHG.xfdl");
