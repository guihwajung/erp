(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAZPR_RETIRESUBST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAZPR_RETIRESUBST_INSERT</Col></Row><Row><Col id=\"SP\">DAZPR_RETIRESUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DAZPR_RETIRESUBST_DELETE</Col><Col id=\"TARGET\">delete</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAZ_RETIRESUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAZ_RETIRESUBST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("FM_KEY", "int");
        	this.dsInsert.addColumn("TO_KEY", "int");
        	this.dsInsert.addColumn("RT_BASE", "double");
        	this.dsInsert.addColumn("AM_BASESUBST", "int");
        	this.dsInsert.addColumn("AM_ADDSUBST", "int");
        	this.dsInsert.addColumn("QN_MINUSYEAR", "int");
        	this.dsInsert.addColumn("ID_INSERT", "string");

            this.dsUpdate = new Dataset();
        	this.dsUpdate.addColumn("YM_BASE", "string");
        	this.dsUpdate.addColumn("FM_KEY", "int");
        	this.dsUpdate.addColumn("TO_KEY", "int");
        	this.dsUpdate.addColumn("RT_BASE", "double");
        	this.dsUpdate.addColumn("AM_BASESUBST", "int");
        	this.dsUpdate.addColumn("AM_ADDSUBST", "int");
        	this.dsUpdate.addColumn("QN_MINUSYEAR", "int");
        	this.dsUpdate.addColumn("ID_UPDATE", "string");

        	this.dsDelete = new Dataset();

        	this.dsDelete.addColumn("YM_BASE", "string");
        	this.dsDelete.addColumn("FM_KEY", "int");
        	this.dsDelete.addColumn("TO_KEY", "int");
        ...
        this.fnSave = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		if(flag == "I" || flag == "U"){
        			if(this.dsList.getColumn(i, "FM_KEY") > this.gfnNvl(this.dsList.getColumn(i, "TO_KEY"), 0)) {
        				var alertMessage = "근속년수[FROM]의 값보다 작은값이 [TO]에 들어갈 수 없습니다.";
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "FM_KEY", this.dsList.getColumn(i, "FM_KEY"));
        				this.dsInsert.setColumn(nrow, "TO_KEY", this.dsList.getColumn(i, "TO_KEY"));
        				this.dsInsert.setColumn(nrow, "RT_BASE", this.dsList.getColumn(i, "RT_BASE"));
        				this.dsInsert.setColumn(nrow, "AM_BASESUBST", this.dsList.getColumn(i, "AM_BASESUBST"));
        				this.dsInsert.setColumn(nrow, "AM_ADDSUBST", this.dsList.getColumn(i, "AM_ADDSUBST"));
        				this.dsInsert.setColumn(nrow, "QN_MINUSYEAR", this.dsList.getColumn(i, "QN_MINUSYEAR"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "FM_KEY", this.dsList.getColumn(i, "FM_KEY"));
        				this.dsUpdate.setColumn(nrow, "TO_KEY", this.dsList.getColumn(i, "TO_KEY"));
        				this.dsUpdate.setColumn(nrow, "RT_BASE", this.dsList.getColumn(i, "RT_BASE"));
        				this.dsUpdate.setColumn(nrow, "AM_BASESUBST", this.dsList.getColumn(i, "AM_BASESUBST"));
        				this.dsUpdate.setColumn(nrow, "AM_ADDSUBST", this.dsList.getColumn(i, "AM_ADDSUBST"));
        				this.dsUpdate.setColumn(nrow, "QN_MINUSYEAR", this.dsList.getColumn(i, "QN_MINUSYEAR"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "FM_KEY", this.dsList.getColumn(i, "FM_KEY"));
        				this.dsDelete.setColumn(nrow, "TO_KEY", this.dsList.getColumn(i, "TO_KEY"));
        ...
        this.loadIncludeScript("DAZ_RETIRESUBST.xfdl");
