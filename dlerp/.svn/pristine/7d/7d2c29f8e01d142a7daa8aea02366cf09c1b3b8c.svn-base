(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFLPR_CMS1_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DFLPR_CMS_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">confirm</Col><Col id=\"SP\">DFLPR_CMS_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFLPR_CMS_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFLPR_CMS_DELETE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFLPR_CMS_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFLPR_CMS_AUTOSLIPX</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFL_CMS.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFL_CMS1");		// 입출금내역조회
        	this.gfnGridInit(this.dxGrid2, this.dsList2, "DF", "DFL_CMS2");		// 전표발행내역조회
        ...
        this.loadIncludeScript("DFL_CMS.xfdl");
