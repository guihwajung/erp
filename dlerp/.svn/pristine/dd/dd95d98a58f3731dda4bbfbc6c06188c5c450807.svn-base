(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"YY_ORDER\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YY_ORDER\"/></Row></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAAPR_NODT_ORDER_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DAAPR_MULTIORDERDLG_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAAPR_NODT_ORDER_SAVE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DAAPR_NODT_ORDER_SELECT_DETAIL</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsDocnum", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYY_ORDER","0","10","92","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("발령년도");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYY_ORDER","staYY_ORDER:0","10","60","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_url("cmm::cmmCalYY.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_CORP","ctclYY_ORDER:0","10","66","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Div("divSplitter","38.98%","-20","5",null,null,"0",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("DAA_REG_ORDERNO.xfdl", function() {
        ...
        this.loadIncludeScript("DAA_REG_ORDERNO.xfdl");
