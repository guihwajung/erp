(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_JUNGSAN_LIST</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_MAGAM","ccfCD_SITE:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("마감일자");
        ...
        // User Script
        this.registerScript("DSK_JUNGSAN_LIST.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0, "DT_MAGAM", today);
        };
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_JUNGSAN_LIST");
        };
        ...
        this.loadIncludeScript("DSK_JUNGSAN_LIST.xfdl");
