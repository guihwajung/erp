(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DQZPR_MDM_AUTHORITY_SELECT2</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DQZPR_MDM_AUTHORITY_UPDATE2</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_ROLE\" type=\"STRING\" size=\"256\"/><Column id=\"CAT_01\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_ROLE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta01","ccfCD_ROLE:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("대분류");
            obj.set_textAlign("center");
            ...
            obj = new Div("ccfCAT_01","sta01:0.0","10.0","300","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new BindItem("item1","divSearch.form.ccfCAT_01.form.CDTextBox","value","dsSearch","CAT_01");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DQZ_MDM_AUTHORITY2.xfdl", function() {
        ...
        this.loadIncludeScript("DQZ_MDM_AUTHORITY2.xfdl");
