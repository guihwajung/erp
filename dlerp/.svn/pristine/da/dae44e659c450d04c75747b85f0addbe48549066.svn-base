(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_RECOMMEND_ETC_REQ_LIST_SELECT_APP</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_LIST_DC_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_LIST_DC_DELETE</Col></Row><Row><Col id=\"TARGET\">regist</Col><Col id=\"SP\">DCAPR_JUDGE_REGIST_TEMP_RESULT_UPDATE</Col></Row><Row><Col id=\"TARGET\">auto</Col><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_AUTO_JUDGE_DC</Col></Row><Row><Col id=\"TARGET\">appr_select</Col><Col id=\"SP\">DZRPR_AP_STATE_SELECT</Col></Row><Row><Col id=\"TARGET\">aplines</Col><Col id=\"SP\">DZRPR_APPLINES_SELECT</Col></Row><Row><Col id=\"TARGET\">execAppr</Col><Col id=\"SP\">DZZPR_APPROVAL_CALLBACK</Col></Row><Row><Col id=\"SP\">DZRPR_AP_STATE_SELECT</Col><Col id=\"TARGET\">appr_select_sap</Col></Row><Row><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_SAPVENDORCODE_UPDATE</Col><Col id=\"TARGET\">appr_sap_update</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"NO_SJC\" type=\"STRING\" size=\"256\"/><Column id=\"YR_REQ\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LICCOST\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DAM\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BUMUN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"YN_LINK\" type=\"STRING\" size=\"256\"/><Column id=\"ID_AP\" type=\"STRING\" size=\"256\"/><Column id=\"NO_BID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TY_SELECT\">미심사</Col><Col id=\"CD_LICCOST\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_BID","0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("입찰번호");
            ...
            obj = new Edit("ctxtNO_BID","staNO_BID:0.0","10.0","150","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_value("");
            obj.set_enable("false");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_LICCOST","ctxtNO_BID:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("사업자번호");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Edit("ctxtNO_BID00","staCD_LICCOST:0.0","10.0","150","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_value("");
            obj.set_enable("false");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divSearch.form.ctxtNO_BID00","value","dsSearch","NO_SJC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCA_RECOMMEND_DC_APP.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().PARAM01) && !this.gfnIsNull(this.getOwnerFrame().PARAM02)) {
        		this.dsSearch.setColumn(0, "NO_BID", this.getOwnerFrame().PARAM01);
        		this.dsSearch.setColumn(0, "NO_SJC", this.getOwnerFrame().PARAM02);
        ...
        this.fnSetVariable = function() {
        	...
        	this.ctxtNO_BID = this.divSearch.form.ctxtNO_BID;
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "RECOMMEND_ETC_REQ_LIST");
        ...
        this.fnSapUadate = function() {
        	...
        	this.dsSapUpdate.setColumn(0, "NO_BID", this.dsList.getColumn(0, "NO_BID"));
        	this.dsSapUpdate.setColumn(0, "NO_SJC", this.dsList.getColumn(0, "NO_SJC"));
        ...
        this.fnInsertDLG = function() {
           ...
           this.gfnFormOpenNonAuth(this.FormInfo.CD_MODULE, "DCA_REGIST_TEMP_REQ_DC_DLG", "fnInsertDLG_callback", param, "570", "380");
        ...
        // 	param.YR_JUDGE = this.dsSearch.getColumn(0, this.gfnGetDate().substr(0,4));
        ...
        //*** 아래는 결재관련 소스 ***//
         ...
         this.fnAprvCmpl = function(obj,e) {
        	...
        	param.V_PARAM01 = this.dsSearch.getColumn(0, "NO_BID");
        	param.V_PARAM02 = this.dsSearch.getColumn(0, "NO_SJC");
        	param.V_PARAM03 = "";
        	param.V_PARAM04 = "";
        	param.ST_APPR = "03";
        	...
        	this.gfnFormOpenNonAuth(this.FormInfo.CD_MODULE, "DZR_AP_NOTE", "fnAprvDialogCallback", param, 430, 210);
        }
        ...
        this.fnApprSelSap = function() {
         ...
         this.fnAprvInf = function(obj,e) {
        	...
        	this.gfnFormOpenNonAuth(this.FormInfo.CD_MODULE, "DZR_APLINES", "", param, 830, 400);
        }
        ...
        // 결제상신
         this.fnAprvSang = function(obj,e) {
        	...
        	param.ID_AP_TYPE = "DC11";
        	param.V_PARAM01 = this.dsSearch.getColumn(0, "NO_BID");
        	param.V_PARAM02 = this.dsSearch.getColumn(0, "NO_SJC");
        	param.V_PARAM03 = "";
        	param.V_PARAM04 = "";
        	param.DS_TITLE =  "미등록업체 품의서";

        	this.gfnFormOpenNonAuth(this.FormInfo.CD_MODULE, "DZR_AP_REQUEST", "fnDialogCallback", param, 900, 650);
         }
        ...
        this.fnExecAppr = function() {
        	...
        	this.dsExecAppr.setColumn(0, "V_PARAM01", this.dsSearch.getColumn(0, "NO_BID"));
        	this.dsExecAppr.setColumn(0, "V_PARAM02", this.dsSearch.getColumn(0, "NO_SJC"));
        ...
        this.loadIncludeScript("DCA_RECOMMEND_DC_APP.xfdl");
