(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSBPR_NOMU_JIGUB_LIST</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSB_NOMU_JIGUB_LIST.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnJIGUB= this.gfnFormButtonAdd("BTN_JIGUB", "fnJIGUB"); //원천세 지급명세서
        };
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSB_NOMU_JIGUB_LIST");
        };
        ...
        this.fnJIGUB = function(){
        	...
        	{
        		no_ids = no_ids + this.dsList.getColumn(rows[i], "NO_ID") + ", ";
        	}
        	...
        	var idnos = no_ids;
        	var workym = this.dsSearch.getColumn(0, "YM_WORK");

        	var strReportName = "/ds/cmbd0140jl.ozr";
        ...
        this.loadIncludeScript("DSB_NOMU_JIGUB_LIST.xfdl");
