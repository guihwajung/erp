(function()
{
    return function()
    {
        ...
        {
            this.set_name("DWB_HDGISUNGMONTH");
            this.set_titletext("기성실적입력");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTHDTL_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_MAX_SELECT</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_EXECUTE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_GISUNG\" type=\"STRING\" size=\"256\"/><Column id=\"NO_DGR\" type=\"STRING\" size=\"256\"/><Column id=\"CHK_REQ\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"YM_WORK\"/><Col id=\"CHK_GISUNG\">0</Col><Col id=\"NO_DGR\"/><Col id=\"CHK_REQ\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk_GISUNG","ctclYM_WORK:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("잔여기성");
            obj.set_truevalue("1");
            ...
            obj = new CheckBox("chk_GISUNGREQ","chk_GISUNG:0.0","10.0","89","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("청구요청건");
            obj.set_value("true");
            obj.set_falsevalue("0");
            ...
            obj = new Static("sta00","chk_GISUNGREQ:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            ...
            obj = new Div("divSplitter",null,"0","5","100.00%","425",null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            ...
            obj = new Static("sta02","0","-20","100.00%","22",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Grid("objGridSub","0","sta02:5",null,null,"0","30",null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("0");
            obj.set_scrollbartype("none");
            obj.set_border("1,0px none,0px none");
            obj._setContents("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("staAC_YM","divSplitter:5","divDataRight:-30","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("*회계일자");
            obj.set_font("bold 12px/normal \"Dotum\"");
            this.divData.addChild(obj.name, obj);

            obj = new Calendar("tclDT_HDGISUNG","staAC_YM:5","divDataRight:-29","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            ...
            obj = new BindItem("item4","divSearch.form.chk_GISUNG","value","dsSearch","CHK_GISUNG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.tclDT_HDGISUNG","value","dsListSubCal","DT_HDGISUNG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item0","divSearch.form.chk_GISUNGREQ","value","dsSearch","CHK_REQ");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWB_HDGISUNGMONTH.xfdl", function() {
        this.DWB_HDGISUNGMONTH_onload = function(obj,e)
        {
           // -- 필수 -------------------//
        ...
        this.fnSetEvent = function() {
           //this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWB_HDGISUNGMONTH");
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", this.FormInfo.CD_MODULE == "DWN" ? "DWN_HDGISUNGMONTH" : "DWB_HDGISUNGMONTH");
        ...
        this.fnSetParameter = function() {
           ...
           this.dsSelect.addColumn("DS_CONTMETHOD", "string");
        	...
        	this.dsUpdate.addColumn("AM_JIKBUL_PROV", "bigdecimal");
        	this.dsUpdate.addColumn("AM_JIKBUL_VAT", "bigdecimal");
        	this.dsUpdate.addColumn("AM_JIKBUL_TXFR", "bigdecimal");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CHK_GISUNG", this.divSearch.form.chk_GISUNG.value);
        	this.dsSelect.setColumn(0, "CHK_REQ", this.divSearch.form.chk_GISUNGREQ.value);
        ...
        //this.dxGridSub.updateToDataset();
        	...
        	if (flagUpYn == "Y" || this.dsListSubCal.getRowType(0) == 4){
        		...
        		this.dsUpdate.setColumn(nrow, "AM_GONGJAE1VAT_NOW", this.dsListSub.lookup("CD_TYPE", "D102", "AM_VAT")); 	//우측 그리드 CD_TYPE = 'D102' FindRow 의 공급가(AM_SUPPLY)
        		...
        		this.dsUpdate.setColumn(nrow, "AM_GONGJAE6PROV_NOW", this.dsListSub.lookup("CD_TYPE", "D109", "AM_SUPPLY"));
        		this.dsUpdate.setColumn(nrow, "AM_GONGJAE6VAT_NOW", this.dsListSub.lookup("CD_TYPE", "D109", "AM_VAT"));
        		...
        		this.dsUpdate.setColumn(nrow, "AM_JIKBUL_PROV",  this.dsListSub.lookup("CD_TYPE", "D105", "AM_SUPPLY"));
        		this.dsUpdate.setColumn(nrow, "AM_JIKBUL_VAT", this.dsListSub.lookup("CD_TYPE", "D105", "AM_VAT"));
        		this.dsUpdate.setColumn(nrow, "AM_JIKBUL_TXFR", "0");
        	}
        ...
        this.fnGrid_EnterCell = function(obj, row, cell) {
        	...
        	if(this.dsList.getColumn(this.dsList.rowposition, "YN_EDIT") == "N") {
        		...
        		// 오른쪽 그리드의 YN_EDIT 컬럼값이 'Y' 일경우 수정가능
        		if(this.dsListSub.getColumn(row, "YN_EDIT") == "N") {
        			return false;
        		}else{
        			// 공급가 컬럼은 YN_EDIT_P 컬럼값이 'Y' 일경우 수정가능
        			if(colnm == "AM_SUPPLY"){	// 공급가
        				if(this.dsListSub.getColumn(row, "YN_EDIT_P") == "N") {
        					return false;
        				}else{
        					return true;
        				}
        			// 부가세 컬럼은 YN_EDIT_V 컬럼값이 'Y' 일경우 수정가능
        			}else if(colnm == "AM_VAT"){	// 부가세
        				if(this.dsListSub.getColumn(row, "YN_EDIT_V") == "N") {
        					return false;
        				}else{
        					return true;
        				}
        			}else if(colnm == "DS_TYPE"){	// 구분
        				return false;
        			}else if(colnm == "AM_TOT"){	// 합계
        				return false;
        			}
        		}
        	}
        ...
        // 	}
           ...
           //색상구분추가
            this.gfnGridColumnColor(this.dxGridSub, "DS_TYPE", "BOLD,RED", "ROW_GUBUN=='B'");
            this.gfnGridColumnColor(this.dxGridSub, "DS_TYPE", "BOLD,BLUE", "ROW_GUBUN=='A'");
        	this.gfnGridColumnColor(this.dxGridSub, "DS_TYPE", "BOLD,BLUE", "ROW_GUBUN=='D'");
        	this.gfnGridColumnColor(this.dxGridSub, "AM_VAT", "BACK_ReadOnly", "CD_TYPE== 'B302'");		// 부가세가 해당조건에 맞으면 배경색을 흰색으로 변경(수정가능상태)
        	var rtn = this.divData.form.divDataRight.form.objGridSub.setCellProperty("body", 7, "edittype", "expr:CD_TYPE=='A301' || CD_TYPE=='B301' || CD_TYPE=='D102' || CD_TYPE=='D109' ?'text':'none'");

        }


        //아래부터는 확장버튼 이벤트.
        this.fnLedger = function(obj,e) {
        	var param = {};
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DWB_HADODJ", "", param);
        }
        ...
        this.fnDetail = function(obj,e) {
        	...
        	switch(this.FormInfo.DS_PARAM){
        		case "SU": // 외주
        			this.gfnFormOpen(this.FormInfo.CD_MODULE, "DWB_HDGISUNGMONTH_DETAIL", "fnDialogCallback", param);
        		break;
        		case "MM": // 자재
        			this.gfnFormOpen(this.FormInfo.CD_MODULE, "DWB_HDGISUNGMONTH_M_DETAIL", "fnDialogCallback", param);
        		break;
        	}
        }
        ...
        this.fnHdLdgrDdct = function(obj,e) {
        	var param = {};
        	var rowposition = this.dsList.rowposition;
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DWB_HDLEDGER_DDCT", "fnDialogCallback", param);
        ...
        // 서명 요청 취소
        this.fnSgnReqCnc = function(obj,e) {
        	...
        	if(e.columnid == "AM_SUPPLY"){		// 공급가
        		if(this.gfnIsNull(this.dsListSub.getColumn(e.row, "DS_CALC"))){
        			...
        			if(this.dsListSub.getColumn(e.row, "YN_EDIT_V") == "Y"){
        				// 현재 row의 부가세 컬럼
                        var B301Row = this.dsListSub.findRow("CD_TYPE", "B302");
        				if(e.row != B301Row){
        			...
        			if(e.row == a301Row){
        			  ...
        			  //this.dsListSub.setColumn(a303Row, "AM_TOT", a303RowSupply + a303RowVAT);
        			...
        			if(e.row == a302Row){
        			  ...
        			  //this.dsListSub.setColumn(a301Row, "AM_TOT", a301RowSupply + a301RowVAT);
        			  this.dsListSub.setColumn(a301Row, "AM_TOT", nexacro.toNumber(this.dsListSub.getColumn(a301Row, "AM_SUPPLY"),0) + nexacro.toNumber(this.dsListSub.getColumn(a301Row, "AM_VAT"),0));
        			}
        		}
        ...
        this.dsListSubCal_oncolumnchanged = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.DWB_HDGISUNGMONTH_onload,this);
            ...
            this.divData.form.tclDT_HDGISUNG.addEventHandler("onchanged",this.divData_tclDT_HDGISUNG_onchanged,this);
            this.dsListSub.addEventHandler("oncolumnchanged",this.dsListSub_oncolumnchanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
            this.dsListSubCal.addEventHandler("oncolumnchanged",this.dsListSubCal_oncolumnchanged,this);
        };
        this.loadIncludeScript("DWB_HDGISUNGMONTH.xfdl");
