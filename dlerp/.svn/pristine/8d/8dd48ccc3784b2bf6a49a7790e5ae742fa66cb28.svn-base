(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOTPR_SALE_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DOTPR_SALE_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DOTPR_SALE_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DOTPR_SALE_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOT_SALE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOT_SALE");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("PY_SALE", "bigdecimal");
        	this.dsInsert.addColumn("PY_AREA", "bigdecimal");
        	this.dsInsert.addColumn("CT_TSALE", "bigdecimal");
        	this.dsInsert.addColumn("AM_TSALE", "bigdecimal");
        	this.dsInsert.addColumn("CT_NSALE", "bigdecimal");
        	this.dsInsert.addColumn("AM_NSALE", "bigdecimal");
        	...
        	this.dsUpdate.addColumn("PY_SALE", "bigdecimal");
        	this.dsUpdate.addColumn("PY_AREA", "bigdecimal");
        	this.dsUpdate.addColumn("CT_TSALE", "bigdecimal");
        	this.dsUpdate.addColumn("AM_TSALE", "bigdecimal");
        	this.dsUpdate.addColumn("CT_NSALE", "bigdecimal");
        	this.dsUpdate.addColumn("AM_NSALE", "bigdecimal");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "PY_SALE", this.dsList.getColumn(i, "PY_SALE"));
        				this.dsInsert.setColumn(nrow, "PY_AREA", this.dsList.getColumn(i, "PY_AREA"));
        				this.dsInsert.setColumn(nrow, "CT_TSALE", this.dsList.getColumn(i, "CT_TSALE"));
        				this.dsInsert.setColumn(nrow, "AM_TSALE", this.dsList.getColumn(i, "AM_TSALE"));
        				this.dsInsert.setColumn(nrow, "CT_NSALE", this.dsList.getColumn(i, "CT_NSALE"));
        				this.dsInsert.setColumn(nrow, "AM_NSALE", this.dsList.getColumn(i, "AM_NSALE"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "PY_SALE", this.dsList.getColumn(i, "PY_SALE"));
        				this.dsUpdate.setColumn(nrow, "PY_AREA", this.dsList.getColumn(i, "PY_AREA"));
        				this.dsUpdate.setColumn(nrow, "CT_TSALE", this.dsList.getColumn(i, "CT_TSALE"));
        				this.dsUpdate.setColumn(nrow, "AM_TSALE", this.dsList.getColumn(i, "AM_TSALE"));
        				this.dsUpdate.setColumn(nrow, "CT_NSALE", this.dsList.getColumn(i, "CT_NSALE"));
        				this.dsUpdate.setColumn(nrow, "AM_NSALE", this.dsList.getColumn(i, "AM_NSALE"));
        ...
        this.loadIncludeScript("DOT_SALE.xfdl");
