(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("maxwidth").set("585");
            this.getSetter("maxheight").set("380");
            if (Form == this.constructor)
            {
                this._setFormPosition(542,297);
            }
            ...
            obj = new Div("divSearch","0","0","541","297",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDS_REM_bg","staDS_MESSAGE:-1","0","462","240",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new TextArea("txtDS_MESSAGE","staDS_MESSAGE:5","5","452","230",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("divBtns","205","staDS_MESSAGE:30","130","27",null,null,null,null,null,null,this.divSearch.form);
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);
