(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAV_PENSIONSUBST");
            this.set_titletext("연금저축 공제");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAVPR_PENSIONSUBST_SELECT</Col></Row><Row><Col id=\"TARGET\">closeCheck</Col><Col id=\"SP\">DAVPR_CLOSE_CHECK2</Col></Row><Row><Col id=\"SP\">DAVPR_CLOSE_CHECK</Col><Col id=\"TARGET\">closeCheck</Col></Row><Row><Col id=\"SP\">DAVPR_PENSIONSUBST_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"SP\">DAVPR_PENSIONSUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAVPR_PENSIONSUBST_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAV_PENSIONSUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAV_PENSIONSUBST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("AM_SUBST", "bigdecimal");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "YY_BASE", this.cboYN_MID=="Y"?this.ctclWORK_BASE.form.TextBox.value.substring(0,4):this.ctclWORK_BASE.form.TextBox.value);
        	this.dsSelect.setColumn(0, "MM_BASE", this.cboYN_MID=="Y"?this.ctclWORK_BASE.form.TextBox.value.substring(4,6):"12");
        ...
        //
        // 	this.dsList.setColumn(nrow, "ID_RESIDENT", this.ccfID_RESIDENT.form.DSTextBox.value.replace(/-/g,""));
        ...
        // 		trace("YEAREND_CLOSE : "+this.dsYnClose.getColumn(0, "YEAREND_CLOSE"));
        ...
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","CD_BANK"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","DS_BANK"),"edittype","none");
        ...
        this.loadIncludeScript("DAV_PENSIONSUBST.xfdl");
