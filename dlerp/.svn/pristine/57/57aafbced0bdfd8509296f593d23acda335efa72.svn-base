...
public class CENUserB2BVO extends CENBaseVO{
	...
	public String getCD_VENDOR() {
		return cdVENDOR;
	}
	public void setCD_VENDOR(String cDVENDOR) {
		cdVENDOR = cDVENDOR;
	}
	@Override
	public String toString() {
		return "CENUserB2BVO [ID_USER=" + idUSER + ", CD_VENDOR=" + cdVENDOR + "]";
	}
	public Map<String, String> getMap() {
		...
		user.put("CD_VENDOR", this.getCD_VENDOR());
		return user;
	}
}
