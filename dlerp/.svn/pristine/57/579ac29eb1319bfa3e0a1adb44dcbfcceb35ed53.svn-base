(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBZPR_SILPART_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBZ_SILPART.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnSilInput = this.gfnFormButtonAdd("btnSilInput", "fnSilInput");
        	this.btnSilInputSub = this.gfnFormButtonAdd("btnSilInputSub", "fnSilInputSub");
        };
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBZ_SILPART");
        	this.dxGrid.addEventHandler("oncelldblclick", this.fnSilInputSub, this);
        };
        ...
        this.fnSilInput = function()
        {
        	var param = {};
        	param.CD_SIL = this.dsSearch.getColumn(0, "CD_SIL");
        	param.DS_SIL = this.dsSearch.getColumn(0, "DS_SIL");

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DBZ_SILPARTINPUT", "fnSilInput_callback", param);
        }

        this.fnSilInput_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		this.FormBtns.Select.click();
        ...
        this.fnSilInputSub = function()
        {
        	var param = {};
        	param.CD_SIL = this.dsSearch.getColumn(0, "CD_SIL");
        	param.DS_SIL = this.dsSearch.getColumn(0, "DS_SIL");

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DBZ_SIL_SUBPARTINPUT", "fnSilInputSub_callback", param);
        }

        this.fnSilInputSub_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		this.FormBtns.Select.click();
        ...
        this.loadIncludeScript("DBZ_SILPART.xfdl");
