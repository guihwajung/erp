(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOTPR_TOT_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DOTPR_CARD_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00",null,"ccfCD_PROJ:10.0","92.0","24.0","5",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("(단위 : 천원)");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOT_TOT.xfdl", function() {
        ...
        this.loadIncludeScript("DOT_TOT.xfdl");
