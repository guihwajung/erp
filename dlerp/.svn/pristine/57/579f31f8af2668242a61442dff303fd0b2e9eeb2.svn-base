(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_VENDOR_WORK_CHECK_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DSKPR_VENDOR_WORK_CHECK_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSK_VENDOR_WORK_CHECK.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btn1 = this.gfnFormButtonAdd("BTN_COMPLETE", "fnCOMPLETE");
        	this.btn2 = this.gfnFormButtonAdd("BTN_CANCEL", "fnCANCEL");
        	this.btn3 = this.gfnFormButtonAdd("BTN_DELETE", "fnDELETE");
        };
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_VENDOR_WORK_CHECK");
        }
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("TY_CHECK", "string");
        ...
        this.fnGoSave = function(sta){
        	if(this.dsList.findRow("NO_SEQ", "1") < 0){
        	...
        	for(var i = 0;i<this.dsList.rowcount;i++){
        		if(this.dsList.getColumn(i, "NO_SEQ") == "1"){
        			...
        			this.dsSave.setColumn(nrow, "TY_CHECK", sta);
        ...
        this.loadIncludeScript("DSK_VENDOR_WORK_CHECK.xfdl");
