(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DLB_CONTRACTCANCEL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLB_CONTRACTCANCEL");
        };
        ...
        this.loadIncludeScript("DLB_CONTRACTCANCEL.xfdl");
