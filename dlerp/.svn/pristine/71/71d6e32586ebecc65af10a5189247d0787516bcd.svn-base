(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("퇴직공제 제외자 현황");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSGPR_TOIJIK_EXCEPT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSG_TOIJIK_EXCEPT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSG_TOIJIK_EXCEPT");
        };
        ...
        this.loadIncludeScript("DSG_TOIJIK_EXCEPT.xfdl");
