(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAV_HOUSEMONTH");
            this.set_titletext("월세소득공제명세");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAVPR_HOUSEMONTH_SELECT</Col></Row><Row><Col id=\"TARGET\">closeCheck</Col><Col id=\"SP\">DAVPR_CLOSE_CHECK2</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAVPR_HOUSEMONTH_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DAVPR_HOUSEMONTH_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAVPR_HOUSEMONTH_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAV_HOUSEMONTH.xfdl", function() {
        ...
        this.loadIncludeScript("DAV_HOUSEMONTH.xfdl");
