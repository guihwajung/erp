(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRBPR_SEARCHCONTRACTOR_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CONTRACTOR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"NO_DONG\" type=\"STRING\" size=\"256\"/><Column id=\"NO_FLOOR\" type=\"STRING\" size=\"256\"/><Column id=\"NO_HO\" type=\"STRING\" size=\"256\"/><Column id=\"DT_CONTRACT_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_CONTRACT_TO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TY_GUBUN\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_GUBUN", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">1</Col><Col id=\"DS_CODE\">성명</Col></Row><Row><Col id=\"CD_CODE\">2</Col><Col id=\"DS_CODE\">주민등록번호</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_GUBUN","0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("계약자");
            ...
            obj = new Combo("ccboTY_GUBUN","staTY_GUBUN:0.0","10.0","110","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Edit("ctxtNO_JUMIN","ccboTY_GUBUN:0.0","10.0","120","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_value("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_ACNTUNIT","ctxtNO_JUMIN:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("사업지코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_DONG","0.0","staTY_GUBUN:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("동층호");
            obj.set_textAlign("center");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Edit("ctxtNO_DONG","staNO_DONG:0.0","staTY_GUBUN:10.0","60","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_value("");
            obj.set_maxlength("4");
            obj.set_inputtype("number,normal");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtNO_FLOOR","ctxtNO_DONG:0.0","staTY_GUBUN:10.0","40","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_value("");
            obj.set_maxlength("2");
            ...
            obj = new Edit("ctxtNO_HO","ctxtNO_FLOOR:0.0","staTY_GUBUN:10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_value("");
            obj.set_inputtype("number,normal");
            obj.set_maxlength("3");
            ...
            obj = new Static("staDT_CONTRACT","ctxtNO_JUMIN:0.0","staCD_ACNTUNIT:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("계약일자");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_CONTRACT_FR","staDT_CONTRACT:0.0","staTY_GUBUN:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            ...
            obj = new Static("staDT_CONTRACT_range","ctclDT_CONTRACT_FR:0.0","staTY_GUBUN:10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("~");
            obj.set_cssclass("sta_WF_AC");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_CONTRACT_TO","staDT_CONTRACT_range:0.0","staTY_GUBUN:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new BindItem("item1","divSearch.form.ctxtNO_JUMIN","value","dsSearch","DS_CONTRACTOR");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item6","divSearch.form.ctclDT_CONTRACT_FR","value","dsSearch","DT_CONTRACT_FR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divSearch.form.ctclDT_CONTRACT_TO","value","dsSearch","DT_CONTRACT_TO");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DRB_SEARCHCONTRACTOR.xfdl", function() {
        ...
        this.loadIncludeScript("DRB_SEARCHCONTRACTOR.xfdl");
