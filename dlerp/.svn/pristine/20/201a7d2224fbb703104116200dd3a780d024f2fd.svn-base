(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOAPR_ARCH_CHARGE</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DOAPR_ARCH_CHARGE_MERGE</Col></Row><Row><Col id=\"TARGET\">selectCharge</Col><Col id=\"SP\">DOAPR_PROJ_YNCHARGE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOZ_PROJ_CHARGE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOZ_PROJ_CHARGE");
        ...
        this.fnGrid_BeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	// 그리드에서 코드파인드 id는 그리드셋팅의 코드파인드 식별ID
         	if (id == "DOXPR_USERID_BYCORP_CODEFIND") {
        ...
        this.fnGrid_AfterCDTextChanged = function(id, codeFindData) {
        	if(id == "DOXPR_USERID_BYCORP_CODEFIND") {
        		...
        		if(arr.length > 0) {
        			var ID_USER = arr[0].ID_USER;
        			var CD_ROLE = this.dsList.getColumn(this.dsList.rowposition,"CD_ROLE");
        			var chkCnt = this.dsList.getCaseCount("ID_USER == '" + ID_USER + "' && CD_ROLE == '" + CD_ROLE + "'");
        			if(chkCnt > 1){
        				this.gfnAlert("담당자 코드가 중복입니다.");
        				this.dsList.setColumn(this.dsList.rowposition,"ID_USER","");
        				this.dsList.setColumn(this.dsList.rowposition,"NM_USER","");
        				return false;
        			}
        		}
        	}
        ...
        this.gridGoloring = function(){
        	this.gfnGridColumnColor(this.dxGrid, "CD_ROLE","BACK_ReadOnly", "nx_flag==null");
        	this.gfnGridColumnColor(this.dxGrid, "ID_USER","BACK_ReadOnly", "nx_flag==null");
        	this.gfnGridColumnColor(this.dxGrid, "NM_USER","BACK_ReadOnly", "nx_flag==null");
        }
        });
        ...
        this.loadIncludeScript("DOZ_PROJ_CHARGE.xfdl");
