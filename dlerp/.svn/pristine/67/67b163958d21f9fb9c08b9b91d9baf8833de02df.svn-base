(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DUS_FILELIST_3.xfdl", function() {
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_FILELIST", "03");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "NO_FILELIST", "03");
        				break;
        		}
        	}
        ...
        this.fnGrid_ExpandUp = function(obj, e) {
        	...
        	if(colnm == "DS_FILE") {
        		...
        		fileManager.CD_DIR = [this.dsList.getColumn(e.row, "CD_SITE"), this.dsList.getColumn(e.row, "YMD_INPUT"), "03"];
        ...
        this.loadIncludeScript("DUS_FILELIST_3.xfdl");
