(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMBPR_INVOLISTCPS_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DMB_INVOLISTCPS.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	var btn2 = this.gfnFormButtonAdd("btnCPS", "fnCPS");
        	var btn3 = this.gfnFormButtonAdd("btnMCPS", "fnMCPS");
        	var btn4 = this.gfnFormButtonAdd("btnGTS", "fnGTS");
        };
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMB_INVOLISTCPS");
        }
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "YM_FR", this.dsSearch.getColumn(0, "DT_START"));
        ...
        this.fnCPS = function(obj,e) {
        	var param = {};

        	param.CD_SITE = this.dsSearch.getColumn(0, "CD_SITE");
        	param.Flag = "I";

        	this.gfnFormOpen("DMB", "DMB_INVOICECPS", "", param);
        };

        this.fnMCPS = function(obj,e) {
        	var param = {};

        	param.CD_SITE = this.dsSearch.getColumn(0, "CD_SITE");
        	param.Flag = "I";

        	this.gfnFormOpen("DMB", "DMB_INVOICEMCPS", "", param);
        };

        this.fnGTS = function(obj,e) {
        	var param = {};

        	param.CD_SITE = this.dsSearch.getColumn(0, "CD_SITE");
        	param.Flag = "I";

        	this.gfnFormOpen("DMB", "DMB_INVOICEGTS", "", param);
        };
        ...
        this.fnPopupOpen=function(){
        	...
        	switch(this.dsList.getColumn(this.dsList.rowposition, "송장종류")){
        		...
        		break;
        		case "GTS" :
        			param.CD_INSITE = this.dsList.getColumn(this.dsList.rowposition, "전입현장");
        			param.CD_TRADE_OUT = this.dsList.getColumn(this.dsList.rowposition, "CD_TRADE_OUT");
        		    param.CD_GUBUN = "CPS";
        			opop = "DMB_INVOICEGTS";
        		break;
        		case "CMS" :
        			opop = "DMB_INVOICEMCPS";
        		break;
        	}
        	...
        	param.CD_SITE = this.dsSearch.getColumn(0, "CD_SITE");
        	param.DT_WORK = this.dsList.getColumn(this.dsList.rowposition, "회계일자");
        	param.BiGo = this.dsList.getColumn(this.dsList.rowposition, "RM_BIGO");
        	param.Flag = "U";

        	this.gfnFormOpen("DMB", opop, "fn_PopupCallBack", param);
        };
        ...
        this.loadIncludeScript("DMB_INVOLISTCPS.xfdl");
