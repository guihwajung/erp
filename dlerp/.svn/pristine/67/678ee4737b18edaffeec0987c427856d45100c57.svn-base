(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAJPR_UPTURN_ITEM_SELECT</Col></Row><Row><Col id=\"TARGET\">selectHeader</Col><Col id=\"SP\">DAJPR_UPTURN_ITEM_SELECT</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("DAJ_UPTURN_ITEM.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAJ_UPTURN_ITEM");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "ID_ASSESSOR", this.FormInfo.GR_SEARCH == "9" ? this.AuthClient.ID_USER : "%");
        ...
        // 	}
        	...
        	for(var i=0;i<this.dsHeader.rowcount;i++){
        		var bindCol = this.dsHeader.getColumn(i, "ID_ASSESSOR");
        		...
        		//sum
        		var sExpr = "expr:dataset.getSum('"+this.dsHeader.getColumn(i, "ID_ASSESSOR")+"')";
        		//trace("sExpr", sExpr);
        	...
        	nIdxHead = nIdxAddStart;
         	...
         	for(var i=0;i<this.dsHeader.rowcount;i++){
        		...
        		nIdxHead = nIdxHead + 1;
         		...
         		this.dxGrid.setCellProperty( "head", nIdxHead, "text", this.dsHeader.getColumn(i, "DS_ASSESSOR"));	// row1
        ...
        //@ID_ASSESSOR		%	>>GR_SEARCH가 9인 경우에는 로그인 ID
        		var ID_ASSESSOR = this.FormInfo.GR_SEARCH == "9" ? this.AuthClient.ID_USER : "%";
        		...
        		dsUserParam.setColumn(nrow, "ID_ASSESSOR", ID_ASSESSOR);
        ...
        this.loadIncludeScript("DAJ_UPTURN_ITEM.xfdl");
