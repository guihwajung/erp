(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("예산 추가");
            if (Form == this.constructor)
            {
                this._setFormPosition(1120,415);
            }
            ...
            obj = new Radio("rdoTY_GUBUN","sta54:5","sta53:-30","113","25",null,null,null,null,null,null,this.divData.form.divDetail1.form);
            obj.set_taborder("5");
            ...
            divData_form_divDetail1_form_rdoTY_GUBUN_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">추가</Col></Row></Rows>");
            ...
            obj = new Div("ctclYM_MAGAM","sta18:5","42","80","25",null,null,null,null,null,null,this.divData.form.divDetail1.form);
            obj.set_taborder("1");
            ...
            obj = new Button("btnFile","694","43","60","24",null,null,null,null,null,null,this.divData.form.divDetail1.form);
            obj.set_taborder("41");
            obj.set_text("첨부");
            obj.set_visible("false");
            this.divData.form.divDetail1.addChild(obj.name, obj);
            ...
            obj = new BindItem("item12","divData.form.divDetail1.form.ctclYM_MAGAM.form.TextBox","value","dsDetail","YM_MAGAM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DIQ_ADDITION.xfdl","lib::libCommon.xjs");
        this.registerScript("DIQ_ADDITION.xfdl", function() {
        this.executeIncludeScript("lib::libCommon.xjs"); /*include "lib::libCommon.xjs"*/;
        this.objApp = this.gfnGetApplication();
        this.GridData = [];
        this.YN_CHBIMOK = false;
        this.YN_CHSEMOK = false;
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0, "TY_GUBUN", "3");
        ...
        this.fnSetVariable = function() {
        	...
        	this.btnFile = this.divData.form.divDetail1.form.btnFile;
        ...
        this.fnBudgetDivertSelect = function(){

        	//trace("[DB] 2 예산변경관리 편성금액 DETAIL 테이블에서 저장된 데이터 조회 fnBudgetDivertSelect");
        	...
        	this.dsBudgetSelect.setColumn(0, "DS_GUBUN", "FROM");
        	this.dsBudgetSelect.setColumn(0, "YR_BUDGET", this.dsDetail.getColumn(0, "YR_BUDGET"));
        	this.dsBudgetSelect.setColumn(0, "CD_DEPT", this.dsDetail.getColumn(0, "FROM_CD_DEPT"));
        	this.dsBudgetSelect.setColumn(0, "CD_ACCOUNT", this.dsDetail.getColumn(0, "FROM_CD_ACCOUNT"));
        	this.dsBudgetSelect.setColumn(0, "CD_ACTIVE", this.dsDetail.getColumn(0, "FROM_CD_ACTIVE"));

        	var strSvcId    = "selectDivertBudget";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
        	var inData      = "selectMon=dsBudgetSelect";
        	var outData 	= "dsListFrom=selectMon0";
        ...
        this.fnBudgetSelect = function(){

        	//trace("[DB] 3 코드파인더 세목 변경되고! 편성금액 뷰테이블 조회 fnBudgetSelect");
        ...
        this.fnSaveValidate = function () {
        	...
        	if (this.gfnIsNull(this.dsDetail.getColumn(0, "FROM_CD_DEPT"))) {
        		msg += "부서코드를 입력하세요.\n";
        		validate = false;
        	}
        	if (this.gfnIsNull(this.dsDetail.getColumn(0, "FROM_CD_ACCOUNT"))) {
        		msg += "비목코드를 입력하세요.\n";
        		validate = false;
        	}
        	if (this.gfnIsNull(this.dsDetail.getColumn(0, "FROM_CD_ACTIVE"))) {
        		msg += "세목코드를 입력하세요.\n";
        		validate = false;
        	}
        	...
        	//변경금액이 천단위인지 확인
        	var amTot = nexacro.toNumber(this.gfnNvl(this.dsListFrom.getColumn(3, "AM_TOT"),0));
        	trace("변경금액이 천단위인지 확인->" + amTot);
        	trace(amTot%1000);
        	if(amTot%1000 != 0){
        		msg += "천원 단위로 입력 가능합니다.\n";
        		validate = false;
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	switch(id) {
        		...
        		case "cfCD_ACTIVE":
        			...
        			var YR_BUDGET = this.dsDetail.getColumn(this.dsDetail.rowposition, "YR_BUDGET");
        			var CD_ACCOUNT = this.gfnNvl(this.dsDetail.getColumn(this.dsDetail.rowposition, "FROM_CD_ACCOUNT"), "");
        			var CD_DEPT = this.dsDetail.getColumn(this.dsDetail.rowposition, "FROM_CD_DEPT");
        ...
        this.fnAfterCDTextChanged = function(id, codeFindData) {
        	...
        	switch(id) {
        		...
        		case "cfCD_ACCOUNT":
        			...
        			//this.cfCD_ACTIVE.form.fnCodeFindClear();
        			this.dsDetail.setColumn(0, "FROM_CD_ACTIVE", "");
        			this.dsDetail.setColumn(0, "FROM_DS_ACTIVE", "");
        ...
        {
        	//trace("dsDetail_onvaluechanged->" + e.columnid);
        ...
        this.fnGridSum = function(p) {
        	...
        	if (p == "GRDDATA") {
        		...
        		row4.push(3);
        		/*
        		합계 값이 0이라서(왜?) for문으로 변경
        		var sum4 = this.dsListFrom.getRowsSum(row4, "AM_JAN+AM_FEB+AM_MAR+AM_APR+AM_MAY+AM_JUN+AM_JUL+AM_AUG+AM_SEP+AM_OCT+AM_NOV+AM_DEC");
        		this.dsListFrom.setColumn(3, "AM_TOT", sum4);
        		*/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDetail1.form.btnFile.addEventHandler("onclick",this.divData_divDetail2_btnFile_onclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
            this.dsDetail.addEventHandler("onvaluechanged",this.dsDetail_onvaluechanged,this);
        };
        this.loadIncludeScript("DIQ_ADDITION.xfdl");
