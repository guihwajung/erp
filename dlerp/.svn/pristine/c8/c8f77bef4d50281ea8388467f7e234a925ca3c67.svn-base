(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLCPR_LEASE_ADDUP_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DLCPR_LEASE_ADDUP_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DLCPR_LEASE_ADDUP_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DLCPR_LEASE_ADDUP_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLC_LEASE_ADDUP.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLC_LEASE_ADDUP");

         	this.gfnGridColumnColor(this.dxGrid, "YN_BANJEA", "Red", "[YN_BANJEA]=='없음'");
        ...
        this.fnAdd = function() {
        	...
        	if (this.dsList.rowcount == 1) {
        		this.dsList.setColumn(nrow, "NO_APPRO", "001");
        	}
        	else {
        		var imax = 0;
        		...
        		this.dsList.setColumn(nrow, "NO_APPRO", (++imax).toString().padLeft(3, "0"));
        	}
        }
        ...
        this.fnGrid_BeforeUserDataSetParam = function(id, dsUserParam, nrow){
        	switch(id) {
        		case "DLB_CFBank_Account_Lease_CodeFind":
        ...
        this.fnPayback = function() {
        	...
        	this.gfnFormOpen("DLC", "DLC_LEASE_ADDUPBACK", "", param);
        }
        ...
        this.loadIncludeScript("DLC_LEASE_ADDUP.xfdl");
