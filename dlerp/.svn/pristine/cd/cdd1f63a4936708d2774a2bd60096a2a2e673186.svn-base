(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DAZ_INSURERATE_PENSION.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAZ_INSURERATE_PENSION");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_GUBUN", "A");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "CD_GUBUN", "A");
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_GUBUN", "A");
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "CD_GUBUN", "A");
        ...
        this.loadIncludeScript("DAZ_INSURERATE_PENSION.xfdl");
