(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLBPR_LOAN_APPLY_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DLBPR_LOAN_REPLY_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DLBPR_LOAN_REPLY_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DLBPR_LOAN_REPLY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DLBPR_LOAN_REPLY_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"NO_DONG\" type=\"STRING\" size=\"256\"/><Column id=\"NO_FLOOR\" type=\"STRING\" size=\"256\"/><Column id=\"NO_HO\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"NO_LOAN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_ACNTUNIT\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("objGrid","0","30",null,"395","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staREPLY","0","objGrid:5","46.95%","22",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_text("상환내역");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.addChild(obj.name, obj);

            obj = new Grid("objGridSub","0","staREPLY:3",null,null,"620","0",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj._setContents("");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("sta01","0","0","33.98%","22",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_text("융자내역");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLB_LOANREPLY.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.staREPLY       = this.divData.form.staREPLY;
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DL", "DLB_LOANREPLY");
        }
        /************************************************************************
         * 파라미터 설정
         ************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "select") {
        		...
        		if(this.dsList.rowcount > 0){
        			this.staREPLY.set_text("신청차수 ["+this.dsList.getColumn(this.dsList.rowposition, "NO_LOAN")+"] 에 대한 상환내역입니다.");
        ...
        this.fnGrid_EnterCell = function(obj, row, cell) {
        	return false;	//융자신청 그리드로 사용하므로 수정되지 않게 처리
        }

        this.dsListSub_oncolumnchanged = function(obj,e)
        {
        	if(e.columnid == "AM_REPLY"){	//상환금액
        		//금액계산
        		this.fnGridAmCalc();
        ...
        this.dsSearch_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue) {
        		...
        		this.staREPLY.set_text("");
        		this.mskAM_LEFT.set_value("");
        	}
        };
        ...
        this.fnCalcAmLeft = function(){
        	var amApply = 0; amReply = 0, amLeft = 0;

        	amApply = nexacro.toNumber(this.dsList.getColumn(this.dsList.rowposition, "AM_APPLY"),0);	//원금
        	amReply = nexacro.toNumber(this.dsListSub.getCaseSum(this.ucFlag+" != 'D'", "AM_REPLY"),0);	//상환금액 합계
        ...
        //그리드 금액계산
        this.fnGridAmCalc = function ()
        {
        	var amReply = nexacro.toNumber(this.dsListSub.getCaseSum(this.ucFlag+" != 'D'", "AM_REPLY"),0);	//상환금액 합계

        	this.dsList.set_enableevent(false);
        	this.dsList.setColumn(this.dsList.rowposition, "AM_REPLY", amReply);	//상환금액
        	this.dsList.set_enableevent(true);
        };
        });
        ...
        this.loadIncludeScript("DLB_LOANREPLY.xfdl");
