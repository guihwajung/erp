(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_UYFNDPLN_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWDPR_UYFNDPLN_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclTO_WORK","sta_range:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new BindItem("item1","divSearch.form.ctclFR_WORK","value","dsSearch","FR_WORK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.ctclTO_WORK","value","dsSearch","TO_WORK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWD_UYFNDPLN.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_SITE) && !this.gfnIsNull(this.getOwnerFrame().DS_SITE)
        	 && !this.gfnIsNull(this.getOwnerFrame().FR_WORK) && !this.gfnIsNull(this.getOwnerFrame().TO_WORK))
        	 {
        	 ...
        	 else
        	 {
        		...
        		this.dsSearch.setColumn(0, "FR_WORK", today + "01");
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWD_UYFNDPLN");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("AM_PLN", "bigdecimal");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "AM_PLN", this.dsList.getColumn(i, "AM_PLN"));
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0, "FR_WORK"))) {
        		...
        		this.gfnAlert("작성시작일자를 입력하세요.", "fnVaidateCallback");
        	}
        		...
        		this.gfnAlert("작성종료일자를 입력하세요.", "fnVaidateCallback");
        	}
        ...
        this.loadIncludeScript("DWD_UYFNDPLN.xfdl");
