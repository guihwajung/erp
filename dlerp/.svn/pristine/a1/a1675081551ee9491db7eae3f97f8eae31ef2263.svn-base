(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHVPR_BGJ_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DHVPR_BGJ_CREATE</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DHVPR_EXCLUSIONTAX_DHV0096</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DHVPR_EXCLUSIONTAX_DHV0096_ISSUECANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHV_BGJAUTOSLIP.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHV_BGJAUTOSLIP");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsIssueSlip.addColumn("CD_DEPT_SELFACNT", "string");
         ...
         this.fnGrid_RowCellChanged = function(obj,e)
        {
        	if ((obj.oldrow > -1 && obj.oldrow == e.row)
        		|| (obj.oldrow == -1 && e.oldrow != e.row)) {
        			if (this.dsList.rowcount > 0) {
        				if (this.gfnIsNull(this.dsList.getColumn(e.row, "CD_TRADE"))) {
        					this.btnCreate.set_enable(true);
        					this.btnIssueSlip.set_enable(true);
        					this.btnDetailSlip.set_enable(false);
        					this.btnCancelSlip.set_enable(false);
        ...
        this.fnIssueSlip = function (obj,e) {
        	if(this.dsList.getCaseCount("YN_SLIP == 1") == 0){
        ...
        this.fnIssueSlip_callback = function(strId, val) {
        	if (val == true) {
        		...
        		for (var i = 0; i < this.dsList.rowcount; i++) {
        			if (this.dsList.getColumn(i, "YN_SLIP") == 1 && this.dsList.getColumn(i, "CD_TRADE") == "") {
        				var nRow = this.dsIssueSlip.addRow();
        				//this.dsIssueSlip.setColumn(nRow, "FALG", "");
        				...
        				this.dsIssueSlip.setColumn(nRow, "CD_DEPT_SELFACNT", this.dsSearch.getColumn(0, "CD_DEPT"));
        			}
        		}
        ...
        this.fnDetailSlip = function (obj,e) {
        	...
        	var param = {};
        	param.CD_TRADE = this.gfnTrim(nexacro.replaceAll(this.dsList.getColumn(this.dsList.rowposition, "CD_TRADE"), "-", "").substr(0, 20));
        	param.IUD_FLAG = "S";
        	...
        	if (val == true) {
        		...
        		for (var i = 0; i < this.dsList.rowcount; i++) {
        			if (this.dsList.getColumn(i, "YN_SLIP") == 1 && this.dsList.getColumn(i, "AM_BGJ_CHATOT") != "") {
        				...
        				this.dsCancelSlip.setColumn(nRow, "CD_TRADE", nexacro.replaceAll(this.dsList.getColumn(i, "CD_TRADE"), "-", ""));
        ...
        //전체선택
        this.fnEntireClick = function (obj,e) {
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        ...
        //전체선택취소
        this.fnEntireCancel = function (obj,e) {
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        ...
        this.loadIncludeScript("DHV_BGJAUTOSLIP.xfdl");
