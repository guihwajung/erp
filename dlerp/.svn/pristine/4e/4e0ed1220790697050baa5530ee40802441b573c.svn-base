(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("BS작업처리결과 입력");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/><Column id=\"CLOB\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_BS_WORKEND_SELECT</Col><Col id=\"CLOB\">PIC_SIGN</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DBSPR_BS_WORKEND_UPDATE</Col><Col id=\"CLOB\"/></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DBXPR_COMBO_SELECT</Col><Col id=\"CLOB\"/></Row><Row><Col id=\"TARGET\">combo2</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"TY_COMPLETE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_FIX\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ACT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CTM\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DONG\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HO\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DAM_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"TY_UMGB\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_COMPLETE", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">0</Col><Col id=\"DS_CODE\">전체</Col></Row><Row><Col id=\"CD_CODE\">2</Col><Col id=\"DS_CODE\">접수</Col></Row><Row><Col id=\"CD_CODE\">3</Col><Col id=\"DS_CODE\">작업지시</Col></Row><Row><Col id=\"CD_CODE\">4</Col><Col id=\"DS_CODE\">처리</Col></Row><Row><Col id=\"CD_CODE\">5</Col><Col id=\"DS_CODE\">완료</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cboTY_COMPLETE","staTY_GBN:0.0","10.0","111","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Static("staCD_CTM","0.0","staCD_SITE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            obj.set_text("협력업체");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_CTM","staCD_CTM:0.0","staCD_SITE:10.0","275","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staDS_DONG","ccfCD_CTM:0.0","staCD_SITE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("16");
            obj.set_text("동");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_FIX","ccfDS_HO:0.0","staCD_SITE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("보수유형");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_FIX","staCD_FIX:0.0","staCD_SITE:10.0","275","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staTY_UMGB","cboTY_COMPLETE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("접수구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboTY_UMGB","staTY_UMGB:0.0","10.0","91","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Static("staCD_ACT","ccfCD_FIX:0.0","staCD_SITE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_text("공종");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_ACT","staCD_ACT:0.0","staCD_SITE:10.0","275","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staCD_DAM_DEPT","ccfCD_ACT:0.0","staCD_SITE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_text("담당부서");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_DAM_DEPT","staCD_DAM_DEPT:0.0","staCD_SITE:10.0","282","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staLeftTitle","0","0","100.00%","22",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("입력항목");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.addChild(obj.name, obj);

            obj = new Calendar("calDT_JOBEND","0","26","105","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            ...
            obj = new Button("btnDT_JOBEND","calDT_JOBEND:4","26","81","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("처리일자적용");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("edtRM_JOBEND","btnDT_JOBEND:4","26","170","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnRM_JOBEND","edtRM_JOBEND:4","26","181","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("처리내용적용 (내용->처리내용)");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Calendar("calDT_APPROVE","btnRM_JOBEND:4","26","105","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Button("btnDT_APPROVE","calDT_APPROVE:4","26","81","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_text("완료일자적용");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divSearch.form.cboTY_COMPLETE","value","dsSearch","TY_COMPLETE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item7","divSearch.form.ccfCD_DAM_DEPT.form.CDTextBox","value","dsSearch","CD_DAM_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divSearch.form.cboTY_UMGB","value","dsSearch","TY_UMGB");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DBS_WORKEND_BS.xfdl", function() {
         ...
         */
        this.divData_btnSetVal_onclick = function(obj,e)
        {
         ...
         */
        this.divData_cal_canchange = function(obj,e)
        {
        	var today = this.gfnGetDate();
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.calDT_JOBEND.addEventHandler("canchange",this.divData_cal_canchange,this);
            this.divData.form.btnDT_JOBEND.addEventHandler("onclick",this.divData_btnSetVal_onclick,this);
            this.divData.form.btnRM_JOBEND.addEventHandler("onclick",this.divData_btnSetVal_onclick,this);
            this.divData.form.calDT_APPROVE.addEventHandler("canchange",this.divData_cal_canchange,this);
            this.divData.form.btnDT_APPROVE.addEventHandler("onclick",this.divData_btnSetVal_onclick,this);
        };
        this.loadIncludeScript("DBS_WORKEND_BS.xfdl");
