(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DRBPR_AGREEMENT_CHANGE</Col></Row></Rows>");
            ...
            obj = new Div("cfTY_NAPIP","116","89","280","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new BindItem("item6","divData.form.cfTY_NAPIP.form.CDTextBox","value","dsData","TY_NAPIP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DLB_AGREEMENT_CHANGE.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.cfTY_NAPIP = this.divData.form.cfTY_NAPIP;
        ...
        this.fnSetEvent = function() {
        	...
        	this.cfTY_NAPIP.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        	this.cfTY_NAPIP.AfterCDTextChanged = "fnAfterCDTextChanged";
        };
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "save") {
        		if(errorCode == 0)
        		{
        			...
        			this.gfnAlert("약정일자가 변경되었습니다.","fnCallback_callback");
        		}else
        		{
        ...
        this.fnAfterCDTextChanged = function(id, codeFindData) {
        	...
        	if(id == "cfCD_ACNTUNIT") {
        		this.cfTY_NAPIP.form.fnCodeFindClear();
        ...
        this.divData_btnOk_onclick = function(obj,e)
        {
        	...
        	this.dsSave.setColumn(0, "TY_NAPIP", this.dsData.getColumn(0, "TY_NAPIP"));
        ...
        this.loadIncludeScript("DLB_AGREEMENT_CHANGE.xfdl");
