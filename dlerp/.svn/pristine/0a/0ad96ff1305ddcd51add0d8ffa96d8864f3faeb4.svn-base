(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DYAPR_SUJU_PLAN_SILJUK_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DYA_SUJU_PLAN_SILJUK.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnSiljuk = this.gfnFormButtonAdd("btnSiljuk", "fnUSiljuk");
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DY", "DYA_SUJU_PLAN_SILJUK");
        ...
        this.fnUSiljuk = function(obj,e) {
        	//if (!this.gfnGridIsRow(this.dxGrid)) { return false; }

        	if (this.dsList.getColumn(this.dsList.rowposition, "CD_DEPT_BU")=='S')
        	{
        		this.gfnAlert("사업팀을 선택하세요.");
        		return false;
        	}
        	...
        	// 타 모듈 화면 호출시 지정할것.
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DYA_SUJU_SILJUK", "", param, 1400, 600);
        }
        ...
        this.fnSiljukAll = function(obj,e) {
        	...
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DYA_SUJU_SILJUK_ALL", "", param, 1400, 600);
        }
        ...
        this.fnColor = function()
        {
        	...
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Title", "DS_DEPT == '민간총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Title", "DS_DEPT == '공공총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Title", "DS_DEPT == '건축총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Title", "DS_DEPT == '토목총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Line", "DS_DEPT == '총계'", true);
        ...
        this.loadIncludeScript("DYA_SUJU_PLAN_SILJUK.xfdl");
