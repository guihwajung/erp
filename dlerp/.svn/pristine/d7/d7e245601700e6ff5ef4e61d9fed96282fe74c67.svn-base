(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"YN_MID\" type=\"STRING\" size=\"256\"/><Column id=\"WORK_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"QN_DIVISION\" type=\"STRING\" size=\"256\"/><Column id=\"ID_RESIDENT\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAVPR_SALARYBASE_DIVISION</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("sta03_00","86","191","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            ...
            obj = new Static("staID_RESIDENT","0","191","87","30",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("주민번호");
            obj.set_cssclass("sta_WF_tablelabel");
            this.addChild(obj.name, obj);

            obj = new Div("ccfID_RESIDENT","92","197","240","20",null,null,null,null,null,null,this);
            ...
            obj = new Edit("edtID_SABUN","ccfID_RESIDENT:1","197","79","20",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_visible("false");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Static("staCD_ORDER00","0","162","87","30",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("분할횟수");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_visible("true");
            ...
            obj = new Static("sta03_01","86","162","330","30",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Combo("cboQN_DIVISION","92","166","93","20",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var cboQN_DIVISION_innerdataset = new nexacro.NormalDataset("cboQN_DIVISION_innerdataset", obj);
            cboQN_DIVISION_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\"/><Col id=\"datacolumn\"/></Row><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">1</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">2</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">3</Col></Row></Rows>");
            obj.set_innerdataset(cboQN_DIVISION_innerdataset);
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item7","cboQN_DIVISION","value","dsList","QN_DIVISION");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAV_SALARYBASE_DIV_DLG.xfdl", function() {
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("QN_DIVISION", "int");
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if(svcID == "save") {
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("급여분할이 완료되었습니다.", "fnClose");
        		} else {
        ...
        this.btnOK_onclick = function(obj,e)
        {
        	...
        	this.gfnConfirm("기존의 정보는 삭제되면 해당 분할 횟수로 재적용 됩니다. \n계속진행하시겠습니까?", "fnConfirmCallback", "Confirm");
        }
        ...
        this.fnConfirmCallback = function(id, val){
        	...
        	if(val){
        		...
        		this.dsSave.setColumn(nrow, "QN_DIVISION", this.dsList.getColumn(0, "QN_DIVISION"));
        		this.dsSave.setColumn(nrow, "ID_RESIDENT", this.dsList.getColumn(0, "ID_RESIDENT"));
        ...
        this.loadIncludeScript("DAV_SALARYBASE_DIV_DLG.xfdl");
