(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_BIDINGLIST_SELECT</Col></Row><Row><Col id=\"TARGET\">cancel</Col><Col id=\"SP\">DCBPR_PREORDERPLAN_APPROVE_INIT</Col></Row><Row><Col id=\"SP\">DCBPR_PRECONTRACT_CREATE_UNION</Col><Col id=\"TARGET\">appr_create</Col></Row><Row><Col id=\"SP\">DCBPR_PRECONTRACT_DELETE_UNION</Col><Col id=\"TARGET\">appr_cancel</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_BIDSTATUS\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"TY_GUBUN\"/><Col id=\"TY_BIDSTATUS\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_BIDSTATUS","cal_ENYMD:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("진행상태");
            obj.set_textDecoration("none");
        ...
        // User Script
        this.addIncludeScript("DCB_BIDINGLIST.xfdl","lib::libCommon.xjs");
        this.registerScript("DCB_BIDINGLIST.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DCB_BIDINGLIST.xfdl");
