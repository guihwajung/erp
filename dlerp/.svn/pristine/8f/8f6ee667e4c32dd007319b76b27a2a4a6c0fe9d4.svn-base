(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWHPR_REQCERTI_SELECT_BONSA</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWH_CERTI_REQ_BONSA.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWH_CERTI_REQ_BONSA");
        }
        ...
        this.fnAPP = function(obj,e) {
        	...
        	if(this.dsList.findRow("CHK", "1") < 0){
        		this.gfnAlert("품의서 확인할 정보를 선택하시기 바랍니다.");
        		return false;
        	}
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		if(this.dsList.getColumn(i, "CHK") == "1"){
        			arr_in.push(this.dsList.getColumn(i, "SN_SEQ"));
        		}
        	}

        	var snSeqArr = arr_in.join(',');

        	var param = {};
        	//var nRow = this.dsList.rowposition;

        	param.PARAM01 = snSeqArr;
        ...
        this.fnAPPVIEW_SITE = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }
        ...
        this.loadIncludeScript("DWH_CERTI_REQ_BONSA.xfdl");
