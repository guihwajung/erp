(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("ctxtSN_SEQ","staSN_SEQ:0.0","10.0","60","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.getSetter("FitToContents").set("true");
            obj.set_value("");
            ...
            obj = new Static("staDS_STATUS","ctxtSN_SEQ:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("발주의뢰");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new CheckBox("cchkYN_REQ","300","4","100","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("2");
            obj.set_text("승인요청");
            obj.set_readonly("true");
            obj.set_truevalue("Y");
            ...
            obj = new CheckBox("cchkYN_APPROVE","500","4","150","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("4");
            obj.set_text("본사승인");
            obj.set_readonly("true");
            obj.set_truevalue("Y");
            ...
            obj = new Static("staBgAM_PREPAYPRO","staAM_PREPAYPRO:-1","staDT_WORKPREV:-1","380","30",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("32");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("false");
            this.divData.form.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staBgAM_PREPAYVAT","staAM_PREPAYVAT:-1","staDT_WORK:-1","380","30",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("34");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            obj.set_visible("false");
            ...
            obj = new Static("staBgDS_REASON","staDS_REASON:-1","staBgDT_WORKPREV:-1","878","87",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("36");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("txtAM_PREPAYPRO","staAM_PREPAYPRO:5","ctclFR_WORKPREV:9","273","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_format("9,999");
            obj.set_taborder("66");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("txtAM_PREPAYVAT","staAM_PREPAYVAT:5","tclFR_WORK:9","273","20",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_format("9,999");
            obj.set_taborder("68");
            obj.set_enable("true");
            obj.set_readonly("true");
            ...
            obj = new TextArea("txtDS_REASON","staDS_REASON:5","ctclFR_WORKPREV:9","865","75",null,null,null,null,null,null,this.divData.form.divData.form);
            obj.set_taborder("70");
            obj.set_readonly("false");
            ...
            obj = new BindItem("item26","divSearch.form.ctxtSN_SEQ","value","dsSearch","SN_SEQ");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item27","divData.form.divData.form.txtAM_DOKUBPREV","value","dsList","AM_DOKUBPREV");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item28","divData.form.divData.form.txtAM_DOKUB","value","dsList","AM_DOKUB");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCC_REQCHGCONTRACT_BONSA.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnDetail = this.gfnFormButtonAdd("btnDetail", "fnBtnDetail");
        };
        ...
        */
        ...
        this.fnSaveValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsList.getColumn(0,"TY_CONT"))) {
        		...
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			//this.divData.form.cboTY_CONT.setFocus();
        		}
        ...
        this.fnBtnDetail = function(obj, e){
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DWA_SILHENGTOHADO_BONSA", "fnBtnDetail_callback", param);

        };

        this.fnBtnDetail_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		this.FormBtns.Select.click();
        ...
        this.loadIncludeScript("DCC_REQCHGCONTRACT_BONSA.xfdl");
