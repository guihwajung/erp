(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select_status</Col><Col id=\"SP\">DAJPR_RTNG_PSNL_MNG_DEPT_SELECT</Col></Row></Rows>");
            ...
            obj = new Static("staID_SABUN","758","10.0","79","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("성명");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfID_SABUN","837","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Edit("edtDS_DEPT","1040","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_enable("false");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAJ_RTNG_PSNL_RTNG_DEPTLIST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsListStatus, "DA", "DAJ_RTNG_PSNL_LIST");
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg) {
        	...
        	if (svcID == "select_status") {
        		...
        		for (var i = 1; i < this.dsListStatus.rowcount; i++) {
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if (id == "ccfCD_CORP") {
        		...
        		dsUserParam.setColumn(nrow, "ID_SCREEN"   , "DAJ_RTNG_PSNL_RTNG_DEPT_LIST");
        ...
        this.loadIncludeScript("DAJ_RTNG_PSNL_RTNG_DEPTLIST.xfdl");
