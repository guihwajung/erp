(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DLB_ADDUP.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	//this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLB_ADDUP");
        ...
        this.fnPayback = function() {
        	...
        	this.gfnFormOpen("DLB", "DLB_ADDUPBACK", "", param);
        }
        ...
        this.loadIncludeScript("DLB_ADDUP.xfdl");
