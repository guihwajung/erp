(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DRB_LOANAPPLY.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRB_LOANAPPLY");
        	...
        	for (var i = 0; i < dsOut.rowcount; ++i) {
        		...
        		if(!this.gfnIsNull(dsTY_INTEREST)){
        			...
        			if(!nexacro.isAlpha(tyInterest)){
        				...
        				this.dsList.setColumn(nrow, "TY_INTEREST", (fRow == -1 ? dsOut.getColumn(i, "TY_INTEREST") : dsTY_INTEREST.getColumn(fRow, "CODE")));	//이자구분
        			}else{
        ...
        this.loadIncludeScript("DRB_LOANAPPLY.xfdl");
