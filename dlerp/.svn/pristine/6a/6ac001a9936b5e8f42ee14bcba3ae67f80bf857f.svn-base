(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFLPR_CASHINLIST_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DFLPR_INCOMEDTL_SELECT</Col></Row><Row><Col id=\"TARGET\">insert2</Col><Col id=\"SP\">DFLPR_INCOMEDTL_INSERT</Col></Row><Row><Col id=\"TARGET\">update2</Col><Col id=\"SP\">DFLPR_INCOMEDTL_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete2</Col><Col id=\"SP\">DFLPR_INCOMEDTL_DELETE</Col></Row><Row><Col id=\"TARGET\">merge</Col><Col id=\"SP\">DFLPR_CASHINLIST_MERGE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"SP\">DFLPR_CASHINLIST_DEPT</Col><Col id=\"TARGET\">cashDept</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFLPR_INCOMEDTL_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFLPR_INCOMEDTL_AUTOSLIPX</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"YN_CONFIRM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TRADE_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TRADE_TO\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BANK\" type=\"STRING\" size=\"256\"/><Column id=\"NO_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT_BH\" type=\"STRING\" size=\"256\"/><Column id=\"YN_SLIP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_DEPT_BH","sta00:0.0","10.0","280","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("90");
            obj.set_taborder("2");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staYN_SLIP","ccfCD_DEPT_BH:0","9","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_text("전표발행");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboYN_SLIP","staYN_SLIP:0.0","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            ...
            obj = new Static("staYN_CONFIRM","ccboYN_SLIP:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("확인구분");
            ...
            obj = new Combo("cboYN_CONFIRM","staYN_CONFIRM:0.0","10.0","109","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_innerdataset("dsYN_CONFIRM");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            obj.set_visible("false");
            obj.set_text("전체");
            ...
            obj = new Static("staDT_REQ","0.0","staCD_CORP:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("거래일자");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("tclDT_TRADE_FR","staDT_REQ:0.0","staCD_CORP:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new Static("staDT_REQ00","tclDT_TRADE_FR:0.0","staCD_CORP:10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("~");
            obj.set_cssclass("sta_WF_AC");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("tclDT_TRADE_TO","staDT_REQ00:0.0","staCD_CORP:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Static("staCD_BANK","ccfCD_CORP:0","staCD_CORP:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("은행코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("cfBANK","staCD_BANK:0.0","staCD_CORP:10.0","280","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("cfNO_ACCOUNT","staNO_ACCOUNT:0.0","staCD_CORP:10.0","280","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Button("btnIncomeSlipSrch2",null,"0","100","22","0",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("3");
            obj.set_text("반제전표조회");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnSlipCncl",null,"0","70","22","btnIncomeSlipSrch2:10",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("6");
            obj.set_text("전표취소");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnNonNmSlip2",null,"0","70","22","btnSlipCncl:10",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("4");
            obj.set_text("전표조회");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnSlipPub",null,"0","91","22","btnNonNmSlip2:9",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("5");
            obj.set_text("가수금전표발행");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnCancel",null,"0","100","22","btnSlipPub:10",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("2");
            obj.set_text("입금내역분류취소");
            this.divData.form.divDataBottom.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item1","divSearch.form.cboYN_CONFIRM","value","dsSearch","YN_CONFIRM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","divSearch.form.cfBANK.form.CDTextBox","value","dsSearch","CD_BANK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch.form.cfNO_ACCOUNT.form.CDTextBox","value","dsSearch","NO_ACCOUNT");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item7","divSearch.form.ccboYN_SLIP","value","dsSearch","YN_SLIP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFL_CONFIRMCASHINLIST.xfdl", function() {
        ...
        this.divSearch_cboYN_CONFIRM_onitemchanged = function(obj,e)
        {
        	//trace(e.userdata);
        ...
        // 입금내역분류및확인
        this.fnIncomeHstCnfm = function(obj,e) {
        ...
        // 입금내역MERGE
        this.fnIncomeMerge = function(obj,e) {
        	this.fnMerge("N");
        }
        ...
        // MERGE내역상세
        this.fnMergeLstDtl = function(obj,e) {
        ...
        // 입금전표발행
        this.fnIncomeSlip = function(obj,e) {
        	//if (!this.gfnGridIsRow(this.dxGrid)) return;
        ...
        // 이자분류처리
        this.fnEzaClassPrcs = function(obj,e) {
        	this.fnComInsert(this.btnEzaClassPrcs.text, 2);
        }

        // 이자전표처리
        this.fnEzaSlipPrcs = function(obj,e) {
        	/*if (!this.gfnGridIsRow(this.dxGrid)) return;*/
        ...
        // 입금전표조회
        this.fnIncomeSlipSrch = function(obj,e) {
        ...
        // 불명전표조회
        this.fnNonNmSlip = function(obj,e) {
        ...
        //처리부서변경
        this.fnCashDept = function (obj,e)
        {
        	//if(!this.gfnGridIsRow(this.dxGrid)) return;
        ...
        this.divData_divDataBottom_btnCancel_onclick = function(obj,e)
        {
        	var cnt = 0;
        	for (var i = 0; i < this.dsListSub.rowcount; i++) {
        ...
        this.divData_divDataBottom_btnIncomeSlipSrch2_onclick = function(obj,e)
        {
        	// 선택된 row가 있을 경우에만 팝업을 띄움
        	if (!this.gfnGridIsRow(this.dxGridSub)) { return false; }
        	// var chkRow = this.dsList.findRow("CHK", 1);
        ...
        this.divData_divDataBottom_btnNonNmSlip2_onclick = function(obj,e)
        {
        	// 선택된 row가 있을 경우에만 팝업을 띄움
        	if (!this.gfnGridIsRow(this.dxGridSub)) { return false; }
        	// var chkRow = this.dsList.findRow("CHK", 1);
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataBottom.form.btnIncomeSlipSrch2.addEventHandler("onclick",this.divData_divDataBottom_btnIncomeSlipSrch2_onclick,this);
            this.divData.form.divDataBottom.form.btnSlipCncl.addEventHandler("onclick",this.fnSlipCncl,this);
            this.divData.form.divDataBottom.form.btnNonNmSlip2.addEventHandler("onclick",this.divData_divDataBottom_btnNonNmSlip2_onclick,this);
            this.divData.form.divDataBottom.form.btnSlipPub.addEventHandler("onclick",this.fnSlipPub,this);
            this.divData.form.divDataBottom.form.btnCancel.addEventHandler("onclick",this.divData_divDataBottom_btnCancel_onclick,this);
            this.dsList.addEventHandler("onrowposchanged",this.dsList_onrowposchanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DFL_CONFIRMCASHINLIST.xfdl");
