(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZZPR_COM_MAIL_LIST_SELECT</Col></Row><Row><Col id=\"SP\">DZZPR_COM_MAIL_HTML_SELECT_HD</Col><Col id=\"TARGET\">select</Col></Row><Row><Col id=\"TARGET\">send</Col><Col id=\"SP\">DZZPR_COM_MAIL_SEND</Col></Row></Rows>");
            ...
            obj = new WebBrowser("webMESSAGE_BODY","10","cboTY_GUBUN:5",null,null,"10","35",null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            this.divData.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DZZ_MAIL_SENDER.xfdl", function() {
        ...
        this.loadIncludeScript("DZZ_MAIL_SENDER.xfdl");
