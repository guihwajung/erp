(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_RCODE_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRFPR_RCODE_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRFPR_RCODE_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRFPR_RCODE_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LCODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_ACNTUNIT\"/><Col id=\"CD_LCODE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP00","ccfCD_ACNTUNIT:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("대분류");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_LCODE","staCD_CORP00:0.0","10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CodeFindName").set("DRX_CFOPTIONCODE_LARGE_CODEFIND");
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("3");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            obj.set_text("");
            ...
            obj = new BindItem("item1","divSearch.form.ccfCD_LCODE.form.CDTextBox","value","dsSearch","CD_LCODE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DRF_ROOM_CODE.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_ACNTUNIT) && !this.gfnIsNull(this.getOwnerFrame().CD_LCODE)) {
        		...
        		this.divSearch.form.ccfCD_LCODE.form.DSTextBox.set_value(this.getOwnerFrame().DS_LCODE);
        ...
        this.fnSetVariable = function() {
        	...
        	this.ccfCD_LCODE = this.divSearch.form.ccfCD_LCODE;
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRF_ROOM_CODE");

        	this.ccfCD_ACNTUNIT.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        	this.ccfCD_LCODE.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        ...
        this.dsSearch_onvaluechanged = function(obj,e) {
         ...
         this.fnItemCd = function(obj,e) {
        	...
        	param.DS_LCODE = this.ccfCD_LCODE.form.DSTextBox.value;
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRF_ITEM_CODE", "fnItemCdCallback", param);
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.ccfCD_LCODE.addEventHandler("onclick",this.Common_onclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DRF_ROOM_CODE.xfdl");
