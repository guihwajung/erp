(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCCPR_CONTRACT_INDIRECT_BID_SELECT</Col></Row><Row><Col id=\"TARGET\">select_d1</Col><Col id=\"SP\">DCCPR_CONTRACT_LABOR_CHG_SELECT</Col></Row><Row><Col id=\"TARGET\">insert_d1</Col><Col id=\"SP\">DCCPR_CONTRACT_LABOR_CHG_INSERT</Col></Row><Row><Col id=\"TARGET\">update_d1</Col><Col id=\"SP\">DCCPR_CONTRACT_LABOR_CHG_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete_d1</Col><Col id=\"SP\">DCCPR_CONTRACT_LABOR_CHG_DELETE</Col></Row><Row><Col id=\"TARGET\">select_d2</Col><Col id=\"SP\">DCCPR_CONTRACT_INDIRECT_UNBID_SELECT</Col></Row><Row><Col id=\"TARGET\">update_d2</Col><Col id=\"SP\">DCCPR_CONTRACT_INDIRECT_UNBID_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete_d2</Col><Col id=\"SP\">DCCPR_CONTRACT_INDIRECT_UNBID_DELETE</Col></Row><Row><Col id=\"TARGET\">calc</Col><Col id=\"SP\">DCCPR_INDIRECT_CONTRACT_CALCULATE</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DCCPR_INDIRECT_CONTRACT_PR_APPLY</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_CONT\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SEQ\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("ctxtSN_SEQ","staSN_SEQ:0.0","10.0","59","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_value("");
            ...
            obj = new Div("divData01","0","0",null,"160","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            ...
            obj.set_taborder("0");
            obj.set_text("계약내역 집계");
            obj.set_cssclass("sta_TITLE_Bg");
            obj.set_textAlign("left");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Grid("objGrid01","0","staTitle:5",null,null,"0","0",null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("0");
            obj._setContents("");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Div("divData02","0","divData01:5",null,"120","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Button("btnDelete",null,"0","17","25","5",null,null,null,null,null,this.divData.form.divData02.form);
            obj.set_taborder("3");
            obj.set_text("삭제");
            ...
            obj = new Button("btnSave",null,"0","17","25","btnDelete:5",null,null,null,null,null,this.divData.form.divData02.form);
            obj.set_taborder("3");
            obj.set_text("저장");
            obj.set_fittocontents("width");
            obj.set_padding("4px 7px 4px 7px");
            ...
            obj = new Button("btnInsert",null,"0","17","25","btnSave:5",null,null,null,null,null,this.divData.form.divData02.form);
            obj.set_taborder("3");
            obj.set_text("입력");
            obj.set_fittocontents("width");
            obj.set_padding("4px 7px 4px 7px");
            ...
            obj = new Div("divData03","0","divData02:5",null,"220","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staMsg","300","0","300","30",null,null,null,null,null,null,this.divData.form.divData03.form);
            obj.set_taborder("1");
            ...
            obj = new Button("btnCalculate",null,"0","17","25","5",null,null,null,null,null,this.divData.form.divData03.form);
            obj.set_taborder("3");
            obj.set_text("재계산");
            obj.set_fittocontents("width");
            obj.set_padding("4px 7px 4px 7px");
            ...
            obj = new Button("btnDelete",null,"0","17","25","btnCalculate:5",null,null,null,null,null,this.divData.form.divData03.form);
            obj.set_taborder("3");
            obj.set_text("삭제");
            obj.set_fittocontents("width");
            obj.set_padding("4px 7px 4px 7px");
            ...
            obj = new Button("btnCfequip_rt",null,"0","17","25","btnSave:5",null,null,null,null,null,this.divData.form.divData03.form);
            obj.set_taborder("3");
            ...
            obj = new Div("ccfCFEQUIP_RT","btnCfequip_rt:-240","4","200","20",null,null,null,"300",null,null,this.divData.form.divData03.form);
            ...
            obj = new BindItem("item2","divSearch.form.ctxtSN_SEQ","value","dsSearch","SN_SEQ");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCC_REQCHGCONTRACT_INDIRECT.xfdl", function() {
        ...
        // 인건비 변경적용 그리드의 입력 버튼.
        this.divData_divData01_btnInsert_onclick = function(obj,e)
        {
        ...
        // 인건비 변경적용 그리드의 삭제 버튼.
        this.divData_divData01_btnDelete_onclick = function(obj,e)
        {
        	this.gfnGridDel(this.dxGrid2);
        };

        // 간접비 계상분의 저장 버튼.
        this.divData_divData02_btnSave_onclick = function(obj,e)
        {
        	this.fnDetail2Save();
        };

        // 간접비 계상분의 삭제 버튼.
        this.divData_divData02_btnDelete_onclick = function(obj,e)
        {
        	this.gfnGridDel(this.dxGrid3);
        };

        // 간접비 계상분의 재계산 버튼.
        this.divData_divData02_btnCalculate_onclick = function(obj,e)
        {
        ...
        // 건설기계대여금요율
        this.divData_divData02_btnCfequip_rt_onclick = function(obj,e)
        {
        	this.ccfCFEQUIP_RT.form.BtnSearch_onclick();
        };


        this.divData_divData01_btnSave_onclick = function(obj,e)
        {
        	this.fnDetail1Save();
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divData02.form.btnDelete.addEventHandler("onclick",this.divData_divData01_btnDelete_onclick,this);
            this.divData.form.divData02.form.btnSave.addEventHandler("onclick",this.divData_divData01_btnSave_onclick,this);
            this.divData.form.divData02.form.btnInsert.addEventHandler("onclick",this.divData_divData01_btnInsert_onclick,this);
            this.divData.form.divData03.form.btnCalculate.addEventHandler("onclick",this.divData_divData02_btnCalculate_onclick,this);
            this.divData.form.divData03.form.btnDelete.addEventHandler("onclick",this.divData_divData02_btnDelete_onclick,this);
            this.divData.form.divData03.form.btnSave.addEventHandler("onclick",this.divData_divData02_btnSave_onclick,this);
            this.divData.form.divData03.form.btnCfequip_rt.addEventHandler("onclick",this.divData_divData02_btnCfequip_rt_onclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DCC_REQCHGCONTRACT_INDIRECT.xfdl");
