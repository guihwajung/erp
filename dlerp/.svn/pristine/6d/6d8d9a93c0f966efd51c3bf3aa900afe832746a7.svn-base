(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DYAPR_SUJU_SAUP_PLAN_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_FLAG00","459","4","91","20",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("(단위 : 백만원)");
        ...
        // User Script
        this.registerScript("DYA_SUJU_SAUP_PLAN.xfdl", function() {
        ...
        this.loadIncludeScript("DYA_SUJU_SAUP_PLAN.xfdl");
