(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZZPR_MDM_MASTER_SELECT_WITH_USER_D</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DZZPR_MDM_DETAIL_SELECT_WITH_USER</Col></Row><Row><Col id=\"TARGET\">d_insert</Col><Col id=\"SP\">DZZPR_MDM_DETAIL_INSERT</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DZZPR_MDM_DETAIL_UPDATE</Col></Row><Row><Col id=\"TARGET\">d_delete</Col><Col id=\"SP\">DZZPR_MDM_DETAIL_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_SYSTEM","staCD_SYSTEM:0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("50");
            obj.set_taborder("0");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_SYSTEM00","ccfCD_SYSTEM:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("분류코드");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_MASTER","staCD_SYSTEM00:0","10.0","110","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("divSplitter","350","0","5","100%",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            ...
            obj = new BindItem("item1","divSearch.form.ccfCD_MASTER.form.CDTextBox","value","dsSearch","CD_MASTER");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DQZ_MDM_MASTERINFO_D.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_SYSTEM) && !this.gfnIsNull(this.getOwnerFrame().CD_MASTER)) {
        		...
        		this.dsSearch.setColumn(0, "CD_MASTER", this.getOwnerFrame().CD_MASTER);
         		...
         		//this.divSearch.form.ccfCD_MASTER.form.fnCodeFindLoad();	// 코드값 변경후 명칭 로딩을 위한 강제 로딩
        ...
        this.fnSetVariable = function() {
        	...
        	this.ccfCD_MASTER = this.divSearch.form.ccfCD_MASTER;
        ...
        this.fnSetEvent = function() {
        	...
        	this.ccfCD_MASTER.CodeFindName = "DZX_CFMASTER";

        	this.ccfCD_MASTER.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";

        	this.gfnGridInit(this.dxGrid, this.dsList, "DQ", "DQZ_MDM_MASTERINFO");
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0, "CD_MASTER"))) {
        		validate = false;
        		//Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			this.ccfCD_MASTER.form.CDTextBox.setFocus();
        		}
        		this.gfnAlert("분류코드를 입력하세요.", "fnVaidateCallback");
        	}
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	...
        	if (id == "ccfCD_MASTER") {
         		...
         		if (this.gfnIsNull(this.dsSearch.getColumn(0, "CD_SYSTEM"))) {
         			this.gfnAlert("시스템을 먼저 입력하세요.");
         			return false;
         		}
        		dsUserParam.setColumn(nrow, "CD_SYSTEM", this.dsSearch.getColumn(0, "CD_SYSTEM"));
        	}
        ...
        this.dsSearch_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue) {
        		...
        		{
        			this.dsSearch.setColumn(0, "CD_MASTER","");
        			this.ccfCD_MASTER.form.DSTextBox.set_value("");
        		}
        	}
        };
        ...
        this.loadIncludeScript("DQZ_MDM_MASTERINFO_D.xfdl");
