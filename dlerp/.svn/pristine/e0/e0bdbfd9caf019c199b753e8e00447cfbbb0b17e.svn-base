(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSGPR_SABAECHK_LIST</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_START\" type=\"STRING\" size=\"256\"/><Column id=\"DT_END\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"TY_GUBUN\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_GUBUN", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">1</Col><Col id=\"DS_CODE\">전체</Col></Row><Row><Col id=\"CD_CODE\">2</Col><Col id=\"DS_CODE\">최종</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYM_WORK","ccfCD_VENDOR:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("조회기간");
            obj.set_textAlign("center");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Calendar("ctclDT_START","staYM_WORK:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staYM_GISUNG","ctclDT_START:0.0","10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("~");
            obj.set_textAlign("center");
            ...
            obj = new Calendar("ctclDT_END","staYM_GISUNG:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Radio("rdoTY_GUBUN","staTY_GUBUN:0.0","10.0","139","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            ...
            obj.set_taborder("1");
            obj.set_text("※ 전체 : 계약일반사항 사배책보증의 최초차수 보증시작일, 최종차수 보증종료일 조회\r\n\r\n    최종 : 계약일반사항 사배책보증의 최종차수 보증시작일, 최종차수 보증종료일 조회");
        ...
        // User Script
        this.registerScript("DSG_SABAECHK_LIST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSG_SABAECHK_LIST");
        };
        ...
        this.loadIncludeScript("DSG_SABAECHK_LIST.xfdl");
