(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\"/><Col id=\"VALUE\">전체</Col></Row><Row><Col id=\"CODE\">01</Col><Col id=\"VALUE\">재직자(휴직자 포함)</Col></Row><Row><Col id=\"CODE\">02</Col><Col id=\"VALUE\">재직자(휴직자 제외)</Col></Row><Row><Col id=\"CODE\">04</Col><Col id=\"VALUE\">퇴직자</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CORP","ctclYR_BASE:90","10.0","66","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Combo("ccfTY_RETIRE","staTY_RETIRE:0.0","ctclYR_BASE:10.0","140","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
        ...
        this.fnSetExtendButton = function() {
        	if (this.FormInfo.TY_AUTH == "F") {
        		...
        		//this.btnYear2.set_enable(false);
        		//this.btnCmmAnnualCreate.set_enable(false);
        		this.btnYear1 = this.gfnFormButtonAdd("Year1", "fnYear1");	// 연차관리(개인별)
        	}
        }
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("CD_DEPT_AUTH", "string");
        	...
        	this.dsUpdate.addColumn("DT_YEARLY", "string");
        ...
        this.fnInit = function() {
        	...
        	this.ccfTY_RETIRE.set_value("01");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_DEPT_AUTH"  , this.AuthClient.CD_DEPT);
        ...
        this.fnSave = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		case "U":
        			...
        			this.dsUpdate.setColumn(nrow, "DT_YEARLY"		 , this.dsList.getColumn(i, "DT_YEARLY"));
        			break;
        		case "D":
