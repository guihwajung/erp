(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("유가증권장단기대체결산");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFEPR_YUDONG_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFEPR_YUDONG_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFEPR_YUDONG_UPDATE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFEPR_YUDONG_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFEPR_YUDONG_AUTOSLIPX</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFE_YUDONG.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFE_YUDONG");
        ...
        this.fnAutoSlip = function(slipYn) {
        	...
        	// 전표발행후처리
        		...
        		var nrow = this.dsAutoSlip.addRow();
        		this.dsAutoSlip.setColumn(nrow, "YM_WORK", this.calYM_WORK.form.TextBox.value);
        		this.dsAutoSlip.setColumn(nrow, "NO_YUGA", this.dsList.getColumn(this.dsList.findRow("CHK", 1), "NO_YUGA"));
        		this.dsAutoSlip.setColumn(nrow, "CD_CORP", this.cfCD_CORP.form.CDTextBox.value);
        		this.dsAutoSlip.setColumn(nrow, "TM_SLIP", tmSlip);
        		this.dsAutoSlip.setColumn(nrow, "YN_SLIP", slipYn);
        		this.dsAutoSlip.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);
        ...
        this.fnStatusSelect = function(obj,e) {
        	...
        	this.gfnFormOpen("DFE", "DFE_YUDONG2", "fnPopCallBack", param);
        }
        ...
        this.fnAgrMntInf = function(obj,e) {
        	...
        	param.NM_YUGA = this.dsList.getColumn(this.dsList.rowposition,"NM_YUGA");		// 관리번호명
        	this.gfnFormOpen("DFE", "DFE_YUGA_REGISTRATION", "fnPopCallBack", param);
        }
        });
        ...
        this.loadIncludeScript("DFE_YUDONG.xfdl");
