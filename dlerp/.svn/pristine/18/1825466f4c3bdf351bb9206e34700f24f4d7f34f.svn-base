(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select_status</Col><Col id=\"SP\">DAJPR_RTNG_GOAL_ESTT_MNG_SELECT</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("DAJ_RTNG_GOAL_ESTT_LIST.xfdl", function() {
        ...
        this.fnGridEnterCell = function(obj, row, cell) {
        	...
        	var list = ['DS_GOAL_WRK', 'DS_EXEC_PLN_HGHYR', 'DS_EXEC_PLN_LOWHYR', 'DS_GOAL_LVL_MIN', 'DS_GOAL_LVL_MAX', 'DS_MNPT_ADMN', 'NO_WGTV','DS_RMK'];	//'DS_FDBK','DS_FDBK_TOT_A','DS_FDBK_TOT_B'];
        ...
        // 	}
        	...
        	this.dxGrid.setCellProperty("body", this.dxGrid.getBindCellIndex("body", colnm), "expandshow", "show");	//"show
        ...
        this.loadIncludeScript("DAJ_RTNG_GOAL_ESTT_LIST.xfdl");
