(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFGPR_LOANPLAN_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFGPR_LOANPLAN_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFGPR_LOANPLAN_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFGPR_LOANPLAN_DELETE</Col></Row><Row><Col id=\"TARGET\">ezacalc</Col><Col id=\"SP\">DFGPR_LOANPLAN_EZACALC</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFGPR_LOANPLAN_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFGPR_LOANPLAN_AUTOSLIPX</Col></Row><Row><Col id=\"TARGET\">linkslip</Col><Col id=\"SP\">DFGPR_LOANPLAN_LINKSLIP</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo2</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo3</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">branch</Col><Col id=\"SP\">DFBPR_BRANCH_INSERT</Col></Row><Row><Col id=\"TARGET\">bracnchcancel</Col><Col id=\"SP\">DFBPR_BRANCH_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"FR_DT_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"TO_DT_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"YN_SLIP\" type=\"STRING\" size=\"256\"/><Column id=\"NO_LOAN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_PLAN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"TY_TRAN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item5","divSearch.form.cfNO_LOAN.form.CDTextBox","value","dsSearch","NO_LOAN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFG_LOAN_PLAN.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFG_LOANPLAN");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("AM_PYEAR", "bigdecimal");
        	this.dsInsert.addColumn("AM_CHA", "bigdecimal");
        	...
        	this.dsUpdate.addColumn("AM_PYEAR", "bigdecimal");
        	this.dsUpdate.addColumn("AM_CHA", "bigdecimal");
        	...
        	this.dsEzaCalc.addColumn("NO_LOAN", "string");
        	...
        	this.dsLinkSlip.addColumn("NO_LOAN", "string");
        	...
        	this.dsCms.addColumn("NO_IN", "string"); //20200507 추가
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_LOAN", this.cfNO_LOAN.form.CDTextBox.value);
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "AM_PYEAR", this.dsList.getColumn(i, "AM_PYEAR"));
        				this.dsInsert.setColumn(nrow, "AM_CHA", this.dsList.getColumn(i, "AM_CHA"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "AM_PYEAR", this.dsList.getColumn(i, "AM_PYEAR"));
        				this.dsUpdate.setColumn(nrow, "AM_CHA", this.dsList.getColumn(i, "AM_CHA"));
        ...
        this.fnPopupValidate = function(popId) {
        	...
        	case "DFG_DLG_LOAN_OUTSLIP":	// 출금전표발행
        	case "DFG_DLG_LOAN_INSLIP":	// 입금전표발행
        		var fndRow = this.dsList.findRow("CHK", 1);
        		if (this.dsList.rowcount == 0 || fndRow <= -1) {
        		...
        		// 체크된 데이터중 거래구분 대여, 이자, 회수 건수
        		var LOANCnt = this.dsList.getCaseCount("CHK == 1 && TY_TRADE == '대여'");
        		var ezaCnt = this.dsList.getCaseCount("CHK == 1 && TY_TRADE == '이자'");
        		var sangCnt = this.dsList.getCaseCount("CHK == 1 && TY_TRADE == '회수'");
        		var totalCnt = LOANCnt + ezaCnt + sangCnt;

        		// 총건수가 1보다 크고(다중선택) 대여, 이자, 회수 건수 모두 총건수보다 작으면 다른 거래구분을 선택한것으로 간주.
        		if ( totalCnt > 1 && (totalCnt != LOANCnt && totalCnt != ezaCnt && totalCnt != sangCnt) ) {
        			this.gfnAlert("거래구분은 하나의 종류만 선택 가능합니다.");
        			return false;
        		}

        		if (ezaCnt > 1 || sangCnt > 1) {
        			var gubun;
        			if (ezaCnt > 1) {
        				gubun = "[이자]";
        			}
        	...
        	if (svcID == "select") {
        		...
        		if ( !this.gfnIsNull(this.getOwnerFrame().OWNER_ID) ) {
        			...
        			if (this.getOwnerFrame().OWNER_ID == "DFB_FINANCE_QUERY") {
        				...
        				this.cfNO_LOAN.form.CDTextBox.set_value(this.getOwnerFrame().NO_LOAN);
        			...
        			// from 대여금약정등록
        			if (this.getOwnerFrame().OWNER_ID == "DFG_LOAN") {
        				this.cfCD_CORP.form.CDTextBox.set_value(this.getOwnerFrame().CD_CORP);
        				this.cfCD_CORP.form.DSTextBox.set_value(this.getOwnerFrame().DS_CORP);
        				this.cfNO_LOAN.form.CDTextBox.set_value(this.getOwnerFrame().NO_LOAN);
        				this.cfNO_LOAN.form.DSTextBox.set_value(this.getOwnerFrame().NM_LOAN);
        				this.calFR_DT_TRADE.set_value(this.getOwnerFrame().DT_FROM);
        				this.calTO_DT_TRADE.set_value(this.getOwnerFrame().DT_TO);
        				this.cboTY_TRADE.set_index(0);												// 거래구분:전체
        			}
        ...
        this.fnPopCallBack = function(svcID, val) {
        	...
        	if (val != false) {
        		...
        		if (svcID.indexOf("DFG_DLG_LOAN_PLAN_CHG") > -1) {
        			...
        			for (var i=0; i < this.dsList.rowcount; i++) {
        				...
        				if (this.dsList.getColumn(i, "CHK") == 1) {
        					...
        					if ( !this.gfnIsNull(json.RT_CURRENCY) ) {
        						this.dsList.setColumn(i, "RT_CURRENCY", json.RT_CURRENCY);	// 환율
        					}
        		...
        		// 출금 전표발행팝업 콜백
        		if (svcID.indexOf("DFG_DLG_LOAN_OUTSLIP") > -1) {
        			this.fnAutoSlip("N");
        		}


        		// 입금 전표발행팝업 콜백
        		if (svcID.indexOf("DFG_DLG_LOAN_INSLIP") > -1) {
        			noTrade = "";
        		...
        		// 전표연결
        		if (svcID.indexOf("DFG_DLG_LINKSLIP") > -1) {
        		...
        		if(svcID.indexOf("DFB_DLG_BRANCH") > -1){
        			...
        			for(var i =0;i<this.dsList.rowcount;i++){
        				if(this.dsList.getColumn(i, "CHK") == 1){
        					...
        					this.dsCms.setColumn(nrow, "SEQ_EXEC", this.dsList.getColumn(i, "NO_LOAN"));
        					this.dsCms.setColumn(nrow, "NO_SEQ", this.dsList.getColumn(i, "NO_SEQ"));
        					this.dsCms.setColumn(nrow, "GB_SEND", "LOAN");
        ...
        this.fnLinkSlip = function(slipNo) {
        	...
        	for (var i=0; i < this.dsList.rowcount; i++) {
        		if (this.dsList.getColumn(i, "CHK") == 1) {
        			...
        			this.dsLinkSlip.setColumn(nrow, "NO_LOAN", this.dsList.getColumn(i, "NO_LOAN"));
        ...
        this.fnGrid_AfterCDTextChanged = function(id, codeFindData) {
        	...
        	if (id == "DFX_CFNO_LOAN") {
        		if(arr.length > 0) {
        			...
        			this.dsList.setColumn(this.dsList.rowposition, "DS_LOAN", arr[0]["DS_LOAN"]);
        			this.dsList.setColumn(this.dsList.rowposition, "CD_LOANBANK", arr[0]["CD_LOANBANK"]);
        	...
        	if (val) {
        		...
        		for (var i=0; i < this.dsList.rowcount; i++) {
        			if (this.dsList.getColumn(i, "CHK") == 1) {
        				...
        				this.dsEzaCalc.setColumn(nrow, "NO_LOAN", this.dsList.getColumn(i, "NO_LOAN"));
        ...
        this.fnBtchInfChng = function(obj,e) {
        	var popId = "DFG_DLG_LOAN_PLAN_CHG";
        	...
        	var fndRow = this.dsList.findRow("CHK", 1)
        	var param = {};
        	param.YN_VIEW = this.dsList.getColumn(fndRow, "YN_VIEW");
        	//param.YN_VIEW = "N";
        	...
        	// 타 모듈 화면 호출시 지정할것.
        	//trace("YN_VIEW :::: " + param.YN_VIEW);

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DFG_DLG_LOAN_PLAN_CHG", "fnPopCallBack", param, width, height);
        }
        ...
        this.fnSlipPub = function(obj,e) {
        	...
        	var popId = "DFG_DLG_LOAN_INSLIP";
        	if (!this.fnPopupValidate(popId)) {
        		return false;
        	}

        	var LOANCnt = this.dsList.findRowExpr("CHK == 1 && TY_TRADE == '대여'");
        	var eZaSangCnt = this.dsList.findRowExpr("CHK == 1 && (TY_TRADE == '이자' || TY_TRADE == '회수')");

        	var param = {};

        	if (LOANCnt != -1) {
        		popId = "DFG_DLG_LOAN_OUTSLIP";
        		var width = 430;
        		var height = 340;
        		...
        		param.AM_TRADE = this.dsList.getCaseSum("CHK == 1", "AM_TRADE");						// 대여금액
        		param.AM_TOTAL = param.AM_TRADE - param.AM_EZA - param.AM_ETC - param.AM_CORP_JUMIN;	// 출금예상금액
        		param.CD_CORP = this.dsList.getColumn(LOANCnt, "CD_CORP");								// 법인코드
        		//param.NO_ACCOUNT = this.dsList.getColumn(this.dsList.rowposition, "NO_ACCOUNT");		// 이자계좌
        	}

        	if (eZaSangCnt != -1) {
        		popId = "DFG_DLG_LOAN_INSLIP";

        		var width = 430;
        		var height = 375;

        		param.AM_TRADE = this.dsList.getCaseSum("CHK == 1", "AM_TRADE");						// 회수금액
        		var amCorp = this.dsList.getCaseSum("CHK == 1", "AM_CORP");								// 법인세
        		var amJumin = this.dsList.getCaseSum("CHK == 1", "AM_JUMIN");							// 주민세
        		param.AM_CORP_JUMIN = amCorp + amJumin;													// 법인/주민세
        		param.AM_EZA = this.dsList.getCaseSum("CHK == 1", "AM_EZA");							// 이자금액
        		param.AM_ETC = this.dsList.getCaseSum("CHK == 1", "AM_ETC");							// 부대비용
        		param.AM_TOTAL = param.AM_TRADE + param.AM_EZA + param.AM_ETC - param.AM_CORP_JUMIN;	// 입금예상금액
        		param.CD_CORP = this.dsList.getColumn(eZaSangCnt, "CD_CORP");							// 법인코드
        		param.NO_ACCOUNT_LOAN = this.dsList.getColumn(eZaSangCnt, "NO_ACCOUNT_LOAN");			// 대여계좌
        		param.DT_TRADE = this.dsList.getColumn(eZaSangCnt, "DT_TRADE");							// 거래일자
        	}
        ...
        this.fnSetCombo = function() {
        	...
        	this.dsCombo2.setColumn(0, "CD_TYPE", "GA");
        	...
        	this.dsCombo3.setColumn(0, "CD_TYPE", "GB");
        ...
        //
        // 		// 체크된 데이터중 거래구분 대여, 이자, 회수 건수
        // 		var LOANCnt = obj.getCaseCount("CHK == 1 && TY_TRADE == '대여'");
        // 		var ezaCnt = obj.getCaseCount("CHK == 1 && TY_TRADE == '이자'");
        // 		var sangCnt = obj.getCaseCount("CHK == 1 && TY_TRADE == '회수'");
        // 		var totalCnt = LOANCnt + ezaCnt + sangCnt;
        //
        // // 		trace("LOANCnt :: " + LOANCnt);
        // // 		trace("ezaCnt :: " + ezaCnt);
        ...
        // 조회결과 YN_VIEW에 따라 화폐단위 ~ 사후신고일 visible 처리
        this.fnSetVisibleCol = function(flag) {
        	if (flag == "Y") {
        		this.dxGrid.setFormatColProperty(18, "size", 70);
        		this.dxGrid.setFormatColProperty(19, "size", 70);
        		this.dxGrid.setFormatColProperty(20, "size", 100);
        		this.dxGrid.setFormatColProperty(21, "size", 100);
        		this.dxGrid.setFormatColProperty(22, "size", 100);
        		this.dxGrid.setFormatColProperty(23, "size", 150);
        		//this.dxGrid.setFormatColProperty(24, "size", 100);
        		//this.dxGrid.setFormatColProperty(25, "size", 100);
        	} else {
        		...
        		//this.dxGrid.setFormatColProperty(25, "size", 0);
        	}
        ...
        this.fnOfflineExec = function(obj,e) {
        	...
        	for(var i =0;i<this.dsList.rowcount;i++){
        		if(this.dsList.getColumn(i, "CHK") == 1){
        			...
        			this.dsCms.setColumn(nrow, "SEQ_EXEC", this.dsList.getColumn(i, "NO_LOAN"));
        			this.dsCms.setColumn(nrow, "NO_SEQ", this.dsList.getColumn(i, "NO_SEQ"));
        			this.dsCms.setColumn(nrow, "GB_SEND", "OFFLOAN");
        			this.dsCms.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);
        ...
        this.loadIncludeScript("DFG_LOAN_PLAN.xfdl");
