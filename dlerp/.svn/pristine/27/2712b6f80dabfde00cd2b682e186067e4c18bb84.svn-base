(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAV_CARDSUBST");
            this.set_titletext("신용카드공제");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAVPR_CARDSUBST2021_SELECT</Col></Row><Row><Col id=\"TARGET\">closeCheck</Col><Col id=\"SP\">DAVPR_CLOSE_CHECK2</Col></Row><Row><Col id=\"TARGET\">closeCheck</Col><Col id=\"SP\">DAVPR_CLOSE_CHECK</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAVPR_CARDSUBST2021_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DAVPR_CARDSUBST2021_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAVPR_CARDSUBST2021_DELETE</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DAVPR_CARDSUBSTRPT21_SELECT</Col></Row><Row><Col id=\"TARGET\">reportSub1</Col><Col id=\"SP\">DAVPR_CARDSUBSTRPT211_SELECT</Col></Row><Row><Col id=\"TARGET\">reportSub2</Col><Col id=\"SP\">DAVPR_CARDSUBSTRPT2021SUB_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAV_CARDSUBST.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	//this.btnCardMyAdd = this.gfnFormButtonAdd("CardMyAdd", "fnExtBtnEvent", "추가공제사용분증가분(본인)");
        };
        /************************************************************************
         * 변수 선언
         ************************************************************************/
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAV_CARDSUBST");
        ...
        // 	this.dsInsert.addColumn("AM_SUBST1", "int");
        // 	this.dsInsert.addColumn("AM_CHECK", "int");
        // 	this.dsInsert.addColumn("AM_SUBST2", "int");
        // 	this.dsInsert.addColumn("AM_SUBST3", "int");
        // 	this.dsInsert.addColumn("AM_SUBST4", "int");
        // 	this.dsInsert.addColumn("AM_SUBST5", "int");
        // 	this.dsInsert.addColumn("AM_SUBST6", "int");
        // 	this.dsInsert.addColumn("AM_SUBST7", "int");
        // 	this.dsInsert.addColumn("AM_SUBST8", "int");
        ...
        // 	this.dsUpdate.addColumn("AM_SUBST1", "int");
        // 	this.dsUpdate.addColumn("AM_CHECK", "int");
        // 	this.dsUpdate.addColumn("AM_SUBST2", "int");
        // 	this.dsUpdate.addColumn("AM_SUBST3", "int");
        // 	this.dsUpdate.addColumn("AM_SUBST4", "int");
        // 	this.dsUpdate.addColumn("AM_SUBST5", "int");
        // 	this.dsUpdate.addColumn("AM_SUBST6", "int");
        // 	this.dsUpdate.addColumn("AM_SUBST7", "int");
        // 	this.dsUpdate.addColumn("AM_SUBST8", "int");
        ...
        // 	this.dsDelete.addColumn("CD_CORP", "string");
        	...
        	this.dsInsert.addColumn("YN_MID", "string");
        	this.dsInsert.addColumn("DS_HNAME", "string");
        	this.dsInsert.addColumn("AM_SUBST80", "int");
        	this.dsInsert.addColumn("AM_SUBST82", "int");
        	this.dsInsert.addColumn("AM_SUBST81", "int");
        	this.dsInsert.addColumn("AM_SUBST85", "int");
        	this.dsInsert.addColumn("AM_SUBST86", "int");
        	this.dsInsert.addColumn("AM_SUBST88", "int");
        	this.dsInsert.addColumn("AM_SUBST87", "int");
        	this.dsInsert.addColumn("AM_SUBST84", "int");
        	this.dsInsert.addColumn("AM_SUBST83", "int");
        	this.dsInsert.addColumn("AM_SUBST80T", "int");
        	this.dsInsert.addColumn("AM_SUBST800", "int");
        	this.dsInsert.addColumn("AM_SUBST820", "int");
        	this.dsInsert.addColumn("AM_SUBST810", "int");
        	this.dsInsert.addColumn("AM_SUBST81T", "int");
        	this.dsInsert.addColumn("AM_SUBST801", "int");
        	this.dsInsert.addColumn("AM_SUBST821", "int");
        	this.dsInsert.addColumn("AM_SUBST811", "int");
        	this.dsInsert.addColumn("YN_NTS", "string");
        	this.dsInsert.addColumn("ID_INSERT", "string");
        	this.dsInsert.addColumn("CD_CORP", "string");
        	...
        	this.dsUpdate.addColumn("YN_MID", "string");
        	this.dsUpdate.addColumn("DS_HNAME", "string");
        	this.dsUpdate.addColumn("AM_SUBST80", "int");
        	this.dsUpdate.addColumn("AM_SUBST82", "int");
        	this.dsUpdate.addColumn("AM_SUBST81", "int");
        	this.dsUpdate.addColumn("AM_SUBST85", "int");
        	this.dsUpdate.addColumn("AM_SUBST86", "int");
        	this.dsUpdate.addColumn("AM_SUBST88", "int");
        	this.dsUpdate.addColumn("AM_SUBST87", "int");
        	this.dsUpdate.addColumn("AM_SUBST84", "int");
        	this.dsUpdate.addColumn("AM_SUBST83", "int");
        	this.dsUpdate.addColumn("AM_SUBST80T", "int");
        	this.dsUpdate.addColumn("AM_SUBST800", "int");
        	this.dsUpdate.addColumn("AM_SUBST820", "int");
        	this.dsUpdate.addColumn("AM_SUBST810", "int");
        	this.dsUpdate.addColumn("AM_SUBST81T", "int");
        	this.dsUpdate.addColumn("AM_SUBST801", "int");
        	this.dsUpdate.addColumn("AM_SUBST821", "int");
        	this.dsUpdate.addColumn("AM_SUBST811", "int");
        	this.dsUpdate.addColumn("YN_NTS", "string");
        	this.dsUpdate.addColumn("NO_SEQ", "int");
        	this.dsUpdate.addColumn("ID_UPDATE", "string");
        	this.dsUpdate.addColumn("CD_CORP", "string");
        ...
        this.fnAdd = function() {
        	...
        	//this.dsList.setColumn(nrow, "YN_NTS", "N");
        };
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "AM_SUBST80", this.dsList.getColumn(i, "AM_SUBST80"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST82", this.dsList.getColumn(i, "AM_SUBST82"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST81", this.dsList.getColumn(i, "AM_SUBST81"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST85", this.dsList.getColumn(i, "AM_SUBST85"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST86", this.dsList.getColumn(i, "AM_SUBST86"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST88", this.dsList.getColumn(i, "AM_SUBST88"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST87", this.dsList.getColumn(i, "AM_SUBST87"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST84", this.dsList.getColumn(i, "AM_SUBST84"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST83", this.dsList.getColumn(i, "AM_SUBST83"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST80T", this.dsList.getColumn(i, "AM_SUBST80T"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST800", this.dsList.getColumn(i, "AM_SUBST800"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST820", this.dsList.getColumn(i, "AM_SUBST820"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST810", this.dsList.getColumn(i, "AM_SUBST810"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST81T", this.dsList.getColumn(i, "AM_SUBST81T"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST801", this.dsList.getColumn(i, "AM_SUBST801"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST821", this.dsList.getColumn(i, "AM_SUBST821"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST811", this.dsList.getColumn(i, "AM_SUBST811"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "AM_SUBST80", this.dsList.getColumn(i, "AM_SUBST80"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST82", this.dsList.getColumn(i, "AM_SUBST82"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST81", this.dsList.getColumn(i, "AM_SUBST81"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST85", this.dsList.getColumn(i, "AM_SUBST85"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST86", this.dsList.getColumn(i, "AM_SUBST86"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST88", this.dsList.getColumn(i, "AM_SUBST88"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST87", this.dsList.getColumn(i, "AM_SUBST87"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST84", this.dsList.getColumn(i, "AM_SUBST84"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST83", this.dsList.getColumn(i, "AM_SUBST83"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST80T", this.dsList.getColumn(i, "AM_SUBST80T"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST800", this.dsList.getColumn(i, "AM_SUBST800"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST820", this.dsList.getColumn(i, "AM_SUBST820"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST810", this.dsList.getColumn(i, "AM_SUBST810"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST81T", this.dsList.getColumn(i, "AM_SUBST81T"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST801", this.dsList.getColumn(i, "AM_SUBST801"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST821", this.dsList.getColumn(i, "AM_SUBST821"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST811", this.dsList.getColumn(i, "AM_SUBST811"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "YY_BASE", this.ctclWORK_BASE.form.TextBox.value.substring(0,4));
        ...
        this.fnPrintProc = function(callType){
        	...
        	if(callType == "S"){
        		...
        		var inProc		= "_dsProc";
        		var inData      = "report=dsReport reportSub1=dsReport reportSub2=dsReport";
        		...
        		var inParam		= "";
        		var inData      = "report=dsReport reportSub1=dsReport reportSub2=dsReport";						// target=파라미터 Ds
        ...
        //
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","NO_SEQ"),"edittype","none");
        ...
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_TOTAL"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_SUBST1"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_CHECK"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_SUBST2"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_SUBST3"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_SUBST4"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","YN_NTS"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_SUBST6"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_SUBST7"),"edittype","none");
        // 			this.dxGrid.setCellProperty("body",this.dxGrid.getBindCellIndex("body","AM_SUBST8"),"edittype","none");
        //
        // 			this.FormBtns.Add.set_enable(false);
        // 			this.FormBtns.Del.set_enable(false);
        // 			this.FormBtns.Save.set_enable(false);
        ...
        this.fnGrid_BeforeUserDataSetParam = function(id, dsUserParam, nrow){
        	...
        	switch(id) {
        		...
        		case "DAX_CFBASESUBST":     // 부양가족
        			dsUserParam.setColumn(nrow, "YY_BASE", this.ctclWORK_BASE.form.TextBox.value.substring(0,4));
        ...
        ************************************************************************/
         ...
         ************************************************************************/
         this.fnExtBtnEvent = function(btn){
        	...
        	switch(btn.id){
        		...
        		case "btnExt_CardMyAdd": //추가공제사용분증가분(본인)
        			param={
        			...
        			this.gfnFormOpen(this.FormInfo.CD_MODULE, "DAV_CARDMYADDDLG", "fnPopupCallback", param);
        			break;
        ...
        this.loadIncludeScript("DAV_CARDSUBST.xfdl");
