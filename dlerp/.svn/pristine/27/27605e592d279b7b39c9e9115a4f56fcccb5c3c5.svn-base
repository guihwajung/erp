(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select_d1</Col><Col id=\"SP\">DCBPR_PRECONTRACT_INDIRECT_BID_SELECT</Col></Row><Row><Col id=\"TARGET\">select_d2</Col><Col id=\"SP\">DCBPR_PRECONTRACT_LABOR_CHG_SELECT</Col></Row><Row><Col id=\"TARGET\">insert_d2</Col><Col id=\"SP\">DCBPR_PRECONTRACT_LABOR_CHG_INSERT</Col></Row><Row><Col id=\"TARGET\">delete_d2</Col><Col id=\"SP\">DCBPR_PRECONTRACT_LABOR_CHG_DELETE</Col></Row><Row><Col id=\"TARGET\">update_d2</Col><Col id=\"SP\">DCBPR_PRECONTRACT_LABOR_CHG_UPDATE</Col></Row><Row><Col id=\"TARGET\">select_d3</Col><Col id=\"SP\">DCBPR_PRECONTRACT_INDIRECT_UNBID_SELECT</Col></Row><Row><Col id=\"TARGET\">update_d3</Col><Col id=\"SP\">DCBPR_PRECONTRACT_INDIRECT_UNBID_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete_d3</Col><Col id=\"SP\">DCBPR_PRECONTRACT_INDIRECT_UNBID_DELETE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"SP\">DCBPR_ESTIMATION_FINISH</Col><Col id=\"TARGET\">finish</Col></Row><Row><Col id=\"SP\">DCCPR_CONTRACT_CANCEL</Col><Col id=\"TARGET\">finish_cancel</Col></Row><Row><Col id=\"TARGET\">calc</Col><Col id=\"SP\">DCBPR_INDIRECT_PRECONTRACT_CALCULATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnSearch",null,"10.0","40","24.0","5",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("검색");
            ...
            obj = new Div("divData02","0","0",null,"160","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DMA_INDIRECT_APLLY.xfdl", function() {
        ...
        this.fnSelect = function() {
        	...
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
        	var inData      = "select_d1=dsSelect select_d2=dsSelect select_d3=dsSelect";
        	var outData     = "dsList1=select_d10 dsList2=select_d20 dsList3=select_d30";
        	var strArg      = "";
        	...
        	for (var i = 0; i < this.dsList2.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert_d2.setColumn(nrow, "NO_CONT", this.dsSearch.getColumn(0, "NO_CONT"));
        	...
        	for (var i = 0; i < this.dsList3.rowcount; i++) {
        		...
        		switch(flag) {
        			case "U":
        				...
        				this.dsUpdate_d3.setColumn(nrow, "NO_CONT", this.dsSearch.getColumn(0, "NO_CONT"));
        ...
        this.fnGWReq_Callback = function(strId, val) {
        		...
        		this.dsRequest.setColumn(0, "NO_CONT", this.dsSearch.getColumn(0, "NO_CONT"));
        ...
        this.fnGWReqCancel_Callback = function(strId, val) {
        		...
        		this.dsRequestCancel.setColumn(0, "NO_CONT", this.dsSearch.getColumn(0, "NO_CONT"));
        ...
        this.fnFinish_Callback = function(strId, val) {
        		...
        		this.dsFinish.setColumn(0, "NO_CONT", this.dsSearch.getColumn(0, "NO_CONT"));
        ...
        this.fnFinishCancel_Callback = function(strId, val) {
        	...
        	this.dsFinishCancel.setColumn(0, "NO_CONT", this.dsSearch.getColumn(0, "NO_CONT"));
        ...
        this.fnAttachEtc = function(obj,e) {
        	if(this.gfnIsNull(this.dsSearch.getColumn(0, "NO_CONT"))) return;
        ...
        this.divData_divData03_btnInsert_onclick = function(obj,e)
        {
        	...
        	this.dsList2.setColumn(nrow, "NO_BID", this.dsSearch.getColumn(0, "NO_CONT"));
        };
        ...
        this.loadIncludeScript("DMA_INDIRECT_APLLY.xfdl");
