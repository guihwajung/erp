(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DT_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_REM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_REQUEST\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Div("divSearch","0","0","351","154",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("staDT_REQUEST","0","58","90","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("자금집행일자");
            ...
            obj = new Static("staDT_ACCOUNT","0","29","90","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("22");
            obj.set_text("회계일자");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staDT_ACCOUNT_bg00","staDT_REQUEST:-1","staDT_ACCOUNT:-1","262","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staDS_REM","0","staDT_ACCOUNT:28","90","30",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("31");
            obj.set_text("적요");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Calendar("tclDT_REQUEST","95","63","105","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
