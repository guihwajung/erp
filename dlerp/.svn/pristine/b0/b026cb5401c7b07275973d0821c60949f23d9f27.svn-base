(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("구매품의서(레미콘)-결재");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_CONT\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"AM_TT_SILHENG\" type=\"STRING\" size=\"256\"/><Column id=\"DS_COMMENT1\" type=\"STRING\" size=\"256\"/><Column id=\"DS_COMMENT2\" type=\"STRING\" size=\"256\"/><Column id=\"AM_ORDER\" type=\"STRING\" size=\"256\"/><Column id=\"AM_GAP\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_PRECONTRACT_RESULT_SELECT_DM_ETC</Col></Row><Row><Col id=\"SP\">DCBPR_ESTIMATION_RESULT_SELECT_DM_ETC</Col><Col id=\"TARGET\">select1</Col></Row><Row><Col id=\"SP\">DMAPR_PRECONTRACT_HADODETAIL_DX_RESULT_SELECT_ETC</Col><Col id=\"TARGET\">select2</Col></Row><Row><Col id=\"TARGET\">appr_select</Col><Col id=\"SP\">DZRPR_AP_STATE_SELECT</Col></Row><Row><Col id=\"TARGET\">aplines</Col><Col id=\"SP\">DZRPR_APPLINES_SELECT</Col></Row><Row><Col id=\"TARGET\">execAppr</Col><Col id=\"SP\">DZZPR_APPROVAL_CALLBACK</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divData01","0","divDataAppr:10","1170","117",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_text("");
            obj.set_enable("true");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("sta203","0","sta202:-1","110","59",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("2");
            obj.set_text("물량배분");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textDecoration("none");
            ...
            obj = new Static("sta213","sta203:-1","sta212:-1","280","59",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta221","776","0","389","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("6");
            obj.set_text("예산대비");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new Edit("txtNO_CONT","sta201:5","34","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("7");
            ...
            obj = new Static("sta06","388","58","110","59",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("10");
            obj.set_text("계약단가");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta07","497","58","280","59",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("txtAM_GAP","891","92","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("16");
            obj.set_format("9,999");
            obj.set_readonly("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new MaskEdit("txtAM_TT_SILHENG","891","34","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("17");
            obj.set_format("9,999");
            obj.set_readonly("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new MaskEdit("txtAM_ORDER","891","63","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("18");
            obj.set_format("9,999");
            obj.set_readonly("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Edit("txtCD_SITE","115","5","75","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("19");
            obj.set_readonly("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Static("sta00","388","29","110","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("20");
            obj.set_text("차수");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textDecoration("none");
            ...
            obj = new Static("sta01","497","29","280","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("21");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Edit("txtSN_SEQ","503","34","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("22");
            obj.set_readonly("true");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new TextArea("txtDS_COMMENT1","115","63","268","49",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("23");
            obj.set_readonly("true");
            obj.set_background("#f3f3f3");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new TextArea("txtDS_COMMENT2","503","63","268","49",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("24");
            obj.set_readonly("true");
            obj.set_enable("true");
            ...
            obj = new Edit("txtDS_SITE","193","5","577","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("25");
            obj.set_readonly("true");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new BindItem("item37","divData.form.divData01.form.txtNO_CONT","value","dsList","NO_CONT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divData.form.divData01.form.txtCD_SITE","value","dsList","CD_SITE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","divData.form.divData01.form.txtAM_GAP","value","dsList","AM_GAP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","divData.form.divData01.form.txtAM_TT_SILHENG","value","dsList","AM_TT_SILHENG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divData.form.divData01.form.txtAM_ORDER","value","dsList","AM_ORDER");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divData.form.divData01.form.txtDS_COMMENT1","value","dsList","DS_COMMENT1");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divData.form.divData01.form.txtDS_COMMENT2","value","dsList","DS_COMMENT2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divData.form.divData01.form.txtDS_SITE","value","dsList","DS_SITE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.divData01.form.txtSN_SEQ","value","dsList","SN_SEQ");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DMA_PO_DETAIL_R_APP.xfdl", function() {
        ...
        this.loadIncludeScript("DMA_PO_DETAIL_R_APP.xfdl");
