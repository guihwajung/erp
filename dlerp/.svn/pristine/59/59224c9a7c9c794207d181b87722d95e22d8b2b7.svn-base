(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLAPR_GUN_OPTION_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DLAPR_GUN_OPTION_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DLAPR_GUN_OPTION_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DLAPR_GUN_OPTION_DELETE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DRAPR_SIZEDIV_SELECT</Col></Row><Row><Col id=\"TARGET\">d_insert</Col><Col id=\"SP\">DRAPR_SIZEDIV_INFO_INSERT</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DRAPR_SIZEDIV_INFO_UPDATE</Col></Row><Row><Col id=\"TARGET\">d_delete</Col><Col id=\"SP\">DRAPR_SIZEDIV_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLA_DLGGUNOPTION.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLA_DLGGUNOPTION");
        	this.dxGrid.set_selecttype("cell");
        	this.dxGrid.addEventHandler("onselectchanged", this.fnGrid_RowCellChanged, this);

        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DL", "DLA_DLGGUNOPTION_2");
        }
        ...
        this.fnConform = function()
        {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DLA_DLG_SIZE_DIV_COPY", "", param);
        }
        ...
        this.fnAppoint = function()
        {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DLA_ASSIGN_HOUSE", "", param);
        }
        });
        ...
        this.loadIncludeScript("DLA_DLGGUNOPTION.xfdl");
