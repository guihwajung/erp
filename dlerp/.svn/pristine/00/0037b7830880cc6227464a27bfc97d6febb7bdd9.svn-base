(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("자금일보 전자결재상신");
            ...
            obj = new Dataset("dsListIlbo1", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListIlbo2", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListIlbo3", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divDataBottom","0","divDataMaster:10",null,null,"0","0",null,null,null,null,this.divData1.form);
            obj.set_taborder("0");
            this.divData1.addChild(obj.name, obj);

            obj = new Tab("tabData","0","0",null,null,"0","0",null,null,null,null,this.divData1.form.divDataBottom.form);
            obj.set_taborder("0");
            obj.set_tabindex("0");
            this.divData1.form.divDataBottom.addChild(obj.name, obj);

            obj = new Tabpage("tab1",this.divData1.form.divDataBottom.form.tabData);
            obj.set_text("계정증감현황");
            obj.set_formscrolltype("none");
            this.divData1.form.divDataBottom.form.tabData.addChild(obj.name, obj);

            obj = new Grid("objGridSub1","0","0",null,null,"0","0",null,null,null,null,this.divData1.form.divDataBottom.form.tabData.tab1.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("1");
            obj._setContents("");
            this.divData1.form.divDataBottom.form.tabData.tab1.addChild(obj.name, obj);

            obj = new Tabpage("tab2",this.divData1.form.divDataBottom.form.tabData);
            obj.set_text("예적금잔액");
            this.divData1.form.divDataBottom.form.tabData.addChild(obj.name, obj);

            obj = new Grid("objGridSub2","0","0",null,null,"0","0",null,null,null,null,this.divData1.form.divDataBottom.form.tabData.tab2.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("2");
            obj._setContents("");
            this.divData1.form.divDataBottom.form.tabData.tab2.addChild(obj.name, obj);

            obj = new Tabpage("tab3",this.divData1.form.divDataBottom.form.tabData);
            obj.set_text("입출금내역");
            this.divData1.form.divDataBottom.form.tabData.addChild(obj.name, obj);

            obj = new Grid("objGridSub3","0","0",null,null,"0","0",null,null,null,null,this.divData1.form.divDataBottom.form.tabData.tab3.form);
            obj.getSetter("sub").set("true");
            obj.set_taborder("3");
            obj._setContents("");
            this.divData1.form.divDataBottom.form.tabData.tab3.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("DFA_ILBO_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DF05";	// 자금일보
        ...
        this.fnSetVariable = function() {
        	...
        	this.dxGridSub2 = tab2form.objGridSub2;

        	// tab 3 입출금내역
        	var tab3form = this.divData1.form.divDataBottom.form.tabData.tab3.form;
        	this.dxGridSub3 = tab3form.objGridSub3;
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	this.gfnGridInit(this.dxGridSub1, this.dsListIlbo1, "DF", "DFA_ILBO_APP1");
        	this.gfnGridInit(this.dxGridSub2, this.dsListIlbo2, "DF", "DFA_ILBO_APP2");
        	this.gfnGridInit(this.dxGridSub3, this.dsListIlbo3, "DF", "DFA_ILBO_APP3");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_CORP", this.dsListMaster.getColumn(0, "V_PARAM01"));	// 법인코드
        	this.dsSelect.setColumn(0, "FR_ILBO", this.dsListMaster.getColumn(0, "V_PARAM02"));	// 일보적용시작일자
        	this.dsSelect.setColumn(0, "TO_ILBO", this.dsListMaster.getColumn(0, "V_PARAM03"));	// 일보적용종료일자

        	var nTabindex = this.tabData.tabindex;
        	var inData = "selectIlbo1=dsSelect";
        	var outData = "dsListIlbo1=selectIlbo10";
        	if(nTabindex == 0){
        		inData = "selectIlbo1=dsSelect";
        		outData = "dsListIlbo1=selectIlbo10";
        	}else if(nTabindex == 1){
        		inData = "selectIlbo2=dsSelect";
        		outData = "dsListIlbo2=selectIlbo20";
        	}else if(nTabindex == 2){
        		inData = "selectIlbo3=dsSelect";
        		outData = "dsListIlbo3=selectIlbo30";
        	}
        ...
        **************************************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg) {
        	if (svcID == "init") {
        		...
        		if (errorCode == 0) {
        			...
        			this.gfnPrintFixView(this.dxGridSub1);
        			this.gfnPrintFixView(this.dxGridSub2);
        			this.gfnPrintFixView(this.dxGridSub3);
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        ...
        this.divData1_divDataBottom_tabData_onchanged = function(obj,e)
        {
        	//결재본문 조회
        	this.fnSelect();
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData1.form.divDataBottom.form.tabData.addEventHandler("onchanged",this.divData1_divDataBottom_tabData_onchanged,this);
        };
        this.loadIncludeScript("DFA_ILBO_APP.xfdl");
