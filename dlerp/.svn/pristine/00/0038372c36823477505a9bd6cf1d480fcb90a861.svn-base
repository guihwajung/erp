(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("원가자료(SAP)조회");
            ...
            obj = new CheckBox("chkYN_EXCLUDE","chkYN_IPT:0.0","10.0","95","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("원가제외포함");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            ...
            obj = new Static("staCD_CORP00","chkYN_EXCLUDE:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("추가 라인수");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkYN_2020","txtADD_CNT:10","10","105","25",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("2020년 이전분");
            obj.set_visible("false");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWD_COSTTUJA_INPUT.xfdl", function() {
        ...
        this.fnSetVariable = function() {
           ...
           //this.chkYN_2020 = this.divSearch.form.chkYN_2020;
        ...
        this.fnSetEvent = function() {
           ...
           // 그리드 초기화
           this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWD_COSTTUJA_INPUT");
        ...
        this.fnSetParameter = function() {
        	...
        	//this.dsSelect.addColumn("YN_2020", "string");

           this.dsSave = new Dataset();
           this.dsSave.addColumn("CD_SITE", "string");
           this.dsSave.addColumn("YM_WORK", "string");
           this.dsSave.addColumn("ID_USER", "string");
           this.dsSave.addColumn("YN_IPT", "string");
        ...
        //    this.dsSave.addColumn("YN_TUJA", "string");
        //    this.dsSave.addColumn("CD_TRADE", "string");
        //    this.dsSave.addColumn("DT_ACCOUNT", "string");
        ...
        this.fnSelect = function() {
           ...
           //this.dsSelect.setColumn(0, "YN_2020", this.chkYN_2020.value == true ? "Y" : "N");
           ...
           for (var i = 0; i < this.dsList.rowcount; i++) {
              ...
              switch(flag) {
        		 ...
        		 case "D":
        			...
        			this.dsSave.setColumn(nrow, "YN_IPT", this.dsList.getColumn(i, "YN_IPT"));
        ...
        // 			this.dsSave.setColumn(nrow, "YN_TUJA", this.dsList.getColumn(i, "YN_TUJA"));
        // 			this.dsSave.setColumn(nrow, "DT_ACCOUNT", this.dsList.getColumn(i, "DT_ACCOUNT"));
                    break;
              }
           }
        ...
        this.fnGrid_EnterCell = function(obj, row, cell) {
        	...
        	if(colnm == "CD_SLIP" || colnm == "CD_SLIP" || colnm == "CD_SLIP" || colnm == "CD_AUTOSLIP" || colnm == "DS_AUTOSLIP"
        		|| colnm == "CD_DEPT_BH" || colnm == "YN_IPT"|| colnm == "DS_SYSTEM"|| colnm == "DS_SITE"|| colnm == "DS_BIMOK"){
        		return false;
        ...
        this.loadIncludeScript("DWD_COSTTUJA_INPUT.xfdl");
