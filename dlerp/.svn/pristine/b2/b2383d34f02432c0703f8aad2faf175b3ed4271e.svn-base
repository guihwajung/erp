(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_ESTIMATION_RESULT_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfNO_BID","staNO_BID:0.0","10.0","329","24.0",null,null,null,null,null,null,this.divSearch.form);
        ...
        // User Script
        this.registerScript("DCB_ESTIMATION_RESULT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCB_PRECONTRACT_APPROVE_BID");
        ...
        this.loadIncludeScript("DCB_ESTIMATION_RESULT.xfdl");
