(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DSB_MAGAM.xfdl", function() {
        ...
        this.loadIncludeScript("DSB_MAGAM.xfdl");
