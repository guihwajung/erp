(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLFPR_CANCEL_STATE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLF_CANCELSTATE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLF_CANCELSTATE");
        ...
        this.dsSearch_onvaluechanged = function(obj,e) {
         ...
         this.fnCancel = function(obj,e) {
        	...
        	if(this.gfnIsNull(this.dsList.getColumn(nRow, "NO_SIZE"))){
        	...
        	param.DT_CANCEL_B = this.dsList.getColumn(nRow, "DT_CANCEL");
        	param.DS_CONTRACTOR = this.dsList.getColumn(nRow, "DS_CONTRACTOR");
        	param.DT_PAYMENT = this.dsList.getColumn(nRow, "DT_PAYMENT");

        	// 화면 오픈.
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DLF_CANCELDETAIL", "fnCancelCallback", param);
        }
        ...
        this.loadIncludeScript("DLF_CANCELSTATE.xfdl");
