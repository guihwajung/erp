(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_RISKDTLSTREE_V2_SELECT</Col></Row><Row><Col id=\"TARGET\">selectSub</Col><Col id=\"SP\">DWAPR_RISKDTLS_V2_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWAPR_RISKDTLS_V2_SAVE</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DWAPR_RISKDTLS_V2_EXECUTE</Col></Row><Row><Col id=\"TARGET\">RiskDtlCre</Col><Col id=\"SP\">DWAPR_RISK_V2_CREATE_DTL</Col></Row></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SILHENG\" type=\"STRING\" size=\"256\"/><Column id=\"NO_RISK\" type=\"STRING\" size=\"256\"/><Column id=\"NO_HADOCONT\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQCONT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_HADOCONT","ccfNO_RISK:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("계약번호");
            ...
            obj.getSetter("CodeFindName").set("DWX_CFRISKHADO_01");
            obj.getSetter("CDTextWidth").set("90");
            obj.set_taborder("6");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            ...
            obj = new Div("divSplitter","20%","0","5","100.00%",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_background("skyblue");
            obj.set_cursor("ew-resize");
            this.divData.addChild(obj.name, obj);

            obj = new Div("divDataLeft","0","0",null,null,"divSplitter:3","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Button("btnRight","divSplitter:3","35.00%","30","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("▶");
            this.divData.addChild(obj.name, obj);

            obj = new Div("divDataRight","btnRight:3","0",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Button("btnLeft","divSplitter:3","55.00%","30","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("◀");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item3","divSearch.form.ccfNO_HADOCONT.form.CDTextBox","value","dsSearch","NO_HADOCONT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWA_RISKDTLS_V2.xfdl", function() {
        ...
        this.loadIncludeScript("DWA_RISKDTLS_V2.xfdl");
