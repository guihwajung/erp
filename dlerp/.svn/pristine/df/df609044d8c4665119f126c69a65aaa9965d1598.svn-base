(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHFPR_BS_SELECT</Col></Row><Row><Col id=\"TARGET\">dept</Col><Col id=\"SP\">DHXPR_BALANCE_ACNTUNIT_CODEFIND</Col></Row><Row><Col id=\"TARGET\">selectYmMagam</Col><Col id=\"SP\">DHXPR_ACNTUNIT</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DHFPR_BS_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT </Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkYN_ZERO","ctclYM_MAGAM:20","10.0","60","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("0 제외");
            obj.set_truevalue("Y");
            ...
            obj = new Static("staCD_SYSTEM00_00","1242","10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("출력구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_PRINT","1332","10","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            ...
            obj = new BindItem("item6","divSearch.form.chkYN_ZERO","value","dsSearch","YN_ZERO");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHF_BS.xfdl", function() {
        ...
        // 	tmpText    += " ~ ";
        	tmpText    += ymWorkE.substr(0,4) + "년 " + ymWorkE.substr(4,2) + "월 " + ymWorkE.substr(6,2) + "일 현재";
        	//trace(" tmpText=>" +this.dsList.getColumn(0,"GI1") );
        ...
        this.loadIncludeScript("DHF_BS.xfdl");
