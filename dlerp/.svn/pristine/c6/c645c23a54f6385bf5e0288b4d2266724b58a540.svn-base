(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("장기자금계획 전자결재(초기화)");
        ...
        // User Script
        this.registerScript("DFA_DLG_APPRL_DELETE.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("DFA_DLG_APPRL_DELETE.xfdl");
