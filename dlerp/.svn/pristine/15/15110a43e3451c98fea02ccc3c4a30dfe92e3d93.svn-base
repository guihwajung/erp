(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAV_INSUSUBST");
            this.set_titletext("보험료공제");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAVPR_INSUSUBST_SELECT</Col></Row><Row><Col id=\"SP\">DAVPR_CLOSE_CHECK2</Col><Col id=\"TARGET\">closeCheck</Col></Row><Row><Col id=\"SP\">DAVPR_INSUSUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DAVPR_INSUSUBST_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAVPR_INSUSUBST_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAV_INSUSUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAV_INSUSUBST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("AM_SUBST1", "bigdecimal");
        	this.dsInsert.addColumn("AM_SUBST2", "bigdecimal");
        	this.dsInsert.addColumn("AM_SUBST3", "bigdecimal");
        	this.dsInsert.addColumn("AM_SUBST4", "bigdecimal");
        	...
        	this.dsDelete.addColumn("NO_APPLY", "bigdecimal");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "AM_SUBST1", this.dsList.getColumn(i, "AM_SUBST1"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST2", this.dsList.getColumn(i, "AM_SUBST2"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST3", this.dsList.getColumn(i, "AM_SUBST3"));
        				this.dsInsert.setColumn(nrow, "AM_SUBST4", this.dsList.getColumn(i, "AM_SUBST4"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "AM_SUBST1", this.dsList.getColumn(i, "AM_SUBST1"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST2", this.dsList.getColumn(i, "AM_SUBST2"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST3", this.dsList.getColumn(i, "AM_SUBST3"));
        				this.dsUpdate.setColumn(nrow, "AM_SUBST4", this.dsList.getColumn(i, "AM_SUBST4"));
        ...
        this.loadIncludeScript("DAV_INSUSUBST.xfdl");
