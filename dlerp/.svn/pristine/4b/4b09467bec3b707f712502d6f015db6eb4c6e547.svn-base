(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_WBS_SELECT</Col></Row><Row><Col id=\"SP\">DWAPR_SILHENGEXCEL_SAVE</Col><Col id=\"TARGET\">save</Col></Row><Row><Col id=\"SP\">DWAPR_SILHENGEXCEL_INSERTERROR</Col><Col id=\"TARGET\">save0</Col></Row><Row><Col id=\"TARGET\">save1</Col><Col id=\"SP\">DWAPR_SILHENGEXCEL_INSERTCHANGE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SILHENG\" type=\"STRING\" size=\"256\"/><Column id=\"CD_COST\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"NO_SILHENG\"/></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWA_FROMIEMS.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btn1 = this.gfnFormButtonAdd("btnExcel", "fnExcelLoad");
        	this.btn2 = this.gfnFormButtonAdd("btnApply", "fnApply");
        };
        ...
        {
        	if(e.col == 9 || e.col == 21){
        		this.dsList.setColumn(e.row, "AM_DESIGN", Math.trunc(this.dsList.getColumn(e.row, "QN_DESIGN") * this.dsList.getColumn(e.row, "UP_DESIGN")));
        	}else if(e.col == 0 || e.col == 29){
        		this.dsList.setColumn(e.row, "AM_TT_DOKUB", Math.trunc(this.dsList.getColumn(e.row, "QN_TT_DOKUB") * this.dsList.getColumn(e.row, "UP_TT_DOKUB")));
        	}else if(e.col == 34 || e.col == 19){
        		this.dsList.setColumn(e.row, "AM_EXSILHENG", Math.trunc(this.dsList.getColumn(e.row, "QN_EXSILHENG") * this.dsList.getColumn(e.row, "UP_EXSILHENG")));
        	}else if(e.col == 13 || e.col == 15){
        		this.dsList.setColumn(e.row, "AM_TT_SILHENG", Math.trunc(this.dsList.getColumn(e.row, "QN_TT_SILHENG") * this.dsList.getColumn(e.row, "UP_TT_SILHENG")));
        	}
        };
        ...
        this.loadIncludeScript("DWA_FROMIEMS.xfdl");
