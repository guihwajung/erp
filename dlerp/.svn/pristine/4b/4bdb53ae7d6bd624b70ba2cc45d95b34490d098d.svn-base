(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("가등록평가(외주-결재)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_LIST_DC_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_LIST_DC_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_LIST_DC_DELETE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo1</Col><Col id=\"SP\">DCXPR_LICCOST_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">comboDam</Col><Col id=\"SP\">DCXPR_DAM_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">regist</Col><Col id=\"SP\">DCAPR_JUDGE_REGIST_TEMP_RESULT_UPDATE</Col></Row><Row><Col id=\"TARGET\">auto</Col><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_AUTO_JUDGE_DC</Col></Row><Row><Col id=\"TARGET\">appr_select</Col><Col id=\"SP\">DZRPR_AP_STATE_SELECT</Col></Row><Row><Col id=\"TARGET\">aplines</Col><Col id=\"SP\">DZRPR_APPLINES_SELECT</Col></Row><Row><Col id=\"TARGET\">execAppr</Col><Col id=\"SP\">DZZPR_APPROVAL_CALLBACK</Col></Row><Row><Col id=\"SP\">DZRPR_AP_STATE_SELECT</Col><Col id=\"TARGET\">appr_select_sap</Col></Row><Row><Col id=\"SP\">DCAPR_REGIST_TEMP_REQ_SAPVENDORCODE_UPDATE</Col><Col id=\"TARGET\">appr_sap_update</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"NO_SJC\" type=\"STRING\" size=\"256\"/><Column id=\"YR_REQ\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LICCOST\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DAM\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BUMUN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"YN_LINK\" type=\"STRING\" size=\"256\"/><Column id=\"ID_AP\" type=\"STRING\" size=\"256\"/><Column id=\"TY_MODULE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TY_SELECT\">미심사</Col><Col id=\"CD_LICCOST\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_CODE\">전체</Col><Col id=\"CD_CODE\">0</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCA_REGIST_TEMP_APP.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCAPR_REGIST_TEMP_REQ_DC_LIST");
        ...
        this.fnInsertDLG = function() {
           ...
           this.gfnFormOpenNonAuth("DCA", "DCA_REGIST_TEMP_REQ_DC_DLG", "fnInsertDLG_callback", param, "570", "380");
        ...
        this.fnSetCombo = function()
        {
        	...
        	var outData     = "dsCD_BUMUN=combo0 dsTY_GUBUN=combo1";
        	var strArg      = "";
        ...
        this.fnSetComboDam  = function()
        {
        	...
        	//담당자
        	this.dsCombo.addRow();
        	this.dsCombo.setColumn(0, "CD_BUMUN", "");

        	var strSvcId    = "comboDam";
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "comboDam=dsCombo";
        	var outData     = "dsCD_DAM=comboDam0";
        	var strArg      = "";
        	var callBackFnc = "fnCallbackCombo";
        ...
        // 결제상신
         this.fnAprvSang = function(obj,e) {
        	...
        	param.ID_AP_TYPE = "DC08";
        	param.V_PARAM01 = this.dsSearch.getColumn(0, "NO_SJC");
        	param.V_PARAM02 = this.dsSearch.getColumn(0,"TY_MODULE");
        	param.V_PARAM03 = "";
        	param.V_PARAM04 = "";
        	param.DS_TITLE =  "외주업체 가등록 품의서";
        ...
        this.loadIncludeScript("DCA_REGIST_TEMP_APP.xfdl");
