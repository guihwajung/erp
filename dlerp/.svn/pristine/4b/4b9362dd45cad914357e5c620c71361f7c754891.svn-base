(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cboTY_STATUS","staTY_STATUS:0","10.0","124","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("DAJ_RTNG_RSLT_PSNL_STATUS.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsListStatus, "DA", "DAJ_RTNG_RSLT_PSNL_STATUS");
        	...
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DA", "DAJ_RTNG_PSNL");
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if (id == "ccfCD_CORP") {
        		...
        		dsUserParam.setColumn(nrow, "ID_SCREEN"   , "DAJ_RTNG_RSLT_PSNL_STATUS");
        ...
        this.fnAfterCDTextChanged = function(id, codeFindData) {
        	...
        	if (id == "ccfID_RTNG") {
        		...
        		if (codeFindData[0]["CD_RTNG_TYPE"] == "JA13") {
        			...
        			this.dxGrid.setCellProperty("head", 6, "text", "보직자\n1차평가 前");
        			this.dxGrid.setCellProperty("head", 7, "text", "보직자\n1차평가 中");
        			this.dxGrid.setCellProperty("head", 8, "text", "보직자\n1차평가 完");
        ...
        this.loadIncludeScript("DAJ_RTNG_RSLT_PSNL_STATUS.xfdl");
