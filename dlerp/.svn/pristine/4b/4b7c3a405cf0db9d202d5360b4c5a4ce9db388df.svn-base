(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DYAPR_SILJUK_MONTH_EIS_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_FLAG00","469","4","91","20",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("(단위 : 백만원)");
        ...
        // User Script
        this.registerScript("DYA_SILJUK_MONTH_EIS1.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DY", "DYA_SILJUK_MONTH_EIS1");
        ...
        this.fnColor = function()
        {
        	...
        	this.gfnGridColumnColor(this.dxGrid, "GUBUN4", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "AM_BEFORE_SIL_SUM", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "AM_PLAN_SUM", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "RT_RATE", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "AM_PLAN", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "AM_SILJUK", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "AM_GAP", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "AM_PLAN_NU", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "AM_SILJUK_NU", "BACK,Green", "GUBUN4 == '(%)'");
        	this.gfnGridColumnColor(this.dxGrid, "AM_GAP_NU", "BACK,Green", "GUBUN4 == '(%)'");

        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Line", "GUBUN4 == '수주'", true);
        	...
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Line", "GUBUN4 == '수금'", true);
        	this.dxGrid.set_enableredraw(true);
        }
        this.divData_objGrid_oncelldblclick = function(obj,e)
        {
        	if (this.dsList.getColumn(this.dsList.rowposition, "GUBUN4")=='영업외수익' )
        	{
        		if (this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_PLAN" || this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_SILJUK" || this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_GAP")
        		{
        			var param = {};
        			param.CD_DEPT_ACNT = "";
        			param.DS_DEPT_ACNT = "";
        		...
        		if (this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_PLAN_NU" || this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_SILJUK_NU" || this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_GAP_NU")
        		{
        			var param = {};
        			param.CD_DEPT_ACNT = "";
        			param.DS_DEPT_ACNT = "";
        	...
        	if (this.dsList.getColumn(this.dsList.rowposition, "GUBUN4")=='영업외비용' )
        	{
        		if (this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_PLAN" || this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_SILJUK" || this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_GAP")
        		{
        			var param = {};
        	...
        	if (this.dsList.getColumn(this.dsList.rowposition, "NO_ORDER1")=='A0'||this.dsList.getColumn(this.dsList.rowposition, "NO_ORDER1")=='A1' )
        	{
        		if (this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_PLAN" || this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_SILJUK" || this.gfnGridGetBindColumnNameByIndex(obj, e.cell) == "AM_GAP")
        		{
        			...
        			param.DS_SAUP = this.dsList.getColumn(this.dsList.rowposition, "GUBUN4");
        ...
        this.loadIncludeScript("DYA_SILJUK_MONTH_EIS1.xfdl");
