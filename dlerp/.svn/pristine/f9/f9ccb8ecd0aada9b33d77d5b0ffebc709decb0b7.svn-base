(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">selectleft</Col><Col id=\"SP\">DRBPR_LOAN_SELECT</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRBPR_LOANAPPLY_SELECT</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRBPR_LOANAPPLY_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRBPR_LOANAPPLY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRBPR_LOANAPPLY_DELETE</Col></Row><Row><Col id=\"TARGET\">insert1</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_INSERT</Col></Row><Row><Col id=\"TARGET\">update1</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete1</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_DELETE</Col></Row><Row><Col id=\"TARGET\">insert2</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_INSERT</Col></Row><Row><Col id=\"TARGET\">update2</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete2</Col><Col id=\"SP\">DRBPR_LOANINTERESTPAY_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_BUNYANG","ccfCD_ACNTUNIT:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("동층호");
            ...
            obj = new Div("divDataTop","0","0",null,null,"0","650",null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("1");
            obj.set_text("");
            ...
            obj = new Div("divDataBottom","0","44",null,null,"0","0",null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("0");
            this.divData.form.divDataRight.addChild(obj.name, obj);
            ...
            obj = new Grid("objGrid1","5","5",null,null,"5","5",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.tabData.tab1.form);
            obj.set_taborder("1");
            obj._setContents("");
        ...
        // User Script
        this.registerScript("DRB_LOANSTATE.xfdl", function() {
        ...
        this.loadIncludeScript("DRB_LOANSTATE.xfdl");
