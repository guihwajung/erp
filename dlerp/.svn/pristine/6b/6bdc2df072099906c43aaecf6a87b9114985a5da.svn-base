(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new CheckBox("chkUNUSE","809","426","86","24",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("93");
            obj.set_text("장기미사용");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new CheckBox("chkREST","809","456","72","24",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("94");
            obj.set_text("휴먼계좌");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new BindItem("item56","divData.form.divDataRight.form.chkUNUSE","value","dsList","YN_UNUSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item57","divData.form.divDataRight.form.chkREST","value","dsList","YN_REST");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.fnSetVariable = function() {
        	...
        	this.chkUNUSE = this.divData.form.divDataRight.form.chkUNUSE;		   // 장기미사용 	2025.04.15 추가
        	this.chkREST = this.divData.form.divDataRight.form.chkREST;			   // 휴먼계좌 	2025.04.15 추가
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("YN_UNUSE", "string"); // 장기미사용계좌 추가  2025.04.15
        	this.dsInsert.addColumn("YN_REST", "string");  //  휴먼계좌 추가  2025.04.15
        	...
        	this.dsUpdate.addColumn("YN_UNUSE", "string"); // 장기미사용계좌 추가  2025.04.15
        	this.dsUpdate.addColumn("YN_REST", "string");  //  휴먼계좌 추가  2025.04.15
        ...
        // 	this.sTY_GUBUN = "";
        	...
        	this.dsList.setColumn(nRow, "YN_UNUSE", "N");									// 장기미사용
        	this.dsList.setColumn(nRow, "YN_REST", "N");									// 휴먼
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "YN_UNUSE", this.gfnNvl(this.dsList.getColumn(i, "YN_UNUSE"),"N"));
        				this.dsInsert.setColumn(nrow, "YN_REST", this.gfnNvl(this.dsList.getColumn(i, "YN_REST"),"N"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "YN_UNUSE", this.gfnNvl(this.dsList.getColumn(i, "YN_UNUSE"),"N"));
        				this.dsUpdate.setColumn(nrow, "YN_REST", this.gfnNvl(this.dsList.getColumn(i, "YN_REST"),"N"));
