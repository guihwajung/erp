(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHZPR_ACBIMOK_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHZPR_ACBIMOK_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHZPR_ACBIMOK_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DHZPR_ACBIMOK_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHZ_ACBIMOK.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHZ_ACBIMOK");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsDelete.addColumn("CD_BIMOK", "string");
         	this.dsDelete.addColumn("ACNT_YN", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "ACNT_YN", "N");
        				break;
        		}
        	}
        ...
        this.loadIncludeScript("DHZ_ACBIMOK.xfdl");
