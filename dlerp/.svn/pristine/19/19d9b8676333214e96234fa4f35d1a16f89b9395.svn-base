(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new ImageViewer("imgPicSign","imgPicAfter:20","430","360","340",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_stretch("fixaspectratio");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnPicSignDown","440","790","130","21",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("사진4다운로드");
            obj.getSetter("uWord").set("popup.cancel");
            this.addChild(obj.name, obj);

            obj = new Button("btnClose","580","790","130","21",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("닫기");
            obj.getSetter("uWord").set("popup.cancel");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("12");
            obj.set_text("사진2다운로드");
            obj.getSetter("uWord").set("popup.ok");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",800,850,this,function(p){});
        ...
        // User Script
        this.registerScript("DBB_CASEPIC.xfdl", function() {
        ...
        */
        	...
        	if (svcID == "select") {
        		...
        		if (errorCode == 0) {
        			for( var i =0; i < this.dsImageFile.rowcount; i++) {
        				...
        				if( this.dsImageFile.getColumn(i,"filepath")==this.filepath + "AFTER/" + this.getOwnerFrame().CD_SITE + "/" + this.getOwnerFrame().CD_JOB && this.dsList.getColumn(0, "PIC_AFTERNM") == this.dsImageFile.getColumn(i,"filename") && !this.gfnIsNull( this.dsImageFile.getColumn(i,"filereturn") )){
        					this.imgPicAfter.set_image(this.dsImageFile.getColumn(i, "filereturn"));
        				}

        				if( this.dsImageFile.getColumn(i,"filepath")==this.filepath + "SIGN/" + this.getOwnerFrame().CD_SITE + "/" + this.getOwnerFrame().CD_JOB && this.dsList.getColumn(0, "PIC_SIGNNM") == this.dsImageFile.getColumn(i,"filename") && !this.gfnIsNull( this.dsImageFile.getColumn(i,"filereturn") )){
        					this.imgPicSign.set_image(this.dsImageFile.getColumn(i, "filereturn"));
        				}
        			}
        		}
        		else {
        ...
        this.loadIncludeScript("DBB_CASEPIC.xfdl");
