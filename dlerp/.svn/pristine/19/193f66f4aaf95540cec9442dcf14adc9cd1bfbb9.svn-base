(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TY_AUTOSLIP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_TRADE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_AUTOSLIP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SLIP_MI\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT_ACNT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_PROOF\" type=\"STRING\" size=\"256\"/><Column id=\"DT_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"AM_CR\" type=\"INT\" size=\"256\"/><Column id=\"AM_DR\" type=\"INT\" size=\"256\"/><Column id=\"DS_REM\" type=\"STRING\" size=\"256\"/><Column id=\"NO_REF\" type=\"STRING\" size=\"256\"/><Column id=\"DT_REF1\" type=\"STRING\" size=\"256\"/><Column id=\"DS_ETC\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SLIP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_REF1\" type=\"STRING\" size=\"256\"/><Column id=\"ISSUE_ID\" type=\"STRING\" size=\"256\"/><Column id=\"TY_ISSUE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT_BE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT_BE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divDataJundo","0","divDataMaster:10",null,"490","0",null,null,null,null,null,this.divData1.form);
            obj.set_taborder("2");
            obj.set_text("");
            this.divData1.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","0",null,"490","0",null,null,null,null,null,this.divData1.form.divDataJundo.form);
            obj.set_taborder("3");
            obj._setContents("");
            this.divData1.form.divDataJundo.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("DHA_JUNDOREQ_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DH03";	// 결재유형등록 (DZR_AP_TYPES)
        ...
        this.fnSetVariable = function() {
        	...
        	this.dxGrid = this.divData1.form.divDataJundo.form.objGrid;
        };
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	this.gfnGridInit(this.dxGrid, this.dsList, "DH", "DHA_JUNDOREQ_APP");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_CORP", this.dsListMaster.getColumn(0, "V_PARAM01"));
        	this.dsSelect.setColumn(0, "CD_DEPT_BH", this.dsListMaster.getColumn(0, "V_PARAM02"));
        	this.dsSelect.setColumn(0, "YM_ACCOUNT", this.dsListMaster.getColumn(0, "V_PARAM03"));
        ...
        **************************************************************************************************/
        ...
        this.loadIncludeScript("DHA_JUNDOREQ_APP.xfdl");
