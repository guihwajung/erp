(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRCPR_TRADEDETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRCPR_TRADEDETAIL_UPDATE</Col></Row><Row><Col id=\"TARGET\">sunapTrans</Col><Col id=\"SP\">DRCPR_INCOME_Batch</Col></Row><Row><Col id=\"TARGET\">transCancel</Col><Col id=\"SP\">DRCPR_INCOME_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRC_TRADEDETAIL.xfdl", function() {
        ...
        this.loadIncludeScript("DRC_TRADEDETAIL.xfdl");
