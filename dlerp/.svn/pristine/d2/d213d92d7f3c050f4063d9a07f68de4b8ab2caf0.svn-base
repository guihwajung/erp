    ...
    return function()
    {
        ...
        this.fnGridExpandUp = function(obj, e) {
        	...
        	if (colnm == "CNT_FILE") {
        		...
        		fileManager.IS_READONLY = this.dsList.getColumn(e.row, "BTN_APRV") == "N" ? true : false;
        ...
        this.fnGridEnterCell = function(obj, row, cell) {
        	...
        	if (this.dsList.getColumn(row, "BTN_APRV") == "N") {
        		if(colnm == "CNT_FILE") return true;
        	} else {

        		if(this.dsGridSpec.getColumn(cell, "YN_READONLY") != "Y"){
        			return true;
        		}
        	}
        	return false;
