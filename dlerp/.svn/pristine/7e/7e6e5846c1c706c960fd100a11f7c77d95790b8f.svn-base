(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_FNDREQDPLNTBAGG_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWDPR_FNDREQDPLNTBAGG_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWD_FNDREQDPLNTBAGG.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWD_FNDREQDPLNTBAGG");

        	this.dxGrid.EnterCell = "fnGrid_EnterCell";

        	// 집계표 그리드 총계row 글자 bold 처리
        	var colAM_PRGS = this.dxGrid.getBindCellIndex("body", "AM_PRGS");
        	...
        	this.dxGrid.setCellProperty("summ", colAM_PRGS, "font", "bold 9pt Dotum");
        	...
        	// 집계표 그리드에 bold 처리
        	this.gfnGridColumnColor(this.dxGrid, "AM_PRGS", "bold", "YN_BOLD == 'Y'");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "AM_UNIT", "1");

        	var strSvcId    = "select";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
        	var inData      = "select=dsSelect";
        	var outData     = "dsList=select0 dsDS_SUMDESCRIPTION=select1";
        	var strArg      = "";
        ...
        this.dsList_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue)
        	{
        		...
        		{
        			var am_noteoco = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_NOTEOCO"),0);
        			var am_cashothco = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_CASHOTHCO"),0);

        			this.dsList.setColumn(e.row, "AM_SUMOCO", nexacro.toNumber(e.newvalue,0) + am_noteoco);
        			this.dsList.setColumn(e.row, "AM_CASHTOT", nexacro.toNumber(e.newvalue,0) + am_cashothco);
        		}
        		// 당사분>어음
        		else if(e.columnid == "AM_NOTEOCO")
        		{
        			var am_cashoco = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_CASHOCO"),0);
        			var am_noteothco = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_NOTEOTHCO"),0);

        			this.dsList.setColumn(e.row, "AM_SUMOCO", nexacro.toNumber(e.newvalue,0) + am_cashoco);
        			this.dsList.setColumn(e.row, "AM_NOTETOT", nexacro.toNumber(e.newvalue,0) + am_noteothco);
        		}
        		// 타사분>현금
        		else if(e.columnid == "AM_CASHOTHCO")
        		{
        			var am_cashoco = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_CASHOCO"),0);
        			this.dsList.setColumn(e.row, "AM_CASHTOT", nexacro.toNumber(e.newvalue,0) + am_cashoco);
        		}
        		// 타사분>어음
        		else if(e.columnid == "AM_NOTEOTHCO")
        		{
        			var am_noteoco = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_NOTEOCO"),0);
        			this.dsList.setColumn(e.row, "AM_NOTETOT", nexacro.toNumber(e.newvalue,0) + am_noteoco);
        		}
        		// 전체>현금
        		else if(e.columnid == "AM_CASHTOT")
        		{
        			var am_notetot = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_NOTETOT"),0);
        			this.dsList.setColumn(e.row, "AM_SUMTOT", nexacro.toNumber(e.newvalue,0) + am_notetot);

        		}
        		// 전체>어음
        		else if(e.columnid == "AM_NOTETOT")
        		{
        			var am_cashtot = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_CASHTOT"),0);
        			this.dsList.setColumn(e.row, "AM_SUMTOT", nexacro.toNumber(e.newvalue,0) + am_cashtot);
        ...
        this.loadIncludeScript("DWD_FNDREQDPLNTBAGG.xfdl");
