(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAAPR_ORGTREE_SELECT_NEW</Col></Row><Row><Col id=\"TARGET\">select2nd</Col><Col id=\"SP\">DAAPR_ORGANLIST_SELECT_NEW</Col></Row><Row><Col id=\"SP\">DAAPR_BASEINFO_CARD_PRINT</Col><Col id=\"TARGET\">reportCard</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DT_SNAPSHOT\" type=\"STRING\" size=\"256\"/><Column id=\"YN_UPDEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DT_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YN_UPDEPT\">Y</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_WORK","285","10","110","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("기준일자");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_WORK","378","10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Div("divTemp","0","-25",null,null,"0","0",null,null,null,null,this.divData.form.divDataRightTop.form.divDataRight.form);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new BindItem("item3","divSearch.form.ctclDT_WORK","value","dsSearch","DT_WORK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAA_ORGANSYSTEM_NEW.xfdl", function() {
        ...
        this.loadIncludeScript("DAA_ORGANSYSTEM_NEW.xfdl");
