(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBTPR_COMMON_KINDSTATE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GBN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"DS_SITE\"/><Col id=\"DT_FROM\"/><Col id=\"DT_TO\"/><Col id=\"TY_GBN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_GBN","0.0","staCD_SITE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("진행구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboTY_GBN","staTY_GBN:0.0","staCD_SITE:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
        ...
        // User Script
        this.registerScript("DBT_COMMON_KINDSTATE.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnWorkBtn1 = this.gfnFormButtonAdd("WorkBtn1", "fnWorkBtn1");  // 상세보기
        };
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBT_COMMON_KINDSTATE");
        ...
        *	상세보기
        */
        this.detaleView = function() {

        	if(!this.gfnGridIsRow(this.dxGrid)) return;

        	var param = {};
        	param.KEY_CD_SITE     = this.dsList.getColumn(this.dsList.rowposition, "CD_SITE");
        	param.KEY_DS_SITE     = this.dsList.getColumn(this.dsList.rowposition, "DS_SITE");
        	param.KEY_DT_FRJOEBSU = this.dsList.getColumn(this.dsList.rowposition, "DS_FROM");
        	param.KEY_DT_TOJOEBSU = this.dsList.getColumn(this.dsList.rowposition, "DS_TO");

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DBT_COMMON_KINDSTATEDETAIL", "", param);
        }
        ...
        this.loadIncludeScript("DBT_COMMON_KINDSTATE.xfdl");
