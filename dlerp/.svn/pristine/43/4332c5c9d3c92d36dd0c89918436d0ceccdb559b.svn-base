(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_ICODE_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRFPR_ICODE_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRFPR_ICODE_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRFPR_ICODE_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_ACNTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LCODE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_RCODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_ACNTUNIT\"/><Col id=\"CD_LCODE\"/><Col id=\"CD_RCODE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("ctxtCD_LCODE","staCD_CORP00:0.0","10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_value("");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtDS_LCODE","ctxtCD_LCODE:0.0","10.0","160","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_value("");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_CORP","ctxtDS_LCODE:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("사업지코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_CORP01","ctxtDS_LCODE:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("실코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtCD_RCODE","staCD_CORP01:0.0","10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_value("");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("ctxtDS_RCODE","ctxtCD_RCODE:0.0","10.0","160","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_value("");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divSearch.form.ctxtCD_LCODE","value","dsSearch","CD_LCODE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.ctxtCD_RCODE","value","dsSearch","CD_RCODE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DRF_ITEM_CODE.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_ACNTUNIT) && !this.gfnIsNull(this.getOwnerFrame().CD_LCODE) && !this.gfnIsNull(this.getOwnerFrame().CD_RCODE)) {
        		...
        		this.divSearch.form.ctxtDS_LCODE.set_value(this.getOwnerFrame().DS_LCODE);
        		this.dsSearch.setColumn(0, "CD_RCODE", this.getOwnerFrame().CD_RCODE);
        		this.divSearch.form.ctxtDS_RCODE.set_value(this.getOwnerFrame().DS_RCODE);
        ...
        this.fnSetVariable = function() {
        	...
        	this.ctxtCD_LCODE = this.divSearch.form.ctxtCD_LCODE;
        	this.ctxtCD_RCODE = this.divSearch.form.ctxtCD_RCODE;
        	this.ctxtDS_ACNTUNIT = this.divSearch.form.ctxtDS_ACNTUNIT;
        	this.ctxtDS_LCODE = this.divSearch.form.ctxtDS_LCODE;
        	this.ctxtDS_RCODE = this.divSearch.form.ctxtDS_RCODE;
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DS_ICODE", "string");
        	...
        	this.dsUpdate.addColumn("DS_ICODE", "string");
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRF_ITEM_CODE");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_ICODE", "");
        ...
        this.fnSave = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		if(this.dsList.getColumn(i, "CD_ICODE").length != 2){
        			this.gfnAlert("품목코드는 반드시 두자리로 입력하셔야 합니다.");
        			return;
        		}
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DS_ICODE", this.dsList.getColumn(i, "DS_ICODE"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "DS_ICODE", this.dsList.getColumn(i, "DS_ICODE"));
        ...
        this.dsSearch_onvaluechanged = function(obj,e) {
         ...
         this.fnColorCd = function(obj,e) {
            ...
            param.CD_LCODE = this.dsSearch.getColumn(0, "CD_LCODE");
        	param.DS_LCODE = this.ctxtDS_LCODE.value;
        	param.CD_RCODE = this.dsSearch.getColumn(0, "CD_RCODE");
        	param.DS_RCODE = this.ctxtDS_RCODE.value;
        	param.CD_ICODE = this.dsList.getColumn(this.dsList.rowposition, "CD_ICODE");
        	param.DS_ICODE = this.dsList.getColumn(this.dsList.rowposition, "DS_ICODE");

        	// 화면 오픈.
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRF_COLOR_CODE", "fnColorCdCallback", param);
        }


        this.fnColorCdCallback =  function(svcID, val) {
        	this.FormBtns.Select.click();
        };
        });
        ...
        this.loadIncludeScript("DRF_ITEM_CODE.xfdl");
