(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFBPR_ACCOUNT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFBPR_ACCOUNT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFBPR_ACCOUNT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFBPR_ACCOUNT_DELETE</Col></Row><Row><Col id=\"TARGET\">accountValidate</Col><Col id=\"SP\">DFBPR_ACCOUNT_GW_START</Col></Row><Row><Col id=\"SP\">DFBPR_ACCOUNT_APPR</Col><Col id=\"TARGET\">accountappr</Col></Row><Row><Col id=\"TARGET\">aprv_execute</Col><Col id=\"SP\">DFBPR_ACCOUNT_APRV_EXECUTE</Col></Row><Row><Col id=\"SP\">DFBPR_ACCOUNT_CMS_CALLBACK</Col><Col id=\"TARGET\">accountCms</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_OWNER\" type=\"STRING\" size=\"256\"/><Column id=\"NO_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"YN_HAEJI\" type=\"STRING\" size=\"256\"/><Column id=\"YN_CHECK\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DAEPYO\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SJC\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00","ccfCorpCd:0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("거래처코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfDeptCode","sta00:0.0","10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("0");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta01","ccfDeptCode:0.0","10.0","92","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("계좌번호");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("sta02","txtNO_ACCOUNT:0.0","10.0","92","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboYN_TERM","sta02:0.0","10.0","70","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new BindItem("item0","divSearch.form.ccfDeptCode.form.CDTextBox","value","dsSearch","CD_OWNER");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item2","this.divSearch.form.cboYN_TERM","value","dsSearch","YN_HAEJI");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFB_ACCOUNT.xfdl", function() {
        ...
        this.fnAccountValidate  = function(obj,e) {
        	if(!this.gfnGridIsRow(this.dxGrid)) return;
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.cboYN_TERM.addEventHandler("onitemchanged",this.fnSearchInit,this);
        };
        this.loadIncludeScript("DFB_ACCOUNT.xfdl");
