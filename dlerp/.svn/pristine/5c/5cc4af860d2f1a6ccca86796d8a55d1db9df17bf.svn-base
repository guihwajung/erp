(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DIQPR_BUDGET_PROSPECT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DIQPR_BUDGET_PROSPECT_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DIQPR_BUDGET_PROSPECT_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DIQPR_BUDGET_PROSPECT_DELETE</Col></Row><Row><Col id=\"TARGET\">select_excel</Col><Col id=\"SP\">DIQPR_BUDGET_PROSPECT_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DIQPR_BUDGET_PROSPECT_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DIQ_BUDGET_PROSPECT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DI", "DIQ_BUDGET_PROSPECT");
        ...
        this.fnExcelImportCallback = function(sImportId, dsOut, dsSheet) {
        	...
        	for (var i=1; i< dsOut.rowcount; i++) {
        		...
        		this.dsList.setColumn(nrow, "AM_PROSPECT", dsOut.getColumnNF(i, "Column7"));
        		this.dsList.setColumn(nrow, "AM_01", dsOut.getColumnNF(i, "Column8"));
        		this.dsList.setColumn(nrow, "AM_02", dsOut.getColumnNF(i, "Column9"));
        		this.dsList.setColumn(nrow, "AM_03", dsOut.getColumnNF(i, "Column10"));
        		this.dsList.setColumn(nrow, "AM_04", dsOut.getColumnNF(i, "Column11"));
        		this.dsList.setColumn(nrow, "AM_05", dsOut.getColumnNF(i, "Column12"));
        		this.dsList.setColumn(nrow, "AM_06", dsOut.getColumnNF(i, "Column13"));
        		this.dsList.setColumn(nrow, "AM_07", dsOut.getColumnNF(i, "Column14"));
        		this.dsList.setColumn(nrow, "AM_08", dsOut.getColumnNF(i, "Column15"));
        		this.dsList.setColumn(nrow, "AM_09", dsOut.getColumnNF(i, "Column16"));
        		this.dsList.setColumn(nrow, "AM_10", dsOut.getColumnNF(i, "Column17"));
        		this.dsList.setColumn(nrow, "AM_11", dsOut.getColumnNF(i, "Column18"));
        		this.dsList.setColumn(nrow, "AM_12", dsOut.getColumnNF(i, "Column19"));
        ...
        this.loadIncludeScript("DIQ_BUDGET_PROSPECT.xfdl");
