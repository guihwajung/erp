(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_SITEBUDGET_SELECT</Col></Row><Row><Col id=\"SP\">DWAPR_SITEBUDGET_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"SP\">DWAPR_SITEBUDGET_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DWAPR_SITEBUDGET_DELETE</Col><Col id=\"TARGET\">delete</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DWAPR_SITEBUDGET_BC_INSERT</Col></Row><Row><Col id=\"TARGET\">execPart</Col><Col id=\"SP\">DWAPR_SITEBUDGET_XTRANS_INSERT</Col></Row><Row><Col id=\"TARGET\">execPartCnc</Col><Col id=\"SP\">DWAPR_SITEBUDGET_XTRANS_DELETE</Col></Row><Row><Col id=\"TARGET\">execB</Col><Col id=\"SP\">DWAPR_SITEBUDGET_BC_INSERT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWA_EXSILHENG.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnA = this.gfnFormButtonAdd("btnA", "fnA");
        	this.btnB = this.gfnFormButtonAdd("btnB", "fnB");
        	this.btnPart = this.gfnFormButtonAdd("btnPart", "fnPart");
        	this.btnPartCancel = this.gfnFormButtonAdd("btnPartCancel", "fnPartCancel");
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWA_EXSILHENG");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("TY_SILHENG", "string");
        	...
        	this.dsExec.addColumn("TY_SILHENG", "string");
        	this.dsExec.addColumn("ID_USER", "string");

        	this.dsExecB = new Dataset();
        	this.dsExecB.addColumn("CD_SITE", "string");
        	this.dsExecB.addColumn("NO_SILHENG", "string");
        	this.dsExecB.addColumn("TY_SILHENG", "string");
        	this.dsExecB.addColumn("ID_USER", "string");

        	this.dsExecPart = new Dataset();
        	this.dsExecPart.addColumn("CD_SITE", "string");
        	this.dsExecPart.addColumn("NO_SILHENG", "string");
        	this.dsExecPart.addColumn("ID_USER", "string");

        	this.dsExecPartCnc = new Dataset();
        	this.dsExecPartCnc.addColumn("CD_SITE", "string");
        	this.dsExecPartCnc.addColumn("ID_USER", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "TY_GUBUN", "A");
        				break;
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "TY_SILHENG", this.dsList.getColumn(i, "TY_SILHENG"));
        				...
        				this.dsUpdate.setColumn(nrow, "TY_GUBUN", "A");
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "TY_GUBUN", "A");
        				break;
        		}
        	}
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "select") {
        		...
        		if (errorCode == 0) {
        // 			this.fnAprc_callback = function()
        // 			{
        // 				this.FormBtns.Select.click();
        // 			}
        // 			var dsConst = this.dsList.getColumn(this.dsList.rowposition, "DS_CONST");
        // 			this.gfnAlert(dsConst + " 부문 현장예산 변경차수 등록 정상 처리되었습니다.", "fnAprc_callback");
        			this.FormBtns.Select.click();
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        	else if(svcID == "execPart") {
        		if (errorCode == 0) {
        			this.fnPartPrc_callback = function()
        			{
        				this.FormBtns.Select.click();
        			}
        			this.gfnAlert("현장예산 공종분할 정상 처리되었습니다.", "fnPartPrc_callback");
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        	else if(svcID == "execPartCnc") {
        		if (errorCode == 0) {
        			this.fnPartCnc_callback = function()
        			{
        				this.FormBtns.Select.click();
        			}
        			this.gfnAlert("현장예산 공종분할 취소 정상 처리되었습니다.", "fnPartCnc_callback");
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        ...
        this.fnAPP = function(obj,e) {
        	...
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DWA_EXSILHENG_APP", "fnAprvDialogCallback", param);
         ...
         // 변경차수등록 버튼 클릭 이벤트
         this.fnA = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }

        	var dsConst = this.dsList.getColumn(this.dsList.rowposition, "DS_CONST");

        	this.gfnConfirm("변경차수를 등록하시겠습니까?", "fnA_callback");

        }

        // 변경차수등록 버튼 클릭 후 callback
        this.fnA_callback = function(strId, val)
        {
        	if(val == true) {
        		...
        		this.dsExec.setColumn(0, "NO_SILHENG", this.dsList.getColumn(this.dsList.rowposition, "NO_SILHENG"));
        		this.dsExec.setColumn(0, "TY_SILHENG", "A");
         ...
         this.fnB = function(obj,e) {
        	...
        	this.gfnConfirm("본실행 등록하시겠습니까?", "fnB_callback");
        }

        // 본실행등록 버튼 클릭 후 callback
        this.fnB_callback = function(strId, val)
        {
        	if(val == true) {
        		this.dsExecB.clearData();

        		this.dsExecB.addRow();

        		this.dsExecB.setColumn(0, "CD_SITE", this.dsSearch.getColumn(0, "CD_SITE"));
        		this.dsExecB.setColumn(0, "NO_SILHENG", this.dsList.getColumn(this.dsList.rowposition, "NO_SILHENG"));
        		this.dsExecB.setColumn(0, "TY_SILHENG", "B");
        		this.dsExecB.setColumn(0, "ID_USER", this.AuthClient.ID_USER);

        		if (this.dsExecB.rowcount == 0) return;

        		var strSvcId    = "execB";
        		var strSvcType  = "save";
        		var inProc		= "_dsProc";
        		var inData      = "execB=dsExecB";
        		var outData     = "";
        		var strArg      = "";
        		var callBackFnc = "fnCallback";
        ...
        // 	}
        	...
        	param.V2 = this.dsList.getColumn(this.dsList.rowposition, "NO_SILHENG");
        	param.V3 = "";
        	param.V4 = "";
        	param.ID_AP = this.dsList.getColumn(this.dsList.rowposition, "NO_ELAPDOC"); //결재번호
        	param.DS_ETITLE = "실행예산품의";
        	param.YN_LINK = "N";
        	trace("ID_AP>>>" + param.ID_AP);

        	this.gfnFormOpen("DWA", "DWA_SILHENG_APPROVAL", "fnAprvDialogCallback", param, 1200, 700);
        }
         ...
         // btnPart
         this.fnPart = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }

        	this.gfnConfirm("현장예산 공종을 분할합니다. 계속하시겠습니까?", "fnPart_callback");

        }

        // btnPart 버튼 클릭 후 callback
        this.fnPart_callback = function(strId, val)
        {
        	if(val == true) {
        		this.dsExecPart.clearData();

        		this.dsExecPart.addRow();

        		this.dsExecPart.setColumn(0, "CD_SITE", this.dsSearch.getColumn(0, "CD_SITE"));
        		this.dsExecPart.setColumn(0, "NO_SILHENG", this.dsList.getColumn(this.dsList.rowposition, "NO_SILHENG"));
        		this.dsExecPart.setColumn(0, "ID_USER", this.AuthClient.ID_USER);

        		if (this.dsExecPart.rowcount == 0) return;

        		var strSvcId    = "execPart";
        		var strSvcType  = "save";
        		var inProc		= "_dsProc";
        		var inData      = "execPart=dsExecPart";
        		var outData     = "";
        		var strArg      = "";
        		var callBackFnc = "fnCallback";
         ...
         // btnPartCancel
         this.fnPartCancel = function(obj,e) {
        	if (this.dsList.rowcount < 1) { return false; }

        	this.gfnConfirm("현장예산 공종분할을 취소하시겠습니까?", "fnPartCancel_callback");

        }

        // btnPartCancel 버튼 클릭 후 callback
        this.fnPartCancel_callback = function(strId, val)
        {
        	if(val == true) {
        		this.dsExecPartCnc.clearData();

        		this.dsExecPartCnc.addRow();

        		this.dsExecPartCnc.setColumn(0, "CD_SITE", this.dsSearch.getColumn(0, "CD_SITE"));
        		this.dsExecPartCnc.setColumn(0, "ID_USER", this.AuthClient.ID_USER);

        		if (this.dsExecPartCnc.rowcount == 0) return;

        		var strSvcId    = "execPartCnc";
        		var strSvcType  = "save";
        		var inProc		= "_dsProc";
        		var inData      = "execPartCnc=dsExecPartCnc";
        		var outData     = "";
        		var strArg      = "";
        		var callBackFnc = "fnCallback";
        ...
        */
        ...
        this.loadIncludeScript("DWA_EXSILHENG.xfdl");
