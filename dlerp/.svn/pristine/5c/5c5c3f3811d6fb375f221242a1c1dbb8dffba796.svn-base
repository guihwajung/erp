(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_SILHENGTOHADO_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWAPR_SILHENGTOHADOUI_SAVE_BONSA</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DWAPR_SILHENGTOHADO_EXECUTE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkYN_TOP","ccfNO_HADOCONT:0.0","10.0","50","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("상하");
            obj.set_value("true");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWA_SILHENGTOHADO_BONSA.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DWA_SILHENGTOHADO_BONSA.xfdl");
