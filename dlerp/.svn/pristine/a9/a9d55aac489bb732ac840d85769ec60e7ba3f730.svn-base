(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCZPR_PUNISH_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCZPR_PUNISH_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCZPR_PUNISH_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsList", this);
            obj._setContents("<ColumnInfo><Column id=\"NO_VENDOR_SAP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_REQUEST\" type=\"STRING\" size=\"256\"/><Column id=\"DT_PUNISH\" type=\"STRING\" size=\"256\"/><Column id=\"YN_RELEASE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_RELEASE\" type=\"STRING\" size=\"256\"/><Column id=\"RM_RELEASE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_REQUEST\" type=\"STRING\" size=\"256\"/><Column id=\"FR_PUNISH\" type=\"STRING\" size=\"256\"/><Column id=\"TO_PUNISH\" type=\"STRING\" size=\"256\"/><Column id=\"FN_PUNISH\" type=\"STRING\" size=\"256\"/><Column id=\"DS_PUNISH\" type=\"STRING\" size=\"256\"/><Column id=\"RM_REMARK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"NO_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Div("divData","0","0","400",null,null,"0",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Calendar("ctclDT_PUNISH","staDT_PUNISH:7","171","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            ...
            obj = new TextArea("ctxtDS_PUNISH","staDS_PUNISH:7","231",null,"49","7",null,null,null,null,null,this.divData.form);
            obj.set_readonly("true");
            obj.set_taborder("12");
            obj.set_value("");
            obj.set_enable("false");
            ...
            obj = new Edit("edtNO_VENDOR_SAP","staNO_VENDOR_SAP:7","113",null,"20","7",null,null,null,null,null,this.divData.form);
            obj.set_taborder("24");
            obj.set_autoselect("true");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Edit("edtCD_VENDOR00","staCD_VENDOR00:7","55",null,"20","7",null,null,null,null,null,this.divData.form);
            obj.set_taborder("27");
            obj.set_autoselect("true");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("edtCD_REQUEST","staCD_REQUEST:7","142",null,"20","179",null,null,null,null,null,this.divData.form);
            obj.set_readonly("true");
            obj.set_taborder("29");
            obj.set_autoselect("true");
            obj.set_enable("false");
            ...
            obj = new Edit("edtCD_VENDOR","staCD_VENDOR:7","84",null,"20","180",null,null,null,null,null,this.divData.form);
            obj.set_taborder("30");
            obj.set_readonly("true");
            obj.set_autoselect("true");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclFR_PUNISH","staFR_PUNISH01:7","202","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("34");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Edit("edtRM_REMARK","staRM_REMARK:7","290",null,"50","6",null,null,null,null,null,this.divData.form);
            obj.set_taborder("38");
            obj.set_readonly("true");
            obj.set_autoselect("true");
            obj.set_enable("false");
            ...
            obj = new Button("btnSave","32.50%","500","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_text("저장");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancel","52.50%","500","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_text("취소");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item0","divData.form.edtCD_VENDOR00","value","dsSearch","NO_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divData.form.edtCD_VENDOR","value","dsSearch","CD_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divData.form.edtDS_VENDOR","value","dsSearch","DS_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCA_PUNISH_DLG_RELEASE.xfdl", function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "NO_ID", this.dsSearch.getColumn(0, "NO_ID"));
        				this.dsUpdate.setColumn(nrow, "YN_RELEASE", this.dsList.getColumn(i, "YN_RELEASE"));
        				this.dsUpdate.setColumn(nrow, "DT_RELEASE", this.dsList.getColumn(i, "DT_RELEASE"));
        				this.dsUpdate.setColumn(nrow, "RM_RELEASE", this.dsList.getColumn(i, "RM_RELEASE"));
        				this.dsUpdate.setColumn(nrow, "ID_RELEASE", this.dsList.getColumn(i, "ID_RELEASE"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "ID_RELEASE", this.dsList.getColumn(i, "ID_RELEASE"));
        ...
        */
        ...
        this.divData_btnSave_onclick = function(obj,e)
        {
        	...
        	this.dsUpdate.setColumn(nrow, "RM_RELEASE", this.divData.form.ctxtRM_RELEASE.value);
        	this.dsUpdate.setColumn(nrow, "ID_RELEASE", this.dsList.getColumn(0, "ID_RELEASE"));

        	if(this.divData.form.chk00.isChecked()) {
        		this.dsUpdate.setColumn(0, "YN_RELEASE", "Y");
        	}else{
        		this.dsUpdate.setColumn(0, "YN_RELEASE", "N");
        	}
        	var strSvcId    = "save";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        ...
        this.loadIncludeScript("DCA_PUNISH_DLG_RELEASE.xfdl");
