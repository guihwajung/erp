(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_SELECT</Col></Row><Row><Col id=\"TARGET\">magam</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_MAGAM</Col></Row><Row><Col id=\"TARGET\">year</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_YEAR_MAX_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_BONSA.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	if(this.FormInfo.DS_PARAM == "DM") {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_BONSA_DM2");
        	} else {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_BONSA");
        	}
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsMagam.addColumn("YN_SUBMIT", "string");
        ...
        this.fnMagam_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		...
        		this.dsMagam.setColumn(nrow, "YN_SUBMIT", strID);
        ...
        this.fnDetail = function()
        {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCD_EVALUEMAGAM_BONSA_DC_DETAIL", "fnDetail_callback", param, 1000, 600);
        }
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_BONSA.xfdl");
