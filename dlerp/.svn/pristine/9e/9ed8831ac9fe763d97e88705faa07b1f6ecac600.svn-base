(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOZPR_CONST_PRICE_DEMAND_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DOZPR_CONST_PRICE_DEMAND_SAVE</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DOZPR_CONST_PRICE_DEMAND_EXECUTE</Col></Row><Row><Col id=\"TARGET\">sapauto</Col><Col id=\"SP\">DWZPR_SAP_AUTOSLIP_ISSUE_SELECT</Col></Row><Row><Col id=\"SP\">DWZPR_SAP_AUTOSLIP_CANCEL_SELECT</Col><Col id=\"TARGET\">sapcancel</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_CONTRCT\" type=\"STRING\" size=\"256\"/><Column id=\"NO_POLY_CONST_CONTRCT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_ORD_FIRM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"NO_CONTRCT\"/><Col id=\"NO_POLY_CONST_CONTRCT\"/><Col id=\"DS_DEPT\"/><Col id=\"CD_ORD_FIRM\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDS_DEPT","txtNO_POLY_CONST_CONTRCT:0.0","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_readonly("true");
            obj.set_enable("false");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_ORD_FIRM","staCD_CORP:0.0","10.0","300","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("5");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divSearch.form.ccfCD_SITE.form.DSTextBox","value","dsSearch","NO_CONTRCT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.txtNO_POLY_CONST_CONTRCT","value","dsSearch","NO_POLY_CONST_CONTRCT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWU_CONSTDEMAND.xfdl", function() {
        ...
        // 그리드 cell 변경시 이벤트 발생(차수 컬럼 2자리로 셋팅하기 위함)
        this.fnGrid_Oncellposchanged = function(obj,e)
        {
        ...
        this.loadIncludeScript("DWU_CONSTDEMAND.xfdl");
