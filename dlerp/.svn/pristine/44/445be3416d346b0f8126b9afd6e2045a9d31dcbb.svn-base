(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_COST_PAY_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBS_COST_PAY.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBS_COST_PAY");  // pForm.gfnGridInit = function(objGrid, objDs, cd_system, id_grid, tree_column, level_column, is_manual)
        	var nCol = this.dxGrid.getBindCellIndex("body","ROW_NUM");
        ...
        this.fnPopupCallBack = function(svcID, value) {
        	...
        	if( !this.gfnIsNull(value) ){
        		...
        		var inData      = "select=dsSelect";
        		var reportpath  = "/db/dbs/DBS_COST_PAY.ozr";
        ...
        this.loadIncludeScript("DBS_COST_PAY.xfdl");
