(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWZPR_PRITEM_APP_DETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DWZPR_PRITEM_APP_DETAIL_UPDATE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DCBPR_JOINBID_SITE_SELECT</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DCBPR_JOINBID_SITE_UPDATE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DCBPR_PREORDERPLAN_APPROVE_GW1_UPDATE</Col></Row><Row><Col id=\"TARGET\">update_attend</Col><Col id=\"SP\">DCBPR_SITE_EXPLAIN_ATTEND_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCBPR_ORDERPLAN_SITE_DM_DELETE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DCBPR_PREORDERPLAN_APPROVE_GW1_UPDATE</Col></Row><Row><Col id=\"TARGET\">select_d</Col><Col id=\"SP\">DWZPR_PRITEM_DX_SELECT</Col></Row><Row><Col id=\"TARGET\">update_d</Col><Col id=\"SP\">DWZPR_PRITEM_DX_UPDATE</Col></Row><Row><Col id=\"TARGET\">insert_po</Col><Col id=\"SP\">DCBPR_PRTOPO_INSERT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWZ_PRITEM_APP_DETAIL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DC", "DWZ_PRITEM_APP_GRID");
        ...
        this.dsList1_onvaluechanged = function(obj,e)
        {
        	if(e.columnid == "AM_TT_HADO"){
        		...
        		this.dsList1.set_enableevent(false);
        		this.dsList1.setColumn(e.row, "AM_TT_HADO", (nexacro.toNumber(this.dsList1.getColumn(e.row, "QN_TT_HADO"),0) * nexacro.toNumber(this.dsList1.getColumn(e.row, "UP_TT_HADO"),0)).toFixed(0));
        		this.dsList1.set_enableevent(true);
        	}
        };
        ...
        this.loadIncludeScript("DWZ_PRITEM_APP_DETAIL.xfdl");
