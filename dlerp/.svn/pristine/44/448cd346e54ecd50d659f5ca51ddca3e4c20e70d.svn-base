(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("완성임대주택명세서조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_LA_APTDETAIL3_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHA_DEPRECIATION_SELECT5.xfdl", function() {
        ...
        this.loadIncludeScript("DHA_DEPRECIATION_SELECT5.xfdl");
