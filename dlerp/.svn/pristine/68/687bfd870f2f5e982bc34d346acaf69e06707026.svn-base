(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DAA_ORDERTEMP.xfdl", function() {
        ...
        this.loadIncludeScript("DAA_ORDERTEMP.xfdl");
