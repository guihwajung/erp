(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DRF_ITEM.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRF_ITEM");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "NO_COLOR", "0");
        ...
        this.dsList_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue)
        	{
        		if(e.columnid == "AM_SUPPLY") {	// 공급가
        			var am_vat = nexacro.toNumber(this.dsList.getColumn(e.row, "AM_SUPPLY"),0) / 10;
        			this.dsList.setColumn(e.row, "AM_VAT", am_vat);

        			this.fnSumTotal(e.row);
        ...
        this.fnSumTotal = function(nRow){
        	var am_supply = nexacro.toNumber(this.dsList.getColumn(nRow, "AM_SUPPLY"),0);
        	var am_vat = nexacro.toNumber(this.dsList.getColumn(nRow, "AM_VAT"),0);
        	this.dsList.setColumn(nRow, "TOTAL", am_supply + am_vat);
        }
        ...
        this.loadIncludeScript("DRF_ITEM.xfdl");
