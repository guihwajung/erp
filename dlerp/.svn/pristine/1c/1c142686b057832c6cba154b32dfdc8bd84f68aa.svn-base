(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(500,900);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_BEFOREWORKENDPIC_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DBSPR_IPSUASPIC_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsList", this);
            obj._setContents("<ColumnInfo><Column id=\"PIC_BEFORENM\" type=\"STRING\" size=\"256\"/><Column id=\"PIC_BEFORENM2\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_JOB\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new ImageViewer("imgPicAfter1","13","110",null,null,"20","480",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_stretch("fixaspectratio");
            this.addChild(obj.name, obj);

            obj = new Button("btnUpload","380","65","90","29",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("업로드");
            obj.getSetter("uWord").set("popup.cancel");
            this.addChild(obj.name, obj);

            obj = new ImageViewer("imgPicAfter2","13","478",null,null,"20","113",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_stretch("fixaspectratio");
            this.addChild(obj.name, obj);

            obj = new Button("btnUpload2","380","440","90","28",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("업로드");
            obj.getSetter("uWord").set("popup.cancel");
            this.addChild(obj.name, obj);

            obj = new Static("image1","23","69","130","24",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("점검전 사진1");
            this.addChild(obj.name, obj);

            obj = new Static("image2","23","444","130","24",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("점검전 사진2");
            this.addChild(obj.name, obj);

            obj = new Static("sta00","13","10","140","58",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("접수번호 :");
            obj.set_font("normal 700 20pt/normal \"Arial\"");
            this.addChild(obj.name, obj);

            obj = new TextArea("CD_JOB","153","23","127","35",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_enable("false");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            obj.set_border("3px none");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item0","CD_JOB","value","dsSearch","CD_JOB");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DBS_BEFORE_UPPIC.xfdl", function() {
        /************************************************************************************************
         * FORM 변수 선언 영역
         ***********************************************************************************************/
        ...
        * FORM EVENT 영역(onload)
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	var link = document.location.href;							//현재 URL 도메인주소
        	var cdSite = link.substr((link.lastIndexOf('CD_SITE') + 8), 6); //CD_SITE
        	var cdJob = link.substr(link.lastIndexOf('CD_JOB') + 7);	//CD_JOB
        	trace("cdSite>>>" + cdSite);
        	trace("cdJob>>>" + cdJob);
        ...
        //  	this.dsSearch.setColumn(0, "CD_JOB", this.getOwnerFrame().CD_JOB);
        	...
        	this.dsSearch.setColumn(0, "CD_SITE", cdSite);
         	this.dsSearch.setColumn(0, "CD_JOB", cdJob);
        ...
        */
        ...
        this.loadIncludeScript("DBS_BEFORE_UPPIC.xfdl");
