(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_JUNDO_REQLIST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHAPR_JUNDO_REQLIST_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHAPR_JUNDO_REQLIST_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DHAPR_JUNDO_REQLIST_DELETE</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DHAPR_JUNDO_REQLIST_AUTOSLIP_ISSUE</Col></Row><Row><Col id=\"TARGET\">cancel</Col><Col id=\"SP\">DHAPR_JUNDO_REQLIST_AUTOSLIP_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"YM_REQ\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CORP\"/><Col id=\"CD_DEPT\"/><Col id=\"YM_REQ\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsJundoReqList", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYM_REQ","ccfDEPT:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("청구년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYM_REQ","staYM_REQ:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new BindItem("item1","divSearch.form.ccfCORP.form.DSTextBox","value","dsSearch","DS_CORP");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item3","divSearch.form.ctclYM_REQ.form.TextBox","value","dsSearch","YM_REQ");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHA_JUNDOREQLIST.xfdl", function() {
        ...
        // 전표금 현황표
        this.fnJundoReq = function (obj,e){
        	var param = {};
        ...
        this.on_initEvent = function()
        {
            ...
            this.dsJundoReqList.addEventHandler("oncolumnchanged",this.dsList_oncolumnchanged,this);
        };
        this.loadIncludeScript("DHA_JUNDOREQLIST.xfdl");
