(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMBPR_ASSET_OUT_OUT_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DMBPR_ASSET_OUT_OUT_SAVE</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DMBPR_ASSET_OUT_OUT_APPROVE</Col></Row><Row><Col id=\"TARGET\">appChk</Col><Col id=\"SP\">DCBPR_APP_DM12_CHK</Col></Row><Row><Col id=\"TARGET\">appSelect</Col><Col id=\"SP\">DCBPR_APP_DM12_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_ACT_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_ACT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"TY_OUT\" type=\"STRING\" size=\"256\"/><Column id=\"TY_APPROVAL\" type=\"STRING\" size=\"256\"/><Column id=\"TY_STATUS\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"DT_ACT_FR\"/><Col id=\"DT_ACT_TO\"/><Col id=\"TY_OUT\"/><Col id=\"TY_APPROVAL\"/><Col id=\"TY_STATUS\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            divSearch_form_ccboTY_ACT_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\"/><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">02</Col><Col id=\"datacolumn\">전용</Col></Row><Row><Col id=\"codecolumn\">03</Col><Col id=\"datacolumn\">폐기</Col></Row></Rows>");
            ...
            obj = new BindItem("item3","divSearch.form.ccboTY_ACT","value","dsSearch","TY_OUT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DMB_ASSET_OUT_OUT.xfdl","lib::libCommon.xjs");
        this.registerScript("DMB_ASSET_OUT_OUT.xfdl", function() {
        ...
        // 전표조회 버튼 클릭
        this.fnSlipSearch2 = function(obj, e) {
        ...
        this.loadIncludeScript("DMB_ASSET_OUT_OUT.xfdl");
