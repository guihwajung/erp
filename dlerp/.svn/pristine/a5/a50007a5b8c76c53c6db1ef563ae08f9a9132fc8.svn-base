(function()
{
    return function()
    {
        ...
        {
            this.set_name("DBT_KINDSTATESITEHADO");
            this.set_titletext("협력업체별-공종");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBTPR_KINDSTATESITEHADO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBT_KINDSTATESITEHADO.xfdl", function() {
        ...
        this.loadIncludeScript("DBT_KINDSTATESITEHADO.xfdl");
