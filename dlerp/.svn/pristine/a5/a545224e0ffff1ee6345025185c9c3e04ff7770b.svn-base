(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("하도공종하자담보기간관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCZPR_LICCOSTDISP_FLAW_TERM_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCZPR_LICCOSTDISP_FLAW_TERM_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_COSTCLASS\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_COSTCLASS\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCostClass","sta00:0.0","10.0","300","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new BindItem("item0","divSearch.form.ccfCostClass.form.CDTextBox","value","dsSearch","CD_COSTCLASS");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCZ__LICCOSTDISP_FLAW_TERM.xfdl", function() {
        ...
        this.loadIncludeScript("DCZ__LICCOSTDISP_FLAW_TERM.xfdl");
