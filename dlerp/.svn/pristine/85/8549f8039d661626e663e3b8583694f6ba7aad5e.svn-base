(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_MAGAM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWD_ZPSR9350.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DW", "DWD_ZPSR9350");
        };
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0, "CD_SITE"))) {
        		...
        		this.gfnAlert("마감일자을 입력하세요.", "fnVaidateCallback");
        	}
        	return validate;
        };
        ...
        this.fnCalcPrice = function()
        {
        	if(this.dsList1.rowcount > 0)
        	{
        		...
        		{
        			var temp = this.dsList1.getColumn(i, "NAME1");
        			this.dsList1.setColumn(i, "JMIBUL", (nexacro.toNumber(this.dsList1.getColumn(i, "JMIBUL"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "DMIBUL_KUM", (nexacro.toNumber(this.dsList1.getColumn(i, "DMIBUL_KUM"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "DMIBUL_VAT", (nexacro.toNumber(this.dsList1.getColumn(i, "DMIBUL_VAT"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "DMIBUL",(nexacro.toNumber(this.dsList1.getColumn(i, "DMIBUL"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "DWRBTR", (nexacro.toNumber(this.dsList1.getColumn(i, "DWRBTR"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "TMIBUL", (nexacro.toNumber(this.dsList1.getColumn(i, "TMIBUL"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "BILL", (nexacro.toNumber(this.dsList1.getColumn(i, "BILL"),0) * 100).toFixed(0));
        			this.dsList1.setColumn(i, "CASH", (nexacro.toNumber(this.dsList1.getColumn(i, "CASH"),0) * 100).toFixed(0));
        		}
        ...
        this.loadIncludeScript("DWD_ZPSR9350.xfdl");
