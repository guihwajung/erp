(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"TY_OUT\" type=\"STRING\" size=\"256\"/><Column id=\"TY_JIBUL\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsTY_JIBUL", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_REGIST","ctclDT_TO:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("출력구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_OUT","staTY_REGIST:0.0","10.0","140","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            ...
            obj = new Static("staTY_REGIST00","ccboTY_OUT:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("지불구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_JIBUL","staTY_REGIST00:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_innerdataset("dsTY_JIBUL");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item4","divSearch.form.ccboTY_JIBUL","value","dsSearch","TY_JIBUL");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWD_ZPSR1010.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DW", "DWD_ZPSR1010");
        };
        ...
        this.fnSelect = function() {
        	...
        	ds_value.push(this.dsSearch.getColumn(0, "TY_JIBUL"));
        ...
        this.fnPrint = function() {
        	...
        	if(this.dsFunc.rowcount > 0 && this.dsInParam.rowcount > 0) {
        		...
        		var inData      = "select=dsSelectSap";
        		var reportpath  = "/dw/dwd/DWD_ZPSR1010.ozr";

        		this.dsReportParam = new Dataset();
        		this.dsReportParam.addColumn("DS_TITLE", "string");
        		this.dsReportParam.addColumn("DS_SITE", "string");
        		this.dsReportParam.addColumn("DT_MAGAM", "string");
        		this.dsReportParam.addColumn("TY_GUBUN", "string");

        		this.dsReportParam.addRow();
        		this.dsReportParam.setColumn(0, "DS_TITLE", "세금계산서집계표(" + this.ccboTY_JIBUL.text + ")");
        		this.dsReportParam.setColumn(0, "DS_SITE", this.ccfCD_SITE.form.DSTextBox.value);
        		this.dsReportParam.setColumn(0, "DT_MAGAM", this.ctclDT_FROM.text + " ~ " + this.ctclDT_TO.text);
        		this.dsReportParam.setColumn(0, "TY_GUBUN", this.ccboTY_OUT.text);
        		...
        		gfnOpenReport(this, reportpath, inProc, inParam, inData, true);
        	}
        }
        ...
        this.fnSelectValidate = function() {
        	...
        	else if (this.gfnIsNull(this.ccboTY_JIBUL.value)) {
        		validate = false;
        		// Alert후 실행할 처리
        		this.fnVaidateCallback = function() {
        			this.ccboTY_JIBUL.setFocus();
        		}
        		this.gfnAlert("지불구분을 입력하세요.", "fnVaidateCallback");
        	}
        	return validate;
        };
        ...
        this.fnSetCombo = function() {
        	...
        	var outData     = "dsTY_OUT=combo0 dsTY_JIBUL=combo1";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.loadIncludeScript("DWD_ZPSR1010.xfdl");
