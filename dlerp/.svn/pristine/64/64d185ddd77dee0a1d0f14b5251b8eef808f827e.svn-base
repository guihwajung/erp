(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHVPR_EMPBUSINESSTAX_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DHVPR_EMPBUSINESSTAX_TOTAL_SELECT</Col></Row><Row><Col id=\"SP\">DHVPR_EMPBUSINESSTAX_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DHVPR_EMPBUSINESSTAX_WRITE</Col></Row><Row><Col id=\"TARGET\">dataCalc</Col><Col id=\"SP\">DHVPR_EMPBUSINESSTAX_CALC</Col></Row><Row><Col id=\"TARGET\">export</Col><Col id=\"SP\">DHVPR_EMPBUSINESSTAX_SINGO</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_DEPT\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsExportA", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsExportB", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYM_WORK","ccfCD_DEPT:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("회계년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkYN_TAX","ctclDT_WORK:0.0","10.0","98","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("과세현장조회");
            ...
            obj = new CheckBox("chkYN_HIDE","chkYN_TAX:0.0","10.0","98","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("요약보기");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new Grid("grdExport","468","40","326","154",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("DHV_EMPBUSINESSTAX.xfdl", function() {
        ...
        //계산 처리
        this.fnDataCalc = function (obj,e)
        {
        	if (this.gfnIsNull(this.gfnTrim(this.ccfCD_CORP.form.CDTextBox.value))) {
        		this.gfnAlert("법인코드는 필수입니다.");
        		this.ccfCD_CORP.form.CDTextBox.setFocus();
        ...
        this.divSearch_chkYN_HIDE_onchanged = function(obj,e)
        {
        	this.fnSetGridColSize((e.postvalue == "Y"? 0 : 120));
        };

        this.fnDataExport = function (obj,e){
        	if (!this.fnSelectValidate()) return false;
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.chkYN_HIDE.addEventHandler("onchanged",this.divSearch_chkYN_HIDE_onchanged,this);
            this.divData.form.tabData.addEventHandler("canchange",this.divData_tabData_canchange,this);
        };
        this.loadIncludeScript("DHV_EMPBUSINESSTAX.xfdl");
