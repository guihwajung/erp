(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZZPR_BID_MAIL_LIST_SELECT</Col></Row><Row><Col id=\"SP\">DZZPR_BID_MAIL_MESSAGEBODY_SELECT</Col><Col id=\"TARGET\">select</Col></Row><Row><Col id=\"TARGET\">send</Col><Col id=\"SP\">DZZPR_BID_MAIL_SEND</Col></Row></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"NO_BID\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new WebBrowser("webMESSAGE_BODY","10","cboTY_GUBUN:5",null,"601","10",null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancel",null,"webMESSAGE_BODY:10","81","22","10",null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("취소");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnSend",null,"webMESSAGE_BODY:10","80","22","btnCancel:5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("발송");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DCB_BID_MAIL_SENDER.xfdl", function() {
        ...
        this.loadIncludeScript("DCB_BID_MAIL_SENDER.xfdl");
