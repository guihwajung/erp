(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"NM_TITLE\" type=\"STRING\" size=\"256\"/><Column id=\"RM_CONTENT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"DT_UPDATE\" type=\"STRING\" size=\"256\"/><Column id=\"YN_POPUP\" type=\"INT\" size=\"256\"/><Column id=\"DT_START\" type=\"DATETIME\" size=\"256\"/><Column id=\"DT_END\" type=\"DATETIME\" size=\"256\"/><Column id=\"NO_LEFT\" type=\"INT\" size=\"256\"/><Column id=\"NO_TOP\" type=\"INT\" size=\"256\"/><Column id=\"NO_WIDTH\" type=\"INT\" size=\"256\"/><Column id=\"NO_HEIGHT\" type=\"INT\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_VENDOR\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"NO_LEFT\">100</Col><Col id=\"NO_TOP\">100</Col><Col id=\"NO_HEIGHT\">400</Col><Col id=\"NO_WIDTH\">500</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDS_GONGJI00","0","staDS_GONGJI:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("18");
            obj.set_text("공지구분");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("right");
            ...
            obj = new Static("staBg0_00","staDS_GONGJI00:-1","69",null,"30","0.00%",null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            ...
            obj = new Static("staDS_POPUP","0","staDS_GONGJI00:-1","87","60",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_text("팝업");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("right");
            ...
            obj = new Static("staDS_CONTENT","0","staDS_POPUP:-1","87","271",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("내용");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("right");
            ...
            obj = new Static("staBg1","staDS_POPUP:-1","98",null,"60","0.00%",null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staBg2","staDS_CONTENT:-1","staBg1:-1",null,"271","0.00%",null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkYN_POPUP","95","103","70","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("메인팝업");
            this.divData.addChild(obj.name, obj);

            obj = new Div("divYN_POPUP","chkYN_POPUP:5","staBg0_00:0",null,"54","2",null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("");
            ...
            obj = new TextArea("edtDS_CONTENT","staDS_CONTENT:5","staBg1:5",null,"259","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            ...
            obj = new Radio("rdoTY_VENDOR","staDS_GONGJI00:10","edtDS_GONGJI:8","227","22",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            obj.set_columncount("2");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var divData_form_rdoTY_VENDOR_innerdataset = new nexacro.NormalDataset("divData_form_rdoTY_VENDOR_innerdataset", obj);
            divData_form_rdoTY_VENDOR_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"datacolumn\">전체공지</Col><Col id=\"codecolumn\">N</Col></Row><Row><Col id=\"codecolumn\">Y</Col><Col id=\"datacolumn\">업체지정공지</Col></Row></Rows>");
            obj.set_innerdataset(divData_form_rdoTY_VENDOR_innerdataset);
            obj.set_text("");
            obj.set_value("Y");
            obj.set_index("-1");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item9","divData.form.rdoTY_VENDOR","value","dsList","TY_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DZU_GONGJI_VENDOR.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().SN_SEQ)) {
        		...
        		this.fnAdd();
        		this.divData.form.rdoTY_VENDOR.set_index(0);
        ...
        this.fnSetExtendButton = function() {
        	 ...
        	 this.btn2 = this.gfnFormButtonAdd("btnVendorList", "fnVendorList");
        ...
        */
        this.fnSave = function() {
        	...
        	if(this.dsList.rowcount > 0) {
        		...
        		if(this.gfnGetFormStatus(this) == "I") {
        			...
        			this.dsInsert.setColumn(nrow, "TY_VENDOR", this.dsList.getColumn(0, "TY_VENDOR"));
        			...
        			this.dsUpdate.setColumn(nrow, "TY_VENDOR", this.dsList.getColumn(0, "TY_VENDOR"));
        ...
        //협력업체 밴더 리스트
        this.fnVendorList = function(obj,e) {

        	if( this.dsList.getColumn(0, "TY_VENDOR") != "Y")  {
        		this.gfnAlert("공지구분이 업체지정일때만 업체지정이 가능합니다.");
        		return;
        	}

        	var param = {};
        	param.SN_SEQ = this.dsList.getColumn(this.dsList.rowposition, "SN_SEQ");	//작성일
        	param.NM_TITLE = this.dsList.getColumn(this.dsList.rowposition, "NM_TITLE");	//작성일

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DZU_GONGJI_VENDOR_LIST", "fnVendorListCallBack",  param, 1280, 730);
        };

        this.fnVendorListCallBack = function(){
        ...
        this.loadIncludeScript("DZU_GONGJI_VENDOR.xfdl");
