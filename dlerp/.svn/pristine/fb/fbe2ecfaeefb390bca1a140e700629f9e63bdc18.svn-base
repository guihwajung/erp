(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUERESULT_HSE_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DCDPR_EVALUERESULT_HSE_SAVE</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DCDPR_EVALUERESULT_HSE_CREATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCDPR_EVALUERESULT_HSE_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DMD_EVALUERESULT_HSE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMD_EVALUERESULT_HSE");
        };
        ...
        */
        ...
        this.loadIncludeScript("DMD_EVALUERESULT_HSE.xfdl");
