(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_CONTRACTOR_SELECT</Col></Row><Row><Col id=\"SP\">DRFPR_ITEMCONTRACT_SELECT</Col><Col id=\"TARGET\">selectEtc</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DRFPR_RECEIVED_SELECT_DT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DRFPR_APPROPRIATE_SELECT</Col></Row><Row><Col id=\"TARGET\">select3</Col><Col id=\"SP\">DRFPR_CANCELHISTORY_SELECT</Col></Row><Row><Col id=\"TARGET\">select4</Col><Col id=\"SP\">DRFPR_IND_RTDELAY_SELECT</Col></Row><Row><Col id=\"TARGET\">insert4</Col><Col id=\"SP\">DRFPR_IND_RTDELAY_INSERT</Col></Row><Row><Col id=\"TARGET\">update4</Col><Col id=\"SP\">DRFPR_IND_RTDELAY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete4</Col><Col id=\"SP\">DRFPR_IND_RTDELAY_DELETE</Col></Row><Row><Col id=\"TARGET\">cancelDel</Col><Col id=\"SP\">DRFPR_RECEIPT_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRF_RECEIPTDETAIL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGridEtc, this.dsListEtc, "DR", "DRF_RECEIPTDETAIL");
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DR", "DRF_RECEIPTDETAIL_1");
        	this.gfnGridInit(this.dxGrid2, this.dsList2, "DR", "DRF_RECEIPTDETAIL_2_1");
        	this.gfnGridInit(this.dxGrid3, this.dsList3, "DR", "DRF_RECEIPTDETAIL_3");
        	this.gfnGridInit(this.dxGrid4, this.dsList4, "DR", "DRF_RECEIPTDETAIL_4");
        ...
        */
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "select") {
        		if(this.dsList.rowcount > 0){
        			...
        			this.dsList1.clearData(); this.dsList2.clearData(); this.dsList3.clearData(); this.dsList4.clearData(); this.dsListEtc.clearData();
        		}
        	}
        	else if (svcID == "selectEct") {
        ...
        this.dsSearch_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue) {
        		...
        		this.dsList1.clearData(); this.dsList2.clearData(); this.dsList3.clearData(); this.dsList4.clearData();
        ...
        this.fnSetSaveTab = function(index)
        {
         ...
         this.fnEstimate = function(obj,e) {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRF_DLGESTIMATERECEIPT", "fnEstimateCallback", param);
        }
        ...
        this.fnEstimateCallback =  function(svcID, val) {
         ...
         this.fnCancel = function(obj,e) {
        	...
        	if(this.dsList1.rowcount > 1){
        		...
        		this.AM_BUNYANGGET_TEXT = this.dsList1.getColumn(this.dsList1.rowcount-1, "AM_BUNYANG");
        ...
        this.fnCancel_popopen = function()
        {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRF_DLGCANCELACC", "fnCancelCallback", param);
        }
        ...
        this.fnCancelCallback =  function(svcID, val) {
         ...
         this.fnAgree = function(obj,e) {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRF_CONTRACTAGREE", "fnAgreeCallback", param);
        }
        ...
        this.divData_divDataBottom_tabData_tab1_btnReceipt_onclick = function(obj,e)
        {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRF_DLGRECEIPT", "fnReceiptCallback", param);
        };
        ...
        this.divData_divDataBottom_tabData_tab1_btnSpecial_onclick = function(obj,e)
        {
        	...
        	if (i < 0){
        		...
        		this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRF_DLGSPECIALRECEIPT", "fnSpecialCallback", param);
        	}
        };
        ...
        this.loadIncludeScript("DRF_RECEIPTDETAIL.xfdl");
