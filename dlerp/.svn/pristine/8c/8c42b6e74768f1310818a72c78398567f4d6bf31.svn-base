(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAM_CARUSE");
            this.set_titletext("일별차량운행일지");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAMPR_CARUSE_SELECT</Col></Row><Row><Col id=\"SP\">DAMPR_CARUSE_KMAFTER_SELECT</Col><Col id=\"TARGET\">selectCar</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAMPR_CARUSE_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CAR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CORP\"/><Col id=\"CD_CAR\"/><Col id=\"DT_FROM\"/><Col id=\"DT_TO\"/></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAM_CARUSE.xfdl", function() {
        ...
        this.loadIncludeScript("DAM_CARUSE.xfdl");
