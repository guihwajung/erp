(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staBar00","109","50","284","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staItem00","20","50","90","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("전표번호");
            ...
            obj = new Static("staTitle01","20","20","373","22",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_text("차입금거래전표연결");
            obj.set_cssclass("sta_POP_Title");
            this.divData.addChild(obj.name, obj);

            obj = new Div("cfNO_SLIP","116","54","270","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Button("btnOk","143","staItem00:15","45","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("확인");
            obj.getSetter("uWord").set("popup.ok");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancle","193","staItem00:15","45","21",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("취소");
        ...
        // User Script
        this.registerScript("DFC_DLG_LINKSLIP.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("DFC_DLG_LINKSLIP.xfdl");
