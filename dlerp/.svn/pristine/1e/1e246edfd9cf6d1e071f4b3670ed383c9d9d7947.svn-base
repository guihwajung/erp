(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_FNDWREQ_SELECT_BONSA</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWDPR_FNDWREQ_SAVE</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DWDPR_FNDWREQ_EXECUTE_BONSA</Col></Row><Row><Col id=\"TARGET\">sap_save</Col><Col id=\"SP\">DWDPR_FNDWREQAGG_SAP_SAVE</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DWDPR_FNDWREQDIFF_SELECT</Col></Row><Row><Col id=\"TARGET\">save1</Col><Col id=\"SP\">DWDPR_FNDWREQDIFF_SAVE</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DWDPR_FNDWREQPLNVSRSLT_SELECT</Col></Row><Row><Col id=\"TARGET\">save2</Col><Col id=\"SP\">DWDPR_FNDWREQPLNVSRSLT_SAVE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_COMMON_SELECT_01</Col></Row><Row><Col id=\"TARGET\">select_sap</Col><Col id=\"SP\">DWXPR_RFCINFO_SELECT</Col></Row><Row><Col id=\"TARGET\">appno</Col><Col id=\"SP\">DZZPR_APPSTATE_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DWDPR_FNDWREQ_UPDATE_BONSA</Col></Row><Row><Col id=\"TARGET\">confirm</Col><Col id=\"SP\">DWDPR_FNDWREQ_CONFIRM</Col></Row><Row><Col id=\"TARGET\">cancel</Col><Col id=\"SP\">DWDPR_FNDWREQ_CANCEL</Col></Row><Row><Col id=\"TARGET\">bonsa_cancel</Col><Col id=\"SP\">DZZPR_APPROVAL_CALLBACK_FND_BONSA</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_PRGS","ctclYM_WORK:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("진행상태");
            obj.set_textAlign("center");
            ...
            obj = new Static("staCD_SITE02","ctclYM_WORK:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("결재번호");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staYN_CONFIRM","edtDS_ELAPPRGS:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("조정금액확정");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtYN_CONFIRM","staYN_CONFIRM:0.0","10.0","40","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_readonly("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Div("divData01","0","0",null,"210","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
        ...
        // User Script
        this.registerScript("DWD_FNDWREQ_BONSA.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnBCancel = this.gfnFormButtonAdd("btnBCancel", "fnBCancel");
        };
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWD_FNDWREQ_BONSA");
        	...
        	this.dxGrid3.EnterCell = "fnGrid3_EnterCell";
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("CD_REQ", "string");
        	this.dsUpdate.addColumn("AM_CASH_HQ", "bigdecimal");
        	this.dsUpdate.addColumn("AM_NOTE_HQ", "bigdecimal");
        	this.dsUpdate.addColumn("AM_CASH_SIT", "bigdecimal");
        	this.dsUpdate.addColumn("AM_CASH_UNDSPT", "bigdecimal");
        	this.dsUpdate.addColumn("AM_CASH_SEXP", "bigdecimal");
        ...
        // 	this.dsSave2.addColumn("DS_RSN", "string");
        	...
        	this.dsConfirm.addColumn("CD_REQ", "string");
        	this.dsConfirm.addColumn("ID_UPDATE", "string");

        	this.dsCancel = new Dataset();
        	this.dsCancel.addColumn("CD_SITE", "string");
        	this.dsCancel.addColumn("YM_WORK", "string");
        	this.dsCancel.addColumn("CD_REQ", "string");
        	this.dsCancel.addColumn("ID_UPDATE", "string");

        	this.dsBonsaCancel = new Dataset();
        	this.dsBonsaCancel.addColumn("ID_AP", "string");
        	this.dsBonsaCancel.addColumn("V_PARAM01", "string");
        	this.dsBonsaCancel.addColumn("V_PARAM02", "string");
        	this.dsBonsaCancel.addColumn("V_PARAM03", "string");
        	this.dsBonsaCancel.addColumn("V_PARAM04", "string");
        	this.dsBonsaCancel.addColumn("ST_APPR", "string");
        	this.dsBonsaCancel.addColumn("ID_USER", "string");
        	this.dsBonsaCancel.addColumn("DS_NOTE", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "U" :
        				...
        				this.dsUpdate.setColumn(nrow, "YM_WORK", this.dsSearch.getColumn(0, "YM_WORK").substr(0,6));
        				this.dsUpdate.setColumn(nrow, "CD_REQ", this.dsList.getColumn(i, "CD_REQ"));
        				this.dsUpdate.setColumn(nrow, "AM_CASH_HQ", this.dsList.getColumn(i, "AM_CASH_HQ"));
        				this.dsUpdate.setColumn(nrow, "AM_NOTE_HQ", this.dsList.getColumn(i, "AM_NOTE_HQ"));
        				this.dsUpdate.setColumn(nrow, "AM_CASH_SIT", this.dsList.getColumn(i, "AM_CASH_SIT"));
        				this.dsUpdate.setColumn(nrow, "AM_CASH_UNDSPT", this.dsList.getColumn(i, "AM_CASH_UNDSPT"));
        				this.dsUpdate.setColumn(nrow, "AM_CASH_SEXP", this.dsList.getColumn(i, "AM_CASH_SEXP"));
            ...
            if (svcID == "select") {
              if(this.dsList.rowcount < 1) {
        		...
        		if(this.dsList.getColumn(0, "YN_CONFIRM") == "Y")
        		{
        			...
        			this.divSearch.form.edtYN_CONFIRM.set_value("Y");
        		}
        		else
        		{
        			this.btnConfirm.set_enable(true);
        			this.btnCancel.set_enable(false);
        			this.divSearch.form.edtYN_CONFIRM.set_value("N");
        		}

        		if(this.dsList.getColumn(0, "YN_AUTH") != "Y")
        		{
        			this.btnConfirm.set_enable(false);
        			this.btnCancel.set_enable(false);
        			this.btnBCancel.set_enable(false);
        		}
        ...
        // 	}
        	...
        	else if(svcID == "confirm")
        	{
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("조정금액확정이 정상처리되었습니다.", "fnCallback_callback");
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        	...
        	else if(svcID == "bonsa_cancel")
        	{
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("본사반려가 정상처리되었습니다.", "fnCallback_callback");
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
         ...
         ************************************************************************/
          ...
          this.fnGrid_EnterCell = function(obj, row, cell) {
        	...
        	if(this.dsList.getColumn(row, "YN_AUTH") != "Y") {
        		return false;
        	}
        ...
        this.fnGrid3_EnterCell = function(obj, row, cell) {
        	return false;
        }
         ...
         this.fnGrid_RowCellChanged = function(obj,e)
        {
        	 if ((obj.oldrow > -1 && obj.oldrow == e.row)
        		...
        		this.fnBtnCheckAll();
        		if(this.dsList.getColumn(e.row, "YN_AUTH") != "Y")
        		{
        			this.btnConfirm.set_enable(false);
        			this.btnCancel.set_enable(false);
        		}
        ...
        this.dsSearch_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue) {
        		...
        		this.divSearch.form.ccboCD_PRGS.set_index(0);
        		this.divSearch.form.edtNO_ELAPDOC.set_value("");
        		this.divSearch.form.edtDS_ELAPPRGS.set_value("");
        		this.divSearch.form.edtYN_CONFIRM.set_value("");
        	}
        };
        ...
        this.fnConfirm = function(obj,e) {
        	this.gfnConfirm("조정금액확정을 진행하시겠습니까?", "fnConfirm_callback");
        }
        ...
        this.fnConfirm_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		...
        		this.dsConfirm.setColumn(nrow, "CD_REQ", "B");
        		this.dsConfirm.setColumn(nrow, "ID_UPDATE", this.AuthClient.ID_USER);
        ...
        this.fnCancel_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		...
        		this.dsCancel.setColumn(nrow, "YM_WORK", this.dsSearch.getColumn(0, "YM_WORK"));
        		this.dsCancel.setColumn(nrow, "CD_REQ", "B");
        ...
        this.fnBCancel = function(obj,e) {
        	this.gfnConfirm("본사반려를 진행하시겠습니까?", "fnBCancel_callback");
        }

        this.fnBCancel_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		this.dsBonsaCancel.clearData();

        		var nrow = this.dsBonsaCancel.addRow();
        		this.dsBonsaCancel.setColumn(nrow, "ID_AP", this.divSearch.form.edtNO_ELAPDOC.text);
        		this.dsBonsaCancel.setColumn(nrow, "V_PARAM01", this.dsSearch.getColumn(0, "CD_SITE"));
        		this.dsBonsaCancel.setColumn(nrow, "V_PARAM02", this.dsSearch.getColumn(0, "YM_WORK").substr(0,6));
        		this.dsBonsaCancel.setColumn(nrow, "V_PARAM03", "");
        		this.dsBonsaCancel.setColumn(nrow, "V_PARAM04", "");
        		this.dsBonsaCancel.setColumn(nrow, "ST_APPR", "04");
        		this.dsBonsaCancel.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);
        		this.dsBonsaCancel.setColumn(nrow, "DS_NOTE", "");

        		var strSvcId    = "bonsa_cancel";
        		var strSvcType  = "save";
        		var inProc		= "_dsProc";
        		var inData      = "bonsa_cancel=dsBonsaCancel";
        		var outData     = "";
        		var strArg      = "";
        		var callBackFnc = "fnCallback";
        ...
        {
        	this.gfnBtnCheck(this.btnFndWreqAgg, this.dsList);
        	this.gfnBtnCheck(this.btnUnpdStmHq, this.dsList);
        	this.gfnBtnCheck(this.btnUnpdStmSit, this.dsList);
        	this.gfnBtnCheck(this.btnUnpdStmDm, this.dsList);
        	this.gfnBtnCheck(this.btnFndWreqChkLst, this.dsList);
        	this.gfnBtnCheck(this.btnFndReqDpln, this.dsList);
        	this.gfnBtnCheck(this.btnFndReqSexp, this.dsList);
        	...
        	this.gfnBtnCheck(this.btnBCancel, this.dsList);
        }
        });
        ...
        this.loadIncludeScript("DWD_FNDWREQ_BONSA.xfdl");
