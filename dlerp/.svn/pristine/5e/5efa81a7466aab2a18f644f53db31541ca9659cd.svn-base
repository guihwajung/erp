(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("maxheight").set("540");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DRCPR_SPECIAL_RECEIPT_HANDLE</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DRCPR_RECEIPT_SALEDISCOUNT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRC_DLGSPECIALRECEIPT.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.AM_DELMISU = this.gfnNvl(this.getOwnerFrame().AM_DELMISU);
        ...
        // 	this.dsSelect.addColumn("AM_BUNYANG", "bigdecimal");
        // 	this.dsSelect.addColumn("GUBUN", "string");
        // 	this.dsSelect.addColumn("DD_DAY", "int");
        // 	this.dsSelect.addColumn("AM_MONEY", "bigdecimal");
        // 	this.dsSelect.addColumn("CD_GUJA", "string");
        // 	this.dsSelect.addColumn("TY_MONEY", "string");
        // 	this.dsSelect.addColumn("CD_VENDOR", "string");
        // 	this.dsSelect.addColumn("YN_DELMISU", "string");
        // 	this.dsSelect.addColumn("DS_REMARK", "string");
        	...
        	if(svcID == "save"){
        		if (errorCode == 0) {
        			...
        			if (this.dsResult.rowcount == 0) {
        				this.gfnAlert("분양금 수납에 실패하였습니다.", "fnAlertCallback");
        			}
        			else {
        ...
        this.dsList_onvaluechanged = function(obj,e) {
        	if (e.oldvalue != e.newvalue) {
        		...
        		else if (e.columnid == "GUBUN" || e.columnid == "DT_RECEIVED") {
        			this.fnAmount();
        		}
        	}
        };
        ...
        // 	this.dsSelect.setColumn(0, "CD_ACNTUNIT", this.ACNTUNIT);
        // 	this.dsSelect.setColumn(0, "TY_GUBUN", this.GUBUN);
        // 	this.dsSelect.setColumn(0, "NO_CHASU", this.CHASU);
        ...
        // 	this.dsSelect.setColumn(0, "AM_BUNYANG", this.dsList.getColumn(0, "AM_BUNYANG"));
        // 	this.dsSelect.setColumn(0, "GUBUN", this.dsList.getColumn(0, "GUBUN"));
        // 	this.dsSelect.setColumn(0, "DD_DAY", this.dsList.getColumn(0, "DD_DAY"));
        // 	this.dsSelect.setColumn(0, "AM_MONEY", this.dsList.getColumn(0, "AM_MONEY"));
        ...
        // 	this.dsSelect.setColumn(0, "CD_VENDOR", this.dsList.getColumn(0, "CD_FINANCING"));
        // 	this.dsSelect.setColumn(0, "YN_DELMISU", "N");
        // 	this.dsSelect.setColumn(0, "DS_REMARK", this.dsList.getColumn(0, "DS_REMARK"));
        ...
        this.loadIncludeScript("DRC_DLGSPECIALRECEIPT.xfdl");
