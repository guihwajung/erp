(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("기초생성");
            this.getSetter("maxwidth").set("390");
            this.getSetter("maxheight").set("370");
            if (Form == this.constructor)
            {
                this._setFormPosition(346,295);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsList", this);
            obj._setContents("<ColumnInfo><Column id=\"YM_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"SN_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"RT_COMPANY\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DT_SALARY\" type=\"STRING\" size=\"256\"/><Column id=\"TY_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SABUN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DAUPR_MONTHLYBASE_CREATE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DAZPR_COMMONCODE_COMBO</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYM_SALARY_bg","staYM_SALARY:-1","staYM_SALARY:-30","260","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            ...
            obj = new Static("staTY_SALARY_bg","staTY_SALARY:-1","staTY_SALARY:-30","260","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Static("staRT_COMPANY","0","staTY_SALARY:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_text("회사지급율");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staRT_COMPANY_bg","staRT_COMPANY:-1","staRT_COMPANY:-30","260","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);

            obj = new Edit("txtRT_COMPANY","staRT_COMPANY:5","staRT_COMPANY:-25","61","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            obj.set_readonly("false");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staRT_COMPANY_percent","txtRT_COMPANY:5","txtRT_COMPANY:-26","20","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_text("%");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staCD_CORP","0","staRT_COMPANY:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_text("법인");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staDT_SALARY","0","staCD_CORP:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_text("지급일");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staDT_SALARY_bg","staDT_SALARY:-1","staDT_SALARY:-30","260","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_visible("true");
            this.divData.addChild(obj.name, obj);

            obj = new Calendar("ctclDT_SALARY","staDT_SALARY:5","staDT_SALARY:-25","100","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            ...
            obj = new Static("staTY_WORK","0","staDT_SALARY:-1","87","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("18");
            obj.set_text("작업대상");
            obj.set_visible("true");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new BindItem("item3","divData.form.txtRT_COMPANY","value","dsList","RT_COMPANY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divData.form.ccfCD_CORP.form.CDTextBox","value","dsList","CD_CORP");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item6","divData.form.ctclDT_SALARY","value","dsList","DT_SALARY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divData.form.rdoTY_WORK","value","dsList","TY_WORK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divData.form.ccfID_SABUN.form.CDTextBox","value","dsList","ID_SABUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divData.form.ccfID_SABUN.form.DSTextBox","value","dsList","DS_HNAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divData.form.ccfCD_DEPT.form.CDTextBox","value","dsList","CD_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","divData.form.ccfCD_DEPT.form.DSTextBox","value","dsList","DS_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAU_INITSALARYBASE_DLG.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.txtRT_COMPANY  = this.divData.form.txtRT_COMPANY;		// 회사지급율
        	this.ccfCD_CORP     = this.divData.form.ccfCD_CORP;			// 법인
        	this.ctclDT_SALARY = this.divData.form.ctclDT_SALARY;		// 지급일
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsExecute.addColumn("RT_COMPANY", "int");
        ...
        this.fnInit = function() {
        	...
        	this.dsList.setColumn(0, "RT_COMPANY", "100");				// 회사지급율
        	this.dsList.setColumn(0, "CD_CORP", frame.CD_CORP);
        	this.dsList.setColumn(0, "DS_CORP", frame.DS_CORP);			// 법인
        	this.dsList.setColumn(0, "DT_SALARY", this.fnGetDtPayment(frame.YM_SALARY));	// 지급일
        ...
        this.fnSelectValidate = function() {
        	...
        	// 회사지급율
        	if (this.gfnIsNull(this.dsList.getColumn(0, "RT_COMPANY"))) {
        		this.fnVaidateCallback = function() {
        			this.txtRT_COMPANY.setFocus();
        		}
        ...
        this.btnOK_onclick = function(obj, e) {
        	this.gfnConfirm("기존 기초정보가 존재합니다. 새로 작업할까요?", "btnOK_onclick_callback");
        }
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	if (svcID == "select") {
        		...
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("급여기초자료 생성이 완료되었습니다.", "fnClose");
        		} else {
        ...
        this.btnOK_onclick_callback = function(strId, val) {
        	...
        	this.dsExecute.setColumn(nrow, "RT_COMPANY", this.dsList.getColumn(0, "RT_COMPANY"));
        ...
        this.dsList_onvaluechanged = function(obj, e) {
        	if (e.newvalue != e.oldvalue) {
        		if (e.columnid == "YM_SALARY") {
        			this.ctclDT_SALARY.set_value(this.fnGetDtPayment(e.newvalue));	// 지급일
        		}
        	}
        }
         ...
         * 기타 함수
         ************************************************************************/
        this.fnGetDtPayment = function(YM_SALARY){
        	var sDT_PAYMENT = this.gfnAddDate(YM_SALARY + "01", 24);
        	return sDT_PAYMENT;
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.txtRT_COMPANY.addEventHandler("onchanged",this.txtRT_COMPANY_onchanged,this);
            this.divData.form.ctclDT_SALARY.addEventHandler("onchanged",this.fnSearchInit,this);
        ...
        this.loadIncludeScript("DAU_INITSALARYBASE_DLG.xfdl");
