(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("5");
            obj.set_text("단기자금계획 생성");
            obj.set_cssclass("sta_POP_Title");
            this.addChild(obj.name, obj);

            obj = new Static("sta00","26","175","337","20",null,null,null,null,null,null,this);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("DFA_DLG_PLANS_CREATE.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        ...
        this.loadIncludeScript("DFA_DLG_PLANS_CREATE.xfdl");
