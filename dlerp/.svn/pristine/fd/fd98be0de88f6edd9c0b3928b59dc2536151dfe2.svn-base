(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"SP\">DRBPR_WEB_AGREEMENT_SELECT</Col><Col id=\"TARGET\">select</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DRBPR_WEB_AGREEMENT_OPT1_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DRBPR_WEB_AGREEMENT_OPT2_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTitle03","0","482",null,"22","0",null,null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("2");
            obj.set_text("별도계약1");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataMain.addChild(obj.name, obj);
            ...
            obj = new Grid("objGrid","0","115",null,null,"360","500",null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("5");
            obj._setContents("");
            this.divData.form.divDataMain.addChild(obj.name, obj);

            obj = new Grid("objGrid1","0","504",null,null,"360","290",null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("6");
            obj._setContents("");
            this.divData.form.divDataMain.addChild(obj.name, obj);

            obj = new Static("staTitle03_00","0","692",null,"22","0",null,null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("7");
            obj.set_text("별도계약2");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataMain.addChild(obj.name, obj);

            obj = new Grid("objGrid2","0","715",null,null,"360","60",null,null,null,null,this.divData.form.divDataMain.form);
            obj.set_taborder("8");
            obj._setContents("");
            this.divData.form.divDataMain.addChild(obj.name, obj);
            ...
            obj = new Static("staTitleMENU02","109","-2",null,"22","1035",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("납입내역조회");
            obj.set_cssclass("sta_TITLE_Bg");
            this.addChild(obj.name, obj);

            obj = new Static("staTitleMENU03","268","-2",null,"22","843",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("납입금일정조회");
            obj.set_cssclass("sta_TITLE_Bg");
            this.addChild(obj.name, obj);

            obj = new Static("staTitleMENU04","440","-1",null,"22","711",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("미납내역조회");
            obj.set_cssclass("sta_TITLE_Bg");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRQ_ARGEEMENT.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRQ_ARGEEMENT1");
        	this.gfnGridInit(this.dxGrid1, this.dsList1, "DR", "DRQ_ARGEEMENT1");
        	this.gfnGridInit(this.dxGrid2, this.dsList2, "DR", "DRQ_ARGEEMENT1");
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.staTitleMENU02.addEventHandler("onclick",this.divData_staTitleMENU02_onclick,this);
            this.staTitleMENU03.addEventHandler("onclick",this.divData_staTitleMENU03_onclick,this);
            this.staTitleMENU04.addEventHandler("onclick",this.divData_staTitleMENU04_onclick,this);
        ...
        this.loadIncludeScript("DRQ_ARGEEMENT.xfdl");
