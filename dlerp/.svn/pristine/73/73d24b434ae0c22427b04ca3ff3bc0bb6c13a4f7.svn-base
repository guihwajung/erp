(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZZPR_ORA_D05_PO_VENDORS_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DMA_ORA_PO_VENDORS.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DMA_ORA_PO_VENDORS");
        }
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("RPRT_NO", "string");	// 계약번호
        }
        ...
        this.loadIncludeScript("DMA_ORA_PO_VENDORS.xfdl");
