(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSBPR_MONTH_PAY_SELECT</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DSBPR_YMPAY_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYM_WORK","ccfCD_DEPT:0.0","10.0","144.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("출역년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("DSB_MONTH_PAY_SELECT.xfdl","lib::libCommon.xjs");
        this.registerScript("DSB_MONTH_PAY_SELECT.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DSB_MONTH_PAY_SELECT.xfdl");
