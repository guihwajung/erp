(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAV_HOUSESUBST");
            this.set_titletext("주택마련저축공제");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAVPR_HOUSESUBST_SELECT</Col></Row><Row><Col id=\"TARGET\">closeCheck</Col><Col id=\"SP\">DAVPR_CLOSE_CHECK2</Col></Row><Row><Col id=\"SP\">DAVPR_CLOSE_CHECK</Col><Col id=\"TARGET\">closeCheck</Col></Row><Row><Col id=\"SP\">DAVPR_HOUSESUBST_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"SP\">DAVPR_HOUSESUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAVPR_HOUSESUBST_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAV_HOUSESUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAV_HOUSESUBST");
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
         	...
         	switch(id) {
        		...
        		case "ccfID_RESIDENT"://주민번호
        			...
        			dsUserParam.setColumn(nrow, "GUBUN", "E");	//임직원 구분 rdoTY_GUBUN 없음
        ...
        // 		if(colnm == "CD_SUBST" || colnm == "CD_BANK"){
        // 			return false;
        // 		}
        // 	}
        //
        ...
        this.loadIncludeScript("DAV_HOUSESUBST.xfdl");
