(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(750,460);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOAPR_SOC_PROJ_ANALISYS_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DOAPR_SOC_PROJ_ANALISYS_MERGE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DOAPR_SOC_PROJ_ANALISYS_DELETE</Col></Row><Row><Col id=\"TARGET\">selectCharge</Col><Col id=\"SP\">DOAPR_PROJ_YNCHARGE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsBase", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"DS_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"DT_STD\" type=\"STRING\" size=\"256\"/><Column id=\"DS_STD\" type=\"STRING\" size=\"256\"/><Column id=\"AM_IVST\" type=\"STRING\" size=\"256\"/><Column id=\"AM_BIZ\" type=\"STRING\" size=\"256\"/><Column id=\"RT_IRR\" type=\"STRING\" size=\"256\"/><Column id=\"RT_COST\" type=\"STRING\" size=\"256\"/><Column id=\"ID_FILE_ATTCH\" type=\"STRING\" size=\"256\"/><Column id=\"ID_USER\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"DS_PROJ\" type=\"STRING\" size=\"256\"/><Column id=\"DT_STD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divData","0","50",null,"410","0",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("sta27","124","191",null,"149","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staID_FILE_ATTCH","5","191","120","149",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            obj.set_text("첨부파일");
            ...
            obj = new Static("sta04","124","133",null,"30","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Div("divFile","118","185",null,"150","10",null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_url("cmm::cmmFileManager.xfdl");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta05","124","162",null,"30","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staRT_COST","5","162","120","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            obj.set_text("시공원가율");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staAM_IRR","5","133","120","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("13");
            obj.set_text("불변IRR");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staAM_BIZ","5","104","120","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_text("총사업비");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staAM_IVST","5","75","120","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("17");
            obj.set_text("총투자비");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staDS_STD","5","46","120","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("19");
            obj.set_text("기준명");
            obj.set_textAlign("left");
            ...
            obj = new Edit("ctxtDS_STD","128","51","298","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_value("");
            obj.set_enable("true");
            this.divData.addChild(obj.name, obj);

            obj = new MaskEdit("ctxtAM_IVST","128","80","200","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_value("");
            ...
            obj = new MaskEdit("ctxtAM_BIZ","128","109","200","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_value("");
            obj.set_textAlign("right");
            obj.set_autoselect("true");
            ...
            obj = new MaskEdit("ctxtAM_IRR","128","138","80","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_value("");
            obj.set_textAlign("right");
            obj.set_autoselect("true");
            ...
            obj = new MaskEdit("ctxtRT_COST","129","167","80","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            obj.set_value("");
            obj.set_textAlign("right");
            obj.set_autoselect("true");
            ...
            obj = new Static("staPercent16_00","214","167","40","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("23");
            obj.set_text("%");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnSave","41.60%","359","60","24",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("저장");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancel","btnSave:8","359","60","24",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_text("취소");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staPercent16_01_00","335","79","40","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("24");
            obj.set_text("억원");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staPercent16_01_00_00","335","108","40","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("25");
            obj.set_text("억원");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staPercent16_00_00","214","138","40","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("26");
            obj.set_text("%");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item7","divData.form.ctclDT_STD","value","dsBase","DT_STD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divData.form.ctxtDS_STD","value","dsBase","DS_STD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divData.form.ctxtAM_IVST","value","dsBase","AM_IVST");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divData.form.ctxtAM_BIZ","value","dsBase","AM_BIZ");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divData.form.ctxtAM_IRR","value","dsBase","RT_IRR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.ctxtRT_COST","value","dsBase","RT_COST");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DOC_SOC_ANALYSIS.xfdl", function() {
        ...
        this.loadIncludeScript("DOC_SOC_ANALYSIS.xfdl");
