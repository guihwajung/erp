(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLFPR_CONTRACT_SELECT_DAEBANG</Col></Row><Row><Col id=\"SP\">DRFPR_CONTRACT_CANCEL</Col><Col id=\"TARGET\">exec</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLF_CONTRACTSTATE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLF_CONTRACTSTATE");

        	this.ccfCD_ACNTUNIT.BeforeUserDataSetParam = "fnBeforeUserDataSetParam";
        	this.ccfCD_ACNTUNIT.AfterCDTextChanged = "fnAfterCDTextChanged";

        	this.gfnGridColumnColor(this.dxGrid, "YN_ITEM", "Red", "YN_ITEM == '미등록'");
        	this.gfnGridColumnColor(this.dxGrid, "YN_CONTRACT", "Blue", "YN_CONTRACT == '계약'");
        ...
        this.dsSearch_onvaluechanged = function(obj,e) {
         ...
         this.fnOk = function(obj,e) {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DLF_ITEMCONTRACT", "fnOkCallback", param);
        }
        ...
        this.loadIncludeScript("DLF_CONTRACTSTATE.xfdl");
