(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_RE_LIST_DM_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_RE_LIST_DM_UPDATE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo1</Col><Col id=\"SP\">DMXPR_LICCOST_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">auto</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_RE_LIST_AUTO_JUDGE_DM</Col></Row><Row><Col id=\"TARGET\">talak</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_RE_LIST_DM_TALAK</Col></Row><Row><Col id=\"TARGET\">exist</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_RE_LIST_DM_RELOAD</Col></Row><Row><Col id=\"TARGET\">regist</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_RE_LIST_DM_REGIST</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCA_JUDGE_REGULAR_EXIST_RE_LIST_DM.xfdl", function() {
        ...
        this.loadIncludeScript("DCA_JUDGE_REGULAR_EXIST_RE_LIST_DM.xfdl");
