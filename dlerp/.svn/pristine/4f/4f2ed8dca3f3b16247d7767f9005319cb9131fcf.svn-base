(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAZPR_SPECIALSUBST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAZPR_SPECIALSUBST_INSERT</Col></Row><Row><Col id=\"SP\">DAZPR_SPECIALSUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DAZPR_SPECIALSUBST_DELETE</Col><Col id=\"TARGET\">delete</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YM_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"YN_DELETE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YM_BASE\"/><Col id=\"YN_DELETE\">N</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divSearch.form.cboYN_DELETE","value","dsSearch","YN_DELETE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAZ_SPECIALSUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAZ_SPECIALSUBST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("CD_SPECIAL", "string");
        	this.dsInsert.addColumn("DS_SPECIAL", "string");
        	this.dsInsert.addColumn("RT_SUBST", "double");
        	this.dsInsert.addColumn("MX_SUBST", "int");
        	this.dsInsert.addColumn("NO_RECORD", "int");
        	this.dsInsert.addColumn("ID_INSERT", "string");

            this.dsUpdate = new Dataset();
        	this.dsUpdate.addColumn("YM_BASE", "string");
        	this.dsUpdate.addColumn("CD_SPECIAL", "string");
        	this.dsUpdate.addColumn("DS_SPECIAL", "string");
        	this.dsUpdate.addColumn("RT_SUBST", "double");
        	this.dsUpdate.addColumn("MX_SUBST", "int");
        	...
        	this.dsDelete.addColumn("CD_SPECIAL", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "CD_SPECIAL", this.dsList.getColumn(i, "CD_SPECIAL"));
        				this.dsInsert.setColumn(nrow, "DS_SPECIAL", this.dsList.getColumn(i, "DS_SPECIAL"));
        				this.dsInsert.setColumn(nrow, "RT_SUBST", this.dsList.getColumn(i, "RT_SUBST"));
        				this.dsInsert.setColumn(nrow, "MX_SUBST", this.dsList.getColumn(i, "MX_SUBST"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_SPECIAL", this.dsList.getColumn(i, "CD_SPECIAL"));
        				this.dsUpdate.setColumn(nrow, "DS_SPECIAL", this.dsList.getColumn(i, "DS_SPECIAL"));
        				this.dsUpdate.setColumn(nrow, "RT_SUBST", this.dsList.getColumn(i, "RT_SUBST"));
        				this.dsUpdate.setColumn(nrow, "MX_SUBST", this.dsList.getColumn(i, "MX_SUBST"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "CD_SPECIAL", this.dsList.getColumn(i, "CD_SPECIAL"));
        ...
        this.loadIncludeScript("DAZ_SPECIALSUBST.xfdl");
