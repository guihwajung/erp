(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DYAPR_SAUP_PLAN_EXCEL_SELECT</Col></Row><Row><Col id=\"SP\">DCBPR_PREORDERPLAN_APPROVE_CANCEL</Col><Col id=\"TARGET\">approve_cancel</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DYAPR_SAUP_PLAN_CREATE</Col></Row><Row><Col id=\"TARGET\">excel</Col><Col id=\"SP\">DYAPR_SAUP_PLAN_EXCEL_INSERT</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("DYA_SAUP_PLAN_EXCEL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DY", "DYA_SAUP_PLAN_EXCEL");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsExcelUp.addColumn("CD_DEPT", "string");
        	this.dsExcelUp.addColumn("DS_DEPT", "string");
        	this.dsExcelUp.addColumn("SN_SEQ", "string");
        	this.dsExcelUp.addColumn("CD_ACNT", "string");
        	this.dsExcelUp.addColumn("DS_ACNT", "string");
        	this.dsExcelUp.addColumn("AM_COMPLET", "bigdecimal");
        	this.dsExcelUp.addColumn("AM_YEAR_NU01", "bigdecimal");
        	this.dsExcelUp.addColumn("AM_YEAR02", "bigdecimal");
        	this.dsExcelUp.addColumn("AM_YEAR_NU02", "bigdecimal");
        ...
        this.fnSaveExcel = function() {
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		this.dsExcelUp.setColumn(nrow, "CD_DEPT", this.dsList.getColumn(i, "CD_DEPT"));
        		this.dsExcelUp.setColumn(nrow, "DS_DEPT", this.dsList.getColumn(i, "DS_DEPT"));
        		this.dsExcelUp.setColumn(nrow, "SN_SEQ", this.dsSeq.getColumn(0, "SN_SEQ_NEW"));
        		this.dsExcelUp.setColumn(nrow, "CD_ACNT", this.dsList.getColumn(i, "CD_ACNT"));
        		this.dsExcelUp.setColumn(nrow, "DS_ACNT", this.dsList.getColumn(i, "DS_ACNT"));
        		this.dsExcelUp.setColumn(nrow, "AM_COMPLET", this.dsList.getColumn(i, "AM_COMPLET"));
        		this.dsExcelUp.setColumn(nrow, "AM_YEAR_NU01", this.dsList.getColumn(i, "AM_YEAR_NU01"));
        		this.dsExcelUp.setColumn(nrow, "AM_YEAR02", this.dsList.getColumn(i, "AM_YEAR02"));
        		this.dsExcelUp.setColumn(nrow, "AM_YEAR_NU02", this.dsList.getColumn(i, "AM_YEAR_NU02"));
        ...
        this.loadIncludeScript("DYA_SAUP_PLAN_EXCEL.xfdl");
