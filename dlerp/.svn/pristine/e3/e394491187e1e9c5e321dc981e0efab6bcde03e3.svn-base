(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAM_CARUSE_MONTH");
            this.set_titletext("월별차량운행일지");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAMPR_CARUSE_MONTH_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YY_CARUSE\" type=\"STRING\" size=\"256\"/><Column id=\"MM_CARUSE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CAR\" type=\"STRING\" size=\"256\"/><Column id=\"NO_CAR\" type=\"STRING\" size=\"256\"/><Column id=\"TY_CAR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsMM_CARUSE", this);
            ...
            obj = new Static("staYY_CARUSE","0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("조회년도");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboMM_CARUSE","staYY_CARUSE:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_innerdataset("dsMM_CARUSE");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_CORP","cboMM_CARUSE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("법인");
            ...
            obj = new Edit("edtNO_CAR","0.0","staYY_CARUSE:10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTY_CAR","edtNO_CAR:0.0","staYY_CARUSE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("차종");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtTY_CAR","staTY_CAR:0.0","staYY_CARUSE:10.0","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staCD_CAR","edtTY_CAR:0.0","staYY_CARUSE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("차량코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_CAR","staCD_CAR:0.0","staYY_CARUSE:10.0","250","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staNO_CAR","ccfCD_CAR:0.0","staYY_CARUSE:10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("차량번호");
            ...
            obj = new Div("ccfYY_CARUSE","staYY_CARUSE:0.0","10.0","96","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_url("cmm::cmmCalYY.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staMM_CARUSE","ccfYY_CARUSE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("조회월");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divSearch.form.ccfYY_CARUSE.form.TextBox","value","dsSearch","YY_CARUSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.cboMM_CARUSE","value","dsSearch","MM_CARUSE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","divSearch.form.ccfCD_CAR.form.CDTextBox","value","dsSearch","CD_CAR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch.form.edtNO_CAR","value","dsSearch","NO_CAR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divSearch.form.edtTY_CAR","value","dsSearch","TY_CAR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAM_CARUSE_MONTH.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edtTY_CAR.addEventHandler("onchanged",this.fnSearchInit,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DAM_CARUSE_MONTH.xfdl");
