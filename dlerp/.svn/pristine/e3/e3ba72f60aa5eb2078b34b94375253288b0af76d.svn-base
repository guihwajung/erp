(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWDPR_JTSLIP_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DWDPR_JTCOSTDIVDETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DWDPR_JTSLIP_SAVE</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DWDPR_JTSLIP_EXECUTE</Col></Row><Row><Col id=\"TARGET\">sapauto</Col><Col id=\"SP\">DWZPR_SAP_AUTOSLIP_ISSUE_SELECT</Col></Row><Row><Col id=\"TARGET\">sapcancel</Col><Col id=\"SP\">DWZPR_SAP_AUTOSLIP_CANCEL_SELECT</Col></Row><Row><Col id=\"TARGET\">appSelect</Col><Col id=\"SP\">DWDPR_APP_DW05_SELECT</Col></Row><Row><Col id=\"TARGET\">appChk</Col><Col id=\"SP\">DWDPR_APP_DW05_CHK</Col></Row><Row><Col id=\"TARGET\">MagamEXE</Col><Col id=\"SP\">DWZPR_AUTOSLIP_AFTEREXECUTE_ISSUE </Col></Row><Row><Col id=\"TARGET\">MagamCNC</Col><Col id=\"SP\">DWZPR_AUTOSLIP_AFTEREXECUTE_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSplitter","0","44.12%","100.00%","5",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            ...
            obj = new Grid("objGrid","0","5",null,null,"0","0",null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("0");
            obj._setContents("");
            ...
            obj = new Grid("objGridSub","0","20",null,null,"0","0",null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("0");
            obj._setContents("");
        ...
        // User Script
        this.addIncludeScript("DWD_JTSLIP.xfdl",'lib::libCommon.xjs');
        this.registerScript("DWD_JTSLIP.xfdl", function() {
        ...
        // 공동도급마감
        this.fnMagamEXE = function(obj,e) {
        	this.gfnConfirm("공동도급마감 하시겠습니까?", "fnExecMagam", "MagamEXE");
        }

        // 마감취소
        this.fnMagamCNC = function(obj,e) {
        ...
        this.divData_divDataTop_objGrid_oncellposchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataTop.form.objGrid.addEventHandler("oncellposchanged",this.divData_divDataTop_objGrid_oncellposchanged,this);
        ...
        this.loadIncludeScript("DWD_JTSLIP.xfdl");
