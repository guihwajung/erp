(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFAPR_PLANS_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFAPR_PLANS_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFAPR_PLANS_UPDATE</Col></Row><Row><Col id=\"TARGET\">createx</Col><Col id=\"SP\">DFAPR_PLANS_CREATEX</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">clearx</Col><Col id=\"SP\">DFAPR_PLANS_GW_CLEAR</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"YM_PLAN\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SUJI\" type=\"STRING\" size=\"256\"/><Column id=\"YN_FINAL\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_SITE","sta03:0.0","sta00:10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Div("ccfCD_SUJI","sta01:0.0","sta00:10.0","269","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("90");
            obj.set_taborder("4");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta02","0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("구분");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboYN_FINAL","sta02:0.0","10.0","110","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Div("calYM_PLAN","cboYN_FINAL:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("divData","0","divSearch:25",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("sta01",null,"63","78","20","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("단위 : 100만원");
            obj.set_textDecoration("none");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item3","divSearch.form.ccfCD_SUJI.form.CDTextBox","value","dsSearch","CD_SUJI");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSearch.form.cboYN_FINAL","value","dsSearch","YN_FINAL");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch.form.calYM_PLAN.form.TextBox","value","dsSearch","YM_PLAN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFA_PLAN_SHORT.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.calYM_PLAN = this.divSearch.form.calYM_PLAN;	// 계획년월
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFA_PLANS");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("AM_13", "bigdecimal");
        	this.dsUpdate.addColumn("AM_14", "bigdecimal");
        	this.dsUpdate.addColumn("AM_15", "bigdecimal");
        	this.dsUpdate.addColumn("AM_16", "bigdecimal");
        	this.dsUpdate.addColumn("AM_17", "bigdecimal");
        	this.dsUpdate.addColumn("AM_18", "bigdecimal");
        	this.dsUpdate.addColumn("AM_19", "bigdecimal");
        	this.dsUpdate.addColumn("AM_20", "bigdecimal");
        	this.dsUpdate.addColumn("AM_21", "bigdecimal");
        	this.dsUpdate.addColumn("AM_22", "bigdecimal");
        	this.dsUpdate.addColumn("AM_23", "bigdecimal");
        	this.dsUpdate.addColumn("AM_24", "bigdecimal");
        	this.dsUpdate.addColumn("AM_25", "bigdecimal");
        	this.dsUpdate.addColumn("AM_26", "bigdecimal");
        	this.dsUpdate.addColumn("AM_27", "bigdecimal");
        	this.dsUpdate.addColumn("AM_28", "bigdecimal");
        	this.dsUpdate.addColumn("AM_29", "bigdecimal");
        	this.dsUpdate.addColumn("AM_30", "bigdecimal");
        	this.dsUpdate.addColumn("AM_31", "bigdecimal");
        ...
        this.fnPopupValidate = function(popId) {
        	...
        	// 단기자금계획 생성
        	case "DFA_DLG_PLANS_CREATE":
        		break;

        	// 단기자금계획 자료삭제(초기화)
        	case "DFA_DLG_PLANS_DELETE":
        		break;

        	// 단기자금계획 전자결재(초기화)
        	case "DFA_DLG_APPRS_DELETE":
        ...
        this.fnPopCallBack = function(svcID, val) {
        	if (val != false) {
        		...
        		// 단기자금계획 생성 콜백
        		if (svcID.indexOf("DFA_DLG_PLANS_CREATE") > -1) {
        			this.fnPLANSCreate("create", json);
        		}

        		// 단기자금계획 자료삭제(초기화) 콜백
        		if (svcID.indexOf("DFA_DLG_PLANS_DELETE") > -1) {
        			this.fnPLANSCreate("createx", json);
        		}

        		// 단기자금계획 전자결재(초기화) 콜백
        		if (svcID.indexOf("DFA_DLG_APPRS_DELETE") > -1) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.cboYN_FINAL.addEventHandler("onitemchanged",this.divSearch_cboYN_FINAL_onitemchanged,this);
            this.divData.form.objGrid.addEventHandler("onselectchanged",this.divData_objGrid_onselectchanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DFA_PLAN_SHORT.xfdl");
