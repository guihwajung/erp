(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staTY_DAESANG","0","staCD_CORP:-1","80","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("대상자");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staTY_DAESANG_bg","staTY_DAESANG:-1","staTY_DAESANG:-30","262","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Radio("rdoTY_DAESANG","staTY_DAESANG:5","staTY_DAESANG:-25","193","22",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
