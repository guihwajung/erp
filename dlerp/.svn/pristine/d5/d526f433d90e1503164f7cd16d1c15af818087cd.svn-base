(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEJUDGER_SITE_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCDPR_EVALUEJUDGER_SITE_UPDATE</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DCDPR_EVALUEJUDGER_SITE_INSERT</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCDPR_EVALUEJUDGER_SITE_DELETE</Col></Row><Row><Col id=\"TARGET\">insert1</Col><Col id=\"SP\">DCDPR_EVALUEJUDGER_SITE_INSERT_MULTI</Col></Row><Row><Col id=\"TARGET\">delete1</Col><Col id=\"SP\">DCDPR_EVALUEJUDGER_SITE_ALL_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta01","ccfMagam:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("현장코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfDz","sta01:0.0","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new BindItem("item2","divSearch.form.ccfDz.form.CDTextBox","value","dsSearch","CD_SITE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCD_EVALUEJUDGER_SITE.xfdl", function() {
        ...
        this.loadIncludeScript("DCD_EVALUEJUDGER_SITE.xfdl");
