(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">selectHeader</Col><Col id=\"SP\">DHDPR_PREPAY_SLIP_HEADER_SELECT</Col></Row><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHDPR_PREPAY_SLIP_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DHDPR_PREPAY_SLIP_CREATE</Col></Row><Row><Col id=\"SP\">DHDPR_PREPAY_CDTRADE</Col><Col id=\"TARGET\">selectCdSlip</Col></Row><Row><Col id=\"TARGET\">issueSlip</Col><Col id=\"SP\">DHDPR_PREPAY_SLIP_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">cancelSlip</Col><Col id=\"SP\">DHDPR_PREPAY_SLIP_CANCELSLIP</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT_ACNT\" type=\"STRING\" size=\"256\"/><Column id=\"YM_MONTH\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">1</Col><Col id=\"DS_CODE\">마감월</Col></Row><Row><Col id=\"CD_CODE\">2</Col><Col id=\"DS_CODE\">누적</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYM_WORK","ccfCD_DEPT_ACNT:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("마감월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ctclYM_MONTH","staYM_WORK:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboTY_GUBUN1","ctclYM_MONTH:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            ...
            obj = new Static("staTY_GUBUN1","ccboTY_GUBUN1:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("구분");
            ...
            obj = new Static("staCDSLIP","990","4","60","20",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("전표번호");
            this.addChild(obj.name, obj);

            obj = new Edit("edtCD_SLIP","1049","5","152","20",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new BindItem("item3","ccboTY_GUBUN1","value","dsSearch","APT_ST_GU");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHD_PREPAY_SLIP.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.staTY_GUBUN1.addEventHandler("onclick",this.divSearch_staAPT_ST_GU_onclick,this);
        ...
        this.loadIncludeScript("DHD_PREPAY_SLIP.xfdl");
