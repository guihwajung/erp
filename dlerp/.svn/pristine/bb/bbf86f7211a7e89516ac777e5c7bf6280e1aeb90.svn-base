(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsTY_POSITION_Y", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">B</Col><Col id=\"DS_CODE\">수납정정</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTY_POSITION_N", this);
        ...
        // User Script
        this.registerScript("DLF_DLGRECEIPT.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.YN_COLLECT     = this.getOwnerFrame().YN_COLLECT;
        	this.Title 			= this.getOwnerFrame().Title;

        	this.staSunapInfo.set_text(this.Title);

        	//일반수납화면(Dlf_ReceiptDetail) OR 수납정정화면(Dlf_CollectDetail) = "True"
        	if(this.YN_COLLECT === true) {
        		this.cboTY_POSITION.setInnerDataset(this.dsTY_POSITION_Y);
        	} else {
        		this.cboTY_POSITION.setInnerDataset(this.dsTY_POSITION_N);
        	}
        ...
        this.dsList_onvaluechanged = function(obj,e) {
        	if (e.oldvalue != e.newvalue) {
        		...
        		if (e.columnid == "TY_RECEIPT") {
        			...
        			if(this.YN_COLLECT === true) {
        				this.dsList.setColumn(0, "TY_POSITION", "B");
        			}
        		}
        ...
        this.loadIncludeScript("DLF_DLGRECEIPT.xfdl");
