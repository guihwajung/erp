...
@RestController("gcDeployController")
public class CENDeployController {

	private static final Logger LOGGER = LoggerFactory.getLogger(CENDeployController.class);
	...
	@GetMapping(value="/deploy/test.do")
	public ResponseEntity<String> commonTest(HttpServletRequest request) {
		return ResponseEntity.ok("test");	
	}

	@PostMapping(value="/deploy/log.do", consumes="application/x-www-form-urlencoded")
	 ...
	 * @throws IOException
	 */
	@PostMapping(value="/deploy/download.do", consumes="application/x-www-form-urlencoded")
	public ResponseEntity<InputStreamResource> deployDownload(HttpServletResponse response, @RequestParam("file") String file) throws IOException {
		String contextRealPath = env.getProperty("com.goodcen.path.deploy");
	 ...
	 * @return
	 */
	@PostMapping(value="/deploy/upload.do")
	...
	@PostMapping(value="/deploy/upload_webapp.do")
	public ResponseEntity<String> deployUploadWebapp(HttpServletRequest request, @RequestParam("path") String path, @RequestParam("id") String id) {
		String contextRealPath = env.getProperty("com.goodcen.path.webapp");
		MultipartHttpServletRequest multipartHttpServletRequest = (MultipartHttpServletRequest)request;
	    Iterator<String> iterator = multipartHttpServletRequest.getFileNames();
	    MultipartFile multipartFile = null;
	    String originalFileName = null;
