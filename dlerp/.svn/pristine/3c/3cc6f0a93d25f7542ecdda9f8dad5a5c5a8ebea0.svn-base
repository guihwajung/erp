(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_PR_EXPLAIN_FILE_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DCBPR_PR_EXPLAIN_FILE_SAVE</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DCBPR_PR_EXPLAIN_FILE_INIT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_PR\" type=\"STRING\" size=\"256\"/><Column id=\"NO_BID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfNO_PR","staNO_PR:0.0","10.0","270","24.0",null,null,null,null,null,null,this.divSearch.form);
        ...
        // User Script
        this.registerScript("DCB_PR_EXPLAIN_FILE.xfdl", function() {
        ...
        this.loadIncludeScript("DCB_PR_EXPLAIN_FILE.xfdl");
