(function()
{
    return function()
    {
        ...
        {
            this.set_name("cmmCodeFind_Pop");
            if (Form == this.constructor)
            {
                this._setFormPosition(420,316);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DXXPR_CDFIND_PROPERTY_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DQZPR_SEARCHDATA_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProcSize", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DXXPR_CODEFINDMST_SIZE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsParam", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CDMST\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("_dsUserParam", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListN", this);
            obj._setContents("");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsParamSize", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CFMST\" type=\"STRING\" size=\"256\"/><Column id=\"DLG_WIDTH\" type=\"INT\" size=\"256\"/><Column id=\"DLG_HEIGHT\" type=\"INT\" size=\"256\"/><Column id=\"ID_UPDATE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearchData", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CODEFINDE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SEARCH\" type=\"STRING\" size=\"256\"/><Column id=\"CD_RESULT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_RESULT\" type=\"STRING\" size=\"256\"/><Column id=\"ID_SEARCH\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("txtSearch","20","20",null,"25","77",null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearch","txtSearch:5","20","52","25",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("검색");
            this.addChild(obj.name, obj);

            obj = new Button("btnNext","btnSearch:5","20","25","25",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_visible("false");
            obj.set_cssclass("btn_WF_last");
            this.addChild(obj.name, obj);

            obj = new Grid("grd","20","txtSearch:10",null,null,"20","66",null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Div("divBtns",null,"grd:20","126","26","19",null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new Button("btnConfirm","0","0","60","26",null,null,null,null,null,null,this.divBtns.form);
            obj.set_taborder("3");
            obj.set_text("확인");
            obj.set_cssclass("btn_WF_action");
            this.divBtns.addChild(obj.name, obj);

            obj = new Button("btnCancel","btnConfirm:4","0","60","26",null,null,null,null,null,null,this.divBtns.form);
            obj.set_taborder("4");
            obj.set_text("취소");
            this.divBtns.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("cmmCodeFind_Pop.xfdl", function() {
        this.Page = 1;
        this.MinValue = "";
        this.IsSize = false;
        this.SearchField = [];
        ...
        this.cmmCodeFind_Pop_onload = function(obj,e)
        {
        ...
        this._grd_onkeydown = function(obj,e)
        {
        	if (e.keycode == 13) {
        ...
        this.txtSearch_onkeydown = function(obj,e)
        {
        	if (e.keycode == 13) {
        ...
        this.cmmCodeFind_Pop_onsize = function(obj,e)
        {
        	var nLeft = (this.width - this.divBtns.width) / 2;
        	//this.divBtns.left = nLeft;
        };

        this.cmmCodeFind_Pop_onkeydown = function(obj,e)
        {
        	if (e.keycode == 27) // esc
        	{
        		this.close();
        ...
        // 사용안함 - 취소는 검색어 저장 안함.
        this.cmmCodeFind_Pop_onbeforeclose = function(obj,e)
        {
        ...
        this.grd_onkeyup = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.cmmCodeFind_Pop_onload,this);
            this.addEventHandler("onsize",this.cmmCodeFind_Pop_onsize,this);
            this.addEventHandler("onkeydown",this.cmmCodeFind_Pop_onkeydown,this);
            this.txtSearch.addEventHandler("onkeydown",this.txtSearch_onkeydown,this);
            this.btnSearch.addEventHandler("onclick",this.btnSearch_onclick,this);
            this.btnNext.addEventHandler("onclick",this.btnNext_onclick,this);
            this.grd.addEventHandler("onkeyup",this.grd_onkeyup,this);
        ...
        this.loadIncludeScript("cmmCodeFind_Pop.xfdl");
