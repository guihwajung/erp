(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"ID_RTNG\" type=\"STRING\" size=\"256\"/><Column id=\"DS_RTNG\" type=\"STRING\" size=\"256\"/><Column id=\"DT_RTNG_BEGN\" type=\"STRING\" size=\"256\"/><Column id=\"DT_RTNG_END\" type=\"STRING\" size=\"256\"/><Column id=\"CTN_WRK\" type=\"INT\" size=\"256\"/><Column id=\"SPNT\" type=\"STRING\" size=\"256\"/><Column id=\"SPLM\" type=\"STRING\" size=\"256\"/><Column id=\"ETC\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select_ldsh_rtngprsn</Col><Col id=\"SP\">DAJPR_RTNG_LDSH_RTNGPRSN_SELECT</Col></Row><Row><Col id=\"TARGET\">select_ldsh_summary</Col><Col id=\"SP\">DAJPR_RTNG_LDSH_SUMMARY_SELECT</Col></Row><Row><Col id=\"TARGET\">select_ldsh</Col><Col id=\"SP\">DAJPR_RTNG_LDSH_SELECT</Col></Row><Row><Col id=\"TARGET\">select_ldsh_additional</Col><Col id=\"SP\">DAJPR_RTNG_LDSH_ADDITIONAL_SELECT</Col></Row><Row><Col id=\"TARGET\">select_ctrn</Col><Col id=\"SP\">DAJPR_RTNG_CTRN_SELECT</Col></Row><Row><Col id=\"TARGET\">save_ldsh</Col><Col id=\"SP\">DAJPR_RTNG_LDSH_SAVE</Col></Row><Row><Col id=\"TARGET\">save_ldsh_additional</Col><Col id=\"SP\">DAJPR_RTNG_LDSH_ADDITIONAL_SAVE</Col></Row><Row><Col id=\"TARGET\">complete_ldsh</Col><Col id=\"SP\">DAJPR_RTNG_LDSH_COMPLETE</Col></Row><Row><Col id=\"TARGET\">select_rtng_std</Col><Col id=\"SP\">DAXPR_RTNG_STD_CODEFIND</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staStatusOpen","2","5","190","40",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataTop.form.divStatus.form);
            obj.set_taborder("2");
            obj.set_text("평가오픈");
            ...
            obj = new Grid("objGridSub","0","sta02:5",null,null,"0","275",null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form);
            ...
            obj.set_taborder("0");
            obj.set_cssclass("sta_TITLE_Bg");
            obj.set_text("나는 기회가 된다면 향후에도 이 리더와 함꼐 일하고 싶다. ( ※ 리더 본인평가 : 나는 구성원들이 함께 일하고 싶어하는 리더이다.)");
            ...
            obj = new Static("sta05","0","rdoCTN_WRK:10","100%","22",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_TITLE_Bg");
            obj.set_text("작성하신 내용은 평가 대상자에게 피드백 되지 않으며, 철저하게 비밀이 보장 되오니 솔직한 의견을 가감없이 구체적으로 작성해 주시기 바랍니다. ");
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.addChild(obj.name, obj);

            obj = new Static("staSPNT","0","sta05:10","250","50",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("4");
            obj.set_text("1");
            obj.set_cssclass("sta_WF_tablelabel");
            ...
            obj = new TextArea("txtSPNT","staSPNT:-1","staSPNT:-50",null,"50","0",null,null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("2");
            obj.set_maxlength("2000");
            obj.set_wordWrap("char");
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.addChild(obj.name, obj);

            obj = new Static("staSPLM","0","staSPNT:-1","250","50",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("5");
            obj.set_text("2");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new TextArea("txtSPLM","staSPLM:-1","staSPLM:-50",null,"50","0",null,null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("3");
            obj.set_maxlength("2000");
            obj.set_wordWrap("char");
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.addChild(obj.name, obj);

            obj = new Static("staETC","0","txtSPLM:-1","250","50",null,null,null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("5");
            obj.set_text("3");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new TextArea("txtETC","staETC:-1","staETC:-50",null,"50","0",null,null,null,null,null,this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form);
            obj.set_taborder("3");
            obj.set_maxlength("2000");
            obj.set_wordWrap("char");
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.addChild(obj.name, obj);
            ...
            obj = new BindItem("item9","divData.form.divDataRight.form.divDataBottom.form.divAdditional.form.txtETC","value","dsListAdditional","ETC");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divSearch.form.edtCD_RTNG_ASBLNEXT","value","dsSearch","DS_RTNG_ASBLNEXT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAJ_RTNG_LDSH.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.staETC     = this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form.staETC;			// 기타
        	this.txtETC     = this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form.txtETC;
        }
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAJ_RTNG_LDSH_BGVDPRSN");
        	this.dxGrid.BeforeUserDataSetParam = "fnGridBeforeUserDataSetParam";
        	this.dxGrid.AfterCDTextChanged     = "fnGridAfterCDTextChanged";
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DA", "DAJ_RTNG_LDSH");
        ...
        this.fnSetParameter = function() {
        	// 리더십 피평가자 조회
        	this.dsSelectLdshRtngprsn = new Dataset();
        	this.dsSelectLdshRtngprsn.addColumn("CD_CORP", "string");
        	this.dsSelectLdshRtngprsn.addColumn("ID_RTNG", "string");
        	this.dsSelectLdshRtngprsn.addColumn("ID_SABUN", "string");

        	// 리더십평가 역량 요약 조회
        	this.dsSelectLdshSummary = new Dataset();
        	this.dsSelectLdshSummary.addColumn("CD_CORP", "string");
        	this.dsSelectLdshSummary.addColumn("ID_RTNG", "string");
        	this.dsSelectLdshSummary.addColumn("ID_SABUN_BGVD", "string");
        	this.dsSelectLdshSummary.addColumn("ID_SABUN_RTNG", "string");

        	// 리더십평가 역량 평가항목 조회
        	this.dsSelectLdsh = new Dataset();
        	this.dsSelectLdsh.addColumn("CD_CORP", "string");
        	this.dsSelectLdsh.addColumn("ID_RTNG", "string");
        	this.dsSelectLdsh.addColumn("ID_SABUN_BGVD", "string");
        	this.dsSelectLdsh.addColumn("ID_SABUN_RTNG", "string");

        	// 리더십평가 역량 추가 평가항목 조회
        	this.dsSelectLdshAdditional = new Dataset();
        	this.dsSelectLdshAdditional.addColumn("CD_CORP", "string");
        	this.dsSelectLdshAdditional.addColumn("ID_RTNG", "string");
        	this.dsSelectLdshAdditional.addColumn("ID_SABUN_BGVD", "string");
        	this.dsSelectLdshAdditional.addColumn("ID_SABUN_RTNG", "string");
        	...
        	// 리더십평가 역량 평가 답변 저장
        	this.dsSaveLdsh = new Dataset();
        	this.dsSaveLdsh.addColumn("CD_CORP", "string");
        	this.dsSaveLdsh.addColumn("ID_RTNG", "string");
        	this.dsSaveLdsh.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsSaveLdsh.addColumn("SEQ_RTNGPRSN", "int");
        	this.dsSaveLdsh.addColumn("SEQ_ITEM", "int");
        	this.dsSaveLdsh.addColumn("CD_CTRN", "string");
        	this.dsSaveLdsh.addColumn("ID_SABUN", "string");

        	// 리더십평가 역량 추가 평가항목 저장
        	this.dsSaveLdshAdditional = new Dataset();
        	this.dsSaveLdshAdditional.addColumn("CD_CORP", "string");
        	this.dsSaveLdshAdditional.addColumn("ID_RTNG", "string");
        	this.dsSaveLdshAdditional.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsSaveLdshAdditional.addColumn("SEQ_RTNGPRSN", "int");
        	this.dsSaveLdshAdditional.addColumn("CTN_WRK", "int");
        	this.dsSaveLdshAdditional.addColumn("SPNT", "string");
        	this.dsSaveLdshAdditional.addColumn("SPLM", "string");
        	this.dsSaveLdshAdditional.addColumn("ETC", "string");
        	this.dsSaveLdshAdditional.addColumn("ID_SABUN", "string");

        	// 리더십평가 역량 평가완료
        	this.dsCompleteLdsh = new Dataset();
        	this.dsCompleteLdsh.addColumn("CD_CORP", "string");
        	this.dsCompleteLdsh.addColumn("ID_RTNG", "string");
        	this.dsCompleteLdsh.addColumn("SEQ_BGVDPRSN", "int");
        	this.dsCompleteLdsh.addColumn("SEQ_RTNGPRSN", "int");
        	this.dsCompleteLdsh.addColumn("ID_SABUN", "string");
        ...
        this.fnInit = function() {
        	...
        	// 리더십 추가 역량평가
        	this.staSPNT.set_text("1. 리더로서 장점");
        	this.staSPLM.set_text("2. 리더로서 아쉬운 점");
        	this.staETC.set_text("3. 기타");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelectLdshRtngprsn.clearData();
        	this.dsSelectLdshRtngprsn.addRow();
        	this.dsSelectLdshRtngprsn.setColumn(0, "CD_CORP" , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSelectLdshRtngprsn.setColumn(0, "ID_RTNG" , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSelectLdshRtngprsn.setColumn(0, "ID_SABUN", this.dsSearch.getColumn(0, "ID_SABUN"));

        	var strSvcId    = "select_ldsh_rtngprsn";
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "select_ldsh_rtngprsn=dsSelectLdshRtngprsn";
        	var outData     = "dsList=select_ldsh_rtngprsn0";
        	var strArg      = "";
        ...
        this.fnSelectSub = function() {
        	...
        	// 리더십평가 피평가자/평가자 요약 정보
        	this.dsSelectLdshSummary.clearData();
        	this.dsSelectLdshSummary.addRow();
        	this.dsSelectLdshSummary.setColumn(0, "CD_CORP"      , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSelectLdshSummary.setColumn(0, "ID_RTNG"      , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSelectLdshSummary.setColumn(0, "ID_SABUN_BGVD", this.dsList.getColumn(this.dsList.rowposition, "ID_SABUN"));
        	this.dsSelectLdshSummary.setColumn(0, "ID_SABUN_RTNG", this.dsSearch.getColumn(0, "ID_SABUN"));

        	// 리더십평가 역량 평가항목 조회
        	this.dsSelectLdsh.clearData();
        	this.dsSelectLdsh.addRow();
        	this.dsSelectLdsh.setColumn(0, "CD_CORP"      , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSelectLdsh.setColumn(0, "ID_RTNG"      , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSelectLdsh.setColumn(0, "ID_SABUN_BGVD", this.dsList.getColumn(this.dsList.rowposition, "ID_SABUN"));
        	this.dsSelectLdsh.setColumn(0, "ID_SABUN_RTNG", this.dsSearch.getColumn(0, "ID_SABUN"));

        	// 리더십평가 역량 추가 평가항목 조회
        	this.dsSelectLdshAdditional.clearData();
        	this.dsSelectLdshAdditional.addRow();
        	this.dsSelectLdshAdditional.setColumn(0, "CD_CORP"      , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSelectLdshAdditional.setColumn(0, "ID_RTNG"      , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSelectLdshAdditional.setColumn(0, "ID_SABUN_BGVD", this.dsList.getColumn(this.dsList.rowposition, "ID_SABUN"));
        	this.dsSelectLdshAdditional.setColumn(0, "ID_SABUN_RTNG", this.dsSearch.getColumn(0, "ID_SABUN"));
        	...
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "select_ldsh_summary=dsSelectLdshSummary select_ldsh=dsSelectLdsh select_ctrn=dsSelectCtrn select_ldsh_additional=dsSelectLdshAdditional";
        	var outData     = "dsListSummary=select_ldsh_summary0 dsListSub=select_ldsh0 dsListCtrn=select_ctrn0 dsListAdditional=select_ldsh_additional0";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	// 리더십 피평가자 조회
        	if (svcID == "select_ldsh_rtngprsn") {
        		this.gfnGridAfterSelect(this.dxGrid);
        		this.fnClearSummary();
        		this.gfnGridClear(this.dxGridSub);
        	}
        	// 리더십평가 요약, 역량 질문지 및 평가척도 조회
        	else if (svcID == "select_ldsh") {
        		// 평가대상자
        		...
        		this.txtSPNT.set_value(this.dsListAdditional.getColumn(0, "SPNT"));
        		this.txtSPLM.set_value(this.dsListAdditional.getColumn(0, "SPLM"));
        		this.txtETC.set_value(this.dsListAdditional.getColumn(0, "ETC"));
        	}
        	// 리더십평가 평가척도 저장
        	else if (svcID == "save_ldsh") {
         		this.fnSelectSub();
        		this.FormBtns.Select.click();
        	}
        	// 리더십평가 완료
        	else if (svcID == "complete_ldsh") {
        		this.fnSelectSub();
        		this.FormBtns.Select.click();
        	}
        	// 평가대상자 존재 여부에 따른 화면 제어
        		...
        		if (this.dsListRtngStd.rowcount == 0) {
        			this.gfnAlert("평가대상자가 존재하지 않습니다.\n확인 버튼을 누르면 리더십다면평가 화면이 닫힙니다.", "", "", function() {
        ...
        this.fnCheckExtensionButtonStatus = function() {
        	...
        	if (this.dsListAdditional.getColumn(0, "SPNT").length == 0 ||	// 강점
        		...
        		//this.dsListAdditional.getColumn(0, "ETC").length == 0		// 기타
        	) {
        		CD_CTRN_ALL = false;
        	}
        ...
        this.fnBeforeUserDataSetParam = function(id, dsUserParam, nrow) {
        	if (id == "ccfCD_CORP") {
        		...
        		dsUserParam.setColumn(nrow, "CD_RTNG_TYPE", "JA02");
        ...
        this.fnClearSummary = function() {
        	...
        	this.txtETC.set_value("");		// 기타
        }

        // 임시저장버튼 클릭이벤트
        this.btnSave_onclick = function(obj, e) {
        	var msg = "리더십평가를 임시저장하시겠습니까?";
        ...
        this.btnSave_onclick_callback = function() {
        	...
        	this.dsSaveLdsh.clearData();
        	for (var i = 0; i < this.dsListSub.rowcount; i++) {
        		var flag = this.gfnGetFlag(this.dsListSub, i);
        		switch (flag) {
        		case "U":
        			var nrow = this.dsSaveLdsh.addRow();
        			this.dsSaveLdsh.setColumn(nrow, "CD_CORP"     , this.dsListSub.getColumn(i, "CD_CORP"));
        			this.dsSaveLdsh.setColumn(nrow, "ID_RTNG"     , this.dsListSub.getColumn(i, "ID_RTNG"));
        			this.dsSaveLdsh.setColumn(nrow, "SEQ_BGVDPRSN", this.dsListSummary.getColumn(0, "SEQ_BGVDPRSN"));
        			this.dsSaveLdsh.setColumn(nrow, "SEQ_RTNGPRSN", this.dsListSummary.getColumn(0, "SEQ_RTNGPRSN"));
        			this.dsSaveLdsh.setColumn(nrow, "SEQ_ITEM"    , this.dsListSub.getColumn(i, "SEQ_ITEM"));
        			this.dsSaveLdsh.setColumn(nrow, "CD_CTRN"     , this.dsListSub.getColumn(i, "CD_CTRN"));
        			this.dsSaveLdsh.setColumn(nrow, "ID_SABUN"    , this.AuthClient.ID_USER);
        			break;
        		}
        	}

        	this.dsSaveLdshAdditional.clearData();
        	var nrow = this.dsSaveLdshAdditional.addRow();
        	this.dsSaveLdshAdditional.setColumn(nrow, "CD_CORP"      , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsSaveLdshAdditional.setColumn(nrow, "ID_RTNG"      , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsSaveLdshAdditional.setColumn(nrow, "SEQ_BGVDPRSN" , this.dsListSummary.getColumn(0, "SEQ_BGVDPRSN"));
        	this.dsSaveLdshAdditional.setColumn(nrow, "SEQ_RTNGPRSN" , this.dsListSummary.getColumn(0, "SEQ_RTNGPRSN"));
        	this.dsSaveLdshAdditional.setColumn(nrow, "CTN_WRK"      , this.rdoCTN_WRK.value);
        	this.dsSaveLdshAdditional.setColumn(nrow, "SPNT"         , this.txtSPNT.value);
        	this.dsSaveLdshAdditional.setColumn(nrow, "SPLM"         , this.txtSPLM.value);
        	this.dsSaveLdshAdditional.setColumn(nrow, "ETC"          , this.txtETC.value);
        	this.dsSaveLdshAdditional.setColumn(nrow, "ID_SABUN"     , this.AuthClient.ID_USER);

        	var inDataText = "";
        	if (this.dsSaveLdsh.rowcount > 0) {
        		inDataText += "save_ldsh=dsSaveLdsh"
        	}
        	if (this.dsSaveLdshAdditional.rowcount > 0) {
        		if (inDataText.length > 0) {
        			inDataText += " "
        		}
        		inDataText += "save_ldsh_additional=dsSaveLdshAdditional"
        	}

        	var strSvcId    = "save_ldsh";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        ...
        this.btnSubmit_onclick = function(obj, e) {
        	this.gfnConfirm("리더십평가를 제출하시겠습니까?", function(strId, val) {
        		if (val == false) {
        			return;
        		}

        // 		if (this.rdoCTN_WRK.value == 0) {
        // 			this.gfnConfirm("'나는 기회가 된다면 향후에도 이 리더와 함께 일하고 싶다' 항목을\n'0' 선택하였습니다. 맞습니까?", function(strId, val) {
        // 				if (val == false) {
        // 					return;
        // 				}
        //
        // 				this.btnSumbit_onclick_callback();
        // 			})
        // 		} else {
        // 			this.btnSumbit_onclick_callback();
        // 		}
        ...
        this.btnSumbit_onclick_callback = function() {
        	this.dxGridSub.updateToDataset();
        	this.dsCompleteLdsh.clearData();
        	var nrow = this.dsCompleteLdsh.addRow();
        	this.dsCompleteLdsh.setColumn(nrow, "CD_CORP"     , this.dsSearch.getColumn(0, "CD_CORP"));
        	this.dsCompleteLdsh.setColumn(nrow, "ID_RTNG"     , this.dsSearch.getColumn(0, "ID_RTNG"));
        	this.dsCompleteLdsh.setColumn(nrow, "SEQ_BGVDPRSN", this.dsListSummary.getColumn(0, "SEQ_BGVDPRSN"));
        	this.dsCompleteLdsh.setColumn(nrow, "SEQ_RTNGPRSN", this.dsListSummary.getColumn(0, "SEQ_RTNGPRSN"));
        	this.dsCompleteLdsh.setColumn(nrow, "ID_SABUN"    , this.AuthClient.ID_USER);

        	if (this.dsCompleteLdsh.rowcount == 0) return;

        	var strSvcId    = "complete_ldsh";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "complete_ldsh=dsCompleteLdsh";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.checkTarget = function() {
        	...
        	this.dsSelectRtngStd.setColumn(0, "CD_RTNG_TYPE", "JA02");
        	this.dsSelectRtngStd.setColumn(0, "ID_SCREEN", "");
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataRight.form.divDataBottom.form.divAdditional.form.staETC.addEventHandler("onclick",this.divData_divDataRight_divDataTop_divSummary_staRTNGPRSN_onclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DAJ_RTNG_LDSH.xfdl");
