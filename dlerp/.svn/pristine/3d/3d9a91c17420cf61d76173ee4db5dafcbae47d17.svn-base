(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_HNAME\" type=\"STRING\" size=\"256\"/><Column id=\"DT_WORK\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_POSITION\" type=\"STRING\" size=\"256\"/><Column id=\"TY_GUBUN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Div("divData","0","0",null,"700","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Div("divDataInfo","0","divDataMaster:10",null,"490","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta01","0","30","150","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("0");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta02","sta01:-1","30","270","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta00","sta02:-1","30","150","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("2");
            obj.set_text("부서");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new Static("sta03","sta00:-1","30",null,"30","0",null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta04","567","59",null,"30","0",null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta05","418","59","150","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("5");
            obj.set_text("직위");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new Static("sta06","149","59","270","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("6");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta07","0","59","150","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("7");
            obj.set_text("성명");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new Static("sta08","567","88",null,"30","0",null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta09","418","88","150","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("9");
            obj.set_text("구분");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new Static("sta10","149","88","270","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta11","0","88","150","30",null,null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("11");
            obj.set_text("계획근무일");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new Static("staTopTitle","0","0",null,"22","440",null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("12");
            obj.set_text("기본정보");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("staTopTitle2","0","sta11:10",null,"22","440",null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("5");
            obj.set_text("계획일정");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataInfo.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","staTopTitle2:10",null,"330","0",null,null,null,null,null,this.divData.form.divDataInfo.form);
            obj.set_taborder("13");
            obj._setContents("");
            this.divData.form.divDataInfo.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new BindItem("item11","divData.form.divDataMaster.form.sta07","text","dsListMaster","DS_ETITLE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divData.form.divDataInfo.form.sta02","text","dsListInfo","DS_CORP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divData.form.divDataInfo.form.sta06","text","dsListInfo","DS_HNAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","divData.form.divDataInfo.form.sta10","text","dsListInfo","DT_WORK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divData.form.divDataInfo.form.sta08","text","dsListInfo","TY_GUBUN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","divData.form.divDataInfo.form.sta04","text","dsListInfo","DS_POSITION");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item17","divData.form.divDataInfo.form.sta03","text","dsListInfo","DS_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAG_WORKDAY_PLAN_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DA01";	//	52시간계획신청
        ...
        this.fnSetVariable = function() {
        	...
        	//제목
        	//this.txtDS_ETITLE = this.divData.form.divDataMaster.form.txtDS_ETITLE;
        	...
        	this.dxGrid = this.divData.form.divDataInfo.form.objGrid;
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "DT_WORK_START", this.dsListMaster.getColumn(0, "V_PARAM02"));	// 법인코드
        	this.dsSelect.setColumn(0, "DT_WORK_END", this.dsListMaster.getColumn(0, "V_PARAM03"));	// 작성부서
        	this.dsSelect.setColumn(0, "ID_PERSON", this.dsListMaster.getColumn(0, "V_PARAM01"));	// 작성년월
        	...
        	var inProc		= "_dsProc";
         	...
         	var outData     = "dsListInfo=select0 dsList=select1";		// dsList1=select10
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg) {
        	if (svcID == "init") {
        		...
        		if (this.dsListMaster.rowcount > 0) {
        			...
        			this.btn12.set_visible(this.dsListMaster.getColumn(0, "BTNPNT") != "H");
        			...
        			this.btn12.set_enable(this.dsListMaster.getColumn(0, "BTNPNT") == "Y");
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataInfo.form.objGrid.addEventHandler("oncellclick",this.divData_objGrid_oncellclick,this);
        };
        this.loadIncludeScript("DAG_WORKDAY_PLAN_APP.xfdl");
