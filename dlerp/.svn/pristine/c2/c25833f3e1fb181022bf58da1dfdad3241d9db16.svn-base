(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAZPR_TAXSUBST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAZPR_TAXSUBST_INSERT</Col></Row><Row><Col id=\"SP\">DAZPR_TAXSUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DAZPR_TAXSUBST_DELETE</Col><Col id=\"TARGET\">delete</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAZ_TAXSUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAZ_TAXSUBST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("CD_TAXCODE", "string");
        	this.dsInsert.addColumn("DS_TAXCODE", "string");
        	this.dsInsert.addColumn("RT_TAXSUBST", "int");
        	this.dsInsert.addColumn("MX_TAXSUBST", "int");
        	this.dsInsert.addColumn("NO_RECORD", "int");
        	this.dsInsert.addColumn("ID_INSERT", "string");

            this.dsUpdate = new Dataset();
        	this.dsUpdate.addColumn("YM_BASE", "string");
        	this.dsUpdate.addColumn("CD_TAXCODE", "string");
        	this.dsUpdate.addColumn("DS_TAXCODE", "string");
        	this.dsUpdate.addColumn("RT_TAXSUBST", "int");
        	this.dsUpdate.addColumn("MX_TAXSUBST", "int");
        	...
        	this.dsDelete.addColumn("CD_TAXCODE", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "CD_TAXCODE", this.dsList.getColumn(i, "CD_TAXCODE"));
        				this.dsInsert.setColumn(nrow, "DS_TAXCODE", this.dsList.getColumn(i, "DS_TAXCODE"));
        				this.dsInsert.setColumn(nrow, "RT_TAXSUBST", this.dsList.getColumn(i, "RT_TAXSUBST"));
        				this.dsInsert.setColumn(nrow, "MX_TAXSUBST", this.dsList.getColumn(i, "MX_TAXSUBST"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_TAXCODE", this.dsList.getColumn(i, "CD_TAXCODE"));
        				this.dsUpdate.setColumn(nrow, "DS_TAXCODE", this.dsList.getColumn(i, "DS_TAXCODE"));
        				this.dsUpdate.setColumn(nrow, "RT_TAXSUBST", this.dsList.getColumn(i, "RT_TAXSUBST"));
        				this.dsUpdate.setColumn(nrow, "MX_TAXSUBST", this.dsList.getColumn(i, "MX_TAXSUBST"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "CD_TAXCODE", this.dsList.getColumn(i, "CD_TAXCODE"));
        ...
        this.loadIncludeScript("DAZ_TAXSUBST.xfdl");
