(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFCPR_CHAIPREG_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFCPR_CHAIPREG_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFCPR_CHAIPREG_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFCPR_CHAIPREG_DELETE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo2</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo3</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo4</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo5</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo6</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo7</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo8</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo9</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo10</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo11</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo12</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">e_create</Col><Col id=\"SP\">DFCPR_CHAIPPLAN_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta07","94","377",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("77");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta50_00","214","435","105","29",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            ...
            obj = new MaskEdit("mskAM_HALIN","540","382","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            ...
            obj = new Static("sta28","0","167",null,"22","-1",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("53");
            obj.set_text("원금상환조건");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataRight.addChild(obj.name, obj);
            ...
            obj = new Static("sta33","94","194",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("55");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta34","0","194","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("56");
            obj.set_text("원금상환방법");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta36","213","194","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("57");
            obj.set_text("상환주기(개월)");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("staChitPubPnt","440","194","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("58");
            obj.set_text("상환기준일");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta39","660","194","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("59");
            obj.set_text("상환거치기간");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta45","0","348",null,"22","-1",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("60");
            ...
            obj = new Combo("cboTY_SANG","100","199","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("12");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new MaskEdit("mskTR_SANG","325","199","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("13");
            obj.set_format("#,###,###,##0");
            obj.set_limitbymask("integer");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Calendar("calDT_ORIGINFROM","551","199","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("14");
            ...
            obj = new Static("sta15","0","242",null,"22","-1",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("64");
            obj.set_text("이자지급방식");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta16","94","270",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("65");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta17","0","270","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("66");
            obj.set_text("기준금리");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskRT_EZA","101","275","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("16");
            obj.set_format("#,##0.####");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta18","214","270","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("67");
            obj.set_text("가산금리");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskRT_SPREAD","325","275","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("17");
            obj.set_format("#,##0.####");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta19","440","270","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("68");
            obj.set_text("유형");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_EZA","551","275","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("18");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Static("sta20","660","270","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("69");
            obj.set_text("연동");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_INTLOCK","762","275","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("19");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Static("sta22","94","299",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("70");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta23","0","299","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("71");
            obj.set_text("방식");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_DANBOK","101","304","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("20");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Static("sta24","214","299","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("72");
            obj.set_text("지급일");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskTR_EZASTD","325","304","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("21");
            obj.set_format("#,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta25","440","299","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("73");
            obj.set_text("이자주기(개월)");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskTR_INTTERM","551","304","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("22");
            obj.set_format("#,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta30","660","299","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("74");
            obj.set_text("지급기준");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_SUNHOO","762","304","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("23");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Static("sta35","879","270","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("75");
            obj.set_text("계산방식");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_EZACAL","980","275","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("24");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Static("sta37","879","299","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("76");
            obj.set_text("일수계산");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboTY_YANGDAN","980","304","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("25");
            obj.set_codecolumn("CD_CODE");
            obj.set_datacolumn("DS_CODE");
            ...
            obj = new Static("sta08","0","377","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("78");
            obj.set_text("한도");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CHAMAX","101","382","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("26");
            obj.set_format("#,###,###,###,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta09","214","377","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("80");
            obj.set_text("차입");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_CHAIP","325","382","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("27");
            obj.set_format("#,###,###,###,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta38","651","377","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("81");
            obj.set_text("상환");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta40","903","377","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("82");
            obj.set_text("잔액");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_SANG","763","382","131","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("28");
            obj.set_format("#,###,###,###,###,###,##0");
            ...
            obj = new MaskEdit("mskAM_JAN","1005","382","133","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("29");
            obj.set_format("#,###,###,###,###,###,##0");
            obj.set_autoselect("false");
            obj.set_enable("false");
            ...
            obj = new Static("sta47","94","406",null,"30","0",null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("86");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            obj.set_visible("true");
            ...
            obj = new Static("sta48","651","406","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("87");
            obj.set_text("담보감정가");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta49","439","406","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("88");
            obj.set_text("담보방식");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta50","214","406","105","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("89");
            obj.set_text("담보물건");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Static("sta51","0","406","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("79");
            obj.set_text("담보여부");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new Combo("cboYN_DAMBO","101","411","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("32");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("NAME");
            ...
            obj = new Edit("txtDS_MULGYUN","326","411","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("33");
            obj.set_maxlength("100");
            obj.set_enable("true");
            obj.set_visible("true");
            ...
            obj = new Edit("txtDS_DAMBO","540","411","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("34");
            obj.set_maxlength("100");
            obj.set_enable("true");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_GAM","763","411","131","19",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("35");
            obj.set_format("#,###,###,###,###,###,##0");
            this.divData.form.divDataRight.addChild(obj.name, obj);
            ...
            obj = new Edit("txtQN_DEFFERED","762","199","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("15");
            obj.set_maxlength("100");
            obj.set_enable("false");
            this.divData.form.divDataRight.addChild(obj.name, obj);
            ...
            obj = new Static("sta70","903","406","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("106");
            obj.set_text("담보매매가");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskAM_TRADE","1005","411","133","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            ...
            obj = new Static("sta51_00","439","377","95","30",null,null,null,null,null,null,this.divData.form.divDataRight.form);
            obj.set_taborder("115");
            obj.set_text("할인발행차금");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataRight.addChild(obj.name, obj);

            obj = new MaskEdit("mskRT_YEZA","326","440","105","20",null,null,null,null,null,null,this.divData.form.divDataRight.form);
        ...
        // User Script
        this.registerScript("DFC_CHAIP_REGISTRATION.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.mskAM_CHAIP = this.divData.form.divDataRight.form.mskAM_CHAIP;				// 차입
        	this.mskAM_SANG = this.divData.form.divDataRight.form.mskAM_SANG;				// 상환
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFC_CHAIPREG");
        ...
        this.fnSetCombo = function() {
        	...
        	this.dsCombo2.setColumn(0, "CD_TYPE", "C1");
        	...
        	this.dsCombo3.setColumn(0, "CD_TYPE", "C2");
        	...
        	this.dsCombo4.setColumn(0, "CD_TYPE", "C3");
        	...
        	this.dsCombo5.setColumn(0, "CD_TYPE", "C4");
        	...
        	this.dsCombo6.setColumn(0, "CD_TYPE", "C5");
        	...
        	this.dsCombo7.setColumn(0, "CD_TYPE", "C6");
        	...
        	this.dsCombo8.setColumn(0, "CD_TYPE", "C7");
        	...
        	this.dsCombo9.setColumn(0, "CD_TYPE", "C8");
        	...
        	this.dsCombo10.setColumn(0, "CD_TYPE", "C9");
        	...
        	this.dsCombo12.setColumn(0, "CD_TYPE", "C9");

        	var strSvcId    = "combo";
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "combo=dsCombo combo2=dsCombo2 combo3=dsCombo3 combo4=dsCombo4 combo5=dsCombo5"
        	                + " combo6=dsCombo6 combo7=dsCombo7 combo8=dsCombo8 combo9=dsCombo9 combo10=dsCombo10 combo11=dsCombo11 combo12=dsCombo12";
        	var outData     = "dsTY_DANBOK=combo0 dsTY_RAISE=combo20 dsTY_SANG=combo30 dsTY_EZA=combo40 dsTY_INTLOCK=combo50 dsTY_SUNHOO=combo60"
        	                + " dsTY_EZACAL=combo70 dsTY_YANGDAN=combo80 dsTY_TERM=combo90 dsTY_REPAY1=combo100 dsTY_CMS=combo110 dsTY_REPAY2=combo120";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.loadIncludeScript("DFC_CHAIP_REGISTRATION.xfdl");
