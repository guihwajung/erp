(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOSPR_ITEM_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DOSPR_ITEM_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DOSPR_ITEM_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DOSPR_ITEM_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOS_ITEM.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnCopy = this.gfnFormButtonAdd("btnCopy", "fnCopy", "사업수지항목복사");
        	this.btnSujicode = this.gfnFormButtonAdd("btnBasis", "fnBasis");
        	this.btnSujicode = this.gfnFormButtonAdd("btnSujicode", "fnSujicode", "자금수지항목");
        };
        ...
        this.fnSetEvent = function() {
         	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOS_ITEM");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("CD_ITEMTOT", "string");
        	this.dsInsert.addColumn("YN_USE", "string");
        	this.dsInsert.addColumn("RM_BIGO", "string");
        	this.dsInsert.addColumn("SN_ORDER", "bigdecimal");
        	...
        	this.dsUpdate.addColumn("CD_ITEMTOT", "string");
        	this.dsUpdate.addColumn("YN_USE", "string");
        	this.dsUpdate.addColumn("RM_BIGO", "string");
        	this.dsUpdate.addColumn("SN_ORDER", "bigdecimal");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I" :
        				...
        				this.dsInsert.setColumn(nrow, "CD_ITEMUP", this.dsList.getColumn(i, "CD_ITEMUP"));
        				...
        				this.dsInsert.setColumn(nrow, "TY_SIL", this.dsList.getColumn(i, "TY_SIL"));
        				...
        				this.dsInsert.setColumn(nrow, "CD_ITEMTOT", this.dsList.getColumn(i, "CD_ITEMTOT"));
        			...
        			case "U" :
        				...
        				this.dsUpdate.setColumn(nrow, "CD_ITEMUP", this.dsList.getColumn(i, "CD_ITEMUP"));
        				...
        				this.dsUpdate.setColumn(nrow, "TY_SIL", this.dsList.getColumn(i, "TY_SIL"));
        				...
        				this.dsUpdate.setColumn(nrow, "CD_ITEMTOT", this.dsList.getColumn(i, "CD_ITEMTOT"));
        ...
        this.fnCopy = function(obj,e) {
         	...
         	var param = {};
        	param.CD_PROJF = this.dsSearch.getColumn(0, "CD_PROJ");
        	param.DS_PROJF = this.dsSearch.getColumn(0, "DS_PROJ");

         	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DOS_COPY_DLG", "fnDlgButton_callback", param , 500, 420);
        };

         // 산출근거관리
        this.fnBasis = function(obj,e) {
        	...
        	param.DS_ITEM = this.dsList.getColumn(this.dsList.rowposition, "DS_ITEM");
         	...
         	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DOS_BASIS", "fnDlgButton_callback", param);
        };

         // 자금수지항목
        this.fnSujicode = function(obj,e) {

         	var param = {};
        	param.CD_PROJ = this.dsSearch.getColumn(0, "CD_PROJ");
        	param.DS_PROJ = this.dsSearch.getColumn(0, "DS_PROJ");

         	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DOS_SUJI", "fnDlgButton_callback", param);
        };
        ...
        this.loadIncludeScript("DOS_ITEM.xfdl");
