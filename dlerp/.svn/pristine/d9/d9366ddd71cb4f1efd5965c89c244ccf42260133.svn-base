(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUE_DAMDANG_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCDPR_EVALUE_DAMDANG_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCD_EVALUE_DAMDANG.xfdl", function() {
        ...
        this.fnSetEvent = function()
        {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUE_DAMDANG");
        };
        ...
        {
        	if(id == "DCX_CFBASEINFO" && this.AllChange){
        		this.AllChange = false;
        		...
        		if(cnt > 0)
        		{
        			this.gfnConfirm("체크된 정보의 담당자를 모두 변경 하시겠습니까?", "fnAllDamChange_Callback", sNoId);
        		}
        	}
        };

        this.fnAllDamChange_Callback = function(strId, val)
        {
        	if(val == true)
        	{
        		for (var i = 0; i < this.dsList.rowcount; i++)
        		{
        			...
        			if(chk == '1')
        			{
        				...
        				this.dsList.setColumn(i, "ID_EVALUE", strId);
        			}
        		}
        	}
        }
        ...
        this.loadIncludeScript("DCD_EVALUE_DAMDANG.xfdl");
