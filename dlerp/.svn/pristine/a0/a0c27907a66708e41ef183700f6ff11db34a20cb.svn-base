(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAJPR_EVAL_WEIGHTS_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAJPR_EVAL_WEIGHTS_SAVE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DAXPR_EVAL_TERMS_COMBO</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"TERM_EVAL\" type=\"STRING\" size=\"256\"/><Column id=\"TY_EVAL\" type=\"STRING\" size=\"256\"/><Column id=\"STD_EVAL\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAJ_EVALUATION_WEIGH.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btnItem1 = this.gfnFormButtonAdd("btnCopyEvalWeigh", "fnCopyEvalWeigh");			// 평가가중치복사
        	this.btnItem2 = this.gfnFormButtonAdd("btnEvalWeighDetail", "fnEvalWeighDetail");		// 평가가중치추가
        };
        ...
        this.fnSetEvent = function() {
        	...
        	//그리드
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAJ_EVALUATION_WEIGH");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("SPOT_EVAL", "string");
        	this.dsSave.addColumn("RT_WEIGHTS", "bigdecimal");
        	this.dsSave.addColumn("REF_WEIGHTS", "string");
        ...
        this.fnAdd = function() {
        	...
        	this.fnFormOpenEvalWeighDetail("I");
        }
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "SPOT_EVAL", this.dsList.getColumn(i, "SPOT_EVAL"));
        				this.dsSave.setColumn(nrow, "RT_WEIGHTS", this.dsList.getColumn(i, "RT_WEIGHTS"));
        				this.dsSave.setColumn(nrow, "REF_WEIGHTS", this.dsList.getColumn(i, "REF_WEIGHTS"));
        ...
        this.fnGrid_BeforeUserDataSetParam = function(id, dsUserParam, nrow){
         ...
         this.fnGrid_CellDblclick = function(obj,e){
        	...
        	if(colName == ""){}
        	this.fnFormOpenEvalWeighDetail("U");
        };
        ...
        // 평가가중치 복사
        this.fnCopyEvalWeigh = function(obj, e){
        	//if(this.dsList.rowposition < 0)return;
        	var param = {};
        	param.P_GUBUN  = "WEIGH";	// ITEM(항목) / WEIGH(가중치)
        	param.P_TERM_EVAL = this.dsSearch.getColumn(0, "TERM_EVAL");
        	this.gfnFormOpen("DAJ", "DAJ_EVALUATION_CRITERIA_DLG", "fnCopyEvalWeigh_callback", param, 430, 250);
        };

        this.fnCopyEvalWeigh_callback = function(svcID, val) {
        	if(val){
        		this.FormBtns.Select.click();
        	}
        }
        ...
        // 평가가중치 추가
        this.fnEvalWeighDetail = function(obj, e){
        	this.fnFormOpenEvalWeighDetail("I");
        };

        this.fnFormOpenEvalWeighDetail = function(sTySave) {
        	//if(this.dsList.rowposition < 0) return;
        	var param = {};
        	...
        	// 타 모듈 화면 호출시 지정할것.
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DAJ_EVALUATION_WEIGH_DLG", "fnEvalWeighDetail_callback", param, 650, 420);
        }

        this.fnEvalWeighDetail_callback = function(svcID, val) {
        	if(val){
        		this.FormBtns.Select.click();
        	}
        }
        ...
        this.loadIncludeScript("DAJ_EVALUATION_WEIGH.xfdl");
