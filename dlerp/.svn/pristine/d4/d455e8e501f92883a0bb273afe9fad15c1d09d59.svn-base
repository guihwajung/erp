(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAZPR_LABINCTAXSUBST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAZPR_LABINCTAXSUBST_INSERT</Col></Row><Row><Col id=\"SP\">DAZPR_LABINCTAXSUBST_UPDATE</Col><Col id=\"TARGET\">update</Col></Row><Row><Col id=\"SP\">DAZPR_LABINCTAXSUBST_DELETE</Col><Col id=\"TARGET\">delete</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAZ_LABINCTAXSUBST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAZ_LABINCTAXSUBST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("AM_BASICSUBST", "int");
        	...
        	this.dsUpdate.addColumn("AM_BASICSUBST", "int");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		if(flag == "I" || flag == "U"){
        			if(this.dsList.getColumn(i, "FR_AMOUNT") > this.gfnNvl(this.dsList.getColumn(i, "TO_AMOUNT"), 0)) {
        				var alertMessage = "세액범위[FROM]의 값보다 작은값이 [TO]에 들어갈 수 없습니다.";
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "AM_BASICSUBST", this.dsList.getColumn(i, "AM_BASICSUBST"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "AM_BASICSUBST", this.dsList.getColumn(i, "AM_BASICSUBST"));
        ...
        this.loadIncludeScript("DAZ_LABINCTAXSUBST.xfdl");
