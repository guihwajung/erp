(function()
{
    return function()
    {
        ...
        {
            this.set_name("DBT_DAYSTATESITEJOBPLAN");
            this.set_titletext("작업예정일-현장");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBTPR_DAYSTATESITEJOBPLAN_SELECT</Col></Row><Row><Col id=\"TARGET\">selectHeader</Col><Col id=\"SP\">DBSPR_CT_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DT_FROM\" type=\"STRING\" size=\"256\"/><Column id=\"DT_TO\" type=\"STRING\" size=\"256\"/><Column id=\"YN_MINWON\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_SITE","staCD_SITE:0.0","10.0","319","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Static("staDT","ccfCD_SITE:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("접수일");
            ...
            obj = new CheckBox("chkYN_MINWON","calDT_TO:0.0","staCD_SITE:10.0","119","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("민원포함여부");
            ...
            obj = new BindItem("item4","divSearch.form.chkYN_MINWON","value","dsSearch","YN_MINWON");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DBT_DAYSTATESITEJOBPLAN.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0, "YN_MINWON", "N");
        };
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBT_DAYSTATESITEJOBPLAN");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("YN_MINWON", "string");
        }
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "YN_MINWON", this.dsSearch.getColumn(0, "YN_MINWON"));
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "selectHeader") { //그리드 헤더
        		...
        		this.dsList.deleteRow(this.dsList.findRow("DS_CTM","평균"));
        ...
        // 		if( this.dsList.getColID(i).search("RT_") > -1){
        ...
        // 	}
        	...
        	for(var i=0;i<this.dsHeader.rowcount;i++){
        		...
        		this.dxGrid.setCellProperty("body", apdCol, "text", "bind:" + "RT_"+colNo);						//컬럼 바인딩
        		this.dxGrid.setCellProperty("summ", apdCol, "displaytype", "number");
        		this.dxGrid.setCellProperty("summ", apdCol, "maskeditformat", "#,##0");
        		this.dxGrid.setCellProperty("summ", apdCol, "text", "expr:nexacro.round(dataset.getCaseAvg('DS_CTM != \"평균\"', 'RT_"+colNo+"'),0)");		//합계 텍스트
        	}

        	//평균처리일수 추가
        	apdCol = this.dxGrid.appendContentsCol();
        	this.dxGrid.setFormatColProperty(apdCol, "size", colSize);
        	this.dxGrid.setCellProperty("head", apdCol, "text", "평균처리일수");
        	this.dxGrid.setCellProperty("body", apdCol, "displaytype", "mask");
        	this.dxGrid.setCellProperty("body", apdCol, "maskeditformat", "#,##0");
        	this.dxGrid.setCellProperty("body", apdCol, "text", "bind:RT_TOT");
        	this.dxGrid.setCellProperty("body", apdCol, "cssclass", "BACK_GangJo");
        	this.dxGrid.setCellProperty("summ", apdCol, "displaytype", "number");
        	this.dxGrid.setCellProperty("summ", apdCol, "text", "expr:nexacro.round(dataset.getCaseAvg('DS_CTM != \"평균\"', 'RT_TOT'),0)");
        ...
        this.loadIncludeScript("DBT_DAYSTATESITEJOBPLAN.xfdl");
