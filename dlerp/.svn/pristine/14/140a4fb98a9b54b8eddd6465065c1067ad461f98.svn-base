(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DUSPR_FILEUP_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DUSPR_FILEUP_SAVE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclYMD_INPUT","staDT_START:0.0","10.0","110","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta01","ctclYMD_INPUT:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("종류");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("ccboNO_FILELIST","sta01:0.0","10.0","220","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            obj.set_innerdataset("dsNO_FILELIST");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","divSearch.form.ctclYMD_INPUT","value","dsSearch","YMD_INPUT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSearch.form.ccboNO_FILELIST","value","dsSearch","NO_FILELIST");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DUS_FILELIST_1.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0, "YMD_INPUT", this.gfnGetDate());
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DU", "DUS_FILELIST_1");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_FILELIST", this.dsSearch.getColumn(0, "NO_FILELIST"));
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "NO_FILELIST", this.dsList.getColumn(i, "NO_FILELIST"));
        				break;
        		}
        	}
        ...
        this.fnSetCombo = function() {
        	...
        	this.dsCombo.addRow();
        	this.dsCombo.setColumn(0, "CD_SYSTEM", "DU");
        	this.dsCombo.setColumn(0, "CD_TYPE", "S1");

        	var strSvcId    = "combo";
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "combo=dsCombo";
        	var outData     = "dsNO_FILELIST=combo0";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg) {
        	if(svcID == "select") {
        		...
        		if (errorCode == 0) {
        			var nrow = this.dsNO_FILELIST.insertRow(0);
        			this.dsNO_FILELIST.setColumn(nrow, "CD_CODE", "");
        			this.dsNO_FILELIST.setColumn(nrow, "DS_CODE", "전체");

        			this.ccboNO_FILELIST.set_index(0);
        		}
        		else {
        			this.gfnAlert(errorMsg);
        		}
        ...
        this.fnGrid_ExpandUp = function(obj, e) {
        	...
        	if(colnm == "DS_FILE") {
        		...
        		fileManager.CD_DIR = [this.dsList.getColumn(e.row, "CD_SITE"), this.dsList.getColumn(e.row, "YMD_INPUT"), this.dsList.getColumn(e.row, "NO_FILELIST")];
        ...
        this.loadIncludeScript("DUS_FILELIST_1.xfdl");
