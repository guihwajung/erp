(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZZPR_USERMODULE_MODULE_SELECT</Col></Row><Row><Col id=\"SP\">DZZPR_USERMODULE_INSERT</Col><Col id=\"TARGET\">insert</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DZZPR_USERMODULE_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DZZPR_USERMODULE_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_MODULE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CORP\"/><Col id=\"CD_MODULE\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stabu","ccfCorp:0","10","79","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_cssclass("sta_WF_SchLabelE");
            obj.set_taborder("1");
            obj.set_text("시스템");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfSystem","stabu:0","10","180","24",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("3");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divSearch.form.ccfSystem.form.CDTextBox","value","dsSearch","CD_MODULE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DZU_USERMODULE_MODULE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DZ", "DZU_USERMODULE_MODULE");
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_MODULE", this.ccfSystem.form.CDTextBox.value);
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "CD_MODULE", this.ccfSystem.form.CDTextBox.value);
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_MODULE", this.ccfSystem.form.CDTextBox.value);
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "CD_MODULE", this.ccfSystem.form.CDTextBox.value);
        ...
        this.fnValidate = function() {
        	...
        	if (this.gfnIsNull(this.ccfSystem.form.CDTextBox.value)) {
        		this.fnVaidateCallback = function() {
        ...
        this.fnGrid_BeforuserDataSetParam=function(id, dsUserParam, nrow){
        	if(id == "DZX_CFUSERBYCORP"){
        	...
        	}else if(id == "DZX_CFGYUMDEPT"){
        		if(!this.gfnIsNull(this.ccfCorp.form.CDTextBox.value) && !this.gfnIsNull(this.dsList.getColumn(this.dsList.rowposition, "ID_USER"))){
        			dsUserParam.setColumn(nrow, "CD_CORP", this.ccfCorp.form.CDTextBox.value);
        			dsUserParam.setColumn(nrow, "ID_USER", this.dsList.getColumn(this.dsList.rowposition, "ID_USER"));
        		}else{
        			var alertMsg = "";
        			if(this.gfnIsNull(this.dsList.getColumn(this.dsList.rowposition, "ID_USER"))){
        				alertMsg = "[0.사용자] \n";
        			}
        			if(this.gfnIsNull(this.ccfCorp.form.CDTextBox.value)){
        				alertMsg += "[1.법인코드] \n";
        		...
        		if(!this.gfnIsNull(this.ccfSystem.form.CDTextBox.value)){
        			dsUserParam.setColumn(nrow, "CD_MODULE", this.ccfSystem.form.CDTextBox.value);
        		}else{
        ...
        this.loadIncludeScript("DZU_USERMODULE_MODULE.xfdl");
