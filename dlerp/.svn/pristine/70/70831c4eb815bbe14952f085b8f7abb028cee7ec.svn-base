(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAZPR_COMMONCODE_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAZPR_COMMONCODE_SAVE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DAZPR_ORDER_SELECT</Col></Row><Row><Col id=\"TARGET\">d_save</Col><Col id=\"SP\">DAZPR_ORDER_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staMsg","sta01:0","4",null,"20","0",null,null,null,null,null,this.divData.form.divDataLeft.form);
            obj.set_taborder("2");
            obj.set_text("※ 대분류 코드 입력/수정 시 전산관리자에게 문의하시기 바랍니다.");
            this.divData.form.divDataLeft.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAZ_ORDER.xfdl", function() {
        ...
        this.loadIncludeScript("DAZ_ORDER.xfdl");
