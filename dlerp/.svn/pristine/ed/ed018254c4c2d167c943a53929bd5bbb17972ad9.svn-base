(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCZPR_PUNISHLIST_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DCZPR_PUNISH_SAVE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("tclDT_FROM","staCD_PERIOD:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new Static("staCD_TILDE","tclDT_FROM:0.0","10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("~");
            obj.set_cssclass("sta_WF_AC");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("tclDT_TO","staCD_TILDE:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new BindItem("item0","divSearch.form.tclDT_TO","value","dsSearch","DT_TO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.tclDT_FROM","value","dsSearch","DT_FROM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCZ_PUNISHLIST.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	this.btn1 = this.gfnFormButtonAdd("PunishReg", "fnPunishReg");
        	this.btn2 = this.gfnFormButtonAdd("PunishRelease", "fnPunishRelease");
        };
        ...
        this.fnSetVariable = function() {
        	...
        	this.tclDT_FROM = this.divSearch.form.tclDT_FROM;
        	this.tclDT_TO = this.divSearch.form.tclDT_TO;
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCZ_PUNISHLIST");
        ...
        //	this.dsSelect.setColumn(0, "TY_MODULE", "DC");
        	...
        	for(var i = 0; i < this.dsList.rowcount;i++)
        	{
        		...
        		switch(flag)
        		{
        			...
        			case "D" :
        				...
        				this.dsSave.setColumn(nrow, "TY_MODULE", "DC");
        			break;
        		}
        	}
        ...
        //
        // this.fnPunishReg = function(obj:nexacro.Button,e:nexacro.ClickEventInfo) {
        //
        // 	var param = {};
        //
        // 	// 화면 오픈.
        ...
        // 	// 타 모듈 화면 호출시 지정할것.
        // 	this.gfnFormOpenNonAuth("DCA", "DCA_PUNISH_DLG_REG", "fnPunishReg_callback", param);
        // }
        //
        //
        //
        // this.fnPunishRelease = function(obj:nexacro.Button,e:nexacro.ClickEventInfo) {
        //
        // 	var param = {};
        //
        ...
        // 	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        // 	// 타 모듈 화면 호출시 지정할것.
        // 	this.gfnFormOpenNonAuth("DCA", "DCA_PUNISH_DLG_RELEASE", "fnPunishRelease_callback", param, 450, 600);
        // }
        //
        // this.fnPunishReg_callback = function(svcID, value)
        // {
        // 	if(value == true)
        // 	{
        // 		this.FormBtns.Select.click();
        ...
        // }
        //
        // this.fnPunishRelease_callback = function(svcID, value)
        // {
        // 	if(value == true)
        // 	{
        // 		this.FormBtns.Select.click();
        ...
        this.loadIncludeScript("DCZ_PUNISHLIST.xfdl");
