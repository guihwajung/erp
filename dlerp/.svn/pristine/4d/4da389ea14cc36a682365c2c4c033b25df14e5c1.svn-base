(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"NO_IN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_IN\" type=\"STRING\" size=\"256\"/><Column id=\"CD_IN\" type=\"STRING\" size=\"256\"/><Column id=\"CD_OWNER\" type=\"STRING\" size=\"256\"/><Column id=\"NO_OUT\" type=\"STRING\" size=\"256\"/><Column id=\"TY_OUT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_OUT\" type=\"STRING\" size=\"256\"/><Column id=\"TY_TRAN\" type=\"STRING\" size=\"256\"/><Column id=\"DS_OUT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_IN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta01","20","39","80","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("입금계좌");
            ...
            obj = new Static("staBg2","sta01:-1","39",null,"30","20",null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            ...
            obj = new Div("cfCD_IN","sta01:5","44","285","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Button("btnSave","37%","137","50","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("전송");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancel","50.00%","137","50","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("취소");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta02_00","20","97","80","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("9");
            obj.set_text("이체구분");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_tablelabelE");
            ...
            obj = new Static("staBg00_00","99","97",null,"30","20",null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Combo("ccboTY_TRAN","105","102","150","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("11");
            ...
            obj = new BindItem("item3","divData.form.cfCD_IN.form.DSTextBox","value","dsList","DS_IN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divData.form.cfCD_OUT.form.DSTextBox","value","dsList","DS_OUT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFB_DLG_BRANCH.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DFB_DLG_BRANCH.xfdl");
