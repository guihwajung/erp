(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DT_ACCOUNT\" type=\"STRING\" size=\"256\"/><Column id=\"ID_USER\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CAR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT\" type=\"STRING\" size=\"256\"/><Column id=\"INSURANCE_PAY\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
        ...
        // User Script
        this.registerScript("DHA_CAR_DLG.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if(!this.gfnIsNull(this.getOwnerFrame().CD_CAR)) {
        		...
        		this.dsList.setColumn(0, "CD_CAR", this.pvCD_CAR);
        ...
        this.dlgfnSave = function() {
        	...
        	this.dsSlip.setColumn(nrow, "CD_CAR", this.pvCD_CAR );
        ...
        trace("this.dsSlip >>>>>>>"+this.pvCD_CAR );
        ...
        this.loadIncludeScript("DHA_CAR_DLG.xfdl");
