(function()
{
    return function()
    {
        ...
        {
            this.set_name("DLF_COUNSEL");
            this.set_titletext("별도계약상담관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRFPR_COUNSEL_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DRFPR_COUNSEL_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DRFPR_COUNSEL_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DRFPR_COUNSEL_DELETE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DRFPR_CONTRACTDETAIL_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staNO_RECPOST","0","116","127","30",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_text("현주소");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("right");
            ...
            obj = new Edit("txtNO_RECPOST","132","120","63","22",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("34");
            obj.set_value("");
            obj.set_maxlength("40");
            obj.set_readonly("true");
            ...
            obj = new BindItem("item10","divData.form.txtNO_RECPOST","value","dsDetail","NO_RECPOST");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DLF_COUNSEL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLF_COUNSEL");
        ...
        this.loadIncludeScript("DLF_COUNSEL.xfdl");
