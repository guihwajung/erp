(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUERESULT_SITE_MAGAM_SELECT</Col></Row><Row><Col id=\"TARGET\">exec_magam</Col><Col id=\"SP\">DCDPR_EVALUERESULT_SITE_MAGAM_CONFIRM</Col></Row><Row><Col id=\"TARGET\">exec_magamcl</Col><Col id=\"SP\">DCDPR_EVALUERESULT_SITE_MAGAM_CANCEL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCD_EVALUERESULT_SITE_MAGAM.xfdl", function() {
        ...
        this.loadIncludeScript("DCD_EVALUERESULT_SITE_MAGAM.xfdl");
