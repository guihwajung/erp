(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_MAINTAINPRE_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DBSPR_MAINTAINPRE_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DBSPR_MAINTAINPRE_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DBSPR_MAINTAINPRE_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBS_MAINTAINPRE.xfdl", function() {
        ...
        this.loadIncludeScript("DBS_MAINTAINPRE.xfdl");
