(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_SITE_STATUS_DM_SELECT</Col></Row><Row><Col id=\"TARGET\">year</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_YEAR_MAX_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_SITE","ccfNO_SEQ:0.0","10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("현장코드");
            ...
            obj = new Static("staDS_VENDOR","0.0","staYR_MAGAM:10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("업체명");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_REGIST","ctxtDS_VENDOR:0.0","staYR_MAGAM:10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("업체등록시기");
            ...
            obj = new Static("staAM_SCORE","ccboTY_REGIST:0.0","staYR_MAGAM:10.0","118.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("총점");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_SITE_STATUS_DM.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DCD_EVALUEMAGAM_SITE_STATUS_DM");
        };
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_SITE_STATUS_DM.xfdl");
