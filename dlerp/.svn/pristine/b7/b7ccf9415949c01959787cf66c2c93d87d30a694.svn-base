(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_MAX_SELECT</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_EXECUTE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DWB_HDLEDGER_LIST.xfdl", function() {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.objGrid.addEventHandler("oncelldblclick",this.divData_divDataLeft_objGrid_oncelldblclick,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
            this.dsListSubCal.addEventHandler("oncolumnchanged",this.dsListSubCal_oncolumnchanged,this);
        };
        this.loadIncludeScript("DWB_HDLEDGER_LIST.xfdl");
