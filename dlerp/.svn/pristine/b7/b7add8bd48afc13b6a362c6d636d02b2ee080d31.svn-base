(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_MONTH_SELECT</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_MAX_SELECT</Col></Row><Row><Col id=\"TARGET\">execute</Col><Col id=\"SP\">DWBPR_HDGISUNGMONTH_EXECUTE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cboNO_DGR","sta00:0.0","10.0","30","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
        ...
        // User Script
        this.registerScript("DWB_HDGISUNG_LIST.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DWB_HDGISUNG_LIST.xfdl");
