(function()
{
    return function()
    {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnFileDown = this.gfnFormButtonAdd("btnFileDown", "fnFileDown");
        };
        ...
        */
        ...
        // 이미지파일  다운로드
        this.fnFileDown = function(obj,e)
        {
        	...
        	trace("nChkRow =>" + nChkRow);
        	this.fileConfig = this.gfnGetFileConfig();
        	var sFilename = this.dsList.getColumn(nChkRow, "TEMP_PIC");
        	var sFilepath = this.dsList.getColumn(nChkRow, "DS_FILE_PATH").replace(/\//g, "\\");

        	sFilepath = this.gfnLeft(sFilepath, this.gfnLengthByte(sFilepath) -1);
        	...
        	trace("encodeFileName =>" + sFilename);
