(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCZPR_LICCOSTDISP_FB_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DQCPR_LICCOST_FB_UPDATE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DQCPR_FB_COST_CBS_SELECT</Col></Row><Row><Col id=\"TARGET\">d_insert</Col><Col id=\"SP\">DQCPR_FB_COST_CBS_INSERT</Col></Row><Row><Col id=\"TARGET\">d_update</Col><Col id=\"SP\">DQCPR_FB_COST_CBS_UPDATE</Col></Row><Row><Col id=\"TARGET\">d_delete</Col><Col id=\"SP\">DQCPR_FB_COST_CBS_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_LICCOST\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_LICCOST","0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("공종코드");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("ccfCD_LICCOST","staCD_LICCOST:0.0","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new BindItem("item0","divSearch.form.ccfCD_LICCOST.form.CDTextBox","value","dsSearch","CD_LICCOST");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DQC_FB_COST.xfdl", function() {
        ...
        this.loadIncludeScript("DQC_FB_COST.xfdl");
