(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DC_SELECT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo1</Col><Col id=\"SP\">DMXPR_LICCOST_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">except</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DC_EXCEPT</Col></Row><Row><Col id=\"TARGET\">talak</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DC_TALAK</Col></Row><Row><Col id=\"TARGET\">regist</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DC_REGIST</Col></Row><Row><Col id=\"TARGET\">auto</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_AUTO_JUDGE_DC</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DC_CREATE</Col></Row><Row><Col id=\"TARGET\">rejudge</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DC_REJUDGE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCA_JUDGE_REGULAR_EXIST_LIST_DC.xfdl", function() {
        ...
        this.fnReJudge = function()
        {
        	...
        	this.gfnConfirm("해당건을 재평가 하시겠습니까?", "fnReJudge_CallBack");
        }
        ...
        this.loadIncludeScript("DCA_JUDGE_REGULAR_EXIST_LIST_DC.xfdl");
