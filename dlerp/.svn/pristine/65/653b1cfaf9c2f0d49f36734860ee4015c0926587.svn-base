(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DQAPR_PROJECTLIST_SELECT</Col></Row><Row><Col id=\"SP\">DQAPR_PROJECTLIST_SAVE</Col><Col id=\"TARGET\">save</Col></Row><Row><Col id=\"TARGET\">erp</Col><Col id=\"SP\">DQAPR_PROJECTCODE_DEPLOYTOERP</Col></Row><Row><Col id=\"TARGET\">deploySap</Col><Col id=\"SP\">DQAPR_PROJECTCODE_DEPLOYTOSAP</Col></Row><Row><Col id=\"SP\">DQAPR_PROJ_SELECT</Col><Col id=\"TARGET\">select_proj</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"COLUMN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"COLUMN\">CD_BCONTRACT|CD_SAUP|CD_CONST|CD_OPTION|CD_CS|CD_BUNYANG|CD_REFUND|CD_OFFICETEL|CD_COMMECIAL|CD_ADMIN1|CD_ADMIN2|CD_SAUPLOAN</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DQA_PROJECTLIST.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnPS = this.gfnFormButtonAdd("btnPS", "fnPS");
        	this.btnCreateCode = this.gfnFormButtonAdd("btnCreateCode", "fnCreateCode");
        	this.btnCOST = this.gfnFormButtonAdd("btnCOST", "fnCOST");
        	this.btnPROJ = this.gfnFormButtonAdd("btnPROJ", "fnPROJ");
        	this.btnSAPLIST = this.gfnFormButtonAdd("btnSAPLIST", "fnSAPLIST");
        };
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DQ", "DQA_PROJECTLIST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("CD_SITE_A0", "string");
        	this.dsSave.addColumn("CD_SITE_E0", "string");
        	this.dsSave.addColumn("CD_SITE_E1", "string");
        	this.dsSave.addColumn("ID_UPDATE", "string");
        	this.dsSave.addColumn("CD_COST", "string");
        	this.dsSave.addColumn("YR_CONST", "string");
        	this.dsSave.addColumn("FS_CONST", "string");
        	this.dsSave.addColumn("YR_ELECT", "string");
        	this.dsSave.addColumn("FS_ELECT", "string");
        	this.dsSave.addColumn("YR_EQMT", "string");
        	this.dsSave.addColumn("FS_EQMT", "string");
        	this.dsSave.addColumn("YR_CIVIL", "string");
        	this.dsSave.addColumn("FS_CIVIL", "string");
        	this.dsSave.addColumn("CD_FBTYPE", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "CD_SITE_A0", this.dsList.getColumn(i, "CD_SITE_A0"));
        				this.dsSave.setColumn(nrow, "CD_SITE_E0", this.dsList.getColumn(i, "CD_SITE_E0"));
        				this.dsSave.setColumn(nrow, "CD_SITE_E1", this.dsList.getColumn(i, "CD_SITE_E1"));
        				...
        				this.dsSave.setColumn(nrow, "YR_CONST", this.dsList.getColumn(i, "YR_CONST"));
        				this.dsSave.setColumn(nrow, "FS_CONST", this.dsList.getColumn(i, "FS_CONST"));
        				this.dsSave.setColumn(nrow, "YR_ELECT", this.dsList.getColumn(i, "YR_ELECT"));
        				this.dsSave.setColumn(nrow, "FS_ELECT", this.dsList.getColumn(i, "FS_ELECT"));
        				this.dsSave.setColumn(nrow, "YR_EQMT", this.dsList.getColumn(i, "YR_EQMT"));
        				this.dsSave.setColumn(nrow, "FS_EQMT", this.dsList.getColumn(i, "FS_EQMT"));
        				this.dsSave.setColumn(nrow, "YR_CIVIL", this.dsList.getColumn(i, "YR_CIVIL"));
        				this.dsSave.setColumn(nrow, "FS_CIVIL", this.dsList.getColumn(i, "FS_CIVIL"));
        				this.dsSave.setColumn(nrow, "CD_FBTYPE", this.dsList.getColumn(i, "CD_FBTYPE"));
        				break;
        		}
        	}
        ...
        // 		}
        	...
        	else if(svcID == "sap_costcenter_single") {
        		if(this.dsExport.rowcount > 0)
        		{
        			var msg = "";
        ...
        //			}
        	...
        	else if(svcID == "select_proj")
        	{
        		if(this.dsProj.rowcount > 0)
        		{
        			this.gfnAlert(this.dsProj.getColumn(0, "PSPID") + " 프로젝트 코드는 생성되어있습니다.");
        		}
        		else
        		{
        			this.gfnAlert("해당 프로젝트 코드는 생성되지 않았습니다.");
        		}
        	}
        }
        		...
        		if(this.dsList.getColumn(i, "chk") == "1")
        		{
        			...
        			for(var col = 0; col < columnIds.length; col++)
        			{
        				if(!this.gfnIsNull(this.dsList.getColumn(i, columnIds[col])))
        				{
        					...
        					var ds_code = this.fnGetCostCenterDS_CODE(columnIds[col]);
        ...
        //
        // 					var type = this.dsList.getColumn(i, columnIds[col]).substr(0,1);
        // 					var costcenter_type = "";
        //
        // 					if(type == "B")
        // 					{
        ...
        this.fnCreateCode = function(obj,e) {
            ...
            */
        	...
        	this.gfnFormOpenNonAuth(this.FormInfo.CD_MODULE, "DQA_PRJ_MANAGEMENT", "", param,  842, 420);
        ...
        // 현장정보 버튼 이벤트.
         this.fnSite = function(obj,e) {
        	...
        	*/
        	...
        	if(this.gfnIsNull(this.dsList.getColumn(this.dsList.rowposition, "CD_CONST"))){
        		this.gfnAlert("현장코드가 등록 되지 않았습니다.");
        		return;
        	}
        ...
        // 	}
        	...
        	param.CD_SITE = this.dsList.getColumn(this.dsList.rowposition, "CD_CONST");
        	param.DS_SITE = this.dsList.getColumn(this.dsList.rowposition, "DS_CONST");
        ...
        this.fnCOST = function(obj,e) {
        	...
        	for(var i = 0; i < columnIds.length; i++)
        	{
        		if(nColumnid == columnIds[i])
        		{
        			...
        			else
        			{
        				...
        				var nrow = this.dsSelectSap.addRow();
        				// IN 파라미터 셋팅
        				this.dsSelectSap.setColumn(nrow, "COSTCENTER", this.dsList.getColumn(this.dsList.rowposition, nColumnid));
        				this.dsSelectSap.setColumn(nrow, "PROFIT_CTR", this.dsList.getColumn(this.dsList.rowposition, nColumnid));
        				this.dsSelectSap.setColumn(nrow, "PERSON_IN_CHARGE", "관리자");

        				var type = this.dsList.getColumn(this.dsList.rowposition, nColumnid).substr(0,1);
        				var costcenter_type = "";
        				...
        				var ds_code = this.fnGetCostCenterDS_CODE(nColumnid);

        				this.dsSelectSap.setColumn(nrow, "COSTCENTER_TYPE", costcenter_type);
        				this.dsSelectSap.setColumn(nrow, "COSTCTR_HIER_GRP", 4520);
        				this.dsSelectSap.setColumn(nrow, "CURRENCY", "KRW");
        				this.dsSelectSap.setColumn(nrow, "NAME", this.dsList.getColumn(this.dsList.rowposition, "DS_PROJECT") + ds_code);
        				this.dsSelectSap.setColumn(nrow, "DESCRIPT", this.dsList.getColumn(this.dsList.rowposition, "DS_PROJECT") + ds_code);
        				this.dsSelectSap.setColumn(nrow, "VALID_FROM", "19600101");
        				this.dsSelectSap.setColumn(nrow, "VALID_TO", "99991231");
        				this.dsSelectSap.setColumn(nrow, "COMP_CODE", "HD00");
        	...
        	if(check == false)
        	{
        		this.gfnAlert("CostCenter 데이터를 선택해주세요.");
        		return false;
        	}

        	// SAP 호출
        	var strSvcId    = "sap_costcenter_single";
        	var strSvcType  = "sap";
        	var inProc		= "_dsProcSap";
        	var inData      = "select=dsSap IN_IT_DATA=dsSelectSap";
        	var outData     = "dsExport=export dsSapCostCenter=ET_RETURN";
        ...
        this.fnPROJ = function(obj,e) {
        	...
        	this.dsProj = new Dataset();
        	this.dsProj.addColumn("CD_CODE", "string");
        	...
        	if(check == false)
        	{
        		// 위의 코스트센터 체크로직에는 본공사의 코드는 빠져있음.
        		if(nColumnid == "CD_PROJECT")
        		{
        			cd_code = this.dsList.getColumn(this.dsList.rowposition, "CD_PROJECT");
        		}
        		else
        		{
        	...
        	this.dsProj.addRow();
        	this.dsProj.setColumn(0, "CD_CODE", cd_code);

        	var strSvcId    = "select_proj";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
        	var inData      = "select_proj=dsProj";
        	var outData     = "dsProj=select_proj0";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnSapSelect = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }
        ...
        // 프로젝트코드수정 버튼 이벤트.
        this.fnSAP_UPDATE = function(obj,e) {
        	if(this.dsList.rowposition < 0) return;
        ...
        this.fnSAP_UPDATE_Callback = function(strID, val)
        {
        	if(val == true)
        	{
        		this.FormBtns.Select.click();
        		...
        		if(this.dsList.getColumn(i, "chk") == "1")
        		{
        			...
        			for(var col = 0; col < columnIds.length; col++)
        			{
        				if(!this.gfnIsNull(this.dsList.getColumn(i, columnIds[col])))
        				{
        					...
        					this.dsSap.setColumn(nrow, "I_PSPID", this.dsList.getColumn(i, columnIds[col]));
        ...
        this.fnSAPLIST = function()
        {
        	if(this.dsList.rowposition < 0) return;

        	var param = {};
        	param.CD_PROJECT = this.dsList.getColumn(this.dsList.rowposition, "CD_PROJECT");
        	this.gfnFormOpenNonAuth(this.FormInfo.CD_MODULE, "DQA_PROJECTLIST_SAPLIST", "", param);
        }
        ...
        this.loadIncludeScript("DQA_PROJECTLIST.xfdl");
