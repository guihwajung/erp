(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWAPR_RISKAPRV_V2_SELECT</Col></Row><Row><Col id=\"SP\">DWAPR_RISKAPRV_V2_EXECUTE</Col><Col id=\"TARGET\">exec</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DWAPR_RISKDTLS_V2_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("ctxtNO_SILHENG",null,"10.0","200","24.0","10",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_value("");
        ...
        // User Script
        this.registerScript("DWA_RISKAPRV_V2.xfdl", function() {
        ...
        */
        ...
        this.fnAprvRstor = function(obj,e) {
        ...
        this.loadIncludeScript("DWA_RISKAPRV_V2.xfdl");
