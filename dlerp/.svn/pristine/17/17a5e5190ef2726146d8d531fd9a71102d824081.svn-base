(function()
{
    return function()
    {
        ...
        {
            this.set_name("DLM_PLAN");
            this.set_titletext("임대계획-매출");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLMPR_PLAN_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DLMPR_PLAN_UPDATE</Col></Row><Row><Col id=\"SP\">DLMPR_PLAN_CREATE</Col><Col id=\"TARGET\">create</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_PLAN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YR_PLAN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ctclYR_PLAN","staCD_ACNTUNIT:0.0","10.0","60","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("DLM_PLAN.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnDetail = this.gfnFormButtonAdd("Detail", "fnDetail");	//상세실적
        };
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLM_PLAN");
        ...
        this.fnDetail = function(obj,e) {
        	if(this.gfnIsNull(this.dsSearch.getColumn(0, "YR_PLAN"))){
        		this.gfnAlert("계획년도를 입력하세요.");
        		this.ctclYR_PLAN.form.TextBox.setFocus();
        		return false;
        	}

        	var param = {};
        	param.YEAR = this.dsSearch.getColumn(0, "YR_PLAN")-1;

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DLM_EXEC", "", param);
        }
        ...
        this.loadIncludeScript("DLM_PLAN.xfdl");
