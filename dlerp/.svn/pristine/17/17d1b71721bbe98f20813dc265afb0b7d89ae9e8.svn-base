(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("수주-공통-프로젝트 관계사관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DOAPR_ARCH_CONCERN</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DOAPR_ARCH_CONCERN_MERGE</Col></Row><Row><Col id=\"TARGET\">selectCharge</Col><Col id=\"SP\">DOAPR_PROJ_YNCHARGE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DOZ_PROJ_CONCERN.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DO", "DOZ_PROJ_CONCERN");
        ...
        this.fnGrid_AfterCDTextChanged = function(id, codeFindData) {
        	if(id == "DOX_CFVENDOR_DH") {
        		...
        		if(arr.length > 0) {
        			...
        			if(chkCnt > 1){
        				this.gfnAlert("관계사 코드 중복입니다.");
        				this.dsList.setColumn(this.dsList.rowposition,"CD_CONCERN","");
        				this.dsList.setColumn(this.dsList.rowposition,"NM_CONCERN","");
        				return false;
        			}
        		}
        	}
        ...
        this.loadIncludeScript("DOZ_PROJ_CONCERN.xfdl");
