(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1270,700);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("_dsProc", this);
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DZZPR_APPROVAL_CALLBACK</Col></Row><Row><Col id=\"SP\">DZRPR_MRC_LIST_SELECT</Col><Col id=\"TARGET\">select</Col></Row><Row><Col id=\"SP\">DZRPR_MRC_LIST_UPDATE</Col><Col id=\"TARGET\">save</Col></Row></Rows>");
            ...
            obj = new Static("staDS_SITE","0","40","66","86",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("의견");
            ...
            obj = new Static("staBg1","staDS_SITE:-1","40",null,"86","0.00%",null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnOk","40.63%","666","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("확인");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancel","btnOk:31.67%","666","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("4");
            obj.set_text("취소");
            this.divData.addChild(obj.name, obj);

            obj = new TextArea("txtDS_NOTE","71","45",null,"75","6",null,null,null,null,null,this.divData.form);
            obj.set_taborder("5");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnATTACH",null,"10","63","25","5",null,null,null,null,null,this.divData.form);
            obj.set_taborder("6");
            obj.set_text("첨부파일");
            this.divData.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","staBg1:10",null,"514","0",null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj._setContents("");
            this.divData.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DZR_AP_MRC.xfdl", function() {
        ...
        this.loadIncludeScript("DZR_AP_MRC.xfdl");
