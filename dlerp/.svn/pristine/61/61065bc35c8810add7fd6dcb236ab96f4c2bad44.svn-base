(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_VENDOR_USER_WORK_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DSKPR_VENDOR_USER_WORK_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSK_VENDOR_USER_WORK.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_VENDOR_USER_WORK");
        }
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("CN_WORK", "int");
        ...
        this.fnSave = function() {
        	...
        	for(var i = 0;i<this.dsList.rowcount;i++){
        		var flg =  this.gfnGetFlag(this.dsList, i);
        		if(flg == "I" || flg == "U" || flg == "D"){
        			var nrow = this.dsSave.addRow();

        			this.dsSave.setColumn(nrow, "CD_SITE", this.ccfCD_SITE.form.CDTextBox.value);
        			this.dsSave.setColumn(nrow, "DS_SITE", this.ccfCD_SITE.form.DSTextBox.value);
        			...
        			this.dsSave.setColumn(nrow, "DT_WORK", this.divSearch.form.ctclDT_WORK.value);
        			this.dsSave.setColumn(nrow, "TY_WORK", this.dsList.getColumn(i, "TY_WORK"));
        			this.dsSave.setColumn(nrow, "CN_WORK", this.dsList.getColumn(i, "CN_WORK"));
        		}
        	}
        ...
        this.loadIncludeScript("DSK_VENDOR_USER_WORK.xfdl");
