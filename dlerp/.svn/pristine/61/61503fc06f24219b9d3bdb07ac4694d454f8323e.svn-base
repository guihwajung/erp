(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"INT\" size=\"4\"/><Column id=\"VALUE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">-1</Col><Col id=\"VALUE\">작성</Col></Row><Row><Col id=\"VALUE\">위탁요청</Col><Col id=\"CODE\">0</Col></Row><Row><Col id=\"CODE\">1</Col><Col id=\"VALUE\">위탁반려</Col></Row><Row><Col id=\"CODE\">2</Col><Col id=\"VALUE\">위탁확인</Col></Row><Row><Col id=\"CODE\">4</Col><Col id=\"VALUE\">검수요청</Col></Row><Row><Col id=\"CODE\">5</Col><Col id=\"VALUE\">검수반려</Col></Row><Row><Col id=\"CODE\">6</Col><Col id=\"VALUE\">검수완료</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnWork_2","76.50%","27","60","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Button("btnFile","61.00%","27","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            obj.set_text("파일첨부");
            obj.set_enable("false");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new Button("btnWork_5","84.25%","27","60","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Button("btnWork_6","92.00%","27","60","20",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Button("btnWork_1","68.75%","27","60","20",null,null,null,null,null,null,this.divData.form);
        ...
        // User Script
        this.registerScript("DCH_WORKORDER_RESPONSE.xfdl", function() {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.btnWork_5.addEventHandler("onclick",this.fnWorkBtnClick,this);
            this.divData.form.btnWork_6.addEventHandler("onclick",this.fnWorkBtnClick,this);
        ...
        this.loadIncludeScript("DCH_WORKORDER_RESPONSE.xfdl");
