(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staYM_WORK00","cchkAM_PAYSCHD:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("*증빙월이 다를경우 강조됩니다.");
            obj.set_color("red");
        ...
        // User Script
        this.addIncludeScript("DWB_HDGISUNGSLIP.xfdl",'lib::libCommon.xjs');
        this.registerScript("DWB_HDGISUNGSLIP.xfdl", function() {
        this.executeIncludeScript('lib::libCommon.xjs'); /*include 'lib::libCommon.xjs'*/
        this.objApp = this.gfnGetApplication();
        this.selSlipNo;
        var yn_Gw = ""; // 링크로 페이지 오픈 했는지 유무
        var no_Slip = ""; // 링크로 페이지 오픈 시 전표번호 받아서 저장
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	// 링크로 페이지 오픈 시 전표번호 받아서 저장
        	this.no_Slip = this.getOwnerFrame().NO_SLIP;
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelectLedger.addColumn("NO_DGR", "string");
        };
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_SLIP", this.no_Slip);
        ...
        */
        ...
        this.fnLedger_rpt = function(){
        	...
        	this.dsSelectLedger.setColumn(nrow, "NO_DGR", this.dsList.getColumn(this.dsList.rowposition, "NO_DGR"));
        ...
        this.loadIncludeScript("DWB_HDGISUNGSLIP.xfdl");
