(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("출금요청 및 집행현황 조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFBPR_REQUEST_STATUS_SELECT</Col></Row><Row><Col id=\"TARGET\">print</Col><Col id=\"SP\">DFBPR_REQUEST_STATUS_PRINT</Col></Row><Row><Col id=\"TARGET\">fileinfo</Col><Col id=\"SP\">DZUPR_FILEMANAGER_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"TY_PAYMENT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPTOPER\" type=\"STRING\" size=\"256\"/><Column id=\"DS_DEPTOPER\" type=\"STRING\" size=\"256\"/><Column id=\"TY_SEARCH\" type=\"STRING\" size=\"256\"/><Column id=\"DT_REQ_FR\" type=\"STRING\" size=\"256\"/><Column id=\"DT_REQ_TO\" type=\"STRING\" size=\"256\"/><Column id=\"CD_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SEARCH\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCorpCd","staCorpCd:0.0","10.0","282","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new Combo("cboTY_SEARCH","ccfCorpCd:10","10.0","103","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var divSearch_form_cboTY_SEARCH_innerdataset = new nexacro.NormalDataset("divSearch_form_cboTY_SEARCH_innerdataset", obj);
            divSearch_form_cboTY_SEARCH_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">0</Col><Col id=\"datacolumn\">집행요청일자</Col></Row><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">집행일자</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_cboTY_SEARCH_innerdataset);
            obj.set_text("집행요청일자");
            obj.set_value("0");
            obj.set_index("0");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("calDtFromReq","cboTY_SEARCH:5","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new Static("staCD_TILDE","calDtFromReq:0.0","10.0","30.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("~");
            obj.set_cssclass("sta_WF_AC");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("calDtToReq","staCD_TILDE:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Div("ccfAcntUnitCd","sta03:0.0","staCorpCd:10.0","282","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("3");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta01","ccfAcntUnitCd:0.0","staCorpCd:10.0","118","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("거래처코드");
            obj.set_textDecoration("none");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Div("ccfVendorCd","sta01:0.0","staCorpCd:10.0","282","24.0",null,null,null,null,null,null,this.divSearch.form);
            ...
            obj = new BindItem("item0","divSearch.form.ccfCorpCd.form.CDTextBox","value","dsSearch","CD_CORP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.ccfCorpCd.form.DSTextBox","value","dsSearch","DS_CORP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.cboTY_SEARCH","value","dsSearch","TY_SEARCH");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.ccfAcntUnitCd.form.CDTextBox","value","dsSearch","CD_DEPTOPER");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSearch.form.ccfAcntUnitCd.form.DSTextBox","value","dsSearch","DS_DEPTOPER");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch.form.calDtFromReq","value","dsSearch","DT_REQ_FR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divSearch.form.calDtToReq","value","dsSearch","DT_REQ_TO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divSearch.form.ccfVendorCd.form.CDTextBox","value","dsSearch","CD_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divSearch.form.ccfVendorCd.form.DSTextBox","value","dsSearch","DS_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divSearch.form.cboTY_SEARCH","text","dsSearch","DS_SEARCH");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DFB_REQUESTSTATUS.xfdl", function() {
        ...
        // 이체영수증출력
        this.fnPrintTrnsfRcpt = function(obj,e) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.calDtFromReq.addEventHandler("onchanged",this.fnSearchInit,this);
            this.divSearch.form.calDtToReq.addEventHandler("onchanged",this.fnSearchInit,this);
            this.divData.form.objGrid.addEventHandler("oncelldblclick",this.divData_objGrid_oncelldblclick,this);
            this.dsList.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
            this.dsList.addEventHandler("onrowposchanged",this.dsList_onrowposchanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DFB_REQUESTSTATUS.xfdl");
