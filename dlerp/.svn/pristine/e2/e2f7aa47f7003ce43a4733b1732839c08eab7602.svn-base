(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAV_HOUSEMONEY");
            this.set_titletext("금전소비대차 계약");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAVPR_HOUSEMONEY_SELECT</Col></Row><Row><Col id=\"TARGET\">closeCheck</Col><Col id=\"SP\">DAVPR_CLOSE_CHECK2</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DAVPR_HOUSEMONEY_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DAVPR_HOUSEMONEY_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DAVPR_HOUSEMONEY_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAV_HOUSEMONEY.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAV_HOUSEMONEY");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DS_NAME_MONEY", "string");
        	this.dsInsert.addColumn("ID_RESIDENT_MONEY", "string");
        	this.dsInsert.addColumn("DT_FROM_MONEY", "string");
        	this.dsInsert.addColumn("DT_TO_MONEY", "string");
        	this.dsInsert.addColumn("RT_REF", "string");
        	this.dsInsert.addColumn("AM_ORIGINMONEY", "string");
        	this.dsInsert.addColumn("AM_MONEY", "string");
        	...
        	this.dsUpdate.addColumn("DS_NAME_MONEY", "string");
        	this.dsUpdate.addColumn("ID_RESIDENT_MONEY", "string");
        	this.dsUpdate.addColumn("DT_FROM_MONEY", "string");
        	this.dsUpdate.addColumn("DT_TO_MONEY", "string");
        	this.dsUpdate.addColumn("RT_REF", "string");
        	this.dsUpdate.addColumn("AM_ORIGINMONEY", "string");
        	this.dsUpdate.addColumn("AM_MONEY", "string");
        	...
        	this.dsDelete.addColumn("DS_NAME_MONEY", "string");
        	this.dsDelete.addColumn("ID_RESIDENT_MONEY", "string");
        	this.dsDelete.addColumn("DT_FROM_MONEY", "string");
        	this.dsDelete.addColumn("DT_TO_MONEY", "string");
        	this.dsDelete.addColumn("RT_REF", "string");
        	this.dsDelete.addColumn("AM_ORIGINMONEY", "string");
        	this.dsDelete.addColumn("AM_MONEY", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DS_NAME_MONEY", this.dsList.getColumn(i, "DS_NAME_MONEY"));
        				this.dsInsert.setColumn(nrow, "ID_RESIDENT_MONEY", this.dsList.getColumn(i, "ID_RESIDENT_MONEY"));
        				this.dsInsert.setColumn(nrow, "DT_FROM_MONEY", this.dsList.getColumn(i, "DT_FROM_MONEY"));
        				this.dsInsert.setColumn(nrow, "DT_TO_MONEY", this.dsList.getColumn(i, "DT_TO_MONEY"));
        				this.dsInsert.setColumn(nrow, "RT_REF", this.dsList.getColumn(i, "RT_REF"));
        				this.dsInsert.setColumn(nrow, "AM_ORIGINMONEY", this.dsList.getColumn(i, "AM_ORIGINMONEY"));
        				this.dsInsert.setColumn(nrow, "AM_MONEY", this.dsList.getColumn(i, "AM_MONEY"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "DS_NAME_MONEY", this.dsList.getColumn(i, "DS_NAME_MONEY"));
        				this.dsUpdate.setColumn(nrow, "ID_RESIDENT_MONEY", this.dsList.getColumn(i, "ID_RESIDENT_MONEY").replace(/-/g,""));
        				this.dsUpdate.setColumn(nrow, "DT_FROM_MONEY", this.dsList.getColumn(i, "DT_FROM_MONEY"));
        				this.dsUpdate.setColumn(nrow, "DT_TO_MONEY", this.dsList.getColumn(i, "DT_TO_MONEY"));
        				this.dsUpdate.setColumn(nrow, "RT_REF", this.dsList.getColumn(i, "RT_REF"));
        				this.dsUpdate.setColumn(nrow, "AM_ORIGINMONEY", this.dsList.getColumn(i, "AM_ORIGINMONEY"));
        				this.dsUpdate.setColumn(nrow, "AM_MONEY", this.dsList.getColumn(i, "AM_MONEY"));
        			...
        			case "D":
        				...
        				this.dsDelete.setColumn(nrow, "DS_NAME_MONEY", this.dsList.getColumn(i, "DS_NAME_MONEY"));
        				this.dsDelete.setColumn(nrow, "ID_RESIDENT_MONEY", this.dsList.getColumn(i, "ID_RESIDENT_MONEY").replace(/-/g,""));
        				this.dsDelete.setColumn(nrow, "DT_FROM_MONEY", this.dsList.getColumn(i, "DT_FROM_MONEY"));
        				this.dsDelete.setColumn(nrow, "DT_TO_MONEY", this.dsList.getColumn(i, "DT_TO_MONEY"));
        				this.dsDelete.setColumn(nrow, "RT_REF", this.dsList.getColumn(i, "RT_REF"));
        				this.dsDelete.setColumn(nrow, "AM_ORIGINMONEY", this.dsList.getColumn(i, "AM_ORIGINMONEY"));
        				this.dsDelete.setColumn(nrow, "AM_MONEY", this.dsList.getColumn(i, "AM_MONEY"));
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("DAV_HOUSEMONEY.xfdl");
