(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCAPR_REGISTLIST_SELECT</Col></Row><Row><Col id=\"TARGET\">exec</Col><Col id=\"SP\">DCZPR_IDMANAGEAPPROVAL_PW_INIT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_CODE_LIST_SELECT</Col></Row><Row><Col id=\"TARGET\">print</Col><Col id=\"SP\">DCAPR_REGIST_HISTORY_PRINT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCA_REGISTLIST.xfdl", function() {
        ...
        // 협력업체대장출력 버튼 클릭시 이벤트
        this.fnRegPrint = function(obj,e) {
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }
        ...
        this.loadIncludeScript("DCA_REGISTLIST.xfdl");
