(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("ctxtCD_ACNTUNIT","sta00:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("sta03","ctxtDS_ACNTUNIT:0.0","10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("동층호");
            ...
            obj = new Div("divSplitter","0","57%","100%","5",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            ...
            obj = new Static("sta00","0","0","100.00%","22",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("0");
            obj.set_text("기본정보");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta01","0","32","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("1");
            obj.set_text("평형");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta02","sta01:-1","32","225","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta03","sta02:-1","32","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("3");
            obj.set_text("군/OPTION");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta04","sta03:-1","32","270","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta05","sta04:-1","32","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("5");
            obj.set_text("입주일자");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta06","sta05:-1","32",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("6");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta07","0","sta01:-1","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("7");
            obj.set_text("별도계약");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta08","sta07:-1","sta02:-1","225","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("sta10","sta09:-1","sta04:-1","270","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta11","sta10:-1","sta05:-1","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("11");
            obj.set_text("입주기산일자");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta12","sta11:-1","sta06:-1",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta13","0","sta07:-1","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("13");
            obj.set_text("계약일자");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta14","sta13:-1","sta08:-1","225","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("sta16","sta15:-1","sta10:-1","270","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta17","sta16:-1","sta11:-1","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("17");
            obj.set_text("재계약");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta18","sta17:-1","sta12:-1",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("18");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta19","0","sta13:-1","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("19");
            obj.set_text("계약자명");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta20","sta19:-1","sta14:-1","225","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("20");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("sta22","sta21:-1","sta16:-1","270","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("22");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta23","sta22:-1","sta17:-1","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("23");
            obj.set_text("계약구분");
            ...
            obj = new Static("sta25","0","sta19:-1","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("25");
            obj.set_text("☎(자택)");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta26","sta25:-1","sta20:-1","225","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta27","sta26:-1","sta21:-1","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("27");
            obj.set_text("☎(직장)");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta28","sta27:-1","sta22:-1","270","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("28");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta29","sta28:-1","sta23:-1","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("29");
            obj.set_text("휴대폰");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta30","sta29:-1","sta24:-1",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta31","0","sta25:-1","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("31");
            obj.set_text("사업자번호");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta32","sta31:-1","sta26:-1","225","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("32");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta33","sta32:-1","sta27:-1","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("33");
            obj.set_text("업태");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta34","sta33:-1","sta28:-1","270","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("34");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Static("sta36","sta35:-1","sta30:-1",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("36");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta37","0","sta31:-1","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("37");
            obj.set_text("상호");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta38","sta37:-1","sta32:-1","618","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("38");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta41","sta38:-1","sta35:-1","125","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("39");
            obj.set_text("e_Mail");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta42","sta41:-1","sta36:-1",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("40");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta43","0","sta37:-1","100","50",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("41");
            obj.set_text("명의변경사유");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta44","sta43:-1","sta38:-1",null,"50","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("42");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta45","0","sta43:-1","100","50",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("43");
            obj.set_text("특이사항");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta46","sta45:-1","sta44:-1",null,"50","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("44");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta47","0","343","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("45");
            obj.set_text("약정분양금");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta48","sta47:-1","343","140","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("46");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta49","sta48:-1","343","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("47");
            obj.set_text("수납분양금");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta50","sta49:-1","343","140","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("48");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta51","sta50:-1","343","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("49");
            obj.set_text("월임대료");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta52","sta51:-1","343","140","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("50");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta53","sta52:-1","343","100","30",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("51");
            obj.set_text("전표번호");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta54","sta53:-1","343",null,"30","0",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("52");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new MaskEdit("txtNO_SIZE","sta01:5","sta02:-25","100","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("53");
            obj.set_value("");
            obj.set_format("#,###.0000");
            obj.set_readonly("true");
            ...
            obj = new Static("sta55","txtNO_SIZE:5","sta02:-25","30","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("54");
            obj.set_text("면적");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtTY_TYPE","sta55:10","sta02:-25","20","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("55");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta56","txtTY_TYPE:5","sta02:-25","20","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("56");
            obj.set_text("형");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtTY_DISTRICT","sta03:5","sta04:-25","30","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("57");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Div("cfRT_OPTION","txtTY_DISTRICT:5","sta04:-25","220","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            ...
            obj = new Calendar("tclDT_IPJUPLAN","sta05:5","sta06:-25","105","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("59");
            ...
            obj = new Edit("txtYN_OPTION","sta07:5","sta08:-25","110","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("60");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtTY_STATE","sta09:5","sta10:-25","80","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("61");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Static("sta57","txtTY_STATE:10","sta10:-25","50","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("62");
            obj.set_text("분양구분");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtTY_BUNYANG","sta57:5","sta10:-25","80","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("63");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Calendar("tclDT_IPJUPLAN_G","sta11:5","sta12:-25","105","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("64");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Calendar("tclDT_CONTRACT","sta13:5","sta14:-25","105","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("65");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Calendar("tclDT_LEASE_FR","sta15:5","sta16:-25","105","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("66");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new Static("sta58","tclDT_LEASE_FR:10","sta16:-25","20","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("67");
            obj.set_text("~");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Calendar("tclDT_LEASE_TO","sta58:0","sta16:-25","105","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("68");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyyMMdd");
            obj.set_autoselect("true");
            ...
            obj = new MaskEdit("txtNO_RENEW","sta17:5","sta18:-25","80","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("69");
            obj.set_value("");
            obj.set_format("#,###");
            obj.set_readonly("true");
            ...
            obj = new Static("sta59","txtNO_RENEW:5","sta18:-25","20","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("70");
            obj.set_text("차");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtDS_CONTRACTOR","sta19:5","sta20:-25","110","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("71");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtNO_JUMIN","sta21:5","sta22:-25","140","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("72");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Radio("rdoTY_CONTRACTOR","sta23:5","sta24:-25","187","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("73");
            ...
            obj = new Edit("txtNO_TEL","sta25:5","sta26:-25","110","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("74");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtNO_OFFICETEL","sta27:5","sta28:-25","140","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("75");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtNO_MOBILE","sta29:5","sta30:-25","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("76");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtCD_VENDOR","sta31:5","sta32:-25","140","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("77");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtDS_UPTAE","sta33:5","sta34:-25","140","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("78");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtDS_UPJONG","sta35:5","sta36:-25","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("79");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtDS_VENDOR","sta37:5","sta38:-25","210","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("80");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new Edit("txtDS_EMAIL","sta41:5","sta42:-25","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("81");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new TextArea("txtDS_TRANSFER","sta43:5","sta44:-45","917","40",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("82");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new TextArea("txtDS_REMARK","sta45:5","sta46:-45","917","40",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("83");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new MaskEdit("txtAM_BUNYANGPLAN","sta47:5","sta48:-25","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("84");
            obj.set_format("#,###");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new MaskEdit("txtAM_BUNYANGGET","sta49:5","sta50:-25","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("85");
            obj.set_format("#,###");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new MaskEdit("txtAM_MLEASE","sta51:5","sta52:-25","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("86");
            obj.set_format("#,###");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);

            obj = new MaskEdit("txtCD_SLIP","sta53:5","sta54:-25","120","20",null,null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("87");
            obj.set_format("#,###");
            obj.set_readonly("true");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Button("btnReceiptUpdate",null,"5","70","20","10",null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab1.form);
            obj.set_taborder("1");
            obj.set_text("수납정정");
            this.divData.form.divDataBottom.form.tabData.tab1.addChild(obj.name, obj);

            obj = new Button("btnReceiptCancel",null,"5","70","20","btnReceiptUpdate:5",null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab1.form);
            obj.set_taborder("1");
            obj.set_text("수납취소");
            this.divData.form.divDataBottom.form.tabData.tab1.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk_SUNAP",null,"5","50","20","btnReceipt:10",null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab1.form);
            obj.set_taborder("4");
            obj.set_text("수납");
            ...
            obj = new CheckBox("chk_GOJI",null,"5","50","20","chk_SUNAP:5",null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab1.form);
            obj.set_taborder("4");
            obj.set_text("고지");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new CheckBox("chk_MISU",null,"5","50","20","chk_GOJI:5",null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab1.form);
            obj.set_taborder("4");
            obj.set_text("미수");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new Static("sta00","5","5",null,"22","5",null,null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab4.form);
            obj.set_taborder("1");
            obj.set_text("계상내역");
            obj.set_cssclass("sta_TITLE_Bg");
            this.divData.form.divDataBottom.form.tabData.tab4.addChild(obj.name, obj);

            obj = new Grid("objGrid4","5","sta00:5",null,null,"5","5",null,null,null,null,this.divData.form.divDataBottom.form.tabData.tab4.form);
            obj.set_taborder("1");
            obj._setContents("");
            this.divData.form.divDataBottom.form.tabData.tab4.addChild(obj.name, obj);
            ...
            obj = new BindItem("item7","divData.form.divDataTop.form.txtNO_SIZE","value","dsList","NO_SIZE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","divData.form.divDataTop.form.txtTY_TYPE","value","dsList","TY_TYPE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divData.form.divDataTop.form.txtTY_DISTRICT","value","dsList","TY_DISTRICT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divData.form.divDataTop.form.cfRT_OPTION.form.CDTextBox","value","dsList","RT_OPTION");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","divData.form.divDataTop.form.cfRT_OPTION.form.DSTextBox","value","dsList","DS_OPTION");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","divData.form.divDataTop.form.tclDT_IPJUPLAN","value","dsList","DT_IPJUPLAN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divData.form.divDataTop.form.txtYN_OPTION","value","dsList","YN_OPTION");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","divData.form.divDataTop.form.txtTY_STATE","value","dsList","TY_STATE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divData.form.divDataTop.form.txtTY_BUNYANG","value","dsList","TY_BUNYANG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","divData.form.divDataTop.form.tclDT_IPJUPLAN_G","value","dsList","DT_IPJU");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item17","divData.form.divDataTop.form.tclDT_CONTRACT","value","dsList","DT_CONTRACT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item18","divData.form.divDataTop.form.tclDT_LEASE_FR","value","dsList","DT_LEASE_FR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item19","divData.form.divDataTop.form.tclDT_LEASE_TO","value","dsList","DT_LEASE_TO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item20","divData.form.divDataTop.form.txtNO_RENEW","value","dsList","NO_RENEW");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item21","divData.form.divDataTop.form.txtDS_CONTRACTOR","value","dsList","DS_CONTRACTOR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item22","divData.form.divDataTop.form.txtNO_JUMIN","value","dsList","NO_JUMIN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item23","divData.form.divDataTop.form.rdoTY_CONTRACTOR","value","dsList","TY_CONTRACTOR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item24","divData.form.divDataTop.form.txtNO_TEL","value","dsList","NO_TEL");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item25","divData.form.divDataTop.form.txtNO_OFFICETEL","value","dsList","NO_OFFICETEL");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item26","divData.form.divDataTop.form.txtNO_MOBILE","value","dsList","NO_MOBILE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item27","divData.form.divDataTop.form.txtCD_VENDOR","value","dsList","CD_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item28","divData.form.divDataTop.form.txtDS_UPTAE","value","dsList","DS_UPTAE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item29","divData.form.divDataTop.form.txtDS_UPJONG","value","dsList","DS_UPJONG");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item30","divData.form.divDataTop.form.txtDS_VENDOR","value","dsList","DS_VENDOR1");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item32","divData.form.divDataTop.form.txtDS_EMAIL","value","dsList","DS_EMAIL");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item33","divData.form.divDataTop.form.txtDS_TRANSFER","value","dsList","DS_TRANSFER");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item34","divData.form.divDataTop.form.txtDS_REMARK","value","dsList","DS_REMARK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item35","divData.form.divDataTop.form.txtAM_BUNYANGPLAN","value","dsList","AM_BUNYANGPLAN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item36","divData.form.divDataTop.form.txtAM_BUNYANGGET","value","dsList","AM_BUNYANGGET");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item37","divData.form.divDataTop.form.txtAM_MLEASE","value","dsList","AM_MLEASE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item38","divData.form.divDataTop.form.txtCD_SLIP","value","dsList","CD_SLIP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DLC_RESIDENTMANAGE.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnEstReceipt = this.gfnFormButtonAdd("EstReceipt", "fnEstReceipt");	//예상수납
        ...
        this.fnSetVariable = function() {
        	...
        	this.tclDT_IPJUPLAN = this.divData.form.divDataTop.form.tclDT_IPJUPLAN;
        	this.tclDT_IPJUPLAN_G = this.divData.form.divDataTop.form.tclDT_IPJUPLAN_G;
        	this.sta05 = this.divData.form.divDataTop.form.sta05;
        	this.sta37 = this.divData.form.divDataTop.form.sta37;
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid2, this.dsList2, "DL", "DLB_CONTRACTOR_3");
        	this.gfnGridInit(this.dxGrid3, this.dsList3, "DL", "DLB_CONTRACTOR_4");
        ...
        this.fnSelect = function() {
        	...
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
          	var inData      = "select=dsSelect select1=dsSelect select2=dsSelect select3=dsSelect select4=dsSelect select5=dsSelect select6=dsSelect selectBasic=dsSelectBasic";
          	var outData     = "dsList=select0 dsList1=select10 dsList2=select20 dsList3=select30 dsList4=select40 dsList5=select50 dsList6=select60 dsBasic=selectBasic0";
        	var strArg      = "";
        	...
        	for (var i = 0; i < this.dsList2.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert2.setColumn(nrow, "NO_DONG", this.dsSearch.getColumn(0, "NO_DONG"));
        				this.dsInsert2.setColumn(nrow, "NO_FLOOR", this.dsSearch.getColumn(0, "NO_FLOOR"));
        				this.dsInsert2.setColumn(nrow, "NO_HO", this.dsSearch.getColumn(0, "NO_HO"));
        			...
        			case "U":
        				...
        				this.dsUpdate2.setColumn(nrow, "NO_DONG", this.dsSearch.getColumn(0, "NO_DONG"));
        				this.dsUpdate2.setColumn(nrow, "NO_FLOOR", this.dsSearch.getColumn(0, "NO_FLOOR"));
        				this.dsUpdate2.setColumn(nrow, "NO_HO", this.dsSearch.getColumn(0, "NO_HO"));
        			...
        			case "D":
        				...
        				this.dsDelete2.setColumn(nrow, "NO_DONG", this.dsSearch.getColumn(0, "NO_DONG"));
        				this.dsDelete2.setColumn(nrow, "NO_FLOOR", this.dsSearch.getColumn(0, "NO_FLOOR"));
        				this.dsDelete2.setColumn(nrow, "NO_HO", this.dsSearch.getColumn(0, "NO_HO"));
        	...
        	if (svcID == "select") {
        		...
        		if (this.dsMsg.rowcount > 0) {
        			if (this.gfnNvl(this.dsMsg.getColumn(0, "MSG")).length > 0) {
        				this.fnSelectMsg_Callback = function() {
        					this.FormBtns.Select.click();
        				}
        				this.gfnAlert(this.dsMsg.getColumn(0, "MSG"), "fnSelectMsg_Callback");
        				return;
        			}
        			this.FormBtns.Select.click();
        		}
        ...
        this.fnSelectDetailAfter = function() {
        	...
        	if (hasDT_CONTRACT) {
        		...
        		this.btnEstReceipt.set_enable(false);
        		...
        		this.btnEstReceipt.set_enable(true);
        ...
        this.fnQuitApply = function(obj,e) {
        	...
        	var strDongFloorHo = this.dsSearch.getColumn(0, "NO_DONG") + "동"
        ...
        //예상수납
        this.fnEstReceipt = function(obj,e) {
        	var param = {};
        	param.CD_ACNTUNIT = this.dsSearch.getColumn(0, "CD_ACNTUNIT");
        	param.DS_ACNTUNIT = this.dsSearch.getColumn(0, "DS_ACNTUNIT");
        	param.NO_DONG = this.dsSearch.getColumn(0, "NO_DONG");
        	...
        	this.gfnFormOpen("DLC", "DLC_DLGESTRECEIPT", "", param);
        }
        ...
        //수납정정
        this.divData_divDataBottom_tabData_tab1_btnReceiptUpdate_onclick = function(obj,e) {
        	if (this.dsList1.rowcount == 0) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataBottom.form.tabData.tab1.form.btnReceiptUpdate.addEventHandler("onclick",this.divData_divDataBottom_tabData_tab1_btnReceiptUpdate_onclick,this);
            ...
            this.divData.form.divDataBottom.form.tabData.tab1.form.chk_SUNAP.addEventHandler("onchanged",this.chk_SUNAP_onchanged,this);
            this.divData.form.divDataBottom.form.tabData.tab1.form.chk_GOJI.addEventHandler("onchanged",this.chk_GOJI_onchanged,this);
            this.divData.form.divDataBottom.form.tabData.tab1.form.chk_MISU.addEventHandler("onchanged",this.chk_MISU_onchanged,this);
            this.dsList.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
        };
        this.loadIncludeScript("DLC_RESIDENTMANAGE.xfdl");
