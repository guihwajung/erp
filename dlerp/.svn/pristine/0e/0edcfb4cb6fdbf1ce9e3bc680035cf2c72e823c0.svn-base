(function()
{
    return function()
    {
        ...
        {
            this.set_name("DLM_SIZEPLAN");
            this.set_titletext("임대계획-면적");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DLMPR_SIZEPLAN_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DLMPR_SIZEPLAN_UPDATE</Col></Row><Row><Col id=\"SP\">DLMPR_SIZEPLAN_CREATE</Col><Col id=\"TARGET\">create</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DLM_SIZEPLAN.xfdl", function() {
        ...
        this.loadIncludeScript("DLM_SIZEPLAN.xfdl");
