(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DLA_ASSIGN_HOUSE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DL", "DLA_ASSIGN_HOUSE");
        };
        ...
        this.fnAuto = function()
        {
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DLA_DLG_AUTO_ASSIGN", "fnAuto_callback", param);
        }
        ...
        this.loadIncludeScript("DLA_ASSIGN_HOUSE.xfdl");
