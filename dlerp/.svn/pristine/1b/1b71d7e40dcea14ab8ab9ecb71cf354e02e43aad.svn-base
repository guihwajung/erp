(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("계정별거래처잔액관리(거래처타입)");
            ...
            obj = new Static("staCD_ACNT","0.0","staCD_CORP:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("계정코드");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_VENDOR","ccfCD_VENDOR:0.0","staCD_CORP:10.0","105.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("거래처타입");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboTY_VENDOR","staTY_VENDOR:0.0","staCD_CORP:10.0","88","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var divSearch_form_cboTY_VENDOR_innerdataset = new nexacro.NormalDataset("divSearch_form_cboTY_VENDOR_innerdataset", obj);
            divSearch_form_cboTY_VENDOR_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"datacolumn\">사원</Col><Col id=\"codecolumn\">S</Col></Row><Row><Col id=\"datacolumn\">부서</Col><Col id=\"codecolumn\">D</Col></Row><Row><Col id=\"datacolumn\">거래처</Col><Col id=\"codecolumn\">FBX</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_cboTY_VENDOR_innerdataset);
            obj.set_text("cbo00");
            this.divSearch.addChild(obj.name, obj);

            obj = new CheckBox("chkYN_DEPT","cboTY_VENDOR:0.0","staCD_CORP:10.0","140","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("부서별");
            ...
            obj = new BindItem("item10","divSearch.form.cboTY_VENDOR","value","dsSearch","TY_VENDOR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHE_ACCOUNTVENDORSELECT_NEW.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.cboTY_VENDOR = this.divSearch.form.cboTY_VENDOR;
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(nRow, "TY_VENDOR", this.cboTY_VENDOR.value);
        ...
        this.loadIncludeScript("DHE_ACCOUNTVENDORSELECT_NEW.xfdl");
