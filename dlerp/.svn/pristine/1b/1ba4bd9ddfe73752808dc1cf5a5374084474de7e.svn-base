(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCBPR_ESTIMATIONRANKING_SELECT</Col></Row><Row><Col id=\"TARGET\">copy</Col><Col id=\"SP\">DCBPR_BID_EPS_TO_ERP_COPY</Col></Row><Row><Col id=\"SP\">DZZPR_DBMAIL_SMS_SEND</Col><Col id=\"TARGET\">succal</Col></Row><Row><Col id=\"TARGET\">check</Col><Col id=\"SP\">DCBPR_BLIND_CHECK_UPDATE</Col></Row><Row><Col id=\"SP\">DCBPR_ESTIMATION_BLIND_RELEASE</Col><Col id=\"TARGET\">release</Col></Row><Row><Col id=\"TARGET\">succal1</Col><Col id=\"SP\">DCBPR_PUBLISH_BID_UPDATE</Col></Row><Row><Col id=\"TARGET\">open_check</Col><Col id=\"SP\">DCBPR_BIDMAGAM_CHECK_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DCBPR_ESTIMATION_REBID_RESULT_SELECT</Col></Row><Row><Col id=\"TARGET\">appChk</Col><Col id=\"SP\">DCBPR_APP_DC03_CHK</Col></Row><Row><Col id=\"TARGET\">appSelect</Col><Col id=\"SP\">DCBPR_APP_DC03_SELECT</Col></Row><Row><Col id=\"TARGET\">appChk2</Col><Col id=\"SP\">DCBPR_APP_DC04_CHK</Col></Row><Row><Col id=\"TARGET\">appSelect2</Col><Col id=\"SP\">DCBPR_APP_DC04_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_BID\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_BID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_SITE\"/><Col id=\"NO_BID\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item3","divSearch.form.ccfNO_BID.form.DSTextBox","value","dsSearch","DS_BID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DCB_FIRSTSELECT.xfdl","lib::libCommon.xjs");
        this.registerScript("DCB_FIRSTSELECT.xfdl", function() {
        ...
        this.fnOpenDtlBid = function()
        {
        	...
        	param.DS_OPENER = this.getOwnerFrame().DS_OPENER;
        ...
        this.fnSuccBid = function(obj,e)
        {
           ...
           */
        	...
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DCB_SUCCESSBIDDLG", "fnSuccBidCallback", param, 450, 220);
        }
        ...
        */
        ...
        this.fnBtnCheckAll = function()
        {
        	...
        	this.gfnBtnCheck(this.btnAPP2, this.dsList);
        }
        ...
        // 	}
        	...
        	var param = {};
        	param.V1 = this.dsSearch.getColumn(0, "CD_SITE");							// 현장코드
        	param.V2 = this.dsSearch.getColumn(0, "NO_BID");							// 입찰번호
        	param.V3 = "";
        	param.V4 = "";
        	param.ID_AP = this.dsList.getColumn(this.dsList.rowposition, "NO_ELAPDOC");	// 전자결재문서번호
        	param.DS_ETITLE = this.dsSearch.getColumn(0, "DS_BID");						// 입찰번호명
        ...
        // {
        // 	var check1 = false; // 개봉여부 확인.
        // 	var check2 = false; // 합의진행여부 확인.
        // 	var check3 = false; // 결과통보여부 확인.
        //
        // 	for(var i = 0; i < this.dsList.rowcount; i++)
        // 	{
        // 		if(this.dsList.getColumn(i, "YN_OPENBILL") != "Y")
        // 		{
        // 			check1 = true;
        // 		}
        //
        // 		switch(this.dsList.getColumn(i, "AGREE_STATUS"))
        // 		{
        // 			// 합의요청중.
        // 			case "01" : case "04" :
        // 				check2 = true;
        // 		}
        //
        // 		if(this.dsList.getColumn(i, "CD_ELAPPRGS") == "03")
        // 		{
        // 			check3 = true;
        // 		}
        //
        ...
        // 		 this.btnAPP.set_enable(false); // 결과통보버튼
        // 	else this.btnAPP.set_enable(true);
        //
        // 	if(check1 == true || check2 == true)
        // 	{
        // 		this.btnPassBid.set_enable(false);
        // 		this.btnAPP2.set_enable(false);
        // 		this.btnSuccAlert.set_enable(false);
        // 	}
        // 	else
        // 	{
        // 		this.btnPassBid.set_enable(true);
        // 		this.btnAPP2.set_enable(true);
        // 		this.btnSuccAlert.set_enable(true);
        // 		this.btnAPP.set_enable(true);
        // 	}
        // }
        });
        ...
        this.loadIncludeScript("DCB_FIRSTSELECT.xfdl");
