(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCCPR_CONTRACT_EQUIP_FILE_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DCCPR_CONTRACT_EQUIP_FILE_SAVE</Col></Row><Row><Col id=\"SP\">DCCPR_CONT_EQUIP_FILE_INIT_INSERT</Col><Col id=\"TARGET\">exec</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCC_CONTRACT_EQUIP_FILE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCC_CONTRACT_EQUIP_FILE");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSave.addColumn("CONT_DGR", "int");
        	...
        	this.dsExec.addColumn("YN_CHK", "string");
        ...
        this.fnAdd = function() {
        	...
        	{
        		this.gfnAlert("파일목록생성 이후 추가해주세요.");
        		return false;
        	}
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I" :
        				...
        				this.dsSave.setColumn(nrow, "CONT_DGR", this.dsList.getColumn(i, "CONT_DGR"));
        				...
        				this.dsSave.setColumn(nrow, "SIGN_YN", "");
        				this.dsSave.setColumn(nrow, "MANDATORY_YN", this.dsList.getColumn(i, "MANDATORY_YN"));
        				this.dsSave.setColumn(nrow, "FORM_FILE_NO", "");
        				this.dsSave.setColumn(nrow, "FORM_FILE_YN", "");
        				this.dsSave.setColumn(nrow, "ADDFILE_NO", this._ADDFILE_NO);
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "select") {
        		...
        		{
        			this._ADDFILE_NO = this.dsList.getColumn(0, "ADDFILE_NO");
        			//this.fnBtnCheck(0);
        		}
        		...
        		if (errorCode == 0) {
        			this.gfnAlert("구비서류파일이 정상 초기화되었습니다.");
        			this.FormBtns.Select.click();
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        ...
        this.dsSearch_onvaluechanged = function(obj,e)
        {
         ...
         this.fnCreate = function(obj,e) {
        	this.gfnConfirm("구비서류파일을 초기화 하시겠습니까?", "fnCreate_Confirm", "Cancel");
        }
        ...
        this.fnExec = function() {
        	...
        	this.dsExec.setColumn(0, "TY_GUBUN", this.getOwnerFrame().DS_PARAM);
        ...
        this.loadIncludeScript("DCC_CONTRACT_EQUIP_FILE.xfdl");
