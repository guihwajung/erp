(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSKPR_IPCHALBANYONG</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSK_IPCHALBANYONG.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSK_IPCHALBANYONG");
        }
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "DT_START", "");
        	this.dsSelect.setColumn(0, "DT_END", "");
        ...
        this.loadIncludeScript("DSK_IPCHALBANYONG.xfdl");
