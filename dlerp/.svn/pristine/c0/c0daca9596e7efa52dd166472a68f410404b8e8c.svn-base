(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE_PR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SUBCON\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CONT_PR\" type=\"STRING\" size=\"256\"/><Column id=\"AM_DOKUB\" type=\"STRING\" size=\"256\"/><Column id=\"AM_SILHENG\" type=\"STRING\" size=\"256\"/><Column id=\"DT_EXPLAIN\" type=\"STRING\" size=\"256\"/><Column id=\"DT_BIDMAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"AT_SITEEXPLAIN\" type=\"STRING\" size=\"256\"/><Column id=\"AT_BIDMAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"RM_REMARK\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("txtAM_SILHENG","757","92",null,"20","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("13");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Static("staTITLE00","0","220","44.50%","22",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("15");
            obj.set_text("업체초정");
            ...
            obj = new Static("sta29","149","174",null,"41","0",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);

            obj = new Static("sta30","0","174","150","41",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("26");
            obj.set_text("특기사항");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new TextArea("txtRM_REMARK","154","179",null,"31","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("27");
            obj.set_background("#ffffff");
            obj.set_border("0px none");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDT_BIDMAGAM","757","121",null,"20","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("29");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAT_BIDMAGAM","757","150",null,"20","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("30");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAM_DOKUB","154","92","445","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("31");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtDT_EXPLAIN","154","121","445","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("32");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Edit("txtAT_SITEEXPLAIN","154","150","445","20",null,null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("33");
            obj.set_enable("true");
            obj.set_readonly("true");
            obj.set_background("#ffffff");
            ...
            obj = new Grid("objGrid","0","249",null,null,"0","0",null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("34");
            obj._setContents("");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);
            ...
            obj = new Edit("txtDS_ETITLE","147","34","671","20",null,null,null,null,null,null,this.divData1.form.divDataMaster.form);
            obj.set_taborder("10");
            ...
            obj = new Static("sta09","985","sta05:-1",null,"30","0",null,null,null,null,null,this.divData1.form.divDataMaster.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData1.form.divDataMaster.addChild(obj.name, obj);

            obj = new Static("sta08","836","sta04:-1","150","30",null,null,null,null,null,null,this.divData1.form.divDataMaster.form);
            obj.set_taborder("8");
            obj.set_text("문서번호");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("center");
            ...
            obj = new BindItem("item8","divData1.form.divDataInfo.form.txtAM_SILHENG","value","dsListEtc","AM_SILHENG");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item18","divData1.form.divDataInfo.form.txtRM_REMARK","value","dsListEtc","RM_REMARK");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item20","divData1.form.divDataInfo.form.txtDT_BIDMAGAM","value","dsListEtc","DT_BIDMAGAM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item21","divData1.form.divDataInfo.form.txtAT_BIDMAGAM","value","dsListEtc","AT_BIDMAGAM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","divData1.form.divDataInfo.form.txtAM_DOKUB","value","dsListEtc","AM_DOKUB");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","divData1.form.divDataInfo.form.txtDT_EXPLAIN","value","dsListEtc","DT_EXPLAIN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","divData1.form.divDataInfo.form.txtAT_SITEEXPLAIN","value","dsListEtc","AT_SITEEXPLAIN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_PR_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DC04";	//	발주요청서
        this.FlagGb = "";	// 저장 플래그값
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCB_SITEVENDOR_APP");
        ...
        this.fnSetParameter = function() {
        	...
        	**************************************************************************************************/
        	...
        	this.dsSaveBas.addColumn("CD_SITE", "string");
        	this.dsSaveBas.addColumn("NO_PR", "string");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_PR", this.dsListMaster.getColumn(0, "V_PARAM02"));
        ...
        **************************************************************************************************/
        ...
        this.fnSaveBas = function(status) {
        	...
        	this.dsSaveBas.setColumn(0, "CD_SITE", this.dsListMaster.getColumn(0, "V_PARAM01"));
        	this.dsSaveBas.setColumn(0, "NO_PR", this.dsListMaster.getColumn(0, "V_PARAM02"));
        	this.dsSaveBas.setColumn(0, "RM_BIGO", this.dsListEtc.getColumn(0, "RM_REMARK"));
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData1.form.divDataInfo.form.txtAT_BIDMAGAM.addEventHandler("onkeyup",this.divData_divDataRight_onkeyup,this);
            this.divData1.form.divDataInfo.form.txtAT_BIDMAGAM.addEventHandler("onkillfocus",this.divData_divDataRight_onkillfocus,this);
            ...
            this.divData1.form.divDataInfo.form.txtAT_SITEEXPLAIN.addEventHandler("onkeyup",this.divData_divDataRight_onkeyup,this);
            this.divData1.form.divDataInfo.form.txtAT_SITEEXPLAIN.addEventHandler("onkillfocus",this.divData_divDataRight_onkillfocus,this);
            this.dsListEtc.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
            this.dsList.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
        };
        this.loadIncludeScript("DCB_PR_APP.xfdl");
