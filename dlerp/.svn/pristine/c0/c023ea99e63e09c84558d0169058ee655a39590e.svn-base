(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DCD_EVALUERESULT_HSE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUERESULT_HSE");
        };
        ...
        */
        ...
        this.loadIncludeScript("DCD_EVALUERESULT_HSE.xfdl");
