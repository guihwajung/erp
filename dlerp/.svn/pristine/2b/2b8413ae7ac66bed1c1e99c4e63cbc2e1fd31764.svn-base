(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_COSTSUM_REPORT_SELECT </Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DBSPR_COSTSUM_REPORTDETAIL_SELECT </Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("tclYM_WORK","0.0","staYM_WORK:10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Div("divSplitter","0","44.36%","100.00%","5",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            ...
            obj = new Div("divDataBottom","0","276",null,null,"0","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_DATA_Bg");
            this.divData.addChild(obj.name, obj);

            obj = new Grid("objGrid1","0","39",null,null,"0","0",null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("1");
            obj._setContents("");
        ...
        // User Script
        this.registerScript("DBS_COSTSUM_REPORT.xfdl", function() {
        ...
        this.loadIncludeScript("DBS_COSTSUM_REPORT.xfdl");
