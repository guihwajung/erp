(function()
{
	return function()
	{
            						...
            						"btn_MDI_button" :
            						{
            							"self" :
            							{
            								...
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8"),
            									"padding" : nexacro.PaddingObject("0px 33px 0px 20px"),
            									"color" : nexacro.ColorObject("#019e07")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #c8c8c8"),
            					...
            					},
            					{
            						"btn_MDI_buttonS" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 1px solid #019e07"),
            									"padding" : nexacro.PaddingObject("0px 33px 0px 20px"),
            									"font" : nexacro.FontObject("bold 13px \"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            					...
            					},
            					{
            						"btn_CF_Search" :
            						{
            							"self" :
            							{
            								...
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #7dd188")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("1px solid #7dd188")
            				...
            				[
            					{
            						"div_SEARCH_Bg" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #bbe2c0, 0px none, 1px solid #bbe2c0, 0px none")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #bbe2c0, 0px none, 1px solid #bbe2c0, 0px none")
        ...
        imgcache[nexacro._getImageLocation("theme://images/btn_TF_Min.png")] = { width:24, height:24 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/img_logo_DL.PNG")] = { width:174, height:82 };
        		imgcache[nexacro._getImageLocation("theme://images/login_check_off.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/login_check_on.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/pw_icon.png")] = { width:3, height:5 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/btn_MF_arrowG.png")] = { width:7, height:12 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/Icon_MF_piechart_G.png")] = { width:36, height:36 };
