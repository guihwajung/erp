(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_CARREQUEST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHAPR_CARREQUEST_INSERT</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DHAPR_CARREQUEST_DELETE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHAPR_CARREQUEST_UPDATE</Col></Row><Row><Col id=\"SP\">DHAPR_CARUSE_KMAFTER_SELECT</Col><Col id=\"TARGET\">selectCar</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHA_CARREQUEST.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnDhaCarreg = this.gfnFormButtonAdd("DhaCarreg", "fnDhaCarreg", "차량등록");
        };
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DG", "DHA_CARREQUEST");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DT_USE", "string");
        	...
        	this.dsInsert.addColumn("TIME_START", "string");
        	this.dsInsert.addColumn("TIME_ARRIVE", "string");
        	...
        	this.dsUpdate.addColumn("DT_USE", "string");
        	...
        	this.dsUpdate.addColumn("TIME_START", "string");
        	this.dsUpdate.addColumn("TIME_ARRIVE", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DT_USE", this.dsList.getColumn(i, "DT_USE"));
        				...
        				this.dsInsert.setColumn(nrow,"TIME_START", this.dsList.getColumn(i, "TIME_START"));
        				this.dsInsert.setColumn(nrow,"TIME_ARRIVE", this.dsList.getColumn(i, "TIME_ARRIVE"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "DT_USE", this.dsList.getColumn(i, "DT_USE"));
        				...
        				this.dsUpdate.setColumn(nrow,"TIME_START", this.dsList.getColumn(i, "TIME_START"));
        				this.dsUpdate.setColumn(nrow,"TIME_ARRIVE", this.dsList.getColumn(i, "TIME_ARRIVE"));
        ...
        this.loadIncludeScript("DHA_CARREQUEST.xfdl");
