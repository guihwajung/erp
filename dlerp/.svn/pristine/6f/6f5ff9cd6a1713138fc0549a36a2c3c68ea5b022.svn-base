(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DYAPR_SUJU_PLAN_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_FLAG","ccfSN_SEQ:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("조건선택");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboTY_FLAG","staTY_FLAG:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staTY_FLAG00","cboTY_FLAG:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("(단위 : 백만원)");
        ...
        // User Script
        this.registerScript("DYA_SUJU_PLAN.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnJan = this.gfnFormButtonAdd("btnJan", "fnJan");
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DY", "DYA_SUJU_PLAN");
        ...
        this.fnJan = function(obj,e) {
        	...
        	// CD_MODULE은 보통 같은 모듈에서 호출하는 경우가 많으니 this.FormInfo.CD_MODULE 사용
        	// 타 모듈 화면 호출시 지정할것.
        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DYA_SUJU_JAN", "", param, 480, 200);
        }
        ...
        this.fnColor = function()
        {
        	...
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Sum", "CD_PROJ == '소계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_Footer", "CD_PROJ == '총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_KuBun", "CD_PROJ == '건축총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_KuBun", "CD_PROJ == '토목총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_SoKe", "CD_PROJ == '민간총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_SoKe", "CD_PROJ == '공공총계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_KuBun", "CD_PROJ == '건축소계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_KuBun", "CD_PROJ == '토목소계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_SoKe", "CD_PROJ == '민간소계'", true);
        	this.gfnGridColumnColor(this.dxGrid, "ST_PROGRESS", "Back_SoKe", "CD_PROJ == '공공소계'", true);
        ...
        this.loadIncludeScript("DYA_SUJU_PLAN.xfdl");
