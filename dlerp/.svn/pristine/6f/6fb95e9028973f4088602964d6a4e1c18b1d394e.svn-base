(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DAVPR_YEARENDDISK_DATA_CREATE</Col></Row><Row><Col id=\"SP\">DAVPR_YEARENDDISKA_SELECT</Col><Col id=\"TARGET\">select0</Col></Row><Row><Col id=\"SP\">DAVPR_YEARENDDISKB_SELECT</Col><Col id=\"TARGET\">select1</Col></Row><Row><Col id=\"SP\">DAVPR_YEARENDDISKCD_SELECT</Col><Col id=\"TARGET\">select2</Col></Row><Row><Col id=\"SP\">DAVPR_YEARENDDISKMEDICAL_SELECT</Col><Col id=\"TARGET\">select3</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTITLE","1","0","360","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("전산매체생성");
            ...
            obj = new Div("divBtns","0","308",null,"27","0",null,null,null,null,null,this);
            obj.set_taborder("9");
            this.addChild(obj.name, obj);

            obj = new Button("btnMakeLocalFile","90","0","80","27",null,null,null,null,null,null,this.divBtns.form);
            obj.set_taborder("0");
            obj.set_text("전산매체생성");
            this.divBtns.addChild(obj.name, obj);

            obj = new Button("btnCANCLE","btnMakeLocalFile:30","0","80","27",null,null,null,null,null,null,this.divBtns.form);
            obj.set_taborder("1");
            obj.set_text("취소");
            this.divBtns.addChild(obj.name, obj);
            ...
            obj = new Static("staYY_BASE","0","staTY_GUBUN:-1","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("정산년도");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Static("sta04","99","64","260","30",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_CFSELFACNT","0","staCD_CORP:-1","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("세무단위");
            ...
            obj = new Static("sta08","99","122","260","30",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta10","99","151","260","30",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_tablebg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("staDS_DAM_DEPT","0","180","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_text("담당부서명");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Static("sta12","99","180","260","30",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Static("staDS_DAM_NAME","0","209","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("담당자명");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Static("sta14","99","209","260","30",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Static("staDT_SUBMIT","0","267","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("제출일");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Static("sta16","99","267","260","30",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Edit("edtDS_HNAME","staDS_DAM_NAME:3","214","248","20",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_readonly("false");
            this.addChild(obj.name, obj);

            obj = new Static("staDS_DAM_TEL","0","238","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("담당자전화번호");
            obj.set_cssclass("sta_WF_tablelabelE");
            this.addChild(obj.name, obj);

            obj = new Static("sta17","99","238","260","30",null,null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_cssclass("sta_WF_tablebg");
            this.addChild(obj.name, obj);

            obj = new Edit("edtID_HOMETAX","104","156","247","20",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_readonly("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edtDS_DEPT","104","185","247","20",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_readonly("false");
            this.addChild(obj.name, obj);

            obj = new Combo("cboTY_GUBUN","103","40","120","20",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var cboTY_GUBUN_innerdataset = new nexacro.NormalDataset("cboTY_GUBUN_innerdataset", obj);
            cboTY_GUBUN_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">근로소득</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">의료소득</Col></Row></Rows>");
            obj.set_innerdataset(cboTY_GUBUN_innerdataset);
            obj.set_text("근로소득");
            obj.set_value("1");
            obj.set_index("0");
            this.addChild(obj.name, obj);

            obj = new Div("ctclYY_BASE","103","69","80","20",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_url("cmm::cmmCalYY.xfdl");
            obj.getSetter("onchanged").set("fnSearchInit");
            this.addChild(obj.name, obj);

            obj = new Calendar("calDT_PRINT","104","272","105","20",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Div("ccfCD_CORP","staCD_CORP:3","98","248","20",null,null,null,null,null,null,this);
            ...
            obj = new Div("ccfCD_CFSELFACNT","103","127","248","20",null,null,null,null,null,null,this);
            ...
            obj = new Edit("edtDS_TELNO","104","243","247","20",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_textAlign("left");
            ...
            obj = new TextArea("txtCont","363","-1","137","81",null,null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edtNO_SAUP","194","4","136","21",null,null,null,null,null,null,this);
            obj.set_taborder("30");
        ...
        // User Script
        this.registerScript("DAV_YEARENDDISKDLG.xfdl", function() {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divBtns.form.btnMakeLocalFile.addEventHandler("onclick",this.divBtns_btnMakeLocalFile_onclick,this);
            this.divBtns.form.btnCANCLE.addEventHandler("onclick",this.divBtns_btnCANCLE_onclick,this);
            this.cboTY_GUBUN.addEventHandler("onitemchanged",this.cboTY_GUBUN_onitemchanged,this);
            this.calDT_PRINT.addEventHandler("onchanged",this.fnSearchInit,this);
        };
        this.loadIncludeScript("DAV_YEARENDDISKDLG.xfdl");
