(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCCPR_ACTUALPROOF_SELET</Col></Row><Row><Col id=\"SP\">DCCPR_ACTUALPROOF_SAVE</Col><Col id=\"TARGET\">save</Col></Row><Row><Col id=\"TARGET\">signSave</Col><Col id=\"SP\">DCCPR_ACTUALPROOF_SIGN_SAVE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DCCPR_ACTUALPROOF_DELETE</Col></Row><Row><Col id=\"TARGET\">copy</Col><Col id=\"SP\">DCCPR_ACTUALPROOF_COPY</Col></Row><Row><Col id=\"TARGET\">reWrite</Col><Col id=\"SP\">DCCPR_ACTUALPROOF_REWRITE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            ...
            obj = new Static("staDS_VNDRMMO","0","staDS_SLPLCLPLC:28","120","140",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("4");
            obj.set_text("\r\n수정요청사항");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Static("staBg4","staDS_VNDRMMO:-1","staBg3:28",null,"140","0",null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new TextArea("ctxtCANCELREASON","staDS_VNDRMMO:5","edtADDR:38",null,"130","5",null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("20");
            obj.set_value("");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("staDS_VENDOR00","989","40","120","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("27");
            obj.set_text("사업자번호");
            obj.set_cssclass("sta_WF_tablelabel");
            obj.set_textAlign("left");
            ...
            obj = new Edit("edtREPNM00","1114","45",null,"20","5",null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("28");
            obj.set_readonly("true");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new BindItem("item13","divData.form.divData01.form.edtREPNM00","value","dsList","NO_SJC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCC_ACTUALPROOF_BAK.xfdl", function() {
        ...
        this.fnSetCombo = function()
        {
        	...
        	var outData     = "dsEDTREQRSNCD=combo0 dsCD_LICENSE=combo1";
        	var strArg      = "";
        ...
        this.fnSave = function()
        {
        	...
        	this.dsSave.setColumn(nrow,"EDTREQRSNCD",this.dsListDtl.getColumn(0,"EDTREQRSNCD"));
        	...
        	this.dsSave.setColumn(nrow,"CANCELREASON",this.dsListDtl.getColumn(0,"CANCELREASON"));
        ...
        this.fnCopy = function(obj,e) {
        	...
        	{
        		this.gfnAlert("승인대기 자료만 복사 가능합니다.");
        		return;
        	}
        ...
        this.fnDivData01_set_readonly = function(value)
        {
        	...
        	this.divData.form.divData01.form.cboCD_LICENSE.set_readonly(value);
        	...
        	this.divData.form.divData01.form.cboEDTREQRSNCD.set_enable(false);
        	this.divData.form.divData01.form.ctxtCANCELREASON.set_enable(false);
        ...
        this.fnReqAgree = function(obj,e)
        {
        	...
        	if(strTY_STATUS == "SC05010" || strTY_STATUS == "SC05015")
        	{
        		var msg = "기준년도 : ["+ this.dsSearch.getColumn(0, "WORKYEAR")  + "] 년도"
                    + "\n업체코드 : [" + this.dsSearch.getColumn(0, "CD_VENDOR")  +"]"+ this.divSearch.form.ccfCD_VENDOR.form.DSTextBox.text
                    + "\n전자발급번호 : [" + this.dsSearch.getColumn(0, "ENO_SEQ")  + "]"
                    + "\n\n기성실적증명을 합의 요청 하시겠습니까?";

        		this.gfnConfirm(msg, "fnSign_callback", "");
        	}
        	else{
        		this.gfnAlert("승인대기중이거나 수정 요청 자료만 요청 가능합니다.");
        		return;
        	}
        }
        ...
        this.fnSignSave = function()
        {
        	...
        	this.dsSign.setColumn(0,"SIGN_STATUS", "SC05040");
        ...
        this.loadIncludeScript("DCC_ACTUALPROOF_BAK.xfdl");
