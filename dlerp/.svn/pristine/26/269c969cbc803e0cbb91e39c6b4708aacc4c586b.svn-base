(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAJPR_UPTURN_MASTER_SELECT</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DAJPR_UPTURN_MASTER_SAVE</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DAJPR_UPTURN_DETAIL_SELECT</Col></Row><Row><Col id=\"TARGET\">d_save</Col><Col id=\"SP\">DAJPR_UPTURN_DETAIL_SAVE</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DAJPR_UPTURN_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAJ_UPTURN_MASTER.xfdl", function() {
        ...
        this.fnCreateTarget = function(obj,e) {
        	...
        	param.ID_FORM = "DAJ_UPTURN_MASTER";
        ...
        */
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAJ_UPTURN_MASTER");
        	this.gfnGridInit(this.dxGridSub, this.dsListSub, "DA", "DAJ_UPTURN_DETAIL");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSaveSub.addColumn("ID_ASSESSOR", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSave.setColumn(nrow, "CD_JOBTYPE", this.gfnNvl(this.dsList.getColumn(i, "CD_JOBTYPE"), ""));
        				this.dsSave.setColumn(nrow, "CD_EMPTYPE", this.gfnNvl(this.dsList.getColumn(i, "CD_EMPTYPE"), ""));
        				this.dsSave.setColumn(nrow, "CD_PAYSTEP", this.gfnNvl(this.dsList.getColumn(i, "CD_PAYSTEP"), ""));
        				this.dsSave.setColumn(nrow, "CD_POSITION", this.gfnNvl(this.dsList.getColumn(i, "CD_POSITION"), ""));
        				this.dsSave.setColumn(nrow, "CD_OCCUPATION", this.gfnNvl(this.dsList.getColumn(i, "CD_OCCUPATION"), ""));
        	...
        	for (var i = 0; i < this.dsListSub.rowcount; i++) {
        		...
        		switch(flag) {
        			...
        			case "D":
        				...
        				this.dsSaveSub.setColumn(nrow, "NO_SEQ", flag == "I" ? 0 : this.dsListSub.getColumn(i, "NO_SEQ"));
        				this.dsSaveSub.setColumn(nrow, "ID_ASSESSOR", this.gfnNvl(this.dsListSub.getColumn(i, "ID_ASSESSOR"), ""));
        ...
        this.loadIncludeScript("DAJ_UPTURN_MASTER.xfdl");
