(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_CAR_YEARSTATE_SELECT</Col></Row><Row><Col id=\"TARGET\">report</Col><Col id=\"SP\">DHAPR_CAR_YEARSTATE_RPT_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_CAR","ctclYY_CARCOST:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("차종");
            ...
            obj = new Edit("edtDS_HNAME","staDS_HNAME:0.0","10.0","135","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Calendar("ctclDT_STD","staDT_STD:0.0","10.0","105","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
        ...
        // User Script
        this.registerScript("DHA_CAR_YEARSTATE.xfdl", function() {
        ...
        this.loadIncludeScript("DHA_CAR_YEARSTATE.xfdl");
