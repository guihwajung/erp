(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("차입금 미지급이자 전표발행");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFCPR_GYULSAN_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFCPR_GYULSAN_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFCPR_GYULSAN_UPDATE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFCPR_GYULSAN_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFCPR_GYULSAN_AUTOSLIPX</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staYM_WORK","cfCD_CORP:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("회계년월");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("calYM_WORK","staYM_WORK:0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta02","calYM_WORK:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("결산종류");
        ...
        // User Script
        this.registerScript("DFC_GYULSAN_MIBUL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFC_GYULSAN_MIBUL");
        ...
        this.fnSetCombo = function() {
        	...
        	this.dsCombo.setColumn(0, "CD_TYPE", "CC");
        ...
        this.loadIncludeScript("DFC_GYULSAN_MIBUL.xfdl");
