(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_DM_SELECT</Col></Row><Row><Col id=\"TARGET\">magam</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_BONSA_MAGAM_DM</Col></Row><Row><Col id=\"TARGET\">year</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_YEAR_MAX_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_BONSA_DM.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DCD_EVALUEMAGAM_BONSA_DM");
        };
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg)
        {
        	...
        	else if(svcID == "year")
        	{
        		...
        		if (errorCode == 0) {
        			...
        			var msg = "본사마감 정상처리하였습니다.";

        			if(strArg == "N")
        			{
        				msg = "본사마감취소 정상처리하였습니다.";
        			}
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_BONSA_DM.xfdl");
