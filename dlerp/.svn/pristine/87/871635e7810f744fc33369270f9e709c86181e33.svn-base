(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DWBPR_HDLEDGER_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staDT_FROM","ccfCD_SITE:0.0","10.0","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("조회기간");
        ...
        // User Script
        this.registerScript("DWB_HDLEDGER.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	switch(this.FormInfo.CD_ROLE)
        	{
        		case "R00" : case "R30" : case "R31" :
        		case "R32" : case "R34" : case "R35" :
        		case "R36" :
        			this.divSearch.form.ccfCD_SITE.form.set_enable(false);
        		break;
        	}
        };
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DW", "DWB_HDLEDGER");
        };
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "DT_FR", this.dsSearch.getColumn(0, "DT_FROM"));
        ...
        this.fnSelectValidate = function() {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0,"DT_FROM"))) {
        		...
        		this.gfnAlert("조회시작일자를 입력하세요.", "fnVaidateCallback");
        	}
        		...
        		this.gfnAlert("조회종료일자를 입력하세요.", "fnVaidateCallback");
        	}
        ...
        this.loadIncludeScript("DWB_HDLEDGER.xfdl");
