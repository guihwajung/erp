(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_ID\" type=\"STRING\" size=\"256\"/><Column id=\"YM_WORK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSB_GUNROSINGOLIST2.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.ccfCD_SITE.CodeFindName = "DZX_CFDEPTCORP";		// DHX_CFACNTUNIT (변경전) 코드파인드 변경됨
        ...
        this.fnSelectSub = function() {
        	...
        	this.dsSelectSub.setColumn(0, "NO_ID", this.dsSearch.getColumn(0, "NO_ID"));
        ...
        this.selectExcel = function() {
        	...
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "selectExcel=dsSelect";
        ...
        this.loadIncludeScript("DSB_GUNROSINGOLIST2.xfdl");
