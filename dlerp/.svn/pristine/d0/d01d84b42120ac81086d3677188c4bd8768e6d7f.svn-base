(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHVPR_BI_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DHVPR_BI_CREATE</Col></Row><Row><Col id=\"TARGET\">ganTaxSingo</Col><Col id=\"SP\">DHVPR_GANTAXSINGO_PAYYM_CREATE_NEW</Col></Row><Row><Col id=\"TARGET\">ganTaxSingo2</Col><Col id=\"SP\">DHVPR_GANTAXSINGO_CREATE2</Col></Row><Row><Col id=\"SP\">DZXPR_COMPANYCORP_CODEFIND</Col><Col id=\"TARGET\">nosaup</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YY_TUITION\" type=\"STRING\" size=\"256\"/><Column id=\"YM_IMPUTE_FR\" type=\"STRING\" size=\"256\"/><Column id=\"YM_IMPUTE_TO\" type=\"STRING\" size=\"256\"/><Column id=\"YN_RESIDENT\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YM_IMPUTE_TO\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta01","ctclYY_TUITION:0.0","10.0","66","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("구분");
            obj.set_cssclass("sta_WF_SchLabel");
            ...
            obj = new Combo("ccboTY_YM","sta01:0.0","10.0","80","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_datacolumn("datacolumn");
            obj.set_codecolumn("codecolumn");
            obj.set_visible("false");
            var divSearch_form_ccboTY_YM_innerdataset = new nexacro.NormalDataset("divSearch_form_ccboTY_YM_innerdataset", obj);
            divSearch_form_ccboTY_YM_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">U</Col><Col id=\"datacolumn\">상반기</Col></Row><Row><Col id=\"codecolumn\">D</Col><Col id=\"datacolumn\">하반기</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_ccboTY_YM_innerdataset);
            obj.set_text("");
            obj.set_value("");
            obj.set_index("-1");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta06","ctclYY_TUITION:10","10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("귀속기간");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            divSearch_form_ccboYN_RESIDENT_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">Y</Col><Col id=\"datacolumn\">거주</Col></Row></Rows>");
            ...
            obj = new Grid("objGrid","1","0",null,null,"-1","0",null,null,null,null,this.divData.form);
            obj.set_taborder("0");
            obj._setContents("");
            ...
            obj = new BindItem("item5","divSearch.form.ctclYY_TUITION.form.TextBox","value","dsSearch","YY_TUITION");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DHV_LOCAL_SELECT.xfdl", function() {
        ...
        this.divSearch_ccboTY_YM_onitemchanged = function(obj,e)
        {
        	var frYm = "", toYm = "";
        	if(e.postvalue == "U"){
        ...
        this.divSearch_ccboYN_RESIDENT_onitemchanged = function(obj,e)
        {
        //rowcount 0 일때 의미 없음
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.ccboTY_YM.addEventHandler("onitemchanged",this.divSearch_ccboTY_YM_onitemchanged,this);
        ...
        this.loadIncludeScript("DHV_LOCAL_SELECT.xfdl");
