(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("구분별 AS 접수내역 조회(콜센터)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DBSPR_JEOBSU_GUBUN_CALL_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DBS_JEOBSU_GUBUN.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DB", "DBS_JEOBSU_GUBUN");  // pForm.gfnGridInit = function(objGrid, objDs, cd_system, id_grid, tree_column, level_column, is_manual)
        ...
        this.fnExcel = function() {
        	...
        	this.gfnExcelExport(this.dxGrid,sSheetName,"구분별 AS 접수내역 조회");
        }
        ...
        this.loadIncludeScript("DBS_JEOBSU_GUBUN.xfdl");
