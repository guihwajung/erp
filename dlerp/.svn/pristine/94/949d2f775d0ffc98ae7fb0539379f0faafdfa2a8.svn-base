(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFEPR_GYULSAN_SELECT</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DFEPR_GYULSAN_CREATE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFEPR_GYULSAN_UPDATE</Col></Row><Row><Col id=\"TARGET\">autoslip</Col><Col id=\"SP\">DFEPR_GYULSAN_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">autoslipx</Col><Col id=\"SP\">DFEPR_GYULSAN_AUTOSLIPX</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFE_GYULSAN_MISU.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFE_GYULSAN_MISU");
        ...
        this.fnSetCombo = function() {
        	...
        	this.dsCombo.setColumn(0, "CD_TYPE", "EC");
        ...
        this.loadIncludeScript("DFE_GYULSAN_MISU.xfdl");
