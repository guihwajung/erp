(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_FIELD\" type=\"STRING\" size=\"256\"/><Column id=\"DS_FIELD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_FIELD\">DS_CONTMETHOD</Col><Col id=\"DS_FIELD\">계약방법</Col></Row><Row><Col id=\"CD_FIELD\">CD_ACCOUNT</Col><Col id=\"DS_FIELD\">계정코드</Col></Row><Row><Col id=\"CD_FIELD\">CD_LICCOST</Col><Col id=\"DS_FIELD\">품목</Col></Row><Row><Col id=\"CD_FIELD\">CD_VENDOR</Col><Col id=\"DS_FIELD\">(대표)거래처</Col></Row><Row><Col id=\"CD_FIELD\">RT_TAX</Col><Col id=\"DS_FIELD\">과세율</Col></Row><Row><Col id=\"CD_FIELD\">ID_DAM</Col><Col id=\"DS_FIELD\">담당자</Col></Row><Row><Col id=\"DS_FIELD\">납기일자</Col><Col id=\"CD_FIELD\">DS_DELIVERY</Col></Row><Row><Col id=\"CD_FIELD\">DS_ORDER</Col><Col id=\"DS_FIELD\">발주명</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divData01","0","sta02:10","1170","233",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Static("sta24","497","145","668","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("33");
            ...
            obj = new Static("sta204","0","174","110","59",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("3");
            obj.set_text("특기사항");
            obj.set_cssclass("sta_WF_tablelabel");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta214","sta204:-1","174","1056","59",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta01","497","0","668","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta18","497","116","668","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("28");
            obj.set_cssclass("sta_WF_tablebg");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new TextArea("txtRM_BIGO","sta204:5","179","1044","49",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("37");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Div("cfID_DAM","891","34","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.getSetter("CodeFindName").set("DSX_CFSITETYPE_CODE");
            obj.getSetter("CDTextWidth").set("70");
            obj.set_taborder("9");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            ...
            obj = new MaskEdit("txtRT_TAX","503","63","106","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("42");
            obj.set_format("#,0.00");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Static("sta22","614","58","26","30",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("50");
            obj.set_text("%");
            this.divData.form.divData01.addChild(obj.name, obj);
            ...
            obj = new Edit("cboCD_PAY_CONDITION","115","150","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("51");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Edit("cboCD_DELIVERY","891","150","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("52");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Edit("cboDS_DELIVERY","503","150","268","20",null,null,null,null,null,null,this.divData.form.divData01.form);
            obj.set_taborder("53");
            this.divData.form.divData01.addChild(obj.name, obj);

            obj = new Div("divData02","0","divData01:5","1170",null,null,"0",null,null,null,null,this.divData.form);
            obj.set_taborder("1");
            obj.set_text("");
            this.divData.addChild(obj.name, obj);

            obj = new Grid("objGrid","0","10",null,null,"5","0",null,null,null,null,this.divData.form.divData02.form);
            obj.set_taborder("0");
            obj._setContents("");
            ...
            obj = new BindItem("item12","divData.form.divData01.form.cboCD_PAY_CONDITION","value","dsList","CD_PAY_CONDITION");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item21","divData.form.divData01.form.cboCD_DELIVERY","value","dsList","CD_DELIVERY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item22","divData.form.divData01.form.cboDS_DELIVERY","value","dsList","DS_DELIVERY");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DMA_PO_DETAIL.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList1, "DM", "DMA_PO_DETAIL");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("DS_DELIVERY", "string");
        ...
        this.fnSave = function() {
        	if(this.dsList.getColumn(0, "YN_APPROVE") != "Y") {

        		// 싱글폼(Dataset) 필수입력 체크
        		if (!this.gfnDataValidate(this.dsList, this.dsRequired)) return;

        		if(this.dsList.getColumn(0, "CD_VENDOR") == "000000") { //업체 미지정일 경우
        			this.gfnAlert("발주서의 대표업체가 지정되지 않았습니다.");
        			return;
        		}
        		...
        		if(flag == "U") {
        			...
        			this.dsUpdate.setColumn(nrow, "DS_DELIVERY", this.dsList.getColumn(0, "DS_DELIVERY"));
        		}
        		...
        		for (var i = 0; i < this.dsList1.rowcount; i++) {
        			...
        			switch(flag) {
        				...
        				case "D":
        					...
        					this.dsSave.setColumn(nrow, "NO_CONT", this.dsList1.getColumn(i, "NO_CONT"));
        					this.dsSave.setColumn(nrow, "CD_COST", this.dsList1.getColumn(i, "CD_COST"));
        					this.dsSave.setColumn(nrow, "UP_TT_HADO", this.dsList1.getColumn(i, "UP_TT_HADO"));
        					this.dsSave.setColumn(nrow, "SZ_SIZE_SITE", this.dsList1.getColumn(i, "SZ_SIZE_SITE"));
        		...
        		if(this.dsSave.rowcount > 0) {
        			arr_in.push("update_d=dsSave");
        		}


        		if (this.dsUpdate.rowcount == 0 && this.dsSave.rowcount == 0) return;
        ...
        this.fnPrint = function() {
        	...
        	this.dsReport.setColumn(0, "NO_CONT", this.dsSearch.getColumn(0, "NO_CONT"));

        	var inProc		= "_dsProc";
        	//var inParam 	= "params=dsReportParam";	// 조회SP이외 사용할 정보
        	var inParam 	= "";						// 필요없는 경우 생략
        	var inData      = "report=dsReport";
        	var reportpath  = "/dc/dcc/DMAPR_PO_DOCUMENT.ozr";
        	...
        	// 프린트 기능을 사용하지않게하기 위함(프린트 창이 뜨지 않음)
        	return false;
        }
        ...
        this.dsList_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue) {
        		...
        		else if(e.columnid == "AM_CONTVAT")
        		{
        			this.dsList.setColumn(0, "AM_TT_APPROVE", this.dsList.getColumn(0, "AM_CONTVAT") + this.dsList.getColumn(0, "AM_CONTPRO"));
        			this.dsList.setColumn(0, "AM_CONT", this.dsList.getColumn(0, "AM_CONTVAT") + this.dsList.getColumn(0, "AM_CONTPRO"));
        		}
        ...
        this.fnSetCombo = function() {
        	...
        	this.dsCombo.setColumn(4, "YN_USE", "Y");
        ...
        this.dsList1_onvaluechanged = function(obj,e)
        {
        	if(e.oldvalue != e.newvalue) {
        		...
        		if(e.columnid == "UP_TT_HADO")	// 발주 단가
        		{
        ...
        this.fnReadOnly = function () {
        	if(this.dsList.getColumn(0, "YN_APPROVE") == "Y") {
        		this.divData.form.divData01.form.cfCD_LICCOST.set_enable(false);
        		this.divData.form.divData01.form.cfID_DAM.set_enable(false);
        		this.divData.form.divData01.form.cfCD_VENDOR.set_enable(false);

        		this.divData.form.divData01.form.txtDS_ORDER.set_readonly(true);
        		this.divData.form.divData01.form.txtRT_TAX.set_readonly(true);
        		this.divData.form.divData01.form.txtRT_TAXFREE.set_readonly(true);
        		this.divData.form.divData01.form.txtAM_CONTVAT.set_readonly(true);
        		this.divData.form.divData01.form.cboCD_PAY_CONDITION.set_readonly(true);
        		this.divData.form.divData01.form.cboDS_DELIVERY.set_readonly(true);
        		this.divData.form.divData01.form.cboCD_DELIVERY.set_readonly(true);
        		this.divData.form.divData01.form.txtRM_BIGO.set_readonly(true);
        	} else {
        		this.divData.form.divData01.form.cfCD_LICCOST.set_enable(true);
        		this.divData.form.divData01.form.cfID_DAM.set_enable(true);
        		this.divData.form.divData01.form.cfCD_VENDOR.set_enable(true);

        		this.divData.form.divData01.form.txtDS_ORDER.set_readonly(false);
        		this.divData.form.divData01.form.txtRT_TAX.set_readonly(false);
        		this.divData.form.divData01.form.txtRT_TAXFREE.set_readonly(false);
        		this.divData.form.divData01.form.txtAM_CONTVAT.set_readonly(false);
        		this.divData.form.divData01.form.cboCD_PAY_CONDITION.set_readonly(false);
        		this.divData.form.divData01.form.cboDS_DELIVERY.set_readonly(false);
        		this.divData.form.divData01.form.cboCD_DELIVERY.set_readonly(false);
        		this.divData.form.divData01.form.txtRM_BIGO.set_readonly(false);
        	}
        }
        ...
        this.divData_objGrid_oncelldblclick = function(obj,e)
        {
        	...
        	if(nexacro.replaceAll(obj.getCellProperty("body", e.cell, "text"), "bind:", "") == "UP_TT_HADO") return;
        	if(this.dsList.getColumn(0, "YN_APPROVE") != "Y") return;

        	// 선택된 row가 있을 경우에만 팝업을 띄움
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }
        	var param = {};

        	param.NO_CONT = this.dsList1.getColumn(this.dsList1.rowposition, "NO_CONT");
        	param.CD_COST = this.dsList1.getColumn(this.dsList1.rowposition, "CD_COST");

        	this.gfnFormOpen("DMA", "DMA_PO_DETAIL_HISTORY", "", param, 800, 400);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divData02.form.objGrid.addEventHandler("oncelldblclick",this.divData_objGrid_oncelldblclick,this);
            this.dsList.addEventHandler("onvaluechanged",this.dsList_onvaluechanged,this);
            this.dsSearch.addEventHandler("onvaluechanged",this.dsSearch_onvaluechanged,this);
            this.dsList1.addEventHandler("onvaluechanged",this.dsList1_onvaluechanged,this);
        };
        this.loadIncludeScript("DMA_PO_DETAIL.xfdl");
