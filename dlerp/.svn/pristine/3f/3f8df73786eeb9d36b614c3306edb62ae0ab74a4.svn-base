(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DRBPR_CANCELSIMPLE_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DRB_CANCELSTATE.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DR", "DRB_CANCELSTATE");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsSelect.addColumn("YN_DONGHO"       , "string");		// 동층호확정여부 (Y, N)
        }
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "CD_TYPE"         , this.UserInfo.DR_SPACE03 || "");
        	this.dsSelect.setColumn(0, "YN_DONGHO"       , this.UserInfo.DR_SPACE04 || "");
        ...
        this.fnButtonClick = function(obj,e) {
        	...
        	param.NO_UNIONMEMBER = objDs.getColumn(objDs.rowposition, "NO_UNIONMEMBER");
        	param.CANCEL         = objDs.getColumn(objDs.rowposition, "NO_CANCEL");

        	this.gfnFormOpen(this.FormInfo.CD_MODULE, "DRB_CANCELDETAIL", "", param);
        }
        ...
        this.divSearch_cbtnNO_DONGHO_onclick = function(obj,e)
        {
        	...
        	this.gfnFormOpen("DRI", "DRI_DONGHOCANCEL", "fnPopupCallback", param);
        };
        ...
        this.loadIncludeScript("DRB_CANCELSTATE.xfdl");
