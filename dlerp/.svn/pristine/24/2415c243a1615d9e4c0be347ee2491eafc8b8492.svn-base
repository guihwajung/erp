(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DQB_CBS.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.DQB_CBS_onload = function(obj,e)
        {
        	// -- 필수 -------------------//
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DQ", "DQB_CBS", "DS_CBS", "NO_LEVEL");
        ...
        {
            this.addEventHandler("onload",this.DQB_CBS_onload,this);
        };
        this.loadIncludeScript("DQB_CBS.xfdl");
