(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DHAPR_CARTAX_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DHAPR_CAR_INSERT</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DHAPR_CAR_DELETE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DHAPR_CARTAX_UPD</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DAXPR_COMMONCODE_CODEFIND</Col></Row><Row><Col id=\"TARGET\">slipDelete</Col><Col id=\"SP\">DHAPR_CARTAX_AUTOSLIP_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DHA_CARTAX.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DG", "DHA_CARTAX");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("NO_TAX_AUTOSLIP", "string");
        	...
        	this.dsUpdate.addColumn("NO_TAX_AUTOSLIP", "string");
        	this.dsUpdate.addColumn("CD_VENDOR", "string");
        	this.dsUpdate.addColumn("DS_VENDOR", "string");
        	this.dsUpdate.addColumn("INSURANCE_PAY", "string");
        	this.dsUpdate.addColumn("DT_TAX_FROM", "string");
        	this.dsUpdate.addColumn("DT_TAX_TO", "string");
        	this.dsUpdate.addColumn("AMT_TAX", "string");
        	...
        	this.dsSlip.addColumn("AMT_TAX", "string");
        	...
        	this.dsSlip.addColumn("NO_TAX_AUTOSLIP", "string");       // 취소할 전표번호
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow,"NO_TAX_AUTOSLIP", this.dsList.getColumn(i, "NO_TAX_AUTOSLIP"));
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow,"NO_TAX_AUTOSLIP", this.dsList.getColumn(i, "NO_TAX_AUTOSLIP"));
        				this.dsUpdate.setColumn(nrow,"CD_VENDOR", this.dsList.getColumn(i, "CD_VENDOR"));
        				this.dsUpdate.setColumn(nrow,"DS_VENDOR", this.dsList.getColumn(i, "DS_VENDOR"));
        				this.dsUpdate.setColumn(nrow,"DT_TAX_FROM", this.dsList.getColumn(i, "DT_TAX_FROM"));
        				this.dsUpdate.setColumn(nrow,"DT_TAX_TO", this.dsList.getColumn(i, "DT_TAX_TO"));
        				this.dsUpdate.setColumn(nrow,"AMT_TAX", this.dsList.getColumn(i, "AMT_TAX"));
        				break;
        ...
        this.fnFormButton = function(obj,e) {
        	...
        	if( obj.id == "btnExt_FormButton3"){
        		if( !this.gfnIsNull(this.dsList.getColumn(this.dsList.rowposition, "NO_TAX_AUTOSLIP")) ){
        			var param = {};

        			param.CD_TRADE = this.dsList.getColumn(this.dsList.rowposition,"NO_TAX_AUTOSLIP");
        			param.IUD_FLAG = "S";
        	...
        	if(value) {
        		...
        		for ( var i =0; i < this.dsList.rowcount; i++){
        			...
        			//	    this.gfnAlert("승인 상태가 아닙니다.");
        			 //       return;
        			//	}
        				if(!this.gfnIsNull(this.dsList.getOrgColumn(i,"NO_TAX_AUTOSLIP"))){
        				    this.gfnAlert("이미 전표발행된 데이터가 있습니다.");
        			        return;
        				}
        				strSlipKey1 += this.dsList.getColumn(i,"CD_VENDOR")+",";
        				strSlipKey2 += this.dsList.getColumn(i,"AMT_TAX")+",";
        		...
        		param.AMT_TAX = strSlipKey2.substr(0,strSlipKey2.length-1);
        		...
        		this.gfnFormOpen(this.FormInfo.CD_MODULE, "DHA_CARTAX_DLG", "fnPopupCallback", param, 330, 270);
        ...
        this.fnSlipCancel = function(svcID, value){
        	...
        	if(value) {
        		...
        		for ( var i =0; i < this.dsList.rowcount; i++){
        			...
        			if( this.dsList.getColumn(i, this.ucFlag) != "#" && strDisplaytype == "checkboxcontrol" && this.dsList.getColumn(i,"CHK") == 1) {
        				if(this.gfnIsNull(this.dsList.getColumn(i,"NO_TAX_AUTOSLIP"))){
        				    this.gfnAlert("전표가 생성된 행만 전표취소 가능합니다.");
        			        return;
        				}

        				strSlipKey1 += this.dsList.getColumn(i,"CD_CAR")+",";
        				strSlipKey2 += this.dsList.getColumn(i,"NO_TAX_AUTOSLIP")+",";
        			}
        		}
        		...
        		this.dsSlip.setColumn(0, "NO_TAX_AUTOSLIP", strSlipKey2.substr(0,strSlipKey2.length-1));
        ...
        this.fnPopupCallback = function(strId, val) {
        	...
        	// 전표발행 / 취소
        	if(strId.indexOf("DHA_CARTAX_DLG") > 0) {
        		if(val){
        			var msg = "전표발행"
        ...
        this.fnUpate = function(svcID, value){
        	...
        	if(value) {
        		...
        		this.gfnFormOpen(this.FormInfo.CD_MODULE, "DHA_CARTAX", "fnPopupCallback", param, 330, 270);
        ...
        this.loadIncludeScript("DHA_CARTAX.xfdl");
