(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DM_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DM_UPDATE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">combo1</Col><Col id=\"SP\">DMXPR_LICCOST_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">except</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DM_EXCEPT</Col></Row><Row><Col id=\"TARGET\">talak</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DM_TALAK</Col></Row><Row><Col id=\"TARGET\">rejudge</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DM_REJUDGE</Col></Row><Row><Col id=\"TARGET\">regist</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_RE_LIST_DM_REGIST</Col></Row><Row><Col id=\"TARGET\">auto</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_AUTO_JUDGE_DM</Col></Row><Row><Col id=\"TARGET\">create</Col><Col id=\"SP\">DCAPR_JUDGE_REGULAR_EXIST_LIST_DM_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_JUDGE\" type=\"STRING\" size=\"256\"/><Column id=\"TY_JUDGEKIND\" type=\"STRING\" size=\"256\"/><Column id=\"CD_LICCOST\" type=\"STRING\" size=\"256\"/><Column id=\"ID_DAM\" type=\"STRING\" size=\"256\"/><Column id=\"CD_BUMUN\" type=\"STRING\" size=\"256\"/><Column id=\"TY_RESULT\" type=\"STRING\" size=\"256\"/><Column id=\"DS_VENDOR\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_LICCOST\"/><Col id=\"TY_RESULT\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DS_CODE\">전체</Col><Col id=\"CD_CODE\"/></Row><Row><Col id=\"DS_CODE\">미평가</Col><Col id=\"CD_CODE\">미평가</Col></Row><Row><Col id=\"DS_CODE\">평가중</Col><Col id=\"CD_CODE\">평가중</Col></Row><Row><Col id=\"DS_CODE\">탈락</Col><Col id=\"CD_CODE\">탈락</Col></Row><Row><Col id=\"DS_CODE\">평가제외</Col><Col id=\"CD_CODE\">평가제외</Col></Row><Row><Col id=\"DS_CODE\">등록심의</Col><Col id=\"CD_CODE\">등록심의</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item5","divSearch.form.ctxtID_DAM","value","dsSearch","ID_DAM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCA_JUDGE_REGULAR_EXIST_LIST_DM.xfdl", function() {
        ...
        this.fnSetExtendButton = function() {
        	...
        	this.btnReJudge = this.gfnFormButtonAdd("btnReJudge", "fnReJudge");
        };
        ...
        this.fnSetEvent = function() {
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCA_JUDGE_REGULAR_EXIST_LIST_DM");
        };
        ...
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "TY_SELECTION", "");
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	if (svcID == "select") {
        		...
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("자료생성이 정상 처리되었습니다.", "fnValidate");
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        		...
        		if (errorCode == 0) {
        			...
        			this.gfnAlert("재평가가 정상적으로 처리되었습니다.", "fnValidate");
        		} else {
        			this.gfnAlert(errorMsg);
        		}
        	}
        ...
        this.fnCreate = function() {
        	...
        	this.gfnConfirm("자료생성을 진행 하시겠습니까?", "fnCreate_CallBack");
        }
        ...
        this.fnExcept = function() {
        	...
        	this.gfnConfirm("해당건을 평가제외 진행 하시겠습니까?", "fnExcept_CallBack");
        }

        this.fnReJudge = function() {
        	if (!this.gfnGridIsRow(this.dxGrid)) { return false; }

        	this.gfnConfirm("해당건을 재평가 진행 하시겠습니까?", "fnReJudge_CallBack");
        }
        ...
        this.fnReJudge_CallBack = function(strId, val) {
        	if(val == true)
        	{
        		this.dsReJudge = new Dataset();
        		this.dsReJudge.addColumn("NO_ID", "string");
        		this.dsReJudge.addColumn("YR_JUDGE", "string");
        		this.dsReJudge.addColumn("CD_JUDGEKIND", "string");
        		this.dsReJudge.addColumn("CD_VENDOR", "string");
        		this.dsReJudge.addColumn("CD_LICCOST", "string");
        		this.dsReJudge.addColumn("NO_SJC", "string");
        		this.dsReJudge.addColumn("ID_USER", "string");

        		this.dsReJudge.clearData();
        		for(var row = 0; row < this.dsList.rowcount; row++)
        		{
        			if(this.dsList.getColumn(row, "CHK") == "Y")
        			{
        				var nrow = this.dsReJudge.addRow();
        				this.dsReJudge.setColumn(nrow, "NO_ID", this.dsList.getColumn(row, "NO_ID"));
        				this.dsReJudge.setColumn(nrow, "YR_JUDGE", this.dsList.getColumn(row, "YR_JUDGE"));
        				this.dsReJudge.setColumn(nrow, "CD_JUDGEKIND", this.dsList.getColumn(row, "CD_JUDGEKIND"));
        				this.dsReJudge.setColumn(nrow, "CD_VENDOR", this.dsList.getColumn(row, "CD_VENDOR"));
        				this.dsReJudge.setColumn(nrow, "CD_LICCOST", this.dsList.getColumn(row, "CD_LICCOST"));
        				this.dsReJudge.setColumn(nrow, "NO_SJC", this.dsList.getColumn(row, "NO_SJC"));
        				this.dsReJudge.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);
        			}
        		}

        		var strSvcId    = "rejudge";
        		var strSvcType  = "save";
        		var inProc		= "_dsProc";
        		var inData      = "rejudge=dsReJudge";
        		var outData     = "";
        		var strArg      = "";
        		var callBackFnc = "fnCallback";
        ...
        this.loadIncludeScript("DCA_JUDGE_REGULAR_EXIST_LIST_DM.xfdl");
