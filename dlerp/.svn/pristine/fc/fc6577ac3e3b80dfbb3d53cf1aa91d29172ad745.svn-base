(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE_PR\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SUBCON\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CONT_PR\" type=\"STRING\" size=\"256\"/><Column id=\"AM_DOKUB\" type=\"STRING\" size=\"256\"/><Column id=\"AM_SILHENG\" type=\"STRING\" size=\"256\"/><Column id=\"DT_EXPLAIN\" type=\"STRING\" size=\"256\"/><Column id=\"DT_BIDMAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"AT_SITEEXPLAIN\" type=\"STRING\" size=\"256\"/><Column id=\"AT_BIDMAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"RM_VENDOR_REMARK\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new TextArea("txtRM_VENDOR_REMARK","154","179",null,"31","5",null,null,null,null,null,this.divData1.form.divDataInfo.form);
            obj.set_taborder("27");
            obj.set_background("#ffffff");
            obj.set_border("0px none");
            this.divData1.form.divDataInfo.addChild(obj.name, obj);
            ...
            obj = new BindItem("item18","divData1.form.divDataInfo.form.txtRM_VENDOR_REMARK","value","dsListEtc","RM_VENDOR_REMARK");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DCB_ORDERPLAN_APP.xfdl", function() {
        this.objApp = this.gfnGetApplication();

        this.ID_AP_TYPE = "DC05";	//	실시계획서
        this.FlagGb = "";	// 저장 플래그값
        ...
        this.fnSetEvent = function() {
        	...
        	//결재본문 그리드 세팅
        	this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCB_ORDERPLAN_APP");
        ...
        this.fnSetParameter = function() {
        	...
        	**************************************************************************************************/
        	...
        	this.dsSelectList.addColumn("CD_SITE", "string");
        	this.dsSelectList.addColumn("NO_BID", "string");

        	this.dsSaveBas = new Dataset();
        	this.dsSaveBas.addColumn("NO_BID", "string");
        ...
        **************************************************************************************************/
        this.fnSelect = function() {
        	...
        	this.dsSelect.setColumn(0, "NO_BID", this.dsListMaster.getColumn(0, "V_PARAM01"));

        	this.dsSelectList.clearData();
        	this.dsSelectList.addRow();

        	this.dsSelectList.setColumn(0, "CD_SITE", "");
        	this.dsSelectList.setColumn(0, "NO_BID", this.dsListMaster.getColumn(0, "V_PARAM01"));

        	var strSvcId    = "select";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
         	var inData      = "selectEtc=dsSelect select=dsSelectList";	// select1=dsSelect1
        ...
        **************************************************************************************************/
        ...
        this.fnSaveBas = function(status) {
        	...
        	this.dsSaveBas.setColumn(0, "NO_BID", this.dsListMaster.getColumn(0, "V_PARAM01"));
        	this.dsSaveBas.setColumn(0, "RM_BIGO", this.dsListEtc.getColumn(0, "RM_VENDOR_REMARK"));
        ...
        */
        ...
        this.loadIncludeScript("DCB_ORDERPLAN_APP.xfdl");
