(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_SITE_MAGAM_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_SITE_MAGAM_UPDATE</Col></Row><Row><Col id=\"TARGET\">magam</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_SITE_MAGAM</Col></Row><Row><Col id=\"TARGET\">year</Col><Col id=\"SP\">DCDPR_EVALUEMAGAM_YEAR_MAX_SELECT</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"YR_MAGAM\" type=\"STRING\" size=\"256\"/><Column id=\"NO_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("ccfCD_SITE","ccfNO_SEQ:0.0","10.0","300","24.0",null,null,null,null,null,null,this.divSearch.form);
        ...
        // User Script
        this.registerScript("DCD_EVALUEMAGAM_SITE_MAGAM.xfdl", function() {
        ...
        // 	if(cd_role!="R40" && cd_role!="R41" && cd_role!="R99")
        // 	{
        ...
        this.fnSetEvent = function() {
        	...
        	if(this.FormInfo.DS_PARAM == "SF") {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_SITE_MAGAM_SF");
        	} else if(this.FormInfo.DS_PARAM == "DM") {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DM", "DCD_EVALUEMAGAM_SITE_MAGAM_DM");
        	} else {
        		this.gfnGridInit(this.dxGrid, this.dsList, "DC", "DCD_EVALUEMAGAM_SITE_MAGAM");
        	}
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsMagam.addColumn("NO_SEQ", "string");
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg, strArg)
        {
        	...
        	else if(svcID == "magam")
        	{
        		if (errorCode == 0) {
        			...
        			var msg = "현장마감을 정상처리하였습니다.";
        			if(strArg == "N")
        			{
        				msg = "현장마감취소를 정상처리하였습니다.";
        			}
        ...
        this.fnMagam = function()
        {
        	...
        	var msg = "평가년도 : [" + this.dsSearch.getColumn(0, "YR_MAGAM") + "] 년"
        			+ "\n" + "평가시기 : [" + this.divSearch.form.ccfNO_SEQ.form.DSTextBox.text + "]"
        			+ "\n\n" + "현장마감을 진행하시겠습니까?"
        	;
        	this.gfnConfirm(msg, "fnMagam_callback", "Y");
        }
        ...
        this.fnMagamCancel = function()
        {
        	...
        	var msg = "평가년도 : [" + this.dsSearch.getColumn(0, "YR_MAGAM") + "] 년"
        			...
        			+ "\n\n" + "현장마감취소를 진행하시겠습니까?"
        	;
        	this.gfnConfirm(msg, "fnMagam_callback", "N");
        }
        ...
        this.fnMagam_callback = function(strID, val)
        {
        	if(val == true)
        	{
        		...
        		this.dsMagam.setColumn(nrow, "NO_SEQ", this.dsSearch.getColumn(0, "NO_SEQ"));
        ...
        this.loadIncludeScript("DCD_EVALUEMAGAM_SITE_MAGAM.xfdl");
