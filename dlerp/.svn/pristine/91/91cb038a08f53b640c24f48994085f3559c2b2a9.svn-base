(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("사업주인정승인 업체현황");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DSGPR_VENDOR_SAUPJU</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DSG_VENDOR_SAUPJU.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DS", "DSG_VENDOR_SAUPJU");
        };
        ...
        this.loadIncludeScript("DSG_VENDOR_SAUPJU.xfdl");
