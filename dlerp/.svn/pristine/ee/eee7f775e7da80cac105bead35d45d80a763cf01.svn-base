(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DMMPR_ITEMTREE_SELECT</Col></Row><Row><Col id=\"TARGET\">d_select</Col><Col id=\"SP\">DMMPR_ITEMSELECT_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DMMPR_ITEMSELECT_INSERT</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DMMPR_ITEMSELECT_DELETE</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DMMPR_ITEMSELECT_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdoYN_USE","sta02:0.0","10.0","200","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("DMM_ITEMSELECT.xfdl", function() {
        ...
        this.divSearch_rdoYN_USE_onitemchanged = function(obj,e)
        {
        	this.FormBtns.Select.click();
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.rdoYN_USE.addEventHandler("onitemchanged",this.divSearch_rdoYN_USE_onitemchanged,this);
            this.divData.addEventHandler("ondragmove",this.divData_ondragmove,this);
            this.divData.form.divSplitter.addEventHandler("ondrag",this.divData_divSplitter_ondrag,this);
        };
        this.loadIncludeScript("DMM_ITEMSELECT.xfdl");
