(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DZMPR_QM_LIST</Col></Row><Row><Col id=\"TARGET\">select1</Col><Col id=\"SP\">DZMPR_SITE_SELECT</Col></Row><Row><Col id=\"TARGET\">select_be</Col><Col id=\"SP\">DZMPR_QM_CODE_SELECT</Col></Row><Row><Col id=\"TARGET\">select_sub</Col><Col id=\"SP\">DZMPR_QM_CODE_LV1</Col></Row><Row><Col id=\"TARGET\">save1</Col><Col id=\"SP\">DZMPR_SITE_SAVE</Col></Row><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DZMPR_QM_LIST_INSERT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DZMPR_QM_LIST_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DZMPR_QM_LIST_DELETE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZMPR_CODEFIND_LIST</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCD_WORK","ccfCD_SITE:0","10","92","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("대공종");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboCD_WORK","staCD_WORK:0","10","118","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Static("staCD_CHASU","cboCD_WORK:0","10","92","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("점검종류");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboCD_CHASU","staCD_CHASU:0","10","118","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_innerdataset("dsCD_CHASU");
            obj.set_datacolumn("DS_CODE");
            obj.set_codecolumn("CD_CODE");
            obj.set_text("");
            obj.set_value("");
            ...
            obj = new Static("staID_USER","cboCD_CHASU:0","10","79","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("작성자");
            ...
            obj = new Static("staTab1Title2","0","298",null,"35","19",null,null,null,null,null,this.divData.form.tabData.tab1.form);
            obj.set_taborder("0");
            obj.set_text("공종선택");
            obj.set_cssclass("sta_TITLE_Bg2");
            this.divData.form.tabData.tab1.addChild(obj.name, obj);

            obj = new Grid("objGrid2","0","333",null,"169","890",null,null,null,null,null,this.divData.form.tabData.tab1.form);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("DZM_QM_LIST.xfdl", function() {
        ...
        this.fnSetVariable = function() {
        	...
        	this.dxGrid2= this.divData.form.tabData.tab1.form.objGrid2;
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid1, this.dsList, "DZ", "DZM_QM_LIST_QM");
        	this.gfnGridInit(this.dxGrid3, this.dsList2, "DZ", "DZM_QM_LIST_SB");
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsUpdate.addColumn("KEY_SEQ", "string");
        	...
        	this.dsUpdate.addColumn("DS_REPORT", "string");
        	...
        	this.dsDelete.addColumn("KEY_SEQ", "string");
        	this.dsDelete.addColumn("CD_LV3", "string");
        ...
        this.fnSelect = function() {
        	...
        	switch(index) {
        		...
        		case 0:
        			...
        			this.dsSelect1.setColumn(0, "CD_GBN", "");
        			this.dsSelect1.setColumn(0, "CD_CHASU", this.divSearch.form.cboCD_CHASU.value);
        			strSvcId    = "select1";
        		...
        		case 1:
        			...
        			this.dsSelect.setColumn(0, "CD_GBN", "");
        			this.dsSelect.setColumn(0, "CD_CHASU", this.divSearch.form.cboCD_CHASU.value);
        			...
        			for (var i = 0; i < this.dsList.rowcount; i++) {
        					...
        					switch(flag) {
        						case "I":
        							...
        							this.dsInsert.setColumn(nrow, "CD_CHASU", this.divSearch.form.cboCD_CHASU.value);
        						...
        						case "U":
        							...
        							this.dsUpdate.setColumn(nrow, "KEY_SEQ", this.dsList.getColumn(i, "KEY_SEQ"));
        						...
        						case "D":
        							...
        							this.dsDelete.setColumn(nrow, "KEY_SEQ", this.dsList.getColumn(i, "KEY_SEQ"));
        							this.dsDelete.setColumn(nrow, "CD_LV3", this.dsList.getColumn(i, "CD_LV3"));
        							break;
        					}
        				}
        			break;
        ...
        //			}
        	...
        	if (svcID == "selectSub") {
        		...
        		this.gfnGridInit(this.dxGrid2, this.dsList1, "DZ", "DZM_QM_LIST_SUB");
        		this.fnSelectSub();
        ...
        this.fnSelectBe = function() {
        	...
        	this.dsSelectBe.setColumn(0, "CD_CHASU", this.divSearch.form.cboCD_CHASU.value);
        ...
        this.fnSelectSub = function() {
        	...
        	this.dsSelectSub.setColumn(0, "CD_CHASU", this.divSearch.form.cboCD_CHASU.value);
        	this.dsSelectSub.setColumn(0, "CD_GBN", this.divSearch.form.cboCD_WORK.value);

        	var strSvcId    = "selectSub";
        	var strSvcType  = "grid";
        	var inProc		= "_dsProc";
        	var inData      = "select_sub=dsSelectSub";
        	var outData     = "dsList1=select_sub0";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.dxGrid_oncellclick = function(obj,e)
        {
        	...
        	FileManager.CD_DIR   = [this.dsList.getColumn(this.dsList.rowposition, "KEY_SEQ"),
        							this.dsList.getColumn(this.dsList.rowposition, "CD_LV3")];
        ...
        this.fnCallbackCombo = function(svcID, errorCode, errorMsg)
        {
        	...
        	if(svcID == "combo1") {
        		...
        		this.dsNO_DGR.setColumn(0, "DS_DGR", "전체");
         		*/
        		this.divSearch.form.cboCD_CHASU.set_index(0);
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.staCD_WORK.addEventHandler("onclick",this.divSearch_staCD_SITE01_onclick,this);
        ...
        this.loadIncludeScript("DZM_QM_LIST.xfdl");
