(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DAAPR_STATUS_DEPTJOIN</Col></Row><Row><Col id=\"SP\">DAAPR_STATUS_DEPTJOIN_SUB</Col><Col id=\"TARGET\">selectSub</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DAA_STATUS_DEPTJOIN.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	this.gfnGridInit(this.dxGrid, this.dsList, "DA", "DAA_STATUS_DEPTJOIN");
        ...
        this.loadIncludeScript("DAA_STATUS_DEPTJOIN.xfdl");
