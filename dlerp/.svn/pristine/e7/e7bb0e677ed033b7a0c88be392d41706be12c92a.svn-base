(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFAPR_SUJIFIRST_SELECT</Col></Row><Row><Col id=\"TARGET\">insert</Col><Col id=\"SP\">DFAPR_SUJIFIRST_INSERT</Col></Row><Row><Col id=\"TARGET\">udpate</Col><Col id=\"SP\">DFAPR_SUJIFIRST_UPDATE</Col></Row><Row><Col id=\"TARGET\">delete</Col><Col id=\"SP\">DFAPR_SUJIFIRST_DELETE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("DFA_SUJIFIRST.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	...
        	// 그리드 초기화
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFA_SUJIFIRST");
        };
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsInsert.addColumn("DS_SUJIFIRST", "string");
        	this.dsInsert.addColumn("NO_ORDER", "string");

        	this.dsUpdate = new Dataset();
        	this.dsUpdate.addColumn("CD_SUJIFIRST", "string");
        	this.dsUpdate.addColumn("DS_SUJIFIRST", "string");
        	this.dsUpdate.addColumn("NO_ORDER", "string");
        	...
        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		...
        		switch(flag) {
        			case "I":
        				...
        				this.dsInsert.setColumn(nrow, "DS_SUJIFIRST", this.dsList.getColumn(i, "DS_SUJIFIRST"));
        ...
        // 				this.dsInsert.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);
        			...
        			case "U":
        				...
        				this.dsUpdate.setColumn(nrow, "CD_SUJIFIRST", this.dsList.getColumn(i, "CD_SUJIFIRST"));
        				this.dsUpdate.setColumn(nrow, "DS_SUJIFIRST", this.dsList.getColumn(i, "DS_SUJIFIRST"));
        ...
        this.loadIncludeScript("DFA_SUJIFIRST.xfdl");
