(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divData","0","40",null,"40","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Button("btnConf","25%","divData:10","69","27",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("확인");
            this.addChild(obj.name, obj);

            obj = new Button("btnCancel","btnConf:10","divData:10","69","27",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("취소");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DHA_REVERSESLIPDLG.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("DHA_REVERSESLIPDLG.xfdl");
