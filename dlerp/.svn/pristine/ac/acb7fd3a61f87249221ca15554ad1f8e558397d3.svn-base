(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("maxheight").set("269");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">save</Col><Col id=\"SP\">DACPR_MGTVACA_PAY_AUTOSLIP_CREATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsData", this);
            obj._setContents("<ColumnInfo><Column id=\"YY_BASE\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CORP\" type=\"STRING\" size=\"256\"/><Column id=\"CD_DEPT_ACNT\" type=\"STRING\" size=\"256\"/><Column id=\"DT_ACCOUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"YY_BASE\"/><Col id=\"CD_CORP\"/><Col id=\"CD_DEPT_ACNT\"/><Col id=\"DT_ACCOUNT\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("tclYY_BASE","116","41","80","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("15");
            ...
            obj = new Div("divBtns","120","staDT_CONFIRM:10","130","27",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("10");
            this.divData.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divData.form.tclYY_BASE.form.TextBox","value","dsData","YY_BASE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DAC_MGTVACATION_PAY_AUTOSLIP_ISSUE.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divBtns.form.btnCANCLE.addEventHandler("onclick",this.divData_btnCancel_onclick,this);
        };
        this.loadIncludeScript("DAC_MGTVACATION_PAY_AUTOSLIP_ISSUE.xfdl");
