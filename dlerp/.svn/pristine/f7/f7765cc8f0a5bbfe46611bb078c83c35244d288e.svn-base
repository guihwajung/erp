(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TARGET\" type=\"STRING\" size=\"256\"/><Column id=\"SP\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TARGET\">select</Col><Col id=\"SP\">DFBPR_REQUESTDTL_FRGN_SELECT</Col></Row><Row><Col id=\"TARGET\">select2</Col><Col id=\"SP\">DFBPR_EXECDTL_FRGN_SELECT</Col></Row><Row><Col id=\"TARGET\">update</Col><Col id=\"SP\">DFBPR_REQUEST_UPDATE</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_MDMCODE_CODEFIND_SELECT</Col></Row><Row><Col id=\"TARGET\">AssignConfirm</Col><Col id=\"SP\">DFBPR_REQUESTDTL_ASSIGN</Col></Row><Row><Col id=\"TARGET\">SeqUpdate</Col><Col id=\"SP\">DFBPR_REQUESTDTL_UPDATE</Col></Row><Row><Col id=\"SP\">DFBPR_EXECDTL_TRAN_ASSIGNX</Col><Col id=\"TARGET\">AssignCancel</Col></Row><Row><Col id=\"TARGET\">trans</Col><Col id=\"SP\">DFBPR_EXEC_FRGN_AUTOSLIP</Col></Row><Row><Col id=\"TARGET\">cancel</Col><Col id=\"SP\">DFBPR_EXEC_SLIP_CANCEL</Col></Row><Row><Col id=\"TARGET\">connect</Col><Col id=\"SP\">DFBPR_EXEC_SLIP_UPDATE</Col></Row><Row><Col id=\"TARGET\">BranchInsert</Col><Col id=\"SP\">DFBPR_BRANCH_INSERT</Col></Row><Row><Col id=\"TARGET\">BranchDelete</Col><Col id=\"SP\">DFBPR_BRANCH_DELETE</Col></Row><Row><Col id=\"TARGET\">Assign</Col><Col id=\"SP\">DFBPR_EXECDTL_FRGN_INSERT</Col></Row><Row><Col id=\"TARGET\">combo</Col><Col id=\"SP\">DZXPR_COMBO_SELECT</Col></Row><Row><Col id=\"TARGET\">accntUpdate</Col><Col id=\"SP\">DFBPR_EXECDTL_TRAN_MAINACCOUNT</Col></Row><Row><Col id=\"TARGET\">reqDtUpdate</Col><Col id=\"SP\">DFBPR_DT_REQUEST_FRGN_UPDATE</Col></Row><Row><Col id=\"TARGET\">execUpdate</Col><Col id=\"SP\">DFBPR_EXECDTL_FRGN_UPDATE</Col></Row><Row><Col id=\"TARGET\">charge</Col><Col id=\"SP\">DFBPR_CHARGE_FRGN_UPDATE</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CD_CODE\">F</Col><Col id=\"DS_CODE\">외화</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTY_CASH","1370","39","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("20");
            obj.set_text("현금구분");
            obj.set_cssclass("sta_WF_SchLabelE");
            ...
            obj = new Combo("ccboTY_GUBUN","1460","37","100","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staTY_CASH00","ccboYN_EXEC:0","10","92.0","24.0",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("24");
            obj.set_text("전표승인");
            obj.set_cssclass("sta_WF_SchLabelE");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Button("btnDocQ",null,"0","120","22","210",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("6");
            obj.set_text("자금신청품의서 조회");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("txtDragSUM",null,"1","100","20","staDragCnt:10",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("8");
            obj.set_format("#,###.##");
            obj.set_readonly("true");
            obj.set_tabstop("false");
            ...
            obj = new Static("staCD_VENDOR00",null,"2","86","20","txtDragSUM:-8",null,null,null,null,null,this.divData.form.divDataTop.form);
            obj.set_taborder("9");
            obj.set_text("선택합계");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divData.form.divDataTop.addChild(obj.name, obj);
            ...
            obj = new Div("divSearchBottom","0","24",null,"31","0",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("5");
            obj.set_cssclass("div_SEARCH_Bg");
            obj.set_formscrolltype("none");
            obj.set_visible("false");
            ...
            obj = new Button("btnAssign",null,"0","100","22","5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("0");
            obj.set_text("개별배정확정");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Static("sta03","0","divSearchBottom:-25","100","22",null,null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("6");
            obj.set_text("■ 자금집행내역");
            this.divData.form.divDataBottom.addChild(obj.name, obj);
            ...
            obj = new Button("btnCancel",null,"30","70","22","5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("4");
            obj.set_text("전표취소");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnSlip",null,"30","70","22","btnCancel:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("3");
            obj.set_text("전표조회");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnTrans",null,"30","70","22","btnSlip:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("2");
            obj.set_text("전표발행");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new MaskEdit("txtAMTSUM","sta03:5","divSearchBottom:-25","100","20",null,null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("1");
            obj.set_format("#,##0.##");
            obj.set_readonly("true");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Static("staCNTSUM","txtAMTSUM:5","divSearchBottom:-25","100","20",null,null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("8");
            obj.set_text("원 0건");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnOfflineInsert",null,"30","80","22","320",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("9");
            obj.set_text("오프라인처리");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnBranchInsert",null,"30","90","22","btnOfflineInsert:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("10");
            obj.set_text("집행내역전송");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnChargeSave",null,"30","82","22","btnTrans:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("11");
            obj.set_text("수수료저장");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnSetNO_ACCOUNT",null,"30","90","22","btnBranchInsert:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("13");
            obj.set_text("출금계좌변경");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnExecEdit",null,"30","140","22","btnSetNO_ACCOUNT:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("12");
            obj.set_text("출금구분및입금계좌변경");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnExecChange",null,"30","95","22","btnExecEdit:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("15");
            obj.set_text("집행내역변경");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("tbbAssignCncl","btnExecChange:-162","30",null,"22","btnExecChange:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("14");
            obj.set_text("배정취소");
            this.divData.form.divDataBottom.addChild(obj.name, obj);

            obj = new Button("btnExecDetail","tbbAssignCncl:-157","30",null,"22","tbbAssignCncl:5",null,null,null,null,null,this.divData.form.divDataBottom.form);
            obj.set_taborder("16");
            obj.set_text("배정내역상세");
            this.divData.form.divDataBottom.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DFB_REQUESTASSIGN_EXECTRAN_FRGN.xfdl", function() {
        ...
        this.fnSetEvent = function() {
        	this.gfnGridInit(this.dxGridAssign, this.dsListAssign, "DF", "DFB_REQUESTASSIGN_EXECTRAN_FRGN");
        	this.gfnGridInit(this.dxGrid, this.dsList, "DF", "DFB_REQUESTASSIGN_EXECTRAN_FRGN2");

        	this.dxGridAssign.addEventHandler("onselectchanged", this.fnGridAssign_RowCellChanged, this);
        	this.dxGrid.addEventHandler("onselectchanged", this.fnGrid_RowCellChanged, this);

        	this.dxGridAssign.AfterEdit = "fnGrid_AfterEdit";
        	this.dxGridAssign.AfterAllCheck = "fnGridAssign_AfterAllCheck";
        ...
        this.fnSetParameter = function() {
        	...
        	this.dsAssign.addColumn("CD_CURR", "string");

        	this.dsCharge = new Dataset();
        	this.dsCharge.addColumn("SEQ_EXEC", "bigdecimal");
        	this.dsCharge.addColumn("SEQ_ALLOT", "bigdecimal");
        	this.dsCharge.addColumn("CD_CHARGE_CURR", "string");
        	this.dsCharge.addColumn("AM_CHARGE", "bigdecimal");
        	this.dsCharge.addColumn("DS_CHARGE_REM", "string");
        	this.dsCharge.addColumn("DS_CHARGEBANK_REM", "string");
        ...
        this.fnSelect = function() {
        	...
        	this.dxGridAssign.setCellProperty("head", 1, "text", 0);
        	...
        	this.dsSelect.setColumn(0, "TY_GUBUN", "F");  //외화만 나오게
        	...
        	this.dsSelect2.setColumn(0, "TY_CASH", "F");  // 외화만 나오게
        ...
        this.fnDataDisplay_asgn = function() {
        	...
        	var arrChk = [];
        	for(var i = 0; i < this.dsListAssign.rowcount; i++) {
        		if(this.dsListAssign.getColumn(i, "CHK") == 1) {
        			arrChk.push(i);
        		}
        	}
        	...
        	if (this.dsExec.rowcount > 0) {
        		...
        		this.dsPnl1.setColumn(0, "TY_CASH", this.dsExec.getColumn(row, "TY_CASH"));
        		...
        		if (this.dsPnl1.getColumn(0, "TY_CASH") != "C" && this.dsPnl1.getColumn(0, "TY_CASH") != "F" ) {
        ...
        this.fnDialogCallback = function(svcID, value) {
        	trace('fnDialogCallback / value ->' + value + " / svcID->"+svcID);
        	if (value) {
        		//this.FormBtns.Select.click();
        		...
        		// 집행내역 수정 후
        		if (svcID.indexOf("DFB_MODIFY_CURR_AMT_DLG") > -1) {
        			this.dsReturn.clearData();

        			if(!this.gfnIsNull(value)) {
        				this.dsReturn.loadXML(value);

        				this.dsExecUpdate = new Dataset();
        				this.dsExecUpdate.addColumn("SEQ_EXEC", "bigdecimal");
        				this.dsExecUpdate.addColumn("DT_REQ", "string");
        				this.dsExecUpdate.addColumn("CD_CURR_EXEC", "string");
        				this.dsExecUpdate.addColumn("AM_AMT", "bigdecimal");
        				this.dsExecUpdate.addColumn("AM_AMT_KRW", "bigdecimal");

        				this.dsExecUpdate.clearData();

        				for (var i=0; i < this.dsList.rowcount; i++) {
        					if (this.dsList.getColumn(i, "CHK") == 1) {
        						var nrow = this.dsExecUpdate.addRow();
        						this.dsExecUpdate.setColumn(nrow, "SEQ_EXEC", this.dsList.getColumn(i, "SEQ_EXEC"));
        						this.dsExecUpdate.setColumn(nrow, "DT_REQ", this.dsReturn.getColumn(0, "DT_REQ"));
        						this.dsExecUpdate.setColumn(nrow, "CD_CURR_EXEC",this.dsReturn.getColumn(0, "CD_CURR_EXEC"));
        						this.dsExecUpdate.setColumn(nrow, "AM_AMT", this.dsReturn.getColumn(0, "AM_AMT"));
        						this.dsExecUpdate.setColumn(nrow, "AM_AMT_KRW", this.dsReturn.getColumn(0, "AM_AMT_KRW"));
        					}
        				}


        			if (this.dsExecUpdate.rowcount == 0) return;

        			var strSvcId    = "save";
        			var strSvcType  = "save";
        			var inProc		= "_dsProc";
        			var inData      = "execUpdate=dsExecUpdate";
        			var outData     = "";
        			var strArg      = "";
        			var callBackFnc = "fnCallback";
        ...
        this.fnUpdateStatusExtendButton = function() {
        	...
        	var bEnableDoc = (this.gfnIsNull(this.dsListAssign.getColumn(this.dsListAssign.rowposition, "NO_DOC"))) ? false : true;

        	this.divData.form.divDataTop.form.btnDocQ.set_enable(bEnable && bEnableDoc && this.dsListAssign.getColumn(nrow, "BTN_DOC_Q") == "Y");
        ...
        //집행내역수정 - 통화, 금액 수정 처리
        this.btnExecChange_onclick = function(obj,e)
        {
        	if (this.dsList.findRow("CHK", 1) == -1) {
        		return false;
        	}
        	trace("btnExecChange_onclick : " + "DFB_MODIFY_CURR_AMT_DLG");

        	var param = {};
        	param.SEQ_EXEC = this.dsList.getColumn(this.dsList.rowposition, "SEQ_EXEC");
        	param.DT_REQ = this.dsList.getColumn(this.dsList.rowposition, "DT_REQ");
        	param.CD_CURR_EXEC = this.dsList.getColumn(this.dsList.rowposition, "CD_CURR_REQ");
        	param.AM_EXEC = this.dsList.getColumn(this.dsList.rowposition, "AM_ACCOUNT");
        	param.AM_AMT = this.dsList.getColumn(this.dsList.rowposition, "AM_AMT");
        	param.AM_AMT_KRW = this.dsList.getColumn(this.dsList.rowposition, "AM_AMT_KRW");
        	this.gfnFormOpenNonAuth(this.FormInfo.CD_MODULE, "DFB_MODIFY_CURR_AMT_DLG", "fnDialogCallback", param, 500, 500);
        };
        ...
        this.btnTrans_onclick = function(obj,e)
        {
        	...
        	if(this.dsList.getCaseCount("nx_flag =='U'") != 0){
        		this.gfnAlert(" 수수료 수정자료가 존재합니다. 수수료 저장 작업후 전표발행 하세요!.");
        		return;
        	}
        // 	for (var i=0; i < this.dsList.rowcount; i++) {
        //
        ...
        this.btnBranchInsert_onclick = function(obj,e)
        {
            if( obj.id == "btnBranchInsert") {
        	   ...
        	   param.CD_CURR = this.gfnTrim(this.dsList.getColumn(this.dsList.rowposition, "CD_CURR_EXEC"));
        	   param.YN_FRGN = "Y";
        ...
        this.fnGridAssign_AfterAllCheck = function(obj, cell, check)
        {
        var ds = obj.getBindDataset();
        	...
        	if (check) {
        		...
        		if (obj.name = "objGridAssign") {
        			...
        			// 배정된것은 체크 해제
        			var arrExec = ds.extractRows("SEQ_EXECDESC == '배정'");

        			for(var i in arrAppr){
        				ds.setColumn(arrAppr[i], "CHK", 0);
        			}

        			for(var i in arrExec){
        				ds.setColumn(arrExec[i], "CHK", 0);
        			}
        ...
        // 수수료 저장 처리
        this.btnChargeSave_onclick = function(obj,e)
        {
            if (!this.gfnGridValidate(this.dxGrid)) return;

        	this.dxGrid.updateToDataset();

        	this.dsCharge.clearData();

        	for (var i = 0; i < this.dsList.rowcount; i++) {
        		var flag = this.gfnGetFlag(this.dsList, i);
        		switch(flag) {
        			case "U":
        				var nrow = this.dsCharge.addRow();

        				this.dsCharge.setColumn(nrow, "SEQ_EXEC", this.dsList.getColumn(i, "SEQ_EXEC"));
        				this.dsCharge.setColumn(nrow, "SEQ_ALLOT", this.dsList.getColumn(i, "SEQ_ALLOT"));
        				this.dsCharge.setColumn(nrow, "CD_CHARGE_CURR", this.dsList.getColumn(i, "CD_CHARGE_CURR"));
        				this.dsCharge.setColumn(nrow, "AM_CHARGE", this.dsList.getColumn(i, "AM_CHARGE"));
        				this.dsCharge.setColumn(nrow, "DS_CHARGE_REM", this.dsList.getColumn(i, "DS_CHARGE_REM"));
        				this.dsCharge.setColumn(nrow, "DS_CHARGEBANK_REM", this.dsList.getColumn(i, "DS_CHARGEBANK_REM"));

        				break;
        		}
        	}

        	if (this.dsCharge.rowcount == 0) return;

        	var strSvcId    = "save";
        	var strSvcType  = "save";
        	var inProc		= "_dsProc";
        	var inData      = "charge=dsCharge";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.fnSAssign_callback = function(strId, val) {
        	if (val) {
        		...
        		param.GUBUN = "DFBPR_EXECDTL_FRGN_INSERT";
        ...
        this.fnAssign = function(YN_EXEC, DT_REQ) {
        	...
        	if (YN_EXEC == "N") {
        		...
        		for (var  i=0; i < this.dsListAssign.rowcount; i++) {
        			if (this.dsListAssign.getColumn(i, chk) == 1 && this.dsListAssign.getColumn(i, this.ucFlag) != "#") {
        				...
        				this.dsAssign.setColumn(nrow, "CD_CURR", this.dsListAssign.getColumn(i, "CD_CURR"));
        			}
        		}
        	...
        	// 후처리시 Y
        		...
        		this.dsAssign.setColumn(nrow, "SEQ_ALLOT", this.dsListAssign.getColumn(i, "SEQ_ALLOT"));
        		this.dsAssign.setColumn(nrow, "ID_USER", this.AuthClient.ID_USER);
        		this.dsAssign.setColumn(nrow, "CD_CURR", "");
        	}
        ...
        // 	this.dsCombo.setColumn(1, "CD_TYPE", "B2");
        	...
        	this.dsCombo.addRow();
        	this.dsCombo.setColumn(1, "CD_SYSTEM", "DF");
        	this.dsCombo.setColumn(1, "CD_TYPE", "Z3");

        	this.dsCombo.addRow();
        	this.dsCombo.setColumn(2, "CD_SYSTEM", "DF");
        	this.dsCombo.setColumn(2, "CD_TYPE", "B7");

        // 	this.dsCombo.addRow();
        // 	this.dsCombo.setColumn(4, "CD_SYSTEM", "DF");
        // 	this.dsCombo.setColumn(4, "CD_TYPE", "B7");

        	var strSvcId    = "combo";
        	var strSvcType  = "select";
        	var inProc		= "_dsProc";
        	var inData      = "combo=dsCombo";
        	var outData     = "dsYN_SLIP=combo0 dsYN_APPR=combo1 dsTY_GUBUN=combo2";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.divDataBottom.form.btnChargeSave.addEventHandler("onclick",this.btnChargeSave_onclick,this);
            ...
            this.divData.form.divDataBottom.form.btnExecChange.addEventHandler("onclick",this.btnExecChange_onclick,this);
            ...
            this.dsCharge.addEventHandler("oncolumnchanged",this.dsList_oncolumnchanged,this);
        };
        this.loadIncludeScript("DFB_REQUESTASSIGN_EXECTRAN_FRGN.xfdl");
