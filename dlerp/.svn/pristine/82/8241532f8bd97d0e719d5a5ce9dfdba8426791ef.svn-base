(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("직영계약명공종코드가져오기");
            if (Form == this.constructor)
            {
                this._setFormPosition(430,200);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"CD_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"DS_SITE\" type=\"STRING\" size=\"256\"/><Column id=\"NO_HADOCONT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staMsg01","10","103",null,"30","10",null,null,null,null,null,this.divData.form);
            obj.set_taborder("3");
            obj.set_text("직영 건을 대상으로만 계약번호 및 공종코드가 조회됩니다.");
            obj.set_textAlign("center");
            obj.set_font("normal bold 10pt/normal \"Arial\"");
            this.divData.addChild(obj.name, obj);

            obj = new Static("staMsg02","15","138",null,"30","10",null,null,null,null,null,this.divData.form);
            obj.set_taborder("2");
            obj.set_text("※ 확인 후 호출화면에서 저장 버튼을 클릭하세요.");
            obj.set_textAlign("center");
            obj.set_font("normal bold 10pt/normal \"Arial\"");
            obj.set_color("red");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnOk","34.65%","178","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("7");
            obj.set_text("확인");
            obj.set_cssclass("btnExt");
            this.divData.addChild(obj.name, obj);

            obj = new Button("btnCancel","54.65%","178","60","20",null,null,null,null,null,null,this.divData.form);
            obj.set_taborder("8");
            obj.set_text("닫기");
            obj.set_cssclass("btnExt");
            this.divData.addChild(obj.name, obj);

            obj = new Div("ccfNO_HADOCONT","105","38","250","25",null,null,null,null,null,null,this.divData.form);
            ...
            obj = new Div("ccfNO_COST","105","68","250","25",null,null,null,null,null,null,this.divData.form);
            obj.getSetter("CDTextWidth").set("80");
            obj.set_taborder("10");
            obj.set_url("cmm::cmmCodeFind.xfdl");
            ...
            obj = new BindItem("item0","divData.form.ccfNO_HADOCONT.form.CDTextBox","value","dsData","NO_HADOCONT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("DWD_JTCONTCOSTDLG.xfdl", function() {
        ...
        this.divData_staMsg01_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divData.form.staMsg01.addEventHandler("onclick",this.divData_staMsg01_onclick,this);
            this.divData.form.btnOk.addEventHandler("onclick",this.divData_btnOk_onclick,this);
            this.divData.form.btnCancel.addEventHandler("onclick",this.divData_btnCancel_onclick,this);
            this.dsData.addEventHandler("onvaluechanged",this.dsData_onvaluechanged,this);
        };
        this.loadIncludeScript("DWD_JTCONTCOSTDLG.xfdl");
